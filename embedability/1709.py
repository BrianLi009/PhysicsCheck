...
def test_embed(): 
    ...
    s.add(((z_10*x_11-x_10*z_11)*z_9-(x_10*y_11-y_10*x_11)*y_9)==0) 
    s.add(((x_10*y_11-y_10*x_11)*x_9-(y_10*z_11-z_10*y_11)*z_9)==0) 
    s.add(((y_10*z_11-z_10*y_11)*y_9-(z_10*x_11-x_10*z_11)*x_9)==0) 
    s.add(((z_11*x_12-x_11*z_12)*z_0-(x_11*y_12-y_11*x_12)*y_0)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_0-(y_11*z_12-z_11*y_12)*z_0)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_0-(z_11*x_12-x_11*z_12)*x_0)==0) 
    s.add(((z_10*x_13-x_10*z_13)*z_1-(x_10*y_13-y_10*x_13)*y_1)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_1-(y_10*z_13-z_10*y_13)*z_1)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_1-(z_10*x_13-x_10*z_13)*x_1)==0) 
    s.add(((z_1*x_13-x_1*z_13)*z_4-(x_1*y_13-y_1*x_13)*y_4)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_4-(y_1*z_13-z_1*y_13)*z_4)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_4-(z_1*x_13-x_1*z_13)*x_4)==0) 
    ...
    s.add(((z_4*x_12-x_4*z_12)*z_7-(x_4*y_12-y_4*x_12)*y_7)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_7-(y_4*z_12-z_4*y_12)*z_7)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_7-(z_4*x_12-x_4*z_12)*x_7)==0) 
    s.add(((z_7*x_9-x_7*z_9)*z_5-(x_7*y_9-y_7*x_9)*y_5)==0) 
    s.add(((x_7*y_9-y_7*x_9)*x_5-(y_7*z_9-z_7*y_9)*z_5)==0) 
    s.add(((y_7*z_9-z_7*y_9)*y_5-(z_7*x_9-x_7*z_9)*x_5)==0) 
    s.add(((z_8*x_10-x_8*z_10)*z_6-(x_8*y_10-y_8*x_10)*y_6)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_6-(y_8*z_10-z_8*y_10)*z_6)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_6-(z_8*x_10-x_8*z_10)*x_6)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_4 == 0) 
