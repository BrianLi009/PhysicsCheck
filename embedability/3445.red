...
neq10 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(k(k(k(v3,v2),v3),v1),v2)); 
neq11 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(v3,v2)); 
neq12 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),v0); 
neq13 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(v3,k(v0,v1))); 
neq14 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),v3); 
neq15 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(v0,v1)); 
neq16 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(k(v3,v2),v3)); 
neq17 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),v1); 
neq18 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(k(k(v3,v2),v3),v1)); 
neq19 := k(k(k(k(k(v3,v2),v3),v1),v2),k(v3,v2)); 
neq20 := k(k(k(k(k(v3,v2),v3),v1),v2),v0); 
neq21 := k(k(k(k(k(v3,v2),v3),v1),v2),k(v3,v1)); 
neq22 := k(k(k(k(k(v3,v2),v3),v1),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq23 := k(k(k(k(k(v3,v2),v3),v1),v2),k(v3,k(v0,v1))); 
...
neq30 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq31 := k(k(v3,v2),k(v3,k(v0,v1))); 
neq32 := k(k(v3,v2),k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1)))); 
neq33 := k(k(v3,v2),k(v0,v1)); 
neq34 := k(k(v3,v2),v1); 
neq35 := k(k(v3,v2),k(k(k(v3,v2),v3),v1)); 
neq36 := k(v0,k(v3,v1)); 
neq37 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq38 := k(v0,k(v3,k(v0,v1))); 
neq39 := k(v0,k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1)))); 
neq40 := k(v0,v3); 
neq41 := k(v0,k(k(v3,v2),v3)); 
neq42 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq43 := k(k(v3,v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq44 := k(k(v3,v1),k(v3,k(v0,v1))); 
neq45 := k(k(v3,v1),k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1)))); 
neq46 := k(k(v3,v1),k(v0,v1)); 
neq47 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq48 := k(k(v3,v1),k(k(k(v3,v2),v3),v1)); 
neq49 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,k(v0,v1))); 
neq50 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1)))); 
neq51 := k(k(k(k(v3,v2),v3),k(v0,v1)),v3); 
neq52 := k(k(k(k(v3,v2),v3),k(v0,v1)),v1); 
neq53 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v3),v1)); 
neq54 := k(k(v3,k(v0,v1)),k(k(v3,v2),v3)); 
neq55 := k(k(v3,k(v0,v1)),v1); 
neq56 := k(k(v3,k(v0,v1)),k(k(k(v3,v2),v3),v1)); 
neq57 := k(k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1))),v3); 
neq58 := k(k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1))),k(v0,v1)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v2)) = 0 and 
       d(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v1)),k(k(k(k(v3,v2),v3),v1),k(v3,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
