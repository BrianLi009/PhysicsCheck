...
def test_embed(): 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_10-(x_8*y_12-y_8*x_12)*y_10)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_10-(y_8*z_12-z_8*y_12)*z_10)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_10-(z_8*x_12-x_8*z_12)*x_10)==0) 
    s.add(((z_7*x_10-x_7*z_10)*z_9-(x_7*y_10-y_7*x_10)*y_9)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_9-(y_7*z_10-z_7*y_10)*z_9)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_9-(z_7*x_10-x_7*z_10)*x_9)==0) 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_2-(x_7*y_13-y_7*x_13)*y_2)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_2-(y_7*z_13-z_7*y_13)*z_2)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_2-(z_7*x_13-x_7*z_13)*x_2)==0) 
    s.add(((z_2*x_6-x_2*z_6)*z_4-(x_2*y_6-y_2*x_6)*y_4)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_4-(y_2*z_6-z_2*y_6)*z_4)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_4-(z_2*x_6-x_2*z_6)*x_4)==0) 
    s.add(((z_5*x_8-x_5*z_8)*z_3-(x_5*y_8-y_5*x_8)*y_3)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_3-(y_5*z_8-z_5*y_8)*z_3)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_3-(z_5*x_8-x_5*z_8)*x_3)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_8 == 0) 
