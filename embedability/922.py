...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_13-(x_7*y_12-y_7*x_12)*y_13)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_13-(y_7*z_12-z_7*y_12)*z_13)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_13-(z_7*x_12-x_7*z_12)*x_13)==0) 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_0-(x_6*y_11-y_6*x_11)*y_0)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_0-(y_6*z_11-z_6*y_11)*z_0)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_0-(z_6*x_11-x_6*z_11)*x_0)==0) 
