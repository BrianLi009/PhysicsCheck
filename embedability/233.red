...
neq13 := k(k(k(k(v3,v1),v3),k(v0,v1)),k(k(v3,v1),v2)); 
neq14 := k(k(k(k(v3,v1),v3),k(v0,v1)),k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq15 := k(k(k(k(v3,v1),v3),k(v0,v1)),k(k(k(v3,v1),v2),v0)); 
neq16 := k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v1)); 
neq17 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),v0); 
neq18 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),v1); 
neq19 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),v3); 
neq20 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),k(v3,v2)); 
neq21 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),k(k(v3,v1),v2)); 
neq22 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),k(k(v3,v1),v3)); 
neq23 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v1),v2),v0)); 
neq24 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1)),k(v3,v1)); 
neq25 := k(v0,v3); 
neq26 := k(v0,k(v3,v2)); 
neq27 := k(v0,k(k(v3,v1),v2)); 
neq28 := k(v0,k(k(v3,v1),v3)); 
neq29 := k(v0,k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq30 := k(v0,k(v3,v1)); 
neq31 := k(v1,v3); 
neq32 := k(v1,k(v3,v2)); 
neq33 := k(v1,k(k(v3,v1),v2)); 
neq34 := k(v1,k(k(v3,v1),v3)); 
neq35 := k(v1,k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq36 := k(v1,k(k(k(v3,v1),v2),v0)); 
neq37 := k(v3,k(k(v3,v1),v2)); 
neq38 := k(v3,k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq39 := k(v3,k(k(k(v3,v1),v2),v0)); 
neq40 := k(v3,k(v0,v1)); 
neq41 := k(k(v3,v2),k(k(v3,v1),v2)); 
neq42 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq43 := k(k(v3,v2),k(k(k(v3,v1),v2),v0)); 
neq44 := k(k(v3,v2),k(v3,v1)); 
neq45 := k(k(v3,v2),k(v0,v1)); 
neq46 := k(k(k(v3,v1),v2),k(k(v3,v1),v3)); 
neq47 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq48 := k(k(k(v3,v1),v2),k(v0,v1)); 
neq49 := k(k(k(v3,v1),v3),k(k(k(k(v3,v1),v2),v0),k(v3,v2))); 
neq50 := k(k(k(v3,v1),v3),k(k(k(v3,v1),v2),v0)); 
neq51 := k(k(k(v3,v1),v3),k(v0,v1)); 
neq52 := k(k(k(k(k(v3,v1),v2),v0),k(v3,v2)),k(v3,v1)); 
neq53 := k(k(k(k(k(v3,v1),v2),v0),k(v3,v2)),k(v0,v1)); 
neq54 := k(k(k(k(v3,v1),v2),v0),k(v3,v1)); 
neq55 := k(k(k(k(v3,v1),v2),v0),k(v0,v1)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(v3,v1),v2),v0),k(v3,v2)),k(k(k(k(v3,v1),v3),k(v0,v1)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
