...
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq4 := k(v2,v3); 
neq5 := k(v2,v1); 
neq6 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq7 := k(k(v3,k(v2,v0)),k(k(v2,v0),v0)); 
neq8 := k(k(v3,k(v2,v0)),v0); 
neq9 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq10 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq11 := k(k(v3,k(v2,v0)),v1); 
neq12 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq13 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq14 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq15 := k(k(k(v2,v0),v0),k(v3,v2)); 
neq16 := k(k(k(v2,v0),v0),v3); 
neq17 := k(k(k(v2,v0),v0),v1); 
neq18 := k(v0,k(v2,v1)); 
neq19 := k(v0,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq20 := k(v0,k(v3,v2)); 
neq21 := k(v0,v3); 
neq22 := k(v0,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq23 := k(k(v2,v1),k(v3,v2)); 
neq24 := k(k(v2,v1),v3); 
neq25 := k(k(v2,v1),k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq26 := k(k(v2,v1),k(v2,v0)); 
neq27 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v3,v2)); 
neq28 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v3); 
neq29 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq30 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq31 := k(k(v3,v2),v1); 
neq32 := k(k(v3,v2),k(v2,v0)); 
neq33 := k(v3,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq34 := k(v3,k(v2,v0)); 
neq35 := k(v1,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0))); 
neq36 := k(v1,k(v2,v0)); 
neq37 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0)),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v0)),k(v3,v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
