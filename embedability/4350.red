...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0))); 
neq1 := k(v2,k(k(k(v3,v2),v3),v0)); 
neq2 := k(v2,k(k(v3,v1),v1)); 
neq3 := k(v2,k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3)); 
neq4 := k(v2,k(v3,v1)); 
neq5 := k(v2,k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq6 := k(v2,k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq7 := k(v2,v3); 
neq8 := k(v2,k(k(v3,v2),v3)); 
neq9 := k(v2,v1); 
neq10 := k(k(k(k(v3,v1),v1),v2),k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0))); 
neq11 := k(k(k(k(v3,v1),v1),v2),k(k(k(v3,v2),v3),v0)); 
neq12 := k(k(k(k(v3,v1),v1),v2),v0); 
neq13 := k(k(k(k(v3,v1),v1),v2),k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3)); 
neq14 := k(k(k(k(v3,v1),v1),v2),k(v3,v1)); 
neq15 := k(k(k(k(v3,v1),v1),v2),k(v3,v2)); 
neq16 := k(k(k(k(v3,v1),v1),v2),k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq17 := k(k(k(k(v3,v1),v1),v2),v3); 
neq18 := k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)); 
neq19 := k(k(k(k(v3,v1),v1),v2),v1); 
neq20 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),k(k(v3,v1),v1)); 
neq21 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),v0); 
neq22 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),k(v3,v1)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq24 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),k(v3,v2)); 
neq25 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),v3); 
neq26 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),k(k(v3,v2),v3)); 
neq27 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)),v1); 
neq28 := k(k(k(k(v3,v2),v3),v0),k(k(v3,v1),v1)); 
neq29 := k(k(k(k(v3,v2),v3),v0),k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3)); 
neq30 := k(k(k(k(v3,v2),v3),v0),k(v3,v1)); 
neq31 := k(k(k(k(v3,v2),v3),v0),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq32 := k(k(k(k(v3,v2),v3),v0),k(v3,v2)); 
neq33 := k(k(k(k(v3,v2),v3),v0),k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq34 := k(k(k(k(v3,v2),v3),v0),v3); 
neq35 := k(k(k(k(v3,v2),v3),v0),v1); 
neq36 := k(k(k(v3,v1),v1),v0); 
neq37 := k(k(k(v3,v1),v1),k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3)); 
neq38 := k(k(k(v3,v1),v1),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq39 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq40 := k(k(k(v3,v1),v1),k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq41 := k(k(k(v3,v1),v1),v3); 
neq42 := k(k(k(v3,v1),v1),k(k(v3,v2),v3)); 
neq43 := k(v0,k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3)); 
neq44 := k(v0,k(v3,v1)); 
neq45 := k(v0,k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq46 := k(v0,k(v3,v2)); 
neq47 := k(v0,k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq48 := k(v0,v3); 
neq49 := k(v0,k(k(v3,v2),v3)); 
neq50 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),k(v3,v1)); 
neq51 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq52 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),k(v3,v2)); 
neq53 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),k(k(v3,v2),v3)); 
neq54 := k(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),v1); 
neq55 := k(k(v3,v1),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq56 := k(k(v3,v1),k(v3,v2)); 
neq57 := k(k(v3,v1),k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq58 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq59 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),k(v3,v2)); 
neq60 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v3); 
neq61 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1); 
neq62 := k(k(v3,v2),k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq63 := k(k(v3,v2),v1); 
neq64 := k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3); 
neq65 := k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(v3,v2),v3)); 
neq66 := k(v3,v1); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),v3),k(k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
