...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_1-(x_8*y_11-y_8*x_11)*y_1)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_1-(y_8*z_11-z_8*y_11)*z_1)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_1-(z_8*x_11-x_8*z_11)*x_1)==0) 
