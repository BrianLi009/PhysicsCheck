...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(v2,k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq1 := k(v2,v3); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1))); 
...
neq10 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v3); 
neq11 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v3,v2)); 
neq12 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0); 
neq13 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq14 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v0,v1)); 
neq15 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),v1)); 
neq16 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v3,v2),v3)); 
neq17 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1); 
neq18 := k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)); 
neq19 := k(v3,k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1))); 
neq20 := k(v3,k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq21 := k(v3,k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq22 := k(v3,k(v0,v1)); 
neq23 := k(v3,k(k(k(v3,v2),v3),v1)); 
neq24 := k(v3,k(v2,k(v0,v1))); 
neq25 := k(v3,v1); 
neq26 := k(v3,k(k(k(k(v3,v2),v3),v1),v1)); 
neq27 := k(k(v3,v2),v0); 
neq28 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1))); 
neq29 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq30 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq31 := k(k(v3,v2),k(v0,v1)); 
neq32 := k(k(v3,v2),k(k(k(v3,v2),v3),v1)); 
neq33 := k(k(v3,v2),k(v2,k(v0,v1))); 
neq34 := k(k(v3,v2),v1); 
neq35 := k(k(v3,v2),k(k(k(k(v3,v2),v3),v1),v1)); 
neq36 := k(v0,k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1))); 
neq37 := k(v0,k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq38 := k(v0,k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq39 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq40 := k(v0,k(k(v3,v2),v3)); 
neq41 := k(v0,k(v2,k(v0,v1))); 
neq42 := k(v0,k(k(k(k(v3,v2),v3),v1),v1)); 
neq43 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq44 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),k(v0,v1)); 
neq45 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),k(k(k(v3,v2),v3),v1)); 
neq46 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),k(k(v3,v2),v3)); 
neq47 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),k(v2,k(v0,v1))); 
neq48 := k(k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)),v1); 
neq49 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq50 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(v0,v1)); 
neq51 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(k(v3,v2),v3),v1)); 
neq52 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)); 
neq53 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(v2,k(v0,v1))); 
neq54 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v1); 
neq55 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v0,v1)); 
neq56 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),v1)); 
neq57 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),v1); 
neq58 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1)); 
neq59 := k(k(v0,v1),k(k(k(v3,v2),v3),v1)); 
neq60 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq61 := k(k(v0,v1),k(k(k(k(v3,v2),v3),v1),v1)); 
neq62 := k(k(k(k(v3,v2),v3),v1),k(v2,k(v0,v1))); 
neq63 := k(k(k(v3,v2),v3),k(v2,k(v0,v1))); 
neq64 := k(k(k(v3,v2),v3),v1); 
neq65 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),v1),v1)); 
neq66 := k(k(v2,k(v0,v1)),v1); 
neq67 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v2),v3),v1),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
