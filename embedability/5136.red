...
v2c2 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq2 := k(v2,k(v3,v0)); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(v3,v2),v3),k(v0,v1))); 
neq5 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq6 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq7 := k(v2,k(k(v3,v2),v3)); 
neq8 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2)); 
neq11 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq12 := k(k(v3,v2),k(v3,v0)); 
neq13 := k(k(v3,v2),v0); 
neq14 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq15 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq16 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq17 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq18 := k(k(v3,v2),v1); 
neq19 := k(k(v3,v2),k(v0,v1)); 
neq20 := k(v3,k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2)); 
neq21 := k(v3,k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq22 := k(v3,v0); 
neq23 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq24 := k(v3,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq25 := k(v3,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq26 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq27 := k(v3,v1); 
neq28 := k(v3,k(v0,v1)); 
neq29 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)); 
neq30 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),v0); 
neq31 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq32 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq33 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq34 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(k(v3,v2),v3)); 
neq35 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),v1); 
neq36 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v0,v1)); 
neq37 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(v3,v0)); 
neq38 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v0); 
neq39 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq40 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq41 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(v3,v2),v3)); 
neq42 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq43 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v1); 
neq44 := k(k(v3,v0),k(k(k(v3,v2),v3),k(v0,v1))); 
neq45 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq46 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq47 := k(k(v3,v0),k(k(v3,v2),v3)); 
neq48 := k(k(v3,v0),v1); 
neq49 := k(k(v3,v0),k(v0,v1)); 
neq50 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq51 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq52 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq53 := k(v0,k(k(v3,v2),v3)); 
neq54 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq55 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1)); 
neq56 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))); 
neq57 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq58 := k(k(k(k(v3,v2),v3),k(v0,v1)),v1); 
neq59 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1),k(k(v3,v2),v3)); 
neq60 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1),k(v0,v1)); 
neq61 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3)),v1); 
neq62 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3)),k(v0,v1)); 
neq63 := k(k(k(v3,v2),v3),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0))); 
neq64 := k(k(k(v3,v2),v3),v1); 
neq65 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq66 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1); 
neq67 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(v0,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),v1),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v2),k(v3,v0)),k(k(v3,v2),v3))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
