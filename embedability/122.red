...
neq5 := k(k(k(v3,v2),v1),k(v2,v1)); 
neq6 := k(k(k(v3,v2),v1),k(k(v2,v1),v2)); 
...
neq13 := k(v2,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq14 := k(v2,v1); 
...
neq27 := k(k(k(v3,v2),v3),k(k(v2,v1),v2)); 
neq28 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq29 := k(k(k(v3,v2),v3),v1); 
neq30 := k(k(k(v3,v2),v3),k(v3,v0)); 
neq31 := k(v0,k(v2,v1)); 
neq32 := k(v0,k(k(v2,v1),v2)); 
neq33 := k(v0,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq34 := k(v0,k(k(k(v3,v2),v3),k(k(v3,v0),v0))); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(k(v3,v0),v0),k(v2,v1)); 
neq37 := k(k(k(v3,v0),v0),k(k(v2,v1),v2)); 
neq38 := k(k(k(v3,v0),v0),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq39 := k(k(k(v3,v0),v0),v1); 
neq40 := k(k(k(v3,v0),v0),k(v3,v2)); 
neq41 := k(k(v2,v1),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq42 := k(k(v2,v1),k(k(k(v3,v2),v3),k(k(v3,v0),v0))); 
neq43 := k(k(v2,v1),k(v3,v0)); 
neq44 := k(k(v2,v1),k(v3,v2)); 
neq45 := k(k(k(v2,v1),v2),v1); 
neq46 := k(k(k(v2,v1),v2),k(k(k(v3,v2),v3),k(k(v3,v0),v0))); 
neq47 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq48 := k(k(k(v2,v1),v2),k(v3,v2)); 
neq49 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v1); 
neq50 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0)); 
neq51 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v2)); 
...
phi := 
       ...
       d(k(k(k(v3,v2),v3),k(k(v3,v0),v0)),k(k(k(v3,v2),v1),k(k(v2,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
