...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v0,k(k(v3,v2),v1)); 
neq1 := k(v0,k(v3,v1)); 
neq2 := k(v0,k(v3,v2)); 
neq3 := k(v0,v3); 
neq4 := k(v0,k(k(k(v3,v1),v2),k(v3,v0))); 
neq5 := k(v0,k(k(v3,v1),v2)); 
neq6 := k(v1,v2); 
neq7 := k(v1,k(v3,v0)); 
neq8 := k(v1,k(v3,v2)); 
neq9 := k(v1,v3); 
neq10 := k(v1,k(k(k(v3,v1),v2),k(v3,v0))); 
neq11 := k(v1,k(k(v3,v1),v2)); 
neq12 := k(v2,k(v3,v0)); 
neq13 := k(v2,k(k(v3,v2),v1)); 
neq14 := k(v2,k(v3,v1)); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(k(v3,v1),v2),k(v3,v0))); 
neq17 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq18 := k(k(v3,v0),k(v3,v1)); 
neq19 := k(k(v3,v0),k(v3,v2)); 
neq20 := k(k(v3,v0),k(k(v3,v1),v2)); 
neq21 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq22 := k(k(k(v3,v2),v1),v3); 
neq23 := k(k(k(v3,v2),v1),k(k(v3,v1),v2)); 
neq24 := k(k(v3,v1),k(v3,v2)); 
neq25 := k(k(v3,v1),k(k(k(v3,v1),v2),k(v3,v0))); 
neq26 := k(k(v3,v2),k(k(k(v3,v1),v2),k(v3,v0))); 
neq27 := k(k(v3,v2),k(k(v3,v1),v2)); 
neq28 := k(v3,k(k(k(v3,v1),v2),k(v3,v0))); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v2),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
