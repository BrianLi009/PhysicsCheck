...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3))); 
neq1 := k(v2,v0); 
neq2 := k(v2,k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
...
neq12 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq13 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),v1); 
neq14 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
neq15 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq16 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),v3); 
neq17 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(v2,v1)); 
neq18 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v2,v0),v0)); 
neq19 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(v3,k(k(v2,v0),v0))); 
neq20 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3))); 
neq21 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq22 := k(k(v2,v0),v1); 
neq23 := k(k(v2,v0),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
neq24 := k(k(v2,v0),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq25 := k(k(v2,v0),v3); 
neq26 := k(k(v2,v0),k(v2,v1)); 
neq27 := k(k(v2,v0),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq28 := k(k(v2,v0),k(v3,k(k(v2,v0),v0))); 
neq29 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),v0); 
neq30 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),v1); 
neq31 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
neq32 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq33 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),v3); 
neq34 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),k(v2,v1)); 
neq35 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),k(k(v2,v0),v0)); 
neq36 := k(k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3)),k(v3,k(k(v2,v0),v0))); 
neq37 := k(v0,k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq38 := k(v0,k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
neq39 := k(v0,k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq40 := k(v0,v3); 
neq41 := k(v0,k(v2,v1)); 
neq42 := k(v0,k(k(v3,k(k(v2,v0),v0)),v3)); 
neq43 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq44 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),v1); 
neq45 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq46 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),v3); 
neq47 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq48 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v0)); 
neq49 := k(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(v3,k(k(v2,v0),v0))); 
neq50 := k(v1,k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1))); 
neq51 := k(v1,k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq52 := k(v1,k(k(v3,k(k(v2,v0),v0)),v3)); 
neq53 := k(v1,k(k(v2,v0),v0)); 
neq54 := k(v1,k(v3,k(k(v2,v0),v0))); 
neq55 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),v3); 
neq56 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq57 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(k(v2,v0),v0)); 
neq58 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v3,k(k(v2,v0),v0))); 
neq59 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),v3); 
neq60 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)); 
neq61 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq62 := k(v3,k(v2,v1)); 
neq63 := k(v3,k(k(v2,v0),v0)); 
neq64 := k(k(v2,v1),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq65 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq66 := k(k(v2,v1),k(v3,k(k(v2,v0),v0))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(k(k(v3,k(k(v2,v0),v0)),v3),v2),k(k(v3,k(k(v2,v0),v0)),v3))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
