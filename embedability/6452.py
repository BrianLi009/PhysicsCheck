...
def test_embed(): 
    ...
    s.add(((z_1*x_10-x_1*z_10)*z_12-(x_1*y_10-y_1*x_10)*y_12)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_12-(y_1*z_10-z_1*y_10)*z_12)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_12-(z_1*x_10-x_1*z_10)*x_12)==0) 
