...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq1 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq2 := k(k(v2,k(v0,v1)),v0); 
neq3 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))); 
neq4 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1))); 
neq5 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq6 := k(k(v2,k(v0,v1)),v1); 
neq7 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq8 := k(k(v2,k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)); 
neq9 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq10 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))); 
neq13 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1))); 
neq14 := k(v2,k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
...
neq19 := k(v2,k(v0,v1)); 
neq20 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq21 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))); 
neq22 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
neq23 := k(k(k(k(v2,v1),v2),v0),k(k(k(v2,v1),v2),k(v0,v1))); 
neq24 := k(k(k(k(v2,v1),v2),v0),v1); 
neq25 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq26 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)); 
neq27 := k(k(k(k(v2,v1),v2),v0),k(v0,v1)); 
neq28 := k(k(v2,v1),v0); 
neq29 := k(k(v2,v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))); 
neq30 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1))); 
neq31 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
neq32 := k(k(v2,v1),k(k(k(v2,v1),v2),k(v0,v1))); 
neq33 := k(k(v2,v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq34 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)); 
neq35 := k(k(v2,v1),k(v0,v1)); 
neq36 := k(v0,k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))); 
neq37 := k(v0,k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1))); 
neq38 := k(v0,k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
...
neq43 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
neq44 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1)),v1); 
neq45 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq46 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)); 
neq47 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1)),k(k(v2,v1),v2)); 
neq48 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)))); 
neq49 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq50 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),v1); 
neq51 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq52 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(v0,v1)); 
neq53 := k(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(k(v2,v1),v2)); 
neq54 := k(k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))),k(k(k(v2,v1),v2),k(v0,v1))); 
neq55 := k(k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))),v1); 
neq56 := k(k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))),k(v0,v1)); 
neq57 := k(k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq58 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq59 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)); 
neq60 := k(v1,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))),k(v2,k(v0,v1))) = 0 and 
       d(k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
