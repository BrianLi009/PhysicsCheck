...
def test_embed(): 
    ...
    s.add(((z_11*x_13-x_11*z_13)*z_12-(x_11*y_13-y_11*x_13)*y_12)==0) 
    s.add(((x_11*y_13-y_11*x_13)*x_12-(y_11*z_13-z_11*y_13)*z_12)==0) 
    s.add(((y_11*z_13-z_11*y_13)*y_12-(z_11*x_13-x_11*z_13)*x_12)==0) 
