...
def test_embed(): 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_8-(x_1*y_12-y_1*x_12)*y_8)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_8-(y_1*z_12-z_1*y_12)*z_8)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_8-(z_1*x_12-x_1*z_12)*x_8)==0) 
    ...
    s.add(((z_3*x_11-x_3*z_11)*z_10-(x_3*y_11-y_3*x_11)*y_10)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_10-(y_3*z_11-z_3*y_11)*z_10)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_10-(z_3*x_11-x_3*z_11)*x_10)==0) 
    s.add(((z_4*x_8-x_4*z_8)*z_9-(x_4*y_8-y_4*x_8)*y_9)==0) 
    s.add(((x_4*y_8-y_4*x_8)*x_9-(y_4*z_8-z_4*y_8)*z_9)==0) 
    s.add(((y_4*z_8-z_4*y_8)*y_9-(z_4*x_8-x_4*z_8)*x_9)==0) 
