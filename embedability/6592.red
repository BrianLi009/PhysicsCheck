...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v0,k(v3,k(v0,v1))); 
neq1 := k(v0,k(v3,v1)); 
neq2 := k(v0,v2); 
neq3 := k(v0,k(k(v3,v2),v2)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq6 := k(v0,k(k(v3,v1),v2)); 
neq7 := k(v0,k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq8 := k(v0,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq9 := k(v0,k(v3,v2)); 
neq10 := k(k(v0,v1),k(v3,v1)); 
neq11 := k(k(v0,v1),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0)); 
neq12 := k(k(v0,v1),v2); 
neq13 := k(k(v0,v1),k(k(v3,v2),v2)); 
neq14 := k(k(v0,v1),v3); 
neq15 := k(k(v0,v1),k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq16 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq17 := k(k(v0,v1),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq18 := k(k(v0,v1),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq19 := k(k(v0,v1),k(v3,v2)); 
neq20 := k(v1,k(v3,k(v0,v1))); 
neq21 := k(v1,k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0)); 
neq22 := k(v1,v2); 
neq23 := k(v1,k(k(v3,v2),v2)); 
neq24 := k(v1,v3); 
neq25 := k(v1,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq26 := k(v1,k(k(v3,v1),v2)); 
neq27 := k(v1,k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq28 := k(v1,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq29 := k(v1,k(v3,v2)); 
neq30 := k(k(v3,k(v0,v1)),k(v3,v1)); 
neq31 := k(k(v3,k(v0,v1)),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0)); 
neq32 := k(k(v3,k(v0,v1)),v2); 
neq33 := k(k(v3,k(v0,v1)),k(k(v3,v2),v2)); 
neq34 := k(k(v3,k(v0,v1)),k(k(v3,v1),v2)); 
neq35 := k(k(v3,k(v0,v1)),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq36 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq37 := k(k(v3,k(v0,v1)),k(v3,v2)); 
neq38 := k(k(v3,v1),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0)); 
neq39 := k(k(v3,v1),v2); 
neq40 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq41 := k(k(v3,v1),k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq42 := k(k(v3,v1),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq43 := k(k(v3,v1),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq44 := k(k(v3,v1),k(v3,v2)); 
neq45 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),v2); 
neq46 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),k(k(v3,v2),v2)); 
neq47 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),v3); 
neq48 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq49 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),k(k(v3,v1),v2)); 
neq50 := k(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0),k(v3,v2)); 
neq51 := k(v2,v3); 
neq52 := k(v2,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq53 := k(v2,k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq54 := k(v2,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq55 := k(k(k(v3,v2),v2),v3); 
neq56 := k(k(k(v3,v2),v2),k(k(v3,v1),v2)); 
neq57 := k(k(k(v3,v2),v2),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq58 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq59 := k(v3,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq60 := k(v3,k(k(v3,v1),v2)); 
neq61 := k(v3,k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq62 := k(v3,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2))); 
neq63 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)); 
neq64 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq65 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(v3,v2)); 
neq66 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2))); 
neq67 := k(k(k(v3,v1),v2),k(v3,v2)); 
neq68 := k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),k(v3,v2)),k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(v3,v1),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
