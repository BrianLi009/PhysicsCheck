...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_12-(x_0*y_10-y_0*x_10)*y_12)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_12-(y_0*z_10-z_0*y_10)*z_12)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_12-(z_0*x_10-x_0*z_10)*x_12)==0) 
