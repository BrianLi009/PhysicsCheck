...
neq21 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
...
neq28 := k(k(k(k(v3,v2),k(v0,v1)),k(v3,v2)),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
...
neq43 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(v2,k(v0,v1))); 
neq44 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(v2,v0)); 
neq45 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(v0,v1)); 
...
neq52 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq53 := k(k(v2,k(v0,v1)),v1); 
neq54 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq55 := k(k(v2,v0),k(k(k(k(v3,v2),k(v0,v1)),k(v3,v2)),k(v2,k(v0,v1)))); 
neq56 := k(k(v2,v0),k(v0,v1)); 
neq57 := k(k(v2,v0),v1); 
neq58 := k(k(v2,v0),k(v3,v2)); 
neq59 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(k(v3,v2),k(v0,v1)),k(v3,v2)),k(v2,k(v0,v1)))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v2),k(v0,v1)),k(v3,v2)),k(v2,k(v0,v1))),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
