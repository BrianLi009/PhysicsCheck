...
def test_embed(): 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_11-(x_4*y_10-y_4*x_10)*y_11)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_11-(y_4*z_10-z_4*y_10)*z_11)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_11-(z_4*x_10-x_4*z_10)*x_11)==0) 
