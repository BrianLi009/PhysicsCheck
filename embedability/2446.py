...
def test_embed(): 
    ...
    s.add(((z_3*x_9-x_3*z_9)*z_12-(x_3*y_9-y_3*x_9)*y_12)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_12-(y_3*z_9-z_3*y_9)*z_12)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_12-(z_3*x_9-x_3*z_9)*x_12)==0) 
    s.add(((z_4*x_7-x_4*z_7)*z_11-(x_4*y_7-y_4*x_7)*y_11)==0) 
    s.add(((x_4*y_7-y_4*x_7)*x_11-(y_4*z_7-z_4*y_7)*z_11)==0) 
    s.add(((y_4*z_7-z_4*y_7)*y_11-(z_4*x_7-x_4*z_7)*x_11)==0) 
