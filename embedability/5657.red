...
v3c1 := 0;
neq0 := k(v2,v0); 
neq1 := k(v2,k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)))); 
neq2 := k(v2,v3); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq5 := k(v2,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq6 := k(v2,k(v3,v0)); 
neq7 := k(v2,k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq8 := k(v2,k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq9 := k(v2,k(k(k(v3,v0),v2),v1)); 
neq10 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(v3,v2)); 
neq11 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),v0); 
neq12 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),v3); 
neq13 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(v3,v0),v2)); 
neq14 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),v1); 
neq15 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq16 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq17 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(v3,v0)); 
neq18 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq19 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(k(v3,v0),v2),v1)); 
neq20 := k(k(v3,v2),v0); 
neq21 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)))); 
neq22 := k(k(v3,v2),k(k(v3,v0),v2)); 
neq23 := k(k(v3,v2),v1); 
neq24 := k(k(v3,v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq25 := k(k(v3,v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq26 := k(k(v3,v2),k(v3,v0)); 
neq27 := k(k(v3,v2),k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq28 := k(k(v3,v2),k(k(k(v3,v0),v2),v1)); 
neq29 := k(v0,k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)))); 
neq30 := k(v0,k(k(v3,v0),v2)); 
neq31 := k(v0,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq32 := k(v0,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq33 := k(v0,k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq34 := k(v0,k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq35 := k(v0,k(k(k(v3,v0),v2),v1)); 
neq36 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),v3); 
neq37 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),k(k(v3,v0),v2)); 
neq38 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),v1); 
neq39 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq40 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),k(v3,v0)); 
neq41 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq42 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))),k(k(k(v3,v0),v2),v1)); 
neq43 := k(v3,k(k(v3,v0),v2)); 
neq44 := k(v3,v1); 
neq45 := k(v3,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq46 := k(v3,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq47 := k(v3,k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq48 := k(v3,k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq49 := k(v3,k(k(k(v3,v0),v2),v1)); 
neq50 := k(k(k(v3,v0),v2),v1); 
neq51 := k(k(k(v3,v0),v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq52 := k(k(k(v3,v0),v2),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq53 := k(k(k(v3,v0),v2),k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq54 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq55 := k(v1,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1))); 
neq56 := k(v1,k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq57 := k(v1,k(v3,v0)); 
neq58 := k(v1,k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq59 := k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0))); 
neq60 := k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)),k(v3,v0)); 
neq61 := k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)),k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq62 := k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),k(k(k(v3,v0),v2),v1)); 
neq63 := k(k(v3,v0),k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1)); 
neq64 := k(k(v3,v0),k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq65 := k(k(v3,v0),k(k(k(v3,v0),v2),v1)); 
neq66 := k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(v3,v0),v2),v1),k(v3,v2))); 
neq67 := k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(v3,v0),v2),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),v2),k(k(k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(k(v3,v0),v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
