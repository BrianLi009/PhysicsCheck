...
def test_embed(): 
    ...
    s.add(((z_9*x_12-x_9*z_12)*z_0-(x_9*y_12-y_9*x_12)*y_0)==0) 
    s.add(((x_9*y_12-y_9*x_12)*x_0-(y_9*z_12-z_9*y_12)*z_0)==0) 
    s.add(((y_9*z_12-z_9*y_12)*y_0-(z_9*x_12-x_9*z_12)*x_0)==0) 
    ...
    s.add(((z_10*x_13-x_10*z_13)*z_2-(x_10*y_13-y_10*x_13)*y_2)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_2-(y_10*z_13-z_10*y_13)*z_2)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_2-(z_10*x_13-x_10*z_13)*x_2)==0) 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_5-(x_3*y_10-y_3*x_10)*y_5)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_5-(y_3*z_10-z_3*y_10)*z_5)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_5-(z_3*x_10-x_3*z_10)*x_5)==0) 
    s.add(((z_4*x_11-x_4*z_11)*z_6-(x_4*y_11-y_4*x_11)*y_6)==0) 
    s.add(((x_4*y_11-y_4*x_11)*x_6-(y_4*z_11-z_4*y_11)*z_6)==0) 
    s.add(((y_4*z_11-z_4*y_11)*y_6-(z_4*x_11-x_4*z_11)*x_6)==0) 
    ...
    s.add(((z_6*x_7-x_6*z_7)*z_8-(x_6*y_7-y_6*x_7)*y_8)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_8-(y_6*z_7-z_6*y_7)*z_8)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_8-(z_6*x_7-x_6*z_7)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_9 == 0) 
