...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(v2,k(k(k(v3,v0),v2),k(v0,v1))); 
neq1 := k(v2,k(v3,v0)); 
neq2 := k(v2,k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1)); 
neq3 := k(v2,k(v0,v1)); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2))); 
neq6 := k(v2,k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq7 := k(v2,k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq8 := k(v2,v3); 
neq9 := k(v2,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq10 := k(k(k(k(v3,v0),v2),v2),k(k(k(v3,v0),v2),k(v0,v1))); 
neq11 := k(k(k(k(v3,v0),v2),v2),k(v3,v0)); 
neq12 := k(k(k(k(v3,v0),v2),v2),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1)); 
neq13 := k(k(k(k(v3,v0),v2),v2),k(v0,v1)); 
neq14 := k(k(k(k(v3,v0),v2),v2),v0); 
neq15 := k(k(k(k(v3,v0),v2),v2),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq16 := k(k(k(k(v3,v0),v2),v2),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq17 := k(k(k(k(v3,v0),v2),v2),v3); 
neq18 := k(k(k(k(v3,v0),v2),v2),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq19 := k(k(k(k(v3,v0),v2),v2),v1); 
neq20 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,v0)); 
neq21 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1)); 
neq22 := k(k(k(k(v3,v0),v2),k(v0,v1)),v0); 
neq23 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2))); 
neq24 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq25 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq26 := k(k(k(k(v3,v0),v2),k(v0,v1)),v3); 
neq27 := k(k(k(k(v3,v0),v2),k(v0,v1)),v1); 
neq28 := k(k(v3,v0),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1)); 
neq29 := k(k(v3,v0),k(v0,v1)); 
neq30 := k(k(v3,v0),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2))); 
neq31 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq32 := k(k(v3,v0),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq33 := k(k(v3,v0),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq34 := k(k(v3,v0),v1); 
neq35 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(v0,v1)); 
neq36 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v0); 
neq37 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq38 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq39 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3); 
neq40 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(v3,v0),v2)); 
neq41 := k(k(v0,v1),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2))); 
neq42 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq43 := k(k(v0,v1),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq44 := k(k(v0,v1),v3); 
neq45 := k(k(v0,v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq46 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq47 := k(v0,k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2))); 
neq48 := k(v0,k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)); 
neq49 := k(v0,k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq50 := k(v0,v3); 
neq51 := k(v0,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq52 := k(v0,k(k(v3,v0),v2)); 
neq53 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3)); 
neq54 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3); 
neq55 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq56 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v1); 
neq57 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),k(k(v3,v0),v2)); 
neq58 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq59 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3),v1); 
neq60 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3),k(k(v3,v0),v2)); 
neq61 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3),v1); 
neq62 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3),k(k(v3,v0),v2)); 
neq63 := k(v3,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq64 := k(v3,v1); 
neq65 := k(v3,k(k(v3,v0),v2)); 
neq66 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1); 
neq67 := k(v1,k(k(v3,v0),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v3),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),v2)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
