...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_10-(x_1*y_11-y_1*x_11)*y_10)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_10-(y_1*z_11-z_1*y_11)*z_10)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_10-(z_1*x_11-x_1*z_11)*x_10)==0) 
    s.add(((z_2*x_6-x_2*z_6)*z_9-(x_2*y_6-y_2*x_6)*y_9)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_9-(y_2*z_6-z_2*y_6)*z_9)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_9-(z_2*x_6-x_2*z_6)*x_9)==0) 
