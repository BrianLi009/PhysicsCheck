...
def test_embed(): 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_11-(x_9*y_10-y_9*x_10)*y_11)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_11-(y_9*z_10-z_9*y_10)*z_11)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_11-(z_9*x_10-x_9*z_10)*x_11)==0) 
    ...
    s.add(((z_2*x_9-x_2*z_9)*z_6-(x_2*y_9-y_2*x_9)*y_6)==0) 
    s.add(((x_2*y_9-y_2*x_9)*x_6-(y_2*z_9-z_2*y_9)*z_6)==0) 
    s.add(((y_2*z_9-z_2*y_9)*y_6-(z_2*x_9-x_2*z_9)*x_6)==0) 
