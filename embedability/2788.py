...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_3-(x_0*y_13-y_0*x_13)*y_3)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_3-(y_0*z_13-z_0*y_13)*z_3)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_3-(z_0*x_13-x_0*z_13)*x_3)==0) 
    s.add(((z_12*x_13-x_12*z_13)*z_1-(x_12*y_13-y_12*x_13)*y_1)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_1-(y_12*z_13-z_12*y_13)*z_1)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_1-(z_12*x_13-x_12*z_13)*x_1)==0) 
    s.add(((z_1*x_11-x_1*z_11)*z_2-(x_1*y_11-y_1*x_11)*y_2)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_2-(y_1*z_11-z_1*y_11)*z_2)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_2-(z_1*x_11-x_1*z_11)*x_2)==0) 
    ...
    s.add(((z_4*x_9-x_4*z_9)*z_5-(x_4*y_9-y_4*x_9)*y_5)==0) 
    s.add(((x_4*y_9-y_4*x_9)*x_5-(y_4*z_9-z_4*y_9)*z_5)==0) 
    s.add(((y_4*z_9-z_4*y_9)*y_5-(z_4*x_9-x_4*z_9)*x_5)==0) 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_7-(x_8*y_10-y_8*x_10)*y_7)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_7-(y_8*z_10-z_8*y_10)*z_7)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_7-(z_8*x_10-x_8*z_10)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
