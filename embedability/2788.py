...
def test_embed(): 
    ...
    s.add(((z_5*x_7-x_5*z_7)*z_10-(x_5*y_7-y_5*x_7)*y_10)==0) 
    s.add(((x_5*y_7-y_5*x_7)*x_10-(y_5*z_7-z_5*y_7)*z_10)==0) 
    s.add(((y_5*z_7-z_5*y_7)*y_10-(z_5*x_7-x_5*z_7)*x_10)==0) 
    s.add(((z_2*x_6-x_2*z_6)*z_11-(x_2*y_6-y_2*x_6)*y_11)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_11-(y_2*z_6-z_2*y_6)*z_11)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_11-(z_2*x_6-x_2*z_6)*x_11)==0) 
