...
def test_embed(): 
    ...
    s.add(((z_2*x_11-x_2*z_11)*z_9-(x_2*y_11-y_2*x_11)*y_9)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_9-(y_2*z_11-z_2*y_11)*z_9)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_9-(z_2*x_11-x_2*z_11)*x_9)==0) 
    s.add(((z_3*x_11-x_3*z_11)*z_4-(x_3*y_11-y_3*x_11)*y_4)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_4-(y_3*z_11-z_3*y_11)*z_4)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_4-(z_3*x_11-x_3*z_11)*x_4)==0) 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_6-(x_7*y_11-y_7*x_11)*y_6)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_6-(y_7*z_11-z_7*y_11)*z_6)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_6-(z_7*x_11-x_7*z_11)*x_6)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
