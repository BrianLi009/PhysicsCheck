...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v3,v0),v2); 
neq1 := k(k(v3,v0),k(v2,v0)); 
neq2 := k(k(v3,v0),k(k(k(v3,v1),v2),k(v3,v1))); 
neq3 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)); 
neq4 := k(k(v3,v0),k(k(v3,v1),v2)); 
neq5 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq6 := k(k(v3,v0),v1); 
neq7 := k(k(v3,v0),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq8 := k(k(v3,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq9 := k(k(v3,v0),k(v3,v1)); 
neq10 := k(v2,v0); 
neq11 := k(v2,k(k(k(v3,v1),v2),k(v3,v1))); 
neq12 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)); 
neq13 := k(v2,v3); 
neq14 := k(v2,k(k(v3,v0),v3)); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq17 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq18 := k(v2,k(v3,v1)); 
neq19 := k(k(v2,v0),k(k(k(v3,v1),v2),k(v3,v1))); 
neq20 := k(k(v2,v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)); 
neq21 := k(k(v2,v0),v3); 
neq22 := k(k(v2,v0),k(k(v3,v0),v3)); 
neq23 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq24 := k(k(v2,v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq25 := k(k(v2,v0),v1); 
neq26 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq27 := k(k(v2,v0),k(v3,v1)); 
neq28 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq29 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(k(v3,v0),v3)); 
neq32 := k(v0,k(k(v3,v1),v2)); 
neq33 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq34 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq35 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq36 := k(v0,k(v3,v1)); 
neq37 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)); 
neq38 := k(k(k(k(v3,v1),v2),k(v3,v1)),v3); 
neq39 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v0),v3)); 
neq40 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq41 := k(k(k(k(v3,v1),v2),k(v3,v1)),v1); 
neq42 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq43 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1),v3); 
neq44 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1),k(k(v3,v0),v3)); 
neq45 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1),k(k(v3,v1),v2)); 
neq46 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq47 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1),k(v3,v1)); 
neq48 := k(v3,k(k(v3,v1),v2)); 
neq49 := k(v3,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq50 := k(v3,v1); 
neq51 := k(v3,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq52 := k(v3,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq53 := k(k(k(v3,v0),v3),k(k(v3,v1),v2)); 
neq54 := k(k(k(v3,v0),v3),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq55 := k(k(k(v3,v0),v3),v1); 
neq56 := k(k(k(v3,v0),v3),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq57 := k(k(k(v3,v0),v3),k(v3,v1)); 
neq58 := k(k(k(v3,v1),v2),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2)); 
neq59 := k(k(k(v3,v1),v2),v1); 
neq60 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq61 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq62 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2),v1); 
neq63 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq64 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2),k(v3,v1)); 
neq65 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq66 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3))); 
neq67 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(v3,v1)); 
neq68 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),k(v3,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v2),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v3)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
