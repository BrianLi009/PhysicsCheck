...
neq6 := k(v2,k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(v3,v2)))); 
...
neq22 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v1),v1),k(v2,v0))); 
neq23 := k(k(k(v3,v2),v3),k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq24 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq25 := k(k(k(v3,v2),v3),k(k(v3,v2),v1)); 
neq26 := k(k(k(v3,v2),v3),v1); 
neq27 := k(v3,k(k(k(v3,v2),v1),v1)); 
neq28 := k(v3,k(v2,v1)); 
neq29 := k(v3,k(k(k(k(v3,v2),v1),v1),k(v2,v0))); 
neq30 := k(v3,k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq31 := k(v3,k(v2,v0)); 
...
neq41 := k(k(v2,v1),v0); 
neq42 := k(k(v2,v1),k(k(k(k(v3,v2),v1),v1),k(v2,v0))); 
neq43 := k(k(v2,v1),k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(v3,v2)))); 
...
neq51 := k(v0,k(v3,v2)); 
neq52 := k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v1))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,v2),v3),k(v2,v1)),k(k(k(k(k(v3,v2),v1),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(v3,v2)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
