...
neq4 := k(v2,v3); 
neq5 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))); 
neq6 := k(v2,k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(v3,k(v2,v0))); 
neq9 := k(k(k(v2,v0),v2),k(k(v2,v0),v0)); 
neq10 := k(k(k(v2,v0),v2),v0); 
neq11 := k(k(k(v2,v0),v2),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq12 := k(k(k(v2,v0),v2),k(k(v3,k(v2,v0)),v3)); 
neq13 := k(k(k(v2,v0),v2),v3); 
neq14 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq15 := k(k(k(v2,v0),v2),k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq16 := k(k(k(v2,v0),v2),v1); 
neq17 := k(k(k(v2,v0),v2),k(v3,k(v2,v0))); 
neq18 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq19 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),v3)); 
neq20 := k(k(k(v2,v0),v0),v3); 
neq21 := k(k(k(v2,v0),v0),k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))); 
neq22 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq23 := k(k(k(v2,v0),v0),v1); 
neq24 := k(k(k(v2,v0),v0),k(v3,k(v2,v0))); 
neq25 := k(v0,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq26 := k(v0,k(k(v3,k(v2,v0)),v3)); 
neq27 := k(v0,v3); 
neq28 := k(v0,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))); 
neq29 := k(v0,k(v2,v1)); 
neq30 := k(v0,k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq31 := k(v0,k(v3,k(v2,v0))); 
neq32 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v3,k(v2,v0)),v3)); 
neq33 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v3); 
neq34 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq35 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq36 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq37 := k(k(k(v3,k(v2,v0)),v3),k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))); 
neq38 := k(k(k(v3,k(v2,v0)),v3),k(v2,v1)); 
neq39 := k(k(k(v3,k(v2,v0)),v3),v1); 
neq40 := k(k(k(v3,k(v2,v0)),v3),k(v2,v0)); 
neq41 := k(v3,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))); 
neq42 := k(v3,k(v2,v1)); 
neq43 := k(v3,k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq44 := k(v3,k(v2,v0)); 
neq45 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2)),k(v2,v1)); 
neq46 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2)),v1); 
neq47 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2)),k(v3,k(v2,v0))); 
neq48 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2)),k(v2,v0)); 
neq49 := k(k(v2,v1),k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0))); 
neq50 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq51 := k(k(v2,v1),k(v2,v0)); 
neq52 := k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0)),v1); 
neq53 := k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0)),k(v3,k(v2,v0))); 
neq54 := k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0)),k(v2,v0)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,k(v2,v0)),v3),k(k(v2,v0),v0)),k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
