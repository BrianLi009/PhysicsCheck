...
def test_embed(): 
    ...
    s.add(((z_0*x_12-x_0*z_12)*z_4-(x_0*y_12-y_0*x_12)*y_4)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_4-(y_0*z_12-z_0*y_12)*z_4)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_4-(z_0*x_12-x_0*z_12)*x_4)==0) 
    ...
    s.add(((z_1*x_8-x_1*z_8)*z_2-(x_1*y_8-y_1*x_8)*y_2)==0) 
    s.add(((x_1*y_8-y_1*x_8)*x_2-(y_1*z_8-z_1*y_8)*z_2)==0) 
    s.add(((y_1*z_8-z_1*y_8)*y_2-(z_1*x_8-x_1*z_8)*x_2)==0) 
