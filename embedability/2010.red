...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(v0,v1)); 
neq1 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v2); 
neq2 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v0); 
neq3 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(v2,v1)); 
neq4 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3); 
neq5 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)); 
neq6 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(v3,v0)); 
neq7 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq8 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(v3,v0),v2)); 
neq9 := k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),k(k(k(v3,v0),v2),k(v0,v1))); 
neq10 := k(k(v0,v1),v2); 
neq11 := k(k(v0,v1),k(v2,v1)); 
neq12 := k(k(v0,v1),v3); 
neq13 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)); 
neq14 := k(k(v0,v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq15 := k(k(v0,v1),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3)); 
neq16 := k(k(v0,v1),k(v3,v0)); 
neq17 := k(k(v0,v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq18 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq19 := k(v2,v0); 
neq20 := k(v2,v3); 
neq21 := k(v2,k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)); 
neq22 := k(v2,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq23 := k(v2,k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3)); 
neq24 := k(v2,k(v3,v0)); 
neq25 := k(v2,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq26 := k(v2,k(k(k(v3,v0),v2),k(v0,v1))); 
neq27 := k(v0,k(v2,v1)); 
neq28 := k(v0,v3); 
neq29 := k(v0,k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)); 
neq30 := k(v0,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq31 := k(v0,k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3)); 
neq32 := k(v0,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq33 := k(v0,k(k(v3,v0),v2)); 
neq34 := k(v0,k(k(k(v3,v0),v2),k(v0,v1))); 
neq35 := k(k(v2,v1),v3); 
neq36 := k(k(v2,v1),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)); 
neq37 := k(k(v2,v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq38 := k(k(v2,v1),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3)); 
neq39 := k(k(v2,v1),k(v3,v0)); 
neq40 := k(k(v2,v1),k(k(v3,v0),v2)); 
neq41 := k(k(v2,v1),k(k(k(v3,v0),v2),k(v0,v1))); 
neq42 := k(v3,k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq43 := k(v3,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq44 := k(v3,k(k(v3,v0),v2)); 
neq45 := k(v3,k(k(k(v3,v0),v2),k(v0,v1))); 
neq46 := k(v3,v1); 
neq47 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3),k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2))); 
neq48 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3),k(v3,v0)); 
neq49 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3),k(k(v3,v0),v2)); 
neq50 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3),k(k(k(v3,v0),v2),k(v0,v1))); 
neq51 := k(k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3),v1); 
neq52 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3)); 
neq53 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),k(v3,v0)); 
neq54 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq55 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1); 
neq56 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),k(v3,v0)); 
neq57 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq58 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),k(k(v3,v0),v2)); 
neq59 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),k(k(k(v3,v0),v2),k(v0,v1))); 
neq60 := k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v1); 
neq61 := k(k(v3,v0),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq62 := k(k(v3,v0),k(k(k(v3,v0),v2),k(v0,v1))); 
neq63 := k(k(v3,v0),v1); 
neq64 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v3,v0),v2)); 
neq65 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),v1); 
neq66 := k(k(k(v3,v0),v2),v1); 
neq67 := k(k(k(k(v3,v0),v2),k(v0,v1)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,v0),v2)),v1),v3),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
