...
neq1 := k(v2,v0); 
neq2 := k(v2,k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq3 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)); 
...
neq9 := k(v2,v1); 
neq10 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(v3,v2)); 
neq11 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(v2,v1)); 
neq12 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),v0); 
neq13 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq14 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(k(v3,v2),v3),k(v2,v1))); 
neq15 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq16 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(k(v3,v2),v3),v0)); 
neq17 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),v3); 
neq18 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(v3,v2),v3)); 
neq19 := k(k(k(k(k(k(v3,v2),v3),v0),v0),v2),v1); 
neq20 := k(k(k(k(k(v3,v2),v3),v0),v0),k(v3,v2)); 
neq21 := k(k(k(k(k(v3,v2),v3),v0),v0),k(v2,v1)); 
neq22 := k(k(k(k(k(v3,v2),v3),v0),v0),k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq23 := k(k(k(k(k(v3,v2),v3),v0),v0),k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)); 
neq24 := k(k(k(k(k(v3,v2),v3),v0),v0),k(k(k(v3,v2),v3),k(v2,v1))); 
neq25 := k(k(k(k(k(v3,v2),v3),v0),v0),k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq26 := k(k(k(k(k(v3,v2),v3),v0),v0),v3); 
neq27 := k(k(k(k(k(v3,v2),v3),v0),v0),k(k(v3,v2),v3)); 
neq28 := k(k(k(k(k(v3,v2),v3),v0),v0),v1); 
neq29 := k(k(v3,v2),k(v2,v1)); 
neq30 := k(k(v3,v2),v0); 
neq31 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq32 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)); 
neq33 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v2,v1))); 
neq34 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq35 := k(k(v3,v2),k(k(k(v3,v2),v3),v0)); 
neq36 := k(k(v3,v2),v1); 
neq37 := k(k(v2,v1),v0); 
neq38 := k(k(v2,v1),k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq39 := k(k(v2,v1),k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)); 
neq40 := k(k(v2,v1),k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq41 := k(k(v2,v1),k(k(k(v3,v2),v3),v0)); 
neq42 := k(k(v2,v1),v3); 
neq43 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq44 := k(v0,k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1)); 
neq45 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)); 
neq46 := k(v0,k(k(k(v3,v2),v3),k(v2,v1))); 
neq47 := k(v0,k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq48 := k(v0,v3); 
neq49 := k(v0,k(k(v3,v2),v3)); 
neq50 := k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),k(v2,v1))); 
neq51 := k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)); 
neq52 := k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v3); 
neq53 := k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),k(k(v3,v2),v3)); 
neq54 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1),k(k(k(v3,v2),v3),k(v2,v1))); 
neq55 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1),k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3))); 
neq56 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1),k(k(k(v3,v2),v3),v0)); 
neq57 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1),v3); 
neq58 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1),k(k(v3,v2),v3)); 
neq59 := k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(k(v3,v2),v3),v0)); 
neq60 := k(k(k(k(v3,v2),v3),k(v2,v1)),v3); 
neq61 := k(k(k(k(v3,v2),v3),k(v2,v1)),v1); 
neq62 := k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),k(k(k(v3,v2),v3),v0)); 
neq63 := k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v3); 
neq64 := k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v2),v3),v0),v0),v2),k(k(k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v3)),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
