...
def test_embed(): 
    ...
    s.add(((z_2*x_4-x_2*z_4)*z_9-(x_2*y_4-y_2*x_4)*y_9)==0) 
    s.add(((x_2*y_4-y_2*x_4)*x_9-(y_2*z_4-z_2*y_4)*z_9)==0) 
    s.add(((y_2*z_4-z_2*y_4)*y_9-(z_2*x_4-x_2*z_4)*x_9)==0) 
    s.add(((z_0*x_3-x_0*z_3)*z_10-(x_0*y_3-y_0*x_3)*y_10)==0) 
    s.add(((x_0*y_3-y_0*x_3)*x_10-(y_0*z_3-z_0*y_3)*z_10)==0) 
    s.add(((y_0*z_3-z_0*y_3)*y_10-(z_0*x_3-x_0*z_3)*x_10)==0) 
    ...
    s.add(((z_4*x_5-x_4*z_5)*z_13-(x_4*y_5-y_4*x_5)*y_13)==0) 
    s.add(((x_4*y_5-y_4*x_5)*x_13-(y_4*z_5-z_4*y_5)*z_13)==0) 
    s.add(((y_4*z_5-z_4*y_5)*y_13-(z_4*x_5-x_4*z_5)*x_13)==0) 
    s.add(x_4 == 0) 
    s.add(y_4 == 0) 
    s.add(z_4 == 1) 
    s.add(x_5 == 0) 
