...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_10-(x_0*y_13-y_0*x_13)*y_10)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_10-(y_0*z_13-z_0*y_13)*z_10)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_10-(z_0*x_13-x_0*z_13)*x_10)==0) 
    s.add(((z_1*x_10-x_1*z_10)*z_3-(x_1*y_10-y_1*x_10)*y_3)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_3-(y_1*z_10-z_1*y_10)*z_3)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_3-(z_1*x_10-x_1*z_10)*x_3)==0) 
    ...
    s.add(((z_1*x_2-x_1*z_2)*z_11-(x_1*y_2-y_1*x_2)*y_11)==0) 
    s.add(((x_1*y_2-y_1*x_2)*x_11-(y_1*z_2-z_1*y_2)*z_11)==0) 
    s.add(((y_1*z_2-z_1*y_2)*y_11-(z_1*x_2-x_1*z_2)*x_11)==0) 
