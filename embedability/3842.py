...
def test_embed(): 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_12-(x_8*y_10-y_8*x_10)*y_12)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_12-(y_8*z_10-z_8*y_10)*z_12)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_12-(z_8*x_10-x_8*z_10)*x_12)==0) 
    s.add(((z_9*x_11-x_9*z_11)*z_13-(x_9*y_11-y_9*x_11)*y_13)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_13-(y_9*z_11-z_9*y_11)*z_13)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_13-(z_9*x_11-x_9*z_11)*x_13)==0) 
    ...
    s.add(((z_10*x_11-x_10*z_11)*z_2-(x_10*y_11-y_10*x_11)*y_2)==0) 
    s.add(((x_10*y_11-y_10*x_11)*x_2-(y_10*z_11-z_10*y_11)*z_2)==0) 
    s.add(((y_10*z_11-z_10*y_11)*y_2-(z_10*x_11-x_10*z_11)*x_2)==0) 
