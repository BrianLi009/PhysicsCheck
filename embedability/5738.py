...
def test_embed(): 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_7-(x_12*y_13-y_12*x_13)*y_7)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_7-(y_12*z_13-z_12*y_13)*z_7)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_7-(z_12*x_13-x_12*z_13)*x_7)==0) 
