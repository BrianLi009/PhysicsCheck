...
def test_embed(): 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_2-(x_3*y_10-y_3*x_10)*y_2)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_2-(y_3*z_10-z_3*y_10)*z_2)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_2-(z_3*x_10-x_3*z_10)*x_2)==0) 
