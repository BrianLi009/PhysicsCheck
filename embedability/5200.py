...
def test_embed(): 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_8-(x_12*y_13-y_12*x_13)*y_8)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_8-(y_12*z_13-z_12*y_13)*z_8)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_8-(z_12*x_13-x_12*z_13)*x_8)==0) 
