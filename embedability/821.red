...
neq1 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq5 := k(v2,k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1))); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(k(v3,k(k(v2,v1),v2)),v0)); 
neq8 := k(v2,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq9 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq10 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v3,k(k(v2,v1),v2))); 
neq11 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v0); 
neq12 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1); 
neq13 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq14 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1))); 
neq15 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v3); 
neq16 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(v3,k(k(v2,v1),v2)),v0)); 
neq17 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v3,v2)); 
neq18 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,v1)); 
neq19 := k(k(v3,k(k(v2,v1),v2)),v0); 
neq20 := k(k(v3,k(k(v2,v1),v2)),v1); 
neq21 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq22 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1))); 
neq23 := k(k(v3,k(k(v2,v1),v2)),k(v3,v2)); 
neq24 := k(k(v3,k(k(v2,v1),v2)),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq25 := k(k(v3,k(k(v2,v1),v2)),k(v2,v1)); 
neq26 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq27 := k(v0,k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq28 := k(v0,k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1))); 
neq29 := k(v0,v3); 
neq30 := k(v0,k(v3,v2)); 
neq31 := k(v0,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq32 := k(v0,k(v2,v1)); 
neq33 := k(v0,k(k(v2,v1),v2)); 
neq34 := k(v1,k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq35 := k(v1,k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1))); 
neq36 := k(v1,k(k(v3,k(k(v2,v1),v2)),v0)); 
neq37 := k(v1,k(v3,v2)); 
neq38 := k(v1,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq39 := k(v1,k(k(k(v2,v1),v2),v0)); 
neq40 := k(v1,k(k(v2,v1),v2)); 
neq41 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),v3); 
neq42 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(v3,k(k(v2,v1),v2)),v0)); 
neq43 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq44 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
neq45 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v2)); 
neq46 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),v3); 
neq47 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(v3,k(k(v2,v1),v2)),v0)); 
neq48 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(v3,v2)); 
neq49 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(v2,v1),v2),v0)); 
neq50 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(v2,v1),v2)); 
neq51 := k(v3,k(k(v3,k(k(v2,v1),v2)),v0)); 
neq52 := k(v3,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq53 := k(v3,k(v2,v1)); 
neq54 := k(v3,k(k(k(v2,v1),v2),v0)); 
neq55 := k(v3,k(k(v2,v1),v2)); 
neq56 := k(k(k(v3,k(k(v2,v1),v2)),v0),k(v3,v2)); 
neq57 := k(k(k(v3,k(k(v2,v1),v2)),v0),k(v2,v1)); 
neq58 := k(k(k(v3,k(k(v2,v1),v2)),v0),k(k(k(v2,v1),v2),v0)); 
neq59 := k(k(k(v3,k(k(v2,v1),v2)),v0),k(k(v2,v1),v2)); 
neq60 := k(k(v3,v2),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq61 := k(k(v3,v2),k(v2,v1)); 
neq62 := k(k(v3,v2),k(k(k(v2,v1),v2),v0)); 
neq63 := k(k(v3,v2),k(k(v2,v1),v2)); 
neq64 := k(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(v2,v1)); 
neq65 := k(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(k(v2,v1),v2),v0)); 
neq66 := k(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq67 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(v3,k(k(v2,v1),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
