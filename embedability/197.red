...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0))); 
...
neq8 := k(v2,v3); 
neq9 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(k(v2,v0),v0)); 
neq10 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),v0); 
neq11 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(k(v2,v1),v2)); 
neq12 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(v2,v1)); 
neq13 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(v3,k(k(v2,v0),v0))); 
neq14 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),v1); 
neq15 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(v3,k(k(v2,v1),v2))); 
neq16 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),v3); 
neq17 := k(k(k(v2,v0),v0),k(k(v3,k(k(v2,v1),v2)),k(v2,v0))); 
...
neq22 := k(k(k(v2,v0),v0),k(v3,k(k(v2,v1),v2))); 
neq23 := k(k(k(v2,v0),v0),v3); 
neq24 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),v0); 
neq25 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(k(v2,v1),v2)); 
neq26 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v1)); 
neq27 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq28 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v3,k(k(v2,v0),v0))); 
neq29 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),v1); 
neq30 := k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),v3); 
neq31 := k(v0,k(k(v2,v1),v2)); 
neq32 := k(v0,k(v2,v1)); 
neq33 := k(v0,k(k(v3,k(k(v2,v0),v0)),v3)); 
neq34 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq35 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq36 := k(v0,v3); 
neq37 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq38 := k(k(k(v2,v1),v2),k(v3,k(k(v2,v0),v0))); 
neq39 := k(k(k(v2,v1),v2),v1); 
neq40 := k(k(k(v2,v1),v2),v3); 
neq41 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq42 := k(k(v2,v1),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq43 := k(k(v2,v1),k(v3,k(k(v2,v0),v0))); 
neq44 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq45 := k(k(v2,v1),v3); 
neq46 := k(k(v2,v1),k(v2,v0)); 
neq47 := k(k(k(v3,k(k(v2,v0),v0)),v3),v1); 
neq48 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(v3,k(k(v2,v1),v2))); 
neq49 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v0)); 
neq50 := k(k(v3,k(k(v2,v0),v0)),v1); 
neq51 := k(k(v3,k(k(v2,v0),v0)),k(v3,k(k(v2,v1),v2))); 
neq52 := k(k(v3,k(k(v2,v0),v0)),k(v2,v0)); 
neq53 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq54 := k(v1,k(v2,v0)); 
neq55 := k(k(v3,k(k(v2,v1),v2)),k(v2,v0)); 
neq56 := k(v3,k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,k(k(v2,v1),v2)),k(v2,v0)),k(v2,v0)),k(k(v3,k(k(v2,v0),v0)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
