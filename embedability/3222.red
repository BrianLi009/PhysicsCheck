...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),v2); 
neq1 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),v0); 
neq2 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),v1); 
neq3 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(v2,v0)); 
neq4 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq5 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(k(v3,v1),v2)); 
neq6 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(v3,k(v2,v0))); 
neq7 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(v3,v1)); 
neq8 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(k(k(v3,v1),v2),k(v3,v1))); 
neq9 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq10 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1)); 
neq11 := k(v2,v1); 
neq12 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq13 := k(v2,v3); 
neq14 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq15 := k(v2,k(v3,k(v2,v0))); 
neq16 := k(v2,k(v3,v1)); 
neq17 := k(v2,k(k(k(v3,v1),v2),k(v3,v1))); 
neq18 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq19 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),v0); 
neq20 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(v2,v0)); 
neq21 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),v3); 
neq22 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(k(v3,v1),v2)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq24 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(v3,k(v2,v0))); 
neq25 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(v3,v1)); 
neq26 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(k(k(v3,v1),v2),k(v3,v1))); 
neq27 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq28 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq29 := k(v0,v3); 
neq30 := k(v0,k(k(v3,v1),v2)); 
neq31 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq32 := k(v0,k(v3,k(v2,v0))); 
neq33 := k(v0,k(v3,v1)); 
neq34 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq35 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq36 := k(v1,k(v2,v0)); 
neq37 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq38 := k(v1,v3); 
...
neq43 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq44 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq45 := k(k(v2,v0),v3); 
neq46 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq47 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq48 := k(k(v2,v0),k(v3,v1)); 
neq49 := k(k(v2,v0),k(k(k(v3,v1),v2),k(v3,v1))); 
neq50 := k(k(v2,v0),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq51 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v3); 
neq52 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(v3,v1),v2)); 
neq53 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq54 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(v3,v1)); 
neq55 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))); 
neq56 := k(v3,k(k(v3,v1),v2)); 
neq57 := k(v3,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq58 := k(v3,k(k(k(v3,v1),v2),k(v3,v1))); 
neq59 := k(v3,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq60 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1)))); 
neq61 := k(k(k(v3,v1),v2),k(v3,k(v2,v0))); 
neq62 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
neq63 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),k(v3,k(v2,v0))); 
neq64 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),k(v3,v1)); 
neq65 := k(k(v3,k(v2,v0)),k(v3,v1)); 
neq66 := k(k(v3,k(v2,v0)),k(k(k(v3,v1),v2),k(v3,v1))); 
neq67 := k(k(v3,v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0)))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,k(v2,v0))),k(k(k(v3,v1),v2),k(v3,v1))),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
