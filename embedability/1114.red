...
neq7 := k(v2,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq8 := k(v2,k(v0,v1)); 
neq9 := k(v2,v1); 
neq10 := k(v3,k(k(v3,v2),v1)); 
neq11 := k(v3,k(k(k(v3,v2),v1),k(v3,v2))); 
neq12 := k(v3,v0); 
neq13 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq14 := k(v3,k(k(k(v3,v2),v2),k(v0,v1))); 
neq15 := k(v3,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq16 := k(v3,k(k(v3,v2),v2)); 
neq17 := k(v3,k(v2,v0)); 
neq18 := k(v3,v1); 
neq19 := k(k(k(v3,v2),v1),v0); 
neq20 := k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),v1)); 
neq21 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v2),k(v0,v1))); 
neq22 := k(k(k(v3,v2),v1),k(v3,k(v2,v0))); 
neq23 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq24 := k(k(k(v3,v2),v1),k(k(v3,v2),v2)); 
neq25 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq26 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq27 := k(k(k(k(v3,v2),v1),k(v3,v2)),v0); 
neq28 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v3,k(v2,v0)),v1)); 
neq29 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(v3,v2),v2),k(v0,v1))); 
neq30 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v0))); 
neq31 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v3,v2),v2)); 
neq32 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)); 
neq33 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)); 
neq34 := k(k(k(k(v3,v2),v1),k(v3,v2)),v1); 
neq35 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq36 := k(v0,k(k(k(v3,v2),v2),k(v0,v1))); 
neq37 := k(v0,k(v3,k(v2,v0))); 
neq38 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq39 := k(v0,k(k(v3,v2),v2)); 
neq40 := k(v0,k(v3,v2)); 
neq41 := k(k(k(v3,k(v2,v0)),v1),k(k(k(v3,v2),v2),k(v0,v1))); 
neq42 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq43 := k(k(k(v3,k(v2,v0)),v1),k(v0,v1)); 
neq44 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq45 := k(k(k(v3,k(v2,v0)),v1),k(v3,v2)); 
neq46 := k(k(k(k(v3,v2),v2),k(v0,v1)),k(v3,k(v2,v0))); 
neq47 := k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)); 
neq48 := k(k(k(k(v3,v2),v2),k(v0,v1)),v1); 
neq49 := k(k(k(k(v3,v2),v2),k(v0,v1)),k(v3,v2)); 
neq50 := k(k(v3,k(v2,v0)),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0))); 
neq51 := k(k(v3,k(v2,v0)),k(k(v3,v2),v2)); 
neq52 := k(k(v3,k(v2,v0)),k(v0,v1)); 
neq53 := k(k(v3,k(v2,v0)),v1); 
neq54 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq55 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)),k(k(v3,v2),v2)); 
neq56 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)),k(v0,v1)); 
neq57 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)),v1); 
neq58 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)),k(v3,v2)); 
neq59 := k(k(k(v3,v2),v2),k(v0,v1)); 
neq60 := k(k(k(v3,v2),v2),k(v2,v0)); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(v3,k(v2,v0)),v1),k(k(v3,v2),v2)) = 0 and 
       d(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v2,v0)),k(k(k(v3,v2),v2),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
