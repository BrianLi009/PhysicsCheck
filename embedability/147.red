...
v2c3 := 0;
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(v3,k(v0,v1)),k(v0,v1))); 
neq2 := k(v0,k(v3,k(v0,v1))); 
neq3 := k(v0,k(k(v3,v2),v1)); 
neq4 := k(v0,k(k(k(v3,v2),v1),v1)); 
neq5 := k(v0,k(v3,v2)); 
neq6 := k(v0,k(k(k(k(v3,v2),v1),v1),v2)); 
neq7 := k(v0,v3); 
neq8 := k(v0,k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq9 := k(v2,k(k(v3,k(v0,v1)),k(v0,v1))); 
neq10 := k(v2,k(v3,k(v0,v1))); 
neq11 := k(v2,k(k(v3,v2),v1)); 
neq12 := k(v2,k(k(k(v3,v2),v1),v1)); 
neq13 := k(v2,k(v3,v0)); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq16 := k(v2,v1); 
neq17 := k(k(k(v3,k(v0,v1)),k(v0,v1)),k(k(v3,v2),v1)); 
neq18 := k(k(k(v3,k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v1),v1)); 
neq19 := k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0)); 
neq20 := k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v2)); 
neq21 := k(k(k(v3,k(v0,v1)),k(v0,v1)),k(k(k(k(v3,v2),v1),v1),v2)); 
neq22 := k(k(k(v3,k(v0,v1)),k(v0,v1)),v3); 
neq23 := k(k(k(v3,k(v0,v1)),k(v0,v1)),v1); 
neq24 := k(k(v3,k(v0,v1)),k(k(v3,v2),v1)); 
neq25 := k(k(v3,k(v0,v1)),k(k(k(v3,v2),v1),v1)); 
neq26 := k(k(v3,k(v0,v1)),k(v3,v0)); 
neq27 := k(k(v3,k(v0,v1)),k(v3,v2)); 
neq28 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v1),v1),v2)); 
neq29 := k(k(v3,k(v0,v1)),k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq30 := k(k(v3,k(v0,v1)),v1); 
neq31 := k(k(k(v3,v2),v1),k(v3,v0)); 
neq32 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),v1),v2)); 
neq33 := k(k(k(v3,v2),v1),v3); 
neq34 := k(k(k(v3,v2),v1),k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq35 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq36 := k(k(k(k(v3,v2),v1),v1),k(v3,v0)); 
neq37 := k(k(k(k(v3,v2),v1),v1),k(v3,v2)); 
neq38 := k(k(k(k(v3,v2),v1),v1),v3); 
neq39 := k(k(k(k(v3,v2),v1),v1),k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq40 := k(k(k(k(v3,v2),v1),v1),k(v0,v1)); 
neq41 := k(k(v3,v0),k(v3,v2)); 
neq42 := k(k(v3,v0),k(k(k(k(v3,v2),v1),v1),v2)); 
neq43 := k(k(v3,v0),v1); 
neq44 := k(k(v3,v0),k(v0,v1)); 
neq45 := k(k(v3,v2),k(k(k(k(v3,v2),v1),v1),v2)); 
neq46 := k(k(v3,v2),k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq47 := k(k(v3,v2),v1); 
neq48 := k(k(v3,v2),k(v0,v1)); 
neq49 := k(k(k(k(k(v3,v2),v1),v1),v2),v3); 
neq50 := k(k(k(k(k(v3,v2),v1),v1),v2),v1); 
neq51 := k(k(k(k(k(v3,v2),v1),v1),v2),k(v0,v1)); 
neq52 := k(v3,k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0))); 
neq53 := k(v3,v1); 
neq54 := k(v3,k(v0,v1)); 
neq55 := k(k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0)),v1); 
neq56 := k(k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0)),k(v0,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(v0,v1)),k(v0,v1)),k(v3,v0)),k(k(k(k(v3,v2),v1),v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
