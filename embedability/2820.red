...
neq4 := k(v2,k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq5 := k(v2,k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(v3,k(v0,v1))); 
neq8 := k(v2,k(v0,v1)); 
neq9 := k(v2,k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq10 := k(k(v3,k(v2,k(v0,v1))),k(v2,v1)); 
neq11 := k(k(v3,k(v2,k(v0,v1))),v0); 
neq12 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,k(v0,v1)),v2)); 
neq13 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq14 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
neq15 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq16 := k(k(v3,k(v2,k(v0,v1))),k(v3,k(v0,v1))); 
neq17 := k(k(v3,k(v2,k(v0,v1))),k(v0,v1)); 
neq18 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq19 := k(v3,k(v2,v1)); 
neq20 := k(v3,v0); 
neq21 := k(v3,k(k(v3,k(v2,k(v0,v1))),v0)); 
neq22 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq23 := k(v3,k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq24 := k(v3,v1); 
neq25 := k(v3,k(v2,k(v0,v1))); 
neq26 := k(v3,k(v0,v1)); 
neq27 := k(v3,k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq28 := k(k(v2,v1),v0); 
neq29 := k(k(v2,v1),k(k(v3,k(v2,k(v0,v1))),v0)); 
neq30 := k(k(v2,v1),k(k(v3,k(v0,v1)),v2)); 
neq31 := k(k(v2,v1),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
neq32 := k(k(v2,v1),k(v3,k(v0,v1))); 
neq33 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq34 := k(k(v2,v1),k(v0,v1)); 
neq35 := k(k(v2,v1),k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq36 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq37 := k(v0,k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq38 := k(v0,k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
neq39 := k(v0,k(v3,k(v0,v1))); 
neq40 := k(v0,k(v2,k(v0,v1))); 
neq41 := k(v0,k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq42 := k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)); 
neq43 := k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq44 := k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
...
neq49 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))); 
neq50 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3)); 
neq51 := k(k(k(v3,k(v0,v1)),v2),v1); 
neq52 := k(k(k(v3,k(v0,v1)),v2),k(v2,k(v0,v1))); 
neq53 := k(k(k(v3,k(v0,v1)),v2),k(v0,v1)); 
neq54 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1)),v1); 
neq55 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1)),k(v3,k(v0,v1))); 
neq56 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1)),k(v2,k(v0,v1))); 
neq57 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1)),k(v0,v1)); 
neq58 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3),v1); 
neq59 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3),k(v3,k(v0,v1))); 
neq60 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3),k(v2,k(v0,v1))); 
neq61 := k(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3),k(v0,v1)); 
neq62 := k(v1,k(v3,k(v0,v1))); 
neq63 := k(v1,k(v2,k(v0,v1))); 
neq64 := k(v1,k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq65 := k(k(v3,k(v0,v1)),k(v2,k(v0,v1))); 
neq66 := k(k(v3,k(v0,v1)),k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq67 := k(k(v2,k(v0,v1)),k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
neq68 := k(k(v0,v1),k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),v3),k(k(k(k(v3,k(v2,k(v0,v1))),v0),k(k(v3,k(v0,v1)),v2)),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
