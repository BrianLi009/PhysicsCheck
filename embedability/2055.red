...
neq5 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq6 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq7 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v0)); 
...
neq14 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq15 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq16 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)); 
neq17 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq18 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v1)); 
neq19 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq20 := k(v2,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq21 := k(v2,v0); 
neq22 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq23 := k(v2,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq24 := k(v2,k(k(v2,v0),v0)); 
neq25 := k(v2,k(k(v2,v1),v1)); 
neq26 := k(v2,v1); 
neq27 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq28 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)); 
neq29 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0); 
neq30 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq31 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)); 
neq32 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v0)); 
neq33 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)); 
neq34 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v1); 
neq35 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1)); 
neq36 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0); 
neq37 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq38 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)); 
neq39 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v0)); 
neq40 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)); 
neq41 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1); 
neq42 := k(k(v2,v1),v0); 
neq43 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq44 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq45 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq46 := k(k(v2,v1),k(v2,v0)); 
neq47 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq48 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq49 := k(v0,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq50 := k(v0,k(k(v2,v1),v1)); 
neq51 := k(v0,k(k(v2,v0),v2)); 
neq52 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(v2,v0),v0)); 
neq53 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(v2,v0)); 
neq54 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)),v1); 
neq55 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq56 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(v2,v0)); 
neq57 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(v2,v1),v1)); 
neq58 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1); 
neq59 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
