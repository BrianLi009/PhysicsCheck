...
def test_embed(): 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_1-(x_6*y_10-y_6*x_10)*y_1)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_1-(y_6*z_10-z_6*y_10)*z_1)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_1-(z_6*x_10-x_6*z_10)*x_1)==0) 
    ...
    s.add(((z_2*x_7-x_2*z_7)*z_3-(x_2*y_7-y_2*x_7)*y_3)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_3-(y_2*z_7-z_2*y_7)*z_3)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_3-(z_2*x_7-x_2*z_7)*x_3)==0) 
