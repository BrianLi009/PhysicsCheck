...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_8-(x_7*y_12-y_7*x_12)*y_8)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_8-(y_7*z_12-z_7*y_12)*z_8)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_8-(z_7*x_12-x_7*z_12)*x_8)==0) 
    s.add(((z_7*x_8-x_7*z_8)*z_6-(x_7*y_8-y_7*x_8)*y_6)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_6-(y_7*z_8-z_7*y_8)*z_6)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_6-(z_7*x_8-x_7*z_8)*x_6)==0) 
    s.add(((z_7*x_10-x_7*z_10)*z_0-(x_7*y_10-y_7*x_10)*y_0)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_0-(y_7*z_10-z_7*y_10)*z_0)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_0-(z_7*x_10-x_7*z_10)*x_0)==0) 
    s.add(((z_11*x_12-x_11*z_12)*z_1-(x_11*y_12-y_11*x_12)*y_1)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_1-(y_11*z_12-z_11*y_12)*z_1)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_1-(z_11*x_12-x_11*z_12)*x_1)==0) 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_3-(x_8*y_12-y_8*x_12)*y_3)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_3-(y_8*z_12-z_8*y_12)*z_3)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_3-(z_8*x_12-x_8*z_12)*x_3)==0) 
    s.add(((z_3*x_4-x_3*z_4)*z_5-(x_3*y_4-y_3*x_4)*y_5)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_5-(y_3*z_4-z_3*y_4)*z_5)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_5-(z_3*x_4-x_3*z_4)*x_5)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
