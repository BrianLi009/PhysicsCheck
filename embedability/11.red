...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v2,k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1)))); 
...
neq5 := k(v2,v0); 
neq6 := k(v2,v1); 
neq7 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq8 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v0)); 
neq9 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)); 
neq10 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq11 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),v0); 
neq12 := k(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq13 := k(k(v2,k(v0,v1)),k(k(v2,v0),v0)); 
neq14 := k(k(v2,k(v0,v1)),k(k(v2,v1),v1)); 
neq15 := k(k(v2,k(v0,v1)),k(v2,v0)); 
neq16 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq17 := k(k(v2,k(v0,v1)),v0); 
neq18 := k(k(v2,k(v0,v1)),v1); 
neq19 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(v2,v0),v0)); 
neq20 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(v2,v1),v1)); 
neq21 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)); 
...
phi := 
       ...
       d(k(k(k(v2,v0),v0),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
