...
def test_embed(): 
    ...
    s.add(((z_6*x_9-x_6*z_9)*z_10-(x_6*y_9-y_6*x_9)*y_10)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_10-(y_6*z_9-z_6*y_9)*z_10)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_10-(z_6*x_9-x_6*z_9)*x_10)==0) 
    ...
    s.add(((z_6*x_12-x_6*z_12)*z_1-(x_6*y_12-y_6*x_12)*y_1)==0) 
    s.add(((x_6*y_12-y_6*x_12)*x_1-(y_6*z_12-z_6*y_12)*z_1)==0) 
    s.add(((y_6*z_12-z_6*y_12)*y_1-(z_6*x_12-x_6*z_12)*x_1)==0) 
    s.add(((z_9*x_11-x_9*z_11)*z_2-(x_9*y_11-y_9*x_11)*y_2)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_2-(y_9*z_11-z_9*y_11)*z_2)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_2-(z_9*x_11-x_9*z_11)*x_2)==0) 
