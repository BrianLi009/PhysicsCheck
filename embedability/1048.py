...
def test_embed(): 
    ...
    s.add(((z_0*x_3-x_0*z_3)*z_9-(x_0*y_3-y_0*x_3)*y_9)==0) 
    s.add(((x_0*y_3-y_0*x_3)*x_9-(y_0*z_3-z_0*y_3)*z_9)==0) 
    s.add(((y_0*z_3-z_0*y_3)*y_9-(z_0*x_3-x_0*z_3)*x_9)==0) 
    ...
    s.add(((z_3*x_4-x_3*z_4)*z_12-(x_3*y_4-y_3*x_4)*y_12)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_12-(y_3*z_4-z_3*y_4)*z_12)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_12-(z_3*x_4-x_3*z_4)*x_12)==0) 
