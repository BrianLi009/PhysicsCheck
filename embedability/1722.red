...
neq1 := k(k(k(v3,v1),k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq2 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0))); 
neq3 := k(k(k(v3,v1),k(v2,v0)),v0); 
neq4 := k(k(k(v3,v1),k(v2,v0)),v3); 
neq5 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v1),v1)); 
neq6 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v2),v3)); 
neq7 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq8 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq9 := k(k(k(v3,v1),k(v2,v0)),k(v3,v2)); 
neq10 := k(v2,k(k(k(v3,v2),v3),k(v2,v0))); 
neq11 := k(v2,k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0))); 
neq12 := k(v2,v3); 
neq13 := k(v2,k(k(v3,v1),v1)); 
neq14 := k(v2,k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq15 := k(v2,k(k(v3,v2),v3)); 
neq16 := k(v2,v1); 
neq17 := k(v2,k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq18 := k(v2,k(v3,v1)); 
neq19 := k(k(k(k(v3,v2),v3),k(v2,v0)),v0); 
neq20 := k(k(k(k(v3,v2),v3),k(v2,v0)),v3); 
neq21 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v1),v1)); 
neq22 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq23 := k(k(k(k(v3,v2),v3),k(v2,v0)),v1); 
neq24 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq25 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(v3,v1)); 
neq26 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(v3,v2)); 
neq27 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),v0); 
neq28 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),v3); 
neq29 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(k(v3,v1),v1)); 
neq30 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq31 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(k(v3,v2),v3)); 
neq32 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),v1); 
neq33 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(v3,v1)); 
neq34 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(v3,v2)); 
neq35 := k(v0,v3); 
neq36 := k(v0,k(k(v3,v1),v1)); 
neq37 := k(v0,k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq38 := k(v0,k(k(v3,v2),v3)); 
neq39 := k(v0,k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq40 := k(v0,k(v3,v1)); 
neq41 := k(v0,k(v3,v2)); 
neq42 := k(v3,k(k(v3,v1),v1)); 
neq43 := k(v3,k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq44 := k(v3,v1); 
neq45 := k(v3,k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq46 := k(v3,k(v2,v0)); 
neq47 := k(k(k(v3,v1),v1),k(k(k(v3,v1),k(v2,v0)),k(v3,v2))); 
neq48 := k(k(k(v3,v1),v1),k(k(v3,v2),v3)); 
neq49 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq50 := k(k(k(v3,v1),v1),k(v2,v0)); 
neq51 := k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v2),v3)); 
neq52 := k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),v1); 
neq53 := k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(v3,v1)); 
neq54 := k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(v2,v0)); 
neq55 := k(k(k(v3,v2),v3),v1); 
neq56 := k(k(k(v3,v2),v3),k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq57 := k(k(k(v3,v2),v3),k(v3,v1)); 
neq58 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq59 := k(v1,k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1))); 
neq60 := k(v1,k(v3,v2)); 
neq61 := k(v1,k(v2,v0)); 
neq62 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v3,v1)); 
neq63 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v3,v2)); 
neq64 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v1),k(v2,v0)),k(v3,v2)),k(k(v3,v1),v1)),k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
