...
def test_embed(): 
    ...
    s.add(((z_2*x_4-x_2*z_4)*z_8-(x_2*y_4-y_2*x_4)*y_8)==0) 
    s.add(((x_2*y_4-y_2*x_4)*x_8-(y_2*z_4-z_2*y_4)*z_8)==0) 
    s.add(((y_2*z_4-z_2*y_4)*y_8-(z_2*x_4-x_2*z_4)*x_8)==0) 
    ...
    s.add(((z_6*x_7-x_6*z_7)*z_11-(x_6*y_7-y_6*x_7)*y_11)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_11-(y_6*z_7-z_6*y_7)*z_11)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_11-(z_6*x_7-x_6*z_7)*x_11)==0) 
    s.add(((z_5*x_8-x_5*z_8)*z_12-(x_5*y_8-y_5*x_8)*y_12)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_12-(y_5*z_8-z_5*y_8)*z_12)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_12-(z_5*x_8-x_5*z_8)*x_12)==0) 
