...
neq5 := k(v2,k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq6 := k(v2,k(v3,k(v2,v0))); 
neq7 := k(v2,v3); 
neq8 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq9 := k(k(k(v2,v0),v2),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq10 := k(k(k(v2,v0),v2),v0); 
neq11 := k(k(k(v2,v0),v2),v1); 
neq12 := k(k(k(v2,v0),v2),k(v0,v1)); 
neq13 := k(k(k(v2,v0),v2),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq14 := k(k(k(v2,v0),v2),k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq15 := k(k(k(v2,v0),v2),k(v3,k(v2,v0))); 
neq16 := k(k(k(v2,v0),v2),v3); 
neq17 := k(k(k(v2,v0),v2),k(k(v3,k(v2,v0)),v1)); 
neq18 := k(k(k(k(v3,k(v2,v0)),v1),v2),v0); 
neq19 := k(k(k(k(v3,k(v2,v0)),v1),v2),v1); 
neq20 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)); 
neq21 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v3,k(k(v2,v0),v2))); 
neq22 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq23 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v3,k(v2,v0))); 
neq24 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v2,v0)); 
neq25 := k(k(k(k(v3,k(v2,v0)),v1),v2),v3); 
neq26 := k(v0,k(v3,k(k(v2,v0),v2))); 
neq27 := k(v0,k(k(v3,k(k(v2,v0),v2)),v3)); 
neq28 := k(v0,k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq29 := k(v0,k(v3,k(v2,v0))); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq32 := k(v1,k(v3,k(k(v2,v0),v2))); 
neq33 := k(v1,k(k(v3,k(k(v2,v0),v2)),v3)); 
neq34 := k(v1,k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq35 := k(v1,k(v3,k(v2,v0))); 
neq36 := k(v1,k(v2,v0)); 
neq37 := k(v1,v3); 
neq38 := k(k(v0,v1),k(v3,k(k(v2,v0),v2))); 
neq39 := k(k(v0,v1),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq40 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq41 := k(k(v0,v1),k(v3,k(v2,v0))); 
neq42 := k(k(v0,v1),k(v2,v0)); 
neq43 := k(k(v0,v1),k(k(v3,k(v2,v0)),v1)); 
neq44 := k(k(v3,k(k(v2,v0),v2)),k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))); 
neq45 := k(k(v3,k(k(v2,v0),v2)),k(v3,k(v2,v0))); 
neq46 := k(k(v3,k(k(v2,v0),v2)),k(v2,v0)); 
neq47 := k(k(v3,k(k(v2,v0),v2)),k(k(v3,k(v2,v0)),v1)); 
neq48 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(v3,k(v2,v0))); 
neq49 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(v2,v0)); 
neq50 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(k(v3,k(v2,v0)),v1)); 
neq51 := k(k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3)),k(v3,k(v2,v0))); 
neq52 := k(k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3)),k(v2,v0)); 
neq53 := k(k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3)),v3); 
neq54 := k(k(v2,v0),v3); 
neq55 := k(k(v2,v0),k(k(v3,k(v2,v0)),v1)); 
neq56 := k(v3,k(k(v3,k(v2,v0)),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(v2,v0)),v1),v2),k(k(k(v3,k(v2,v0)),v1),k(k(v3,k(k(v2,v0),v2)),v3))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
