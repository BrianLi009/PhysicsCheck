...
def test_embed(): 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_2-(x_1*y_12-y_1*x_12)*y_2)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_2-(y_1*z_12-z_1*y_12)*z_2)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_2-(z_1*x_12-x_1*z_12)*x_2)==0) 
    s.add(((z_3*x_13-x_3*z_13)*z_4-(x_3*y_13-y_3*x_13)*y_4)==0) 
    s.add(((x_3*y_13-y_3*x_13)*x_4-(y_3*z_13-z_3*y_13)*z_4)==0) 
    s.add(((y_3*z_13-z_3*y_13)*y_4-(z_3*x_13-x_3*z_13)*x_4)==0) 
