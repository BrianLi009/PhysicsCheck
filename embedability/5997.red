...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))); 
neq1 := k(v2,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
...
neq10 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq11 := k(k(v2,v0),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))); 
neq12 := k(k(v2,v0),k(v2,v1)); 
neq13 := k(k(v2,v0),v3); 
neq14 := k(k(v2,v0),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq15 := k(k(v2,v0),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq16 := k(k(v2,v0),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq17 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq18 := k(k(v2,v0),v1); 
neq19 := k(k(v2,v0),k(v3,k(k(v2,v1),v2))); 
neq20 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))); 
neq21 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))); 
neq22 := k(k(k(v2,v1),v2),v0); 
neq23 := k(k(k(v2,v1),v2),v3); 
neq24 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq25 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq26 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq27 := k(k(k(v2,v1),v2),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(v2,v1)); 
neq30 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),v0); 
neq31 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),v3); 
neq32 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq33 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq34 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq35 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),v1); 
neq36 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(v3,k(k(v2,v1),v2))); 
neq37 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(v2,v1)); 
neq38 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v0); 
neq39 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v3); 
neq40 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq41 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq42 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v1); 
neq43 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(v3,k(k(v2,v1),v2))); 
neq44 := k(k(v2,v1),v0); 
neq45 := k(k(v2,v1),v3); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2))),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
