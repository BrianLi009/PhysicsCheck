...
def test_embed(): 
    ...
    s.add(((z_1*x_4-x_1*z_4)*z_6-(x_1*y_4-y_1*x_4)*y_6)==0) 
    s.add(((x_1*y_4-y_1*x_4)*x_6-(y_1*z_4-z_1*y_4)*z_6)==0) 
    s.add(((y_1*z_4-z_1*y_4)*y_6-(z_1*x_4-x_1*z_4)*x_6)==0) 
    s.add(((z_0*x_4-x_0*z_4)*z_7-(x_0*y_4-y_0*x_4)*y_7)==0) 
    s.add(((x_0*y_4-y_0*x_4)*x_7-(y_0*z_4-z_0*y_4)*z_7)==0) 
    s.add(((y_0*z_4-z_0*y_4)*y_7-(z_0*x_4-x_0*z_4)*x_7)==0) 
    s.add(((z_1*x_3-x_1*z_3)*z_8-(x_1*y_3-y_1*x_3)*y_8)==0) 
    s.add(((x_1*y_3-y_1*x_3)*x_8-(y_1*z_3-z_1*y_3)*z_8)==0) 
    s.add(((y_1*z_3-z_1*y_3)*y_8-(z_1*x_3-x_1*z_3)*x_8)==0) 
    ...
    s.add(((z_0*x_6-x_0*z_6)*z_12-(x_0*y_6-y_0*x_6)*y_12)==0) 
    s.add(((x_0*y_6-y_0*x_6)*x_12-(y_0*z_6-z_0*y_6)*z_12)==0) 
    s.add(((y_0*z_6-z_0*y_6)*y_12-(z_0*x_6-x_0*z_6)*x_12)==0) 
