...
def test_embed(): 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_3-(x_7*y_11-y_7*x_11)*y_3)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_3-(y_7*z_11-z_7*y_11)*z_3)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_3-(z_7*x_11-x_7*z_11)*x_3)==0) 
