...
neq1 := k(v2,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0))); 
neq2 := k(v2,k(v0,v1)); 
neq3 := k(v2,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1))); 
neq4 := k(v2,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq5 := k(v2,k(k(v2,v0),v0)); 
neq6 := k(v2,v0); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(v2,v0),v2),k(v0,v1))); 
neq9 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq10 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0))); 
neq11 := k(k(k(k(v2,v0),v2),v1),k(v0,v1)); 
neq12 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1))); 
neq13 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq14 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq15 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)); 
neq16 := k(k(k(k(v2,v0),v2),v1),v0); 
neq17 := k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq18 := k(k(k(k(v2,v0),v2),v1),k(v2,v1)); 
neq19 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(v0,v1)); 
neq20 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1))); 
neq21 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq22 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(v2,v0)); 
neq23 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),v0); 
neq24 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),v1); 
neq25 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
neq26 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)),k(v2,v1)); 
neq27 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1))); 
neq28 := k(k(v0,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq29 := k(k(v0,v1),k(v2,v0)); 
neq30 := k(k(v0,v1),k(k(v2,v0),v0)); 
neq31 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq32 := k(k(v0,v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq33 := k(k(v0,v1),k(v2,v1)); 
neq34 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),k(v2,v0)); 
neq35 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v0)); 
neq36 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),v0); 
neq37 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),v1); 
neq38 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v2)); 
neq39 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),k(k(k(v2,v0),v2),k(v0,v1))); 
neq40 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v0)); 
neq41 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)); 
neq42 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),v0); 
neq43 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),v1); 
neq44 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v2)); 
neq45 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq46 := k(k(v2,v0),v1); 
neq47 := k(k(v2,v0),k(k(k(v2,v0),v2),k(v0,v1))); 
neq48 := k(k(v2,v0),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq49 := k(k(v2,v0),k(v2,v1)); 
neq50 := k(k(k(v2,v0),v0),v1); 
neq51 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq52 := k(k(k(v2,v0),v0),k(k(k(v2,v0),v2),k(v0,v1))); 
neq53 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq54 := k(v0,k(k(v2,v0),v2)); 
neq55 := k(v0,k(k(k(v2,v0),v2),k(v0,v1))); 
neq56 := k(v0,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq57 := k(v0,k(v2,v1)); 
neq58 := k(v1,k(k(v2,v0),v2)); 
neq59 := k(v1,k(k(k(v2,v0),v2),k(v0,v1))); 
neq60 := k(v1,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq61 := k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq62 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq63 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq64 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)); 
neq65 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0))) = 0 and 
       d(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
