...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_9-(x_0*y_13-y_0*x_13)*y_9)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_9-(y_0*z_13-z_0*y_13)*z_9)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_9-(z_0*x_13-x_0*z_13)*x_9)==0) 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_11-(x_1*y_13-y_1*x_13)*y_11)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_11-(y_1*z_13-z_1*y_13)*z_11)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_11-(z_1*x_13-x_1*z_13)*x_11)==0) 
