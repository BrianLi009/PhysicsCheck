...
neq3 := k(v2,v0); 
neq4 := k(v2,v3); 
neq5 := k(v2,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq6 := k(v2,k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(v3,v1)); 
neq9 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v2,v0),v0)); 
neq10 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),v0); 
neq11 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),v3); 
neq12 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)); 
neq13 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq14 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),v1); 
neq15 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v1)); 
neq16 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2)); 
neq17 := k(k(k(v2,v0),v0),k(k(v3,v1),k(v2,v0))); 
neq18 := k(k(k(v2,v0),v0),v3); 
neq19 := k(k(k(v2,v0),v0),k(v3,v2)); 
neq20 := k(k(k(v2,v0),v0),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq21 := k(k(k(v2,v0),v0),v1); 
neq22 := k(k(k(v2,v0),v0),k(v3,v1)); 
neq23 := k(k(k(v2,v0),v0),k(k(v3,v2),v2)); 
neq24 := k(k(k(v3,v1),k(v2,v0)),v0); 
neq25 := k(k(k(v3,v1),k(v2,v0)),v3); 
neq26 := k(k(k(v3,v1),k(v2,v0)),k(v3,v2)); 
neq27 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq28 := k(k(k(v3,v1),k(v2,v0)),k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq29 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq30 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v2),v2)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(v3,v2)); 
neq33 := k(v0,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq34 := k(v0,k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq35 := k(v0,k(v3,v1)); 
neq36 := k(v0,k(k(v3,v2),v2)); 
neq37 := k(v3,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq38 := k(v3,k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq39 := k(v3,k(k(v3,v2),v2)); 
neq40 := k(v3,k(v2,v0)); 
neq41 := k(k(v3,v2),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))); 
neq42 := k(k(v3,v2),k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq43 := k(k(v3,v2),v1); 
neq44 := k(k(v3,v2),k(v3,v1)); 
neq45 := k(k(v3,v2),k(v2,v0)); 
neq46 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2)),v1); 
neq47 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2)),k(v3,v1)); 
neq48 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2)),k(v2,v0)); 
neq49 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),v1); 
neq50 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(v3,v1)); 
neq51 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq52 := k(v1,k(k(v3,v2),v2)); 
neq53 := k(v1,k(v2,v0)); 
neq54 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq55 := k(k(v3,v1),k(v2,v0)); 
neq56 := k(k(k(v3,v2),v2),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
