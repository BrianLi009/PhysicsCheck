...
neq5 := k(v2,k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq6 := k(v2,k(v3,v0)); 
neq7 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq8 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq9 := k(v2,k(k(v3,v2),v3)); 
neq10 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v0,v1)); 
neq11 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v0); 
neq12 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1); 
neq13 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2)); 
neq14 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,v2)); 
neq15 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v3); 
neq16 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,v0)); 
neq17 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq18 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq19 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(v3,v2),v3)); 
neq20 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2)); 
neq21 := k(k(v0,v1),k(v3,v2)); 
neq22 := k(k(v0,v1),v3); 
neq23 := k(k(v0,v1),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq24 := k(k(v0,v1),k(v3,v0)); 
neq25 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq26 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq27 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq28 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2)); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq32 := k(v0,k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq33 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq34 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq35 := k(v0,k(k(v3,v2),v3)); 
neq36 := k(v1,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2)); 
neq37 := k(v1,k(v3,v2)); 
neq38 := k(v1,v3); 
neq39 := k(v1,k(k(k(v3,v2),v3),k(v0,v1))); 
neq40 := k(v1,k(v3,v0)); 
neq41 := k(v1,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq42 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq43 := k(v1,k(k(v3,v2),v3)); 
neq44 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),k(v3,v2)); 
neq45 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),v3); 
neq46 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq47 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),k(v3,v0)); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2),k(k(v3,v2),v3)); 
neq50 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq51 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq52 := k(k(v3,v2),k(v3,v0)); 
neq53 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq54 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq55 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq56 := k(v3,k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq57 := k(v3,k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq58 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq59 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1)); 
neq60 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v0)); 
neq61 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq62 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0))); 
neq63 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)); 
neq64 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq65 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(k(v3,v2),v3)); 
neq66 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3))); 
neq67 := k(k(v3,v0),k(k(v3,v2),v3)); 
neq68 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),k(k(v3,v2),v3)),k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1),k(v3,v0)),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
