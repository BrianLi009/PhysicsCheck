...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_0-(x_8*y_11-y_8*x_11)*y_0)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_0-(y_8*z_11-z_8*y_11)*z_0)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_0-(z_8*x_11-x_8*z_11)*x_0)==0) 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_3-(x_9*y_10-y_9*x_10)*y_3)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_3-(y_9*z_10-z_9*y_10)*z_3)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_3-(z_9*x_10-x_9*z_10)*x_3)==0) 
