...
neq3 := k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq4 := k(k(k(k(v2,v0),v2),v1),v0); 
neq5 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq6 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq7 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq8 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)); 
neq9 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq10 := k(k(k(v2,v1),v1),v2); 
neq11 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq12 := k(k(k(v2,v1),v1),v0); 
neq13 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq14 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq15 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq16 := k(k(k(v2,v1),v1),k(k(v2,v0),v0)); 
neq17 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq18 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq19 := k(k(v2,v1),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq20 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq21 := k(k(v2,v1),v0); 
neq22 := k(k(v2,v1),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq23 := k(k(v2,v1),k(v2,v0)); 
neq24 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq25 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq26 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq27 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq28 := k(v2,k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq29 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq30 := k(v2,v0); 
neq31 := k(v2,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq32 := k(v2,k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq33 := k(v2,k(k(v2,v0),v0)); 
neq34 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq35 := k(v2,v1); 
neq36 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq37 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0); 
neq38 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq39 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(v2,v0)); 
neq40 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)); 
neq41 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq42 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v1); 
neq43 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),v0); 
neq44 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq45 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v0)); 
neq46 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq47 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),v1); 
neq48 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
neq49 := k(v0,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1)); 
neq50 := k(v0,k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq51 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq52 := k(v0,k(k(v2,v0),v2)); 
neq53 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1),k(v2,v0)); 
neq54 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1),k(k(v2,v0),v0)); 
neq55 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1),k(k(v2,v0),v2)); 
neq56 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq57 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq58 := k(k(v2,v0),v1); 
neq59 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(v2,v0),v0)); 
neq60 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1); 
neq61 := k(k(k(v2,v0),v0),v1); 
neq62 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq63 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0)),v1); 
neq64 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))) = 0 and 
       d(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(v2,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
