...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),v0); 
neq1 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),v1); 
neq2 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(v2,v1)); 
neq3 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),v3); 
neq4 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(v3,v1)); 
neq5 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(v3,v0)); 
neq6 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq7 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(k(v2,v1),v2)); 
neq8 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(k(v3,v0),k(k(v2,v1),v2))); 
neq9 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq10 := k(v2,k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3)); 
neq11 := k(v2,v0); 
neq12 := k(v2,v1); 
neq13 := k(v2,v3); 
neq14 := k(v2,k(v3,v1)); 
neq15 := k(v2,k(v3,v0)); 
neq16 := k(v2,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq17 := k(v2,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq18 := k(v2,k(k(v3,v0),k(k(v2,v1),v2))); 
neq19 := k(v2,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq20 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v0); 
neq21 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v1); 
neq22 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(v2,v1)); 
neq23 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(v3,v1)); 
neq24 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(v3,v0)); 
neq25 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(k(v2,v1),v2)); 
neq26 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq27 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(k(v3,v0),k(k(v2,v1),v2))); 
neq28 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq29 := k(v0,k(v2,v1)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(v3,v1)); 
neq32 := k(v0,k(k(v2,v1),v2)); 
neq33 := k(v0,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq34 := k(v0,k(k(v3,v0),k(k(v2,v1),v2))); 
neq35 := k(v0,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq36 := k(v1,v3); 
neq37 := k(v1,k(v3,v0)); 
neq38 := k(v1,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq39 := k(v1,k(k(v2,v1),v2)); 
neq40 := k(v1,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq41 := k(v1,k(k(v3,v0),k(k(v2,v1),v2))); 
neq42 := k(v1,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq43 := k(k(v2,v1),v3); 
neq44 := k(k(v2,v1),k(v3,v1)); 
neq45 := k(k(v2,v1),k(v3,v0)); 
neq46 := k(k(v2,v1),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq47 := k(k(v2,v1),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq48 := k(k(v2,v1),k(k(v3,v0),k(k(v2,v1),v2))); 
neq49 := k(k(v2,v1),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq50 := k(v3,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq51 := k(v3,k(k(v2,v1),v2)); 
neq52 := k(v3,k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq53 := k(v3,k(k(v3,v0),k(k(v2,v1),v2))); 
neq54 := k(v3,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq55 := k(k(v3,v1),k(v3,v0)); 
neq56 := k(k(v3,v1),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq57 := k(k(v3,v1),k(k(v2,v1),v2)); 
neq58 := k(k(v3,v1),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq59 := k(k(v3,v1),k(k(v3,v0),k(k(v2,v1),v2))); 
neq60 := k(k(v3,v0),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0)); 
neq61 := k(k(v3,v0),k(k(v2,v1),v2)); 
neq62 := k(k(v3,v0),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq63 := k(k(v3,v0),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq64 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),k(k(v2,v1),v2)); 
neq65 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq66 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),k(k(v3,v0),k(k(v2,v1),v2))); 
neq67 := k(k(k(v2,v1),v2),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq68 := k(k(k(v2,v1),v2),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),v0),v3),v2),k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v0),k(k(v2,v1),v2)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
