...
def test_embed(): 
    ...
    s.add(((z_4*x_13-x_4*z_13)*z_8-(x_4*y_13-y_4*x_13)*y_8)==0) 
    s.add(((x_4*y_13-y_4*x_13)*x_8-(y_4*z_13-z_4*y_13)*z_8)==0) 
    s.add(((y_4*z_13-z_4*y_13)*y_8-(z_4*x_13-x_4*z_13)*x_8)==0) 
