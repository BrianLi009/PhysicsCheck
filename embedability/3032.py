...
def test_embed(): 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_9-(x_1*y_13-y_1*x_13)*y_9)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_9-(y_1*z_13-z_1*y_13)*z_9)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_9-(z_1*x_13-x_1*z_13)*x_9)==0) 
