...
neq1 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq2 := k(k(v2,v1),v0); 
neq3 := k(k(v2,v1),k(k(k(v2,v0),v2),v1)); 
neq4 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq5 := k(k(v2,v1),k(v2,v0)); 
neq6 := k(k(v2,v1),k(v3,k(k(v2,v1),v1))); 
neq7 := k(k(v2,v1),v3); 
neq8 := k(k(v2,v1),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq9 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq10 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq11 := k(k(k(v2,v1),v1),v0); 
neq12 := k(k(k(v2,v1),v1),k(k(k(v2,v0),v2),v1)); 
neq13 := k(k(k(v2,v1),v1),v2); 
neq14 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq15 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq16 := k(k(k(v2,v1),v1),v3); 
neq17 := k(k(k(v2,v1),v1),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq18 := k(k(v0,v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq19 := k(k(v0,v1),k(k(k(v2,v0),v2),v1)); 
neq20 := k(k(v0,v1),v2); 
neq21 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq22 := k(k(v0,v1),k(v2,v0)); 
neq23 := k(k(v0,v1),k(v3,k(k(v2,v1),v1))); 
neq24 := k(k(v0,v1),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq25 := k(k(k(k(k(v2,v0),v2),v1),v1),v0); 
neq26 := k(k(k(k(k(v2,v0),v2),v1),v1),v2); 
neq27 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v2)); 
neq28 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)); 
neq29 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v3,k(k(v2,v1),v1))); 
neq30 := k(k(k(k(k(v2,v0),v2),v1),v1),v3); 
neq31 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq32 := k(v0,v2); 
neq33 := k(v0,k(k(v2,v0),v2)); 
neq34 := k(v0,k(v3,k(k(v2,v1),v1))); 
neq35 := k(v0,v3); 
neq36 := k(v0,k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq37 := k(k(k(k(v2,v0),v2),v1),v2); 
neq38 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq39 := k(k(k(k(v2,v0),v2),v1),k(v3,k(k(v2,v1),v1))); 
neq40 := k(k(k(k(v2,v0),v2),v1),v3); 
neq41 := k(k(k(k(v2,v0),v2),v1),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq42 := k(v2,k(v3,k(k(v2,v1),v1))); 
neq43 := k(v2,v3); 
neq44 := k(v2,k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq45 := k(v2,v1); 
neq46 := k(k(k(v2,v0),v2),k(v3,k(k(v2,v1),v1))); 
neq47 := k(k(k(v2,v0),v2),v3); 
neq48 := k(k(k(v2,v0),v2),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq49 := k(k(k(v2,v0),v2),v1); 
neq50 := k(k(v2,v0),k(v3,k(k(v2,v1),v1))); 
neq51 := k(k(v2,v0),v3); 
neq52 := k(k(v2,v0),k(v3,k(k(k(k(v2,v0),v2),v1),v1))); 
neq53 := k(k(v2,v0),v1); 
neq54 := k(k(v3,k(k(v2,v1),v1)),v1); 
neq55 := k(v3,v1); 
neq56 := k(k(v3,k(k(k(k(v2,v0),v2),v1),v1)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(v3,k(k(v2,v1),v1)),k(v3,k(k(k(k(v2,v0),v2),v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
