...
def test_embed(): 
    ...
    s.add(((z_10*x_12-x_10*z_12)*z_13-(x_10*y_12-y_10*x_12)*y_13)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_13-(y_10*z_12-z_10*y_12)*z_13)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_13-(z_10*x_12-x_10*z_12)*x_13)==0) 
    ...
    s.add(((z_0*x_8-x_0*z_8)*z_4-(x_0*y_8-y_0*x_8)*y_4)==0) 
    s.add(((x_0*y_8-y_0*x_8)*x_4-(y_0*z_8-z_0*y_8)*z_4)==0) 
    s.add(((y_0*z_8-z_0*y_8)*y_4-(z_0*x_8-x_0*z_8)*x_4)==0) 
    ...
    s.add(((z_1*x_9-x_1*z_9)*z_7-(x_1*y_9-y_1*x_9)*y_7)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_7-(y_1*z_9-z_1*y_9)*z_7)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_7-(z_1*x_9-x_1*z_9)*x_7)==0) 
