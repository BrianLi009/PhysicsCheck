...
def test_embed(): 
    ...
    s.add(((z_0*x_12-x_0*z_12)*z_7-(x_0*y_12-y_0*x_12)*y_7)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_7-(y_0*z_12-z_0*y_12)*z_7)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_7-(z_0*x_12-x_0*z_12)*x_7)==0) 
    ...
    s.add(((z_1*x_7-x_1*z_7)*z_8-(x_1*y_7-y_1*x_7)*y_8)==0) 
    s.add(((x_1*y_7-y_1*x_7)*x_8-(y_1*z_7-z_1*y_7)*z_8)==0) 
    s.add(((y_1*z_7-z_1*y_7)*y_8-(z_1*x_7-x_1*z_7)*x_8)==0) 
    s.add(((z_2*x_12-x_2*z_12)*z_9-(x_2*y_12-y_2*x_12)*y_9)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_9-(y_2*z_12-z_2*y_12)*z_9)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_9-(z_2*x_12-x_2*z_12)*x_9)==0) 
    s.add(((z_3*x_12-x_3*z_12)*z_4-(x_3*y_12-y_3*x_12)*y_4)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_4-(y_3*z_12-z_3*y_12)*z_4)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_4-(z_3*x_12-x_3*z_12)*x_4)==0) 
    s.add(((z_3*x_9-x_3*z_9)*z_10-(x_3*y_9-y_3*x_9)*y_10)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_10-(y_3*z_9-z_3*y_9)*z_10)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_10-(z_3*x_9-x_3*z_9)*x_10)==0) 
    ...
    s.add(((z_5*x_11-x_5*z_11)*z_6-(x_5*y_11-y_5*x_11)*y_6)==0) 
    s.add(((x_5*y_11-y_5*x_11)*x_6-(y_5*z_11-z_5*y_11)*z_6)==0) 
    s.add(((y_5*z_11-z_5*y_11)*y_6-(z_5*x_11-x_5*z_11)*x_6)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_11 == 0) 
