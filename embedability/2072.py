...
def test_embed(): 
    ...
    s.add(((z_10*x_13-x_10*z_13)*z_12-(x_10*y_13-y_10*x_13)*y_12)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_12-(y_10*z_13-z_10*y_13)*z_12)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_12-(z_10*x_13-x_10*z_13)*x_12)==0) 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_9-(x_0*y_10-y_0*x_10)*y_9)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_9-(y_0*z_10-z_0*y_10)*z_9)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_9-(z_0*x_10-x_0*z_10)*x_9)==0) 
    ...
    s.add(((z_6*x_7-x_6*z_7)*z_2-(x_6*y_7-y_6*x_7)*y_2)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_2-(y_6*z_7-z_6*y_7)*z_2)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_2-(z_6*x_7-x_6*z_7)*x_2)==0) 
