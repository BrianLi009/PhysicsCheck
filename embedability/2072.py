...
def test_embed(): 
    ...
    s.add(((z_0*x_2-x_0*z_2)*z_7-(x_0*y_2-y_0*x_2)*y_7)==0) 
    s.add(((x_0*y_2-y_0*x_2)*x_7-(y_0*z_2-z_0*y_2)*z_7)==0) 
    s.add(((y_0*z_2-z_0*y_2)*y_7-(z_0*x_2-x_0*z_2)*x_7)==0) 
    s.add(((z_5*x_8-x_5*z_8)*z_10-(x_5*y_8-y_5*x_8)*y_10)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_10-(y_5*z_8-z_5*y_8)*z_10)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_10-(z_5*x_8-x_5*z_8)*x_10)==0) 
    ...
    s.add(((z_3*x_4-x_3*z_4)*z_13-(x_3*y_4-y_3*x_4)*y_13)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_13-(y_3*z_4-z_3*y_4)*z_13)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_13-(z_3*x_4-x_3*z_4)*x_13)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_7 == 0) 
