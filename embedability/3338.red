...
neq3 := k(v2,k(v3,v1)); 
neq4 := k(v2,v3); 
neq5 := k(v2,k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq6 := k(v2,v1); 
...
neq12 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),k(v3,v1)); 
neq13 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),v3); 
neq14 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq15 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),v1); 
neq16 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),k(v3,k(k(v2,v1),v2))); 
neq17 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq18 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0),k(k(v3,v1),v1)); 
neq19 := k(k(v2,v1),v0); 
neq20 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq21 := k(k(v2,v1),k(v3,v1)); 
neq22 := k(k(v2,v1),v3); 
neq23 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq24 := k(k(v2,v1),k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq25 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq26 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq27 := k(k(v2,v1),k(k(v3,v1),v1)); 
neq28 := k(v0,k(k(v2,v1),v2)); 
neq29 := k(v0,k(v3,v1)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq32 := k(v0,k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq33 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq34 := k(v0,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq35 := k(v0,k(k(v3,v1),v1)); 
neq36 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq37 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq38 := k(k(k(v2,v1),v2),v3); 
neq39 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq40 := k(k(k(v2,v1),v2),k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq41 := k(k(k(v2,v1),v2),v1); 
neq42 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq43 := k(k(k(v2,v1),v2),k(k(v3,v1),v1)); 
neq44 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v3,v1)); 
neq45 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v3); 
neq46 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq47 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq48 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v1); 
neq49 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v3,k(k(v2,v1),v2))); 
neq50 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(v3,v1),v1)); 
neq51 := k(k(v3,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq52 := k(k(v3,v1),k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq53 := k(k(v3,v1),k(v3,k(k(v2,v1),v2))); 
neq54 := k(k(v3,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq55 := k(v3,k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq56 := k(v3,k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq57 := k(v3,v1); 
neq58 := k(v3,k(k(v3,v1),v1)); 
neq59 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq60 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v1); 
neq61 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(v3,k(k(v2,v1),v2))); 
neq62 := k(k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2))),v1); 
neq63 := k(k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2))),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq64 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq65 := k(v1,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq66 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v1),v1)); 
neq67 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(v3,v1),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(v3,v1),v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)) = 0 and 
       d(k(k(k(v3,v1),v1),k(v3,k(k(v2,v1),v2))),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
