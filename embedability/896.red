...
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,v0); 
neq6 := k(v2,k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq7 := k(v2,k(v3,k(v2,v1))); 
neq8 := k(v2,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1)))); 
neq9 := k(v2,v1); 
...
neq41 := k(k(v0,v1),k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq42 := k(k(v0,v1),k(v3,k(v2,v1))); 
neq43 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq44 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1)))); 
neq45 := k(k(v0,v1),k(v2,v1)); 
neq46 := k(k(v0,v1),k(v3,v2)); 
neq47 := k(v0,k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq48 := k(v0,k(v3,k(v2,v1))); 
neq49 := k(v0,k(k(v2,v1),v2)); 
neq50 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1)))); 
neq51 := k(v0,k(v2,v1)); 
neq52 := k(v0,k(v3,v2)); 
neq53 := k(k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2)),k(v3,k(v2,v1))); 
neq54 := k(k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2)),k(v2,v1)); 
neq55 := k(k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2)),v1); 
neq56 := k(k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2)),k(v3,v2)); 
neq57 := k(k(v3,k(v2,v1)),k(k(v2,v1),v2)); 
neq58 := k(k(v3,k(v2,v1)),v1); 
neq59 := k(k(v3,k(v2,v1)),k(v3,v2)); 
neq60 := k(k(k(v2,v1),v2),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1)))); 
neq61 := k(k(k(v2,v1),v2),v1); 
neq62 := k(k(k(v2,v1),v2),k(v3,v2)); 
neq63 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1))),k(v2,v1)); 
neq64 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1))),v1); 
neq65 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1))),k(v3,v2)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v2,v1))),k(k(k(v3,v2),k(v0,v1)),k(k(v2,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
