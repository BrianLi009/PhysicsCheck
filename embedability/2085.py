...
def test_embed(): 
    ...
    s.add(((z_0*x_12-x_0*z_12)*z_9-(x_0*y_12-y_0*x_12)*y_9)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_9-(y_0*z_12-z_0*y_12)*z_9)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_9-(z_0*x_12-x_0*z_12)*x_9)==0) 
    ...
    s.add(((z_3*x_13-x_3*z_13)*z_2-(x_3*y_13-y_3*x_13)*y_2)==0) 
    s.add(((x_3*y_13-y_3*x_13)*x_2-(y_3*z_13-z_3*y_13)*z_2)==0) 
    s.add(((y_3*z_13-z_3*y_13)*y_2-(z_3*x_13-x_3*z_13)*x_2)==0) 
