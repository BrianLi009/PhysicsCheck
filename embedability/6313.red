...
neq1 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1))); 
neq2 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq3 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2),k(k(v2,v0),v0)); 
neq4 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2),k(v2,v0)); 
neq5 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
...
neq11 := k(v2,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0)))); 
neq12 := k(v2,k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1))); 
neq13 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq14 := k(v2,k(k(v2,v0),v0)); 
neq15 := k(v2,k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq16 := k(v2,k(k(v2,v1),v1)); 
neq17 := k(v2,k(v0,v1)); 
neq18 := k(v2,v0); 
neq19 := k(v2,v1); 
neq20 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0)))); 
neq21 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v2,v1)); 
neq22 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1))); 
neq23 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(v2,v0),v0)); 
neq24 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v2,v0)); 
neq25 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
...
neq29 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v2,v1)); 
neq30 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(k(v2,v1),v1),k(v2,v0))); 
neq31 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(v2,v0),v0)); 
neq32 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v2,v0)); 
neq33 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(v2,v1),v1)); 
neq34 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v0,v1)); 
neq35 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),v0); 
neq36 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),v1); 
neq37 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1))); 
neq38 := k(k(v2,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq39 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq40 := k(k(v2,v1),k(v2,v0)); 
neq41 := k(k(v2,v1),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq42 := k(k(v2,v1),k(v0,v1)); 
neq43 := k(k(v2,v1),v0); 
neq44 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq45 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(v2,v0),v0)); 
neq46 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(v2,v0)); 
neq47 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(v2,v1),v1)); 
neq48 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),v0); 
neq49 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),v1); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
