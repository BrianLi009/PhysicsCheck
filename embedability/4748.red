...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0)); 
neq1 := k(k(v2,k(v0,v1)),v0); 
neq2 := k(k(v2,k(v0,v1)),v1); 
neq3 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq4 := k(k(v2,k(v0,v1)),v3); 
neq5 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq6 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq7 := k(k(v2,k(v0,v1)),k(k(k(v3,v1),v2),v2)); 
neq8 := k(k(v2,k(v0,v1)),k(k(v3,v1),v2)); 
neq9 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v1),v2),v2),v3)); 
neq10 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0)); 
neq11 := k(k(v0,v1),v2); 
neq12 := k(k(v0,v1),k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1)))); 
neq13 := k(k(v0,v1),k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq14 := k(k(v0,v1),v3); 
neq15 := k(k(v0,v1),k(v3,v1)); 
neq16 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq17 := k(k(v0,v1),k(k(k(v3,v1),v2),v2)); 
neq18 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq19 := k(k(v0,v1),k(k(k(k(v3,v1),v2),v2),v3)); 
neq20 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),v1); 
neq21 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),v2); 
neq22 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),v3); 
neq24 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(v3,v1)); 
neq25 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(k(k(v3,v1),v2),v2)); 
neq26 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(k(v3,v1),v2)); 
neq27 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(k(k(k(v3,v1),v2),v2),v3)); 
neq28 := k(v0,v2); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1)))); 
neq30 := k(v0,k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(v3,v1)); 
neq33 := k(v0,k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq34 := k(v0,k(k(k(v3,v1),v2),v2)); 
neq35 := k(v0,k(k(v3,v1),v2)); 
neq36 := k(v0,k(k(k(k(v3,v1),v2),v2),v3)); 
neq37 := k(v1,v2); 
neq38 := k(v1,k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1)))); 
neq39 := k(v1,k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq40 := k(v1,v3); 
neq41 := k(v1,k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq42 := k(v1,k(k(k(v3,v1),v2),v2)); 
neq43 := k(v1,k(k(v3,v1),v2)); 
neq44 := k(v1,k(k(k(k(v3,v1),v2),v2),v3)); 
neq45 := k(v2,k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1)))); 
neq46 := k(v2,k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq47 := k(v2,v3); 
neq48 := k(v2,k(v3,v1)); 
neq49 := k(v2,k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq50 := k(v2,k(k(k(k(v3,v1),v2),v2),v3)); 
neq51 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),k(k(k(k(k(v3,v1),v2),v2),v3),v3)); 
neq52 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v3); 
neq53 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),k(v3,v1)); 
neq54 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq55 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),k(k(k(v3,v1),v2),v2)); 
neq56 := k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),k(k(v3,v1),v2)); 
neq57 := k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(v3,v1)); 
neq58 := k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(k(v3,v1),v2),v2)); 
neq59 := k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2)); 
neq60 := k(v3,k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq61 := k(v3,k(k(k(v3,v1),v2),v2)); 
neq62 := k(v3,k(k(v3,v1),v2)); 
neq63 := k(k(v3,v1),k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))); 
neq64 := k(k(v3,v1),k(k(k(v3,v1),v2),v2)); 
neq65 := k(k(v3,v1),k(k(k(k(v3,v1),v2),v2),v3)); 
neq66 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2)),k(k(k(v3,v1),v2),v2)); 
neq67 := k(k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2)),k(k(k(k(v3,v1),v2),v2),v3)); 
neq68 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),v2),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v1),v2),v2),v3),k(v2,k(v0,v1))),v0),k(k(k(k(k(k(v3,v1),v2),v2),v3),v3),k(k(v3,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
