...
neq1 := k(v2,k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2))); 
neq2 := k(v2,k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3))); 
neq3 := k(v2,k(k(k(k(k(v3,v1),v3),v2),v1),v1)); 
...
neq10 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2))); 
neq11 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(v3,v2)); 
neq12 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(k(k(k(v3,v1),v3),v2),v1),v1)); 
neq13 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(k(v3,v1),v3),v2)); 
neq14 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(v3,v1)); 
neq15 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),v1); 
neq16 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),v3); 
neq17 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)); 
neq18 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(k(k(v3,v1),v3),v2),v1)); 
neq19 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),v0); 
neq20 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),k(k(k(v3,v1),v3),v2)); 
neq21 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq22 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),k(v3,v1)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),v1); 
neq24 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),v3); 
neq25 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),k(k(v3,v1),v3)); 
neq26 := k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2)),k(k(k(k(v3,v1),v3),v2),v1)); 
neq27 := k(v0,k(v3,v2)); 
neq28 := k(v0,k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3))); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v3),v2),v1),v1)); 
...
neq36 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3))); 
neq37 := k(k(v3,v2),k(k(k(k(k(v3,v1),v3),v2),v1),v1)); 
neq38 := k(k(v3,v2),k(k(k(v3,v1),v3),v2)); 
neq39 := k(k(v3,v2),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq40 := k(k(v3,v2),k(v3,v1)); 
neq41 := k(k(v3,v2),v1); 
neq42 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq43 := k(k(v3,v2),k(k(k(k(v3,v1),v3),v2),v1)); 
neq44 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(k(k(k(k(v3,v1),v3),v2),v1),v1)); 
neq45 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(k(k(v3,v1),v3),v2)); 
neq46 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq47 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(v3,v1)); 
neq48 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),v1); 
neq49 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),v3); 
neq50 := k(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(k(k(k(v3,v1),v3),v2),v1)); 
neq51 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(k(k(v3,v1),v3),v2)); 
neq52 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq53 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v1)); 
neq54 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),v3); 
neq55 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(k(v3,v1),v3)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),v0),k(k(v3,v1),v3)),k(k(k(k(k(k(v3,v1),v3),v2),v1),v1),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
