...
neq1 := k(v2,k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1))); 
neq2 := k(v2,k(v3,v1)); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(k(v3,k(v2,v1)),v0)); 
neq5 := k(v2,v0); 
neq6 := k(v2,k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq7 := k(v2,k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq8 := k(v2,k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq9 := k(v2,k(v3,k(v2,v1))); 
neq10 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1))); 
neq11 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v3,v1)); 
neq12 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v3); 
neq13 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v3,k(v2,v1)),v0)); 
neq14 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v0); 
neq15 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq16 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq17 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq18 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v1); 
neq19 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v3,v1)); 
neq20 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v3); 
neq21 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(v3,k(v2,v1)),v0)); 
neq22 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v0); 
neq23 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq24 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq25 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v3,k(v2,v1))); 
neq26 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v1); 
neq27 := k(k(v3,v1),k(k(v3,k(v2,v1)),v0)); 
neq28 := k(k(v3,v1),v0); 
neq29 := k(k(v3,v1),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq30 := k(k(v3,v1),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq31 := k(k(v3,v1),k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq32 := k(k(v3,v1),k(v3,k(v2,v1))); 
neq33 := k(k(v3,v1),k(v2,v1)); 
neq34 := k(v3,k(k(v3,k(v2,v1)),v0)); 
neq35 := k(v3,v0); 
neq36 := k(v3,k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq37 := k(v3,k(k(k(v3,k(v2,v1)),v0),v2)); 
neq38 := k(v3,k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq39 := k(v3,v1); 
neq40 := k(v3,k(v2,v1)); 
neq41 := k(k(k(v3,k(v2,v1)),v0),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq42 := k(k(k(v3,k(v2,v1)),v0),k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq43 := k(k(k(v3,k(v2,v1)),v0),k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq44 := k(k(k(v3,k(v2,v1)),v0),v1); 
neq45 := k(k(k(v3,k(v2,v1)),v0),k(v2,v1)); 
neq46 := k(v0,k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq47 := k(v0,k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq48 := k(v0,k(k(k(v3,k(v2,v1)),v0),v2)); 
neq49 := k(v0,k(v3,k(v2,v1))); 
neq50 := k(v0,k(v2,v1)); 
neq51 := k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))); 
neq52 := k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq53 := k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v3,k(v2,v1))); 
neq54 := k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),v1); 
neq55 := k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)); 
neq56 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1)),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq57 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1)),k(v3,k(v2,v1))); 
neq58 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1)),v1); 
neq59 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1)),k(v2,v1)); 
neq60 := k(k(k(k(v3,k(v2,v1)),v0),v2),k(k(k(v3,k(v2,v1)),k(v2,v1)),v0)); 
neq61 := k(k(k(k(v3,k(v2,v1)),v0),v2),k(v3,k(v2,v1))); 
neq62 := k(k(k(k(v3,k(v2,v1)),v0),v2),v1); 
neq63 := k(k(k(k(v3,k(v2,v1)),v0),v2),k(v2,v1)); 
neq64 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,k(v2,v1))); 
neq65 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),v1); 
neq66 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v2,v1)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(k(v3,k(v2,v1)),k(v2,v1)),v0),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
