...
neq7 := k(v2,k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq8 := k(v2,k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq9 := k(v2,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq10 := k(v3,v0); 
neq11 := k(v3,v1); 
neq12 := k(v3,k(k(v3,v2),v1)); 
neq13 := k(v3,k(k(v3,v2),v0)); 
neq14 := k(v3,k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq15 := k(v3,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq16 := k(v3,k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq17 := k(v3,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq18 := k(v3,k(v0,v1)); 
neq19 := k(k(k(v3,v2),v3),v0); 
neq20 := k(k(k(v3,v2),v3),v1); 
neq21 := k(k(k(v3,v2),v3),k(v3,k(v0,v1))); 
neq22 := k(k(k(v3,v2),v3),k(k(v3,v2),v1)); 
neq23 := k(k(k(v3,v2),v3),k(k(v3,v2),v0)); 
neq24 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq25 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq26 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq27 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq28 := k(v0,k(v3,k(v0,v1))); 
neq29 := k(v0,k(k(v3,v2),v1)); 
neq30 := k(v0,k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq31 := k(v0,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq32 := k(v0,k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq33 := k(v0,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq34 := k(v0,k(v3,v2)); 
neq35 := k(v1,k(v3,k(v0,v1))); 
neq36 := k(v1,k(k(v3,v2),v0)); 
neq37 := k(v1,k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq38 := k(v1,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq39 := k(v1,k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq40 := k(v1,k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq41 := k(v1,k(v3,v2)); 
neq42 := k(k(v3,k(v0,v1)),k(k(v3,v2),v1)); 
neq43 := k(k(v3,k(v0,v1)),k(k(v3,v2),v0)); 
neq44 := k(k(v3,k(v0,v1)),k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq45 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq46 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq47 := k(k(v3,k(v0,v1)),k(v3,v2)); 
neq48 := k(k(k(v3,v2),v1),k(k(v3,v2),v0)); 
neq49 := k(k(k(v3,v2),v1),k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq50 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq51 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq52 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq53 := k(k(k(v3,v2),v0),k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1))); 
neq54 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq55 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))); 
neq56 := k(k(k(v3,v2),v0),k(v0,v1)); 
neq57 := k(k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2)); 
neq58 := k(k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)),k(k(k(v3,v2),v0),k(v3,k(v0,v1)))); 
neq59 := k(k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)),k(v3,v2)); 
neq60 := k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2),k(v0,v1)); 
neq61 := k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2),k(v3,v2)); 
neq62 := k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(v0,v1)); 
neq63 := k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(v3,v2)); 
neq64 := k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)); 
neq65 := k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v3,v2)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),v2),k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1))) = 0 and 
       d(k(k(k(k(k(v3,v2),v0),k(v3,k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)),k(k(v3,v2),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
