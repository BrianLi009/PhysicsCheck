...
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v2,v0); 
neq1 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1)); 
neq2 := k(v2,k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0)); 
...
neq8 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1)); 
neq9 := k(v0,k(v2,v1)); 
neq10 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq11 := k(v0,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2)); 
neq12 := k(v0,k(k(v2,v1),v1)); 
neq13 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq14 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq15 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(v2,v1)); 
neq16 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0)); 
neq17 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(v2,v0)); 
neq18 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(v2,v1),v1)); 
neq19 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq20 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq21 := k(k(v2,v1),k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0)); 
neq22 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq23 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2)); 
neq24 := k(k(v2,v1),k(v2,v0)); 
neq25 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq26 := k(k(v2,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq27 := k(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq28 := k(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),v1); 
neq29 := k(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),k(v2,v0)); 
neq30 := k(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),k(k(v2,v1),v1)); 
neq31 := k(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),k(k(k(v2,v1),v1),k(v2,v0))); 
neq32 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1); 
neq33 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2)); 
neq34 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(v2,v1),v1)); 
neq35 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq36 := k(v1,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2)); 
neq37 := k(v1,k(v2,v0)); 
neq38 := k(v1,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq39 := k(v1,k(k(k(v2,v1),v1),k(v2,v0))); 
neq40 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),k(v2,v0)); 
neq41 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),k(k(v2,v1),v1)); 
neq42 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq43 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq44 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2)) = 0 and 
       d(k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v2),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
