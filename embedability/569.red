...
neq1 := k(v2,k(v3,v0)); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq4 := k(v2,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq5 := k(v2,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq6 := k(v2,k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq7 := k(v2,k(k(v3,v0),k(k(v2,v1),v2))); 
neq8 := k(v2,v1); 
neq9 := k(k(k(v2,v1),v2),k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2)); 
neq10 := k(k(k(v2,v1),v2),v3); 
neq11 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq12 := k(k(k(v2,v1),v2),v0); 
neq13 := k(k(k(v2,v1),v2),k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq14 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq15 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq16 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq17 := k(k(k(v2,v1),v2),v1); 
neq18 := k(k(v2,v1),k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2)); 
neq19 := k(k(v2,v1),v3); 
neq20 := k(k(v2,v1),k(v3,v0)); 
neq21 := k(k(v2,v1),v0); 
neq22 := k(k(v2,v1),k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq23 := k(k(v2,v1),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq24 := k(k(v2,v1),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq25 := k(k(v2,v1),k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq26 := k(k(v2,v1),k(k(v3,v0),k(k(v2,v1),v2))); 
neq27 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3); 
neq28 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),k(v3,v0)); 
neq29 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v0); 
neq30 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq31 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq32 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),k(k(v3,v0),k(k(v2,v1),v2))); 
neq33 := k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v1); 
neq34 := k(v3,k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq35 := k(v3,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq36 := k(v3,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq37 := k(v3,k(k(v3,v0),k(k(v2,v1),v2))); 
neq38 := k(v3,v1); 
neq39 := k(k(v3,v0),k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq40 := k(k(v3,v0),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq41 := k(k(v3,v0),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq42 := k(k(v3,v0),k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq43 := k(k(v3,v0),v1); 
neq44 := k(v0,k(k(k(v3,v0),k(k(v2,v1),v2)),v1)); 
neq45 := k(v0,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq46 := k(v0,k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq47 := k(v0,k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq48 := k(v0,k(k(v3,v0),k(k(v2,v1),v2))); 
neq49 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))); 
neq50 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1)); 
neq51 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3)); 
neq52 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2))),v1); 
neq53 := k(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1),k(k(v3,v0),k(k(v2,v1),v2))); 
neq54 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2))); 
neq55 := k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1); 
neq56 := k(k(k(v3,v0),k(k(v2,v1),v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),v1),k(k(k(k(k(k(v3,v0),k(k(v2,v1),v2)),v1),v2),v3),k(k(v3,v0),k(k(v2,v1),v2)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
