...
neq1 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(v2,v1)); 
neq2 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)); 
neq3 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(v2,v0),k(k(v2,v1),v1))); 
neq4 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(v2,v0)); 
neq5 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),v1); 
neq6 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(v2,v0),v2)); 
neq7 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(v2,v1),v1)); 
neq8 := k(v2,v0); 
neq9 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq10 := k(v2,k(k(v2,v0),k(k(v2,v1),v1))); 
neq11 := k(v2,v1); 
neq12 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq13 := k(v2,k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq14 := k(v2,k(k(v2,v1),v1)); 
neq15 := k(k(v2,v1),v0); 
neq16 := k(k(v2,v1),k(k(k(v2,v0),v2),v1)); 
neq17 := k(k(v2,v1),k(k(v2,v0),k(k(v2,v1),v1))); 
neq18 := k(k(v2,v1),k(v2,v0)); 
neq19 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq20 := k(k(v2,v1),k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq21 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq22 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq23 := k(v0,k(k(v2,v0),k(k(v2,v1),v1))); 
neq24 := k(v0,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq25 := k(v0,k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq26 := k(v0,k(k(v2,v0),v2)); 
neq27 := k(v0,k(k(v2,v1),v1)); 
neq28 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),k(k(v2,v1),v1))); 
neq29 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq30 := k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq31 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v1)); 
neq32 := k(k(k(v2,v0),k(k(v2,v1),v1)),v1); 
neq33 := k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq34 := k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq35 := k(k(v2,v0),v1); 
neq36 := k(k(v2,v0),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq37 := k(k(v2,v0),k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq38 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq39 := k(v1,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq40 := k(v1,k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq41 := k(v1,k(k(v2,v0),v2)); 
neq42 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v2,v1),v1)); 
neq43 := k(k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq44 := k(k(k(v2,v0),v2),k(k(v2,v1),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))) = 0 and 
       d(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(v2,v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
