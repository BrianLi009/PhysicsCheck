...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(k(k(k(v3,v2),v2),v1),v2); 
neq1 := k(k(k(k(v3,v2),v2),v1),k(k(k(v3,v2),v2),k(k(v3,v1),v3))); 
neq2 := k(k(k(k(v3,v2),v2),v1),k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2))); 
neq3 := k(k(k(k(v3,v2),v2),v1),k(v3,v1)); 
neq4 := k(k(k(k(v3,v2),v2),v1),v0); 
neq5 := k(k(k(k(v3,v2),v2),v1),v3); 
neq6 := k(k(k(k(v3,v2),v2),v1),k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq7 := k(k(k(k(v3,v2),v2),v1),k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq8 := k(k(k(k(v3,v2),v2),v1),k(k(v3,v1),v3)); 
neq9 := k(k(k(k(v3,v2),v2),v1),k(v3,v2)); 
neq10 := k(v2,k(k(k(v3,v2),v2),k(k(v3,v1),v3))); 
neq11 := k(v2,k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2))); 
neq12 := k(v2,k(k(k(k(v3,v2),v2),v1),v1)); 
neq13 := k(v2,k(v3,v1)); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq16 := k(v2,k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq17 := k(v2,k(k(v3,v1),v3)); 
neq18 := k(v2,v1); 
neq19 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(k(k(v3,v2),v2),v1),v1)); 
neq20 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(v3,v1)); 
neq21 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),v0); 
neq22 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),v3); 
neq23 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq24 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq25 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(v3,v2)); 
neq26 := k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),v1); 
neq27 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),k(k(k(k(v3,v2),v2),v1),v1)); 
neq28 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),k(v3,v1)); 
neq29 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0); 
neq30 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v3); 
neq31 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq32 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),k(k(v3,v1),v3)); 
neq33 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),k(v3,v2)); 
neq34 := k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v1); 
neq35 := k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v1)); 
neq36 := k(k(k(k(k(v3,v2),v2),v1),v1),v0); 
neq37 := k(k(k(k(k(v3,v2),v2),v1),v1),v3); 
neq38 := k(k(k(k(k(v3,v2),v2),v1),v1),k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq39 := k(k(k(k(k(v3,v2),v2),v1),v1),k(k(v3,v1),v3)); 
neq40 := k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2)); 
neq41 := k(k(k(k(k(v3,v2),v2),v1),v1),k(k(v3,v2),v2)); 
neq42 := k(k(v3,v1),v0); 
neq43 := k(k(v3,v1),k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq44 := k(k(v3,v1),k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq45 := k(k(v3,v1),k(v3,v2)); 
neq46 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq47 := k(v0,v3); 
neq48 := k(v0,k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq49 := k(v0,k(k(v3,v1),v3)); 
neq50 := k(v0,k(v3,v2)); 
neq51 := k(v0,k(k(v3,v2),v2)); 
neq52 := k(v3,k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))); 
neq53 := k(v3,k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0)); 
neq54 := k(v3,v1); 
neq55 := k(v3,k(k(v3,v2),v2)); 
neq56 := k(k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2)),k(k(v3,v1),v3)); 
neq57 := k(k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2)),v1); 
neq58 := k(k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2)),k(k(v3,v2),v2)); 
neq59 := k(k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0),k(k(v3,v1),v3)); 
neq60 := k(k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0),k(v3,v2)); 
neq61 := k(k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0),v1); 
neq62 := k(k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0),k(k(v3,v2),v2)); 
neq63 := k(k(k(v3,v1),v3),k(v3,v2)); 
neq64 := k(k(k(v3,v1),v3),v1); 
neq65 := k(k(k(v3,v1),v3),k(k(v3,v2),v2)); 
neq66 := k(k(v3,v2),v1); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v2),v2),k(k(v3,v1),v3)),k(k(v3,v2),v2)),v0),k(k(k(k(k(v3,v2),v2),v1),v1),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
