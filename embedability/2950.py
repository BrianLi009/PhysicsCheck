...
def test_embed(): 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_9-(x_3*y_10-y_3*x_10)*y_9)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_9-(y_3*z_10-z_3*y_10)*z_9)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_9-(z_3*x_10-x_3*z_10)*x_9)==0) 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_8-(x_6*y_10-y_6*x_10)*y_8)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_8-(y_6*z_10-z_6*y_10)*z_8)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_8-(z_6*x_10-x_6*z_10)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
