...
def test_embed(): 
    ...
    s.add(((z_11*x_12-x_11*z_12)*z_13-(x_11*y_12-y_11*x_12)*y_13)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_13-(y_11*z_12-z_11*y_12)*z_13)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_13-(z_11*x_12-x_11*z_12)*x_13)==0) 
    s.add(((z_0*x_12-x_0*z_12)*z_2-(x_0*y_12-y_0*x_12)*y_2)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_2-(y_0*z_12-z_0*y_12)*z_2)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_2-(z_0*x_12-x_0*z_12)*x_2)==0) 
    s.add(((z_0*x_10-x_0*z_10)*z_4-(x_0*y_10-y_0*x_10)*y_4)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_4-(y_0*z_10-z_0*y_10)*z_4)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_4-(z_0*x_10-x_0*z_10)*x_4)==0) 
    s.add(((z_0*x_11-x_0*z_11)*z_6-(x_0*y_11-y_0*x_11)*y_6)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_6-(y_0*z_11-z_0*y_11)*z_6)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_6-(z_0*x_11-x_0*z_11)*x_6)==0) 
    s.add(((z_2*x_12-x_2*z_12)*z_1-(x_2*y_12-y_2*x_12)*y_1)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_1-(y_2*z_12-z_2*y_12)*z_1)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_1-(z_2*x_12-x_2*z_12)*x_1)==0) 
    s.add(((z_1*x_10-x_1*z_10)*z_9-(x_1*y_10-y_1*x_10)*y_9)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_9-(y_1*z_10-z_1*y_10)*z_9)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_9-(z_1*x_10-x_1*z_10)*x_9)==0) 
    s.add(((z_4*x_10-x_4*z_10)*z_3-(x_4*y_10-y_4*x_10)*y_3)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_3-(y_4*z_10-z_4*y_10)*z_3)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_3-(z_4*x_10-x_4*z_10)*x_3)==0) 
    s.add(((z_3*x_11-x_3*z_11)*z_8-(x_3*y_11-y_3*x_11)*y_8)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_8-(y_3*z_11-z_3*y_11)*z_8)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_8-(z_3*x_11-x_3*z_11)*x_8)==0) 
    s.add(((z_6*x_10-x_6*z_10)*z_5-(x_6*y_10-y_6*x_10)*y_5)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_5-(y_6*z_10-z_6*y_10)*z_5)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_5-(z_6*x_10-x_6*z_10)*x_5)==0) 
    s.add(((z_5*x_12-x_5*z_12)*z_7-(x_5*y_12-y_5*x_12)*y_7)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_7-(y_5*z_12-z_5*y_12)*z_7)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_7-(z_5*x_12-x_5*z_12)*x_7)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
