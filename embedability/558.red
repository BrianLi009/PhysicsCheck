...
neq2 := k(v2,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1)))); 
neq3 := k(v2,v0); 
...
neq8 := k(v2,v1); 
neq9 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq10 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,v2),k(v0,v1))); 
neq11 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1)))); 
neq12 := k(k(k(v2,k(v0,v1)),v2),v0); 
neq13 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,v2),v1)); 
neq14 := k(k(k(v2,k(v0,v1)),v2),k(v3,v2)); 
neq15 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq16 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v3,v2),v1),v1)); 
neq17 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq18 := k(k(v2,k(v0,v1)),v3); 
neq19 := k(k(v2,k(v0,v1)),k(k(v3,v2),k(v0,v1))); 
neq20 := k(k(v2,k(v0,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1)))); 
neq21 := k(k(v2,k(v0,v1)),v0); 
neq22 := k(k(v2,k(v0,v1)),k(k(v3,v2),v1)); 
neq23 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq24 := k(k(v2,k(v0,v1)),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq25 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v1),v1)); 
neq26 := k(k(v2,k(v0,v1)),v1); 
neq27 := k(v3,k(k(v3,v2),k(v0,v1))); 
neq28 := k(v3,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1)))); 
neq29 := k(v3,k(k(v3,v2),v1)); 
neq30 := k(v3,k(v0,v1)); 
neq31 := k(v3,k(k(k(v3,v2),v1),v1)); 
neq32 := k(v3,v1); 
neq33 := k(k(k(v3,v2),k(v0,v1)),v0); 
neq34 := k(k(k(v3,v2),k(v0,v1)),k(k(v3,v2),v1)); 
neq35 := k(k(k(v3,v2),k(v0,v1)),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq36 := k(k(k(v3,v2),k(v0,v1)),k(k(k(v3,v2),v1),v1)); 
neq37 := k(k(k(v3,v2),k(v0,v1)),v1); 
neq38 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),v0); 
neq39 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),k(k(v3,v2),v1)); 
neq40 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),k(v3,v2)); 
neq41 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),k(v0,v1)); 
neq42 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),v1); 
neq43 := k(v0,k(k(v3,v2),v1)); 
neq44 := k(v0,k(v3,v2)); 
neq45 := k(v0,k(v3,k(k(v2,k(v0,v1)),v2))); 
neq46 := k(v0,k(k(k(v3,v2),v1),v1)); 
neq47 := k(k(k(v3,v2),v1),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq48 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq49 := k(k(v3,v2),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq50 := k(k(v3,v2),k(v0,v1)); 
neq51 := k(k(v3,v2),k(k(k(v3,v2),v1),v1)); 
neq52 := k(k(v3,v2),v1); 
neq53 := k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq54 := k(k(v3,k(k(v2,k(v0,v1)),v2)),v1); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,v2),v1),v1),k(v3,k(k(v2,k(v0,v1)),v2))) = 0 and 
       d(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v3,v2),k(v0,v1))),k(k(k(v3,v2),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
