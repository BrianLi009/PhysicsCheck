...
neq1 := k(v2,k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0)); 
neq2 := k(v2,k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3)); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(v3,v1),k(v2,v0))); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,v1); 
neq9 := k(k(v2,v0),k(k(k(v3,v1),k(v2,v0)),k(v2,v1))); 
neq10 := k(k(v2,v0),k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0)); 
neq11 := k(k(v2,v0),k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3)); 
neq12 := k(k(v2,v0),k(v2,v1)); 
neq13 := k(k(v2,v0),v3); 
neq14 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq15 := k(k(v2,v0),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq16 := k(k(v2,v0),k(v3,v1)); 
neq17 := k(k(v2,v0),v1); 
neq18 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0)); 
neq19 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3)); 
neq20 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),v0); 
neq21 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),v3); 
neq22 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)); 
neq23 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(v3,v1)); 
neq24 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),v1); 
neq25 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),k(v2,v1)); 
neq26 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),k(k(v3,v1),k(v2,v0))); 
neq27 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),v3); 
neq28 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),k(k(v3,v1),v2)); 
neq29 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),k(v3,v1)); 
neq30 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0),v1); 
neq31 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),k(v2,v1)); 
neq32 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),v0); 
neq33 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),k(k(v3,v1),k(v2,v0))); 
neq34 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),k(k(v3,v1),v2)); 
neq35 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),k(v3,v1)); 
neq36 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),v1); 
neq37 := k(k(v2,v1),v0); 
neq38 := k(k(v2,v1),k(k(v3,v1),k(v2,v0))); 
neq39 := k(k(v2,v1),v3); 
neq40 := k(k(v2,v1),k(k(v3,v1),v2)); 
neq41 := k(k(v2,v1),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq42 := k(k(v2,v1),k(v3,v1)); 
neq43 := k(v0,k(k(v3,v1),k(v2,v0))); 
neq44 := k(v0,v3); 
neq45 := k(v0,k(k(v3,v1),v2)); 
neq46 := k(v0,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq47 := k(v0,k(v3,v1)); 
neq48 := k(k(k(v3,v1),k(v2,v0)),v3); 
neq49 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v1),v2)); 
neq50 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq51 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq52 := k(v3,k(k(v3,v1),v2)); 
neq53 := k(v3,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2))); 
neq54 := k(k(k(v3,v1),v2),v1); 
neq55 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),k(v3,v1)); 
neq56 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v3),k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v1)),k(k(v3,v1),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
