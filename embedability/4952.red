...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0))); 
neq1 := k(k(v3,v0),v2); 
neq2 := k(k(v3,v0),k(k(k(k(v3,v1),v3),v2),v2)); 
neq3 := k(k(v3,v0),k(k(k(v3,v1),v3),v2)); 
neq4 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq5 := k(k(v3,v0),k(k(v3,v1),v1)); 
neq6 := k(k(v3,v0),k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq7 := k(k(v3,v0),k(k(v3,v1),v3)); 
neq8 := k(k(v3,v0),v1); 
neq9 := k(k(v3,v0),k(v3,v1)); 
neq10 := k(k(k(v3,v0),v0),v2); 
neq11 := k(k(k(v3,v0),v0),k(k(k(k(v3,v1),v3),v2),v2)); 
neq12 := k(k(k(v3,v0),v0),k(k(k(v3,v1),v3),v2)); 
neq13 := k(k(k(v3,v0),v0),v3); 
neq14 := k(k(k(v3,v0),v0),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq15 := k(k(k(v3,v0),v0),k(k(v3,v1),v1)); 
neq16 := k(k(k(v3,v0),v0),k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq17 := k(k(k(v3,v0),v0),k(k(v3,v1),v3)); 
neq18 := k(k(k(v3,v0),v0),v1); 
neq19 := k(k(k(v3,v0),v0),k(v3,v1)); 
neq20 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),v2); 
neq21 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),v0); 
neq22 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),k(k(k(k(v3,v1),v3),v2),v2)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),k(k(k(v3,v1),v3),v2)); 
neq24 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),v3); 
neq25 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),k(k(v3,v1),v1)); 
neq26 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),k(k(v3,v1),v3)); 
neq27 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),v1); 
neq28 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0)),k(v3,v1)); 
neq29 := k(v2,v0); 
neq30 := k(v2,v3); 
neq31 := k(v2,k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq32 := k(v2,k(k(v3,v1),v1)); 
neq33 := k(v2,k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq34 := k(v2,k(k(v3,v1),v3)); 
neq35 := k(v2,k(v3,v1)); 
neq36 := k(v0,k(k(k(k(v3,v1),v3),v2),v2)); 
neq37 := k(v0,k(k(k(v3,v1),v3),v2)); 
neq38 := k(v0,v3); 
neq39 := k(v0,k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq40 := k(v0,k(k(v3,v1),v1)); 
neq41 := k(v0,k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq42 := k(v0,k(k(v3,v1),v3)); 
neq43 := k(v0,k(v3,v1)); 
neq44 := k(k(k(k(k(v3,v1),v3),v2),v2),v3); 
neq45 := k(k(k(k(k(v3,v1),v3),v2),v2),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq46 := k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)); 
neq47 := k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v3)); 
neq48 := k(k(k(k(k(v3,v1),v3),v2),v2),v1); 
neq49 := k(k(k(k(k(v3,v1),v3),v2),v2),k(v3,v1)); 
neq50 := k(k(k(k(v3,v1),v3),v2),v3); 
neq51 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq52 := k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v1)); 
neq53 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq54 := k(k(k(k(v3,v1),v3),v2),v1); 
neq55 := k(k(k(k(v3,v1),v3),v2),k(v3,v1)); 
neq56 := k(v3,k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3))); 
neq57 := k(v3,k(k(v3,v1),v1)); 
neq58 := k(v3,k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1))); 
neq59 := k(v3,v1); 
neq60 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)),k(k(v3,v1),v1)); 
neq61 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)),v1); 
neq62 := k(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)),k(v3,v1)); 
neq63 := k(k(k(v3,v1),v1),k(k(v3,v1),v3)); 
neq64 := k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)); 
neq65 := k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),v1); 
neq66 := k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(v3,v1)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)),k(k(k(k(k(k(v3,v1),v3),v2),v2),k(k(v3,v1),v1)),k(k(v3,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
