...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_4-(x_1*y_11-y_1*x_11)*y_4)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_4-(y_1*z_11-z_1*y_11)*z_4)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_4-(z_1*x_11-x_1*z_11)*x_4)==0) 
