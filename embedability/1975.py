...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_3-(x_1*y_11-y_1*x_11)*y_3)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_3-(y_1*z_11-z_1*y_11)*z_3)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_3-(z_1*x_11-x_1*z_11)*x_3)==0) 
