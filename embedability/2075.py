...
def test_embed(): 
    ...
    s.add(((z_1*x_4-x_1*z_4)*z_3-(x_1*y_4-y_1*x_4)*y_3)==0) 
    s.add(((x_1*y_4-y_1*x_4)*x_3-(y_1*z_4-z_1*y_4)*z_3)==0) 
    s.add(((y_1*z_4-z_1*y_4)*y_3-(z_1*x_4-x_1*z_4)*x_3)==0) 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_2-(x_5*y_13-y_5*x_13)*y_2)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_2-(y_5*z_13-z_5*y_13)*z_2)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_2-(z_5*x_13-x_5*z_13)*x_2)==0) 
