...
def test_embed(): 
    ...
    s.add(((z_1*x_2-x_1*z_2)*z_5-(x_1*y_2-y_1*x_2)*y_5)==0) 
    s.add(((x_1*y_2-y_1*x_2)*x_5-(y_1*z_2-z_1*y_2)*z_5)==0) 
    s.add(((y_1*z_2-z_1*y_2)*y_5-(z_1*x_2-x_1*z_2)*x_5)==0) 
    s.add(((z_0*x_1-x_0*z_1)*z_6-(x_0*y_1-y_0*x_1)*y_6)==0) 
    s.add(((x_0*y_1-y_0*x_1)*x_6-(y_0*z_1-z_0*y_1)*z_6)==0) 
    s.add(((y_0*z_1-z_0*y_1)*y_6-(z_0*x_1-x_0*z_1)*x_6)==0) 
    s.add(((z_3*x_4-x_3*z_4)*z_10-(x_3*y_4-y_3*x_4)*y_10)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_10-(y_3*z_4-z_3*y_4)*z_10)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_10-(z_3*x_4-x_3*z_4)*x_10)==0) 
    s.add(((z_5*x_8-x_5*z_8)*z_11-(x_5*y_8-y_5*x_8)*y_11)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_11-(y_5*z_8-z_5*y_8)*z_11)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_11-(z_5*x_8-x_5*z_8)*x_11)==0) 
    s.add(((z_6*x_7-x_6*z_7)*z_12-(x_6*y_7-y_6*x_7)*y_12)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_12-(y_6*z_7-z_6*y_7)*z_12)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_12-(z_6*x_7-x_6*z_7)*x_12)==0) 
    s.add(((z_2*x_7-x_2*z_7)*z_13-(x_2*y_7-y_2*x_7)*y_13)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_13-(y_2*z_7-z_2*y_7)*z_13)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_13-(z_2*x_7-x_2*z_7)*x_13)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_7 == 0) 
