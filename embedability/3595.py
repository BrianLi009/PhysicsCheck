...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_7-(x_0*y_10-y_0*x_10)*y_7)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_7-(y_0*z_10-z_0*y_10)*z_7)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_7-(z_0*x_10-x_0*z_10)*x_7)==0) 
    ...
    s.add(((z_5*x_11-x_5*z_11)*z_8-(x_5*y_11-y_5*x_11)*y_8)==0) 
    s.add(((x_5*y_11-y_5*x_11)*x_8-(y_5*z_11-z_5*y_11)*z_8)==0) 
    s.add(((y_5*z_11-z_5*y_11)*y_8-(z_5*x_11-x_5*z_11)*x_8)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
