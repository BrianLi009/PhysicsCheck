...
neq20 := k(v2,v3); 
neq21 := k(v2,v0); 
neq22 := k(v2,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq23 := k(v2,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3))); 
neq24 := k(v2,k(v0,v1)); 
neq25 := k(v2,k(v3,v1)); 
neq26 := k(v2,v1); 
neq27 := k(v2,k(k(v3,v0),v3)); 
neq28 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq29 := k(k(k(v2,v1),v2),v3); 
neq30 := k(k(k(v2,v1),v2),v0); 
neq31 := k(k(k(v2,v1),v2),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq32 := k(k(k(v2,v1),v2),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3))); 
neq33 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq34 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq35 := k(k(k(v2,v1),v2),v1); 
neq36 := k(k(k(v2,v1),v2),k(k(v3,v0),v3)); 
neq37 := k(k(v3,v0),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq38 := k(k(v3,v0),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3))); 
neq39 := k(k(v3,v0),k(v0,v1)); 
neq40 := k(k(v3,v0),k(v3,v1)); 
neq41 := k(k(v3,v0),k(v2,v1)); 
neq42 := k(k(v3,v0),v1); 
neq43 := k(v3,v0); 
neq44 := k(v3,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq45 := k(v3,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3))); 
neq46 := k(v3,k(v0,v1)); 
neq47 := k(v3,k(v2,v1)); 
neq48 := k(v3,v1); 
neq49 := k(v0,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq50 := k(v0,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3))); 
neq51 := k(v0,k(v3,v1)); 
neq52 := k(v0,k(v2,v1)); 
neq53 := k(v0,k(k(v3,v0),v3)); 
neq54 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(v0,v1)); 
neq55 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(v3,v1)); 
neq56 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(v2,v1)); 
neq57 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),v1); 
neq58 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3)),k(v0,v1)); 
neq59 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3)),k(v3,v1)); 
neq60 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3)),k(v2,v1)); 
neq61 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3)),v1); 
...
phi := 
       ...
       d(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v3,v0),v3)),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
