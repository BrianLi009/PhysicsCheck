...
neq5 := k(v2,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq6 := k(v2,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq7 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq8 := k(v2,k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq9 := k(v2,k(k(v3,v0),v3)); 
neq10 := k(k(k(v2,v1),v2),v0); 
neq11 := k(k(k(v2,v1),v2),v1); 
neq12 := k(k(k(v2,v1),v2),v3); 
neq13 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq14 := k(k(k(v2,v1),v2),k(k(k(v3,v0),v3),v1)); 
neq15 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq16 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq17 := k(k(k(v2,v1),v2),k(k(k(v3,v0),v3),v2)); 
neq18 := k(k(k(v2,v1),v2),k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq19 := k(k(k(v2,v1),v2),k(k(v3,v0),v3)); 
neq20 := k(k(v2,v1),v0); 
neq21 := k(k(v2,v1),v3); 
neq22 := k(k(v2,v1),k(v3,v0)); 
neq23 := k(k(v2,v1),k(k(k(v3,v0),v3),v1)); 
neq24 := k(k(v2,v1),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq25 := k(k(v2,v1),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq26 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq27 := k(k(v2,v1),k(k(k(v3,v0),v3),v2)); 
neq28 := k(k(v2,v1),k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq29 := k(k(v2,v1),k(k(v3,v0),v3)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(k(k(v3,v0),v3),v1)); 
neq32 := k(v0,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq33 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq34 := k(v0,k(k(k(v3,v0),v3),v2)); 
neq35 := k(v0,k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq36 := k(v0,k(k(v3,v0),v3)); 
neq37 := k(v1,v3); 
neq38 := k(v1,k(v3,v0)); 
neq39 := k(v1,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq40 := k(v1,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq41 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq42 := k(v1,k(k(k(v3,v0),v3),v2)); 
neq43 := k(v1,k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq44 := k(v1,k(k(v3,v0),v3)); 
neq45 := k(v3,k(k(k(v3,v0),v3),v1)); 
neq46 := k(v3,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq47 := k(v3,k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq48 := k(v3,k(k(k(v3,v0),v3),v2)); 
neq49 := k(v3,k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq50 := k(k(v3,v0),k(k(k(v3,v0),v3),v1)); 
neq51 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq52 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1))); 
neq53 := k(k(v3,v0),k(v3,k(k(v2,v1),v2))); 
neq54 := k(k(v3,v0),k(k(k(v3,v0),v3),v2)); 
neq55 := k(k(v3,v0),k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq56 := k(k(k(k(v3,v0),v3),v1),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)); 
neq57 := k(k(k(k(v3,v0),v3),v1),k(v3,k(k(v2,v1),v2))); 
neq58 := k(k(k(k(v3,v0),v3),v1),k(k(k(v3,v0),v3),v2)); 
neq59 := k(k(k(k(v3,v0),v3),v1),k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2)))); 
neq60 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0),k(v3,k(k(v2,v1),v2))); 
neq61 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0),k(k(k(v3,v0),v3),v2)); 
neq62 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0),k(k(v3,v0),v3)); 
neq63 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1)),k(v3,k(k(v2,v1),v2))); 
neq64 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1)),k(k(k(v3,v0),v3),v2)); 
neq65 := k(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1)),k(k(v3,v0),v3)); 
neq66 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v3,v0),v3),v2)); 
neq67 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v0),v3)); 
neq68 := k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(v3,v0),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),k(k(k(v3,v0),v3),v1)),k(k(k(k(k(v3,v0),v3),v2),k(v3,k(k(v2,v1),v2))),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
