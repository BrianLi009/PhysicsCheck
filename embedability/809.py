...
def test_embed(): 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_0-(x_5*y_12-y_5*x_12)*y_0)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_0-(y_5*z_12-z_5*y_12)*z_0)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_0-(z_5*x_12-x_5*z_12)*x_0)==0) 
    s.add(((z_6*x_11-x_6*z_11)*z_1-(x_6*y_11-y_6*x_11)*y_1)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_1-(y_6*z_11-z_6*y_11)*z_1)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_1-(z_6*x_11-x_6*z_11)*x_1)==0) 
