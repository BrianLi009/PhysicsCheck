...
def test_embed(): 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_2-(x_5*y_12-y_5*x_12)*y_2)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_2-(y_5*z_12-z_5*y_12)*z_2)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_2-(z_5*x_12-x_5*z_12)*x_2)==0) 
    s.add(((z_2*x_11-x_2*z_11)*z_6-(x_2*y_11-y_2*x_11)*y_6)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_6-(y_2*z_11-z_2*y_11)*z_6)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_6-(z_2*x_11-x_2*z_11)*x_6)==0) 
    s.add(((z_6*x_10-x_6*z_10)*z_4-(x_6*y_10-y_6*x_10)*y_4)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_4-(y_6*z_10-z_6*y_10)*z_4)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_4-(z_6*x_10-x_6*z_10)*x_4)==0) 
