...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq1 := k(k(v2,v1),k(k(k(v2,v1),v2),k(v0,v1))); 
neq2 := k(k(v2,v1),k(k(k(v2,k(v0,v1)),v2),v1)); 
neq3 := k(k(v2,v1),v0); 
neq4 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq5 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq6 := k(k(v2,v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq7 := k(k(v2,v1),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq8 := k(k(v2,v1),k(v0,v1)); 
neq9 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq10 := k(k(v2,k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v1)); 
neq11 := k(k(v2,k(v0,v1)),v0); 
neq12 := k(k(v2,k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq13 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
...
neq17 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v1)); 
neq18 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq19 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq20 := k(k(k(k(v2,v1),v2),k(v0,v1)),v2); 
neq21 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
neq22 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq23 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq24 := k(k(k(k(v2,k(v0,v1)),v2),v1),v0); 
neq25 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq26 := k(k(k(k(v2,k(v0,v1)),v2),v1),v2); 
neq27 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,v1),v2)); 
neq28 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
...
neq35 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),v2); 
neq36 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v2,v1),v2)); 
neq37 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v2,k(v0,v1)),v2)); 
neq38 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),k(v0,v1)); 
neq39 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),v1); 
neq40 := k(v2,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq41 := k(v2,k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq42 := k(v2,k(v0,v1)); 
neq43 := k(v2,v1); 
neq44 := k(k(k(v2,v1),v2),k(k(v2,k(v0,v1)),v2)); 
neq45 := k(k(k(v2,v1),v2),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq46 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq47 := k(k(k(v2,v1),v2),v1); 
neq48 := k(k(k(v2,k(v0,v1)),v2),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))); 
neq49 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq50 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq51 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),k(v0,v1)); 
neq52 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v1); 
neq53 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq54 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2))) = 0 and 
       d(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
