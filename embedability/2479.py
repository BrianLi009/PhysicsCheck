...
def test_embed(): 
    ...
    s.add(((z_0*x_11-x_0*z_11)*z_9-(x_0*y_11-y_0*x_11)*y_9)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_9-(y_0*z_11-z_0*y_11)*z_9)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_9-(z_0*x_11-x_0*z_11)*x_9)==0) 
