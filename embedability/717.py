...
def test_embed(): 
    ...
    s.add(((z_2*x_3-x_2*z_3)*z_8-(x_2*y_3-y_2*x_3)*y_8)==0) 
    s.add(((x_2*y_3-y_2*x_3)*x_8-(y_2*z_3-z_2*y_3)*z_8)==0) 
    s.add(((y_2*z_3-z_2*y_3)*y_8-(z_2*x_3-x_2*z_3)*x_8)==0) 
    ...
    s.add(((z_1*x_4-x_1*z_4)*z_11-(x_1*y_4-y_1*x_4)*y_11)==0) 
    s.add(((x_1*y_4-y_1*x_4)*x_11-(y_1*z_4-z_1*y_4)*z_11)==0) 
    s.add(((y_1*z_4-z_1*y_4)*y_11-(z_1*x_4-x_1*z_4)*x_11)==0) 
