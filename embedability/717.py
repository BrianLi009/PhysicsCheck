...
def test_embed(): 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_0-(x_7*y_13-y_7*x_13)*y_0)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_0-(y_7*z_13-z_7*y_13)*z_0)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_0-(z_7*x_13-x_7*z_13)*x_0)==0) 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_2-(x_8*y_10-y_8*x_10)*y_2)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_2-(y_8*z_10-z_8*y_10)*z_2)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_2-(z_8*x_10-x_8*z_10)*x_2)==0) 
    ...
    s.add(((z_3*x_7-x_3*z_7)*z_5-(x_3*y_7-y_3*x_7)*y_5)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_5-(y_3*z_7-z_3*y_7)*z_5)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_5-(z_3*x_7-x_3*z_7)*x_5)==0) 
