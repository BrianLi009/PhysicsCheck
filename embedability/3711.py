...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_10-(x_8*y_11-y_8*x_11)*y_10)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_10-(y_8*z_11-z_8*y_11)*z_10)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_10-(z_8*x_11-x_8*z_11)*x_10)==0) 
