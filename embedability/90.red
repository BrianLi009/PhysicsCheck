...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v2,k(k(k(k(v3,v0),v2),v1),k(v2,v0))); 
neq1 := k(v2,k(v3,k(v2,v0))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3)); 
neq6 := k(v2,k(k(k(v3,v0),v2),v1)); 
neq7 := k(v2,k(v3,v0)); 
neq8 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq9 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),k(v3,k(v2,v0))); 
neq10 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v0); 
neq11 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq12 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),k(k(v3,v0),v2)); 
neq13 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3); 
neq14 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v1); 
neq15 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),k(v3,v0)); 
neq16 := k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),k(k(v3,k(v2,v0)),v1)); 
neq17 := k(k(v3,k(v2,v0)),v0); 
neq18 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq19 := k(k(v3,k(v2,v0)),k(k(v3,v0),v2)); 
neq20 := k(k(v3,k(v2,v0)),v1); 
neq21 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3)); 
neq22 := k(k(v3,k(v2,v0)),k(k(k(v3,v0),v2),v1)); 
neq23 := k(k(v3,k(v2,v0)),k(v3,v0)); 
neq24 := k(v0,k(k(k(v3,k(v2,v0)),v1),v2)); 
neq25 := k(v0,k(k(v3,v0),v2)); 
neq26 := k(v0,v3); 
neq27 := k(v0,k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3)); 
neq28 := k(v0,k(k(k(v3,v0),v2),v1)); 
neq29 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq30 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(k(v3,v0),v2)); 
neq31 := k(k(k(k(v3,k(v2,v0)),v1),v2),v3); 
neq32 := k(k(k(k(v3,k(v2,v0)),v1),v2),v1); 
neq33 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(k(k(v3,v0),v2),v1)); 
neq34 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v3,v0)); 
neq35 := k(k(k(k(v3,k(v2,v0)),v1),v2),k(v2,v0)); 
neq36 := k(k(k(v3,v0),v2),v3); 
neq37 := k(k(k(v3,v0),v2),v1); 
neq38 := k(k(k(v3,v0),v2),k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3)); 
neq39 := k(k(k(v3,v0),v2),k(k(v3,k(v2,v0)),v1)); 
neq40 := k(k(k(v3,v0),v2),k(v2,v0)); 
neq41 := k(v3,v1); 
neq42 := k(v3,k(k(k(v3,v0),v2),v1)); 
neq43 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq44 := k(v3,k(v2,v0)); 
neq45 := k(v1,k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3)); 
neq46 := k(v1,k(v3,v0)); 
neq47 := k(v1,k(v2,v0)); 
neq48 := k(k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3),k(k(k(v3,v0),v2),v1)); 
neq49 := k(k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3),k(v3,v0)); 
neq50 := k(k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3),k(k(v3,k(v2,v0)),v1)); 
neq51 := k(k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3),k(v2,v0)); 
neq52 := k(k(k(k(v3,v0),v2),v1),k(v3,v0)); 
neq53 := k(k(k(k(v3,v0),v2),v1),k(k(v3,k(v2,v0)),v1)); 
neq54 := k(k(k(k(v3,v0),v2),v1),k(v2,v0)); 
neq55 := k(k(v3,v0),k(k(v3,k(v2,v0)),v1)); 
neq56 := k(k(v3,v0),k(v2,v0)); 
neq57 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v0),v2),v1),k(v2,v0)),v3),k(k(k(v3,k(v2,v0)),v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
