...
neq12 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),v1),k(v3,v0))); 
neq13 := k(k(k(v3,v2),v1),k(k(v2,v0),v2)); 
neq14 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq15 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq16 := k(k(k(v3,v2),v1),k(v3,v0)); 
neq17 := k(v3,v0); 
neq18 := k(v3,k(k(k(k(v3,v2),v1),v1),k(v3,v0))); 
neq19 := k(v3,k(k(v2,v0),v2)); 
neq20 := k(v3,k(v2,v0)); 
neq21 := k(v3,k(k(k(v3,v2),v1),v1)); 
neq22 := k(v3,v1); 
neq23 := k(v3,k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq24 := k(k(k(v3,v2),v3),v0); 
neq25 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v1),v1),k(v3,v0))); 
...
neq31 := k(v0,k(k(k(k(v3,v2),v1),v1),k(v3,v0))); 
neq32 := k(v0,k(k(v2,v0),v2)); 
neq33 := k(v0,k(k(k(v3,v2),v1),v1)); 
neq34 := k(v0,k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(k(k(k(v3,v2),v1),v1),k(v3,v0)),k(k(v2,v0),v2)); 
neq37 := k(k(k(k(k(v3,v2),v1),v1),k(v3,v0)),k(v2,v0)); 
neq38 := k(k(k(k(k(v3,v2),v1),v1),k(v3,v0)),v1); 
neq39 := k(k(k(k(k(v3,v2),v1),v1),k(v3,v0)),k(v3,v2)); 
neq40 := k(k(k(v2,v0),v2),k(k(k(v3,v2),v1),v1)); 
neq41 := k(k(k(v2,v0),v2),v1); 
neq42 := k(k(k(v2,v0),v2),k(v3,v0)); 
neq43 := k(k(k(v2,v0),v2),k(v3,v2)); 
neq44 := k(k(v2,v0),k(k(k(v3,v2),v1),v1)); 
neq45 := k(k(v2,v0),v1); 
neq46 := k(k(v2,v0),k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq47 := k(k(v2,v0),k(v3,v0)); 
neq48 := k(k(v2,v0),k(v3,v2)); 
neq49 := k(k(k(k(v3,v2),v1),v1),k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq50 := k(k(k(k(v3,v2),v1),v1),k(v3,v0)); 
neq51 := k(k(k(k(v3,v2),v1),v1),k(v3,v2)); 
neq52 := k(v1,k(k(k(v3,v2),v3),k(k(v2,v0),v2))); 
neq53 := k(v1,k(v3,v0)); 
neq54 := k(v1,k(v3,v2)); 
neq55 := k(k(k(k(v3,v2),v3),k(k(v2,v0),v2)),k(v3,v0)); 
neq56 := k(k(k(k(v3,v2),v3),k(k(v2,v0),v2)),k(v3,v2)); 
...
phi := 
       ...
       d(k(k(k(k(v3,v2),v1),v1),k(v3,v0)),k(k(k(v3,v2),v3),k(k(v2,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
