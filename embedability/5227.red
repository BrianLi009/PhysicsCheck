...
v3 := {v3c1, v3c2, v3c3}; 
v3c3 := 0;
neq0 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(k(v2,v1),v2)); 
neq1 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),v0); 
neq2 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(v0,v1)); 
neq3 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(v2,v1)); 
neq4 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq5 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),v3); 
neq6 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(k(k(v2,v1),v2),v0)); 
neq7 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq8 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),k(v3,k(k(k(v2,v1),v2),v0))); 
neq9 := k(k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2),v1); 
neq10 := k(v2,k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0)))); 
neq11 := k(v2,k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1)); 
neq12 := k(v2,v0); 
neq13 := k(v2,k(v0,v1)); 
neq14 := k(v2,k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq17 := k(v2,k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq18 := k(v2,k(v3,k(k(k(v2,v1),v2),v0))); 
neq19 := k(v2,v1); 
neq20 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0)))); 
neq21 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1)); 
neq22 := k(k(k(v2,v1),v2),v0); 
neq23 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq24 := k(k(k(v2,v1),v2),k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq25 := k(k(k(v2,v1),v2),v3); 
neq26 := k(k(k(v2,v1),v2),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq27 := k(k(k(v2,v1),v2),k(v3,k(k(k(v2,v1),v2),v0))); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1)); 
neq30 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),v0); 
neq31 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(v0,v1)); 
neq32 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(v2,v1)); 
neq33 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq34 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),v3); 
neq35 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(k(k(v2,v1),v2),v0)); 
neq36 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),v1); 
neq37 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v0); 
neq38 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),k(v0,v1)); 
neq39 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),k(v2,v1)); 
neq40 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v3); 
neq41 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),k(k(k(v2,v1),v2),v0)); 
neq42 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq43 := k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),k(v3,k(k(k(v2,v1),v2),v0))); 
neq44 := k(v0,k(v2,v1)); 
neq45 := k(v0,k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq46 := k(v0,v3); 
neq47 := k(v0,k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq48 := k(v0,k(v3,k(k(k(v2,v1),v2),v0))); 
neq49 := k(k(v0,v1),k(v2,v1)); 
neq50 := k(k(v0,v1),k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq51 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq52 := k(k(v0,v1),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq53 := k(k(v0,v1),k(v3,k(k(k(v2,v1),v2),v0))); 
neq54 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v2),v0)),v3)); 
neq55 := k(k(v2,v1),v3); 
neq56 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq57 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq58 := k(k(v2,v1),k(v3,k(k(k(v2,v1),v2),v0))); 
neq59 := k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),k(k(k(v2,v1),v2),v0)); 
neq60 := k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq61 := k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1); 
neq62 := k(v3,k(k(k(v2,v1),v2),v0)); 
neq63 := k(v3,k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq64 := k(v3,v1); 
neq65 := k(k(k(k(v2,v1),v2),v0),k(k(v3,k(k(k(v2,v1),v2),v0)),v1)); 
neq66 := k(k(k(k(v2,v1),v2),v0),v1); 
neq67 := k(k(v3,k(k(k(v2,v1),v2),v0)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v1),k(v3,k(k(k(v2,v1),v2),v0))),k(k(k(k(v3,k(k(k(v2,v1),v2),v0)),v3),v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
