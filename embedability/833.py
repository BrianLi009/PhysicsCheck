...
def test_embed(): 
    ...
    s.add(((z_1*x_4-x_1*z_4)*z_8-(x_1*y_4-y_1*x_4)*y_8)==0) 
    s.add(((x_1*y_4-y_1*x_4)*x_8-(y_1*z_4-z_1*y_4)*z_8)==0) 
    s.add(((y_1*z_4-z_1*y_4)*y_8-(z_1*x_4-x_1*z_4)*x_8)==0) 
    s.add(((z_0*x_5-x_0*z_5)*z_9-(x_0*y_5-y_0*x_5)*y_9)==0) 
    s.add(((x_0*y_5-y_0*x_5)*x_9-(y_0*z_5-z_0*y_5)*z_9)==0) 
    s.add(((y_0*z_5-z_0*y_5)*y_9-(z_0*x_5-x_0*z_5)*x_9)==0) 
    s.add(((z_2*x_3-x_2*z_3)*z_10-(x_2*y_3-y_2*x_3)*y_10)==0) 
    s.add(((x_2*y_3-y_2*x_3)*x_10-(y_2*z_3-z_2*y_3)*z_10)==0) 
    s.add(((y_2*z_3-z_2*y_3)*y_10-(z_2*x_3-x_2*z_3)*x_10)==0) 
    s.add(((z_5*x_7-x_5*z_7)*z_11-(x_5*y_7-y_5*x_7)*y_11)==0) 
    s.add(((x_5*y_7-y_5*x_7)*x_11-(y_5*z_7-z_5*y_7)*z_11)==0) 
    s.add(((y_5*z_7-z_5*y_7)*y_11-(z_5*x_7-x_5*z_7)*x_11)==0) 
    s.add(((z_0*x_3-x_0*z_3)*z_12-(x_0*y_3-y_0*x_3)*y_12)==0) 
    s.add(((x_0*y_3-y_0*x_3)*x_12-(y_0*z_3-z_0*y_3)*z_12)==0) 
    s.add(((y_0*z_3-z_0*y_3)*y_12-(z_0*x_3-x_0*z_3)*x_12)==0) 
