...
v4c1 := 0;
neq0 := k(k(v3,v2),v0); 
neq1 := k(k(v3,v2),k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))); 
neq2 := k(k(v3,v2),k(v4,k(k(v2,v0),v2))); 
neq3 := k(k(v3,v2),v4); 
neq4 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq5 := k(k(v3,v2),k(v3,v1)); 
neq6 := k(k(v3,v2),k(v2,v0)); 
neq7 := k(k(v3,v2),k(k(v2,v0),v2)); 
neq8 := k(k(v3,v2),v1); 
neq9 := k(k(v3,v2),k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq10 := k(k(k(v3,v2),v1),v2); 
neq11 := k(k(k(v3,v2),v1),v3); 
neq12 := k(k(k(v3,v2),v1),v0); 
neq13 := k(k(k(v3,v2),v1),k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))); 
neq14 := k(k(k(v3,v2),v1),k(v4,k(k(v2,v0),v2))); 
neq15 := k(k(k(v3,v2),v1),v4); 
neq16 := k(k(k(v3,v2),v1),k(k(v3,v1),v3)); 
neq17 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq18 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq19 := k(k(k(v3,v2),v1),k(k(v2,v0),v2)); 
neq20 := k(v2,v3); 
neq21 := k(v2,v0); 
neq22 := k(v2,k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))); 
neq23 := k(v2,k(v4,k(k(v2,v0),v2))); 
neq24 := k(v2,v4); 
neq25 := k(v2,k(k(v3,v1),v3)); 
neq26 := k(v2,k(v3,v1)); 
neq27 := k(v2,v1); 
neq28 := k(v2,k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq29 := k(v3,v0); 
neq30 := k(v3,k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))); 
neq31 := k(v3,k(v4,k(k(v2,v0),v2))); 
neq32 := k(v3,v4); 
neq33 := k(v3,k(v2,v0)); 
neq34 := k(v3,k(k(v2,v0),v2)); 
neq35 := k(v3,v1); 
neq36 := k(v3,k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq37 := k(v0,k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))); 
neq38 := k(v0,k(v4,k(k(v2,v0),v2))); 
neq39 := k(v0,k(k(v3,v1),v3)); 
neq40 := k(v0,k(v3,v1)); 
neq41 := k(v0,k(k(v2,v0),v2)); 
neq42 := k(v0,k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq43 := k(k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))),k(k(v3,v1),v3)); 
neq44 := k(k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))),k(v3,v1)); 
neq45 := k(k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))),k(v2,v0)); 
neq46 := k(k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))),k(k(v2,v0),v2)); 
neq47 := k(k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))),v1); 
neq48 := k(k(v4,k(k(v2,v0),v2)),k(k(v3,v1),v3)); 
neq49 := k(k(v4,k(k(v2,v0),v2)),k(v3,v1)); 
neq50 := k(k(v4,k(k(v2,v0),v2)),k(v2,v0)); 
neq51 := k(k(v4,k(k(v2,v0),v2)),v1); 
neq52 := k(k(v4,k(k(v2,v0),v2)),k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq53 := k(v4,k(k(v3,v1),v3)); 
neq54 := k(v4,k(v3,v1)); 
neq55 := k(v4,k(v2,v0)); 
neq56 := k(v4,k(k(v2,v0),v2)); 
neq57 := k(v4,v1); 
neq58 := k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq59 := k(k(k(v3,v1),v3),k(v2,v0)); 
neq60 := k(k(k(v3,v1),v3),k(k(v2,v0),v2)); 
neq61 := k(k(k(v3,v1),v3),v1); 
neq62 := k(k(v3,v1),k(v2,v0)); 
neq63 := k(k(v3,v1),k(k(v2,v0),v2)); 
neq64 := k(k(v3,v1),k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq65 := k(k(v2,v0),v1); 
neq66 := k(k(v2,v0),k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq67 := k(k(k(v2,v0),v2),v1); 
neq68 := k(k(k(v2,v0),v2),k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
neq69 := k(v1,k(k(k(v3,v2),v1),k(k(v3,v1),v3))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v4,v0) = 0 and 
       d(k(v4,k(k(v2,v0),v2)),k(v4,k(k(k(v3,v2),v1),k(k(v3,v1),v3)))) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
