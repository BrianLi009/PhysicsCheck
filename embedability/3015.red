...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1))); 
neq1 := k(v2,k(k(k(k(k(v3,v1),v1),v2),v3),v0)); 
...
neq10 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(v3,v2)); 
neq11 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),v0); 
neq12 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(k(k(k(k(v3,v1),v1),v2),v3),v3)); 
neq13 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(k(k(v3,v1),v1),v2)); 
neq14 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(v3,v1)); 
neq15 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),v3); 
neq16 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(k(v3,v1),v1)); 
neq17 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),v1); 
neq18 := k(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(k(k(k(v3,v1),v1),v2),v3)); 
neq19 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(v3,v2)); 
neq20 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)); 
neq21 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(k(k(k(k(v3,v1),v1),v2),v3),v3),k(k(v3,v1),v1))); 
neq22 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(k(k(k(v3,v1),v1),v2),v3),v3)); 
neq23 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(k(v3,v1),v1),v2)); 
neq24 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(v3,v1)); 
neq25 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),v3); 
neq26 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v1),v1)); 
neq27 := k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),v1); 
neq28 := k(k(v3,v2),v0); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v1),v2),v3),v0),k(k(v3,v2),v1)),k(k(k(k(k(k(v3,v1),v1),v2),v3),v3),k(k(v3,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
