...
def test_embed(): 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_7-(x_6*y_11-y_6*x_11)*y_7)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_7-(y_6*z_11-z_6*y_11)*z_7)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_7-(z_6*x_11-x_6*z_11)*x_7)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
