...
v2c1 := 0;
neq0 := k(v0,v3); 
neq1 := k(v0,k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))); 
neq2 := k(v0,k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2))); 
neq3 := k(v0,k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq4 := k(v0,k(k(k(k(v3,v1),v3),v2),v1)); 
neq5 := k(v0,k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq6 := k(v0,k(v3,v1)); 
neq7 := k(v0,k(k(v3,v1),v3)); 
neq8 := k(v0,k(k(k(v3,v1),v3),v2)); 
neq9 := k(v0,k(k(v3,v1),v2)); 
neq10 := k(v2,v1); 
neq11 := k(v2,k(k(k(v3,v1),v3),v0)); 
neq12 := k(v2,v3); 
neq13 := k(v2,k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))); 
neq14 := k(v2,k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2))); 
neq15 := k(v2,k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq16 := k(v2,k(k(k(k(v3,v1),v3),v2),v1)); 
neq17 := k(v2,k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq18 := k(v2,k(v3,v1)); 
neq19 := k(v2,k(k(v3,v1),v3)); 
neq20 := k(v1,k(k(k(v3,v1),v3),v0)); 
neq21 := k(v1,v3); 
neq22 := k(v1,k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))); 
neq23 := k(v1,k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2))); 
neq24 := k(v1,k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq25 := k(v1,k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq26 := k(v1,k(k(v3,v1),v3)); 
neq27 := k(v1,k(k(k(v3,v1),v3),v2)); 
neq28 := k(v1,k(k(v3,v1),v2)); 
neq29 := k(k(k(k(v3,v1),v3),v0),v3); 
neq30 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))); 
neq31 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2))); 
neq32 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq33 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(v3,v1),v3),v2),v1)); 
neq34 := k(k(k(k(v3,v1),v3),v0),k(v3,v1)); 
neq35 := k(k(k(k(v3,v1),v3),v0),k(k(k(v3,v1),v3),v2)); 
neq36 := k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)); 
neq37 := k(v3,k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))); 
neq38 := k(v3,k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2))); 
neq39 := k(v3,k(k(k(k(v3,v1),v3),v2),v1)); 
neq40 := k(v3,k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq41 := k(v3,k(k(k(v3,v1),v3),v2)); 
neq42 := k(v3,k(k(v3,v1),v2)); 
neq43 := k(k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2)),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq44 := k(k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2)),k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq45 := k(k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2)),k(v3,v1)); 
neq46 := k(k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2)),k(k(v3,v1),v3)); 
neq47 := k(k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2)),k(k(v3,v1),v2)); 
neq48 := k(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(k(k(k(k(v3,v1),v3),v2),v1),v3)); 
neq49 := k(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(k(k(k(v3,v1),v3),v2),v1)); 
neq50 := k(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(v3,v1)); 
neq51 := k(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(k(v3,v1),v3)); 
neq52 := k(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(k(k(v3,v1),v3),v2)); 
neq53 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),k(v3,v1)); 
neq54 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),k(k(v3,v1),v3)); 
neq55 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),k(k(k(v3,v1),v3),v2)); 
neq56 := k(k(k(k(k(k(v3,v1),v3),v2),v1),v3),k(k(v3,v1),v2)); 
neq57 := k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))); 
neq58 := k(k(k(k(k(v3,v1),v3),v2),v1),k(v3,v1)); 
neq59 := k(k(k(k(k(v3,v1),v3),v2),v1),k(k(v3,v1),v3)); 
neq60 := k(k(k(k(k(v3,v1),v3),v2),v1),k(k(v3,v1),v2)); 
neq61 := k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(v3,v1)); 
neq62 := k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v3)); 
neq63 := k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(k(v3,v1),v3),v2)); 
neq64 := k(k(v3,v1),k(k(k(v3,v1),v3),v2)); 
neq65 := k(k(k(v3,v1),v3),k(k(v3,v1),v2)); 
neq66 := k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v1),v3),v2),v1),v3),k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2))) = 0 and 
       d(k(k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v2)),k(k(v3,v1),v2)),k(k(k(k(k(v3,v1),v3),v2),v1),k(k(k(v3,v1),v3),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
