...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_8-(x_0*y_13-y_0*x_13)*y_8)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_8-(y_0*z_13-z_0*y_13)*z_8)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_8-(z_0*x_13-x_0*z_13)*x_8)==0) 
    s.add(((z_0*x_12-x_0*z_12)*z_11-(x_0*y_12-y_0*x_12)*y_11)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_11-(y_0*z_12-z_0*y_12)*z_11)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_11-(z_0*x_12-x_0*z_12)*x_11)==0) 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_7-(x_1*y_13-y_1*x_13)*y_7)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_7-(y_1*z_13-z_1*y_13)*z_7)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_7-(z_1*x_13-x_1*z_13)*x_7)==0) 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_4-(x_7*y_13-y_7*x_13)*y_4)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_4-(y_7*z_13-z_7*y_13)*z_4)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_4-(z_7*x_13-x_7*z_13)*x_4)==0) 
