...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1))); 
neq1 := k(v2,k(k(v2,v1),v1)); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(v3,k(v2,v0))); 
neq5 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)); 
neq6 := k(v2,k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq7 := k(v2,k(k(v3,v2),k(k(v2,v1),v1))); 
neq8 := k(v2,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq9 := k(v2,v1); 
neq10 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(k(v2,v1),v1)); 
neq11 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),v0); 
neq12 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),v3); 
neq13 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v3,k(v2,v0))); 
neq14 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)); 
neq15 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(k(v3,v2),k(k(v2,v1),v1))); 
neq16 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),v1); 
neq17 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v3,v2)); 
neq18 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)); 
neq19 := k(k(k(v2,v1),v1),v0); 
neq20 := k(k(k(v2,v1),v1),v3); 
neq21 := k(k(k(v2,v1),v1),k(v3,k(v2,v0))); 
neq22 := k(k(k(v2,v1),v1),k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)); 
neq23 := k(k(k(v2,v1),v1),k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq24 := k(k(k(v2,v1),v1),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq25 := k(k(k(v2,v1),v1),k(v3,v2)); 
neq26 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq27 := k(v0,v3); 
neq28 := k(v0,k(v3,k(v2,v0))); 
neq29 := k(v0,k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq30 := k(v0,k(k(v3,v2),k(k(v2,v1),v1))); 
neq31 := k(v0,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq32 := k(v0,k(v3,v2)); 
neq33 := k(v0,k(v2,v1)); 
neq34 := k(v3,k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)); 
neq35 := k(v3,k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq36 := k(v3,k(k(v3,v2),k(k(v2,v1),v1))); 
neq37 := k(v3,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq38 := k(v3,k(v2,v0)); 
neq39 := k(v3,k(v2,v1)); 
neq40 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)); 
neq41 := k(k(v3,k(v2,v0)),k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq42 := k(k(v3,k(v2,v0)),k(k(v3,v2),k(k(v2,v1),v1))); 
neq43 := k(k(v3,k(v2,v0)),v1); 
neq44 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq45 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq46 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),v0),k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq47 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),v0),k(k(v3,v2),k(k(v2,v1),v1))); 
neq48 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),v0),v1); 
neq49 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),v0),k(v2,v0)); 
neq50 := k(k(k(k(v3,k(v2,v0)),k(v2,v1)),v0),k(v2,v1)); 
neq51 := k(k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq52 := k(k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1); 
neq53 := k(k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)),k(v3,v2)); 
neq54 := k(k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)),k(v2,v1)); 
neq55 := k(k(k(v3,v2),k(k(v2,v1),v1)),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq56 := k(k(k(v3,v2),k(k(v2,v1),v1)),v1); 
neq57 := k(k(k(v3,v2),k(k(v2,v1),v1)),k(v2,v0)); 
neq58 := k(k(k(v3,v2),k(k(v2,v1),v1)),k(v2,v1)); 
neq59 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq60 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v3,v2)); 
neq61 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq62 := k(v1,k(v3,v2)); 
neq63 := k(v1,k(v2,v0)); 
neq64 := k(k(v3,v2),k(v2,v0)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(v3,v2),k(k(k(v3,k(v2,v0)),k(v2,v1)),v0)) = 0 and 
       d(k(k(v3,v2),k(k(v2,v1),v1)),k(k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v1)),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
