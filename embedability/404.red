...
neq1 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq2 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1)); 
neq3 := k(k(v2,v1),k(v0,v1)); 
neq4 := k(k(v2,v1),v0); 
neq5 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0))); 
neq6 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq7 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq8 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq9 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq10 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq11 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1)); 
neq12 := k(v2,k(v0,v1)); 
neq13 := k(v2,v0); 
...
neq17 := k(v2,v1); 
neq18 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1)); 
neq19 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v0,v1)); 
neq20 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v0); 
neq21 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0))); 
neq22 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq23 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))); 
neq24 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1); 
neq25 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(v0,v1)); 
neq26 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v0); 
neq27 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0))); 
neq28 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq29 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))); 
neq30 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(k(v2,v1),v2)); 
neq31 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0)); 
neq32 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),k(v0,v1)); 
neq33 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),v0); 
neq34 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq35 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),k(v2,k(v0,v1))); 
neq36 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),k(k(v2,v1),v2)); 
neq37 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1),k(k(k(v2,v1),v2),v0)); 
neq38 := k(k(v0,v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0))); 
neq39 := k(k(v0,v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq40 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq41 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq42 := k(v0,k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0))); 
neq43 := k(v0,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq44 := k(v0,k(v2,k(v0,v1))); 
neq45 := k(v0,k(k(v2,v1),v2)); 
neq46 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0)),k(v2,k(v0,v1))); 
neq47 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v2)); 
neq48 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0)),v1); 
neq49 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq50 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0)),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
