...
def test_embed(): 
    ...
    s.add(((z_3*x_7-x_3*z_7)*z_9-(x_3*y_7-y_3*x_7)*y_9)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_9-(y_3*z_7-z_3*y_7)*z_9)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_9-(z_3*x_7-x_3*z_7)*x_9)==0) 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_5-(x_8*y_12-y_8*x_12)*y_5)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_5-(y_8*z_12-z_8*y_12)*z_5)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_5-(z_8*x_12-x_8*z_12)*x_5)==0) 
