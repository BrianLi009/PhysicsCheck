...
neq5 := k(v2,v1); 
neq6 := k(v2,k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
...
neq12 := k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq13 := k(k(k(v3,v2),v1),k(v2,v1)); 
neq14 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq15 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v3),v0)); 
neq16 := k(k(k(v3,v2),v1),k(v3,k(v2,v0))); 
neq17 := k(v3,v0); 
neq18 := k(v3,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq19 := k(v3,v1); 
neq20 := k(v3,k(v2,v1)); 
neq21 := k(v3,k(v2,v0)); 
neq22 := k(v3,k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq23 := k(v3,k(k(k(v3,v2),v3),v0)); 
neq24 := k(k(k(v3,v2),v3),v0); 
neq25 := k(k(k(v3,v2),v3),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq26 := k(k(k(v3,v2),v3),v1); 
neq27 := k(k(k(v3,v2),v3),k(v2,v1)); 
neq28 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq29 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq30 := k(k(k(v3,v2),v3),k(v3,k(v2,v0))); 
neq31 := k(v0,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq32 := k(v0,k(v2,v1)); 
neq33 := k(v0,k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq34 := k(v0,k(v3,k(v2,v0))); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq37 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq38 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(k(v3,v2),v3),v0)); 
neq39 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v3,v2)); 
neq40 := k(v1,k(v2,v0)); 
neq41 := k(v1,k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq42 := k(v1,k(k(k(v3,v2),v3),v0)); 
neq43 := k(v1,k(v3,k(v2,v0))); 
neq44 := k(v1,k(v3,v2)); 
neq45 := k(k(v2,v1),k(v2,v0)); 
neq46 := k(k(v2,v1),k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq47 := k(k(v2,v1),k(k(k(v3,v2),v3),v0)); 
neq48 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq49 := k(k(v2,v1),k(v3,v2)); 
neq50 := k(k(v2,v0),k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))); 
neq51 := k(k(v2,v0),k(k(k(v3,v2),v3),v0)); 
neq52 := k(k(v2,v0),k(v3,v2)); 
neq53 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1))),k(v3,k(v2,v0))); 
neq54 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1))),k(v3,v2)); 
...
phi := 
       ...
       d(k(k(k(v3,v2),v3),v0),k(k(k(v3,v2),v1),k(k(v3,k(v2,v0)),k(v2,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
