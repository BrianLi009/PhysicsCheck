...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),v2); 
neq1 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2)); 
neq2 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),v0); 
neq3 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(k(v3,v1),k(v2,v0))); 
neq4 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(v3,k(v2,v0))); 
neq5 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(k(v3,v1),v1)); 
neq6 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq7 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(v2,v0)); 
neq8 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),v1); 
neq9 := k(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(v3,v1)); 
neq10 := k(v2,k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1)); 
neq11 := k(v2,v3); 
...
neq20 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(k(v3,v1),k(v2,v0)))); 
neq21 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v0); 
neq22 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(k(v3,v1),k(v2,v0))); 
neq23 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(v3,k(v2,v0))); 
neq24 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(k(v3,v1),v1)); 
neq25 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(v2,v0)); 
neq26 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1); 
neq27 := k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),k(v3,v1)); 
neq28 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3); 
neq29 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(k(v3,v1),k(v2,v0)))); 
neq30 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v0); 
neq31 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(k(v3,v1),k(v2,v0))); 
neq32 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(v3,k(v2,v0))); 
neq33 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(k(v3,v1),v1)); 
neq34 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq35 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(v2,v0)); 
neq36 := k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),k(v3,v1)); 
neq37 := k(v3,k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(k(v3,v1),k(v2,v0)))); 
neq38 := k(v3,v0); 
neq39 := k(v3,k(k(v3,v1),k(v2,v0))); 
neq40 := k(v3,k(k(v3,v1),v1)); 
neq41 := k(v3,k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq42 := k(v3,k(v2,v0)); 
neq43 := k(v3,v1); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),v2),v1),v3),k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(k(v3,v1),k(v2,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
