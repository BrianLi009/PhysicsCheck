...
neq2 := k(v2,k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1))); 
neq3 := k(v2,k(v0,v1)); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq6 := k(v2,k(k(k(v3,v1),v3),k(v2,v0))); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq10 := k(v3,k(v2,v0)); 
neq11 := k(v3,k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1))); 
neq12 := k(v3,k(v0,v1)); 
neq13 := k(v3,v0); 
...
neq17 := k(v3,v1); 
neq18 := k(v3,k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq19 := k(k(v2,v0),k(k(v3,v1),v3)); 
neq20 := k(k(v2,v0),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1))); 
neq21 := k(k(v2,v0),k(v0,v1)); 
neq22 := k(k(v2,v0),k(v2,k(v0,v1))); 
neq23 := k(k(v2,v0),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq24 := k(k(v2,v0),k(v2,v1)); 
neq25 := k(k(v2,v0),k(v3,v1)); 
neq26 := k(k(v2,v0),v1); 
neq27 := k(k(v2,v0),k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq28 := k(k(k(v3,v1),v3),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1))); 
neq29 := k(k(k(v3,v1),v3),k(v0,v1)); 
neq30 := k(k(k(v3,v1),v3),v0); 
neq31 := k(k(k(v3,v1),v3),k(v2,k(v0,v1))); 
neq32 := k(k(k(v3,v1),v3),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq33 := k(k(k(v3,v1),v3),k(v2,v1)); 
neq34 := k(k(k(v3,v1),v3),v1); 
neq35 := k(k(k(v3,v1),v3),k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq36 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),k(v0,v1)); 
neq37 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),v0); 
neq38 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),k(v2,k(v0,v1))); 
neq39 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(v3,v1),v3),k(v2,v0))); 
neq40 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),k(v3,v1)); 
neq41 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),v1); 
neq42 := k(k(v0,v1),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq43 := k(k(v0,v1),k(v2,v1)); 
neq44 := k(k(v0,v1),k(k(k(v3,v1),v3),k(v2,v0))); 
neq45 := k(k(v0,v1),k(v3,v1)); 
neq46 := k(k(v0,v1),k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq47 := k(v0,k(v2,k(v0,v1))); 
neq48 := k(v0,k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq49 := k(v0,k(v2,v1)); 
neq50 := k(v0,k(k(k(v3,v1),v3),k(v2,v0))); 
neq51 := k(v0,k(v3,v1)); 
neq52 := k(v0,k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq53 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)); 
neq54 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq55 := k(k(v2,k(v0,v1)),k(k(k(v3,v1),v3),k(v2,v0))); 
neq56 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq57 := k(k(v2,k(v0,v1)),v1); 
neq58 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3),k(v2,v1)); 
neq59 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3),k(k(k(v3,v1),v3),k(v2,v0))); 
neq60 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3),k(v3,v1)); 
neq61 := k(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3),v1); 
neq62 := k(k(v2,v1),k(k(k(v3,v1),v3),k(v2,v0))); 
neq63 := k(k(v2,v1),k(v3,v1)); 
neq64 := k(k(v2,v1),k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq65 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v3,v1)); 
neq66 := k(k(k(k(v3,v1),v3),k(v2,v0)),v1); 
neq67 := k(k(v3,v1),k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq68 := k(v1,k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(k(k(v3,v1),v3),k(v2,v0)),k(v2,k(v0,v1))),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
