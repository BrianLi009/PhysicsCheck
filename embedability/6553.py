...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_6-(x_9*y_13-y_9*x_13)*y_6)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_6-(y_9*z_13-z_9*y_13)*z_6)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_6-(z_9*x_13-x_9*z_13)*x_6)==0) 
