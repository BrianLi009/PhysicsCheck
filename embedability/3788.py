...
def test_embed(): 
    ...
    s.add(((z_10*x_12-x_10*z_12)*z_9-(x_10*y_12-y_10*x_12)*y_9)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_9-(y_10*z_12-z_10*y_12)*z_9)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_9-(z_10*x_12-x_10*z_12)*x_9)==0) 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_1-(x_0*y_13-y_0*x_13)*y_1)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_1-(y_0*z_13-z_0*y_13)*z_1)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_1-(z_0*x_13-x_0*z_13)*x_1)==0) 
    s.add(((z_1*x_9-x_1*z_9)*z_6-(x_1*y_9-y_1*x_9)*y_6)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_6-(y_1*z_9-z_1*y_9)*z_6)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_6-(z_1*x_9-x_1*z_9)*x_6)==0) 
