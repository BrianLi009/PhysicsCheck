...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3)); 
...
neq6 := k(v2,k(v3,v1)); 
neq7 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq8 := k(v2,k(v3,v0)); 
neq9 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),v0); 
neq10 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),v1); 
neq11 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(k(v3,v1),v2)); 
neq12 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(k(k(v3,v1),v2),k(v3,v1))); 
neq13 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq14 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(v3,v1)); 
neq15 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq16 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3),k(v3,v0)); 
neq17 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),v0); 
neq18 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(k(v3,v1),v2)); 
neq19 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2)); 
neq20 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(k(k(v3,v1),v2),k(v3,v1))); 
neq21 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),v3); 
neq22 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(v3,v1)); 
neq23 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq24 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(v3,v0)); 
neq25 := k(v0,k(k(v3,v1),v2)); 
neq26 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2)); 
neq27 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq28 := k(v0,v3); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq30 := k(v0,k(v3,v1)); 
neq31 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq32 := k(v1,k(k(v3,v1),v2)); 
neq33 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2)); 
neq34 := k(v1,k(k(k(v3,v1),v2),k(v3,v1))); 
neq35 := k(v1,v3); 
neq36 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq37 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq38 := k(v1,k(v3,v0)); 
neq39 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2)); 
neq40 := k(k(k(v3,v1),v2),v3); 
neq41 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq42 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq43 := k(k(k(v3,v1),v2),k(v3,v0)); 
neq44 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),k(k(k(v3,v1),v2),k(v3,v1))); 
neq45 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3); 
neq46 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq47 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),k(v3,v1)); 
neq48 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),k(v3,v0)); 
neq49 := k(k(k(k(v3,v1),v2),k(v3,v1)),v3); 
neq50 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq51 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)); 
neq52 := k(v3,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0))); 
neq53 := k(v3,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq54 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),k(v3,v1)); 
neq55 := k(k(v3,v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0))); 
neq56 := k(k(v3,v1),k(v3,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),k(v3,v0)),v1),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v0)),v2),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
