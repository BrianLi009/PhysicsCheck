...
def test_embed(): 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_13-(x_6*y_10-y_6*x_10)*y_13)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_13-(y_6*z_10-z_6*y_10)*z_13)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_13-(z_6*x_10-x_6*z_10)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_1 == 0) 
