...
def test_embed(): 
    ...
    s.add(((z_4*x_8-x_4*z_8)*z_11-(x_4*y_8-y_4*x_8)*y_11)==0) 
    s.add(((x_4*y_8-y_4*x_8)*x_11-(y_4*z_8-z_4*y_8)*z_11)==0) 
    s.add(((y_4*z_8-z_4*y_8)*y_11-(z_4*x_8-x_4*z_8)*x_11)==0) 
    s.add(((z_5*x_9-x_5*z_9)*z_10-(x_5*y_9-y_5*x_9)*y_10)==0) 
    s.add(((x_5*y_9-y_5*x_9)*x_10-(y_5*z_9-z_5*y_9)*z_10)==0) 
    s.add(((y_5*z_9-z_5*y_9)*y_10-(z_5*x_9-x_5*z_9)*x_10)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_1 == 0) 
