...
neq1 := k(k(v3,k(v2,v0)),k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0))); 
neq2 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0))); 
neq3 := k(k(v3,k(v2,v0)),v0); 
neq4 := k(k(v3,k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq5 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3)); 
neq6 := k(k(v3,k(v2,v0)),v1); 
neq7 := k(k(v3,k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq8 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq9 := k(v2,k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0))); 
neq10 := k(v2,k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0))); 
neq11 := k(v2,v3); 
neq12 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq13 := k(v2,k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3)); 
neq14 := k(v2,v1); 
neq15 := k(v2,k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq16 := k(v2,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq17 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),v0); 
neq18 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),v3); 
neq19 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),k(k(v3,k(v2,v0)),v1)); 
neq20 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq21 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),v1); 
neq22 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq23 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq24 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),v0); 
neq25 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),v3); 
neq26 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),k(k(v3,k(v2,v0)),v1)); 
neq27 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq28 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3)); 
neq29 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),v1); 
neq30 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq33 := k(v0,k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq34 := k(v0,k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3)); 
neq35 := k(v0,k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq36 := k(v0,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq37 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq38 := k(v3,k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq39 := k(v3,v1); 
neq40 := k(v3,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq41 := k(v3,k(v2,v0)); 
neq42 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(v3,k(v2,v0)),v1),v1),v2)); 
neq43 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3)); 
neq44 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq45 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq46 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v1); 
neq47 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq48 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),k(v2,v0)); 
neq49 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),v1); 
neq50 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq51 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq52 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)); 
neq53 := k(v1,k(k(k(k(v3,k(v2,v0)),v1),v1),v3)); 
neq54 := k(v1,k(v2,v0)); 
neq55 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0)); 
neq56 := k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,k(v2,v0)),v1),v1),v2),v3),k(v2,v0)),k(k(k(k(k(v3,k(v2,v0)),v1),v1),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
