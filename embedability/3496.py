...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_13-(x_7*y_10-y_7*x_10)*y_13)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_13-(y_7*z_10-z_7*y_10)*z_13)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_13-(z_7*x_10-x_7*z_10)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_2 == 0) 
