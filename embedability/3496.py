...
def test_embed(): 
    ...
    s.add(((z_10*x_11-x_10*z_11)*z_13-(x_10*y_11-y_10*x_11)*y_13)==0) 
    s.add(((x_10*y_11-y_10*x_11)*x_13-(y_10*z_11-z_10*y_11)*z_13)==0) 
    s.add(((y_10*z_11-z_10*y_11)*y_13-(z_10*x_11-x_10*z_11)*x_13)==0) 
    ...
    s.add(((z_0*x_8-x_0*z_8)*z_6-(x_0*y_8-y_0*x_8)*y_6)==0) 
    s.add(((x_0*y_8-y_0*x_8)*x_6-(y_0*z_8-z_0*y_8)*z_6)==0) 
    s.add(((y_0*z_8-z_0*y_8)*y_6-(z_0*x_8-x_0*z_8)*x_6)==0) 
    s.add(((z_2*x_8-x_2*z_8)*z_1-(x_2*y_8-y_2*x_8)*y_1)==0) 
    s.add(((x_2*y_8-y_2*x_8)*x_1-(y_2*z_8-z_2*y_8)*z_1)==0) 
    s.add(((y_2*z_8-z_2*y_8)*y_1-(z_2*x_8-x_2*z_8)*x_1)==0) 
