...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v2,v0); 
neq1 := k(v2,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq2 := k(v2,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0))); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(v3,v1)); 
neq5 := k(v2,k(v3,v0)); 
neq6 := k(v2,v1); 
...
neq9 := k(v0,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq10 := k(v0,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0))); 
neq11 := k(v0,v3); 
neq12 := k(v0,k(v3,v1)); 
neq13 := k(v0,k(v2,v1)); 
neq14 := k(v0,k(k(v3,v0),v2)); 
neq15 := k(v0,k(v3,k(v2,v1))); 
neq16 := k(v0,k(k(k(v3,v0),v2),k(v3,v1))); 
neq17 := k(k(k(v3,k(v2,v1)),k(v2,v0)),v3); 
neq18 := k(k(k(v3,k(v2,v1)),k(v2,v0)),k(v3,v1)); 
neq19 := k(k(k(v3,k(v2,v1)),k(v2,v0)),k(v2,v1)); 
neq20 := k(k(k(v3,k(v2,v1)),k(v2,v0)),k(k(v3,v0),v2)); 
neq21 := k(k(k(v3,k(v2,v1)),k(v2,v0)),k(v3,v0)); 
neq22 := k(k(k(v3,k(v2,v1)),k(v2,v0)),v1); 
neq23 := k(k(k(v3,k(v2,v1)),k(v2,v0)),k(k(k(v3,v0),v2),k(v3,v1))); 
neq24 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),v3); 
neq25 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(v3,v1)); 
neq26 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(v2,v1)); 
neq27 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v0),v2)); 
neq28 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(v3,v0)); 
neq29 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),v1); 
neq30 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(v3,k(v2,v1))); 
neq31 := k(v3,k(v2,v1)); 
neq32 := k(v3,k(k(v3,v0),v2)); 
neq33 := k(v3,v1); 
neq34 := k(v3,k(k(k(v3,v0),v2),k(v3,v1))); 
neq35 := k(v3,k(v2,v0)); 
...
neq42 := k(k(v2,v1),k(v3,v0)); 
neq43 := k(k(v2,v1),k(k(k(v3,v0),v2),k(v3,v1))); 
neq44 := k(k(v2,v1),k(v2,v0)); 
neq45 := k(k(k(v3,v0),v2),v1); 
neq46 := k(k(k(v3,v0),v2),k(v3,k(v2,v1))); 
neq47 := k(k(k(v3,v0),v2),k(v2,v0)); 
neq48 := k(k(v3,v0),v1); 
neq49 := k(k(v3,v0),k(v3,k(v2,v1))); 
neq50 := k(k(v3,v0),k(k(k(v3,v0),v2),k(v3,v1))); 
neq51 := k(k(v3,v0),k(v2,v0)); 
neq52 := k(v1,k(v3,k(v2,v1))); 
neq53 := k(v1,k(k(k(v3,v0),v2),k(v3,v1))); 
neq54 := k(v1,k(v2,v0)); 
neq55 := k(k(v3,k(v2,v1)),k(k(k(v3,v0),v2),k(v3,v1))); 
neq56 := k(k(v3,k(v2,v1)),k(v2,v0)); 
neq57 := k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v2,v0)),k(k(v3,k(v2,v1)),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
