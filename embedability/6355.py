...
def test_embed(): 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_12-(x_3*y_10-y_3*x_10)*y_12)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_12-(y_3*z_10-z_3*y_10)*z_12)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_12-(z_3*x_10-x_3*z_10)*x_12)==0) 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_7-(x_5*y_13-y_5*x_13)*y_7)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_7-(y_5*z_13-z_5*y_13)*z_7)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_7-(z_5*x_13-x_5*z_13)*x_7)==0) 
