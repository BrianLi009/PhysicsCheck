...
v3 := {v3c1, v3c2, v3c3}; 
v3c3 := 0;
neq0 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v2); 
neq1 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v2,v1),v1)); 
neq2 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v3); 
neq3 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v0); 
neq4 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1))); 
neq5 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v3,v2),v2)); 
neq6 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v3,v2)); 
neq7 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v1); 
neq8 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v3,k(v2,v1)),v0)); 
neq9 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)); 
neq10 := k(v2,k(k(v2,v1),v1)); 
neq11 := k(v2,v3); 
neq12 := k(v2,v0); 
neq13 := k(v2,k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1))); 
neq14 := k(v2,k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1))); 
neq15 := k(v2,v1); 
...
neq21 := k(k(k(v2,v1),v1),k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1))); 
neq22 := k(k(k(v2,v1),v1),k(k(v3,v2),v2)); 
neq23 := k(k(k(v2,v1),v1),k(v3,v2)); 
neq24 := k(k(k(v2,v1),v1),k(v3,k(v2,v1))); 
neq25 := k(k(k(v2,v1),v1),k(k(v3,k(v2,v1)),v0)); 
neq26 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq27 := k(v3,v0); 
neq28 := k(v3,k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1))); 
neq29 := k(v3,k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1))); 
neq30 := k(v3,k(k(v3,v2),v2)); 
neq31 := k(v3,v1); 
neq32 := k(v3,k(k(v3,k(v2,v1)),v0)); 
neq33 := k(v3,k(v2,v1)); 
neq34 := k(v0,k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1))); 
neq35 := k(v0,k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1))); 
neq36 := k(v0,k(k(v3,v2),v2)); 
neq37 := k(v0,k(v3,v2)); 
neq38 := k(v0,k(v3,k(v2,v1))); 
neq39 := k(v0,k(v2,v1)); 
neq40 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),k(k(v3,v2),v2)); 
neq41 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),k(v3,v2)); 
neq42 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),v1); 
neq43 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),k(v3,k(v2,v1))); 
neq44 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),k(k(v3,k(v2,v1)),v0)); 
neq45 := k(k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)),k(v2,v1)); 
neq46 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(k(v3,v2),v2)); 
neq47 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(v3,v2)); 
neq48 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),v1); 
neq49 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(v3,k(v2,v1))); 
neq50 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(v0,v1)); 
neq51 := k(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(v2,v1)); 
neq52 := k(k(k(v3,v2),v2),v1); 
neq53 := k(k(k(v3,v2),v2),k(v3,k(v2,v1))); 
neq54 := k(k(k(v3,v2),v2),k(v0,v1)); 
neq55 := k(k(k(v3,v2),v2),k(v2,v1)); 
neq56 := k(k(v3,v2),v1); 
neq57 := k(k(v3,v2),k(v3,k(v2,v1))); 
neq58 := k(k(v3,v2),k(k(v3,k(v2,v1)),v0)); 
neq59 := k(k(v3,v2),k(v0,v1)); 
neq60 := k(k(v3,v2),k(v2,v1)); 
neq61 := k(v1,k(v3,k(v2,v1))); 
neq62 := k(v1,k(k(v3,k(v2,v1)),v0)); 
neq63 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq64 := k(k(k(v3,k(v2,v1)),v0),k(v0,v1)); 
neq65 := k(k(k(v3,k(v2,v1)),v0),k(v2,v1)); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(v3,k(v2,v1)),v0),k(k(v3,v2),v2)) = 0 and 
       d(k(k(k(v3,k(v2,v1)),v0),k(k(v2,v1),v1)),k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
