...
def test_embed(): 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_13-(x_4*y_10-y_4*x_10)*y_13)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_13-(y_4*z_10-z_4*y_10)*z_13)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_13-(z_4*x_10-x_4*z_10)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
