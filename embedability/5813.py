...
def test_embed(): 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_11-(x_5*y_12-y_5*x_12)*y_11)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_11-(y_5*z_12-z_5*y_12)*z_11)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_11-(z_5*x_12-x_5*z_12)*x_11)==0) 
