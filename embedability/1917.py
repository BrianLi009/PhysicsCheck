...
def test_embed(): 
    ...
    s.add(((z_11*x_12-x_11*z_12)*z_10-(x_11*y_12-y_11*x_12)*y_10)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_10-(y_11*z_12-z_11*y_12)*z_10)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_10-(z_11*x_12-x_11*z_12)*x_10)==0) 
    ...
    s.add(((z_2*x_10-x_2*z_10)*z_7-(x_2*y_10-y_2*x_10)*y_7)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_7-(y_2*z_10-z_2*y_10)*z_7)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_7-(z_2*x_10-x_2*z_10)*x_7)==0) 
    ...
    s.add(((z_5*x_9-x_5*z_9)*z_8-(x_5*y_9-y_5*x_9)*y_8)==0) 
    s.add(((x_5*y_9-y_5*x_9)*x_8-(y_5*z_9-z_5*y_9)*z_8)==0) 
    s.add(((y_5*z_9-z_5*y_9)*y_8-(z_5*x_9-x_5*z_9)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
