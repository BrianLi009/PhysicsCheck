...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(v2,v1),k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1)); 
neq1 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1)); 
neq2 := k(k(v2,v1),v0); 
neq3 := k(k(v2,v1),k(v2,v0)); 
neq4 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq5 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq6 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq7 := k(k(v2,v1),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq8 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq9 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1)); 
neq10 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1)); 
neq11 := k(k(k(v2,v1),v1),v0); 
neq12 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq13 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq14 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq15 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq16 := k(k(k(v2,v1),v1),v2); 
neq17 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq18 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),v0); 
neq19 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),k(v2,v0)); 
neq20 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq21 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq22 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),v2); 
neq23 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq24 := k(k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1),k(k(v2,v0),v2)); 
neq25 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),v0); 
neq26 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(v2,v0)); 
neq27 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq28 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq29 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),v2); 
neq30 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq31 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(k(v2,v0),v2)); 
neq32 := k(v0,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq33 := k(v0,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq34 := k(v0,v2); 
neq35 := k(v0,k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq36 := k(v0,k(k(v2,v0),v2)); 
neq37 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq38 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq39 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq40 := k(k(v2,v0),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq41 := k(k(v2,v0),v1); 
neq42 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0)); 
neq43 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2)); 
neq44 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v2); 
neq45 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1); 
neq46 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2); 
neq47 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),k(k(v2,v0),v2)); 
neq48 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v1); 
neq49 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq50 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),k(k(v2,v0),v2)); 
neq51 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1); 
neq52 := k(v2,k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq53 := k(v2,v1); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v1),k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0),v2),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
