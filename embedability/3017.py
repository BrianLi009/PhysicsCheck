...
def test_embed(): 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_1-(x_4*y_10-y_4*x_10)*y_1)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_1-(y_4*z_10-z_4*y_10)*z_1)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_1-(z_4*x_10-x_4*z_10)*x_1)==0) 
