...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),v2); 
neq1 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(v2,v1)); 
neq2 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),v1); 
neq3 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(k(v2,v1),v2)); 
neq4 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq5 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(v3,v2)); 
neq6 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq7 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),v3); 
neq8 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(k(v3,v2),v3)); 
neq9 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0),k(k(k(v3,v2),v3),v1)); 
neq10 := k(v2,v0); 
neq11 := k(v2,v1); 
neq12 := k(v2,k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)))); 
neq13 := k(v2,k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq14 := k(v2,k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq15 := k(v2,k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq16 := k(v2,v3); 
neq17 := k(v2,k(k(v3,v2),v3)); 
neq18 := k(v2,k(k(k(v3,v2),v3),v1)); 
neq19 := k(k(v2,v1),v0); 
neq20 := k(k(v2,v1),k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)))); 
neq21 := k(k(v2,v1),k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq22 := k(k(v2,v1),k(v3,v2)); 
neq23 := k(k(v2,v1),k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq24 := k(k(v2,v1),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq25 := k(k(v2,v1),v3); 
neq26 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq27 := k(k(v2,v1),k(k(k(v3,v2),v3),v1)); 
neq28 := k(v0,k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)))); 
neq29 := k(v0,k(k(v2,v1),v2)); 
neq30 := k(v0,k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq31 := k(v0,k(v3,v2)); 
neq32 := k(v0,k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq33 := k(v0,k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq34 := k(v0,k(k(v3,v2),v3)); 
neq35 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq36 := k(v1,k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)))); 
neq37 := k(v1,k(k(v2,v1),v2)); 
neq38 := k(v1,k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq39 := k(v1,k(v3,v2)); 
neq40 := k(v1,k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq41 := k(v1,k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq42 := k(v1,v3); 
neq43 := k(v1,k(k(v3,v2),v3)); 
neq44 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq45 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(v3,v2)); 
neq46 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq47 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),v3); 
neq48 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(k(v3,v2),v3)); 
neq49 := k(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(k(k(v3,v2),v3),v1)); 
neq50 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3)); 
neq51 := k(k(k(v2,v1),v2),k(v3,v2)); 
neq52 := k(k(k(v2,v1),v2),k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq53 := k(k(k(v2,v1),v2),v3); 
neq54 := k(k(k(v2,v1),v2),k(k(v3,v2),v3)); 
neq55 := k(k(k(v2,v1),v2),k(k(k(v3,v2),v3),v1)); 
neq56 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(v3,v2)); 
neq57 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq58 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(v3,v2),v3)); 
neq59 := k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(v3,v2),v3),v1)); 
neq60 := k(k(v3,v2),k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3))); 
neq61 := k(k(v3,v2),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq62 := k(k(v3,v2),k(k(k(v3,v2),v3),v1)); 
neq63 := k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))); 
neq64 := k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v3); 
neq65 := k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3); 
neq66 := k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),k(k(v3,v2),v3)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2)),v3),k(k(k(k(v3,v2),v3),v1),k(k(v2,v1),v2))),k(k(k(k(k(v3,v2),v3),v1),k(k(v3,v2),v3)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
