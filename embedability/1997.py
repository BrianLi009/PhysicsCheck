...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_5-(x_7*y_10-y_7*x_10)*y_5)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_5-(y_7*z_10-z_7*y_10)*z_5)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_5-(z_7*x_10-x_7*z_10)*x_5)==0) 
    s.add(((z_8*x_9-x_8*z_9)*z_6-(x_8*y_9-y_8*x_9)*y_6)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_6-(y_8*z_9-z_8*y_9)*z_6)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_6-(z_8*x_9-x_8*z_9)*x_6)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_3 == 0) 
