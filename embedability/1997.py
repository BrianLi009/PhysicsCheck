...
def test_embed(): 
    ...
    s.add(((z_0*x_5-x_0*z_5)*z_7-(x_0*y_5-y_0*x_5)*y_7)==0) 
    s.add(((x_0*y_5-y_0*x_5)*x_7-(y_0*z_5-z_0*y_5)*z_7)==0) 
    s.add(((y_0*z_5-z_0*y_5)*y_7-(z_0*x_5-x_0*z_5)*x_7)==0) 
    ...
    s.add(((z_3*x_5-x_3*z_5)*z_10-(x_3*y_5-y_3*x_5)*y_10)==0) 
    s.add(((x_3*y_5-y_3*x_5)*x_10-(y_3*z_5-z_3*y_5)*z_10)==0) 
    s.add(((y_3*z_5-z_3*y_5)*y_10-(z_3*x_5-x_3*z_5)*x_10)==0) 
