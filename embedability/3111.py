...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_11-(x_7*y_10-y_7*x_10)*y_11)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_11-(y_7*z_10-z_7*y_10)*z_11)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_11-(z_7*x_10-x_7*z_10)*x_11)==0) 
