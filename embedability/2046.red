...
v3c2 := 0;
neq0 := k(v2,k(v0,v1)); 
neq1 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1))); 
...
neq9 := k(v2,v3); 
neq10 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)))); 
neq11 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2)); 
neq12 := k(k(v0,v1),k(k(k(k(v3,v2),v3),v0),v2)); 
neq13 := k(k(v0,v1),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq14 := k(k(v0,v1),k(v3,v2)); 
neq15 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
neq16 := k(k(v0,v1),k(k(k(v3,v2),v3),v0)); 
neq17 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq18 := k(k(v0,v1),v3); 
neq19 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),v0); 
neq20 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),v1); 
neq21 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1))); 
neq22 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(k(k(k(v3,v2),v3),v0),v2)); 
neq23 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(v3,v2)); 
neq24 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(k(k(v3,v2),v3),v0)); 
neq25 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(k(v3,v2),v3)); 
neq26 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),v3); 
neq27 := k(v0,k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1))); 
neq28 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2)); 
neq29 := k(v0,k(k(k(k(v3,v2),v3),v0),v2)); 
neq30 := k(v0,k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq31 := k(v0,k(v3,v2)); 
neq32 := k(v0,k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
neq33 := k(v0,k(k(v3,v2),v3)); 
neq34 := k(v0,v3); 
neq35 := k(v1,k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1))); 
neq36 := k(v1,k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2)); 
neq37 := k(v1,k(k(k(k(v3,v2),v3),v0),v2)); 
neq38 := k(v1,k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq39 := k(v1,k(v3,v2)); 
neq40 := k(v1,k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
neq41 := k(v1,k(k(k(v3,v2),v3),v0)); 
neq42 := k(v1,k(k(v3,v2),v3)); 
neq43 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2)); 
neq44 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq45 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),k(v3,v2)); 
neq46 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),k(k(k(v3,v2),v3),v0)); 
neq47 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),k(k(v3,v2),v3)); 
neq48 := k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),k(k(k(k(v3,v2),v3),v0),v2)); 
neq50 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq51 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),k(v3,v2)); 
neq52 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),k(k(k(v3,v2),v3),v0)); 
neq53 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),k(k(v3,v2),v3)); 
neq54 := k(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2),v3); 
neq55 := k(k(k(k(k(v3,v2),v3),v0),v2),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq56 := k(k(k(k(k(v3,v2),v3),v0),v2),k(v3,v2)); 
neq57 := k(k(k(k(k(v3,v2),v3),v0),v2),k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
...
neq61 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
neq62 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v3); 
neq63 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3)); 
neq64 := k(k(v3,v2),k(k(k(v3,v2),v3),v0)); 
neq65 := k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(v3,v2),v3),v0)); 
neq66 := k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(v3,v2),v3)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))),k(k(k(k(k(k(k(v3,v2),v3),v0),v2),k(v0,v1)),v3),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
