...
def test_embed(): 
    ...
    s.add(((z_1*x_7-x_1*z_7)*z_5-(x_1*y_7-y_1*x_7)*y_5)==0) 
    s.add(((x_1*y_7-y_1*x_7)*x_5-(y_1*z_7-z_1*y_7)*z_5)==0) 
    s.add(((y_1*z_7-z_1*y_7)*y_5-(z_1*x_7-x_1*z_7)*x_5)==0) 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_2-(x_6*y_11-y_6*x_11)*y_2)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_2-(y_6*z_11-z_6*y_11)*z_2)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_2-(z_6*x_11-x_6*z_11)*x_2)==0) 
    s.add(((z_2*x_10-x_2*z_10)*z_8-(x_2*y_10-y_2*x_10)*y_8)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_8-(y_2*z_10-z_2*y_10)*z_8)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_8-(z_2*x_10-x_2*z_10)*x_8)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_8 == 0) 
