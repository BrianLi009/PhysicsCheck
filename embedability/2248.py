...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_7-(x_9*y_13-y_9*x_13)*y_7)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_7-(y_9*z_13-z_9*y_13)*z_7)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_7-(z_9*x_13-x_9*z_13)*x_7)==0) 
