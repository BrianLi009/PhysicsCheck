...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_5-(x_1*y_11-y_1*x_11)*y_5)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_5-(y_1*z_11-z_1*y_11)*z_5)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_5-(z_1*x_11-x_1*z_11)*x_5)==0) 
