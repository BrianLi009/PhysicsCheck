...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),k(k(v3,k(v2,v0)),v1)); 
neq1 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v2); 
neq2 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),k(k(k(k(v3,k(v2,v0)),v1),v2),v2)); 
neq3 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v0); 
neq4 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3); 
neq5 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v1); 
neq6 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),k(v3,k(v2,v0))); 
neq7 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq8 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),k(v2,v0)); 
neq9 := k(k(k(v3,k(v2,v0)),v1),v2); 
neq10 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(v3,k(v2,v0)),v1),v2),v2)); 
neq11 := k(k(k(v3,k(v2,v0)),v1),v0); 
neq12 := k(k(k(v3,k(v2,v0)),v1),v3); 
neq13 := k(k(k(v3,k(v2,v0)),v1),k(v0,v1)); 
neq14 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq15 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq16 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq17 := k(v2,v0); 
neq18 := k(v2,v3); 
neq19 := k(v2,v1); 
neq20 := k(v2,k(v0,v1)); 
neq21 := k(v2,k(v3,k(v2,v0))); 
neq22 := k(v2,k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq23 := k(v2,k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq24 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),v0); 
neq25 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),v3); 
neq26 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),v1); 
neq27 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),k(v0,v1)); 
neq28 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),k(v3,k(v2,v0))); 
neq29 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq30 := k(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),k(v2,v0)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(v3,k(v2,v0))); 
neq33 := k(v0,k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq34 := k(v0,k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq35 := k(v0,k(k(k(v3,k(v2,v0)),v1),v2)); 
neq36 := k(v3,v1); 
neq37 := k(v3,k(v0,v1)); 
neq38 := k(v3,k(v2,v0)); 
neq39 := k(v3,k(k(k(v3,k(v2,v0)),v1),v2)); 
neq40 := k(v1,k(v3,k(v2,v0))); 
neq41 := k(v1,k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq42 := k(v1,k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq43 := k(v1,k(v2,v0)); 
neq44 := k(v1,k(k(k(v3,k(v2,v0)),v1),v2)); 
neq45 := k(k(v0,v1),k(v3,k(v2,v0))); 
neq46 := k(k(v0,v1),k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq47 := k(k(v0,v1),k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq48 := k(k(v0,v1),k(v2,v0)); 
neq49 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq50 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3)); 
neq51 := k(k(v3,k(v2,v0)),k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)); 
neq52 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq53 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),k(v2,v0)); 
neq54 := k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq55 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3),k(v2,v0)); 
neq56 := k(k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3),k(k(k(v3,k(v2,v0)),v1),v2)); 
neq57 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(v2,v0)),v1),v2),v2),k(k(k(k(k(k(v3,k(v2,v0)),v1),v2),k(v0,v1)),v3),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
