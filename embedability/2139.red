...
v3c3 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0)); 
neq2 := k(v2,k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2)))); 
neq3 := k(v2,k(v0,v1)); 
neq4 := k(v2,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq5 := k(v2,k(k(v3,k(k(v2,v0),v2)),v3)); 
neq6 := k(v2,k(v3,k(k(v2,v0),v2))); 
neq7 := k(v2,k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq8 := k(v2,v0); 
neq9 := k(v2,v1); 
neq10 := k(v3,k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0)); 
neq11 := k(v3,k(v2,v0)); 
neq12 := k(v3,k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2)))); 
neq13 := k(v3,k(k(v2,v0),v2)); 
neq14 := k(v3,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2)); 
neq15 := k(v3,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq16 := k(v3,k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq17 := k(v3,v0); 
neq18 := k(v3,v1); 
neq19 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(v2,v0)); 
neq20 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(k(v2,v0),v2)); 
neq21 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(v0,v1)); 
neq22 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq23 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq24 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(v3,k(k(v2,v0),v2))); 
neq25 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq26 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0),v1); 
neq27 := k(k(v2,v0),k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2)))); 
neq28 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2)); 
neq29 := k(k(v2,v0),k(v0,v1)); 
neq30 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq31 := k(k(v2,v0),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq32 := k(k(v2,v0),k(v3,k(k(v2,v0),v2))); 
neq33 := k(k(v2,v0),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq34 := k(k(v2,v0),v1); 
neq35 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(k(v2,v0),v2)); 
neq36 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2)); 
neq37 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(v0,v1)); 
neq38 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq39 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq40 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),v0); 
neq41 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),v1); 
neq42 := k(k(k(v2,v0),v2),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2)); 
neq43 := k(k(k(v2,v0),v2),k(v0,v1)); 
neq44 := k(k(k(v2,v0),v2),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq45 := k(k(k(v2,v0),v2),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq46 := k(k(k(v2,v0),v2),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq47 := k(k(k(v2,v0),v2),v0); 
neq48 := k(k(k(v2,v0),v2),v1); 
neq49 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),k(v0,v1)); 
neq50 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq51 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq52 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),k(v3,k(k(v2,v0),v2))); 
neq53 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0); 
neq54 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v1); 
neq55 := k(k(v0,v1),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1)); 
neq56 := k(k(v0,v1),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq57 := k(k(v0,v1),k(v3,k(k(v2,v0),v2))); 
neq58 := k(k(v0,v1),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq59 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq60 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))); 
neq61 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),v0); 
neq62 := k(k(k(v3,k(k(v2,v0),v2)),v3),v0); 
neq63 := k(k(k(v3,k(k(v2,v0),v2)),v3),v1); 
neq64 := k(k(v3,k(k(v2,v0),v2)),k(k(k(v3,k(k(v2,v0),v2)),v3),v1)); 
neq65 := k(k(v3,k(k(v2,v0),v2)),v0); 
neq66 := k(k(v3,k(k(v2,v0),v2)),v1); 
neq67 := k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v0); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v1),k(v3,k(k(v2,v0),v2))),k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v1),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
