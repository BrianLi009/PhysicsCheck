...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq1 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1))); 
neq2 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq3 := k(v0,v3); 
neq4 := k(v0,k(v3,v2)); 
...
neq9 := k(v2,v1); 
neq10 := k(v2,k(k(k(v3,v2),v3),v1)); 
neq11 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1))); 
neq12 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq13 := k(v2,v3); 
neq14 := k(v2,k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq15 := k(v2,k(k(v3,v2),v3)); 
neq16 := k(v2,k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq17 := k(v2,k(k(k(v3,v2),v3),k(v2,v0))); 
neq18 := k(v1,k(v2,v0)); 
neq19 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1))); 
neq20 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq21 := k(v1,v3); 
neq22 := k(v1,k(v3,v2)); 
neq23 := k(v1,k(k(v3,v2),v3)); 
neq24 := k(v1,k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq25 := k(v1,k(k(k(v3,v2),v3),k(v2,v0))); 
neq26 := k(k(v2,v0),k(k(k(v3,v2),v3),v1)); 
neq27 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1))); 
neq28 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq29 := k(k(v2,v0),v3); 
neq30 := k(k(v2,v0),k(v3,v2)); 
neq31 := k(k(v2,v0),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq32 := k(k(v2,v0),k(k(v3,v2),v3)); 
neq33 := k(k(v2,v0),k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq34 := k(k(k(k(v3,v2),v3),v1),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq35 := k(k(k(k(v3,v2),v3),v1),v3); 
neq36 := k(k(k(k(v3,v2),v3),v1),k(v3,v2)); 
neq37 := k(k(k(k(v3,v2),v3),v1),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq38 := k(k(k(k(v3,v2),v3),v1),k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq39 := k(k(k(k(v3,v2),v3),v1),k(k(k(v3,v2),v3),k(v2,v0))); 
neq40 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1)),v3); 
neq41 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1)),k(v3,v2)); 
neq42 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1)),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq43 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1)),k(k(v3,v2),v3)); 
neq44 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq45 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(v3,v2)); 
neq46 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq47 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(v3,v2),v3)); 
neq48 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(v3,v2),v3),k(v2,v0))); 
neq49 := k(v3,k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq50 := k(v3,k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq51 := k(v3,k(k(k(v3,v2),v3),k(v2,v0))); 
neq52 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v2,v0)),v1)); 
neq53 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq54 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v2,v0))); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),v1),k(k(k(v3,v2),v3),k(v2,v0))),k(k(k(v3,v2),v3),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
