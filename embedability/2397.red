...
neq5 := k(v2,v0); 
neq6 := k(v2,k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq7 := k(v2,k(k(k(v3,v2),v3),k(v0,v1))); 
neq8 := k(v2,k(v3,v0)); 
neq9 := k(v2,v1); 
neq10 := k(k(k(v3,v2),v1),v3); 
neq11 := k(k(k(v3,v2),v1),k(k(v3,v2),v3)); 
neq12 := k(k(k(v3,v2),v1),k(k(k(v3,v0),v2),v1)); 
neq13 := k(k(k(v3,v2),v1),v0); 
neq14 := k(k(k(v3,v2),v1),k(k(v3,v0),v2)); 
neq15 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
...
neq21 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)); 
neq22 := k(k(k(k(v3,v2),v1),k(v3,v2)),v0); 
neq23 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v3,v0),v2)); 
...
neq31 := k(v3,k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq32 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq33 := k(v3,k(v0,v1)); 
neq34 := k(v3,v1); 
neq35 := k(k(k(v3,v2),v3),k(k(k(v3,v0),v2),v1)); 
neq36 := k(k(k(v3,v2),v3),v0); 
neq37 := k(k(k(v3,v2),v3),k(k(v3,v0),v2)); 
neq38 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq39 := k(k(k(v3,v2),v3),k(v3,v0)); 
neq40 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq41 := k(k(k(v3,v2),v3),v1); 
neq42 := k(k(k(k(v3,v0),v2),v1),v0); 
neq43 := k(k(k(k(v3,v0),v2),v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq44 := k(k(k(k(v3,v0),v2),v1),k(v3,v0)); 
neq45 := k(k(k(k(v3,v0),v2),v1),k(v0,v1)); 
neq46 := k(k(k(k(v3,v0),v2),v1),k(v3,v2)); 
neq47 := k(v0,k(k(v3,v0),v2)); 
neq48 := k(v0,k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq49 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq50 := k(v0,k(v3,v2)); 
neq51 := k(k(k(v3,v0),v2),k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq52 := k(k(k(v3,v0),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq53 := k(k(k(v3,v0),v2),k(v0,v1)); 
neq54 := k(k(k(v3,v0),v2),v1); 
neq55 := k(k(k(v3,v0),v2),k(v3,v2)); 
neq56 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))),k(v3,v0)); 
neq57 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))),k(v0,v1)); 
neq58 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v1); 
neq59 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))),k(v3,v2)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))),k(k(k(v3,v0),v2),v1)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
