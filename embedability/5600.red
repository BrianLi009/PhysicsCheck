...
neq3 := k(v2,k(v3,v0)); 
neq4 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(v0,v1)); 
...
neq13 := k(k(k(v3,v0),v2),k(v3,k(v2,v1))); 
neq14 := k(k(k(v3,v0),v2),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
neq15 := k(k(k(v3,v0),v2),v3); 
neq16 := k(k(k(v3,v0),v2),k(v0,v1)); 
neq17 := k(k(k(v3,v0),v2),k(k(v3,k(v0,v1)),v2)); 
neq18 := k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq19 := k(k(k(v3,v0),v2),k(v3,k(v0,v1))); 
neq20 := k(k(v2,v1),v0); 
neq21 := k(k(v2,v1),k(v3,v0)); 
neq22 := k(k(v2,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
neq23 := k(k(v2,v1),v3); 
neq24 := k(k(v2,v1),k(v0,v1)); 
neq25 := k(k(v2,v1),k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq26 := k(k(v2,v1),k(k(v3,k(v0,v1)),v2)); 
neq27 := k(k(v2,v1),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq28 := k(k(v2,v1),k(v3,k(v0,v1))); 
neq29 := k(v0,k(v3,k(v2,v1))); 
neq30 := k(v0,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
neq31 := k(v0,v3); 
...
neq37 := k(v1,k(v3,v0)); 
neq38 := k(v1,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
neq39 := k(v1,v3); 
neq40 := k(v1,k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq41 := k(v1,k(k(v3,k(v0,v1)),v2)); 
neq42 := k(v1,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq43 := k(v1,k(v3,k(v0,v1))); 
neq44 := k(k(v3,k(v2,v1)),k(v3,v0)); 
neq45 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq46 := k(k(v3,k(v2,v1)),k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq47 := k(k(v3,k(v2,v1)),k(k(v3,k(v0,v1)),v2)); 
neq48 := k(k(v3,k(v2,v1)),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq49 := k(k(v3,k(v2,v1)),k(v3,k(v0,v1))); 
neq50 := k(k(v3,v0),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))); 
...
neq56 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1))),v3); 
neq57 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1))),k(v0,v1)); 
neq58 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1))),k(k(v3,k(v0,v1)),v2)); 
neq59 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1))),k(v3,k(v0,v1))); 
neq60 := k(v3,k(v0,v1)); 
neq61 := k(v3,k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq62 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq63 := k(v3,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq64 := k(k(v0,v1),k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
...
phi := 
       ...
       d(k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,k(v2,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
