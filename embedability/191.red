...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1)); 
neq1 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),v2); 
neq2 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0))); 
neq3 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(k(k(v2,v1),v1),k(v2,v0))); 
neq4 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(k(v2,v0),v0)); 
neq5 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(v2,v1)); 
neq6 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),v1); 
neq7 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(k(v2,v1),v1)); 
neq8 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0),k(v2,v0)); 
neq9 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),v2); 
neq10 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq11 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(k(v2,v0),v0)); 
neq12 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(v2,v1)); 
neq13 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq14 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),v0); 
neq15 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(k(v2,v1),v1)); 
neq16 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1),k(v2,v0)); 
neq17 := k(v2,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0))); 
neq18 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq19 := k(v2,k(k(v2,v0),v0)); 
neq20 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq21 := k(v2,v0); 
neq22 := k(v2,v1); 
neq23 := k(v2,k(k(v2,v1),v1)); 
neq24 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq25 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(v2,v1)); 
neq26 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq27 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),v0); 
neq28 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),v1); 
neq29 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(k(v2,v1),v1)); 
neq30 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq31 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v0),v0)); 
neq32 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v1)); 
neq33 := k(k(k(k(v2,v1),v1),k(v2,v0)),v0); 
neq34 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq35 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq36 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq37 := k(k(k(v2,v0),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq38 := k(k(k(v2,v0),v0),v1); 
neq39 := k(k(k(v2,v0),v0),k(k(v2,v1),v1)); 
neq40 := k(k(k(v2,v0),v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq41 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq42 := k(k(v2,v1),v0); 
neq43 := k(k(v2,v1),k(v2,v0)); 
neq44 := k(k(v2,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq45 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0); 
neq46 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v1); 
neq47 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(v2,v0)); 
neq48 := k(v0,k(k(v2,v1),v1)); 
neq49 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq50 := k(v1,k(v2,v0)); 
neq51 := k(v1,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),k(k(v2,v0),v0)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
