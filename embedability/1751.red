...
neq24 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0)); 
...
neq32 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0))); 
...
neq44 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,v1)),k(v3,v0)); 
...
neq52 := k(k(v2,v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0))); 
...
neq60 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq61 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0)),v1); 
neq62 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0)),k(v3,v2)); 
neq63 := k(k(v3,v0),k(k(k(v3,v2),v3),k(v2,v0))); 
neq64 := k(k(v3,v0),v1); 
...
phi := 
       ...
       d(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v0)),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
