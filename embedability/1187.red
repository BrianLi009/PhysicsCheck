...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(v3,k(v2,v0)),k(k(v2,v1),v2))); 
...
neq7 := k(v2,k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq8 := k(v2,k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq9 := k(v2,v1); 
neq10 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq11 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq12 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),v3); 
neq13 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1)); 
neq14 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),v0); 
neq15 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(v2,v0)); 
neq16 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq17 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(v2,v1)); 
neq18 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),v1); 
neq19 := k(k(k(k(v2,v1),v2),v0),v3); 
neq20 := k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)); 
neq21 := k(k(k(k(v2,v1),v2),v0),k(v2,v0)); 
neq22 := k(k(k(k(v2,v1),v2),v0),k(v3,k(v2,v0))); 
neq23 := k(k(k(k(v2,v1),v2),v0),k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
...
neq27 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v3); 
...
neq31 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v3,k(v2,v0))); 
neq32 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq33 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,v1)); 
neq34 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1); 
neq35 := k(v3,k(k(v2,v1),v1)); 
neq36 := k(v3,v0); 
neq37 := k(v3,k(v2,v0)); 
neq38 := k(v3,k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq39 := k(v3,k(v2,v1)); 
neq40 := k(v3,k(k(v2,v1),v2)); 
neq41 := k(k(k(v2,v1),v1),v0); 
neq42 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq43 := k(k(k(v2,v1),v1),k(v3,k(v2,v0))); 
neq44 := k(k(k(v2,v1),v1),k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq45 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq46 := k(v0,k(v3,k(v2,v0))); 
neq47 := k(v0,k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq48 := k(v0,k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq49 := k(v0,k(v2,v1)); 
neq50 := k(v0,k(k(v2,v1),v2)); 
neq51 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq52 := k(k(v2,v0),k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq53 := k(k(v2,v0),k(v2,v1)); 
neq54 := k(k(v2,v0),v1); 
neq55 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq56 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))); 
neq57 := k(k(v3,k(v2,v0)),k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq58 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq59 := k(k(v3,k(v2,v0)),v1); 
neq60 := k(k(v3,k(v2,v0)),k(k(v2,v1),v2)); 
neq61 := k(k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1)),k(v2,v1)); 
neq62 := k(k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1)),v1); 
neq63 := k(k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(v3,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(k(v3,k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
