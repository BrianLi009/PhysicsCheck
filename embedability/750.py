...
def test_embed(): 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_9-(x_7*y_11-y_7*x_11)*y_9)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_9-(y_7*z_11-z_7*y_11)*z_9)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_9-(z_7*x_11-x_7*z_11)*x_9)==0) 
    ...
    s.add(((z_7*x_9-x_7*z_9)*z_3-(x_7*y_9-y_7*x_9)*y_3)==0) 
    s.add(((x_7*y_9-y_7*x_9)*x_3-(y_7*z_9-z_7*y_9)*z_3)==0) 
    s.add(((y_7*z_9-z_7*y_9)*y_3-(z_7*x_9-x_7*z_9)*x_3)==0) 
