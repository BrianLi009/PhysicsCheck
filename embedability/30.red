...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(v2,k(k(k(v3,v2),v1),k(k(v3,v0),v2))); 
neq1 := k(v2,k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1)))); 
neq2 := k(v2,v3); 
neq3 := k(v2,v0); 
neq4 := k(v2,v1); 
...
neq8 := k(k(v2,v1),k(k(k(v3,v2),v1),k(k(v3,v0),v2))); 
neq9 := k(k(v2,v1),k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1)))); 
neq10 := k(k(v2,v1),v3); 
neq11 := k(k(v2,v1),v0); 
...
neq16 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),v3); 
neq17 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),v0); 
neq18 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),v1); 
neq19 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),k(v3,v2)); 
neq20 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),k(k(v3,v0),k(v2,v1))); 
neq21 := k(k(k(k(v3,v2),v1),k(k(v3,v0),v2)),k(v3,v0)); 
neq22 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),v3); 
neq23 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),v0); 
neq24 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),k(k(v3,v0),v2)); 
neq25 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),v1); 
neq26 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),k(v3,v2)); 
neq27 := k(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),k(v3,v0)); 
neq28 := k(v3,k(k(v3,v0),v2)); 
neq29 := k(v3,v1); 
neq30 := k(v3,k(k(v3,v0),k(v2,v1))); 
...
neq37 := k(k(k(v3,v0),v2),k(v3,v2)); 
neq38 := k(k(k(v3,v0),v2),k(k(v3,v0),k(v2,v1))); 
neq39 := k(k(k(v3,v0),v2),k(k(v3,v2),v1)); 
neq40 := k(v1,k(v3,v2)); 
neq41 := k(v1,k(k(v3,v0),k(v2,v1))); 
neq42 := k(v1,k(v3,v0)); 
neq43 := k(k(v3,v2),k(k(v3,v0),k(v2,v1))); 
neq44 := k(k(v3,v2),k(v3,v0)); 
neq45 := k(k(k(v3,v0),k(v2,v1)),k(k(v3,v2),v1)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,v2),v1),k(k(v3,v0),k(v2,v1))),k(k(k(v3,v2),v1),k(k(v3,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
