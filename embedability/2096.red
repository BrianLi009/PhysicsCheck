...
neq2 := k(v2,v3); 
neq3 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1)))); 
...
neq8 := k(v2,v0); 
neq9 := k(v2,v1); 
neq10 := k(k(v3,k(k(v2,v1),v1)),k(v3,k(v2,v0))); 
neq11 := k(k(v3,k(k(v2,v1),v1)),k(v2,v1)); 
neq12 := k(k(v3,k(k(v2,v1),v1)),k(v2,v0)); 
neq13 := k(k(v3,k(k(v2,v1),v1)),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),v0)); 
neq14 := k(k(v3,k(k(v2,v1),v1)),k(v2,k(v0,v1))); 
neq15 := k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,v0)),k(v2,k(v0,v1)))); 
neq16 := k(k(v3,k(k(v2,v1),v1)),k(v0,v1)); 
neq17 := k(k(v3,k(k(v2,v1),v1)),v0); 
neq18 := k(k(v3,k(k(v2,v1),v1)),v1); 
neq19 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1)))); 
neq20 := k(k(v3,k(v2,v0)),k(k(v2,v1),v1)); 
neq21 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq22 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),v0)); 
neq23 := k(k(v3,k(v2,v0)),k(v2,k(v0,v1))); 
neq24 := k(k(v3,k(v2,v0)),k(v0,v1)); 
neq25 := k(k(v3,k(v2,v0)),v0); 
neq26 := k(k(v3,k(v2,v0)),v1); 
neq27 := k(v3,k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1)))); 
...
neq34 := k(v3,v0); 
neq35 := k(v3,v1); 
neq36 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),k(k(v2,v1),v1)); 
neq37 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),k(v2,v1)); 
neq38 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),k(v2,v0)); 
neq39 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),k(v2,k(v0,v1))); 
neq40 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),k(v0,v1)); 
neq41 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),v0); 
neq42 := k(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))),v1); 
neq43 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq44 := k(k(k(v2,v1),v1),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),v0)); 
neq45 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq46 := k(k(k(v2,v1),v1),k(k(v3,k(v2,v0)),k(v2,k(v0,v1)))); 
neq47 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq48 := k(k(k(v2,v1),v1),v0); 
neq49 := k(k(v2,v1),k(v2,v0)); 
neq50 := k(k(v2,v1),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),v0)); 
neq51 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq52 := k(k(v2,v1),k(k(v3,k(v2,v0)),k(v2,k(v0,v1)))); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),v0),k(k(k(v3,k(v2,v0)),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
