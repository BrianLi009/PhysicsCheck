...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_9-(x_7*y_12-y_7*x_12)*y_9)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_9-(y_7*z_12-z_7*y_12)*z_9)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_9-(z_7*x_12-x_7*z_12)*x_9)==0) 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_2-(x_7*y_11-y_7*x_11)*y_2)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_2-(y_7*z_11-z_7*y_11)*z_2)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_2-(z_7*x_11-x_7*z_11)*x_2)==0) 
