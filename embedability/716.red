...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v2,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq1 := k(v2,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq2 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1)); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq5 := k(v2,k(v0,v1)); 
neq6 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq9 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq10 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq11 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1)); 
neq12 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v0); 
neq13 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq14 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)); 
neq15 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v0,v1)); 
neq16 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1); 
neq17 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq18 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq19 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1)); 
neq20 := k(k(k(v2,k(v0,v1)),k(v0,v1)),v0); 
neq21 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq22 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v1)); 
neq23 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq24 := k(k(k(v2,k(v0,v1)),k(v0,v1)),v1); 
neq25 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(v2,v1),v2)); 
neq26 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq27 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),v0); 
neq28 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(v2,v1)); 
neq29 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(v0,v1)); 
neq30 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(k(v2,v1),v2)); 
neq31 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(k(k(v2,v1),v2),v0)); 
neq32 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq33 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1),k(v2,k(v0,v1))); 
neq34 := k(v0,k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)))); 
neq35 := k(v0,k(v2,v1)); 
neq36 := k(v0,k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq37 := k(v0,k(k(v2,v1),v2)); 
neq38 := k(v0,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq39 := k(v0,k(v2,k(v0,v1))); 
neq40 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(v2,v1)); 
neq41 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(v0,v1)); 
neq42 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),v1); 
neq43 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq44 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(k(v2,v1),v2),v0)); 
neq45 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(v2,k(v0,v1))); 
neq46 := k(k(v2,v1),k(v0,v1)); 
neq47 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq48 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq49 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq50 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq51 := k(k(v0,v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq52 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq53 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq54 := k(k(v0,v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq55 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1); 
neq56 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq57 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),v0)); 
neq58 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
...
neq65 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))) = 0 and 
       d(k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))),k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
