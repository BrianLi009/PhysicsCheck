...
neq2 := k(v0,k(k(v2,v1),v1)); 
neq3 := k(v0,k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq4 := k(v0,k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq5 := k(v0,k(v2,v1)); 
neq6 := k(v1,k(v2,v0)); 
neq7 := k(v1,v2); 
neq8 := k(v1,k(k(v2,v1),v2)); 
neq9 := k(v1,k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq10 := k(v1,k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq11 := k(v1,k(k(v2,v0),v0)); 
neq12 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq13 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq14 := k(k(v2,v0),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq15 := k(k(v2,v0),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
...
neq21 := k(k(k(v2,v1),v2),k(k(v2,v1),v1)); 
neq22 := k(k(k(v2,v1),v2),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq23 := k(k(k(v2,v1),v2),k(k(v2,v0),v0)); 
neq24 := k(k(k(v2,v1),v1),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq25 := k(k(k(v2,v1),v1),k(k(v2,v0),v0)); 
neq26 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v2,v1)); 
neq27 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v2)),k(v2,v1)); 
neq28 := k(k(k(v2,v0),v0),k(v2,v1)); 
phi := 
       (first neq0 neq 0 or
