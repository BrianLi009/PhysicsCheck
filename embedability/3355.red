...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v2,k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq1 := k(v2,k(k(k(v2,v1),v2),k(v0,v1))); 
neq2 := k(v2,k(k(k(v3,v2),v3),v0)); 
neq3 := k(v2,v3); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3))); 
neq6 := k(v2,k(v0,v1)); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(k(v3,v2),v3)); 
neq10 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v2)); 
neq11 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(v3,v2),v3),v0)); 
neq12 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),v3); 
neq13 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),v0); 
neq14 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(v3,v2)); 
neq15 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(v0,v1)); 
neq16 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(v2,v1)); 
neq17 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),v1); 
neq18 := k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)); 
neq19 := k(k(k(v2,v1),v2),k(k(k(v3,v2),v3),v0)); 
neq20 := k(k(k(v2,v1),v2),v3); 
neq21 := k(k(k(v2,v1),v2),v0); 
neq22 := k(k(k(v2,v1),v2),k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3))); 
...
neq28 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v3,v2),v3),v0)); 
neq29 := k(k(k(k(v2,v1),v2),k(v0,v1)),v3); 
neq30 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq31 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3))); 
neq32 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v3,v2)); 
neq33 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v3,v1)); 
neq34 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v2,v1)); 
neq35 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq36 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v3,v2),v3)); 
...
neq43 := k(v3,v0); 
neq44 := k(v3,k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3))); 
neq45 := k(v3,k(v0,v1)); 
neq46 := k(v3,k(v2,v1)); 
neq47 := k(v3,v1); 
neq48 := k(v0,k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3))); 
neq49 := k(v0,k(v3,v2)); 
neq50 := k(v0,k(v3,v1)); 
neq51 := k(v0,k(v2,v1)); 
neq52 := k(v0,k(k(v3,v2),v3)); 
neq53 := k(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),k(v3,v2)); 
neq54 := k(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),k(v0,v1)); 
neq55 := k(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),k(v3,v1)); 
neq56 := k(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),k(v2,v1)); 
neq57 := k(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),v1); 
...
phi := 
       ...
       d(k(k(k(v3,v1),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,v2),v3)),k(k(k(v3,v2),v3),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
