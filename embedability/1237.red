...
neq4 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)); 
neq5 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq6 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq7 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
...
neq12 := k(v2,v0); 
neq13 := k(v2,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)); 
neq14 := k(v2,k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq15 := k(v2,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq16 := k(v2,v1); 
neq17 := k(v2,k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq18 := k(v2,k(k(v2,v0),v0)); 
neq19 := k(k(k(v2,v1),k(k(v2,v0),v0)),v0); 
neq20 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)); 
neq21 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
neq22 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq23 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq24 := k(k(k(v2,v1),k(k(v2,v0),v0)),v1); 
neq25 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq26 := k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v0)); 
neq27 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),v0); 
neq28 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)); 
neq29 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(v2,v0),v2)); 
neq30 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq31 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),v1); 
neq32 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq33 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v0)); 
neq34 := k(k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(v2,v0),v0)); 
neq35 := k(v0,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)); 
neq36 := k(v0,k(k(v2,v0),v2)); 
neq37 := k(v0,k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq38 := k(v0,k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq39 := k(v0,k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq40 := k(v0,k(v2,v1)); 
neq41 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1),k(k(v2,v0),v2)); 
neq42 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq43 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1),k(v2,v0)); 
neq44 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1),k(k(v2,v0),v0)); 
neq45 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1),k(v2,v1)); 
neq46 := k(k(k(v2,v0),v2),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq47 := k(k(k(v2,v0),v2),v1); 
neq48 := k(k(k(v2,v0),v2),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq49 := k(k(k(v2,v0),v2),k(k(v2,v0),v0)); 
neq50 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq51 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1)))); 
neq52 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v1); 
neq53 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(v2,v0)); 
neq54 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)); 
neq55 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(v2,v1)); 
neq56 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1))),v1); 
neq57 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1))),k(v2,v0)); 
neq58 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1))),k(k(v2,v0),v0)); 
neq59 := k(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1))),k(v2,v1)); 
neq60 := k(v1,k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0))); 
neq61 := k(v1,k(v2,v0)); 
neq62 := k(v1,k(k(v2,v0),v0)); 
neq63 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(v2,v0)); 
neq64 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(v2,v1)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),k(k(v2,v0),v0)),k(v2,v1))),k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v0)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
