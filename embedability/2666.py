...
def test_embed(): 
    ...
    s.add(((z_11*x_13-x_11*z_13)*z_10-(x_11*y_13-y_11*x_13)*y_10)==0) 
    s.add(((x_11*y_13-y_11*x_13)*x_10-(y_11*z_13-z_11*y_13)*z_10)==0) 
    s.add(((y_11*z_13-z_11*y_13)*y_10-(z_11*x_13-x_11*z_13)*x_10)==0) 
    ...
    s.add(((z_3*x_4-x_3*z_4)*z_9-(x_3*y_4-y_3*x_4)*y_9)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_9-(y_3*z_4-z_3*y_4)*z_9)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_9-(z_3*x_4-x_3*z_4)*x_9)==0) 
