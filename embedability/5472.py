...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_3-(x_5*y_10-y_5*x_10)*y_3)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_3-(y_5*z_10-z_5*y_10)*z_3)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_3-(z_5*x_10-x_5*z_10)*x_3)==0) 
