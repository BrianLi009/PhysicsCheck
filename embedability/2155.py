...
def test_embed(): 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_2-(x_8*y_13-y_8*x_13)*y_2)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_2-(y_8*z_13-z_8*y_13)*z_2)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_2-(z_8*x_13-x_8*z_13)*x_2)==0) 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_7-(x_4*y_10-y_4*x_10)*y_7)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_7-(y_4*z_10-z_4*y_10)*z_7)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_7-(z_4*x_10-x_4*z_10)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
