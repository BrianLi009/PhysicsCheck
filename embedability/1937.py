...
def test_embed(): 
    ...
    s.add(((z_8*x_9-x_8*z_9)*z_13-(x_8*y_9-y_8*x_9)*y_13)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_13-(y_8*z_9-z_8*y_9)*z_13)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_13-(z_8*x_9-x_8*z_9)*x_13)==0) 
    ...
    s.add(((z_4*x_6-x_4*z_6)*z_0-(x_4*y_6-y_4*x_6)*y_0)==0) 
    s.add(((x_4*y_6-y_4*x_6)*x_0-(y_4*z_6-z_4*y_6)*z_0)==0) 
    s.add(((y_4*z_6-z_4*y_6)*y_0-(z_4*x_6-x_4*z_6)*x_0)==0) 
    s.add(((z_5*x_7-x_5*z_7)*z_1-(x_5*y_7-y_5*x_7)*y_1)==0) 
    s.add(((x_5*y_7-y_5*x_7)*x_1-(y_5*z_7-z_5*y_7)*z_1)==0) 
    s.add(((y_5*z_7-z_5*y_7)*y_1-(z_5*x_7-x_5*z_7)*x_1)==0) 
