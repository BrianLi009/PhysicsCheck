...
neq2 := k(k(k(v2,v0),v0),k(k(v2,v1),v2)); 
neq3 := k(k(k(v2,v0),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq4 := k(k(k(v2,v0),v0),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq5 := k(k(k(v2,v0),v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2))); 
neq6 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq7 := k(k(k(v2,v0),v0),k(k(v2,v1),v1)); 
neq8 := k(k(k(v2,v0),v0),v1); 
neq9 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),v2); 
neq10 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq11 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(k(v2,v1),v2)); 
neq12 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq13 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),v0); 
neq14 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(v2,v0)); 
neq15 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(v2,v1)); 
neq16 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),k(k(v2,v1),v1)); 
neq17 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0)),v1); 
neq18 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq19 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq20 := k(v2,v0); 
neq21 := k(v2,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq22 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2))); 
neq23 := k(v2,k(k(v2,v1),v1)); 
neq24 := k(v2,v1); 
neq25 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)); 
neq26 := k(k(k(k(v2,v1),v1),k(v2,v0)),v0); 
neq27 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq28 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2))); 
neq29 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v1)); 
neq30 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq31 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq32 := k(k(k(v2,v1),v2),v0); 
neq33 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq34 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq35 := k(k(k(v2,v1),v2),k(k(v2,v1),v1)); 
neq36 := k(k(k(v2,v1),v2),v1); 
neq37 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0); 
neq38 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq39 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(v2,v0)); 
neq40 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(v2,v1)); 
neq41 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v1); 
neq42 := k(v0,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1)); 
neq43 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2))); 
neq44 := k(v0,k(v2,v1)); 
neq45 := k(v0,k(k(v2,v1),v1)); 
neq46 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1),k(v2,v0)); 
neq47 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1),k(v2,v1)); 
neq48 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1),k(k(v2,v1),v1)); 
neq49 := k(k(v2,v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2))); 
neq50 := k(k(v2,v0),k(v2,v1)); 
neq51 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq52 := k(k(v2,v0),v1); 
neq53 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(v2,v1)); 
neq54 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v1),v1)); 
neq55 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),v1),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(v2,v1),v2)),k(k(v2,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
