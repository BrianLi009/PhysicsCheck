...
neq0 := k(v2,v3); 
neq1 := k(v2,v0); 
neq2 := k(v2,k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3)); 
neq3 := k(v2,k(v3,v0)); 
neq4 := k(v2,k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq5 := k(v2,k(k(v3,v2),v1)); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq8 := k(v2,k(k(k(v3,v2),v1),k(v3,v0))); 
neq9 := k(v3,v0); 
neq10 := k(v3,k(v0,v1)); 
neq11 := k(v3,k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq12 := k(v3,k(k(v3,v2),v1)); 
neq13 := k(v3,k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq14 := k(v3,v1); 
neq15 := k(v3,k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq16 := k(v3,k(k(k(v3,v2),v1),k(v3,v0))); 
neq17 := k(k(v3,v2),v0); 
neq18 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3)); 
neq19 := k(k(v3,v2),k(v3,v0)); 
neq20 := k(k(v3,v2),k(v0,v1)); 
neq21 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq22 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq23 := k(k(v3,v2),v1); 
neq24 := k(k(v3,v2),k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq25 := k(k(v3,v2),k(k(k(v3,v2),v1),k(v3,v0))); 
neq26 := k(v0,k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3)); 
neq27 := k(v0,k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq28 := k(v0,k(k(v3,v2),v1)); 
neq29 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq30 := k(v0,k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq31 := k(v0,k(k(k(v3,v2),v1),k(v3,v0))); 
neq32 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),k(v3,v0)); 
neq33 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),k(v0,v1)); 
neq34 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),k(k(v3,v2),v1)); 
neq35 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq36 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),v1); 
neq37 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3),k(k(k(v3,v2),v1),k(v3,v0))); 
neq38 := k(k(v3,v0),k(v0,v1)); 
neq39 := k(k(v3,v0),k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq40 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq41 := k(k(v3,v0),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq42 := k(k(v3,v0),v1); 
neq43 := k(k(v3,v0),k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq44 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1)); 
neq45 := k(k(v0,v1),k(k(v3,v2),v1)); 
neq46 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq47 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq48 := k(k(v0,v1),k(k(k(v3,v2),v1),k(v3,v0))); 
neq49 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1),k(k(v3,v2),v1)); 
neq50 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq51 := k(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1),k(k(k(v3,v2),v1),k(v3,v0))); 
neq52 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v3,v0)),v2)); 
neq53 := k(k(k(v3,v2),v1),k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq54 := k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),v1); 
neq55 := k(v1,k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq56 := k(v1,k(k(k(v3,v2),v1),k(v3,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v1),k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),v2),k(k(k(v3,v2),v1),k(v3,v0))),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
