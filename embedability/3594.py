...
def test_embed(): 
    ...
    s.add(((z_0*x_11-x_0*z_11)*z_5-(x_0*y_11-y_0*x_11)*y_5)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_5-(y_0*z_11-z_0*y_11)*z_5)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_5-(z_0*x_11-x_0*z_11)*x_5)==0) 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_3-(x_5*y_12-y_5*x_12)*y_3)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_3-(y_5*z_12-z_5*y_12)*z_3)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_3-(z_5*x_12-x_5*z_12)*x_3)==0) 
