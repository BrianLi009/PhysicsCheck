...
v3 := {v3c1, v3c2, v3c3}; 
v2c3 := 0;
neq0 := k(k(k(k(v3,v0),v3),k(v0,v1)),v2); 
neq1 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,k(v0,v1))); 
neq2 := k(k(k(k(v3,v0),v3),k(v0,v1)),v0); 
neq3 := k(k(k(k(v3,v0),v3),k(v0,v1)),v1); 
neq4 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,v2),v2)); 
neq5 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,v2)); 
neq6 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq7 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(k(v3,v0),v3),v1)); 
neq8 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,v0)); 
neq9 := k(k(k(k(v3,v0),v3),k(v0,v1)),v3); 
neq10 := k(v2,k(v3,k(v0,v1))); 
neq11 := k(v2,v0); 
neq12 := k(v2,v1); 
neq13 := k(v2,k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1)))); 
neq14 := k(v2,k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq15 := k(v2,k(k(k(v3,v0),v3),v1)); 
neq16 := k(v2,k(v3,v0)); 
neq17 := k(v2,v3); 
neq18 := k(v2,k(k(v3,v0),v3)); 
neq19 := k(k(v3,k(v0,v1)),v0); 
neq20 := k(k(v3,k(v0,v1)),v1); 
neq21 := k(k(v3,k(v0,v1)),k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1)))); 
neq22 := k(k(v3,k(v0,v1)),k(k(v3,v2),v2)); 
neq23 := k(k(v3,k(v0,v1)),k(v3,v2)); 
neq24 := k(k(v3,k(v0,v1)),k(k(k(v3,v0),v3),v1)); 
neq25 := k(k(v3,k(v0,v1)),k(v3,v0)); 
neq26 := k(k(v3,k(v0,v1)),k(k(v3,v0),v3)); 
neq27 := k(v0,k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1)))); 
neq28 := k(v0,k(k(v3,v2),v2)); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(v0,k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq31 := k(v0,k(k(k(v3,v0),v3),v1)); 
neq32 := k(v0,v3); 
neq33 := k(v0,k(k(v3,v0),v3)); 
neq34 := k(v1,k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1)))); 
neq35 := k(v1,k(k(v3,v2),v2)); 
neq36 := k(v1,k(v3,v2)); 
neq37 := k(v1,k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq38 := k(v1,k(v3,v0)); 
neq39 := k(v1,v3); 
neq40 := k(v1,k(k(v3,v0),v3)); 
neq41 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),k(v3,v2)); 
neq42 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),k(k(k(v3,v0),v3),v1)); 
neq43 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),k(v3,v0)); 
neq44 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),v3); 
neq45 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),k(k(v3,v0),v3)); 
neq46 := k(k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1))),k(v0,v1)); 
neq47 := k(k(k(v3,v2),v2),k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq48 := k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),v1)); 
neq49 := k(k(k(v3,v2),v2),k(v3,v0)); 
neq50 := k(k(k(v3,v2),v2),v3); 
neq51 := k(k(k(v3,v2),v2),k(k(v3,v0),v3)); 
neq52 := k(k(k(v3,v2),v2),k(v0,v1)); 
neq53 := k(k(v3,v2),k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1)))); 
neq54 := k(k(v3,v2),k(k(k(v3,v0),v3),v1)); 
neq55 := k(k(v3,v2),k(v3,v0)); 
neq56 := k(k(v3,v2),k(k(v3,v0),v3)); 
neq57 := k(k(v3,v2),k(v0,v1)); 
neq58 := k(k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1))),k(v3,v0)); 
neq59 := k(k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1))),v3); 
neq60 := k(k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1))),k(k(v3,v0),v3)); 
neq61 := k(k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1))),k(v0,v1)); 
neq62 := k(k(k(k(v3,v0),v3),v1),k(v3,v0)); 
neq63 := k(k(k(k(v3,v0),v3),v1),v3); 
neq64 := k(k(k(k(v3,v0),v3),v1),k(v0,v1)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(v3,v0),v3),v1),k(v3,k(v0,v1))),k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
