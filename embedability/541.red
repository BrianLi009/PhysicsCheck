...
neq1 := k(v2,v3); 
neq2 := k(v2,k(v3,v1)); 
neq3 := k(v2,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq4 := k(v2,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq5 := k(v2,k(k(v3,v0),k(k(v3,v2),v1))); 
neq6 := k(v2,k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq7 := k(v2,k(k(v3,v2),v1)); 
neq8 := k(v2,k(v3,v0)); 
neq9 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v2)); 
neq10 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),v0); 
neq11 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),v1); 
neq12 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),v3); 
neq13 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)); 
neq14 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq15 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq16 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(k(v3,v2),v1)); 
neq17 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v0)); 
neq18 := k(k(v3,v2),v0); 
neq19 := k(k(v3,v2),v1); 
neq20 := k(k(v3,v2),k(v3,v1)); 
neq21 := k(k(v3,v2),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq22 := k(k(v3,v2),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq23 := k(k(v3,v2),k(k(v3,v0),k(k(v3,v2),v1))); 
neq24 := k(k(v3,v2),k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq25 := k(k(v3,v2),k(v3,v0)); 
neq26 := k(v0,v3); 
neq27 := k(v0,k(v3,v1)); 
neq28 := k(v0,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq29 := k(v0,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq30 := k(v0,k(k(v3,v0),k(k(v3,v2),v1))); 
neq31 := k(v0,k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq32 := k(v0,k(k(v3,v2),v1)); 
neq33 := k(v1,v3); 
neq34 := k(v1,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq35 := k(v1,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq36 := k(v1,k(k(v3,v0),k(k(v3,v2),v1))); 
neq37 := k(v1,k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq38 := k(v1,k(v3,v0)); 
neq39 := k(v3,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq40 := k(v3,k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq41 := k(v3,k(k(v3,v0),k(k(v3,v2),v1))); 
neq42 := k(v3,k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq43 := k(v3,k(k(v3,v2),v1)); 
neq44 := k(k(v3,v1),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))); 
neq45 := k(k(v3,v1),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0))); 
neq46 := k(k(v3,v1),k(k(v3,v0),k(k(v3,v2),v1))); 
neq47 := k(k(v3,v1),k(k(v3,v2),v1)); 
neq48 := k(k(v3,v1),k(v3,v0)); 
neq49 := k(k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1)),k(k(v3,v0),k(k(v3,v2),v1))); 
neq50 := k(k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1)),k(v3,v0)); 
neq51 := k(k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0)),k(k(v3,v0),k(k(v3,v2),v1))); 
neq52 := k(k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0)),k(k(v3,v2),v1)); 
neq53 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1))); 
neq54 := k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1)); 
neq55 := k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(v3,v0)),k(k(k(k(k(v3,v0),k(k(v3,v2),v1)),v2),k(v3,v1)),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
