...
def test_embed(): 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_9-(x_8*y_13-y_8*x_13)*y_9)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_9-(y_8*z_13-z_8*y_13)*z_9)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_9-(z_8*x_13-x_8*z_13)*x_9)==0) 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_0-(x_7*y_11-y_7*x_11)*y_0)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_0-(y_7*z_11-z_7*y_11)*z_0)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_0-(z_7*x_11-x_7*z_11)*x_0)==0) 
