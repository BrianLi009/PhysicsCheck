...
def test_embed(): 
    ...
    s.add(((z_5*x_6-x_5*z_6)*z_9-(x_5*y_6-y_5*x_6)*y_9)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_9-(y_5*z_6-z_5*y_6)*z_9)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_9-(z_5*x_6-x_5*z_6)*x_9)==0) 
    ...
    s.add(((z_0*x_1-x_0*z_1)*z_11-(x_0*y_1-y_0*x_1)*y_11)==0) 
    s.add(((x_0*y_1-y_0*x_1)*x_11-(y_0*z_1-z_0*y_1)*z_11)==0) 
    s.add(((y_0*z_1-z_0*y_1)*y_11-(z_0*x_1-x_0*z_1)*x_11)==0) 
