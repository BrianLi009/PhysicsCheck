...
neq3 := k(v2,k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq4 := k(v2,k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq5 := k(v2,v1); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq8 := k(v2,k(k(v2,v0),v0)); 
neq9 := k(v0,k(k(v3,k(v2,v0)),k(v2,v0))); 
neq10 := k(v0,k(v3,k(v2,v0))); 
neq11 := k(v0,k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq12 := k(v0,k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq13 := k(v0,k(v3,v2)); 
neq14 := k(v0,k(k(v3,v2),v2)); 
neq15 := k(v0,v3); 
neq16 := k(v0,k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq17 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq18 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq19 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v1); 
neq20 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v3,v2)); 
neq21 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(v3,v2),v2)); 
neq22 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v3); 
neq23 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(v2,v0),v0)); 
neq24 := k(k(v3,k(v2,v0)),k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0))); 
neq25 := k(k(v3,k(v2,v0)),k(k(k(v3,v2),v2),k(k(v2,v0),v0))); 
neq26 := k(k(v3,k(v2,v0)),v1); 
neq27 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq28 := k(k(v3,k(v2,v0)),k(k(v3,v2),v2)); 
neq29 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq30 := k(k(v3,k(v2,v0)),k(k(v2,v0),v0)); 
neq31 := k(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),v1); 
neq32 := k(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v3,v2)); 
neq33 := k(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(k(v3,v2),v2)); 
neq34 := k(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),v3); 
neq35 := k(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(v2,v0)); 
neq36 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),v1); 
neq37 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(v3,v2)); 
neq38 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),v3); 
neq39 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq40 := k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq41 := k(v1,k(v3,v2)); 
neq42 := k(v1,k(k(v3,v2),v2)); 
neq43 := k(v1,k(k(v2,v0),v0)); 
neq44 := k(v1,k(v2,v0)); 
neq45 := k(k(v3,v2),k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq46 := k(k(v3,v2),k(k(v2,v0),v0)); 
neq47 := k(k(v3,v2),k(v2,v0)); 
neq48 := k(k(k(v3,v2),v2),v3); 
neq49 := k(k(k(v3,v2),v2),k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq50 := k(k(k(v3,v2),v2),k(k(v2,v0),v0)); 
neq51 := k(k(k(v3,v2),v2),k(v2,v0)); 
neq52 := k(v3,k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)); 
neq53 := k(v3,k(k(v2,v0),v0)); 
neq54 := k(v3,k(v2,v0)); 
neq55 := k(k(k(k(v3,k(v2,v0)),k(v2,v0)),v1),k(k(v2,v0),v0)); 
neq56 := k(k(k(k(v3,k(v2,v0)),k(v2,v0)),v1),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v0)),k(k(k(v3,k(v2,v0)),k(v2,v0)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
