...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0))); 
neq1 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq2 := k(k(k(v2,v1),v1),v0); 
neq3 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2))); 
neq4 := k(k(k(v2,v1),v1),v2); 
neq5 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)); 
neq6 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq7 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq8 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq9 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq10 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq11 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),v0); 
neq12 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),v1); 
neq13 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),v2); 
neq14 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(k(v2,v1),v2),v0)); 
neq15 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq16 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v0),v2)); 
neq17 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)); 
neq18 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(v2,v1)); 
neq19 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v0); 
neq20 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1); 
neq21 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v2); 
neq22 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(v2,v1),v2),v0)); 
neq23 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(v2,v1),v2)); 
neq24 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(v2,v0)); 
neq25 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq26 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(v2,v1)); 
neq27 := k(v0,k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2))); 
neq28 := k(v0,v2); 
neq29 := k(v0,k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq30 := k(v0,k(k(v2,v0),v2)); 
neq31 := k(v0,k(k(v2,v1),v2)); 
neq32 := k(v0,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq33 := k(v0,k(v2,v1)); 
neq34 := k(v1,k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2))); 
neq35 := k(v1,v2); 
neq36 := k(v1,k(k(k(v2,v1),v2),v0)); 
neq37 := k(v1,k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq38 := k(v1,k(k(v2,v0),v2)); 
neq39 := k(v1,k(k(v2,v1),v2)); 
neq40 := k(v1,k(v2,v0)); 
neq41 := k(v1,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq42 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),v2); 
neq43 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq44 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq45 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v0),v2)); 
neq46 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(v2,v0)); 
neq47 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq48 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(v2,v1)); 
neq49 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq50 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))); 
neq51 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq52 := k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)); 
neq53 := k(k(k(k(v2,v1),v2),v0),k(v2,v0)); 
neq54 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq55 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v1),v2)); 
neq56 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(v2,v0)); 
neq57 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(v2,v1)); 
neq58 := k(k(k(v2,v0),v2),k(k(v2,v1),v2)); 
neq59 := k(k(k(v2,v0),v2),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq60 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq61 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq62 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq63 := k(k(v2,v0),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
...
phi := 
       ...
       d(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2))) = 0 and 
       d(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v0),v2)),k(k(v2,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
