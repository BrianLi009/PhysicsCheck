...
neq2 := k(k(v2,k(v0,v1)),k(k(v3,v2),v2)); 
neq3 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq4 := k(k(v2,k(v0,v1)),k(v3,v0)); 
neq5 := k(k(v2,k(v0,v1)),v3); 
neq6 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq7 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq8 := k(k(v2,k(v0,v1)),k(k(v3,v0),v3)); 
neq9 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq10 := k(k(v0,v1),v2); 
neq11 := k(k(v0,v1),k(k(v3,v2),v2)); 
neq12 := k(k(v0,v1),k(v3,v2)); 
neq13 := k(k(v0,v1),k(v3,v0)); 
neq14 := k(k(v0,v1),v3); 
neq15 := k(k(v0,v1),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq16 := k(k(v0,v1),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq17 := k(k(v0,v1),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq18 := k(k(v0,v1),k(k(v3,v0),v3)); 
neq19 := k(k(v0,v1),k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq20 := k(v2,v0); 
neq21 := k(v2,v1); 
neq22 := k(v2,k(v3,v0)); 
neq23 := k(v2,v3); 
neq24 := k(v2,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq25 := k(v2,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq26 := k(v2,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq27 := k(v2,k(k(v3,v0),v3)); 
neq28 := k(v2,k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq29 := k(v0,k(k(v3,v2),v2)); 
neq30 := k(v0,k(v3,v2)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq33 := k(v0,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq34 := k(v0,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq35 := k(v0,k(k(v3,v0),v3)); 
neq36 := k(v0,k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq37 := k(v1,k(k(v3,v2),v2)); 
neq38 := k(v1,k(v3,v2)); 
neq39 := k(v1,k(v3,v0)); 
neq40 := k(v1,v3); 
neq41 := k(v1,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq42 := k(v1,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq43 := k(v1,k(k(v3,v0),v3)); 
neq44 := k(v1,k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq45 := k(k(k(v3,v2),v2),k(v3,v0)); 
neq46 := k(k(k(v3,v2),v2),v3); 
neq47 := k(k(k(v3,v2),v2),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq48 := k(k(k(v3,v2),v2),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq49 := k(k(k(v3,v2),v2),k(k(v3,v0),v3)); 
neq50 := k(k(k(v3,v2),v2),k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq51 := k(k(v3,v2),k(v3,v0)); 
neq52 := k(k(v3,v2),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq53 := k(k(v3,v2),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq54 := k(k(v3,v2),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq55 := k(k(v3,v2),k(k(v3,v0),v3)); 
neq56 := k(k(v3,v2),k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq57 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq58 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq59 := k(k(v3,v0),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq60 := k(k(v3,v0),k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq61 := k(v3,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)); 
neq62 := k(v3,k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2))); 
neq63 := k(v3,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq64 := k(v3,k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3))); 
neq65 := k(k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq66 := k(k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1),k(k(v3,v0),v3)); 
neq67 := k(k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2)),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq68 := k(k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2)),k(k(v3,v0),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),k(k(v3,v2),v2)),k(k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v0),v3)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
