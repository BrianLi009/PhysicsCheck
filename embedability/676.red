...
neq2 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq3 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq4 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq5 := k(k(k(v2,v1),v1),v0); 
neq6 := k(k(k(v2,v1),v1),k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)))); 
neq7 := k(k(k(v2,v1),v1),v3); 
neq8 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq9 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq10 := k(v2,k(v3,k(v2,v1))); 
neq11 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq12 := k(v2,k(v0,v1)); 
neq13 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq14 := k(v2,v0); 
neq15 := k(v2,k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)))); 
neq16 := k(v2,v3); 
neq17 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq18 := k(v2,v1); 
neq19 := k(k(v3,k(v2,v1)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq20 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq21 := k(k(v3,k(v2,v1)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq22 := k(k(v3,k(v2,v1)),v0); 
neq23 := k(k(v3,k(v2,v1)),k(v2,v0)); 
neq24 := k(k(v3,k(v2,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq25 := k(k(v3,k(v2,v1)),k(k(v2,v1),v2)); 
neq26 := k(k(v3,k(v2,v1)),v1); 
neq27 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v0,v1)); 
neq28 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v0); 
neq29 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v3); 
neq30 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v0)); 
neq31 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq32 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v1); 
neq33 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v1)); 
neq34 := k(k(v0,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq35 := k(k(v0,v1),k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)))); 
neq36 := k(k(v0,v1),k(v2,v0)); 
neq37 := k(k(v0,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq38 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq39 := k(k(v0,v1),k(v2,v1)); 
neq40 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v0); 
neq41 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)))); 
neq42 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v3); 
...
neq46 := k(v0,k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2)))); 
neq47 := k(v0,v3); 
neq48 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq49 := k(v0,k(k(v2,v1),v2)); 
neq50 := k(v0,k(v2,v1)); 
neq51 := k(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),k(v2,v0)); 
neq52 := k(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),k(k(k(v2,v1),v1),k(v2,v0))); 
neq53 := k(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq54 := k(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),v1); 
neq55 := k(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),k(v2,v1)); 
neq56 := k(v3,k(v2,v0)); 
neq57 := k(v3,k(k(k(v2,v1),v1),k(v2,v0))); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(v3,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(v2,v1),v2))),k(v3,k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
