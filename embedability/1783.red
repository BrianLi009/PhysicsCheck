...
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq5 := k(v2,k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq6 := k(v2,k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq7 := k(v2,v1); 
neq8 := k(v2,v3); 
neq9 := k(v2,k(k(v3,v2),k(k(v2,v0),v0))); 
neq10 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),k(v2,v0))); 
neq11 := k(k(k(v2,v0),v0),k(v3,k(v2,v0))); 
neq12 := k(k(k(v2,v0),v0),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq13 := k(k(k(v2,v0),v0),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq14 := k(k(k(v2,v0),v0),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq15 := k(k(k(v2,v0),v0),k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq16 := k(k(k(v2,v0),v0),v1); 
neq17 := k(k(k(v2,v0),v0),v3); 
neq18 := k(k(k(v2,v0),v0),k(v3,v2)); 
neq19 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v0); 
neq20 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq21 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq22 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq23 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v1); 
neq24 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v3); 
neq25 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v3,v2)); 
neq26 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(v3,v2),k(k(v2,v0),v0))); 
neq27 := k(k(v3,k(v2,v0)),v0); 
neq28 := k(k(v3,k(v2,v0)),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq29 := k(k(v3,k(v2,v0)),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq30 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq31 := k(k(v3,k(v2,v0)),k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq32 := k(k(v3,k(v2,v0)),v1); 
neq33 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq34 := k(k(v3,k(v2,v0)),k(k(v3,v2),k(k(v2,v0),v0))); 
neq35 := k(v0,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq36 := k(v0,k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq37 := k(v0,k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq38 := k(v0,k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq39 := k(v0,v3); 
neq40 := k(v0,k(v3,v2)); 
neq41 := k(v0,k(k(v3,v2),k(k(v2,v0),v0))); 
neq42 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq43 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq44 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1); 
neq45 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v3); 
neq46 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),k(v2,v0)); 
neq47 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0)))); 
neq48 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v3); 
neq49 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,v2)); 
neq50 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(k(v3,v2),k(k(v2,v0),v0))); 
neq51 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v2,v0)); 
neq52 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),v1); 
neq53 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),v3); 
neq54 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(v3,v2)); 
neq55 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(k(v3,v2),k(k(v2,v0),v0))); 
neq56 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(v2,v0)); 
neq57 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0))),v1); 
neq58 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0))),v3); 
neq59 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0))),k(v3,v2)); 
neq60 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0))),k(v2,v0)); 
neq61 := k(v1,k(v3,v2)); 
neq62 := k(v1,k(k(v3,v2),k(k(v2,v0),v0))); 
neq63 := k(v1,k(v2,v0)); 
neq64 := k(v3,k(k(v3,v2),k(k(v2,v0),v0))); 
neq65 := k(v3,k(v2,v0)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(v3,k(v2,v0)),k(v2,v0))),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
