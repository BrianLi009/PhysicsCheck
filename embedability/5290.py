...
def test_embed(): 
    ...
    s.add(((z_10*x_13-x_10*z_13)*z_11-(x_10*y_13-y_10*x_13)*y_11)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_11-(y_10*z_13-z_10*y_13)*z_11)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_11-(z_10*x_13-x_10*z_13)*x_11)==0) 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_6-(x_1*y_13-y_1*x_13)*y_6)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_6-(y_1*z_13-z_1*y_13)*z_6)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_6-(z_1*x_13-x_1*z_13)*x_6)==0) 
    s.add(((z_2*x_12-x_2*z_12)*z_5-(x_2*y_12-y_2*x_12)*y_5)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_5-(y_2*z_12-z_2*y_12)*z_5)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_5-(z_2*x_12-x_2*z_12)*x_5)==0) 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_4-(x_6*y_13-y_6*x_13)*y_4)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_4-(y_6*z_13-z_6*y_13)*z_4)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_4-(z_6*x_13-x_6*z_13)*x_4)==0) 
