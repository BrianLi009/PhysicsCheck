...
def test_embed(): 
    ...
    s.add(((z_3*x_13-x_3*z_13)*z_8-(x_3*y_13-y_3*x_13)*y_8)==0) 
    s.add(((x_3*y_13-y_3*x_13)*x_8-(y_3*z_13-z_3*y_13)*z_8)==0) 
    s.add(((y_3*z_13-z_3*y_13)*y_8-(z_3*x_13-x_3*z_13)*x_8)==0) 
