...
neq2 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(v2,v0)); 
neq3 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1)); 
neq4 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(v0,v1)); 
neq5 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(k(v2,v0),v2)); 
neq6 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq7 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2),k(k(k(v2,v0),v2),k(v0,v1))); 
neq8 := k(v2,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2))); 
neq9 := k(v2,v0); 
neq10 := k(v2,v1); 
...
neq16 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),v0); 
neq17 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),v1); 
neq18 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(v2,v0)); 
neq19 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq20 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(v0,v1)); 
neq21 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(k(v2,v0),v2)); 
neq22 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(k(k(v2,v0),v2),k(v0,v1))); 
neq23 := k(v0,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1)); 
neq24 := k(v0,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq25 := k(v0,k(k(v2,v0),v2)); 
neq26 := k(v0,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq27 := k(v0,k(k(k(v2,v0),v2),k(v0,v1))); 
neq28 := k(v1,k(v2,v0)); 
neq29 := k(v1,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq30 := k(v1,k(k(v2,v0),v2)); 
neq31 := k(v1,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq32 := k(v1,k(k(k(v2,v0),v2),k(v0,v1))); 
neq33 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1)); 
neq34 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq35 := k(k(v2,v0),k(v0,v1)); 
neq36 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq37 := k(k(v2,v0),k(k(k(v2,v0),v2),k(v0,v1))); 
neq38 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq39 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1),k(v0,v1)); 
...
neq42 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),k(k(v2,v0),v2)); 
neq43 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq44 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq45 := k(k(v0,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v2)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
