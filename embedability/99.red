...
v3c2 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0)))); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(v3,k(k(v2,v0),v0))); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(k(v3,v2),k(k(v2,v0),v0))); 
neq6 := k(v2,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq7 := k(v2,k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq8 := k(v2,k(k(v2,v0),v0)); 
neq9 := k(v3,k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0)))); 
neq10 := k(v3,v0); 
neq11 := k(v3,k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq12 := k(v3,k(v2,v0)); 
neq13 := k(v3,k(k(v3,v2),k(k(v2,v0),v0))); 
neq14 := k(v3,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq15 := k(v3,k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq16 := k(v3,k(k(v2,v0),v0)); 
neq17 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),v0); 
neq18 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),k(v2,v0)); 
neq19 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),v1); 
neq20 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),k(k(v3,v2),k(k(v2,v0),v0))); 
neq21 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq22 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),k(k(v2,v0),v0)); 
neq23 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0))),k(v3,v2)); 
neq24 := k(v0,k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2)); 
neq25 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq26 := k(v0,k(k(v3,v2),k(k(v2,v0),v0))); 
neq27 := k(v0,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq28 := k(v0,k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(v3,k(k(v2,v0),v0))); 
neq31 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(v2,v0)); 
neq32 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),v1); 
neq33 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(k(v3,v2),k(k(v2,v0),v0))); 
neq34 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq35 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(k(v2,v0),v0)); 
neq36 := k(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(v3,v2)); 
neq37 := k(k(v3,k(k(v2,v0),v0)),k(v2,v0)); 
neq38 := k(k(v3,k(k(v2,v0),v0)),v1); 
neq39 := k(k(v3,k(k(v2,v0),v0)),k(k(v3,v2),k(k(v2,v0),v0))); 
neq40 := k(k(v3,k(k(v2,v0),v0)),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq41 := k(k(v3,k(k(v2,v0),v0)),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq42 := k(k(v3,k(k(v2,v0),v0)),k(v3,v2)); 
neq43 := k(k(v2,v0),v1); 
neq44 := k(k(v2,v0),k(k(v3,v2),k(k(v2,v0),v0))); 
neq45 := k(k(v2,v0),k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq46 := k(k(v2,v0),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq47 := k(k(v2,v0),k(v3,v2)); 
neq48 := k(v1,k(k(v3,v2),k(k(v2,v0),v0))); 
neq49 := k(v1,k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2))); 
neq50 := k(v1,k(k(v2,v0),v0)); 
neq51 := k(v1,k(v3,v2)); 
neq52 := k(k(k(v3,v2),k(k(v2,v0),v0)),k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1)); 
neq53 := k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),k(k(v2,v0),v0)); 
neq54 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(k(v2,v0),v0)); 
neq55 := k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,v2)); 
neq56 := k(k(k(v2,v0),v0),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),v2),k(k(k(k(k(v3,v2),k(k(v2,v0),v0)),k(v3,v2)),v1),k(v3,k(k(v2,v0),v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
