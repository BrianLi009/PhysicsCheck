...
def test_embed(): 
    ...
    s.add(((z_3*x_13-x_3*z_13)*z_11-(x_3*y_13-y_3*x_13)*y_11)==0) 
    s.add(((x_3*y_13-y_3*x_13)*x_11-(y_3*z_13-z_3*y_13)*z_11)==0) 
    s.add(((y_3*z_13-z_3*y_13)*y_11-(z_3*x_13-x_3*z_13)*x_11)==0) 
