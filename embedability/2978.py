...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_11-(x_5*y_10-y_5*x_10)*y_11)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_11-(y_5*z_10-z_5*y_10)*z_11)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_11-(z_5*x_10-x_5*z_10)*x_11)==0) 
