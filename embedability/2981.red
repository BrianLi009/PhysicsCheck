...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2)); 
neq1 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),v2); 
neq2 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1)); 
...
neq10 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3))); 
neq11 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v0); 
neq12 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v3); 
neq13 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq14 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(k(k(v3,v2),v3),v1)); 
neq15 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(k(v3,v2),v3)); 
neq16 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(k(k(k(v3,v2),v3),v1),v1)); 
neq17 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1); 
neq18 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),k(v3,v2)); 
neq19 := k(v2,k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3))); 
neq20 := k(v2,v0); 
neq21 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1)); 
neq22 := k(v2,v3); 
neq23 := k(v2,k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq24 := k(v2,k(k(k(v3,v2),v3),v1)); 
neq25 := k(v2,k(k(v3,v2),v3)); 
neq26 := k(v2,k(k(k(k(v3,v2),v3),v1),v1)); 
neq27 := k(v2,v1); 
neq28 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),v0); 
neq29 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq30 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),v3); 
neq31 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq32 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(k(k(v3,v2),v3),v1)); 
neq33 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v3),v1),v1)); 
neq34 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),v1); 
neq35 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(v3,v2)); 
neq36 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1)); 
...
neq42 := k(v0,k(v3,v2)); 
neq43 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq44 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),v3); 
neq45 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq46 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(k(v3,v2),v3),v1)); 
neq47 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(k(k(v3,v2),v3),v1),v1)); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(v3,v2)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v2),v1),k(k(v3,v2),v3)),k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
