...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_2-(x_0*y_13-y_0*x_13)*y_2)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_2-(y_0*z_13-z_0*y_13)*z_2)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_2-(z_0*x_13-x_0*z_13)*x_2)==0) 
    ...
    s.add(((z_2*x_10-x_2*z_10)*z_1-(x_2*y_10-y_2*x_10)*y_1)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_1-(y_2*z_10-z_2*y_10)*z_1)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_1-(z_2*x_10-x_2*z_10)*x_1)==0) 
    s.add(((z_1*x_12-x_1*z_12)*z_5-(x_1*y_12-y_1*x_12)*y_5)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_5-(y_1*z_12-z_1*y_12)*z_5)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_5-(z_1*x_12-x_1*z_12)*x_5)==0) 
    s.add(((z_3*x_10-x_3*z_10)*z_4-(x_3*y_10-y_3*x_10)*y_4)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_4-(y_3*z_10-z_3*y_10)*z_4)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_4-(z_3*x_10-x_3*z_10)*x_4)==0) 
    ...
    s.add(((z_11*x_13-x_11*z_13)*z_8-(x_11*y_13-y_11*x_13)*y_8)==0) 
    s.add(((x_11*y_13-y_11*x_13)*x_8-(y_11*z_13-z_11*y_13)*z_8)==0) 
    s.add(((y_11*z_13-z_11*y_13)*y_8-(z_11*x_13-x_11*z_13)*x_8)==0) 
