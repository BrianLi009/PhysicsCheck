...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(k(v3,v1),v3),k(v2,v0))); 
neq2 := k(v0,k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0))); 
neq3 := k(v0,k(v3,v1)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(v3,v2),v2)); 
neq6 := k(v0,k(v3,v2)); 
neq7 := k(v0,k(k(k(v3,v2),v2),k(v0,v1))); 
neq8 := k(v0,k(k(v3,v1),v3)); 
neq9 := k(v2,k(k(k(v3,v1),v3),k(v2,v0))); 
neq10 := k(v2,k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0))); 
neq11 := k(v2,k(v3,v1)); 
neq12 := k(v2,v3); 
neq13 := k(v2,k(v0,v1)); 
neq14 := k(v2,v1); 
neq15 := k(v2,k(k(k(v3,v2),v2),k(v0,v1))); 
neq16 := k(v2,k(k(v3,v1),v3)); 
neq17 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v3,v1)); 
neq18 := k(k(k(k(v3,v1),v3),k(v2,v0)),v3); 
neq19 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v0,v1)); 
neq20 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(k(v3,v2),v2)); 
neq21 := k(k(k(k(v3,v1),v3),k(v2,v0)),v1); 
neq22 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v3,v2)); 
neq23 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(k(k(v3,v2),v2),k(v0,v1))); 
neq24 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(v3,v1)); 
neq25 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),v3); 
neq26 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(v0,v1)); 
neq27 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(k(v3,v2),v2)); 
neq28 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),v1); 
neq29 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(v3,v2)); 
neq30 := k(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(k(v3,v1),v3)); 
neq31 := k(k(v3,v1),k(v0,v1)); 
neq32 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq33 := k(k(v3,v1),k(v3,v2)); 
neq34 := k(k(v3,v1),k(k(k(v3,v2),v2),k(v0,v1))); 
neq35 := k(k(v3,v1),k(v2,v0)); 
neq36 := k(v3,k(v0,v1)); 
neq37 := k(v3,k(k(v3,v2),v2)); 
neq38 := k(v3,v1); 
neq39 := k(v3,k(k(k(v3,v2),v2),k(v0,v1))); 
neq40 := k(v3,k(v2,v0)); 
...
neq47 := k(k(k(v3,v2),v2),k(v2,v0)); 
neq48 := k(v1,k(v3,v2)); 
neq49 := k(v1,k(k(k(v3,v2),v2),k(v0,v1))); 
neq50 := k(v1,k(k(v3,v1),v3)); 
neq51 := k(v1,k(v2,v0)); 
neq52 := k(k(v3,v2),k(k(k(v3,v2),v2),k(v0,v1))); 
neq53 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq54 := k(k(v3,v2),k(v2,v0)); 
neq55 := k(k(k(k(v3,v2),v2),k(v0,v1)),k(k(v3,v1),v3)); 
neq56 := k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)); 
...
phi := 
       ...
       d(k(k(k(k(v3,v2),v2),k(v0,v1)),k(v2,v0)),k(k(k(v3,v1),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
