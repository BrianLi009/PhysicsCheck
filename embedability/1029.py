...
def test_embed(): 
    ...
    s.add(((z_9*x_12-x_9*z_12)*z_8-(x_9*y_12-y_9*x_12)*y_8)==0) 
    s.add(((x_9*y_12-y_9*x_12)*x_8-(y_9*z_12-z_9*y_12)*z_8)==0) 
    s.add(((y_9*z_12-z_9*y_12)*y_8-(z_9*x_12-x_9*z_12)*x_8)==0) 
