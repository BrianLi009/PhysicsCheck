...
neq3 := k(v2,k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1)); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(k(v3,v2),v3),v0)); 
neq6 := k(v2,k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq7 := k(v2,k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq8 := k(v2,k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq9 := k(v2,k(k(v3,v2),v3)); 
neq10 := k(v3,k(k(v3,v2),v0)); 
neq11 := k(v3,k(k(k(v3,v2),v0),k(v3,v2))); 
neq12 := k(v3,k(v2,v1)); 
neq13 := k(v3,k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1)); 
neq14 := k(v3,v0); 
neq15 := k(v3,k(k(k(v3,v2),v3),v0)); 
neq16 := k(v3,k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq17 := k(v3,k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq18 := k(v3,v1); 
neq19 := k(k(k(v3,v2),v0),k(v2,v1)); 
neq20 := k(k(k(v3,v2),v0),k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1)); 
neq21 := k(k(k(v3,v2),v0),k(k(k(v3,v2),v3),v0)); 
neq22 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq23 := k(k(k(v3,v2),v0),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq24 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq25 := k(k(k(v3,v2),v0),k(k(v3,v2),v3)); 
neq26 := k(k(k(v3,v2),v0),v1); 
neq27 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)); 
neq28 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1)); 
neq29 := k(k(k(k(v3,v2),v0),k(v3,v2)),v0); 
neq30 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(v3,v2),v3),v0)); 
neq31 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq32 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq33 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(v3,v2),v3)); 
neq34 := k(k(k(k(v3,v2),v0),k(v3,v2)),v1); 
neq35 := k(k(v2,v1),k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1)); 
neq36 := k(k(v2,v1),v0); 
neq37 := k(k(v2,v1),k(k(k(v3,v2),v3),v0)); 
neq38 := k(k(v2,v1),k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq39 := k(k(v2,v1),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq40 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq41 := k(k(v2,v1),k(v3,v2)); 
neq42 := k(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),v0); 
neq43 := k(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v0)); 
neq44 := k(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq45 := k(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),k(k(v3,v2),v3)); 
neq46 := k(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),k(v3,v2)); 
neq47 := k(v0,k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3))); 
neq48 := k(v0,k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq49 := k(v0,k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq50 := k(v0,k(k(v3,v2),v3)); 
neq51 := k(v0,k(v3,v2)); 
neq52 := k(k(k(k(v3,v2),v3),v0),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq53 := k(k(k(k(v3,v2),v3),v0),k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq54 := k(k(k(k(v3,v2),v3),v0),v1); 
neq55 := k(k(k(k(v3,v2),v3),v0),k(v3,v2)); 
neq56 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)); 
neq57 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1))); 
neq58 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1); 
neq59 := k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),k(v3,v2)); 
neq60 := k(k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3),k(k(v3,v2),v3)); 
neq61 := k(k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3),v1); 
neq62 := k(k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3),k(v3,v2)); 
neq63 := k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),k(k(v3,v2),v3)); 
neq64 := k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v1); 
neq65 := k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),k(v3,v2)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(v3,v2),v3),v0),k(k(v3,v2),v3)),v1),k(k(k(k(k(v3,v2),v0),k(v3,v2)),k(v2,v1)),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
