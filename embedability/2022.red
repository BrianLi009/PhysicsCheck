...
neq7 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq8 := k(v2,k(v0,v1)); 
neq9 := k(v2,v1); 
neq10 := k(k(k(v3,v2),v1),v3); 
neq11 := k(k(k(v3,v2),v1),k(k(v3,v2),v3)); 
neq12 := k(k(k(v3,v2),v1),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq13 := k(k(k(v3,v2),v1),v0); 
neq14 := k(k(k(v3,v2),v1),k(v3,k(v0,v1))); 
neq15 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq16 := k(k(k(v3,v2),v1),k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq17 := k(k(k(v3,v2),v1),k(k(v3,k(v0,v1)),v2)); 
neq18 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq19 := k(v3,k(k(k(v3,v2),v1),k(v3,v2))); 
neq20 := k(v3,k(k(k(v3,k(v0,v1)),v2),v1)); 
neq21 := k(v3,v0); 
neq22 := k(v3,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq23 := k(v3,k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq24 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq25 := k(v3,k(v0,v1)); 
neq26 := k(v3,v1); 
neq27 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v3,v2),v3)); 
neq28 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq29 := k(k(k(k(v3,v2),v1),k(v3,v2)),v0); 
neq30 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(v0,v1))); 
neq31 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq32 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v3,k(v0,v1)),v2)); 
neq33 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)); 
neq34 := k(k(k(k(v3,v2),v1),k(v3,v2)),v1); 
neq35 := k(k(k(v3,v2),v3),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq36 := k(k(k(v3,v2),v3),v0); 
neq37 := k(k(k(v3,v2),v3),k(v3,k(v0,v1))); 
neq38 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq39 := k(k(k(v3,v2),v3),k(k(v3,k(v0,v1)),v2)); 
neq40 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq41 := k(k(k(v3,v2),v3),v1); 
neq42 := k(k(k(k(v3,k(v0,v1)),v2),v1),v0); 
neq43 := k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,k(v0,v1))); 
neq44 := k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq45 := k(k(k(k(v3,k(v0,v1)),v2),v1),k(v0,v1)); 
neq46 := k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)); 
neq47 := k(v0,k(v3,k(v0,v1))); 
neq48 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq49 := k(v0,k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq50 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq51 := k(v0,k(v3,v2)); 
neq52 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))); 
neq53 := k(k(v3,k(v0,v1)),k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3))); 
neq54 := k(k(v3,k(v0,v1)),v1); 
neq55 := k(k(v3,k(v0,v1)),k(v3,v2)); 
neq56 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)),k(k(v3,k(v0,v1)),v2)); 
neq57 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)),v1); 
neq58 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)),k(v3,v2)); 
neq59 := k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3)),k(k(v3,k(v0,v1)),v2)); 
neq60 := k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3)),k(v0,v1)); 
neq61 := k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3)),v1); 
neq62 := k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3)),k(v3,v2)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(v3,k(v0,v1)),v2),v1),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
