...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(v2,k(v0,v1))); 
neq1 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(v3,k(v0,v1))); 
neq2 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v0); 
neq3 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v1); 
neq4 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2); 
neq5 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v3); 
neq6 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
neq7 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(k(v3,k(v0,v1)),v3)); 
neq8 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq9 := k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq10 := k(k(v2,k(v0,v1)),k(v3,k(v0,v1))); 
neq11 := k(k(v2,k(v0,v1)),v0); 
neq12 := k(k(v2,k(v0,v1)),v1); 
neq13 := k(k(v2,k(v0,v1)),v3); 
neq14 := k(k(v2,k(v0,v1)),k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2)); 
neq15 := k(k(v2,k(v0,v1)),k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq16 := k(k(v2,k(v0,v1)),k(k(v3,k(v0,v1)),v3)); 
neq17 := k(k(v2,k(v0,v1)),k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq18 := k(k(v2,k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq19 := k(k(v3,k(v0,v1)),v0); 
neq20 := k(k(v3,k(v0,v1)),v1); 
neq21 := k(k(v3,k(v0,v1)),v2); 
neq22 := k(k(v3,k(v0,v1)),k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2)); 
neq23 := k(k(v3,k(v0,v1)),k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq24 := k(k(v3,k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
neq25 := k(k(v3,k(v0,v1)),k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq26 := k(k(v3,k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq27 := k(v0,v2); 
neq28 := k(v0,v3); 
neq29 := k(v0,k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2)); 
neq30 := k(v0,k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq31 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq32 := k(v0,k(k(v3,k(v0,v1)),v3)); 
neq33 := k(v0,k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq34 := k(v1,v2); 
neq35 := k(v1,v3); 
neq36 := k(v1,k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2)); 
neq37 := k(v1,k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq38 := k(v1,k(k(v2,k(v0,v1)),v2)); 
neq39 := k(v1,k(k(v3,k(v0,v1)),v3)); 
neq40 := k(v1,k(k(k(v2,k(v0,v1)),v2),v0)); 
neq41 := k(v2,v3); 
neq42 := k(v2,k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq43 := k(v2,k(k(v3,k(v0,v1)),v3)); 
neq44 := k(v2,k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq45 := k(v2,k(k(k(v2,k(v0,v1)),v2),v0)); 
neq46 := k(v2,k(v0,v1)); 
neq47 := k(v3,k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2)); 
neq48 := k(v3,k(k(v2,k(v0,v1)),v2)); 
neq49 := k(v3,k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq50 := k(v3,k(k(k(v2,k(v0,v1)),v2),v0)); 
neq51 := k(v3,k(v0,v1)); 
neq52 := k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),k(v3,k(k(k(v2,k(v0,v1)),v2),v0))); 
neq53 := k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),k(k(v2,k(v0,v1)),v2)); 
neq54 := k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),k(k(v3,k(v0,v1)),v3)); 
neq55 := k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq56 := k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),k(v0,v1)); 
neq57 := k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(k(v2,k(v0,v1)),v2)); 
neq58 := k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(k(v3,k(v0,v1)),v3)); 
neq59 := k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq60 := k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)); 
neq61 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(v0,v1)),v3)); 
neq62 := k(k(k(v2,k(v0,v1)),v2),k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1)); 
neq63 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq64 := k(k(k(v3,k(v0,v1)),v3),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq65 := k(k(k(v3,k(v0,v1)),v3),k(v0,v1)); 
neq66 := k(k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq67 := k(k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1),k(v0,v1)); 
neq68 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(v0,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(k(k(v2,k(v0,v1)),v2),v0)),k(v0,v1)),v2),v1),k(k(v3,k(v0,v1)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
