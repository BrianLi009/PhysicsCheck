...
def test_embed(): 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_2-(x_6*y_10-y_6*x_10)*y_2)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_2-(y_6*z_10-z_6*y_10)*z_2)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_2-(z_6*x_10-x_6*z_10)*x_2)==0) 
