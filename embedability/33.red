...
neq1 := k(v2,v0); 
neq2 := k(v2,v1); 
neq3 := k(v2,k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1))); 
neq4 := k(v2,k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq5 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq6 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq7 := k(v2,k(k(v2,v1),v1)); 
neq8 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(k(k(v2,v1),v2),v0),v0)); 
neq9 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),v0); 
neq10 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),v1); 
neq11 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1))); 
neq12 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(v2,v1),v2)); 
neq13 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(k(v2,v1),v2),v0)); 
neq14 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(v2,v1)); 
neq15 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(v2,v1),v1)); 
neq16 := k(k(k(k(k(v2,v1),v2),v0),v0),v1); 
neq17 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v2)); 
neq18 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq19 := k(k(k(k(k(v2,v1),v2),v0),v0),k(v2,v1)); 
neq20 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq21 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)); 
neq22 := k(v0,k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1))); 
neq23 := k(v0,k(k(v2,v1),v2)); 
neq24 := k(v0,k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq25 := k(v0,k(v2,v1)); 
neq26 := k(v0,k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq27 := k(v0,k(k(v2,v1),v1)); 
neq28 := k(v1,k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1))); 
neq29 := k(v1,k(k(v2,v1),v2)); 
neq30 := k(v1,k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq31 := k(v1,k(k(k(v2,v1),v2),v0)); 
neq32 := k(v1,k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq33 := k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
neq34 := k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq35 := k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)); 
neq36 := k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(v2,v1)); 
neq37 := k(k(k(v2,v1),v2),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq38 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq39 := k(k(k(v2,v1),v2),k(k(v2,v1),v1)); 
neq40 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
neq41 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v1)); 
neq42 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq43 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq44 := k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)); 
neq45 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),v2),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
