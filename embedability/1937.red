...
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(v0,v1),v2); 
neq1 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0))); 
neq2 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq3 := k(k(v0,v1),k(v2,v0)); 
neq4 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq5 := k(k(v0,v1),k(v2,v1)); 
neq6 := k(k(v0,v1),k(k(v2,v0),v0)); 
neq7 := k(k(v0,v1),k(k(v2,v1),v1)); 
neq8 := k(k(v0,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq9 := k(k(v0,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq10 := k(v2,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0))); 
neq11 := k(v2,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1))); 
neq12 := k(v2,v0); 
neq13 := k(v2,v1); 
...
neq18 := k(v2,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq19 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),v0); 
neq20 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(v2,v0)); 
neq21 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),v1); 
neq22 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
neq23 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(v2,v1)); 
neq24 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),k(v0,v1))); 
neq25 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(k(v2,v1),v1)); 
neq26 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq27 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),v0); 
neq28 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(v2,v0)); 
neq29 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),v1); 
neq30 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq31 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(v2,v1)); 
neq32 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(k(v2,v0),v2),k(v0,v1))); 
neq33 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(v2,v0),v0)); 
neq34 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq35 := k(v0,k(k(v2,v0),v2)); 
neq36 := k(v0,k(v2,v1)); 
neq37 := k(v0,k(k(k(v2,v0),v2),k(v0,v1))); 
neq38 := k(v0,k(k(v2,v1),v1)); 
neq39 := k(v0,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
...
neq45 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq46 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq47 := k(v1,k(k(v2,v0),v2)); 
neq48 := k(v1,k(k(k(v2,v0),v2),k(v0,v1))); 
neq49 := k(v1,k(k(v2,v0),v0)); 
neq50 := k(v1,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq51 := k(v1,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq52 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq53 := k(k(k(v2,v0),v2),k(k(v2,v0),v0)); 
neq54 := k(k(k(v2,v0),v2),k(k(v2,v1),v1)); 
neq55 := k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq56 := k(k(v2,v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq57 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq58 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq59 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v0)); 
neq60 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)); 
neq61 := k(k(k(v2,v0),v0),k(k(v2,v1),v1)); 
neq62 := k(k(k(v2,v0),v0),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq63 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
neq64 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0)) = 0 and 
       d(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)) = 0 and 
       d(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v2,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
