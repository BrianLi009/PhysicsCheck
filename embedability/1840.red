...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(v3,v0)); 
neq1 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),v2); 
neq2 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(k(v2,v1),v2)); 
neq3 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),v3); 
neq4 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(v3,v2)); 
neq5 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(k(v3,v0),k(k(v3,v2),v1))); 
neq6 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(v2,v1)); 
neq7 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(v3,v1)); 
neq8 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),v1); 
neq9 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0),k(k(v3,v2),v1)); 
neq10 := k(k(v3,v0),v2); 
neq11 := k(k(v3,v0),k(k(v2,v1),v2)); 
neq12 := k(k(v3,v0),k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1))); 
neq13 := k(k(v3,v0),k(v3,v2)); 
neq14 := k(k(v3,v0),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq15 := k(k(v3,v0),k(v2,v1)); 
neq16 := k(k(v3,v0),k(v3,v1)); 
neq17 := k(k(v3,v0),v1); 
neq18 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq19 := k(v2,v3); 
neq20 := k(v2,k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1))); 
neq21 := k(v2,v0); 
neq22 := k(v2,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq23 := k(v2,k(k(v3,v0),k(k(v3,v2),v1))); 
neq24 := k(v2,k(v3,v1)); 
neq25 := k(v2,v1); 
neq26 := k(v2,k(k(v3,v2),v1)); 
neq27 := k(k(k(v2,v1),v2),v3); 
neq28 := k(k(k(v2,v1),v2),k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1))); 
neq29 := k(k(k(v2,v1),v2),v0); 
neq30 := k(k(k(v2,v1),v2),k(v3,v2)); 
neq31 := k(k(k(v2,v1),v2),k(k(v3,v0),k(k(v3,v2),v1))); 
neq32 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq33 := k(k(k(v2,v1),v2),v1); 
neq34 := k(k(k(v2,v1),v2),k(k(v3,v2),v1)); 
neq35 := k(v3,k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1))); 
neq36 := k(v3,v0); 
neq37 := k(v3,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq38 := k(v3,k(k(v3,v0),k(k(v3,v2),v1))); 
neq39 := k(v3,k(v2,v1)); 
neq40 := k(v3,v1); 
neq41 := k(v3,k(k(v3,v2),v1)); 
neq42 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),v0); 
neq43 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),k(v3,v2)); 
neq44 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq45 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),k(v2,v1)); 
neq46 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),v1); 
neq47 := k(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),k(k(v3,v2),v1)); 
neq48 := k(v0,k(v3,v2)); 
...
neq54 := k(k(v3,v2),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq55 := k(k(v3,v2),k(k(v3,v0),k(k(v3,v2),v1))); 
neq56 := k(k(v3,v2),k(v2,v1)); 
neq57 := k(k(v3,v2),k(v3,v1)); 
neq58 := k(k(v3,v2),v1); 
neq59 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(k(v3,v0),k(k(v3,v2),v1))); 
neq60 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v2,v1)); 
neq61 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v1)); 
neq62 := k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v1); 
neq63 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v2,v1)); 
neq64 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)); 
neq65 := k(k(k(v3,v0),k(k(v3,v2),v1)),v1); 
neq66 := k(k(v2,v1),k(v3,v1)); 
neq67 := k(k(v2,v1),k(k(v3,v2),v1)); 
neq68 := k(k(v3,v1),k(k(v3,v2),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
