...
def test_embed(): 
    ...
    s.add(((z_2*x_5-x_2*z_5)*z_9-(x_2*y_5-y_2*x_5)*y_9)==0) 
    s.add(((x_2*y_5-y_2*x_5)*x_9-(y_2*z_5-z_2*y_5)*z_9)==0) 
    s.add(((y_2*z_5-z_2*y_5)*y_9-(z_2*x_5-x_2*z_5)*x_9)==0) 
    s.add(((z_2*x_6-x_2*z_6)*z_10-(x_2*y_6-y_2*x_6)*y_10)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_10-(y_2*z_6-z_2*y_6)*z_10)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_10-(z_2*x_6-x_2*z_6)*x_10)==0) 
    s.add(((z_0*x_5-x_0*z_5)*z_11-(x_0*y_5-y_0*x_5)*y_11)==0) 
    s.add(((x_0*y_5-y_0*x_5)*x_11-(y_0*z_5-z_0*y_5)*z_11)==0) 
    s.add(((y_0*z_5-z_0*y_5)*y_11-(z_0*x_5-x_0*z_5)*x_11)==0) 
    s.add(((z_1*x_6-x_1*z_6)*z_12-(x_1*y_6-y_1*x_6)*y_12)==0) 
    s.add(((x_1*y_6-y_1*x_6)*x_12-(y_1*z_6-z_1*y_6)*z_12)==0) 
    s.add(((y_1*z_6-z_1*y_6)*y_12-(z_1*x_6-x_1*z_6)*x_12)==0) 
