...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(v2,k(k(k(v3,v2),k(v0,v1)),k(v2,v1))); 
neq1 := k(v2,v3); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq4 := k(v2,k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq5 := k(v2,k(v0,v1)); 
neq6 := k(v2,k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq7 := k(v2,k(k(v3,v2),k(v0,v1))); 
neq8 := k(v2,v1); 
neq9 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(v2,v1)); 
neq10 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(v3,v2)); 
neq11 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(k(k(v3,v2),k(v0,v1)),k(v2,v1))); 
neq12 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),v3); 
neq13 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),v0); 
neq14 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq15 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(v0,v1)); 
neq16 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(k(v3,v2),k(v0,v1))); 
neq17 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),v1); 
neq18 := k(k(v2,v1),k(v3,v2)); 
neq19 := k(k(v2,v1),v3); 
neq20 := k(k(v2,v1),v0); 
neq21 := k(k(v2,v1),k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq22 := k(k(v2,v1),k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq23 := k(k(v2,v1),k(v0,v1)); 
neq24 := k(k(v2,v1),k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq25 := k(k(v2,v1),k(k(v3,v2),k(v0,v1))); 
neq26 := k(k(v3,v2),k(k(k(v3,v2),k(v0,v1)),k(v2,v1))); 
neq27 := k(k(v3,v2),v0); 
neq28 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq29 := k(k(v3,v2),k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq30 := k(k(v3,v2),k(v0,v1)); 
neq31 := k(k(v3,v2),k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq32 := k(k(v3,v2),v1); 
neq33 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),v3); 
neq34 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),v0); 
neq35 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq36 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(v0,v1)); 
neq37 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq38 := k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),v1); 
neq39 := k(v3,k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq40 := k(v3,k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq41 := k(v3,k(v0,v1)); 
neq42 := k(v3,k(k(v3,v2),k(v0,v1))); 
neq43 := k(v3,v1); 
neq44 := k(v0,k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)); 
neq45 := k(v0,k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq46 := k(v0,k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq47 := k(v0,k(k(v3,v2),k(v0,v1))); 
neq48 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1),k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1)))); 
neq49 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1),k(v0,v1)); 
neq50 := k(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1),k(k(v3,v2),k(v0,v1))); 
neq51 := k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),k(v0,v1)); 
neq52 := k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v1); 
neq53 := k(k(v0,v1),k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3)); 
neq54 := k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),k(k(v3,v2),k(v0,v1))); 
neq55 := k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1); 
neq56 := k(k(k(v3,v2),k(v0,v1)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v2),k(k(k(k(k(k(v3,v2),k(v0,v1)),k(v2,v1)),k(k(v3,v2),k(v0,v1))),v3),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
