...
def test_embed(): 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_5-(x_1*y_13-y_1*x_13)*y_5)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_5-(y_1*z_13-z_1*y_13)*z_5)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_5-(z_1*x_13-x_1*z_13)*x_5)==0) 
    ...
    s.add(((z_7*x_8-x_7*z_8)*z_9-(x_7*y_8-y_7*x_8)*y_9)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_9-(y_7*z_8-z_7*y_8)*z_9)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_9-(z_7*x_8-x_7*z_8)*x_9)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
