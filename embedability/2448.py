...
def test_embed(): 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_11-(x_3*y_10-y_3*x_10)*y_11)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_11-(y_3*z_10-z_3*y_10)*z_11)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_11-(z_3*x_10-x_3*z_10)*x_11)==0) 
