...
def test_embed(): 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_2-(x_4*y_10-y_4*x_10)*y_2)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_2-(y_4*z_10-z_4*y_10)*z_2)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_2-(z_4*x_10-x_4*z_10)*x_2)==0) 
    s.add(((z_2*x_5-x_2*z_5)*z_3-(x_2*y_5-y_2*x_5)*y_3)==0) 
    s.add(((x_2*y_5-y_2*x_5)*x_3-(y_2*z_5-z_2*y_5)*z_3)==0) 
    s.add(((y_2*z_5-z_2*y_5)*y_3-(z_2*x_5-x_2*z_5)*x_3)==0) 
