...
def test_embed(): 
    ...
    s.add(((z_0*x_2-x_0*z_2)*z_4-(x_0*y_2-y_0*x_2)*y_4)==0) 
    s.add(((x_0*y_2-y_0*x_2)*x_4-(y_0*z_2-z_0*y_2)*z_4)==0) 
    s.add(((y_0*z_2-z_0*y_2)*y_4-(z_0*x_2-x_0*z_2)*x_4)==0) 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_3-(x_1*y_12-y_1*x_12)*y_3)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_3-(y_1*z_12-z_1*y_12)*z_3)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_3-(z_1*x_12-x_1*z_12)*x_3)==0) 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_6-(x_3*y_10-y_3*x_10)*y_6)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_6-(y_3*z_10-z_3*y_10)*z_6)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_6-(z_3*x_10-x_3*z_10)*x_6)==0) 
