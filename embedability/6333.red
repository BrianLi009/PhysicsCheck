...
neq2 := k(v2,v1); 
neq3 := k(v2,k(v3,v1)); 
neq4 := k(v2,k(k(k(v4,v2),k(v3,v1)),v0)); 
neq5 := k(v2,k(v4,v3)); 
neq6 := k(v2,v4); 
neq7 := k(v2,k(k(v4,v2),k(v3,v1))); 
neq8 := k(v2,k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq9 := k(v2,k(v4,v0)); 
neq10 := k(k(v4,v2),k(k(v4,v0),v2)); 
neq11 := k(k(v4,v2),k(k(k(v4,v0),v2),v2)); 
neq12 := k(k(v4,v2),v0); 
neq13 := k(k(v4,v2),v3); 
neq14 := k(k(v4,v2),v1); 
neq15 := k(k(v4,v2),k(v3,v1)); 
neq16 := k(k(v4,v2),k(k(k(v4,v2),k(v3,v1)),v0)); 
neq17 := k(k(v4,v2),k(v4,v3)); 
neq18 := k(k(v4,v2),k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq19 := k(k(v4,v2),k(v4,v0)); 
neq20 := k(k(k(v4,v0),v2),v0); 
neq21 := k(k(k(v4,v0),v2),v3); 
neq22 := k(k(k(v4,v0),v2),v1); 
neq23 := k(k(k(v4,v0),v2),k(v3,v1)); 
neq24 := k(k(k(v4,v0),v2),k(k(k(v4,v2),k(v3,v1)),v0)); 
neq25 := k(k(k(v4,v0),v2),k(v4,v3)); 
neq26 := k(k(k(v4,v0),v2),v4); 
neq27 := k(k(k(v4,v0),v2),k(k(v4,v2),k(v3,v1))); 
neq28 := k(k(k(v4,v0),v2),k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq29 := k(k(k(k(v4,v0),v2),v2),v0); 
neq30 := k(k(k(k(v4,v0),v2),v2),v3); 
neq31 := k(k(k(k(v4,v0),v2),v2),v1); 
neq32 := k(k(k(k(v4,v0),v2),v2),k(v3,v1)); 
neq33 := k(k(k(k(v4,v0),v2),v2),k(k(k(v4,v2),k(v3,v1)),v0)); 
neq34 := k(k(k(k(v4,v0),v2),v2),k(v4,v3)); 
neq35 := k(k(k(k(v4,v0),v2),v2),v4); 
neq36 := k(k(k(k(v4,v0),v2),v2),k(k(v4,v2),k(v3,v1))); 
neq37 := k(k(k(k(v4,v0),v2),v2),k(v4,v0)); 
neq38 := k(v0,v3); 
neq39 := k(v0,k(v3,v1)); 
neq40 := k(v0,k(v4,v3)); 
neq41 := k(v0,v4); 
neq42 := k(v0,k(k(v4,v2),k(v3,v1))); 
neq43 := k(v0,k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq44 := k(v3,k(k(k(v4,v2),k(v3,v1)),v0)); 
neq45 := k(v3,v4); 
neq46 := k(v3,k(k(v4,v2),k(v3,v1))); 
neq47 := k(v3,k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq48 := k(v3,k(v4,v0)); 
neq49 := k(v1,k(k(k(v4,v2),k(v3,v1)),v0)); 
neq50 := k(v1,k(v4,v3)); 
neq51 := k(v1,v4); 
neq52 := k(v1,k(k(v4,v2),k(v3,v1))); 
neq53 := k(v1,k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq54 := k(v1,k(v4,v0)); 
neq55 := k(k(v3,v1),k(k(k(v4,v2),k(v3,v1)),v0)); 
neq56 := k(k(v3,v1),k(v4,v3)); 
neq57 := k(k(v3,v1),v4); 
neq58 := k(k(v3,v1),k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq59 := k(k(v3,v1),k(v4,v0)); 
neq60 := k(k(k(k(v4,v2),k(v3,v1)),v0),k(v4,v3)); 
neq61 := k(k(k(k(v4,v2),k(v3,v1)),v0),v4); 
neq62 := k(k(k(k(v4,v2),k(v3,v1)),v0),k(v4,v0)); 
neq63 := k(k(v4,v3),k(k(v4,v2),k(v3,v1))); 
neq64 := k(k(v4,v3),k(v4,v0)); 
neq65 := k(v4,k(k(v4,v2),k(v3,v1))); 
neq66 := k(v4,k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq67 := k(k(k(v4,v2),k(v3,v1)),k(k(k(k(v4,v0),v2),v2),k(v4,v3))); 
neq68 := k(k(k(v4,v2),k(v3,v1)),k(v4,v0)); 
neq69 := k(k(k(k(k(v4,v0),v2),v2),k(v4,v3)),k(v4,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v4,v2),k(v3,v1)),v0),k(k(k(k(v4,v0),v2),v2),k(v4,v3))) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
