...
neq3 := k(v2,v4); 
neq4 := k(v2,k(v3,v0)); 
neq5 := k(v2,k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq6 := k(v2,k(v4,k(v3,v0))); 
neq7 := k(v2,k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq10 := k(k(k(v4,k(v3,v0)),v2),k(k(v2,v1),v2)); 
neq11 := k(k(k(v4,k(v3,v0)),v2),k(v2,v1)); 
neq12 := k(k(k(v4,k(v3,v0)),v2),v3); 
neq13 := k(k(k(v4,k(v3,v0)),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq14 := k(k(k(v4,k(v3,v0)),v2),v0); 
neq15 := k(k(k(v4,k(v3,v0)),v2),v4); 
neq16 := k(k(k(v4,k(v3,v0)),v2),k(v3,v0)); 
neq17 := k(k(k(v4,k(v3,v0)),v2),k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq18 := k(k(k(v4,k(v3,v0)),v2),v1); 
neq19 := k(k(k(v4,k(v3,v0)),v2),k(v3,k(k(v2,v1),v2))); 
neq20 := k(k(k(v2,v1),v2),v3); 
neq21 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq22 := k(k(k(v2,v1),v2),v0); 
neq23 := k(k(k(v2,v1),v2),v4); 
neq24 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq25 := k(k(k(v2,v1),v2),k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq26 := k(k(k(v2,v1),v2),k(v4,k(v3,v0))); 
neq27 := k(k(k(v2,v1),v2),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(v2,v1),v3); 
neq30 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq31 := k(k(v2,v1),v0); 
neq32 := k(k(v2,v1),v4); 
neq33 := k(k(v2,v1),k(v3,v0)); 
neq34 := k(k(v2,v1),k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq35 := k(k(v2,v1),k(v4,k(v3,v0))); 
neq36 := k(k(v2,v1),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq37 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq38 := k(v3,v0); 
neq39 := k(v3,v4); 
neq40 := k(v3,k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq41 := k(v3,k(v4,k(v3,v0))); 
neq42 := k(v3,k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq43 := k(v3,v1); 
neq44 := k(k(k(v3,k(k(v2,v1),v2)),v3),v0); 
neq45 := k(k(k(v3,k(k(v2,v1),v2)),v3),v4); 
neq46 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(v3,v0)); 
neq47 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(v4,k(v3,v0))); 
neq48 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq49 := k(k(k(v3,k(k(v2,v1),v2)),v3),v1); 
neq50 := k(v0,v4); 
neq51 := k(v0,k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq52 := k(v0,k(v4,k(v3,v0))); 
neq53 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq54 := k(v4,k(v3,v0)); 
neq55 := k(v4,k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq56 := k(v4,k(v3,k(k(v2,v1),v2))); 
neq57 := k(k(v3,v0),k(v4,k(k(v3,k(k(v2,v1),v2)),v3))); 
neq58 := k(k(v3,v0),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq59 := k(k(v3,v0),v1); 
neq60 := k(k(v3,v0),k(v3,k(k(v2,v1),v2))); 
neq61 := k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),k(v4,k(v3,v0))); 
neq62 := k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v1); 
neq63 := k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),k(v3,k(k(v2,v1),v2))); 
neq64 := k(k(v4,k(v3,v0)),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)); 
neq65 := k(k(v4,k(v3,v0)),v1); 
neq66 := k(k(v4,k(v3,v0)),k(v3,k(k(v2,v1),v2))); 
neq67 := k(k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0),v1); 
neq68 := k(k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0),k(v3,k(k(v2,v1),v2))); 
neq69 := k(v1,k(v3,k(k(v2,v1),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v4,v1) = 0 and 
       d(k(k(v4,k(v3,v0)),v2),k(k(v4,k(k(v3,k(k(v2,v1),v2)),v3)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
