...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v3,k(k(v2,v1),v1)),v2); 
neq1 := k(k(v3,k(k(v2,v1),v1)),k(k(k(v3,k(k(v2,v1),v1)),v2),v2)); 
neq2 := k(k(v3,k(k(v2,v1),v1)),v0); 
neq3 := k(k(v3,k(k(v2,v1),v1)),k(v0,v1)); 
neq4 := k(k(v3,k(k(v2,v1),v1)),k(k(k(v3,v0),v3),k(v0,v1))); 
neq5 := k(k(v3,k(k(v2,v1),v1)),k(v3,v0)); 
neq6 := k(k(v3,k(k(v2,v1),v1)),k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq7 := k(k(v3,k(k(v2,v1),v1)),k(v2,v1)); 
neq8 := k(k(v3,k(k(v2,v1),v1)),v1); 
neq9 := k(k(v3,k(k(v2,v1),v1)),k(k(v3,v0),v3)); 
neq10 := k(v2,v0); 
neq11 := k(v2,k(v0,v1)); 
neq12 := k(v2,k(k(k(v3,v0),v3),k(v0,v1))); 
neq13 := k(v2,k(v3,v0)); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq16 := k(v2,k(k(v2,v1),v1)); 
neq17 := k(v2,v1); 
neq18 := k(v2,k(k(v3,v0),v3)); 
neq19 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),v0); 
neq20 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(v0,v1)); 
neq21 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(k(v3,v0),v3),k(v0,v1))); 
neq22 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(v3,v0)); 
neq23 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),v3); 
neq24 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v2,v1),v1)); 
neq25 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(v2,v1)); 
neq26 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),v1); 
neq27 := k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3)); 
neq28 := k(k(k(v3,k(k(v2,v1),v1)),v2),v0); 
neq29 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v0,v1)); 
neq30 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(k(v3,v0),v3),k(v0,v1))); 
neq31 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v3,v0)); 
neq32 := k(k(k(v3,k(k(v2,v1),v1)),v2),v3); 
neq33 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq34 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(v2,v1),v1)); 
neq35 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v2,v1)); 
neq36 := k(k(k(v3,k(k(v2,v1),v1)),v2),v1); 
neq37 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(v3,v0),v3)); 
neq38 := k(v0,k(k(k(v3,v0),v3),k(v0,v1))); 
neq39 := k(v0,v3); 
neq40 := k(v0,k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq41 := k(v0,k(k(v2,v1),v1)); 
neq42 := k(v0,k(v2,v1)); 
neq43 := k(v0,k(k(v3,v0),v3)); 
neq44 := k(k(v0,v1),k(v3,v0)); 
neq45 := k(k(v0,v1),v3); 
neq46 := k(k(v0,v1),k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq47 := k(k(v0,v1),k(k(v2,v1),v1)); 
neq48 := k(k(v0,v1),k(v2,v1)); 
neq49 := k(k(v0,v1),k(k(v3,v0),v3)); 
neq50 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,v0)); 
neq51 := k(k(k(k(v3,v0),v3),k(v0,v1)),v3); 
neq52 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v2,v1),v1)); 
neq53 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v2,v1)); 
neq54 := k(k(k(k(v3,v0),v3),k(v0,v1)),v1); 
neq55 := k(k(v3,v0),k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq56 := k(k(v3,v0),k(k(v2,v1),v1)); 
neq57 := k(k(v3,v0),k(v2,v1)); 
neq58 := k(k(v3,v0),v1); 
neq59 := k(v3,k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3))); 
neq60 := k(v3,k(k(v2,v1),v1)); 
neq61 := k(v3,k(v2,v1)); 
neq62 := k(v3,v1); 
neq63 := k(k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3)),k(k(v2,v1),v1)); 
neq64 := k(k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3)),k(v2,v1)); 
neq65 := k(k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3)),v1); 
neq66 := k(k(k(v2,v1),v1),k(k(v3,v0),v3)); 
neq67 := k(k(v2,v1),k(k(v3,v0),v3)); 
neq68 := k(v1,k(k(v3,v0),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(k(v2,v1),v1)),v2),v2),k(k(v3,v0),v3)),k(k(k(v3,v0),v3),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
