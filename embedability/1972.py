...
def test_embed(): 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_10-(x_7*y_11-y_7*x_11)*y_10)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_10-(y_7*z_11-z_7*y_11)*z_10)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_10-(z_7*x_11-x_7*z_11)*x_10)==0) 
    ...
    s.add(((z_3*x_8-x_3*z_8)*z_6-(x_3*y_8-y_3*x_8)*y_6)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_6-(y_3*z_8-z_3*y_8)*z_6)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_6-(z_3*x_8-x_3*z_8)*x_6)==0) 
