...
def test_embed(): 
    ...
    s.add(((z_9*x_11-x_9*z_11)*z_0-(x_9*y_11-y_9*x_11)*y_0)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_0-(y_9*z_11-z_9*y_11)*z_0)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_0-(z_9*x_11-x_9*z_11)*x_0)==0) 
    ...
    s.add(((z_3*x_9-x_3*z_9)*z_6-(x_3*y_9-y_3*x_9)*y_6)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_6-(y_3*z_9-z_3*y_9)*z_6)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_6-(z_3*x_9-x_3*z_9)*x_6)==0) 
