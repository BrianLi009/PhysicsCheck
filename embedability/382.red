...
neq9 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(k(v2,v1),v1)); 
neq10 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),v0); 
neq11 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(v2,v1)); 
neq12 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(k(k(v3,k(v2,v0)),v3),v0)); 
neq13 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(v2,v0)); 
neq14 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),v3); 
neq15 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),v1); 
neq16 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(v3,k(v2,v0))); 
neq17 := k(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(k(v3,k(v2,v0)),v3)); 
neq18 := k(k(k(v2,v1),v1),v0); 
neq19 := k(k(k(v2,v1),v1),k(k(k(v3,k(v2,v0)),v3),v0)); 
neq20 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq21 := k(k(k(v2,v1),v1),k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3))); 
neq22 := k(k(k(v2,v1),v1),v3); 
neq23 := k(k(k(v2,v1),v1),k(v3,k(v2,v0))); 
neq24 := k(k(k(v2,v1),v1),k(k(v3,k(v2,v0)),v3)); 
neq25 := k(v0,k(v2,v1)); 
neq26 := k(v0,k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3))); 
neq27 := k(v0,k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq28 := k(v0,v3); 
neq29 := k(v0,k(v3,k(v2,v0))); 
neq30 := k(v0,k(k(v3,k(v2,v0)),v3)); 
neq31 := k(k(v2,v1),k(k(k(v3,k(v2,v0)),v3),v0)); 
neq32 := k(k(v2,v1),k(v2,v0)); 
neq33 := k(k(v2,v1),k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3))); 
neq34 := k(k(v2,v1),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq35 := k(k(v2,v1),v3); 
neq36 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq37 := k(k(v2,v1),k(k(v3,k(v2,v0)),v3)); 
neq38 := k(k(k(k(v3,k(v2,v0)),v3),v0),k(v2,v0)); 
neq39 := k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq40 := k(k(k(k(v3,k(v2,v0)),v3),v0),v3); 
neq41 := k(k(k(k(v3,k(v2,v0)),v3),v0),v1); 
neq42 := k(k(k(k(v3,k(v2,v0)),v3),v0),k(v3,k(v2,v0))); 
neq43 := k(k(v2,v0),k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3))); 
neq44 := k(k(v2,v0),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq45 := k(k(v2,v0),v3); 
neq46 := k(k(v2,v0),v1); 
neq47 := k(k(v2,v0),k(k(v3,k(v2,v0)),v3)); 
neq48 := k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq49 := k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v3); 
neq50 := k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v1); 
neq51 := k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),k(v3,k(v2,v0))); 
neq52 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),v3); 
neq53 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),v1); 
neq54 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(k(v3,k(v2,v0)),v3)); 
neq55 := k(v1,k(v3,k(v2,v0))); 
neq56 := k(v1,k(k(v3,k(v2,v0)),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,k(v2,v0)),v3),v0),k(k(v3,k(v2,v0)),v3)),v2),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
