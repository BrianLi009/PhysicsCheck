...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_9-(x_2*y_13-y_2*x_13)*y_9)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_9-(y_2*z_13-z_2*y_13)*z_9)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_9-(z_2*x_13-x_2*z_13)*x_9)==0) 
