...
neq1 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2))); 
neq2 := k(k(v2,v1),v0); 
neq3 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq4 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1)); 
neq5 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq6 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq7 := k(k(v2,v1),k(v0,v1)); 
neq8 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq9 := k(k(v2,v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq10 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2))); 
neq11 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq12 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq13 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1)); 
neq14 := k(k(k(k(v2,v1),v2),k(v0,v1)),v2); 
neq15 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
...
neq20 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq21 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1)); 
neq22 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),v2); 
neq23 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq24 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq25 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v2)); 
neq26 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)),v1); 
neq27 := k(v0,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq28 := k(v0,k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1)); 
neq29 := k(v0,v2); 
neq30 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq31 := k(v0,k(v2,k(v0,v1))); 
neq32 := k(v0,k(k(v2,v1),v2)); 
neq33 := k(v0,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq34 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v2); 
neq35 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq36 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v0,v1)); 
neq37 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq38 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq39 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1); 
neq40 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),v2); 
neq41 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),k(k(v2,k(v0,v1)),v2)); 
neq42 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),k(v2,k(v0,v1))); 
neq43 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),k(v0,v1)); 
neq44 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),k(k(v2,v1),v2)); 
neq45 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1),k(k(k(v2,v1),v2),v0)); 
neq46 := k(v2,k(v0,v1)); 
neq47 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq48 := k(v2,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(v2,v1); 
neq50 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq51 := k(k(k(v2,k(v0,v1)),v2),k(k(v2,v1),v2)); 
neq52 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v2,v1),v2),v0)); 
neq53 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq54 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq55 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq56 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq57 := k(k(v2,k(v0,v1)),v1); 
neq58 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq59 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq60 := k(k(v0,v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq61 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq62 := k(k(k(v2,v1),v2),v1); 
neq63 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq64 := k(k(k(k(v2,v1),v2),v0),v1); 
neq65 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2))) = 0 and 
       d(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
