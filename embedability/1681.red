...
neq3 := k(v2,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq4 := k(v2,v0); 
...
neq12 := k(v3,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq13 := k(v3,k(v2,v1)); 
neq14 := k(v3,k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq15 := k(v3,k(k(v2,v1),v2)); 
neq16 := k(v3,k(v0,v1)); 
neq17 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq18 := k(v3,v1); 
neq19 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq20 := k(k(k(v3,v2),v1),k(v2,v1)); 
neq21 := k(k(k(v3,v2),v1),v0); 
neq22 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq23 := k(k(k(v3,v2),v1),k(k(v2,v1),v2)); 
neq24 := k(k(k(v3,v2),v1),k(k(v3,v2),v3)); 
neq25 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq26 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq27 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
...
neq33 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(k(v3,v2),v3),k(v0,v1))); 
neq34 := k(k(k(k(v3,v2),v1),k(v3,v2)),v1); 
neq35 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(v2,v1)); 
neq36 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0); 
neq37 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq38 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(v0,v1)); 
neq39 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v1); 
neq40 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(v3,v2)); 
neq41 := k(k(v2,v1),v0); 
neq42 := k(k(v2,v1),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq43 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq44 := k(k(v2,v1),k(v0,v1)); 
neq45 := k(k(v2,v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq46 := k(k(v2,v1),k(v3,v2)); 
neq47 := k(v0,k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq48 := k(v0,k(k(v2,v1),v2)); 
neq49 := k(v0,k(k(v3,v2),v3)); 
neq50 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq51 := k(v0,k(v3,v2)); 
neq52 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(v2,v1),v2)); 
neq53 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(v3,v2),v3)); 
neq54 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),v1); 
neq55 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(v3,v2)); 
neq56 := k(k(k(v2,v1),v2),k(k(v3,v2),v3)); 
neq57 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq58 := k(k(k(v2,v1),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(k(k(v3,v2),v3),k(v0,v1))) = 0 and 
       d(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
