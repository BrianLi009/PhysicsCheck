...
def test_embed(): 
    ...
    s.add(((z_2*x_5-x_2*z_5)*z_11-(x_2*y_5-y_2*x_5)*y_11)==0) 
    s.add(((x_2*y_5-y_2*x_5)*x_11-(y_2*z_5-z_2*y_5)*z_11)==0) 
    s.add(((y_2*z_5-z_2*y_5)*y_11-(z_2*x_5-x_2*z_5)*x_11)==0) 
    s.add(((z_0*x_5-x_0*z_5)*z_12-(x_0*y_5-y_0*x_5)*y_12)==0) 
    s.add(((x_0*y_5-y_0*x_5)*x_12-(y_0*z_5-z_0*y_5)*z_12)==0) 
    s.add(((y_0*z_5-z_0*y_5)*y_12-(z_0*x_5-x_0*z_5)*x_12)==0) 
