...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_9-(x_8*y_11-y_8*x_11)*y_9)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_9-(y_8*z_11-z_8*y_11)*z_9)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_9-(z_8*x_11-x_8*z_11)*x_9)==0) 
