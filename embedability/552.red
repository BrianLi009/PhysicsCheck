...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v0,k(k(v3,v1),v2)); 
neq1 := k(v0,k(k(v3,v2),v1)); 
neq2 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3)); 
neq3 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(v3,v2),v1),k(v3,v2))); 
neq6 := k(v0,k(v3,v1)); 
neq7 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq8 := k(v0,k(v3,v2)); 
neq9 := k(v2,v1); 
neq10 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0)); 
neq11 := k(v2,k(k(v3,v2),v1)); 
neq12 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3)); 
neq13 := k(v2,k(k(k(v3,v1),v2),k(v3,v1))); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(k(k(v3,v2),v1),k(v3,v2))); 
neq16 := k(v2,k(v3,v1)); 
neq17 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq18 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0)); 
neq19 := k(v1,k(k(v3,v1),v2)); 
neq20 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3)); 
neq21 := k(v1,k(k(k(v3,v1),v2),k(v3,v1))); 
neq22 := k(v1,v3); 
neq23 := k(v1,k(k(k(v3,v2),v1),k(v3,v2))); 
neq24 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq25 := k(v1,k(v3,v2)); 
neq26 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(k(v3,v1),v2)); 
neq27 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(k(v3,v2),v1)); 
neq28 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(k(k(v3,v1),v2),k(v3,v1))); 
neq29 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),v3); 
neq30 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(k(k(v3,v2),v1),k(v3,v2))); 
neq31 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(v3,v1)); 
neq32 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0),k(v3,v2)); 
neq33 := k(k(k(v3,v1),v2),k(k(v3,v2),v1)); 
neq34 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3)); 
neq35 := k(k(k(v3,v1),v2),v3); 
neq36 := k(k(k(v3,v1),v2),k(k(k(v3,v2),v1),k(v3,v2))); 
neq37 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq38 := k(k(k(v3,v1),v2),k(v3,v2)); 
neq39 := k(k(k(v3,v2),v1),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3)); 
neq40 := k(k(k(v3,v2),v1),k(k(k(v3,v1),v2),k(v3,v1))); 
neq41 := k(k(k(v3,v2),v1),v3); 
neq42 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq43 := k(k(k(v3,v2),v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq44 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3),k(k(k(v3,v1),v2),k(v3,v1))); 
neq45 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3),k(k(k(v3,v2),v1),k(v3,v2))); 
neq46 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3),k(v3,v1)); 
neq47 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3),k(v3,v2)); 
neq48 := k(k(k(k(v3,v1),v2),k(v3,v1)),v3); 
neq49 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))); 
neq50 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(v3,v2)); 
neq51 := k(v3,k(k(k(v3,v2),v1),k(v3,v2))); 
neq52 := k(v3,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq53 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,v1)); 
neq54 := k(k(v3,v1),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq55 := k(k(v3,v1),k(v3,v2)); 
neq56 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v3),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(v3,v2),v1),k(v3,v2))),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
