...
neq4 := k(v2,k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq5 := k(v2,v0); 
neq6 := k(v2,k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq7 := k(v2,k(v3,v0)); 
neq8 := k(v2,k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq9 := k(k(v3,v1),k(v3,v2)); 
neq10 := k(k(v3,v1),k(k(v3,v0),v2)); 
neq11 := k(k(v3,v1),k(k(v3,v0),v0)); 
neq12 := k(k(v3,v1),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq13 := k(k(v3,v1),v0); 
neq14 := k(k(v3,v1),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq15 := k(k(v3,v1),k(v3,v0)); 
neq16 := k(k(v3,v1),k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq17 := k(v3,k(k(v3,v0),v2)); 
neq18 := k(v3,k(k(k(v3,v0),v0),k(v3,v1))); 
neq19 := k(v3,k(k(v3,v0),v0)); 
neq20 := k(v3,k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq21 := k(v3,v0); 
neq22 := k(v3,k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq23 := k(v3,k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq24 := k(v3,v1); 
neq25 := k(k(v3,v2),k(k(v3,v0),v2)); 
neq26 := k(k(v3,v2),k(k(k(v3,v0),v0),k(v3,v1))); 
neq27 := k(k(v3,v2),k(k(v3,v0),v0)); 
neq28 := k(k(v3,v2),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq29 := k(k(v3,v2),v0); 
neq30 := k(k(v3,v2),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq31 := k(k(v3,v2),k(v3,v0)); 
neq32 := k(k(v3,v2),v1); 
neq33 := k(k(k(v3,v0),v2),k(k(k(v3,v0),v0),k(v3,v1))); 
neq34 := k(k(k(v3,v0),v2),k(k(v3,v0),v0)); 
neq35 := k(k(k(v3,v0),v2),v0); 
neq36 := k(k(k(v3,v0),v2),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq37 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq38 := k(k(k(v3,v0),v2),v1); 
neq39 := k(k(k(k(v3,v0),v0),k(v3,v1)),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq40 := k(k(k(k(v3,v0),v0),k(v3,v1)),v0); 
neq41 := k(k(k(k(v3,v0),v0),k(v3,v1)),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq42 := k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v0)); 
neq43 := k(k(k(k(v3,v0),v0),k(v3,v1)),v1); 
neq44 := k(k(k(v3,v0),v0),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))); 
neq45 := k(k(k(v3,v0),v0),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq46 := k(k(k(v3,v0),v0),k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq47 := k(k(k(v3,v0),v0),v1); 
neq48 := k(k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2)),v0); 
neq49 := k(k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2)),k(v3,v0)); 
neq50 := k(k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2)),v1); 
neq51 := k(v0,k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1)); 
neq52 := k(v0,k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq53 := k(k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1),k(v3,v0)); 
neq54 := k(k(v3,v0),k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2))); 
neq55 := k(k(v3,v0),v1); 
neq56 := k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),v1),k(k(k(k(k(v3,v0),v0),k(v3,v1)),k(v3,v2)),k(k(v3,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
