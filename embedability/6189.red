...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),v0); 
neq1 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(v3,k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq2 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),v3); 
neq3 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(v2,k(v0,v1))); 
neq4 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(k(k(v3,v2),v1),k(v3,v2))); 
neq5 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),v1); 
neq6 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(k(v3,v2),v1)); 
neq7 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(v0,v1)); 
neq8 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq9 := k(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(v3,v2)); 
neq10 := k(v2,k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq11 := k(v2,k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1))); 
neq12 := k(v2,v0); 
neq13 := k(v2,k(v3,k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq14 := k(v2,v3); 
...
neq20 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1))); 
neq21 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v0); 
neq22 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(v3,k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq23 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v3); 
neq24 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq25 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq26 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)); 
neq27 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq28 := k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),k(v3,v2)); 
neq29 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),v0); 
neq30 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),v3); 
neq31 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),k(v2,k(v0,v1))); 
neq32 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),k(k(k(v3,v2),v1),k(v3,v2))); 
neq33 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),v1); 
neq34 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),k(v0,v1)); 
neq35 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq36 := k(k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)),k(v3,v2)); 
neq37 := k(v0,k(v3,k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq38 := k(v0,k(v2,k(v0,v1))); 
neq39 := k(v0,k(k(k(v3,v2),v1),k(v3,v2))); 
neq40 := k(v0,k(k(v3,v2),v1)); 
neq41 := k(v0,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq42 := k(v0,k(v3,v2)); 
neq43 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq44 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v3,v2),v1),k(v3,v2))); 
neq45 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq46 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1)); 
neq47 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq48 := k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(v3,v2)); 
neq49 := k(v3,k(v2,k(v0,v1))); 
neq50 := k(v3,k(k(k(v3,v2),v1),k(v3,v2))); 
neq51 := k(v3,v1); 
neq52 := k(v3,k(k(v3,v2),v1)); 
neq53 := k(v3,k(v0,v1)); 
neq54 := k(v3,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq55 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v1),k(v3,v2))); 
neq56 := k(k(v2,k(v0,v1)),v1); 
neq57 := k(k(v2,k(v0,v1)),k(k(v3,v2),v1)); 
neq58 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq59 := k(k(k(k(v3,v2),v1),k(v3,v2)),v1); 
neq60 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v0,v1)); 
neq61 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq62 := k(v1,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq63 := k(v1,k(v3,v2)); 
neq64 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq65 := k(k(k(v3,v2),v1),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq66 := k(k(v0,v1),k(v3,v2)); 
neq67 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,v2),v1),k(v3,v2)),k(k(v2,k(v0,v1)),k(v0,v1))),v2),k(k(v3,k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
