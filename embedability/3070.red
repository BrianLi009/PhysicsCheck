...
v2c1 := 0;
neq0 := k(k(v3,v1),v2); 
neq1 := k(k(v3,v1),k(v2,v0)); 
neq2 := k(k(v3,v1),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2)); 
neq3 := k(k(v3,v1),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1)); 
neq4 := k(k(v3,v1),k(v3,v0)); 
neq5 := k(k(v3,v1),k(k(k(v3,v0),v3),v1)); 
neq6 := k(k(v3,v1),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq7 := k(k(v3,v1),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq8 := k(k(v3,v1),k(k(v3,v0),v3)); 
neq9 := k(k(v3,v1),v0); 
neq10 := k(v2,k(k(v3,v1),k(v2,v0))); 
neq11 := k(v2,v3); 
neq12 := k(v2,k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1)); 
neq13 := k(v2,k(v3,v0)); 
neq14 := k(v2,k(k(k(v3,v0),v3),v1)); 
neq15 := k(v2,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq16 := k(v2,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq17 := k(v2,k(k(v3,v0),v3)); 
neq18 := k(v2,v1); 
neq19 := k(k(v2,v0),v3); 
neq20 := k(k(v2,v0),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2)); 
neq21 := k(k(v2,v0),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1)); 
neq22 := k(k(v2,v0),k(v3,v0)); 
neq23 := k(k(v2,v0),k(k(k(v3,v0),v3),v1)); 
neq24 := k(k(v2,v0),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq25 := k(k(v2,v0),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq26 := k(k(v2,v0),k(k(v3,v0),v3)); 
neq27 := k(k(v2,v0),v1); 
neq28 := k(k(k(v3,v1),k(v2,v0)),v3); 
neq29 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2)); 
neq30 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1)); 
neq31 := k(k(k(v3,v1),k(v2,v0)),k(v3,v0)); 
neq32 := k(k(k(v3,v1),k(v2,v0)),k(k(k(v3,v0),v3),v1)); 
neq33 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq34 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v0),v3)); 
neq35 := k(k(k(v3,v1),k(v2,v0)),v0); 
neq36 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq37 := k(v3,k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2)); 
neq38 := k(v3,k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1)); 
neq39 := k(v3,k(k(k(v3,v0),v3),v1)); 
neq40 := k(v3,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq41 := k(v3,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq42 := k(v3,v0); 
neq43 := k(v3,v1); 
neq44 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),k(v3,v0)); 
neq45 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),k(k(k(v3,v0),v3),v1)); 
neq46 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq47 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),k(k(v3,v0),v3)); 
neq48 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),v0); 
neq49 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2),v1); 
neq50 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),k(v3,v0)); 
neq51 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),k(k(k(v3,v0),v3),v1)); 
neq52 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq53 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),k(k(v3,v0),v3)); 
neq54 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),v0); 
neq55 := k(k(v3,v0),k(k(k(v3,v0),v3),v1)); 
neq56 := k(k(v3,v0),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3))); 
neq57 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq58 := k(k(v3,v0),v1); 
neq59 := k(k(k(k(v3,v0),v3),v1),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0)))); 
neq60 := k(k(k(k(v3,v0),v3),v1),v0); 
neq61 := k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),v0); 
neq62 := k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),v1); 
neq63 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),k(k(v3,v0),v3)); 
neq64 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v0); 
neq65 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1); 
neq66 := k(k(k(v3,v0),v3),v0); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v1),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v3)),k(k(v3,v1),k(v2,v0))),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
