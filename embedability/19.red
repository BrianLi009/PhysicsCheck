...
v3c3 := 0;
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(v3,k(v2,v0)),k(v2,v0))); 
neq2 := k(v0,k(k(v2,v0),v2)); 
neq3 := k(v0,k(v3,k(v2,v0))); 
neq4 := k(v0,k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq5 := k(v0,k(v3,v2)); 
neq6 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq7 := k(v0,v3); 
neq8 := k(v2,k(k(v3,k(v2,v0)),k(v2,v0))); 
neq9 := k(v2,k(v3,k(v2,v0))); 
neq10 := k(v2,v1); 
neq11 := k(v2,k(v0,v1)); 
neq12 := k(v2,k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq13 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq14 := k(v2,v3); 
neq15 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(v2,v0),v2)); 
neq16 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v1); 
neq17 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v0,v1)); 
neq18 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v3,v2)); 
neq19 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq20 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v3); 
neq21 := k(k(k(v2,v0),v2),k(v3,k(v2,v0))); 
neq22 := k(k(k(v2,v0),v2),v1); 
neq23 := k(k(k(v2,v0),v2),k(v0,v1)); 
neq24 := k(k(k(v2,v0),v2),k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq25 := k(k(k(v2,v0),v2),k(v3,v2)); 
neq26 := k(k(k(v2,v0),v2),v3); 
neq27 := k(k(v3,k(v2,v0)),v1); 
neq28 := k(k(v3,k(v2,v0)),k(v0,v1)); 
neq29 := k(k(v3,k(v2,v0)),k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq30 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq31 := k(k(v3,k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq32 := k(v1,k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq33 := k(v1,k(v3,v2)); 
neq34 := k(v1,v3); 
neq35 := k(v1,k(v2,v0)); 
neq36 := k(k(v0,v1),k(k(v3,v2),k(k(k(v2,v0),v2),v1))); 
neq37 := k(k(v0,v1),k(v3,v2)); 
neq38 := k(k(v0,v1),k(k(k(v2,v0),v2),v1)); 
neq39 := k(k(v0,v1),k(v2,v0)); 
neq40 := k(k(k(v3,v2),k(k(k(v2,v0),v2),v1)),v3); 
neq41 := k(k(k(v3,v2),k(k(k(v2,v0),v2),v1)),k(v2,v0)); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(v3,v2),k(k(k(v2,v0),v2),v1)),k(k(v3,k(v2,v0)),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
