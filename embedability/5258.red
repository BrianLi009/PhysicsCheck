...
neq1 := k(k(k(v3,v2),v0),k(v2,v1)); 
neq2 := k(k(k(v3,v2),v0),v1); 
neq3 := k(k(k(v3,v2),v0),k(k(v2,v1),v2)); 
neq4 := k(k(k(v3,v2),v0),k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq5 := k(k(k(v3,v2),v0),k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq6 := k(k(k(v3,v2),v0),v3); 
neq7 := k(k(k(v3,v2),v0),k(k(v3,v1),v3)); 
neq8 := k(k(k(v3,v2),v0),k(k(v3,v1),k(k(v2,v1),v2))); 
neq9 := k(k(k(v3,v2),v0),k(v3,v1)); 
neq10 := k(k(v3,v2),k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3))); 
neq11 := k(k(v3,v2),v0); 
neq12 := k(k(v3,v2),k(v2,v1)); 
neq13 := k(k(v3,v2),v1); 
neq14 := k(k(v3,v2),k(k(v2,v1),v2)); 
neq15 := k(k(v3,v2),k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq16 := k(k(v3,v2),k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq17 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq18 := k(k(v3,v2),k(k(v3,v1),k(k(v2,v1),v2))); 
neq19 := k(k(v3,v2),k(v3,v1)); 
neq20 := k(v2,k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3))); 
neq21 := k(v2,v0); 
neq22 := k(v2,v1); 
neq23 := k(v2,k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq24 := k(v2,k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq25 := k(v2,v3); 
neq26 := k(v2,k(k(v3,v1),v3)); 
neq27 := k(v2,k(k(v3,v1),k(k(v2,v1),v2))); 
neq28 := k(v2,k(v3,v1)); 
neq29 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),v0); 
neq30 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(v2,v1)); 
neq31 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),v1); 
neq32 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(k(v2,v1),v2)); 
neq33 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq34 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),v3); 
neq35 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(k(v3,v1),k(k(v2,v1),v2))); 
neq36 := k(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(v3,v1)); 
neq37 := k(v0,k(v2,v1)); 
neq38 := k(v0,k(k(v2,v1),v2)); 
neq39 := k(v0,k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq40 := k(v0,v3); 
neq41 := k(v0,k(k(v3,v1),v3)); 
neq42 := k(v0,k(k(v3,v1),k(k(v2,v1),v2))); 
neq43 := k(v0,k(v3,v1)); 
neq44 := k(k(v2,v1),k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq45 := k(k(v2,v1),k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq46 := k(k(v2,v1),v3); 
neq47 := k(k(v2,v1),k(k(v3,v1),v3)); 
neq48 := k(k(v2,v1),k(k(v3,v1),k(k(v2,v1),v2))); 
neq49 := k(k(v2,v1),k(v3,v1)); 
neq50 := k(v1,k(k(v2,v1),v2)); 
neq51 := k(v1,k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq52 := k(v1,k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq53 := k(v1,v3); 
neq54 := k(v1,k(k(v3,v1),v3)); 
neq55 := k(v1,k(k(v3,v1),k(k(v2,v1),v2))); 
neq56 := k(k(k(v2,v1),v2),k(k(k(v3,v1),k(k(v2,v1),v2)),v0)); 
neq57 := k(k(k(v2,v1),v2),k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2)))); 
neq58 := k(k(k(v2,v1),v2),v3); 
neq59 := k(k(k(v2,v1),v2),k(k(v3,v1),v3)); 
neq60 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq61 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),v3); 
neq62 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),v3)); 
neq63 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(v3,v1)); 
neq64 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),v3); 
neq65 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)); 
neq66 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(v3,v1)); 
neq67 := k(v3,k(k(v3,v1),k(k(v2,v1),v2))); 
neq68 := k(k(k(v3,v1),v3),k(k(v3,v1),k(k(v2,v1),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),v0),k(k(v3,v1),k(k(v2,v1),v2))),k(k(v3,v1),v3)),k(k(v3,v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
