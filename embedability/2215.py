...
def test_embed(): 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_0-(x_8*y_12-y_8*x_12)*y_0)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_0-(y_8*z_12-z_8*y_12)*z_0)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_0-(z_8*x_12-x_8*z_12)*x_0)==0) 
