...
def test_embed(): 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_0-(x_6*y_13-y_6*x_13)*y_0)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_0-(y_6*z_13-z_6*y_13)*z_0)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_0-(z_6*x_13-x_6*z_13)*x_0)==0) 
    ...
    s.add(((z_2*x_7-x_2*z_7)*z_5-(x_2*y_7-y_2*x_7)*y_5)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_5-(y_2*z_7-z_2*y_7)*z_5)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_5-(z_2*x_7-x_2*z_7)*x_5)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_6 == 0) 
