...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_11-(x_0*y_10-y_0*x_10)*y_11)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_11-(y_0*z_10-z_0*y_10)*z_11)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_11-(z_0*x_10-x_0*z_10)*x_11)==0) 
