...
neq2 := k(v2,k(k(v3,k(v2,v1)),k(v2,k(v0,v1)))); 
neq3 := k(v2,k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1)))); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2))); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq8 := k(v2,k(v3,k(v2,v1))); 
neq9 := k(v2,v1); 
neq10 := k(k(v0,v1),k(v3,k(v2,k(v0,v1)))); 
neq11 := k(k(v0,v1),k(k(v3,k(v2,v1)),k(v2,k(v0,v1)))); 
neq12 := k(k(v0,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1)))); 
neq13 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq14 := k(k(v0,v1),k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2))); 
neq15 := k(k(v0,v1),v3); 
neq16 := k(k(v0,v1),k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq17 := k(k(v0,v1),k(v3,k(v2,v1))); 
neq18 := k(k(v0,v1),k(v2,v1)); 
neq19 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,k(v2,v1)),k(v2,k(v0,v1)))); 
neq20 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1)))); 
neq21 := k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq22 := k(k(v3,k(v2,k(v0,v1))),v0); 
neq23 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq24 := k(k(v3,k(v2,k(v0,v1))),k(v3,k(v2,v1))); 
neq25 := k(k(v3,k(v2,k(v0,v1))),k(v2,v1)); 
neq26 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq27 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq28 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),v0); 
neq29 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2))); 
neq30 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),v3); 
neq31 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq32 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),k(v2,v1)); 
neq33 := k(k(k(v3,k(v2,v1)),k(v2,k(v0,v1))),v1); 
neq34 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq35 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),v0); 
neq36 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2))); 
neq37 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),v3); 
neq38 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),k(v3,k(v2,v1))); 
neq39 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),k(v2,v1)); 
neq40 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),v1); 
neq41 := k(k(k(v2,v1),v2),v0); 
neq42 := k(k(k(v2,v1),v2),v3); 
neq43 := k(k(k(v2,v1),v2),k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq44 := k(k(k(v2,v1),v2),k(v3,k(v2,v1))); 
neq45 := k(k(k(v2,v1),v2),v1); 
neq46 := k(k(k(v2,v1),v2),k(v2,k(v0,v1))); 
neq47 := k(v0,k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2))); 
neq48 := k(v0,k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq49 := k(v0,k(v3,k(v2,v1))); 
neq50 := k(v0,k(v2,v1)); 
neq51 := k(v0,k(v2,k(v0,v1))); 
neq52 := k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v3); 
neq53 := k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),k(v3,k(v2,v1))); 
neq54 := k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),k(v2,v1)); 
neq55 := k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1); 
neq56 := k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),k(v2,k(v0,v1))); 
neq57 := k(v3,k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1)); 
neq58 := k(v3,k(v2,v1)); 
neq59 := k(v3,v1); 
neq60 := k(v3,k(v2,k(v0,v1))); 
neq61 := k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))); 
neq62 := k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,v1)); 
neq63 := k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v2)),v1),k(v2,k(v0,v1))),k(k(v3,k(v2,v1)),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
