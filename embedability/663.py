...
def test_embed(): 
    ...
    s.add(((z_10*x_11-x_10*z_11)*z_12-(x_10*y_11-y_10*x_11)*y_12)==0) 
    s.add(((x_10*y_11-y_10*x_11)*x_12-(y_10*z_11-z_10*y_11)*z_12)==0) 
    s.add(((y_10*z_11-z_10*y_11)*y_12-(z_10*x_11-x_10*z_11)*x_12)==0) 
    s.add(((z_8*x_12-x_8*z_12)*z_9-(x_8*y_12-y_8*x_12)*y_9)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_9-(y_8*z_12-z_8*y_12)*z_9)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_9-(z_8*x_12-x_8*z_12)*x_9)==0) 
    ...
    s.add(((z_0*x_9-x_0*z_9)*z_6-(x_0*y_9-y_0*x_9)*y_6)==0) 
    s.add(((x_0*y_9-y_0*x_9)*x_6-(y_0*z_9-z_0*y_9)*z_6)==0) 
    s.add(((y_0*z_9-z_0*y_9)*y_6-(z_0*x_9-x_0*z_9)*x_6)==0) 
    s.add(((z_8*x_10-x_8*z_10)*z_1-(x_8*y_10-y_8*x_10)*y_1)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_1-(y_8*z_10-z_8*y_10)*z_1)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_1-(z_8*x_10-x_8*z_10)*x_1)==0) 
    s.add(((z_7*x_12-x_7*z_12)*z_2-(x_7*y_12-y_7*x_12)*y_2)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_2-(y_7*z_12-z_7*y_12)*z_2)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_2-(z_7*x_12-x_7*z_12)*x_2)==0) 
    s.add(((z_6*x_7-x_6*z_7)*z_3-(x_6*y_7-y_6*x_7)*y_3)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_3-(y_6*z_7-z_6*y_7)*z_3)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_3-(z_6*x_7-x_6*z_7)*x_3)==0) 
    s.add(((z_8*x_9-x_8*z_9)*z_4-(x_8*y_9-y_8*x_9)*y_4)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_4-(y_8*z_9-z_8*y_9)*z_4)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_4-(z_8*x_9-x_8*z_9)*x_4)==0) 
    s.add(((z_4*x_7-x_4*z_7)*z_5-(x_4*y_7-y_4*x_7)*y_5)==0) 
    s.add(((x_4*y_7-y_4*x_7)*x_5-(y_4*z_7-z_4*y_7)*z_5)==0) 
    s.add(((y_4*z_7-z_4*y_7)*y_5-(z_4*x_7-x_4*z_7)*x_5)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_8 == 0) 
