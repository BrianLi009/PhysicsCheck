...
neq6 := k(v2,k(k(k(v3,v2),v0),v0)); 
neq7 := k(v2,k(k(v3,v2),v3)); 
neq8 := k(v2,k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq9 := k(k(k(v3,v1),v1),k(v2,v1)); 
neq10 := k(k(k(v3,v1),v1),v0); 
neq11 := k(k(k(v3,v1),v1),v3); 
neq12 := k(k(k(v3,v1),v1),k(k(k(v3,v2),v3),k(v2,v1))); 
neq13 := k(k(k(v3,v1),v1),k(k(v3,v2),v0)); 
neq14 := k(k(k(v3,v1),v1),k(k(k(v3,v2),v0),v0)); 
neq15 := k(k(k(v3,v1),v1),k(k(v3,v2),v3)); 
neq16 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq17 := k(k(v3,v1),k(v2,v1)); 
neq18 := k(k(v3,v1),v0); 
neq19 := k(k(v3,v1),k(k(k(v3,v2),v3),k(v2,v1))); 
neq20 := k(k(v3,v1),k(k(v3,v2),v0)); 
neq21 := k(k(v3,v1),k(k(k(v3,v2),v0),v0)); 
neq22 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq23 := k(k(v3,v1),k(v3,v2)); 
neq24 := k(k(v3,v1),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq25 := k(k(v2,v1),v0); 
neq26 := k(k(v2,v1),v3); 
neq27 := k(k(v2,v1),k(k(v3,v2),v0)); 
neq28 := k(k(v2,v1),k(k(k(v3,v2),v0),v0)); 
neq29 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq30 := k(k(v2,v1),k(v3,v2)); 
neq31 := k(k(v2,v1),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq32 := k(v0,v3); 
neq33 := k(v0,k(k(k(v3,v2),v3),k(v2,v1))); 
neq34 := k(v0,k(k(v3,v2),v3)); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(v0,k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq37 := k(v3,k(k(k(v3,v2),v3),k(v2,v1))); 
neq38 := k(v3,k(k(v3,v2),v0)); 
neq39 := k(v3,k(k(k(v3,v2),v0),v0)); 
neq40 := k(v3,k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq41 := k(v3,v1); 
neq42 := k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(v3,v2),v0)); 
neq43 := k(k(k(k(v3,v2),v3),k(v2,v1)),k(k(k(v3,v2),v0),v0)); 
neq44 := k(k(k(k(v3,v2),v3),k(v2,v1)),k(v3,v2)); 
neq45 := k(k(k(k(v3,v2),v3),k(v2,v1)),v1); 
neq46 := k(k(k(v3,v2),v0),k(k(v3,v2),v3)); 
neq47 := k(k(k(v3,v2),v0),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq48 := k(k(k(v3,v2),v0),v1); 
neq49 := k(k(k(k(v3,v2),v0),v0),k(k(v3,v2),v3)); 
neq50 := k(k(k(k(v3,v2),v0),v0),k(v3,v2)); 
neq51 := k(k(k(k(v3,v2),v0),v0),v1); 
neq52 := k(k(k(v3,v2),v3),v1); 
neq53 := k(k(v3,v2),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))); 
neq54 := k(k(v3,v2),v1); 
neq55 := k(k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(v3,v1),v1),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))) = 0 and 
       d(k(k(k(v3,v2),v3),k(v2,v1)),k(k(k(v3,v2),v3),k(k(k(v3,v2),v0),v0))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
