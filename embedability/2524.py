...
def test_embed(): 
    ...
    s.add(((z_4*x_6-x_4*z_6)*z_9-(x_4*y_6-y_4*x_6)*y_9)==0) 
    s.add(((x_4*y_6-y_4*x_6)*x_9-(y_4*z_6-z_4*y_6)*z_9)==0) 
    s.add(((y_4*z_6-z_4*y_6)*y_9-(z_4*x_6-x_4*z_6)*x_9)==0) 
    s.add(((z_8*x_10-x_8*z_10)*z_5-(x_8*y_10-y_8*x_10)*y_5)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_5-(y_8*z_10-z_8*y_10)*z_5)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_5-(z_8*x_10-x_8*z_10)*x_5)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_6 == 0) 
