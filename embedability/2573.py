...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_5-(x_0*y_13-y_0*x_13)*y_5)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_5-(y_0*z_13-z_0*y_13)*z_5)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_5-(z_0*x_13-x_0*z_13)*x_5)==0) 
    ...
    s.add(((z_5*x_8-x_5*z_8)*z_9-(x_5*y_8-y_5*x_8)*y_9)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_9-(y_5*z_8-z_5*y_8)*z_9)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_9-(z_5*x_8-x_5*z_8)*x_9)==0) 
    s.add(((z_6*x_9-x_6*z_9)*z_11-(x_6*y_9-y_6*x_9)*y_11)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_11-(y_6*z_9-z_6*y_9)*z_11)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_11-(z_6*x_9-x_6*z_9)*x_11)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_5 == 0) 
