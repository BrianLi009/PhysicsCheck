...
def test_embed(): 
    ...
    s.add(((z_2*x_12-x_2*z_12)*z_11-(x_2*y_12-y_2*x_12)*y_11)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_11-(y_2*z_12-z_2*y_12)*z_11)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_11-(z_2*x_12-x_2*z_12)*x_11)==0) 
