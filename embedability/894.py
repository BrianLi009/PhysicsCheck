...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_0-(x_7*y_12-y_7*x_12)*y_0)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_0-(y_7*z_12-z_7*y_12)*z_0)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_0-(z_7*x_12-x_7*z_12)*x_0)==0) 
    s.add(((z_8*x_13-x_8*z_13)*z_1-(x_8*y_13-y_8*x_13)*y_1)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_1-(y_8*z_13-z_8*y_13)*z_1)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_1-(z_8*x_13-x_8*z_13)*x_1)==0) 
