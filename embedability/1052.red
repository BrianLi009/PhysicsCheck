...
neq1 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq2 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1)))); 
neq3 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq4 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v2,k(v0,v1))); 
...
neq8 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)); 
neq9 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq10 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq11 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1)))); 
neq12 := k(v2,v0); 
neq13 := k(v2,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1))); 
neq14 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(k(v2,v1),v1)); 
neq17 := k(v2,k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq18 := k(v2,k(v0,v1)); 
neq19 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1)))); 
neq20 := k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))); 
neq21 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1))); 
neq22 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq23 := k(k(k(k(v2,v1),v2),v0),v1); 
neq24 := k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)); 
neq25 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq26 := k(k(k(k(v2,v1),v2),v0),k(v0,v1)); 
neq27 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),v0); 
neq28 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1))); 
neq29 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(v2,v1)); 
neq30 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),v1); 
neq31 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(k(v2,v1),v1)); 
neq32 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(v0,v1)); 
neq33 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
...
neq39 := k(v0,k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq40 := k(v0,k(k(v2,v1),v2)); 
neq41 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1))); 
neq42 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq43 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq44 := k(k(v2,k(v0,v1)),v1); 
neq45 := k(k(v2,k(v0,v1)),k(k(v2,v1),v1)); 
neq46 := k(k(v2,k(v0,v1)),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq47 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq48 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(v2,v1)); 
neq49 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq50 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),v1); 
neq51 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(v0,v1)); 
neq52 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
neq53 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq54 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
...
neq59 := k(v1,k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))); 
neq60 := k(v1,k(k(v2,v1),v2)); 
neq61 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq62 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq63 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(v0,v1)); 
neq64 := k(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))) = 0 and 
       d(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,k(v0,v1))),k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
