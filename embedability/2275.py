...
def test_embed(): 
    ...
    s.add(((z_8*x_9-x_8*z_9)*z_12-(x_8*y_9-y_8*x_9)*y_12)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_12-(y_8*z_9-z_8*y_9)*z_12)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_12-(z_8*x_9-x_8*z_9)*x_12)==0) 
    s.add(((z_7*x_8-x_7*z_8)*z_0-(x_7*y_8-y_7*x_8)*y_0)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_0-(y_7*z_8-z_7*y_8)*z_0)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_0-(z_7*x_8-x_7*z_8)*x_0)==0) 
    ...
    s.add(((z_3*x_8-x_3*z_8)*z_5-(x_3*y_8-y_3*x_8)*y_5)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_5-(y_3*z_8-z_3*y_8)*z_5)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_5-(z_3*x_8-x_3*z_8)*x_5)==0) 
