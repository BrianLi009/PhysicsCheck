...
def test_embed(): 
    ...
    s.add(((z_4*x_13-x_4*z_13)*z_9-(x_4*y_13-y_4*x_13)*y_9)==0) 
    s.add(((x_4*y_13-y_4*x_13)*x_9-(y_4*z_13-z_4*y_13)*z_9)==0) 
    s.add(((y_4*z_13-z_4*y_13)*y_9-(z_4*x_13-x_4*z_13)*x_9)==0) 
