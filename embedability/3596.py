...
def test_embed(): 
    ...
    s.add(((z_4*x_12-x_4*z_12)*z_3-(x_4*y_12-y_4*x_12)*y_3)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_3-(y_4*z_12-z_4*y_12)*z_3)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_3-(z_4*x_12-x_4*z_12)*x_3)==0) 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_8-(x_5*y_10-y_5*x_10)*y_8)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_8-(y_5*z_10-z_5*y_10)*z_8)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_8-(z_5*x_10-x_5*z_10)*x_8)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
