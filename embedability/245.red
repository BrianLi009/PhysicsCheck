...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(k(k(k(v3,v2),v3),v0),v2); 
neq1 := k(k(k(k(v3,v2),v3),v0),k(k(v2,k(v0,v1)),v2)); 
neq2 := k(k(k(k(v3,v2),v3),v0),k(v2,k(v0,v1))); 
neq3 := k(k(k(k(v3,v2),v3),v0),k(v3,v2)); 
neq4 := k(k(k(k(v3,v2),v3),v0),k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq5 := k(k(k(k(v3,v2),v3),v0),k(v0,v1)); 
neq6 := k(k(k(k(v3,v2),v3),v0),v3); 
neq7 := k(k(k(k(v3,v2),v3),v0),k(v3,v1)); 
neq8 := k(k(k(k(v3,v2),v3),v0),v1); 
neq9 := k(v2,k(k(v3,v2),v3)); 
neq10 := k(v2,k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1))); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq13 := k(v2,k(v0,v1)); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(v3,v1)); 
neq16 := k(v2,v1); 
neq17 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,v2),v3)); 
neq18 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1))); 
neq19 := k(k(k(v2,k(v0,v1)),v2),v0); 
neq20 := k(k(k(v2,k(v0,v1)),v2),k(v3,v2)); 
neq21 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq22 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq23 := k(k(k(v2,k(v0,v1)),v2),k(v3,v1)); 
neq24 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq25 := k(k(v2,k(v0,v1)),k(k(v3,v2),v3)); 
neq26 := k(k(v2,k(v0,v1)),k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1))); 
neq27 := k(k(v2,k(v0,v1)),v0); 
neq28 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq29 := k(k(v2,k(v0,v1)),k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq30 := k(k(v2,k(v0,v1)),v3); 
neq31 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq32 := k(k(v2,k(v0,v1)),v1); 
neq33 := k(k(k(v3,v2),v3),k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1))); 
neq34 := k(k(k(v3,v2),v3),v0); 
neq35 := k(k(k(v3,v2),v3),k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq36 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq37 := k(k(k(v3,v2),v3),k(v3,v1)); 
neq38 := k(k(k(v3,v2),v3),v1); 
neq39 := k(k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1)),v0); 
neq40 := k(k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1)),k(v3,v2)); 
neq41 := k(k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1)),k(v0,v1)); 
neq42 := k(k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1)),v3); 
neq43 := k(k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1)),v1); 
neq44 := k(v0,k(v3,v2)); 
neq45 := k(v0,k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq46 := k(v0,v3); 
neq47 := k(v0,k(v3,v1)); 
neq48 := k(k(v3,v2),k(k(v3,v1),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(k(v3,v2),k(v0,v1)); 
neq50 := k(k(v3,v2),k(v3,v1)); 
neq51 := k(k(v3,v2),v1); 
neq52 := k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq53 := k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),v3); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,v2),v3),v0),k(k(k(v3,v1),k(k(v2,k(v0,v1)),v2)),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
