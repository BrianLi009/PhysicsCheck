...
neq2 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),v0); 
neq3 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(k(v2,v0),v2)); 
neq4 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(k(v2,v1),v1)); 
neq5 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq6 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq7 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(k(k(v2,v0),v2),v1)); 
neq8 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),v1); 
neq9 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1)),k(v2,v0)); 
neq10 := k(k(v0,v1),v2); 
neq11 := k(k(v0,v1),k(v2,v1)); 
neq12 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1))); 
neq13 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq14 := k(k(v0,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq15 := k(k(v0,v1),k(k(v2,v1),v1)); 
neq16 := k(k(v0,v1),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq17 := k(k(v0,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq18 := k(k(v0,v1),k(k(k(v2,v0),v2),v1)); 
neq19 := k(k(v0,v1),k(v2,v0)); 
neq20 := k(v2,v0); 
neq21 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1))); 
neq22 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq23 := k(v2,k(k(v2,v1),v1)); 
neq24 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq25 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq26 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq27 := k(v2,v1); 
neq28 := k(k(v2,v1),v0); 
neq29 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1))); 
neq30 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq31 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq32 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq33 := k(k(v2,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq34 := k(k(v2,v1),k(k(k(v2,v0),v2),v1)); 
neq35 := k(k(v2,v1),k(v2,v0)); 
neq36 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1))); 
neq37 := k(v0,k(k(v2,v0),v2)); 
neq38 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq39 := k(v0,k(k(v2,v1),v1)); 
neq40 := k(v0,k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq41 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq42 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq43 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(k(v2,v0),v2)); 
neq44 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq45 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(k(v2,v1),v1)); 
neq46 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq47 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),v1); 
neq48 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(v2,v0)); 
neq49 := k(k(k(v2,v0),v2),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq50 := k(k(k(v2,v0),v2),k(k(v2,v1),v1)); 
neq51 := k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq52 := k(k(k(v2,v0),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq53 := k(k(k(v2,v0),v2),v1); 
neq54 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(v2,v1),v1)); 
neq55 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq56 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq57 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1); 
neq58 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq59 := k(k(k(v2,v1),v1),k(k(k(v2,v0),v2),v1)); 
neq60 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq61 := k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),v1); 
neq62 := k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(v2,v0)); 
neq63 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v0),v2),v1)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
