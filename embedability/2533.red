...
neq6 := k(k(v0,v1),k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq7 := k(k(v0,v1),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq8 := k(k(v0,v1),v3); 
neq9 := k(k(v0,v1),k(v3,k(k(v2,v1),v1))); 
neq10 := k(v2,k(v3,k(v2,k(v0,v1)))); 
neq11 := k(v2,k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq12 := k(v2,k(k(v2,v1),v1)); 
neq13 := k(v2,v0); 
neq14 := k(v2,k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq15 := k(v2,k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq16 := k(v2,v3); 
neq17 := k(v2,k(v3,k(k(v2,v1),v1))); 
neq18 := k(v2,v1); 
...
neq24 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq25 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq26 := k(k(k(v2,k(v0,v1)),v2),k(v3,k(k(v2,v1),v1))); 
neq27 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq28 := k(k(v3,k(v2,k(v0,v1))),k(k(v2,v1),v1)); 
neq29 := k(k(v3,k(v2,k(v0,v1))),v0); 
neq30 := k(k(v3,k(v2,k(v0,v1))),k(v2,v1)); 
neq31 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq32 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq33 := k(k(v3,k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))); 
neq34 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq35 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v2,v1),v1)); 
neq36 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0); 
neq37 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v2,v1)); 
neq38 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq39 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v3); 
neq40 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v3,k(k(v2,v1),v1))); 
neq41 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1); 
neq42 := k(k(k(v2,v1),v1),v0); 
neq43 := k(k(k(v2,v1),v1),k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq44 := k(k(k(v2,v1),v1),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq45 := k(k(k(v2,v1),v1),v3); 
neq46 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq47 := k(v0,k(v2,v1)); 
neq48 := k(v0,k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(v0,k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq50 := k(v0,k(v3,k(k(v2,v1),v1))); 
neq51 := k(v0,k(v2,k(v0,v1))); 
neq52 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2))); 
neq53 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))); 
neq54 := k(k(v2,v1),v3); 
neq55 := k(k(v2,v1),k(v3,k(k(v2,v1),v1))); 
neq56 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq57 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)),v3); 
neq58 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)),v1); 
neq59 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq60 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))),v3); 
neq61 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))),v1); 
neq62 := k(k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))),k(v2,k(v0,v1))); 
neq63 := k(v3,v1); 
neq64 := k(v3,k(v2,k(v0,v1))); 
neq65 := k(k(v3,k(k(v2,v1),v1)),v1); 
neq66 := k(k(v3,k(k(v2,v1),v1)),k(v2,k(v0,v1))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(v3,k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)),k(k(v3,k(k(v2,v1),v1)),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
