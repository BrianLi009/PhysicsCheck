...
def test_embed(): 
    ...
    s.add(((z_0*x_8-x_0*z_8)*z_3-(x_0*y_8-y_0*x_8)*y_3)==0) 
    s.add(((x_0*y_8-y_0*x_8)*x_3-(y_0*z_8-z_0*y_8)*z_3)==0) 
    s.add(((y_0*z_8-z_0*y_8)*y_3-(z_0*x_8-x_0*z_8)*x_3)==0) 
    ...
    s.add(((z_5*x_8-x_5*z_8)*z_7-(x_5*y_8-y_5*x_8)*y_7)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_7-(y_5*z_8-z_5*y_8)*z_7)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_7-(z_5*x_8-x_5*z_8)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_1 == 0) 
