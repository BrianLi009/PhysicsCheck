...
def test_embed(): 
    ...
    s.add(((z_1*x_10-x_1*z_10)*z_13-(x_1*y_10-y_1*x_10)*y_13)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_13-(y_1*z_10-z_1*y_10)*z_13)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_13-(z_1*x_10-x_1*z_10)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_1 == 0) 
