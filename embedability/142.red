...
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2))); 
neq4 := k(v2,k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1)); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(v3,k(v2,v0)),v3)); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(v3,k(k(v2,v0),v0))); 
neq9 := k(k(v3,k(v2,v0)),k(k(v2,v0),v0)); 
neq10 := k(k(v3,k(v2,v0)),v0); 
neq11 := k(k(v3,k(v2,v0)),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2))); 
neq12 := k(k(v3,k(v2,v0)),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1)); 
neq13 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq14 := k(k(v3,k(v2,v0)),k(k(v2,v1),v2)); 
neq15 := k(k(v3,k(v2,v0)),v1); 
neq16 := k(k(v3,k(v2,v0)),k(v3,k(k(v2,v0),v0))); 
neq17 := k(k(k(v2,v0),v0),k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2))); 
neq18 := k(k(k(v2,v0),v0),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1)); 
neq19 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq20 := k(k(k(v2,v0),v0),v3); 
neq21 := k(k(k(v2,v0),v0),k(k(v2,v1),v2)); 
neq22 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),v3)); 
neq23 := k(k(k(v2,v0),v0),v1); 
neq24 := k(v0,k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2))); 
neq25 := k(v0,k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1)); 
neq26 := k(v0,k(v2,v1)); 
neq27 := k(v0,v3); 
neq28 := k(v0,k(k(v2,v1),v2)); 
neq29 := k(v0,k(k(v3,k(v2,v0)),v3)); 
neq30 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq31 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),k(v2,v1)); 
neq32 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v3); 
neq33 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),k(k(v3,k(v2,v0)),v3)); 
neq34 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1); 
neq35 := k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),k(v2,v0)); 
neq36 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1),k(v2,v1)); 
neq37 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1),v3); 
neq38 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1),k(k(v2,v1),v2)); 
neq39 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v0),v0))); 
neq40 := k(k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1),k(v2,v0)); 
neq41 := k(k(v2,v1),v3); 
...
neq46 := k(v3,v1); 
neq47 := k(v3,k(v2,v0)); 
neq48 := k(k(k(v2,v1),v2),k(k(v3,k(v2,v0)),v3)); 
neq49 := k(k(k(v2,v1),v2),v1); 
neq50 := k(k(k(v2,v1),v2),k(v3,k(k(v2,v0),v0))); 
neq51 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq52 := k(k(k(v3,k(v2,v0)),v3),v1); 
neq53 := k(k(k(v3,k(v2,v0)),v3),k(v3,k(k(v2,v0),v0))); 
neq54 := k(k(k(v3,k(v2,v0)),v3),k(v2,v0)); 
neq55 := k(v1,k(v3,k(k(v2,v0),v0))); 
neq56 := k(v1,k(v2,v0)); 
neq57 := k(k(v3,k(k(v2,v0),v0)),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(v3,k(v2,v0)),v3),k(k(k(v3,k(k(v2,v0),v0)),k(k(v2,v1),v2)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
