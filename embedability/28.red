...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),v2); 
neq1 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(v2,v1)); 
neq2 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),v0); 
neq3 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(k(k(v2,v1),v2),v0)); 
neq4 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0))); 
neq5 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(k(v2,v1),v2)); 
neq6 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(k(k(k(v2,v1),v2),v0),v0)); 
neq7 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq8 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),v2); 
neq9 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(v2,v1)); 
neq10 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),v0); 
neq11 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq12 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq13 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),v1); 
neq14 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v2),v0),v0)); 
neq15 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq16 := k(v2,v0); 
neq17 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq18 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq19 := k(v2,k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0))); 
neq20 := k(v2,v1); 
neq21 := k(v2,k(k(k(k(v2,v1),v2),v0),v0)); 
neq22 := k(k(v2,v1),v0); 
neq23 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq24 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq25 := k(k(v2,v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0))); 
neq26 := k(k(v2,v1),k(k(k(k(v2,v1),v2),v0),v0)); 
neq27 := k(k(v2,v1),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq28 := k(v0,k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq29 := k(v0,k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0))); 
...
neq35 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq36 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0))); 
neq37 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)); 
neq38 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(k(k(v2,v1),v2),v0),v0)); 
neq39 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)); 
neq40 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),v1); 
neq41 := k(k(k(v2,v1),v2),v1); 
neq42 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v2),v0),v0)); 
neq43 := k(k(k(v2,v1),v2),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq44 := k(v1,k(k(k(k(v2,v1),v2),v0),v0)); 
neq45 := k(v1,k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),k(k(k(k(v2,v1),v2),v0),v0)),k(k(v2,v1),v2)),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
