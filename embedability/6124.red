...
v3 := {v3c1, v3c2, v3c3}; 
v3c3 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1)); 
neq1 := k(v2,k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0)); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
...
neq8 := k(v2,v1); 
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(k(v3,k(v0,v1)),v2)); 
neq11 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(v3,v2)); 
neq12 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),v0); 
neq13 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),v3); 
neq14 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq15 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1)))); 
neq16 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2))); 
neq17 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(v3,k(v0,v1))); 
neq18 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),v1); 
neq19 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2),k(v0,v1)); 
neq20 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1)); 
neq21 := k(k(k(v3,k(v0,v1)),v2),k(v3,v2)); 
neq22 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0)); 
neq23 := k(k(k(v3,k(v0,v1)),v2),v0); 
neq24 := k(k(k(v3,k(v0,v1)),v2),v3); 
neq25 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1)))); 
neq26 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2))); 
neq27 := k(k(k(v3,k(v0,v1)),v2),v1); 
neq28 := k(k(k(v3,k(v0,v1)),v2),k(v0,v1)); 
neq29 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(v3,v2)); 
neq30 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0)); 
neq31 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),v0); 
neq32 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),v3); 
neq33 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq34 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2))); 
neq35 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(v3,k(v0,v1))); 
neq36 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(v0,v1)); 
neq37 := k(k(v3,v2),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0)); 
neq38 := k(k(v3,v2),v0); 
neq39 := k(k(v3,v2),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq40 := k(k(v3,v2),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1)))); 
neq41 := k(k(v3,v2),k(v3,k(v0,v1))); 
neq42 := k(k(v3,v2),v1); 
neq43 := k(k(v3,v2),k(v0,v1)); 
neq44 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v3); 
neq45 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq46 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1)))); 
neq47 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),k(v3,k(v0,v1))); 
neq48 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v1); 
neq49 := k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),k(v0,v1)); 
neq50 := k(v0,v3); 
...
neq55 := k(v3,k(k(k(v3,k(v0,v1)),v2),v1)); 
neq56 := k(v3,k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1)))); 
neq57 := k(v3,k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2))); 
neq58 := k(v3,v1); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),k(v3,k(v0,v1))),v1),k(k(k(k(k(k(v3,k(v0,v1)),v2),v1),k(v3,v2)),v0),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
