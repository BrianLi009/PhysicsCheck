...
def test_embed(): 
    ...
    s.add(((z_0*x_6-x_0*z_6)*z_7-(x_0*y_6-y_0*x_6)*y_7)==0) 
    s.add(((x_0*y_6-y_0*x_6)*x_7-(y_0*z_6-z_0*y_6)*z_7)==0) 
    s.add(((y_0*z_6-z_0*y_6)*y_7-(z_0*x_6-x_0*z_6)*x_7)==0) 
    s.add(((z_0*x_5-x_0*z_5)*z_8-(x_0*y_5-y_0*x_5)*y_8)==0) 
    s.add(((x_0*y_5-y_0*x_5)*x_8-(y_0*z_5-z_0*y_5)*z_8)==0) 
    s.add(((y_0*z_5-z_0*y_5)*y_8-(z_0*x_5-x_0*z_5)*x_8)==0) 
    s.add(((z_4*x_5-x_4*z_5)*z_9-(x_4*y_5-y_4*x_5)*y_9)==0) 
    s.add(((x_4*y_5-y_4*x_5)*x_9-(y_4*z_5-z_4*y_5)*z_9)==0) 
    s.add(((y_4*z_5-z_4*y_5)*y_9-(z_4*x_5-x_4*z_5)*x_9)==0) 
    ...
    s.add(((z_1*x_5-x_1*z_5)*z_11-(x_1*y_5-y_1*x_5)*y_11)==0) 
    s.add(((x_1*y_5-y_1*x_5)*x_11-(y_1*z_5-z_1*y_5)*z_11)==0) 
    s.add(((y_1*z_5-z_1*y_5)*y_11-(z_1*x_5-x_1*z_5)*x_11)==0) 
    s.add(((z_2*x_6-x_2*z_6)*z_12-(x_2*y_6-y_2*x_6)*y_12)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_12-(y_2*z_6-z_2*y_6)*z_12)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_12-(z_2*x_6-x_2*z_6)*x_12)==0) 
    s.add(((z_0*x_1-x_0*z_1)*z_13-(x_0*y_1-y_0*x_1)*y_13)==0) 
    s.add(((x_0*y_1-y_0*x_1)*x_13-(y_0*z_1-z_0*y_1)*z_13)==0) 
    s.add(((y_0*z_1-z_0*y_1)*y_13-(z_0*x_1-x_0*z_1)*x_13)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_3 == 0) 
