...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(v2,k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2))); 
neq1 := k(v2,v0); 
neq2 := k(v2,k(v3,v0)); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq5 := k(v2,k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq6 := k(v2,k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,k(k(k(v3,v1),v3),v0)); 
neq9 := k(v2,k(k(v3,v1),v3)); 
neq10 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(v3,v1),v3),v0),v2)); 
neq11 := k(k(k(k(v3,v1),v3),v2),v0); 
neq12 := k(k(k(k(v3,v1),v3),v2),k(v3,v0)); 
neq13 := k(k(k(k(v3,v1),v3),v2),v1); 
neq14 := k(k(k(k(v3,v1),v3),v2),v3); 
neq15 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq16 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq17 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq18 := k(k(k(k(v3,v1),v3),v2),k(v3,v1)); 
neq19 := k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v3),v0)); 
neq20 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(k(k(k(v3,v1),v3),v0),v2)); 
neq21 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),v0); 
neq22 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(v3,v0)); 
neq23 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),v1); 
neq24 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),v3); 
neq25 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq26 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(v3,v1)); 
neq27 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(k(k(v3,v1),v3),v0)); 
neq28 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2)),k(k(v3,v1),v3)); 
neq29 := k(k(k(k(k(v3,v1),v3),v0),v2),v0); 
neq30 := k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v0)); 
neq31 := k(k(k(k(k(v3,v1),v3),v0),v2),v1); 
neq32 := k(k(k(k(k(v3,v1),v3),v0),v2),v3); 
neq33 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq34 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq35 := k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)); 
neq36 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(v3,v1),v3)); 
neq37 := k(v0,v3); 
neq38 := k(v0,k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq39 := k(v0,k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq40 := k(v0,k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq41 := k(v0,k(v3,v1)); 
neq42 := k(v0,k(k(v3,v1),v3)); 
neq43 := k(k(v3,v0),v1); 
neq44 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq45 := k(k(v3,v0),k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq46 := k(k(v3,v0),k(v3,v1)); 
neq47 := k(k(v3,v0),k(k(k(v3,v1),v3),v0)); 
neq48 := k(k(v3,v0),k(k(v3,v1),v3)); 
neq49 := k(v1,v3); 
neq50 := k(v1,k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq51 := k(v1,k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq52 := k(v1,k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq53 := k(v1,k(k(k(v3,v1),v3),v0)); 
neq54 := k(v1,k(k(v3,v1),v3)); 
neq55 := k(v3,k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0))); 
neq56 := k(v3,k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq57 := k(v3,k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0))); 
neq58 := k(v3,k(k(k(v3,v1),v3),v0)); 
neq59 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0)),k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1))); 
neq60 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0)),k(v3,v1)); 
neq61 := k(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0)),k(k(v3,v1),v3)); 
neq62 := k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(k(k(v3,v1),v3),v0)); 
neq63 := k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(k(v3,v1),v3)); 
neq64 := k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(v3,v1)); 
neq65 := k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0)); 
neq66 := k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(v3,v1),v3)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v0)),k(k(k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)),k(v3,v0)),k(k(k(v3,v1),v3),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
