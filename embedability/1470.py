...
def test_embed(): 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_4-(x_9*y_10-y_9*x_10)*y_4)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_4-(y_9*z_10-z_9*y_10)*z_4)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_4-(z_9*x_10-x_9*z_10)*x_4)==0) 
