...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_9-(x_1*y_11-y_1*x_11)*y_9)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_9-(y_1*z_11-z_1*y_11)*z_9)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_9-(z_1*x_11-x_1*z_11)*x_9)==0) 
