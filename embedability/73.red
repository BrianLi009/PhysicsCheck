...
neq28 := k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v0),v0),k(v2,v1))); 
neq29 := k(k(k(k(v2,v0),v2),v1),k(v0,v1)); 
neq30 := k(k(v2,v0),k(k(k(v2,v0),v0),k(v2,v1))); 
neq31 := k(k(v2,v0),k(k(k(v2,v0),v0),k(v2,k(v0,v1)))); 
neq32 := k(k(v2,v0),k(v0,v1)); 
neq33 := k(k(v2,v0),v1); 
neq34 := k(k(k(v2,v0),v0),v2); 
neq35 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq36 := k(k(k(v2,v0),v0),k(v0,v1)); 
neq37 := k(k(k(v2,v0),v0),v1); 
neq38 := k(v0,v2); 
neq39 := k(v0,k(k(v2,v0),v2)); 
neq40 := k(v0,k(k(k(v2,v0),v0),k(v2,v1))); 
neq41 := k(v0,k(k(k(v2,v0),v0),k(v2,k(v0,v1)))); 
neq42 := k(v2,k(k(k(v2,v0),v0),k(v2,v1))); 
neq43 := k(v2,k(k(k(v2,v0),v0),k(v2,k(v0,v1)))); 
neq44 := k(v2,k(v0,v1)); 
neq45 := k(v2,v1); 
neq46 := k(k(k(v2,v0),v2),k(k(k(v2,v0),v0),k(v2,v1))); 
neq47 := k(k(k(v2,v0),v2),k(k(k(v2,v0),v0),k(v2,k(v0,v1)))); 
neq48 := k(k(k(v2,v0),v2),k(v0,v1)); 
neq49 := k(k(k(v2,v0),v2),v1); 
neq50 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(v0,v1)); 
neq51 := k(k(k(k(v2,v0),v0),k(v2,v1)),v1); 
neq52 := k(k(k(k(v2,v0),v0),k(v2,k(v0,v1))),k(v0,v1)); 
...
phi := 
       ...
       d(k(k(k(v2,v0),v0),k(v2,k(v0,v1))),k(k(k(v2,v0),v2),v1)) = 0 and 
