...
def test_embed(): 
    ...
    s.add(((z_0*x_1-x_0*z_1)*z_9-(x_0*y_1-y_0*x_1)*y_9)==0) 
    s.add(((x_0*y_1-y_0*x_1)*x_9-(y_0*z_1-z_0*y_1)*z_9)==0) 
    s.add(((y_0*z_1-z_0*y_1)*y_9-(z_0*x_1-x_0*z_1)*x_9)==0) 
    ...
    s.add(((z_0*x_3-x_0*z_3)*z_13-(x_0*y_3-y_0*x_3)*y_13)==0) 
    s.add(((x_0*y_3-y_0*x_3)*x_13-(y_0*z_3-z_0*y_3)*z_13)==0) 
    s.add(((y_0*z_3-z_0*y_3)*y_13-(z_0*x_3-x_0*z_3)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_9 == 0) 
