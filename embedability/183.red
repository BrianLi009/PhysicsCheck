...
neq4 := k(k(v0,v1),v2); 
neq5 := k(k(v0,v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq6 := k(k(v0,v1),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))); 
neq7 := k(k(v0,v1),k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1))); 
...
neq18 := k(k(k(v2,v1),v1),k(k(k(k(v2,k(v0,v1)),v2),v1),v1)); 
neq19 := k(k(k(v2,v1),v1),v2); 
neq20 := k(k(k(v2,v1),v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq21 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))); 
neq22 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq23 := k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)); 
neq24 := k(k(v2,v1),v0); 
neq25 := k(k(v2,v1),k(k(k(k(v2,k(v0,v1)),v2),v1),v1)); 
neq26 := k(k(v2,v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq27 := k(k(v2,v1),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))); 
neq28 := k(k(v2,v1),k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1))); 
neq29 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq30 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq31 := k(v0,k(k(k(k(v2,k(v0,v1)),v2),v1),v1)); 
neq32 := k(v0,v2); 
neq33 := k(v0,k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))); 
neq34 := k(v0,k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1))); 
neq35 := k(v0,k(v2,k(v0,v1))); 
neq36 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq37 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),v2); 
neq38 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq39 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1))); 
...
neq45 := k(v2,v1); 
neq46 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))); 
neq47 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(v2,k(v0,v1))); 
neq48 := k(k(k(k(v2,k(v0,v1)),v2),v0),v1); 
neq49 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq50 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1))),v1); 
neq51 := k(k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1)),k(v2,k(v0,v1))); 
neq52 := k(k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)); 
neq53 := k(k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1)),v1); 
...
phi := 
       ...
       d(k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1)),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
