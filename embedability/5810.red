...
neq1 := k(v0,k(v3,v1)); 
neq2 := k(v0,v2); 
neq3 := k(v0,k(k(v2,v1),v2)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq6 := k(v0,k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq7 := k(v0,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq8 := k(v0,k(v3,v2)); 
neq9 := k(v0,k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq10 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),v1); 
neq11 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(v2,v1)); 
neq12 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(v3,v1)); 
neq13 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),v2); 
neq14 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(k(v2,v1),v2)); 
neq15 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),v3); 
neq16 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq17 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(k(v3,v2),v0)); 
neq18 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(v3,v2)); 
neq19 := k(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq20 := k(v1,v2); 
neq21 := k(v1,k(k(v2,v1),v2)); 
neq22 := k(v1,v3); 
neq23 := k(v1,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq24 := k(v1,k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq25 := k(v1,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq26 := k(v1,k(k(v3,v2),v0)); 
neq27 := k(v1,k(v3,v2)); 
neq28 := k(v1,k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq29 := k(k(v2,v1),k(v3,v1)); 
neq30 := k(k(v2,v1),v3); 
neq31 := k(k(v2,v1),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq32 := k(k(v2,v1),k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq33 := k(k(v2,v1),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq34 := k(k(v2,v1),k(k(v3,v2),v0)); 
neq35 := k(k(v2,v1),k(v3,v2)); 
neq36 := k(k(v2,v1),k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq37 := k(k(v3,v1),v2); 
neq38 := k(k(v3,v1),k(k(v2,v1),v2)); 
neq39 := k(k(v3,v1),k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq40 := k(k(v3,v1),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq41 := k(k(v3,v1),k(k(v3,v2),v0)); 
neq42 := k(k(v3,v1),k(v3,v2)); 
neq43 := k(k(v3,v1),k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq44 := k(v2,v3); 
neq45 := k(v2,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq46 := k(v2,k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq47 := k(v2,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq48 := k(v2,k(k(v3,v2),v0)); 
neq49 := k(v2,k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq50 := k(k(k(v2,v1),v2),v3); 
neq51 := k(k(k(v2,v1),v2),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq52 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq53 := k(k(k(v2,v1),v2),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq54 := k(k(k(v2,v1),v2),k(k(v3,v2),v0)); 
neq55 := k(k(k(v2,v1),v2),k(v3,v2)); 
neq56 := k(v3,k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1))); 
neq57 := k(v3,k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2))); 
neq58 := k(v3,k(k(v3,v2),v0)); 
neq59 := k(v3,k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq60 := k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq61 := k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(k(v3,v2),v0)); 
neq62 := k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)); 
neq63 := k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)); 
neq64 := k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),k(k(v3,v2),v0)); 
neq65 := k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
neq66 := k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3),k(k(v3,v2),v0)); 
neq67 := k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3),k(v3,v2)); 
neq68 := k(k(v3,v2),k(k(k(v3,v2),v0),k(k(v2,v1),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),k(v3,v1)),k(v3,v2)),v0),k(k(k(k(v3,v2),v0),k(k(v2,v1),v2)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
