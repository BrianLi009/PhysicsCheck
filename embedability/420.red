...
v3 := {v3c1, v3c2, v3c3}; 
v3c3 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0)); 
neq1 := k(v2,k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3)); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq5 := k(v2,v1); 
neq6 := k(v2,k(v0,v1)); 
neq7 := k(v2,k(k(k(v3,v2),v2),v1)); 
neq8 := k(v2,k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq9 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0)); 
neq10 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3)); 
neq11 := k(k(v3,v2),v0); 
neq12 := k(k(v3,v2),k(v2,k(v0,v1))); 
neq13 := k(k(v3,v2),k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq14 := k(k(v3,v2),v1); 
neq15 := k(k(v3,v2),k(v0,v1)); 
neq16 := k(k(v3,v2),k(k(k(v3,v2),v2),v1)); 
neq17 := k(k(v3,v2),k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq18 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),v3); 
neq19 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),k(v2,k(v0,v1))); 
neq20 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),k(k(v3,v2),v2)); 
neq21 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq22 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),v1); 
neq23 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),k(v0,v1)); 
neq24 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0),k(k(k(v3,v2),v2),v1)); 
neq25 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),v0); 
neq26 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(v2,k(v0,v1))); 
neq27 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(k(v3,v2),v2)); 
neq28 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq29 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),v1); 
neq30 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(v0,v1)); 
neq31 := k(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(k(k(v3,v2),v2),v1)); 
neq32 := k(v0,v3); 
neq33 := k(v0,k(v2,k(v0,v1))); 
neq34 := k(v0,k(k(v3,v2),v2)); 
neq35 := k(v0,k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq36 := k(v0,k(k(k(v3,v2),v2),v1)); 
neq37 := k(v0,k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq38 := k(v3,k(v2,k(v0,v1))); 
neq39 := k(v3,k(k(v3,v2),v2)); 
neq40 := k(v3,k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq41 := k(v3,v1); 
neq42 := k(v3,k(k(k(v3,v2),v2),v1)); 
neq43 := k(v3,k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq44 := k(k(v2,k(v0,v1)),k(k(v3,v2),v2)); 
neq45 := k(k(v2,k(v0,v1)),v1); 
neq46 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v2),v1)); 
neq47 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq48 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1)))); 
neq49 := k(k(k(v3,v2),v2),v1); 
neq50 := k(k(k(v3,v2),v2),k(v0,v1)); 
neq51 := k(k(k(v3,v2),v2),k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1))); 
neq52 := k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),v1); 
neq53 := k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(v0,v1)); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v3),k(k(k(k(k(k(v3,v2),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,v2),v2),v1)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
