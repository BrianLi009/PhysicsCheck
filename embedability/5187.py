...
def test_embed(): 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_10-(x_8*y_13-y_8*x_13)*y_10)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_10-(y_8*z_13-z_8*y_13)*z_10)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_10-(z_8*x_13-x_8*z_13)*x_10)==0) 
