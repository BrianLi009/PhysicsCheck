...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3)); 
neq1 := k(v2,v0); 
neq2 := k(v2,v3); 
neq3 := k(v2,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0)); 
neq4 := k(v2,k(k(v3,v0),v3)); 
neq5 := k(v2,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq6 := k(v2,k(v3,v0)); 
neq7 := k(v2,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq8 := k(v2,k(k(k(v3,v0),v3),v1)); 
neq9 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),v0); 
neq10 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),v1); 
neq11 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(k(v3,v0),v3)); 
neq12 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq13 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(k(v3,v0),v2)); 
neq14 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(v3,v0)); 
neq15 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq16 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3),k(k(k(v3,v0),v3),v1)); 
neq17 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),v0); 
neq18 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),v1); 
neq19 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),v3); 
neq20 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0)); 
neq21 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(v3,v0),v3)); 
neq22 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(v3,v0),v2)); 
neq23 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(v3,v0)); 
neq24 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq25 := k(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(k(v3,v0),v3),v1)); 
neq26 := k(v0,v3); 
neq27 := k(v0,k(k(v3,v0),v3)); 
neq28 := k(v0,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq29 := k(v0,k(k(v3,v0),v2)); 
neq30 := k(v0,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq31 := k(v0,k(k(k(v3,v0),v3),v1)); 
neq32 := k(v1,v3); 
neq33 := k(v1,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0)); 
neq34 := k(v1,k(k(v3,v0),v3)); 
neq35 := k(v1,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq36 := k(v1,k(k(v3,v0),v2)); 
neq37 := k(v1,k(v3,v0)); 
neq38 := k(v1,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq39 := k(v3,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0)); 
neq40 := k(v3,k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq41 := k(v3,k(k(v3,v0),v2)); 
neq42 := k(v3,k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq43 := k(v3,k(k(k(v3,v0),v3),v1)); 
neq44 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),k(k(v3,v0),v3)); 
neq45 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq46 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),k(k(v3,v0),v2)); 
neq47 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),k(v3,v0)); 
neq48 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),k(k(k(v3,v0),v3),v1)); 
neq49 := k(k(k(v3,v0),v3),k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1))); 
neq50 := k(k(k(v3,v0),v3),k(k(v3,v0),v2)); 
neq51 := k(k(k(v3,v0),v3),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
neq52 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),k(k(v3,v0),v2)); 
neq53 := k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),k(v3,v0)); 
neq54 := k(k(k(v3,v0),v2),k(k(k(v3,v0),v3),v1)); 
neq55 := k(k(v3,v0),k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2))); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),k(k(k(v3,v0),v3),v1)),v2),k(k(k(k(k(k(v3,v0),v3),v1),k(k(v3,v0),v2)),v0),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
