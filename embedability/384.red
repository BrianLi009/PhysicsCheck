...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(v2,v0),v2)); 
neq2 := k(v0,k(k(v3,v2),v1)); 
neq3 := k(v0,k(v3,v1)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq6 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq7 := k(v0,k(v3,v2)); 
neq8 := k(v0,k(k(v3,v1),k(k(v2,v0),v2))); 
neq9 := k(k(k(v2,v0),v0),v2); 
neq10 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq11 := k(k(k(v2,v0),v0),k(k(v3,v2),v1)); 
neq12 := k(k(k(v2,v0),v0),k(v3,v1)); 
neq13 := k(k(k(v2,v0),v0),v3); 
neq14 := k(k(k(v2,v0),v0),k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq15 := k(k(k(v2,v0),v0),v1); 
neq16 := k(k(k(v2,v0),v0),k(v3,v2)); 
neq17 := k(k(k(v2,v0),v0),k(k(v3,v1),k(k(v2,v0),v2))); 
neq18 := k(v2,k(k(v3,v2),v1)); 
neq19 := k(v2,k(v3,v1)); 
neq20 := k(v2,v3); 
neq21 := k(v2,k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq22 := k(v2,v1); 
neq23 := k(v2,k(v3,k(k(v2,v0),v0))); 
neq24 := k(v2,k(k(v3,v1),k(k(v2,v0),v2))); 
neq25 := k(k(k(v2,v0),v2),k(k(v3,v2),v1)); 
neq26 := k(k(k(v2,v0),v2),k(v3,v1)); 
neq27 := k(k(k(v2,v0),v2),v3); 
neq28 := k(k(k(v2,v0),v2),k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq29 := k(k(k(v2,v0),v2),v1); 
neq30 := k(k(k(v2,v0),v2),k(v3,k(k(v2,v0),v0))); 
neq31 := k(k(k(v2,v0),v2),k(v3,v2)); 
neq32 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq33 := k(k(k(v3,v2),v1),v3); 
neq34 := k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0))); 
neq35 := k(k(k(v3,v2),v1),k(k(v3,v1),k(k(v2,v0),v2))); 
neq36 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq37 := k(k(v3,v1),k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq38 := k(k(v3,v1),k(v3,k(k(v2,v0),v0))); 
neq39 := k(k(v3,v1),k(v3,v2)); 
neq40 := k(k(v3,v1),k(v2,v0)); 
neq41 := k(v3,k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))); 
neq42 := k(v3,v1); 
neq43 := k(v3,k(k(v3,v1),k(k(v2,v0),v2))); 
neq44 := k(v3,k(v2,v0)); 
neq45 := k(k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0))),v1); 
neq46 := k(k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0))),k(v3,v2)); 
neq47 := k(k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0))),k(v2,v0)); 
neq48 := k(v1,k(v3,k(k(v2,v0),v0))); 
neq49 := k(v1,k(v3,v2)); 
neq50 := k(v1,k(k(v3,v1),k(k(v2,v0),v2))); 
neq51 := k(v1,k(v2,v0)); 
neq52 := k(k(v3,k(k(v2,v0),v0)),k(v3,v2)); 
neq53 := k(k(v3,k(k(v2,v0),v0)),k(k(v3,v1),k(k(v2,v0),v2))); 
neq54 := k(k(v3,k(k(v2,v0),v0)),k(v2,v0)); 
neq55 := k(k(v3,v2),k(k(v3,v1),k(k(v2,v0),v2))); 
neq56 := k(k(v3,v2),k(v2,v0)); 
neq57 := k(k(k(v3,v1),k(k(v2,v0),v2)),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(v3,v1),k(k(v2,v0),v2)),k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
