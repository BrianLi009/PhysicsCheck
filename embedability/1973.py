...
def test_embed(): 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_1-(x_7*y_13-y_7*x_13)*y_1)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_1-(y_7*z_13-z_7*y_13)*z_1)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_1-(z_7*x_13-x_7*z_13)*x_1)==0) 
    ...
    s.add(((z_5*x_8-x_5*z_8)*z_4-(x_5*y_8-y_5*x_8)*y_4)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_4-(y_5*z_8-z_5*y_8)*z_4)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_4-(z_5*x_8-x_5*z_8)*x_4)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_7 == 0) 
