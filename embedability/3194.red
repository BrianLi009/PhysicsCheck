...
neq2 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2))); 
neq3 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
...
neq10 := k(k(v2,v1),k(k(k(k(v2,k(v0,v1)),v2),v1),v1)); 
neq11 := k(k(v2,v1),k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2))); 
neq12 := k(k(v2,v1),v0); 
neq13 := k(k(v2,v1),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq14 := k(k(v2,v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq15 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq16 := k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq17 := k(k(v2,v1),k(v0,v1)); 
neq18 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq19 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),v2); 
neq20 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2))); 
neq21 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq22 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),v0); 
neq23 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq24 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v2,k(v0,v1))); 
neq25 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq26 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(v0,v1)); 
neq27 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),v2)); 
neq28 := k(v2,k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2))); 
neq29 := k(v2,k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq30 := k(v2,v0); 
neq31 := k(v2,k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq32 := k(v2,k(k(k(v2,k(v0,v1)),v2),v0)); 
neq33 := k(v2,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq34 := k(v2,k(v0,v1)); 
neq35 := k(v2,v1); 
neq36 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),v0); 
neq37 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq38 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq39 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq40 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq41 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),v1); 
neq42 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),v0); 
neq43 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq44 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq45 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq46 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq47 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq48 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq49 := k(v0,k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
...
phi := 
       ...
       d(k(k(k(v2,k(v0,v1)),v2),v0),k(k(k(k(k(v2,k(v0,v1)),v2),v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))) = 0 and 
       d(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)),k(k(k(v2,k(v0,v1)),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
