...
def test_embed(): 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_11-(x_6*y_10-y_6*x_10)*y_11)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_11-(y_6*z_10-z_6*y_10)*z_11)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_11-(z_6*x_10-x_6*z_10)*x_11)==0) 
