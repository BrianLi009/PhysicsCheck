...
neq1 := k(k(v3,v2),k(v3,v0)); 
neq2 := k(k(v3,v2),k(v0,v1)); 
neq3 := k(k(v3,v2),v0); 
neq4 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq5 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
...
neq13 := k(v2,k(v0,v1)); 
neq14 := k(v2,v0); 
neq15 := k(v2,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq16 := k(v2,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
neq17 := k(v2,k(k(v3,v2),v1)); 
neq18 := k(v2,v1); 
neq19 := k(v2,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq20 := k(v3,k(v0,v1)); 
neq21 := k(v3,v0); 
neq22 := k(v3,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq23 := k(v3,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
neq24 := k(v3,k(k(v2,v1),v2)); 
neq25 := k(v3,k(v2,v1)); 
neq26 := k(v3,k(k(v3,v2),v1)); 
neq27 := k(v3,v1); 
neq28 := k(v3,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq29 := k(k(v3,k(v0,v1)),k(v3,v0)); 
neq30 := k(k(v3,k(v0,v1)),v0); 
neq31 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq32 := k(k(v3,k(v0,v1)),k(k(v2,v1),v2)); 
neq33 := k(k(v3,k(v0,v1)),k(v2,v1)); 
neq34 := k(k(v3,k(v0,v1)),k(k(v3,v2),v1)); 
neq35 := k(k(v3,k(v0,v1)),v1); 
neq36 := k(k(v3,k(v0,v1)),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq37 := k(k(v3,v0),k(v0,v1)); 
neq38 := k(k(v3,v0),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
neq39 := k(k(v3,v0),k(k(v2,v1),v2)); 
neq40 := k(k(v3,v0),k(v2,v1)); 
neq41 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq42 := k(k(v3,v0),v1); 
neq43 := k(k(v3,v0),k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq44 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq45 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
...
neq50 := k(v0,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))); 
neq51 := k(v0,k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1)))); 
neq52 := k(v0,k(k(v2,v1),v2)); 
neq53 := k(v0,k(v2,v1)); 
neq54 := k(v0,k(k(v3,v2),v1)); 
neq55 := k(v0,k(k(k(v3,v2),v1),k(k(v2,v1),v2))); 
neq56 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0)),k(k(v2,v1),v2)); 
neq57 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0)),k(v2,v1)); 
neq58 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0)),k(k(v3,v2),v1)); 
neq59 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0)),v1); 
neq60 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1))),k(k(v2,v1),v2)); 
neq61 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1))),k(v2,v1)); 
neq62 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1))),k(k(v3,v2),v1)); 
neq63 := k(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1))),v1); 
...
phi := 
       ...
       d(k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,k(v0,v1))),k(k(k(k(v3,v2),v1),k(k(v2,v1),v2)),k(v3,v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
