...
neq2 := k(v2,k(k(k(k(v3,v0),v3),v2),v1)); 
neq3 := k(v2,k(v3,v0)); 
...
neq10 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(k(v3,v0),v3),v2)); 
neq11 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(k(k(v3,v0),v3),v2),v1)); 
neq12 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),v0); 
neq13 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(v3,v0)); 
neq14 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(k(v3,v0),v3),k(k(v3,v1),v1))); 
neq15 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(v3,v1)); 
neq16 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),v3); 
neq17 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(v3,v1),v1)); 
neq18 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),v1); 
neq19 := k(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(v3,v0),v3)); 
neq20 := k(k(k(k(v3,v0),v3),v2),k(k(k(k(k(v3,v0),v3),v2),v1),v3)); 
...
neq29 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(k(k(k(v3,v0),v3),k(k(v3,v1),v1)),k(k(v3,v1),v1))); 
neq30 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v0); 
neq31 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(v3,v0)); 
neq32 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(k(k(v3,v0),v3),k(k(v3,v1),v1))); 
neq33 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(v3,v1)); 
neq34 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(k(v3,v1),v1)); 
neq35 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v1); 
neq36 := k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),k(k(v3,v0),v3)); 
neq37 := k(k(k(k(k(v3,v0),v3),k(k(v3,v1),v1)),k(k(v3,v1),v1)),k(k(k(k(v3,v0),v3),v2),v1)); 
...
neq44 := k(k(k(k(k(v3,v0),v3),v2),v1),v0); 
neq45 := k(k(k(k(k(v3,v0),v3),v2),v1),k(v3,v0)); 
neq46 := k(k(k(k(k(v3,v0),v3),v2),v1),k(k(k(v3,v0),v3),k(k(v3,v1),v1))); 
neq47 := k(k(k(k(k(v3,v0),v3),v2),v1),k(v3,v1)); 
neq48 := k(k(k(k(k(v3,v0),v3),v2),v1),v3); 
neq49 := k(k(k(k(k(v3,v0),v3),v2),v1),k(k(v3,v1),v1)); 
neq50 := k(k(k(k(k(v3,v0),v3),v2),v1),k(k(v3,v0),v3)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(v3,v0),v3),v2),v1),v3),v2),k(k(k(k(v3,v0),v3),k(k(v3,v1),v1)),k(k(v3,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
