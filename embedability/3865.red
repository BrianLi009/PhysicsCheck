...
v3c1 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq2 := k(v2,k(v0,v1)); 
neq3 := k(v2,k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))))); 
neq4 := k(v2,v0); 
...
neq11 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq12 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(v0,v1)); 
...
neq20 := k(v3,k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq21 := k(v3,k(v0,v1)); 
neq22 := k(v3,k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))))); 
neq23 := k(v3,k(k(v2,v1),v2)); 
neq24 := k(v3,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq25 := k(v3,k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))); 
neq26 := k(v3,v1); 
neq27 := k(v3,k(v2,v1)); 
neq28 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),v0); 
neq29 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(v2,v1),v2)); 
neq30 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(v3,k(v2,v1))); 
neq31 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq32 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))); 
neq33 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),v1); 
neq34 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(v2,v1)); 
neq35 := k(k(v0,v1),k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))))); 
neq36 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq37 := k(k(v0,v1),k(v3,k(v2,v1))); 
neq38 := k(k(v0,v1),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq39 := k(k(v0,v1),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))); 
neq40 := k(k(v0,v1),k(v3,k(k(v2,v1),v2))); 
neq41 := k(k(v0,v1),k(v2,v1)); 
neq42 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),v0); 
neq43 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(k(v2,v1),v2)); 
neq44 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(v3,k(v2,v1))); 
neq45 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq46 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(v3,k(k(v2,v1),v2))); 
neq47 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),v1); 
neq48 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(v2,v1)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1))),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(v2,v1)))),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
