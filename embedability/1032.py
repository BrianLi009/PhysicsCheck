...
def test_embed(): 
    ...
    s.add(((z_6*x_8-x_6*z_8)*z_10-(x_6*y_8-y_6*x_8)*y_10)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_10-(y_6*z_8-z_6*y_8)*z_10)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_10-(z_6*x_8-x_6*z_8)*x_10)==0) 
    ...
    s.add(((z_5*x_6-x_5*z_6)*z_1-(x_5*y_6-y_5*x_6)*y_1)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_1-(y_5*z_6-z_5*y_6)*z_1)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_1-(z_5*x_6-x_5*z_6)*x_1)==0) 
