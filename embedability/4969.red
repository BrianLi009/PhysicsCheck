...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0)))); 
neq1 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2)); 
neq2 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),v2); 
neq3 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v2,v1)); 
neq4 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(v2,v0),v0)); 
neq5 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v2,v0)); 
neq6 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
...
neq10 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2)); 
neq11 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),v2); 
neq12 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(v2,v1)); 
neq13 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq14 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(v2,v0),v0)); 
neq15 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(v2,v0)); 
neq16 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq17 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(v2,v1),v1)); 
neq18 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),v0); 
neq19 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),v1); 
neq20 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),v2); 
neq21 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v2,v1)); 
neq22 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(k(v2,v1),v1),k(v2,v0))); 
neq23 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(v2,v0),v0)); 
neq24 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v2,v0)); 
neq25 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(k(v2,v1),v1)); 
neq26 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),k(v0,v1)); 
neq27 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),v0); 
neq28 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))),v1); 
neq29 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(v2,v1)); 
neq30 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq31 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(k(v2,v0),v0)); 
neq32 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(v2,v0)); 
neq33 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(k(v2,v1),v1)); 
neq34 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(v0,v1)); 
neq35 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),v0); 
neq36 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),v1); 
neq37 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq38 := k(v2,k(k(v2,v0),v0)); 
neq39 := k(v2,k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
...
neq47 := k(k(v2,v1),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq48 := k(k(v2,v1),k(v0,v1)); 
neq49 := k(k(v2,v1),v0); 
neq50 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v0),v0)); 
neq51 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq52 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)); 
neq53 := k(k(k(k(v2,v1),v1),k(v2,v0)),v0); 
neq54 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq55 := k(k(k(v2,v0),v0),k(k(v2,v1),v1)); 
neq56 := k(k(k(v2,v0),v0),k(v0,v1)); 
neq57 := k(k(k(v2,v0),v0),v1); 
neq58 := k(k(v2,v0),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq59 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq60 := k(k(v2,v0),k(v0,v1)); 
neq61 := k(k(v2,v0),v1); 
neq62 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(v0,v1)); 
neq63 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v0); 
neq64 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v1); 
...
phi := 
       ...
       d(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v2),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v0,v1)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
