...
neq1 := k(k(k(v2,v1),v1),k(v3,k(v2,v1))); 
neq2 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)); 
neq3 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq4 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq5 := k(k(k(v2,v1),v1),v0); 
neq6 := k(k(k(v2,v1),v1),v3); 
neq7 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2)); 
neq8 := k(k(k(v2,v1),v1),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq9 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq10 := k(v2,k(v3,k(v2,v1))); 
neq11 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq12 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq13 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq14 := k(v2,v0); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq17 := k(v2,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq18 := k(v2,v1); 
neq19 := k(k(v3,k(v2,v1)),k(k(k(v2,v1),v2),v0)); 
neq20 := k(k(v3,k(v2,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2))); 
neq21 := k(k(v3,k(v2,v1)),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq22 := k(k(v3,k(v2,v1)),v0); 
neq23 := k(k(v3,k(v2,v1)),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2)); 
neq24 := k(k(v3,k(v2,v1)),k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq25 := k(k(v3,k(v2,v1)),k(k(v2,v1),v2)); 
neq26 := k(k(v3,k(v2,v1)),v1); 
neq27 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1)); 
neq28 := k(k(k(k(v2,v1),v2),v0),v3); 
neq29 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2)); 
neq30 := k(k(k(k(v2,v1),v2),v0),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq31 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq32 := k(k(k(k(v2,v1),v2),v0),v1); 
neq33 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq34 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v0); 
neq35 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v3); 
neq36 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2)); 
neq37 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq38 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq39 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1); 
neq40 := k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),k(v2,v1)); 
neq41 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v0); 
neq42 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v3); 
neq43 := k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
...
neq48 := k(v0,k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq49 := k(v0,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq50 := k(v0,k(k(v2,v1),v2)); 
neq51 := k(v0,k(v2,v1)); 
neq52 := k(v3,k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2)); 
neq53 := k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))); 
neq54 := k(v3,k(k(v2,v1),v2)); 
neq55 := k(v3,v1); 
neq56 := k(v3,k(v2,v1)); 
neq57 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))); 
neq58 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v2)); 
neq59 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),v1); 
neq60 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(v2,v1)); 
neq61 := k(k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))),k(k(v2,v1),v2)); 
neq62 := k(k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))),v1); 
neq63 := k(k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1))),k(v2,v1)); 
neq64 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
neq65 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)),v1); 
neq66 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)),k(v2,v1)); 
neq67 := k(k(k(v2,v1),v2),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(v3,k(v2,v1)),k(v3,k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
