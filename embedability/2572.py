...
def test_embed(): 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_7-(x_6*y_13-y_6*x_13)*y_7)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_7-(y_6*z_13-z_6*y_13)*z_7)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_7-(z_6*x_13-x_6*z_13)*x_7)==0) 
    ...
    s.add(((z_6*x_7-x_6*z_7)*z_10-(x_6*y_7-y_6*x_7)*y_10)==0) 
    s.add(((x_6*y_7-y_6*x_7)*x_10-(y_6*z_7-z_6*y_7)*z_10)==0) 
    s.add(((y_6*z_7-z_6*y_7)*y_10-(z_6*x_7-x_6*z_7)*x_10)==0) 
    s.add(((z_8*x_9-x_8*z_9)*z_11-(x_8*y_9-y_8*x_9)*y_11)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_11-(y_8*z_9-z_8*y_9)*z_11)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_11-(z_8*x_9-x_8*z_9)*x_11)==0) 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_3-(x_7*y_13-y_7*x_13)*y_3)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_3-(y_7*z_13-z_7*y_13)*z_3)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_3-(z_7*x_13-x_7*z_13)*x_3)==0) 
    s.add(((z_3*x_9-x_3*z_9)*z_4-(x_3*y_9-y_3*x_9)*y_4)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_4-(y_3*z_9-z_3*y_9)*z_4)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_4-(z_3*x_9-x_3*z_9)*x_4)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_6 == 0) 
