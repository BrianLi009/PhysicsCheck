...
neq0 := k(v2,v0); 
neq1 := k(v2,v1); 
neq2 := k(v2,k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3)); 
neq3 := k(v2,k(v3,v1)); 
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq7 := k(v2,k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq8 := k(v2,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq9 := k(v2,k(v3,k(v0,v1))); 
neq10 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2)); 
neq11 := k(k(k(v3,v1),v2),v0); 
neq12 := k(k(k(v3,v1),v2),v1); 
neq13 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3)); 
neq14 := k(k(k(v3,v1),v2),k(v0,v1)); 
neq15 := k(k(k(v3,v1),v2),v3); 
neq16 := k(k(k(v3,v1),v2),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq17 := k(k(k(v3,v1),v2),k(k(v3,k(v0,v1)),v2)); 
neq18 := k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq19 := k(k(k(v3,v1),v2),k(v3,k(v0,v1))); 
neq20 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),v0); 
neq21 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),v1); 
neq22 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(v3,v1)); 
neq23 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(v0,v1)); 
neq24 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),v3); 
neq25 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq26 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(k(v3,k(v0,v1)),v2)); 
neq27 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq28 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2),k(v3,k(v0,v1))); 
neq29 := k(v0,k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3)); 
neq30 := k(v0,k(v3,v1)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq33 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq34 := k(v0,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq35 := k(v0,k(v3,k(v0,v1))); 
neq36 := k(v1,k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3)); 
neq37 := k(v1,v3); 
neq38 := k(v1,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq39 := k(v1,k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq40 := k(v1,k(k(v3,k(v0,v1)),v2)); 
neq41 := k(v1,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq42 := k(v1,k(v3,k(v0,v1))); 
neq43 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(v3,v1)); 
neq44 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(v0,v1)); 
neq45 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq46 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(k(v3,k(v0,v1)),v2)); 
neq47 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq48 := k(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(v3,k(v0,v1))); 
neq49 := k(k(v3,v1),k(v0,v1)); 
neq50 := k(k(v3,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq51 := k(k(v3,v1),k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq52 := k(k(v3,v1),k(k(v3,k(v0,v1)),v2)); 
neq53 := k(k(v3,v1),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq54 := k(k(v3,v1),k(v3,k(v0,v1))); 
neq55 := k(k(v0,v1),v3); 
neq56 := k(k(v0,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq57 := k(k(v0,v1),k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq58 := k(k(v0,v1),k(k(v3,k(v0,v1)),v2)); 
neq59 := k(k(v0,v1),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq60 := k(v3,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0)); 
neq61 := k(v3,k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
neq62 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq63 := k(v3,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq64 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))))); 
...
neq67 := k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),k(k(v3,k(v0,v1)),v2)); 
neq68 := k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),k(v3,k(v0,v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,v1),v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))),v3),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
