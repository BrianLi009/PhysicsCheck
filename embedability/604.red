...
neq2 := k(v2,k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq3 := k(v2,v0); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq6 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))); 
neq7 := k(v2,k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1)))); 
neq8 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq11 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq12 := k(k(k(k(v2,v0),v2),k(v0,v1)),v0); 
neq13 := k(k(k(k(v2,v0),v2),k(v0,v1)),v1); 
neq14 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
...
neq19 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq20 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0); 
neq21 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v1); 
neq22 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq23 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1)))); 
...
neq27 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),v0); 
neq28 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),v1); 
neq29 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))); 
neq30 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1)))); 
neq31 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)); 
neq32 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v0,v1)); 
neq33 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(v2,v0),v2)); 
neq34 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq35 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))); 
neq36 := k(v0,k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1)))); 
neq37 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq38 := k(v0,k(v2,k(v0,v1))); 
neq39 := k(v0,k(k(v2,v0),v2)); 
neq40 := k(v1,k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq41 := k(v1,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))); 
neq42 := k(v1,k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1)))); 
neq43 := k(v1,k(v2,v0)); 
neq44 := k(v1,k(v2,k(v0,v1))); 
neq45 := k(v1,k(k(v2,v0),v2)); 
neq46 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))); 
neq47 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq48 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(v0,v1)); 
neq49 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(v2,k(v0,v1))); 
neq50 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(v2,v0),v2)); 
...
neq55 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(k(k(v2,v0),v2),v1)); 
neq56 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(v2,v0)); 
neq57 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(v0,v1)); 
neq58 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(v2,k(v0,v1))); 
neq59 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),k(v0,v1))),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
