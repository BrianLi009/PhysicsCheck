...
neq2 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1)); 
neq3 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq4 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq5 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq6 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq7 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq8 := k(k(k(v2,v1),v1),v2); 
neq9 := k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)); 
neq10 := k(k(v2,v1),k(v0,v1)); 
neq11 := k(k(v2,v1),v0); 
neq12 := k(k(v2,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1)); 
neq13 := k(k(v2,v1),k(v2,v0)); 
neq14 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq15 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq16 := k(k(v2,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq17 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq18 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq19 := k(k(v2,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq20 := k(k(v0,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1)); 
neq21 := k(k(v0,v1),k(v2,v0)); 
neq22 := k(k(v0,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq23 := k(k(v0,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq24 := k(k(v0,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq25 := k(k(v0,v1),v2); 
neq26 := k(k(v0,v1),k(k(v2,k(v0,v1)),v2)); 
neq27 := k(k(v0,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq28 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1)); 
neq29 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq30 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq31 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq32 := k(v0,k(v2,k(v0,v1))); 
neq33 := k(v0,v2); 
neq34 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq35 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq36 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(v2,v0)); 
neq37 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq38 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(v2,k(v0,v1))); 
neq39 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),v2); 
neq40 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(k(v2,k(v0,v1)),v2)); 
neq41 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq42 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq43 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq44 := k(k(v2,v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq45 := k(k(v2,v0),k(v2,k(v0,v1))); 
neq46 := k(k(v2,v0),k(k(v2,k(v0,v1)),v2)); 
neq47 := k(k(v2,v0),v1); 
neq48 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))); 
neq50 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v2); 
neq51 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq52 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1); 
neq53 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq54 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),v2); 
neq55 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),v1); 
neq56 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq57 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2)),v2); 
neq58 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq59 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2)),v1); 
neq60 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq61 := k(k(v2,k(v0,v1)),v1); 
neq62 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq63 := k(v2,v1); 
neq64 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,k(v0,v1))),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
