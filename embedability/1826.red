...
neq1 := k(v2,k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3)); 
neq2 := k(v2,k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3)); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0))); 
neq5 := k(v2,k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq6 := k(v2,k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq7 := k(v2,v3); 
neq8 := k(v2,k(v3,v0)); 
neq9 := k(v2,k(k(k(v3,v0),v2),k(v3,v0))); 
neq10 := k(k(k(v3,v2),v0),k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3)); 
neq11 := k(k(k(v3,v2),v0),k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3)); 
neq12 := k(k(k(v3,v2),v0),v1); 
neq13 := k(k(k(v3,v2),v0),k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq14 := k(k(k(v3,v2),v0),k(k(v3,v0),v2)); 
neq15 := k(k(k(v3,v2),v0),k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq16 := k(k(k(v3,v2),v0),v3); 
neq17 := k(k(k(v3,v2),v0),k(v3,v0)); 
neq18 := k(k(k(v3,v2),v0),k(k(k(v3,v0),v2),k(v3,v0))); 
neq19 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),v0); 
neq20 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),v1); 
neq21 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(v3,v2)); 
neq22 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq23 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(k(v3,v0),v2)); 
neq24 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq25 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(v3,v0)); 
neq26 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3),k(k(k(v3,v0),v2),k(v3,v0))); 
neq27 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),v0); 
neq28 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0))); 
neq29 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),v1); 
neq30 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(v3,v2)); 
neq31 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(k(v3,v0),v2)); 
neq32 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq33 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(v3,v0)); 
neq34 := k(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(k(k(v3,v0),v2),k(v3,v0))); 
neq35 := k(v0,k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0))); 
neq36 := k(v0,k(v3,v2)); 
neq37 := k(v0,k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq38 := k(v0,k(k(v3,v0),v2)); 
neq39 := k(v0,k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq40 := k(v0,v3); 
neq41 := k(v0,k(k(k(v3,v0),v2),k(v3,v0))); 
neq42 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v1); 
neq43 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),k(v3,v2)); 
neq44 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq45 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),k(k(v3,v0),v2)); 
neq46 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3); 
neq47 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),k(v3,v0)); 
neq48 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),k(k(k(v3,v0),v2),k(v3,v0))); 
neq49 := k(v1,k(v3,v2)); 
neq50 := k(v1,k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq51 := k(v1,k(k(v3,v0),v2)); 
neq52 := k(v1,v3); 
neq53 := k(v1,k(v3,v0)); 
neq54 := k(v1,k(k(k(v3,v0),v2),k(v3,v0))); 
neq55 := k(k(v3,v2),k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0)))); 
neq56 := k(k(v3,v2),k(k(v3,v0),v2)); 
neq57 := k(k(v3,v2),k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq58 := k(k(v3,v2),k(v3,v0)); 
neq59 := k(k(v3,v2),k(k(k(v3,v0),v2),k(v3,v0))); 
neq60 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),k(k(v3,v0),v2)); 
neq61 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3); 
neq62 := k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),k(v3,v0)); 
neq63 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),k(v3,v0)),v1)); 
neq64 := k(k(k(v3,v0),v2),v3); 
neq65 := k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),v3); 
neq66 := k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(v3,v0)); 
neq67 := k(v3,k(k(k(v3,v0),v2),k(v3,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(k(v3,v0),v2),k(v3,v0))),v3),k(k(k(k(k(k(v3,v0),v2),k(v3,v0)),v1),k(k(v3,v2),v0)),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
