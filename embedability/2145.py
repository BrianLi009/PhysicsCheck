...
def test_embed(): 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_7-(x_9*y_10-y_9*x_10)*y_7)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_7-(y_9*z_10-z_9*y_10)*z_7)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_7-(z_9*x_10-x_9*z_10)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
