...
v3c2 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2))); 
neq2 := k(v2,k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq3 := k(v2,k(k(v3,v2),v3)); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq8 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq9 := k(v2,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq10 := k(v3,k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2))); 
neq11 := k(v3,k(k(v3,v2),k(k(k(v2,v1),v2),v0))); 
neq12 := k(v3,v0); 
neq13 := k(v3,k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)); 
neq14 := k(v3,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq15 := k(v3,k(k(k(v2,v1),v2),v0)); 
neq16 := k(v3,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq17 := k(v3,k(v2,v1)); 
neq18 := k(v3,k(k(v2,v1),v2)); 
neq19 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(k(v3,v2),v3)); 
neq20 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),v0); 
neq21 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)); 
neq22 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),v1); 
neq23 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq24 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(k(k(v2,v1),v2),v0)); 
neq25 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1)); 
neq26 := k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(k(v2,v1),v2)); 
neq27 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(v3,v2),v3)); 
neq28 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),v0); 
neq29 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)); 
neq30 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),v1); 
neq31 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq32 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq33 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
neq34 := k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v2)); 
neq35 := k(k(k(v3,v2),v3),v0); 
neq36 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)); 
neq37 := k(k(k(v3,v2),v3),v1); 
neq38 := k(k(k(v3,v2),v3),k(k(k(v2,v1),v2),v0)); 
neq39 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq40 := k(k(k(v3,v2),v3),k(v2,v1)); 
neq41 := k(k(k(v3,v2),v3),k(k(v2,v1),v2)); 
neq42 := k(v0,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq43 := k(v0,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq44 := k(v0,k(v2,v1)); 
neq45 := k(v0,k(k(v2,v1),v2)); 
neq46 := k(v0,k(v3,v2)); 
neq47 := k(k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0),v1); 
neq48 := k(k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0),k(k(k(v2,v1),v2),v0)); 
neq49 := k(k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0),k(v2,v1)); 
neq50 := k(k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0),k(k(v2,v1),v2)); 
neq51 := k(k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0),k(v3,v2)); 
neq52 := k(v1,k(k(k(v3,v2),v3),k(k(v2,v1),v2))); 
neq53 := k(v1,k(k(k(v2,v1),v2),v0)); 
neq54 := k(v1,k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq55 := k(v1,k(k(v2,v1),v2)); 
neq56 := k(v1,k(v3,v2)); 
neq57 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq58 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq59 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(v2,v1)); 
neq60 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),k(v3,v2)); 
neq61 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1))); 
neq62 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq63 := k(k(k(k(v2,v1),v2),v0),k(v3,v2)); 
neq64 := k(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1)),k(k(v2,v1),v2)); 
neq65 := k(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1)),k(v3,v2)); 
neq66 := k(k(v2,v1),k(v3,v2)); 
neq67 := k(k(k(v2,v1),v2),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v2),k(k(k(v2,v1),v2),v0)),k(v3,v2)),k(v2,v1)),k(k(k(k(v3,v2),v3),k(k(v2,v1),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
