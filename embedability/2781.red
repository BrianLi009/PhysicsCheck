...
neq3 := k(v2,k(k(v3,k(v2,v0)),k(k(v3,v2),v1))); 
neq4 := k(v2,v0); 
neq5 := k(v2,k(v0,v1)); 
neq6 := k(v2,v3); 
...
neq11 := k(k(v3,k(v2,v1)),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq12 := k(k(v3,k(v2,v1)),k(k(v3,k(v2,v0)),k(k(v3,v2),v1))); 
...
neq18 := k(k(v3,k(v2,v1)),k(v3,k(v2,v0))); 
neq19 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,v2)); 
neq20 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq21 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(v3,k(v2,v0)),k(k(v3,v2),v1))); 
neq22 := k(k(k(k(v3,v2),v1),k(v2,v0)),v0); 
neq23 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v0,v1)); 
neq24 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v2,v1)); 
neq25 := k(k(k(k(v3,v2),v1),k(v2,v0)),v3); 
neq26 := k(k(k(k(v3,v2),v1),k(v2,v0)),v1); 
neq27 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,k(v2,v0))); 
neq28 := k(k(v3,v2),k(k(v3,k(v2,v0)),k(v2,v1))); 
neq29 := k(k(v3,v2),k(k(v3,k(v2,v0)),k(k(v3,v2),v1))); 
neq30 := k(k(v3,v2),v0); 
...
neq36 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v0); 
neq37 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v0,v1)); 
neq38 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq39 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v3); 
neq40 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v3,v2),v1)); 
neq41 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq42 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),v0); 
neq43 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),k(v0,v1)); 
neq44 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),k(v2,v1)); 
neq45 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),k(v2,v0)); 
neq46 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),v3); 
neq47 := k(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),v1); 
neq48 := k(v0,k(v2,v1)); 
neq49 := k(v0,v3); 
...
neq64 := k(v3,v1); 
neq65 := k(k(k(v3,v2),v1),k(v3,k(v2,v0))); 
neq66 := k(v1,k(v3,k(v2,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,k(v2,v1))) = 0 and 
       d(k(k(v3,k(v2,v0)),k(k(v3,v2),v1)),k(k(v3,k(v2,v0)),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
