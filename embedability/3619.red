...
neq0 := k(v2,v3); 
neq1 := k(v2,k(v3,v0)); 
neq2 := k(v2,k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3)); 
neq3 := k(v2,k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2))); 
neq4 := k(v2,k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq5 := k(v2,k(k(k(k(v3,v0),v2),v1),v1)); 
neq6 := k(v2,k(k(k(v3,v0),v2),v1)); 
neq7 := k(v2,k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq8 := k(v2,v0); 
neq9 := k(v2,v1); 
neq10 := k(v3,k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2))); 
neq11 := k(v3,k(k(v3,v0),v2)); 
neq12 := k(v3,k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq13 := k(v3,k(k(k(k(v3,v0),v2),v1),v1)); 
neq14 := k(v3,k(v0,v1)); 
neq15 := k(v3,k(k(k(v3,v0),v2),v1)); 
neq16 := k(v3,k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq17 := k(v3,v0); 
neq18 := k(v3,v1); 
neq19 := k(k(v3,v2),k(v3,v0)); 
neq20 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3)); 
neq21 := k(k(v3,v2),k(k(v3,v0),v2)); 
neq22 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq23 := k(k(v3,v2),k(k(k(k(v3,v0),v2),v1),v1)); 
neq24 := k(k(v3,v2),k(v0,v1)); 
neq25 := k(k(v3,v2),k(k(k(v3,v0),v2),v1)); 
neq26 := k(k(v3,v2),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq27 := k(k(v3,v2),v0); 
neq28 := k(k(v3,v2),v1); 
neq29 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3)); 
neq30 := k(k(v3,v0),k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2))); 
neq31 := k(k(v3,v0),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq32 := k(k(v3,v0),k(k(k(k(v3,v0),v2),v1),v1)); 
neq33 := k(k(v3,v0),k(v0,v1)); 
neq34 := k(k(v3,v0),k(k(k(v3,v0),v2),v1)); 
neq35 := k(k(v3,v0),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq36 := k(k(v3,v0),v1); 
neq37 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2))); 
neq38 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),k(k(v3,v0),v2)); 
neq39 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),k(k(k(k(v3,v0),v2),v1),v1)); 
neq40 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),k(v0,v1)); 
neq41 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),k(k(k(v3,v0),v2),v1)); 
neq42 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),v0); 
neq43 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3),v1); 
neq44 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),k(k(v3,v0),v2)); 
neq45 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq46 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),k(v0,v1)); 
neq47 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),k(k(k(v3,v0),v2),v1)); 
neq48 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0); 
neq49 := k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v1); 
neq50 := k(k(k(v3,v0),v2),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1))); 
neq51 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),v1),v1)); 
neq52 := k(k(k(v3,v0),v2),k(v0,v1)); 
neq53 := k(k(k(v3,v0),v2),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq54 := k(k(k(v3,v0),v2),v0); 
neq55 := k(k(k(v3,v0),v2),v1); 
neq56 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1)),k(k(k(k(v3,v0),v2),v1),v1)); 
neq57 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1)),k(v0,v1)); 
neq58 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1)),v0); 
neq59 := k(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1)),v1); 
neq60 := k(k(k(k(k(v3,v0),v2),v1),v1),k(v0,v1)); 
neq61 := k(k(k(k(k(v3,v0),v2),v1),v1),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq62 := k(k(k(k(k(v3,v0),v2),v1),v1),v0); 
neq63 := k(k(v0,v1),k(k(k(v3,v0),v2),v1)); 
neq64 := k(k(v0,v1),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq65 := k(k(k(k(v3,v0),v2),v1),k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0)); 
neq66 := k(k(k(k(v3,v0),v2),v1),v0); 
neq67 := k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),k(k(k(v3,v0),v2),v1)),k(k(k(k(k(k(k(v3,v0),v2),v1),v1),k(v3,v2)),v0),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
