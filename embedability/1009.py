...
def test_embed(): 
    ...
    s.add(((z_0*x_12-x_0*z_12)*z_5-(x_0*y_12-y_0*x_12)*y_5)==0) 
    s.add(((x_0*y_12-y_0*x_12)*x_5-(y_0*z_12-z_0*y_12)*z_5)==0) 
    s.add(((y_0*z_12-z_0*y_12)*y_5-(z_0*x_12-x_0*z_12)*x_5)==0) 
