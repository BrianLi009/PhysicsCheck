...
neq15 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3))); 
...
neq24 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3))); 
...
neq52 := k(v0,k(v3,v2)); 
neq53 := k(k(k(k(k(v3,v2),v0),k(v3,v1)),k(k(v3,v2),v2)),k(k(k(v3,v2),v3),k(v0,v1))); 
...
neq57 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3)),k(k(k(v3,v2),v0),k(v3,v1))); 
neq58 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3)),v1); 
neq59 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3)),k(v3,v2)); 
neq60 := k(k(k(k(v3,v2),v0),k(v3,v1)),k(k(k(v3,v2),v3),k(v0,v1))); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v0),k(v3,v1)),k(k(v3,v2),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
