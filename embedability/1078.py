...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_7-(x_0*y_13-y_0*x_13)*y_7)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_7-(y_0*z_13-z_0*y_13)*z_7)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_7-(z_0*x_13-x_0*z_13)*x_7)==0) 
    ...
    s.add(((z_5*x_6-x_5*z_6)*z_2-(x_5*y_6-y_5*x_6)*y_2)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_2-(y_5*z_6-z_5*y_6)*z_2)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_2-(z_5*x_6-x_5*z_6)*x_2)==0) 
