...
def test_embed(): 
    ...
    s.add(((z_2*x_7-x_2*z_7)*z_10-(x_2*y_7-y_2*x_7)*y_10)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_10-(y_2*z_7-z_2*y_7)*z_10)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_10-(z_2*x_7-x_2*z_7)*x_10)==0) 
    ...
    s.add(((z_3*x_11-x_3*z_11)*z_9-(x_3*y_11-y_3*x_11)*y_9)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_9-(y_3*z_11-z_3*y_11)*z_9)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_9-(z_3*x_11-x_3*z_11)*x_9)==0) 
    s.add(((z_4*x_12-x_4*z_12)*z_8-(x_4*y_12-y_4*x_12)*y_8)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_8-(y_4*z_12-z_4*y_12)*z_8)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_8-(z_4*x_12-x_4*z_12)*x_8)==0) 
