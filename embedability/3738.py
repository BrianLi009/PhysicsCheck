...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_3-(x_9*y_13-y_9*x_13)*y_3)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_3-(y_9*z_13-z_9*y_13)*z_3)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_3-(z_9*x_13-x_9*z_13)*x_3)==0) 
    s.add(((z_3*x_7-x_3*z_7)*z_8-(x_3*y_7-y_3*x_7)*y_8)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_8-(y_3*z_7-z_3*y_7)*z_8)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_8-(z_3*x_7-x_3*z_7)*x_8)==0) 
