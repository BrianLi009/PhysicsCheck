...
def test_embed(): 
    ...
    s.add(((z_2*x_12-x_2*z_12)*z_3-(x_2*y_12-y_2*x_12)*y_3)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_3-(y_2*z_12-z_2*y_12)*z_3)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_3-(z_2*x_12-x_2*z_12)*x_3)==0) 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_4-(x_5*y_10-y_5*x_10)*y_4)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_4-(y_5*z_10-z_5*y_10)*z_4)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_4-(z_5*x_10-x_5*z_10)*x_4)==0) 
    ...
    s.add(((z_6*x_12-x_6*z_12)*z_7-(x_6*y_12-y_6*x_12)*y_7)==0) 
    s.add(((x_6*y_12-y_6*x_12)*x_7-(y_6*z_12-z_6*y_12)*z_7)==0) 
    s.add(((y_6*z_12-z_6*y_12)*y_7-(z_6*x_12-x_6*z_12)*x_7)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_9 == 0) 
