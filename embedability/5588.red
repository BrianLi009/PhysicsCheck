...
neq1 := k(k(v2,k(v0,v1)),k(k(v3,v1),k(v2,v0))); 
neq2 := k(k(v2,k(v0,v1)),k(k(v3,v0),v2)); 
neq3 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v0),v2),v1),v3)); 
neq4 := k(k(v2,k(v0,v1)),k(k(k(v3,v0),v2),v1)); 
...
neq10 := k(v2,k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq11 := k(v2,v3); 
neq12 := k(v2,k(k(v3,v1),k(v2,v0))); 
neq13 := k(v2,k(k(k(k(v3,v0),v2),v1),v3)); 
neq14 := k(v2,k(k(k(v3,v0),v2),v1)); 
neq15 := k(v2,k(v3,v1)); 
neq16 := k(v2,k(v3,v0)); 
neq17 := k(v2,k(v0,v1)); 
neq18 := k(v2,v0); 
neq19 := k(v2,v1); 
neq20 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),v3); 
neq21 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(v3,v0),v2)); 
neq22 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v0),v2),v1)); 
neq23 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(v3,v1)); 
neq24 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(v3,v0)); 
neq25 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(v2,v0)); 
neq26 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(v0,v1)); 
neq27 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),v0); 
neq28 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),v1); 
neq29 := k(v3,k(k(v3,v1),k(v2,v0))); 
neq30 := k(v3,k(k(v3,v0),v2)); 
neq31 := k(v3,k(k(k(v3,v0),v2),v1)); 
neq32 := k(v3,k(v2,v0)); 
neq33 := k(v3,k(v0,v1)); 
neq34 := k(v3,v0); 
neq35 := k(v3,v1); 
neq36 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v0),v2)); 
neq37 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v0),v2),v1),v3)); 
neq38 := k(k(k(v3,v1),k(v2,v0)),k(k(k(v3,v0),v2),v1)); 
neq39 := k(k(k(v3,v1),k(v2,v0)),k(v3,v0)); 
neq40 := k(k(k(v3,v1),k(v2,v0)),k(v0,v1)); 
neq41 := k(k(k(v3,v1),k(v2,v0)),v0); 
neq42 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq43 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),v1),v3)); 
neq44 := k(k(k(v3,v0),v2),k(v3,v1)); 
neq45 := k(k(k(v3,v0),v2),k(v2,v0)); 
neq46 := k(k(k(v3,v0),v2),k(v0,v1)); 
neq47 := k(k(k(v3,v0),v2),v0); 
neq48 := k(k(k(v3,v0),v2),v1); 
neq49 := k(k(k(k(k(v3,v0),v2),v1),v3),k(v3,v1)); 
neq50 := k(k(k(k(k(v3,v0),v2),v1),v3),k(v3,v0)); 
neq51 := k(k(k(k(k(v3,v0),v2),v1),v3),k(v2,v0)); 
neq52 := k(k(k(k(k(v3,v0),v2),v1),v3),k(v0,v1)); 
neq53 := k(k(k(k(k(v3,v0),v2),v1),v3),v0); 
neq54 := k(k(k(k(k(v3,v0),v2),v1),v3),v1); 
neq55 := k(k(k(k(v3,v0),v2),v1),k(v3,v1)); 
neq56 := k(k(k(k(v3,v0),v2),v1),k(v3,v0)); 
neq57 := k(k(k(k(v3,v0),v2),v1),k(v2,v0)); 
neq58 := k(k(k(k(v3,v0),v2),v1),k(v0,v1)); 
neq59 := k(k(k(k(v3,v0),v2),v1),v0); 
...
phi := 
       ...
       d(k(k(k(k(v3,v0),v2),v1),v3),k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
