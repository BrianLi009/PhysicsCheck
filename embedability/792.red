...
neq1 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1))); 
neq2 := k(v2,k(k(k(v2,v1),v2),k(v0,v1))); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq5 := k(v2,k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq6 := k(v2,k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1))); 
neq11 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),k(v0,v1))); 
neq12 := k(k(k(v2,v1),v1),v0); 
neq13 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq14 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq15 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq16 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq17 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)); 
neq18 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq19 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq20 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),v0); 
neq21 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(v2,k(v0,v1))); 
neq22 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq23 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),v1); 
neq24 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(k(v2,v1),v2)); 
neq25 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(v2,v1),v2),v0)); 
neq26 := k(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(v0,v1)); 
neq27 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq28 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v2,k(v0,v1))); 
neq29 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))); 
neq30 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq31 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
...
neq36 := k(v0,k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq37 := k(v0,k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq38 := k(v0,k(k(v2,v1),v2)); 
neq39 := k(v0,k(v2,v1)); 
neq40 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq41 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq42 := k(k(v2,k(v0,v1)),v1); 
neq43 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq44 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq45 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq46 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq47 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))); 
neq48 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1); 
neq49 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq50 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v0,v1)); 
neq51 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)); 
neq52 := k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),v1); 
...
neq56 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),v1); 
neq57 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v2)); 
neq58 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(v2,v1),v2),v0)); 
neq59 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(v0,v1)); 
neq60 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(v2,v1)); 
neq61 := k(v1,k(k(v2,v1),v2)); 
neq62 := k(v1,k(k(k(v2,v1),v2),v0)); 
neq63 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq64 := k(k(k(k(v2,v1),v2),v0),k(v0,v1)); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)),k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
