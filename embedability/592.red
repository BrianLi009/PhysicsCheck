...
v3c2 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq2 := k(v2,k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq5 := k(v2,k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq8 := k(v2,k(k(v2,v1),v1)); 
neq9 := k(v2,k(v3,k(v2,v0))); 
neq10 := k(v3,k(k(v3,k(v2,v0)),k(v2,v1))); 
neq11 := k(v3,k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq12 := k(v3,v0); 
neq13 := k(v3,k(k(k(v2,v1),v1),k(v2,v0))); 
neq14 := k(v3,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2)); 
neq15 := k(v3,k(v2,v1)); 
neq16 := k(v3,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq17 := k(v3,k(k(v2,v1),v1)); 
neq18 := k(v3,k(v2,v0)); 
neq19 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))); 
neq20 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v0); 
neq21 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq22 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2)); 
neq23 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq24 := k(k(k(v3,k(v2,v0)),k(v2,v1)),v1); 
neq25 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v2,v1),v1)); 
neq26 := k(k(k(v3,k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq27 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),v0); 
neq28 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq29 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(v2,v1)); 
neq30 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq31 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),v1); 
neq32 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq33 := k(k(k(v3,k(v2,v0)),k(k(v2,v1),v1)),k(v2,v0)); 
neq34 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq35 := k(v0,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2)); 
neq36 := k(v0,k(v2,v1)); 
neq37 := k(v0,k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq38 := k(v0,k(k(v2,v1),v1)); 
neq39 := k(v0,k(v3,k(v2,v0))); 
neq40 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2)); 
neq41 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v1)); 
neq42 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq43 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq44 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v3,k(v2,v0))); 
neq45 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(v2,v1)); 
neq46 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),v1); 
neq47 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(k(v2,v1),v1)); 
neq48 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(v2,v0)); 
neq49 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(v3,k(v2,v0))); 
neq50 := k(k(v2,v1),k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq51 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq52 := k(k(v2,v1),k(v2,v0)); 
neq53 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq54 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v1); 
neq55 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(v2,v1),v1)); 
neq56 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(v2,v0)); 
neq57 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(v3,k(v2,v0))); 
neq58 := k(v1,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)); 
neq59 := k(v1,k(v2,v0)); 
neq60 := k(v1,k(v3,k(v2,v0))); 
neq61 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0),k(k(v2,v1),v1)); 
neq62 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0),k(v2,v0)); 
neq63 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0),k(v3,k(v2,v0))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(v3,k(v2,v0)),k(v2,v1)),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)) = 0 and 
       d(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v0)) = 0 and 
       d(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v2),k(k(v3,k(v2,v0)),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
