...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(k(v0,v1),k(v3,k(v2,k(v0,v1)))); 
neq1 := k(k(v0,v1),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq2 := k(k(v0,v1),v2); 
neq3 := k(k(v0,v1),k(k(v2,k(v0,v1)),v2)); 
neq4 := k(k(v0,v1),k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))); 
neq5 := k(k(v0,v1),v3); 
neq6 := k(k(v0,v1),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq7 := k(k(v0,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq8 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq9 := k(k(v0,v1),k(v3,v1)); 
neq10 := k(k(v3,k(v2,k(v0,v1))),v2); 
neq11 := k(k(v3,k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq12 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))); 
neq13 := k(k(v3,k(v2,k(v0,v1))),v0); 
neq14 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq15 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq16 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,v1),v2)); 
neq17 := k(k(v3,k(v2,k(v0,v1))),k(v3,v1)); 
neq18 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq19 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v2); 
neq20 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq21 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))); 
neq22 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0); 
neq23 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v3); 
neq24 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq25 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(v3,v1),v2)); 
neq26 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v3,v1)); 
neq27 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1); 
neq28 := k(v2,k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))); 
neq29 := k(v2,v0); 
neq30 := k(v2,v3); 
neq31 := k(v2,k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq32 := k(v2,k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq33 := k(v2,k(v3,v1)); 
neq34 := k(v2,v1); 
neq35 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))); 
neq36 := k(k(k(v2,k(v0,v1)),v2),v0); 
neq37 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq38 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq39 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,v1),v2)); 
neq40 := k(k(k(v2,k(v0,v1)),v2),k(v3,v1)); 
neq41 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq42 := k(k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))),v0); 
neq43 := k(k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))),v3); 
neq44 := k(k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq45 := k(k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))),v1); 
neq46 := k(k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))),k(v2,k(v0,v1))); 
neq47 := k(v0,v3); 
neq48 := k(v0,k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(v0,k(k(v3,v1),v2)); 
neq50 := k(v0,k(v3,v1)); 
neq51 := k(v0,k(v2,k(v0,v1))); 
neq52 := k(v3,k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq53 := k(v3,k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2))); 
neq54 := k(v3,k(k(v3,v1),v2)); 
neq55 := k(v3,k(v2,k(v0,v1))); 
neq56 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v3,v1),v2)); 
neq57 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(v3,v1)); 
neq58 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v1); 
neq59 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(v2,k(v0,v1))); 
neq60 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)),k(k(v3,v1),v2)); 
neq61 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)),k(v3,v1)); 
neq62 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)),v1); 
neq63 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq64 := k(k(k(v3,v1),v2),v1); 
neq65 := k(k(k(v3,v1),v2),k(v2,k(v0,v1))); 
neq66 := k(k(v3,v1),k(v2,k(v0,v1))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(v3,v1),v2),k(k(v3,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(v2,k(v0,v1)),v2)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
