...
v2c2 := 0;
neq0 := k(v2,k(v0,v1)); 
neq1 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1)); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1)); 
neq4 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(v3,v0)); 
neq7 := k(v2,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq8 := k(v2,k(v3,k(v0,v1))); 
neq9 := k(v2,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq10 := k(k(v0,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1)); 
neq11 := k(k(v0,v1),k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1)); 
neq12 := k(k(v0,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq13 := k(k(v0,v1),v3); 
neq14 := k(k(v0,v1),k(k(v3,k(v0,v1)),v2)); 
neq15 := k(k(v0,v1),k(v3,v2)); 
neq16 := k(k(v0,v1),k(v3,v0)); 
neq17 := k(k(v0,v1),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq18 := k(k(v0,v1),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq19 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),v0); 
neq20 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq21 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),v3); 
neq22 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(k(v3,k(v0,v1)),v2)); 
neq23 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(v3,v2)); 
neq24 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(v3,v0)); 
neq25 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq26 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1),k(v3,k(v0,v1))); 
neq27 := k(v0,k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1)); 
neq28 := k(v0,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq29 := k(v0,v3); 
neq30 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq31 := k(v0,k(v3,v2)); 
neq32 := k(v0,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq33 := k(v0,k(v3,k(v0,v1))); 
neq34 := k(v0,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq35 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq36 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),v3); 
neq37 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(k(v3,k(v0,v1)),v2)); 
neq38 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(v3,v2)); 
neq39 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(v3,v0)); 
neq40 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(v3,k(v0,v1))); 
neq41 := k(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq42 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),v3); 
neq43 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(k(v3,k(v0,v1)),v2)); 
neq44 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)); 
neq45 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,k(v0,v1))); 
neq46 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),v1); 
neq47 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq48 := k(v3,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq49 := k(v3,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq50 := k(v3,v1); 
neq51 := k(k(k(v3,k(v0,v1)),v2),k(v3,v2)); 
neq52 := k(k(k(v3,k(v0,v1)),v2),k(v3,v0)); 
neq53 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq54 := k(k(k(v3,k(v0,v1)),v2),v1); 
neq55 := k(k(v3,v2),k(v3,v0)); 
neq56 := k(k(v3,v2),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0))); 
neq57 := k(k(v3,v2),k(v3,k(v0,v1))); 
neq58 := k(k(v3,v2),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq59 := k(k(v3,v2),v1); 
neq60 := k(k(v3,v0),k(v3,k(v0,v1))); 
neq61 := k(k(v3,v0),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq62 := k(k(v3,v0),v1); 
neq63 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),k(v3,k(v0,v1))); 
neq64 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq65 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1); 
neq66 := k(k(v3,k(v0,v1)),v1); 
neq67 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v0)),v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
