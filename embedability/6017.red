...
neq1 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2)); 
neq2 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3)); 
neq3 := k(k(v2,k(v0,v1)),v3); 
neq4 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1))); 
neq5 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq6 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq7 := k(k(v2,k(v0,v1)),v1); 
neq8 := k(k(v2,k(v0,v1)),k(k(v3,v2),v1)); 
neq9 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq10 := k(k(v0,v1),v2); 
neq11 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2)); 
neq12 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3)); 
neq13 := k(k(v0,v1),v3); 
neq14 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1))); 
neq15 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq16 := k(k(v0,v1),k(v3,v2)); 
neq17 := k(k(v0,v1),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq18 := k(k(v0,v1),k(k(v3,v2),v1)); 
neq19 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq20 := k(v2,v0); 
neq21 := k(v2,k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3)); 
neq22 := k(v2,v3); 
neq23 := k(v2,k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1))); 
neq24 := k(v2,k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq25 := k(v2,v1); 
neq26 := k(v2,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq27 := k(v2,k(k(v3,v2),v1)); 
neq28 := k(v2,k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq29 := k(v0,k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2)); 
neq30 := k(v0,k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1))); 
neq33 := k(v0,k(v3,v2)); 
neq34 := k(v0,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq35 := k(v0,k(k(v3,v2),v1)); 
neq36 := k(v0,k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq37 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3)); 
neq38 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),v3); 
neq39 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),k(v3,v2)); 
neq40 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),v1); 
neq41 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq42 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),k(k(v3,v2),v1)); 
neq43 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq44 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq45 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(v3,v2)); 
neq46 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),v1); 
neq47 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq48 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)); 
neq49 := k(v3,k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1))); 
neq50 := k(v3,k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq51 := k(v3,v1); 
neq52 := k(v3,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq53 := k(v3,k(k(v3,v2),v1)); 
neq54 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0)); 
neq55 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),k(v3,v2)); 
neq56 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),v1); 
neq57 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq58 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq59 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),k(v3,v2)); 
neq60 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v1); 
neq61 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq62 := k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),k(k(v3,v2),v1)); 
neq63 := k(k(v3,v2),v1); 
neq64 := k(k(v3,v2),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq65 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq66 := k(v1,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq67 := k(v1,k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
neq68 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v3),v0),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
