...
def test_embed(): 
    ...
    s.add(((z_8*x_9-x_8*z_9)*z_7-(x_8*y_9-y_8*x_9)*y_7)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_7-(y_8*z_9-z_8*y_9)*z_7)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_7-(z_8*x_9-x_8*z_9)*x_7)==0) 
    s.add(((z_0*x_9-x_0*z_9)*z_4-(x_0*y_9-y_0*x_9)*y_4)==0) 
    s.add(((x_0*y_9-y_0*x_9)*x_4-(y_0*z_9-z_0*y_9)*z_4)==0) 
    s.add(((y_0*z_9-z_0*y_9)*y_4-(z_0*x_9-x_0*z_9)*x_4)==0) 
    ...
    s.add(((z_6*x_8-x_6*z_8)*z_3-(x_6*y_8-y_6*x_8)*y_3)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_3-(y_6*z_8-z_6*y_8)*z_3)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_3-(z_6*x_8-x_6*z_8)*x_3)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
