...
def test_embed(): 
    ...
    s.add(((z_0*x_9-x_0*z_9)*z_2-(x_0*y_9-y_0*x_9)*y_2)==0) 
    s.add(((x_0*y_9-y_0*x_9)*x_2-(y_0*z_9-z_0*y_9)*z_2)==0) 
    s.add(((y_0*z_9-z_0*y_9)*y_2-(z_0*x_9-x_0*z_9)*x_2)==0) 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_4-(x_8*y_13-y_8*x_13)*y_4)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_4-(y_8*z_13-z_8*y_13)*z_4)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_4-(z_8*x_13-x_8*z_13)*x_4)==0) 
