...
neq11 := k(v2,v0); 
neq12 := k(v2,k(v0,v1)); 
neq13 := k(v2,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq14 := k(v2,v1); 
...
neq20 := k(v3,k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
...
neq27 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
...
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq37 := k(k(v0,v1),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq38 := k(k(v0,v1),k(k(k(v3,v2),v3),k(k(v3,v0),v2))); 
neq39 := k(k(v0,v1),k(v3,v0)); 
neq40 := k(k(v0,v1),k(v3,v2)); 
neq41 := k(k(k(v3,v0),v2),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))); 
neq42 := k(k(k(v3,v0),v2),k(v2,k(v0,v1))); 
neq43 := k(k(k(v3,v0),v2),v1); 
neq44 := k(k(k(v3,v0),v2),k(v3,v2)); 
neq45 := k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),v1); 
neq46 := k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),k(v3,v0)); 
neq47 := k(k(k(k(v3,v2),v1),k(v2,k(v0,v1))),k(v3,v2)); 
neq48 := k(k(v2,k(v0,v1)),v1); 
neq49 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v3),k(k(v3,v0),v2))); 
...
phi := 
       ...
       d(k(k(k(v3,v2),v3),k(k(v3,v0),v2)),k(k(k(v3,v2),v1),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
