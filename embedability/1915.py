...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_7-(x_5*y_10-y_5*x_10)*y_7)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_7-(y_5*z_10-z_5*y_10)*z_7)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_7-(z_5*x_10-x_5*z_10)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
