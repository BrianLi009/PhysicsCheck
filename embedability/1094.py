...
def test_embed(): 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_0-(x_5*y_13-y_5*x_13)*y_0)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_0-(y_5*z_13-z_5*y_13)*z_0)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_0-(z_5*x_13-x_5*z_13)*x_0)==0) 
