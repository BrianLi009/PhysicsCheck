...
def test_embed(): 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_9-(x_7*y_13-y_7*x_13)*y_9)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_9-(y_7*z_13-z_7*y_13)*z_9)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_9-(z_7*x_13-x_7*z_13)*x_9)==0) 
