...
neq3 := k(v2,k(v0,v1)); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq6 := k(v2,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq7 := k(v2,k(v3,k(v0,v1))); 
neq8 := k(v2,k(k(k(v3,v2),v3),v1)); 
neq9 := k(k(k(v3,v2),v2),v3); 
neq10 := k(k(k(v3,v2),v2),k(k(v3,v2),v3)); 
neq11 := k(k(k(v3,v2),v2),v0); 
neq12 := k(k(k(v3,v2),v2),k(v0,v1)); 
neq13 := k(k(k(v3,v2),v2),v1); 
neq14 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq15 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v3),v1),v2)); 
neq16 := k(k(k(v3,v2),v2),k(v3,k(v0,v1))); 
neq17 := k(k(k(v3,v2),v2),k(k(k(v3,v2),v3),v1)); 
neq18 := k(v3,v0); 
neq19 := k(v3,k(v0,v1)); 
neq20 := k(v3,v1); 
neq21 := k(v3,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq22 := k(v3,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
...
neq28 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq29 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq30 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),v1),v2)); 
neq31 := k(k(k(v3,v2),v3),k(v3,k(v0,v1))); 
neq32 := k(v0,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq33 := k(v0,k(k(k(k(v3,v2),v3),v1),v2)); 
neq34 := k(v0,k(v3,k(v0,v1))); 
neq35 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq36 := k(v0,k(v3,v2)); 
neq37 := k(k(v0,v1),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq38 := k(k(v0,v1),k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq39 := k(k(v0,v1),k(k(k(k(v3,v2),v3),v1),v2)); 
neq40 := k(k(v0,v1),k(k(k(v3,v2),v3),v1)); 
neq41 := k(k(v0,v1),k(v3,v2)); 
neq42 := k(v1,k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)); 
neq43 := k(v1,k(k(k(v3,v2),v2),k(v3,k(v0,v1)))); 
neq44 := k(v1,k(k(k(k(v3,v2),v3),v1),v2)); 
neq45 := k(v1,k(v3,k(v0,v1))); 
neq46 := k(v1,k(v3,v2)); 
neq47 := k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0),k(v3,k(v0,v1))); 
neq48 := k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0),k(k(k(v3,v2),v3),v1)); 
neq49 := k(k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0),k(v3,v2)); 
neq50 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(k(k(v3,v2),v3),v1),v2)); 
neq51 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(k(k(v3,v2),v3),v1)); 
neq52 := k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),k(v3,v2)); 
neq53 := k(k(k(k(k(v3,v2),v3),v1),v2),k(v3,k(v0,v1))); 
neq54 := k(k(k(k(k(v3,v2),v3),v1),v2),k(v3,v2)); 
neq55 := k(k(v3,k(v0,v1)),k(k(k(v3,v2),v3),v1)); 
neq56 := k(k(v3,k(v0,v1)),k(v3,v2)); 
...
phi := 
       ...
       d(k(k(k(k(v3,v2),v3),v1),v2),k(k(k(k(v3,v2),v2),k(v3,k(v0,v1))),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
