...
def test_embed(): 
    ...
    s.add(((z_4*x_13-x_4*z_13)*z_6-(x_4*y_13-y_4*x_13)*y_6)==0) 
    s.add(((x_4*y_13-y_4*x_13)*x_6-(y_4*z_13-z_4*y_13)*z_6)==0) 
    s.add(((y_4*z_13-z_4*y_13)*y_6-(z_4*x_13-x_4*z_13)*x_6)==0) 
