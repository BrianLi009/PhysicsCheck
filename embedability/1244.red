...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq1 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(v0,v1)); 
neq2 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),v0); 
neq3 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq4 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),v2); 
neq5 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))); 
neq6 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(k(v2,v0),v2),v1)); 
neq7 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)); 
neq8 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(v2,v0)); 
neq9 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(v2,k(v0,v1))); 
neq10 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v0,v1)); 
neq11 := k(k(k(k(k(v2,v0),v2),v1),v1),v0); 
neq12 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq13 := k(k(k(k(k(v2,v0),v2),v1),v1),v2); 
neq14 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2))); 
neq15 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq16 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v2)); 
neq17 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)); 
neq18 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))); 
neq19 := k(k(v0,v1),k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq20 := k(k(v0,v1),v2); 
neq21 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))); 
neq22 := k(k(v0,v1),k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2))); 
neq23 := k(k(v0,v1),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq24 := k(k(v0,v1),k(k(k(v2,v0),v2),v1)); 
neq25 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq26 := k(k(v0,v1),k(v2,v0)); 
neq27 := k(v0,k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1)))); 
neq28 := k(v0,v2); 
neq29 := k(v0,k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))); 
neq30 := k(v0,k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2))); 
neq31 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq32 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq33 := k(v0,k(k(v2,v0),v2)); 
neq34 := k(v0,k(v2,k(v0,v1))); 
neq35 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),v2); 
neq36 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))); 
neq37 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2))); 
neq38 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(k(v2,v0),v2)); 
neq39 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)); 
neq40 := k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),v1); 
neq41 := k(v2,k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))); 
neq42 := k(v2,k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2))); 
neq43 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq44 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq45 := k(v2,v1); 
neq46 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq47 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))),k(k(k(v2,v0),v2),v1)); 
neq48 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))),k(k(v2,v0),v2)); 
neq49 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))),k(v2,v0)); 
neq50 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1))),v1); 
neq51 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0))); 
neq52 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),k(k(k(v2,v0),v2),v1)); 
neq53 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),k(v2,v0)); 
neq54 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),k(v2,k(v0,v1))); 
neq55 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),v1); 
neq56 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq57 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(k(v2,v0),v2)); 
neq58 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),k(v2,k(v0,v1))); 
neq59 := k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1); 
neq60 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq61 := k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))); 
neq62 := k(k(k(v2,v0),v2),k(v2,k(v0,v1))); 
...
phi := 
       ...
       d(k(k(k(k(k(k(k(v2,v0),v2),v1),k(v2,k(v0,v1))),k(v2,v0)),v1),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
