...
neq26 := k(k(k(k(v3,v2),v1),k(v3,v2)),k(v3,k(k(v2,v0),v2))); 
neq27 := k(k(k(k(v3,v2),v1),k(v3,v2)),v1); 
neq28 := k(v3,k(k(v3,k(k(v2,v0),v2)),v1)); 
neq29 := k(v3,v0); 
neq30 := k(v3,k(k(v2,v0),v2)); 
neq31 := k(v3,k(v2,v0)); 
neq32 := k(v3,k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq33 := k(v3,k(k(k(v3,v2),v3),v0)); 
neq34 := k(v3,v1); 
neq35 := k(k(k(v3,v2),v3),k(k(v3,k(k(v2,v0),v2)),v1)); 
neq36 := k(k(k(v3,v2),v3),v0); 
neq37 := k(k(k(v3,v2),v3),k(k(v2,v0),v2)); 
neq38 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq39 := k(k(k(v3,v2),v3),k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq40 := k(k(k(v3,v2),v3),k(v3,k(k(v2,v0),v2))); 
neq41 := k(k(k(v3,v2),v3),v1); 
neq42 := k(k(k(v3,k(k(v2,v0),v2)),v1),v0); 
neq43 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(v2,v0),v2)); 
neq44 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)); 
neq45 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v3),v0)); 
neq46 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(v3,v2)); 
neq47 := k(v0,k(k(v2,v0),v2)); 
neq48 := k(v0,k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq49 := k(v0,k(v3,k(k(v2,v0),v2))); 
neq50 := k(v0,k(v3,v2)); 
neq51 := k(k(k(v2,v0),v2),k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq52 := k(k(k(v2,v0),v2),k(k(k(v3,v2),v3),v0)); 
neq53 := k(k(k(v2,v0),v2),v1); 
neq54 := k(k(k(v2,v0),v2),k(v3,v2)); 
neq55 := k(k(v2,v0),k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))); 
neq56 := k(k(v2,v0),k(k(k(v3,v2),v3),v0)); 
neq57 := k(k(v2,v0),k(v3,k(k(v2,v0),v2))); 
neq58 := k(k(v2,v0),v1); 
neq59 := k(k(v2,v0),k(v3,v2)); 
neq60 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2))),k(v3,k(k(v2,v0),v2))); 
neq61 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2))),v1); 
neq62 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2))),k(v3,v2)); 
neq63 := k(k(k(k(v3,v2),v3),v0),k(v3,k(k(v2,v0),v2))); 
neq64 := k(k(k(k(v3,v2),v3),v0),v1); 
neq65 := k(k(k(k(v3,v2),v3),v0),k(v3,v2)); 
neq66 := k(k(v3,k(k(v2,v0),v2)),v1); 
neq67 := k(k(v3,k(k(v2,v0),v2)),k(v3,v2)); 
neq68 := k(v1,k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,v2),v3),v0),k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,v2),v1),k(v3,v2)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
