...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq1 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)); 
neq2 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),k(v0,v1))); 
neq3 := k(k(k(v2,v1),v1),v0); 
neq4 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
...
neq10 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq11 := k(k(v2,k(v0,v1)),v0); 
neq12 := k(k(v2,k(v0,v1)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq13 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq14 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq15 := k(k(v2,k(v0,v1)),v1); 
neq16 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq17 := k(k(k(k(v2,v1),v2),v0),k(k(k(v2,v1),v2),k(v0,v1))); 
neq18 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq19 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq20 := k(k(k(k(v2,v1),v2),v0),v2); 
neq21 := k(k(k(k(v2,v1),v2),v0),v1); 
neq22 := k(k(k(k(v2,v1),v2),v0),k(k(v2,k(v0,v1)),v2)); 
neq23 := k(k(k(k(v2,v1),v2),v0),k(v0,v1)); 
neq24 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq25 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v2,v1)); 
neq26 := k(k(k(k(v2,v1),v2),k(v0,v1)),v2); 
neq27 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq28 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
neq29 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq30 := k(v0,k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))); 
neq31 := k(v0,k(v2,v1)); 
neq32 := k(v0,v2); 
neq33 := k(v0,k(k(v2,v1),v2)); 
neq34 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq35 := k(v0,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq36 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),k(v2,v1)); 
neq37 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),v2); 
neq38 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v2)); 
neq39 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),v1); 
neq40 := k(k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq41 := k(k(v2,v1),k(k(v2,k(v0,v1)),v2)); 
neq42 := k(k(v2,v1),k(v0,v1)); 
neq43 := k(k(v2,v1),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq44 := k(v2,v1); 
neq45 := k(v2,k(v0,v1)); 
neq46 := k(v2,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq47 := k(k(k(v2,v1),v2),v1); 
neq48 := k(k(k(v2,v1),v2),k(k(v2,k(v0,v1)),v2)); 
neq49 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq50 := k(k(k(v2,v1),v2),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq51 := k(v1,k(k(v2,k(v0,v1)),v2)); 
neq52 := k(v1,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq53 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq54 := k(k(v0,v1),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(k(k(v2,v1),v2),v0)) = 0 and 
       d(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,k(v0,v1)),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
