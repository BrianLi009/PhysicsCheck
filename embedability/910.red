...
v3c2 := 0;
neq0 := k(k(v0,v1),v2); 
neq1 := k(k(v0,v1),k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1)))); 
neq2 := k(k(v0,v1),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq3 := k(k(v0,v1),k(v3,k(v2,k(v0,v1)))); 
neq4 := k(k(v0,v1),k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2))); 
neq5 := k(k(v0,v1),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq6 := k(k(v0,v1),k(v3,v2)); 
neq7 := k(k(v0,v1),v3); 
neq8 := k(k(v0,v1),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq9 := k(k(v0,v1),k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq10 := k(v2,k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1)))); 
neq11 := k(v2,k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq12 := k(v2,k(v3,k(v2,k(v0,v1)))); 
neq13 := k(v2,k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2))); 
neq14 := k(v2,v0); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq17 := k(v2,k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq18 := k(v2,v1); 
neq19 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1)))); 
neq20 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(v3,k(v2,k(v0,v1)))); 
neq21 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),v0); 
neq22 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq23 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(v3,v2)); 
neq24 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),v3); 
neq25 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq26 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),v1); 
neq27 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2))); 
neq28 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0); 
neq29 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq30 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(v3,v2)); 
neq31 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v3); 
neq32 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq33 := k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v1); 
neq34 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2))); 
neq35 := k(k(v3,k(v2,k(v0,v1))),v0); 
neq36 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq37 := k(k(v3,k(v2,k(v0,v1))),k(v3,v2)); 
neq38 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq39 := k(k(v3,k(v2,k(v0,v1))),k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq40 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq41 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),v0); 
neq42 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq43 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),v3); 
neq44 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq45 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),v1); 
neq46 := k(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2)),k(v2,k(v0,v1))); 
neq47 := k(v0,k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2)); 
neq48 := k(v0,k(v3,v2)); 
neq49 := k(v0,v3); 
neq50 := k(v0,k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq51 := k(v0,k(v2,k(v0,v1))); 
neq52 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),k(v3,v2)); 
neq53 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v3); 
neq54 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1); 
neq55 := k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),k(v2,k(v0,v1))); 
neq56 := k(k(v3,v2),k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq57 := k(k(v3,v2),k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq58 := k(k(v3,v2),v1); 
neq59 := k(k(v3,v2),k(v2,k(v0,v1))); 
neq60 := k(v3,k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0)); 
neq61 := k(v3,k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq62 := k(v3,k(v2,k(v0,v1))); 
neq63 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1)); 
neq64 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v1); 
neq65 := k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),k(v2,k(v0,v1))); 
neq66 := k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v2,k(v0,v1))),k(k(k(k(k(k(v3,k(v2,k(v0,v1))),k(v2,k(v0,v1))),v0),v2),v1),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
