...
def test_embed(): 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_11-(x_12*y_13-y_12*x_13)*y_11)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_11-(y_12*z_13-z_12*y_13)*z_11)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_11-(z_12*x_13-x_12*z_13)*x_11)==0) 
    ...
    s.add(((z_0*x_4-x_0*z_4)*z_9-(x_0*y_4-y_0*x_4)*y_9)==0) 
    s.add(((x_0*y_4-y_0*x_4)*x_9-(y_0*z_4-z_0*y_4)*z_9)==0) 
    s.add(((y_0*z_4-z_0*y_4)*y_9-(z_0*x_4-x_0*z_4)*x_9)==0) 
    s.add(((z_1*x_10-x_1*z_10)*z_5-(x_1*y_10-y_1*x_10)*y_5)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_5-(y_1*z_10-z_1*y_10)*z_5)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_5-(z_1*x_10-x_1*z_10)*x_5)==0) 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_3-(x_8*y_10-y_8*x_10)*y_3)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_3-(y_8*z_10-z_8*y_10)*z_3)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_3-(z_8*x_10-x_8*z_10)*x_3)==0) 
    s.add(((z_3*x_12-x_3*z_12)*z_6-(x_3*y_12-y_3*x_12)*y_6)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_6-(y_3*z_12-z_3*y_12)*z_6)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_6-(z_3*x_12-x_3*z_12)*x_6)==0) 
    s.add(((z_5*x_6-x_5*z_6)*z_7-(x_5*y_6-y_5*x_6)*y_7)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_7-(y_5*z_6-z_5*y_6)*z_7)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_7-(z_5*x_6-x_5*z_6)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
