...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_10-(x_9*y_13-y_9*x_13)*y_10)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_10-(y_9*z_13-z_9*y_13)*z_10)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_10-(z_9*x_13-x_9*z_13)*x_10)==0) 
    ...
    s.add(((z_9*x_12-x_9*z_12)*z_3-(x_9*y_12-y_9*x_12)*y_3)==0) 
    s.add(((x_9*y_12-y_9*x_12)*x_3-(y_9*z_12-z_9*y_12)*z_3)==0) 
    s.add(((y_9*z_12-z_9*y_12)*y_3-(z_9*x_12-x_9*z_12)*x_3)==0) 
    ...
    s.add(((z_10*x_12-x_10*z_12)*z_4-(x_10*y_12-y_10*x_12)*y_4)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_4-(y_10*z_12-z_10*y_12)*z_4)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_4-(z_10*x_12-x_10*z_12)*x_4)==0) 
    s.add(((z_4*x_8-x_4*z_8)*z_5-(x_4*y_8-y_4*x_8)*y_5)==0) 
    s.add(((x_4*y_8-y_4*x_8)*x_5-(y_4*z_8-z_4*y_8)*z_5)==0) 
    s.add(((y_4*z_8-z_4*y_8)*y_5-(z_4*x_8-x_4*z_8)*x_5)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
