...
def test_embed(): 
    ...
    s.add(((z_8*x_9-x_8*z_9)*z_0-(x_8*y_9-y_8*x_9)*y_0)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_0-(y_8*z_9-z_8*y_9)*z_0)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_0-(z_8*x_9-x_8*z_9)*x_0)==0) 
    ...
    s.add(((z_3*x_9-x_3*z_9)*z_7-(x_3*y_9-y_3*x_9)*y_7)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_7-(y_3*z_9-z_3*y_9)*z_7)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_7-(z_3*x_9-x_3*z_9)*x_7)==0) 
