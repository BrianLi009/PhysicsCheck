...
def test_embed(): 
    ...
    s.add(((z_2*x_10-x_2*z_10)*z_11-(x_2*y_10-y_2*x_10)*y_11)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_11-(y_2*z_10-z_2*y_10)*z_11)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_11-(z_2*x_10-x_2*z_10)*x_11)==0) 
