...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(v3,v0),v2)); 
neq2 := k(v0,k(k(k(v3,k(v2,v0)),v3),v2)); 
neq3 := k(v0,v3); 
neq4 := k(v0,k(k(v3,k(v2,v0)),v3)); 
neq5 := k(v0,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq6 := k(v0,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq7 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq8 := k(v0,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq9 := k(v0,k(v3,k(v2,v0))); 
neq10 := k(k(v3,v0),v2); 
neq11 := k(k(v3,v0),k(k(k(v3,k(v2,v0)),v3),v2)); 
neq12 := k(k(v3,v0),v1); 
neq13 := k(k(v3,v0),k(v2,v0)); 
neq14 := k(k(v3,v0),k(k(v3,k(v2,v0)),v3)); 
neq15 := k(k(v3,v0),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq16 := k(k(v3,v0),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq17 := k(k(v3,v0),k(k(v3,k(v2,v0)),v1)); 
neq18 := k(k(v3,v0),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq19 := k(k(v3,v0),k(v3,k(v2,v0))); 
neq20 := k(v2,v1); 
neq21 := k(v2,v3); 
neq22 := k(v2,k(k(v3,k(v2,v0)),v3)); 
neq23 := k(v2,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq24 := k(v2,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq25 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq26 := k(v2,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq27 := k(v2,k(v3,k(v2,v0))); 
neq28 := k(k(k(v3,v0),v2),k(k(k(v3,k(v2,v0)),v3),v2)); 
neq29 := k(k(k(v3,v0),v2),v1); 
neq30 := k(k(k(v3,v0),v2),k(v2,v0)); 
neq31 := k(k(k(v3,v0),v2),v3); 
neq32 := k(k(k(v3,v0),v2),k(k(v3,k(v2,v0)),v3)); 
neq33 := k(k(k(v3,v0),v2),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq34 := k(k(k(v3,v0),v2),k(k(v3,k(v2,v0)),v1)); 
neq35 := k(k(k(v3,v0),v2),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq36 := k(k(k(v3,v0),v2),k(v3,k(v2,v0))); 
neq37 := k(k(k(k(v3,k(v2,v0)),v3),v2),v1); 
neq38 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(v2,v0)); 
neq39 := k(k(k(k(v3,k(v2,v0)),v3),v2),v3); 
neq40 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq41 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(v3,k(v2,v0)),v1)); 
neq42 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq43 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(v3,k(v2,v0))); 
neq44 := k(v1,k(v2,v0)); 
neq45 := k(v1,v3); 
neq46 := k(v1,k(k(v3,k(v2,v0)),v3)); 
neq47 := k(v1,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq48 := k(v1,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq49 := k(v1,k(v3,k(v2,v0))); 
neq50 := k(k(v2,v0),v3); 
neq51 := k(k(v2,v0),k(k(v3,k(v2,v0)),v3)); 
neq52 := k(k(v2,v0),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq53 := k(k(v2,v0),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq54 := k(k(v2,v0),k(k(v3,k(v2,v0)),v1)); 
neq55 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq56 := k(v3,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq57 := k(v3,k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq58 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq59 := k(v3,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq60 := k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))); 
neq61 := k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2))); 
neq62 := k(k(k(v3,k(v2,v0)),v3),k(k(v3,k(v2,v0)),v1)); 
neq63 := k(k(k(v3,k(v2,v0)),v3),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq64 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2)),k(k(v3,k(v2,v0)),v1)); 
neq65 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2)),k(v3,k(v2,v0))); 
neq66 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2)),k(k(v3,k(v2,v0)),v1)); 
neq67 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2)),k(v3,k(v2,v0))); 
neq68 := k(k(k(k(v3,k(v2,v0)),v1),v1),k(v3,k(v2,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),v2)),k(k(k(k(v3,k(v2,v0)),v1),v1),k(k(v3,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
