...
def test_embed(): 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_10-(x_5*y_13-y_5*x_13)*y_10)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_10-(y_5*z_13-z_5*y_13)*z_10)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_10-(z_5*x_13-x_5*z_13)*x_10)==0) 
