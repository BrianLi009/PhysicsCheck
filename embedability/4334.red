...
neq2 := k(v2,v0); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1))); 
neq5 := k(v2,k(v3,v0)); 
neq6 := k(v2,k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq7 := k(v2,k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq8 := k(v2,k(k(v3,v0),k(k(v2,v0),v2))); 
neq9 := k(v2,k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq10 := k(k(v2,v0),k(v3,v1)); 
neq11 := k(k(v2,v0),v3); 
neq12 := k(k(v2,v0),k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2)); 
neq13 := k(k(v2,v0),v1); 
neq14 := k(k(v2,v0),k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1))); 
neq15 := k(k(v2,v0),k(v3,v0)); 
neq16 := k(k(v2,v0),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq17 := k(k(v2,v0),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq18 := k(k(v2,v0),k(k(v3,v0),k(k(v2,v0),v2))); 
neq19 := k(k(v2,v0),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq20 := k(k(v3,v1),v0); 
neq21 := k(k(v3,v1),k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2)); 
neq22 := k(k(v3,v1),k(v3,v0)); 
neq23 := k(k(v3,v1),k(k(v2,v0),v2)); 
neq24 := k(k(v3,v1),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq25 := k(k(v3,v1),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq26 := k(k(v3,v1),k(k(v3,v0),k(k(v2,v0),v2))); 
neq27 := k(k(v3,v1),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq28 := k(v3,v0); 
neq29 := k(v3,k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2)); 
neq30 := k(v3,v1); 
neq31 := k(v3,k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1))); 
neq32 := k(v3,k(k(v2,v0),v2)); 
neq33 := k(v3,k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq34 := k(v3,k(k(v3,v0),k(k(v2,v0),v2))); 
neq35 := k(v3,k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq36 := k(v0,k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2)); 
neq37 := k(v0,k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1))); 
neq38 := k(v0,k(k(v2,v0),v2)); 
neq39 := k(v0,k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq40 := k(v0,k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq41 := k(v0,k(k(v3,v0),k(k(v2,v0),v2))); 
neq42 := k(v0,k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq43 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),v1); 
neq44 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(v3,v0)); 
neq45 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(v2,v0),v2)); 
neq46 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq47 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(v3,v0),k(k(v2,v0),v2))); 
neq48 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq49 := k(v1,k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1))); 
neq50 := k(v1,k(v3,v0)); 
neq51 := k(v1,k(k(v2,v0),v2)); 
neq52 := k(v1,k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq53 := k(v1,k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq54 := k(v1,k(k(v3,v0),k(k(v2,v0),v2))); 
neq55 := k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),k(v3,v0)); 
neq56 := k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),k(k(v2,v0),v2)); 
neq57 := k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq58 := k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq59 := k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq60 := k(k(v3,v0),k(k(v2,v0),v2)); 
neq61 := k(k(v3,v0),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq62 := k(k(v3,v0),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq63 := k(k(v3,v0),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq64 := k(k(k(v2,v0),v2),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))); 
neq65 := k(k(k(v2,v0),v2),k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3)); 
neq66 := k(k(k(v2,v0),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)); 
neq67 := k(k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1)),k(k(v3,v0),k(k(v2,v0),v2))); 
neq68 := k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3),k(k(v3,v0),k(k(v2,v0),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,v0),k(k(v2,v0),v2)),v1),v3),k(k(k(k(k(v3,v0),k(k(v2,v0),v2)),k(v3,v1)),v2),k(k(k(v3,v0),k(k(v2,v0),v2)),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
