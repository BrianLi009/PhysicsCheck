...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),v2); 
neq1 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(k(k(v3,v2),v0),v0)); 
neq2 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),v0); 
neq3 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),v1); 
neq4 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(v3,v2)); 
neq5 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq6 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(k(v3,v2),v0)); 
neq7 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(v3,v1)); 
neq8 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3),k(k(v3,v1),k(k(v3,v2),v0))); 
neq9 := k(v2,k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0))); 
neq10 := k(v2,k(k(k(v3,v2),v0),v0)); 
neq11 := k(v2,v0); 
neq12 := k(v2,v3); 
neq13 := k(v2,k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq14 := k(v2,k(k(v3,v2),v0)); 
neq15 := k(v2,k(v3,v1)); 
neq16 := k(v2,k(k(v3,v1),k(k(v3,v2),v0))); 
neq17 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(k(k(v3,v1),k(k(v3,v2),v0)),v2)); 
neq18 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),v0); 
neq19 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),v3); 
neq20 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),v1); 
neq21 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(v3,v2)); 
neq22 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(k(v3,v2),v0)); 
neq23 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(v3,v1)); 
neq24 := k(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(k(v3,v1),k(k(v3,v2),v0))); 
neq25 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),k(k(k(v3,v2),v0),v0)); 
neq26 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v0); 
neq27 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3); 
neq28 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v1); 
neq29 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),k(v3,v2)); 
neq30 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq31 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),k(k(v3,v2),v0)); 
neq32 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),k(v3,v1)); 
neq33 := k(k(k(k(v3,v2),v0),v0),v3); 
neq34 := k(k(k(k(v3,v2),v0),v0),v1); 
neq35 := k(k(k(k(v3,v2),v0),v0),k(v3,v2)); 
neq36 := k(k(k(k(v3,v2),v0),v0),k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq37 := k(k(k(k(v3,v2),v0),v0),k(v3,v1)); 
neq38 := k(k(k(k(v3,v2),v0),v0),k(k(v3,v1),k(k(v3,v2),v0))); 
neq39 := k(v0,v3); 
neq40 := k(v0,k(v3,v2)); 
neq41 := k(v0,k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq42 := k(v0,k(v3,v1)); 
neq43 := k(v0,k(k(v3,v1),k(k(v3,v2),v0))); 
neq44 := k(v3,v1); 
neq45 := k(v3,k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq46 := k(v3,k(k(v3,v2),v0)); 
neq47 := k(v3,k(k(v3,v1),k(k(v3,v2),v0))); 
neq48 := k(v1,k(v3,v2)); 
neq49 := k(v1,k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq50 := k(v1,k(k(v3,v2),v0)); 
neq51 := k(v1,k(k(v3,v1),k(k(v3,v2),v0))); 
neq52 := k(k(v3,v2),k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1))); 
neq53 := k(k(v3,v2),k(v3,v1)); 
neq54 := k(k(v3,v2),k(k(v3,v1),k(k(v3,v2),v0))); 
neq55 := k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(v3,v2),v0)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,v1),k(k(v3,v2),v0)),k(v3,v1)),k(k(k(v3,v2),v0),v0)),k(k(k(k(v3,v1),k(k(v3,v2),v0)),v2),v3)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
