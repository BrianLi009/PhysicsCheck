...
v2c2 := 0;
neq0 := k(v2,v3); 
neq1 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3)); 
neq2 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1))); 
neq3 := k(v2,v0); 
...
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(v2,v1),v3); 
neq11 := k(k(v2,v1),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3)); 
neq12 := k(k(v2,v1),k(v3,v2)); 
neq13 := k(k(v2,v1),v0); 
neq14 := k(k(v2,v1),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq15 := k(k(v2,v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq16 := k(k(v2,v1),k(k(k(v3,v2),v3),v0)); 
neq17 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq18 := k(k(v2,v1),k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0))); 
neq19 := k(k(v2,v1),k(v0,v1)); 
neq20 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1))); 
neq21 := k(v3,v0); 
neq22 := k(v3,k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq23 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq24 := k(v3,k(k(k(v3,v2),v3),v0)); 
neq25 := k(v3,k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0))); 
neq26 := k(v3,v1); 
neq27 := k(v3,k(v0,v1)); 
neq28 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(v3,v2)); 
neq29 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),v0); 
neq30 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq31 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(k(k(v3,v2),v3),k(v0,v1))); 
neq32 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(k(k(v3,v2),v3),v0)); 
neq33 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(k(v3,v2),v3)); 
neq34 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),v1); 
neq35 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3),k(v0,v1)); 
neq36 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1))); 
neq37 := k(k(v3,v2),v0); 
neq38 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq39 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq40 := k(k(v3,v2),k(k(k(v3,v2),v3),v0)); 
neq41 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0))); 
neq42 := k(k(v3,v2),v1); 
neq43 := k(k(v3,v2),k(v0,v1)); 
neq44 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),v0); 
neq45 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1))); 
neq46 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(k(k(v3,v2),v3),k(v0,v1))); 
neq47 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(k(k(v3,v2),v3),v0)); 
neq48 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(k(v3,v2),v3)); 
neq49 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),v1); 
neq50 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(v0,v1)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),k(v2,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v2),v3),v0)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
