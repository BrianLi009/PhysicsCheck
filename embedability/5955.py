...
def test_embed(): 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_10-(x_12*y_13-y_12*x_13)*y_10)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_10-(y_12*z_13-z_12*y_13)*z_10)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_10-(z_12*x_13-x_12*z_13)*x_10)==0) 
