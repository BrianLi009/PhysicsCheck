...
neq3 := k(k(k(v3,v2),v0),k(v3,k(v2,v0))); 
neq4 := k(k(k(v3,v2),v0),k(v3,v1)); 
neq5 := k(k(k(v3,v2),v0),k(v2,v0)); 
neq6 := k(k(k(v3,v2),v0),v1); 
neq7 := k(k(k(v3,v2),v0),k(k(v3,v1),v2)); 
neq8 := k(k(k(v3,v2),v0),k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq9 := k(v2,k(k(v3,v2),v1)); 
neq10 := k(v2,v3); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(v3,v2),v0),k(k(v3,v1),v2))); 
neq13 := k(v2,k(v3,k(v2,v0))); 
neq14 := k(v2,k(v3,v1)); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq17 := k(k(k(v3,v2),v1),v3); 
neq18 := k(k(k(v3,v2),v1),v0); 
neq19 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v0),k(k(v3,v1),v2))); 
neq20 := k(k(k(v3,v2),v1),k(v3,k(v2,v0))); 
neq21 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq22 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq23 := k(k(k(v3,v2),v1),k(k(v3,v1),v2)); 
neq24 := k(v3,v0); 
neq25 := k(v3,k(k(k(v3,v2),v0),k(k(v3,v1),v2))); 
neq26 := k(v3,k(v2,v0)); 
neq27 := k(v3,v1); 
neq28 := k(v3,k(k(v3,v1),v2)); 
neq29 := k(v3,k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq30 := k(v0,k(k(k(v3,v2),v0),k(k(v3,v1),v2))); 
neq31 := k(v0,k(v3,k(v2,v0))); 
neq32 := k(v0,k(v3,v1)); 
neq33 := k(v0,k(k(v3,v1),v2)); 
neq34 := k(v0,k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(k(k(v3,v2),v0),k(k(v3,v1),v2)),k(v3,k(v2,v0))); 
neq37 := k(k(k(k(v3,v2),v0),k(k(v3,v1),v2)),k(v3,v1)); 
neq38 := k(k(k(k(v3,v2),v0),k(k(v3,v1),v2)),k(v2,v0)); 
neq39 := k(k(k(k(v3,v2),v0),k(k(v3,v1),v2)),v1); 
neq40 := k(k(k(k(v3,v2),v0),k(k(v3,v1),v2)),k(v3,v2)); 
neq41 := k(k(v3,k(v2,v0)),k(v3,v1)); 
neq42 := k(k(v3,k(v2,v0)),v1); 
neq43 := k(k(v3,k(v2,v0)),k(k(v3,v1),v2)); 
neq44 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq45 := k(k(v3,v1),k(v2,v0)); 
neq46 := k(k(v3,v1),k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq47 := k(k(v3,v1),k(v3,v2)); 
neq48 := k(k(v2,v0),v1); 
neq49 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq50 := k(k(v2,v0),k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq51 := k(k(v2,v0),k(v3,v2)); 
neq52 := k(v1,k(k(v3,v1),v2)); 
neq53 := k(v1,k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq54 := k(v1,k(v3,v2)); 
neq55 := k(k(k(v3,v1),v2),k(k(k(v3,v2),v1),k(v3,k(v2,v0)))); 
neq56 := k(k(k(v3,v1),v2),k(v3,v2)); 
neq57 := k(k(k(k(v3,v2),v1),k(v3,k(v2,v0))),k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,v2),v1),k(v3,k(v2,v0))),k(k(k(v3,v2),v0),k(k(v3,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
