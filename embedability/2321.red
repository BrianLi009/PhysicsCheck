...
neq9 := k(v2,k(v0,v1)); 
neq10 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(v3,v2),k(v0,v1))); 
neq11 := k(k(k(k(v3,v2),v0),k(v3,v2)),v3); 
neq12 := k(k(k(k(v3,v2),v0),k(v3,v2)),v0); 
neq13 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(v3,v1)); 
neq14 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(v3,k(v0,v1)),v2),k(v3,v1))); 
neq15 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(v3,k(v0,v1))); 
neq16 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(v0,v1)); 
neq17 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(v3,k(v0,v1)),v2)); 
neq18 := k(k(k(k(v3,v2),v0),k(v3,v2)),v1); 
neq19 := k(k(k(v3,v2),v0),k(k(v3,v2),k(v0,v1))); 
neq20 := k(k(k(v3,v2),v0),v3); 
neq21 := k(k(k(v3,v2),v0),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq22 := k(k(k(v3,v2),v0),k(v3,v1)); 
neq23 := k(k(k(v3,v2),v0),k(k(k(v3,k(v0,v1)),v2),k(v3,v1))); 
neq24 := k(k(k(v3,v2),v0),k(v3,k(v0,v1))); 
neq25 := k(k(k(v3,v2),v0),k(v0,v1)); 
neq26 := k(k(k(v3,v2),v0),k(k(v3,k(v0,v1)),v2)); 
neq27 := k(k(k(v3,v2),v0),v1); 
neq28 := k(k(k(v3,v2),k(v0,v1)),v3); 
neq29 := k(k(k(v3,v2),k(v0,v1)),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq30 := k(k(k(v3,v2),k(v0,v1)),v0); 
neq31 := k(k(k(v3,v2),k(v0,v1)),k(v3,v1)); 
neq32 := k(k(k(v3,v2),k(v0,v1)),k(v3,k(v0,v1))); 
neq33 := k(k(k(v3,v2),k(v0,v1)),k(k(v3,k(v0,v1)),v2)); 
neq34 := k(k(k(v3,v2),k(v0,v1)),v1); 
neq35 := k(v3,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq36 := k(v3,v0); 
neq37 := k(v3,k(k(k(v3,k(v0,v1)),v2),k(v3,v1))); 
neq38 := k(v3,k(v0,v1)); 
neq39 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq40 := k(v3,v1); 
neq41 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0); 
neq42 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v1)); 
neq43 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(k(k(v3,k(v0,v1)),v2),k(v3,v1))); 
...
neq47 := k(v0,k(v3,v1)); 
neq48 := k(v0,k(k(k(v3,k(v0,v1)),v2),k(v3,v1))); 
neq49 := k(v0,k(v3,k(v0,v1))); 
neq50 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq51 := k(v0,k(v3,v2)); 
neq52 := k(k(v3,v1),k(v3,k(v0,v1))); 
neq53 := k(k(v3,v1),k(v0,v1)); 
neq54 := k(k(v3,v1),k(k(v3,k(v0,v1)),v2)); 
neq55 := k(k(v3,v1),k(v3,v2)); 
neq56 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,v1)),k(v3,k(v0,v1))); 
neq57 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,v1)),k(v0,v1)); 
neq58 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,v1)),v1); 
neq59 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,v1)),k(v3,v2)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(v3,k(v0,v1)),v2),k(v3,v1)),k(k(v3,v2),k(v0,v1))) = 0 and 
       d(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
