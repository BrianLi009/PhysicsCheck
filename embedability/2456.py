...
def test_embed(): 
    ...
    s.add(((z_0*x_7-x_0*z_7)*z_11-(x_0*y_7-y_0*x_7)*y_11)==0) 
    s.add(((x_0*y_7-y_0*x_7)*x_11-(y_0*z_7-z_0*y_7)*z_11)==0) 
    s.add(((y_0*z_7-z_0*y_7)*y_11-(z_0*x_7-x_0*z_7)*x_11)==0) 
    s.add(((z_1*x_8-x_1*z_8)*z_12-(x_1*y_8-y_1*x_8)*y_12)==0) 
    s.add(((x_1*y_8-y_1*x_8)*x_12-(y_1*z_8-z_1*y_8)*z_12)==0) 
    s.add(((y_1*z_8-z_1*y_8)*y_12-(z_1*x_8-x_1*z_8)*x_12)==0) 
