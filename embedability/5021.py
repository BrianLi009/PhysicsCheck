...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_6-(x_7*y_12-y_7*x_12)*y_6)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_6-(y_7*z_12-z_7*y_12)*z_6)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_6-(z_7*x_12-x_7*z_12)*x_6)==0) 
