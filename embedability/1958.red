...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2))); 
neq1 := k(v2,k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq2 := k(v2,k(k(k(v3,k(v0,v1)),v2),v0)); 
neq3 := k(v2,k(v3,v1)); 
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,v0); 
neq6 := k(v2,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq7 := k(v2,v3); 
neq8 := k(v2,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq9 := k(v2,k(v3,k(v0,v1))); 
neq10 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1)))); 
neq11 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(v3,v1)); 
neq12 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(v0,v1)); 
neq13 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),v0); 
neq14 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(v3,v2)); 
neq15 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq16 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),v3); 
neq17 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(v3,k(v0,v1))); 
neq18 := k(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),v1); 
neq19 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(k(k(v3,k(v0,v1)),v2),v0)); 
neq20 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v1)); 
neq21 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v0,v1)); 
neq22 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v0); 
neq23 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)); 
neq24 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v3); 
neq25 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq26 := k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),v1); 
neq27 := k(k(k(k(v3,k(v0,v1)),v2),v0),k(v3,v1)); 
neq28 := k(k(k(k(v3,k(v0,v1)),v2),v0),k(v0,v1)); 
neq29 := k(k(k(k(v3,k(v0,v1)),v2),v0),k(v3,v2)); 
neq30 := k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq31 := k(k(k(k(v3,k(v0,v1)),v2),v0),v3); 
neq32 := k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
...
neq38 := k(k(v3,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq39 := k(k(v3,v1),k(v3,k(v0,v1))); 
neq40 := k(k(v3,v1),k(k(v3,k(v0,v1)),v2)); 
neq41 := k(k(v0,v1),k(v3,v2)); 
neq42 := k(k(v0,v1),k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq43 := k(k(v0,v1),v3); 
neq44 := k(k(v0,v1),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq45 := k(k(v0,v1),k(k(v3,k(v0,v1)),v2)); 
neq46 := k(v0,k(v3,v2)); 
neq47 := k(v0,k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2))); 
neq48 := k(v0,v3); 
neq49 := k(v0,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq50 := k(v0,k(v3,k(v0,v1))); 
neq51 := k(v0,k(k(v3,k(v0,v1)),v2)); 
neq52 := k(k(v3,v2),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq53 := k(k(v3,v2),k(v3,k(v0,v1))); 
neq54 := k(k(v3,v2),v1); 
neq55 := k(k(v3,v2),k(k(v3,k(v0,v1)),v2)); 
neq56 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),v3); 
neq57 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,k(v0,v1))); 
neq58 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),v1); 
neq59 := k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(k(v3,k(v0,v1)),v2)); 
neq60 := k(v3,k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))); 
neq61 := k(v3,v1); 
neq62 := k(v3,k(k(v3,k(v0,v1)),v2)); 
neq63 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1)),k(v3,k(v0,v1))); 
neq64 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1)),v1); 
neq65 := k(k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1)),k(k(v3,k(v0,v1)),v2)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,k(v0,v1)),v2),v0),k(k(v3,k(v0,v1)),v2)),k(k(k(k(k(v3,k(v0,v1)),v2),k(v3,k(v0,v1))),k(v3,v2)),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
