...
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v0,v2); 
neq1 := k(v0,k(v3,k(v2,v1))); 
neq2 := k(v0,k(v3,v1)); 
neq3 := k(v0,k(k(v3,v1),v2)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq6 := k(v0,k(k(v3,v0),v2)); 
neq7 := k(v0,k(v2,v1)); 
neq8 := k(v1,k(k(k(v3,v1),v2),v0)); 
neq9 := k(v1,k(v3,v0)); 
neq10 := k(v1,v2); 
neq11 := k(v1,k(v3,k(v2,v1))); 
neq12 := k(v1,k(k(v3,v1),v2)); 
neq13 := k(v1,v3); 
neq14 := k(v1,k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq15 := k(v1,k(k(v3,v0),v2)); 
neq16 := k(k(k(k(v3,v1),v2),v0),k(v3,v0)); 
neq17 := k(k(k(k(v3,v1),v2),v0),v2); 
neq18 := k(k(k(k(v3,v1),v2),v0),k(v3,k(v2,v1))); 
neq19 := k(k(k(k(v3,v1),v2),v0),k(v3,v1)); 
neq20 := k(k(k(k(v3,v1),v2),v0),v3); 
neq21 := k(k(k(k(v3,v1),v2),v0),k(k(v3,v0),v2)); 
neq22 := k(k(k(k(v3,v1),v2),v0),k(v2,v1)); 
neq23 := k(k(v3,v0),v2); 
neq24 := k(k(v3,v0),k(v3,k(v2,v1))); 
neq25 := k(k(v3,v0),k(v3,v1)); 
neq26 := k(k(v3,v0),k(k(v3,v1),v2)); 
neq27 := k(k(v3,v0),k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq28 := k(k(v3,v0),k(v2,v1)); 
neq29 := k(v2,k(v3,k(v2,v1))); 
neq30 := k(v2,k(v3,v1)); 
neq31 := k(v2,v3); 
neq32 := k(v2,k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq33 := k(k(v3,k(v2,v1)),k(v3,v1)); 
neq34 := k(k(v3,k(v2,v1)),k(k(v3,v1),v2)); 
neq35 := k(k(v3,k(v2,v1)),k(k(v3,v0),v2)); 
neq36 := k(k(v3,v1),k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq37 := k(k(v3,v1),k(k(v3,v0),v2)); 
neq38 := k(k(v3,v1),k(v2,v1)); 
neq39 := k(k(k(v3,v1),v2),v3); 
neq40 := k(k(k(v3,v1),v2),k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq41 := k(k(k(v3,v1),v2),k(k(v3,v0),v2)); 
neq42 := k(k(k(v3,v1),v2),k(v2,v1)); 
neq43 := k(v3,k(k(k(v3,v0),v2),k(v3,k(v2,v1)))); 
neq44 := k(v3,k(k(v3,v0),v2)); 
neq45 := k(v3,k(v2,v1)); 
neq46 := k(k(k(k(v3,v0),v2),k(v3,k(v2,v1))),k(v2,v1)); 
neq47 := k(k(k(v3,v0),v2),k(v2,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,v0),v2),k(v3,k(v2,v1))),k(k(k(v3,v1),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
