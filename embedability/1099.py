...
def test_embed(): 
    ...
    s.add(((z_5*x_6-x_5*z_6)*z_10-(x_5*y_6-y_5*x_6)*y_10)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_10-(y_5*z_6-z_5*y_6)*z_10)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_10-(z_5*x_6-x_5*z_6)*x_10)==0) 
    ...
    s.add(((z_0*x_4-x_0*z_4)*z_13-(x_0*y_4-y_0*x_4)*y_13)==0) 
    s.add(((x_0*y_4-y_0*x_4)*x_13-(y_0*z_4-z_0*y_4)*z_13)==0) 
    s.add(((y_0*z_4-z_0*y_4)*y_13-(z_0*x_4-x_0*z_4)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
