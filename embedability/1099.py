...
def test_embed(): 
    ...
    s.add(((z_11*x_12-x_11*z_12)*z_7-(x_11*y_12-y_11*x_12)*y_7)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_7-(y_11*z_12-z_11*y_12)*z_7)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_7-(z_11*x_12-x_11*z_12)*x_7)==0) 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_1-(x_8*y_12-y_8*x_12)*y_1)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_1-(y_8*z_12-z_8*y_12)*z_1)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_1-(z_8*x_12-x_8*z_12)*x_1)==0) 
    ...
    s.add(((z_5*x_9-x_5*z_9)*z_2-(x_5*y_9-y_5*x_9)*y_2)==0) 
    s.add(((x_5*y_9-y_5*x_9)*x_2-(y_5*z_9-z_5*y_9)*z_2)==0) 
    s.add(((y_5*z_9-z_5*y_9)*y_2-(z_5*x_9-x_5*z_9)*x_2)==0) 
