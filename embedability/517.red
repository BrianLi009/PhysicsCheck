...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2)); 
neq1 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq2 := k(k(k(k(v2,v1),v2),k(v0,v1)),v2); 
neq3 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v2,v1),v1)); 
neq4 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq5 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq6 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq7 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v2,v1)); 
neq8 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq9 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(v0,v1)); 
neq10 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),v0); 
neq11 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),v2); 
neq12 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v1)); 
neq13 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq14 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),v1); 
neq15 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v2)); 
neq16 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(v2,v1)); 
neq17 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(v2,v1),v2),v0)); 
neq18 := k(k(v0,v1),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2)); 
neq19 := k(k(v0,v1),v2); 
neq20 := k(k(v0,v1),k(k(v2,v1),v1)); 
neq21 := k(k(v0,v1),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq22 := k(k(v0,v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq23 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq24 := k(k(v0,v1),k(v2,v1)); 
neq25 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq26 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),v0); 
neq27 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),k(k(v2,v1),v1)); 
neq28 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq29 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),v1); 
neq30 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),k(k(v2,v1),v2)); 
neq31 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),k(v2,v1)); 
neq32 := k(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2),k(k(k(v2,v1),v2),v0)); 
neq33 := k(v0,v2); 
neq34 := k(v0,k(k(v2,v1),v1)); 
neq35 := k(v0,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq36 := k(v0,k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq37 := k(v0,k(k(v2,v1),v2)); 
neq38 := k(v0,k(v2,v1)); 
neq39 := k(v2,k(k(v2,v1),v1)); 
neq40 := k(v2,k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1))); 
neq41 := k(v2,k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
neq42 := k(v2,v1); 
neq43 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq44 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0))); 
...
neq55 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)),k(k(k(v2,v1),v2),v0)),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
