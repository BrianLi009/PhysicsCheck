...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_7-(x_1*y_11-y_1*x_11)*y_7)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_7-(y_1*z_11-z_1*y_11)*z_7)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_7-(z_1*x_11-x_1*z_11)*x_7)==0) 
    ...
    s.add(((z_6*x_8-x_6*z_8)*z_4-(x_6*y_8-y_6*x_8)*y_4)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_4-(y_6*z_8-z_6*y_8)*z_4)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_4-(z_6*x_8-x_6*z_8)*x_4)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_10 == 0) 
