...
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0))); 
neq4 := k(v2,k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1))); 
neq5 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq8 := k(v2,v3); 
neq9 := k(v2,k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq10 := k(k(v3,k(v2,v0)),k(k(v2,v0),v0)); 
neq11 := k(k(v3,k(v2,v0)),v0); 
neq12 := k(k(v3,k(v2,v0)),k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0))); 
neq13 := k(k(v3,k(v2,v0)),k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1))); 
neq14 := k(k(v3,k(v2,v0)),k(v3,k(k(v2,v1),v2))); 
neq15 := k(k(v3,k(v2,v0)),v1); 
neq16 := k(k(v3,k(v2,v0)),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq17 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq18 := k(k(v3,k(v2,v0)),k(k(v2,v1),v2)); 
neq19 := k(k(k(v2,v0),v0),k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0))); 
neq20 := k(k(k(v2,v0),v0),k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1))); 
neq21 := k(k(k(v2,v0),v0),k(v3,k(k(v2,v1),v2))); 
neq22 := k(k(k(v2,v0),v0),v1); 
neq23 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq24 := k(k(k(v2,v0),v0),k(k(v2,v1),v2)); 
neq25 := k(k(k(v2,v0),v0),v3); 
neq26 := k(k(k(v2,v0),v0),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq27 := k(v0,k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0))); 
neq28 := k(v0,k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1))); 
neq29 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq30 := k(v0,k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq31 := k(v0,k(v2,v1)); 
neq32 := k(v0,k(k(v2,v1),v2)); 
neq33 := k(v0,v3); 
neq34 := k(v0,k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq35 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),v1); 
neq36 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq37 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),k(v2,v1)); 
neq38 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),k(k(v2,v1),v2)); 
neq39 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),v3); 
neq40 := k(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq41 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v3,k(k(v2,v1),v2))); 
neq42 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),v1); 
neq43 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq44 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(k(v2,v1),v2)); 
neq45 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),v3); 
neq46 := k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)); 
neq47 := k(k(v3,k(k(v2,v1),v2)),v1); 
neq48 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq49 := k(k(v3,k(k(v2,v1),v2)),k(v2,v1)); 
neq50 := k(k(v3,k(k(v2,v1),v2)),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq51 := k(k(v3,k(k(v2,v1),v2)),k(v2,v0)); 
neq52 := k(v1,k(k(k(v2,v0),v0),k(k(v2,v1),v2))); 
neq53 := k(v1,k(k(v2,v1),v2)); 
neq54 := k(v1,k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq55 := k(v1,k(v2,v0)); 
neq56 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v2)),k(v2,v1)); 
neq57 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v2)),v3); 
neq58 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v2)),k(v2,v0)); 
neq59 := k(k(v2,v1),v3); 
neq60 := k(k(v2,v1),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq61 := k(k(v2,v1),k(v2,v0)); 
neq62 := k(k(k(v2,v1),v2),v3); 
neq63 := k(k(k(v2,v1),v2),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))); 
neq64 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq65 := k(v3,k(v2,v0)); 
neq66 := k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(v3,k(v2,v0)),k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2)))) = 0 and 
       d(k(k(k(v3,k(k(k(v2,v0),v0),k(k(v2,v1),v2))),k(v2,v1)),k(v2,v0)),k(v3,k(k(v2,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
