...
def test_embed(): 
    ...
    s.add(((z_0*x_13-x_0*z_13)*z_6-(x_0*y_13-y_0*x_13)*y_6)==0) 
    s.add(((x_0*y_13-y_0*x_13)*x_6-(y_0*z_13-z_0*y_13)*z_6)==0) 
    s.add(((y_0*z_13-z_0*y_13)*y_6-(z_0*x_13-x_0*z_13)*x_6)==0) 
    ...
    s.add(((z_1*x_5-x_1*z_5)*z_4-(x_1*y_5-y_1*x_5)*y_4)==0) 
    s.add(((x_1*y_5-y_1*x_5)*x_4-(y_1*z_5-z_1*y_5)*z_4)==0) 
    s.add(((y_1*z_5-z_1*y_5)*y_4-(z_1*x_5-x_1*z_5)*x_4)==0) 
    ...
    s.add(((z_2*x_6-x_2*z_6)*z_3-(x_2*y_6-y_2*x_6)*y_3)==0) 
    s.add(((x_2*y_6-y_2*x_6)*x_3-(y_2*z_6-z_2*y_6)*z_3)==0) 
    s.add(((y_2*z_6-z_2*y_6)*y_3-(z_2*x_6-x_2*z_6)*x_3)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_7 == 0) 
