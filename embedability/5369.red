...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),v0); 
neq1 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),v1); 
neq2 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(k(v3,v2),v1)); 
neq3 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(v2,v0)); 
neq4 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(k(k(v3,v2),v1),k(v2,v0))); 
neq5 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq6 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(v3,v2)); 
neq7 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(v3,v1)); 
neq8 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),v3); 
neq9 := k(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq10 := k(v2,k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1))); 
neq11 := k(v2,v0); 
neq12 := k(v2,v1); 
neq13 := k(v2,k(k(v3,v2),v1)); 
neq14 := k(v2,k(k(k(v3,v2),v1),k(v2,v0))); 
neq15 := k(v2,k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq16 := k(v2,k(v3,v1)); 
neq17 := k(v2,k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq18 := k(v2,v3); 
neq19 := k(v2,k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq20 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v0); 
neq21 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v1); 
neq22 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(k(v3,v2),v1)); 
neq23 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(v2,v0)); 
neq24 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(k(k(v3,v2),v1),k(v2,v0))); 
neq25 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(v3,v2)); 
neq26 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq27 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v3); 
neq28 := k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq29 := k(v0,k(k(v3,v2),v1)); 
neq30 := k(v0,k(k(k(v3,v2),v1),k(v2,v0))); 
neq31 := k(v0,k(v3,v2)); 
neq32 := k(v0,k(v3,v1)); 
neq33 := k(v0,k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq34 := k(v0,v3); 
neq35 := k(v0,k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq36 := k(v1,k(v2,v0)); 
neq37 := k(v1,k(k(k(v3,v2),v1),k(v2,v0))); 
neq38 := k(v1,k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq39 := k(v1,k(v3,v2)); 
neq40 := k(v1,k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq41 := k(v1,v3); 
neq42 := k(v1,k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq43 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq44 := k(k(k(v3,v2),v1),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq45 := k(k(k(v3,v2),v1),k(v3,v1)); 
neq46 := k(k(k(v3,v2),v1),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq47 := k(k(k(v3,v2),v1),v3); 
neq48 := k(k(k(v3,v2),v1),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq49 := k(k(v2,v0),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq50 := k(k(v2,v0),k(v3,v2)); 
neq51 := k(k(v2,v0),k(v3,v1)); 
neq52 := k(k(v2,v0),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq53 := k(k(v2,v0),v3); 
neq54 := k(k(v2,v0),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq55 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0)); 
neq56 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,v2)); 
neq57 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,v1)); 
neq58 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq59 := k(k(k(k(v3,v2),v1),k(v2,v0)),v3); 
neq60 := k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v2)); 
neq61 := k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)); 
neq62 := k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq63 := k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),v3); 
neq64 := k(k(v3,v2),k(v3,v1)); 
neq65 := k(k(v3,v2),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq66 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
neq67 := k(k(v3,v1),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)); 
neq68 := k(k(v3,v1),k(k(k(k(v3,v2),v1),k(v2,v0)),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v0),k(v3,v1)),v2),k(k(k(k(k(v3,v2),v1),k(v2,v0)),v3),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
