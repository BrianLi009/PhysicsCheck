...
neq1 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v2,k(v0,v1))); 
neq2 := k(k(k(k(v3,v0),v3),k(v0,v1)),v0); 
neq3 := k(k(k(k(v3,v0),v3),k(v0,v1)),v1); 
neq4 := k(k(k(k(v3,v0),v3),k(v0,v1)),v3); 
neq5 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,k(v2,k(v0,v1)))); 
neq6 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,v0)); 
neq7 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq8 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1)); 
neq9 := k(v2,v0); 
neq10 := k(v2,v1); 
neq11 := k(v2,v3); 
neq12 := k(v2,k(k(v3,v0),v3)); 
neq13 := k(v2,k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq14 := k(v2,k(v3,k(v2,k(v0,v1)))); 
neq15 := k(v2,k(v3,v0)); 
neq16 := k(v2,k(k(v3,k(v2,k(v0,v1))),v1)); 
neq17 := k(k(v2,k(v0,v1)),v0); 
neq18 := k(k(v2,k(v0,v1)),v1); 
neq19 := k(k(v2,k(v0,v1)),v3); 
neq20 := k(k(v2,k(v0,v1)),k(k(v3,v0),v3)); 
neq21 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq22 := k(k(v2,k(v0,v1)),k(v3,v0)); 
neq23 := k(k(v2,k(v0,v1)),k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq24 := k(k(v2,k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1)); 
neq25 := k(v0,v3); 
neq26 := k(v0,k(k(v3,v0),v3)); 
neq27 := k(v0,k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq28 := k(v0,k(v3,k(v2,k(v0,v1)))); 
neq29 := k(v0,k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq30 := k(v0,k(k(v3,k(v2,k(v0,v1))),v1)); 
neq31 := k(v1,v3); 
neq32 := k(v1,k(k(v3,v0),v3)); 
neq33 := k(v1,k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq34 := k(v1,k(v3,k(v2,k(v0,v1)))); 
neq35 := k(v1,k(v3,v0)); 
neq36 := k(v1,k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq37 := k(v3,k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq38 := k(v3,k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq39 := k(v3,k(k(v3,k(v2,k(v0,v1))),v1)); 
neq40 := k(v3,k(v0,v1)); 
neq41 := k(k(k(v3,v0),v3),k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))); 
neq42 := k(k(k(v3,v0),v3),k(v3,k(v2,k(v0,v1)))); 
neq43 := k(k(k(v3,v0),v3),k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq44 := k(k(k(v3,v0),v3),k(k(v3,k(v2,k(v0,v1))),v1)); 
neq45 := k(k(k(v3,v0),v3),k(v0,v1)); 
neq46 := k(k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1)),k(v3,k(v2,k(v0,v1)))); 
neq47 := k(k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1)),k(v3,v0)); 
neq48 := k(k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1)),k(v0,v1)); 
neq49 := k(k(v3,k(v2,k(v0,v1))),k(v3,v0)); 
neq50 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq51 := k(k(v3,k(v2,k(v0,v1))),k(v0,v1)); 
neq52 := k(k(v3,v0),k(k(k(v3,k(v2,k(v0,v1))),v1),v2)); 
neq53 := k(k(v3,v0),k(k(v3,k(v2,k(v0,v1))),v1)); 
neq54 := k(k(v3,v0),k(v0,v1)); 
neq55 := k(k(k(k(v3,k(v2,k(v0,v1))),v1),v2),k(v0,v1)); 
neq56 := k(k(k(v3,k(v2,k(v0,v1))),v1),k(v0,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(v2,k(v0,v1))),v1),v2),k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
