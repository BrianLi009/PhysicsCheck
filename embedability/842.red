...
neq2 := k(v2,k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0)); 
neq3 := k(v2,k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1))); 
neq4 := k(v2,k(v3,v1)); 
neq5 := k(v2,v0); 
...
neq11 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0)); 
neq12 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1))); 
neq13 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v3,v1)); 
neq14 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v0); 
neq15 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(v3,k(v2,v1)),v0)); 
neq16 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v3); 
neq17 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq18 := k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),v1); 
neq19 := k(k(v3,k(v2,v1)),k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0)); 
neq20 := k(k(v3,k(v2,v1)),k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1))); 
neq21 := k(k(v3,k(v2,v1)),k(v3,v1)); 
...
neq27 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(v3,v1)); 
neq28 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(k(v3,k(v2,v1)),v0)); 
neq29 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),v3); 
neq30 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq31 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq32 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),v1); 
neq33 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(v2,v1)); 
neq34 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),v0); 
neq35 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),k(k(v3,k(v2,v1)),v0)); 
neq36 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),v3); 
neq37 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq38 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq39 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),v1); 
neq40 := k(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1)),k(v2,v1)); 
neq41 := k(k(v3,v1),v0); 
neq42 := k(k(v3,v1),k(k(v3,k(v2,v1)),v0)); 
neq43 := k(k(v3,v1),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq44 := k(k(v3,v1),k(k(k(v3,k(v2,v1)),v0),v2)); 
neq45 := k(k(v3,v1),k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1))); 
neq46 := k(k(v3,v1),k(v2,v1)); 
neq47 := k(v0,v3); 
...
neq51 := k(v0,k(v2,v1)); 
neq52 := k(k(k(v3,k(v2,v1)),v0),v3); 
neq53 := k(k(k(v3,k(v2,v1)),v0),k(k(k(k(v3,k(v2,v1)),v0),v2),v3)); 
neq54 := k(k(k(v3,k(v2,v1)),v0),k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1))); 
neq55 := k(k(k(v3,k(v2,v1)),v0),v1); 
neq56 := k(k(k(v3,k(v2,v1)),v0),k(v2,v1)); 
neq57 := k(v3,k(k(k(v3,k(v2,v1)),v0),v2)); 
neq58 := k(v3,k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1))); 
neq59 := k(v3,v1); 
neq60 := k(v3,k(v2,v1)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),v0),k(k(k(k(k(k(k(v3,k(v2,v1)),v0),v2),v3),k(v2,v1)),k(v2,v1)),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
