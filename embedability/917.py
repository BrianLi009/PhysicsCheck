...
def test_embed(): 
    ...
    s.add(((z_0*x_6-x_0*z_6)*z_9-(x_0*y_6-y_0*x_6)*y_9)==0) 
    s.add(((x_0*y_6-y_0*x_6)*x_9-(y_0*z_6-z_0*y_6)*z_9)==0) 
    s.add(((y_0*z_6-z_0*y_6)*y_9-(z_0*x_6-x_0*z_6)*x_9)==0) 
    s.add(((z_0*x_2-x_0*z_2)*z_10-(x_0*y_2-y_0*x_2)*y_10)==0) 
    s.add(((x_0*y_2-y_0*x_2)*x_10-(y_0*z_2-z_0*y_2)*z_10)==0) 
    s.add(((y_0*z_2-z_0*y_2)*y_10-(z_0*x_2-x_0*z_2)*x_10)==0) 
    ...
    s.add(((z_1*x_3-x_1*z_3)*z_12-(x_1*y_3-y_1*x_3)*y_12)==0) 
    s.add(((x_1*y_3-y_1*x_3)*x_12-(y_1*z_3-z_1*y_3)*z_12)==0) 
    s.add(((y_1*z_3-z_1*y_3)*y_12-(z_1*x_3-x_1*z_3)*x_12)==0) 
