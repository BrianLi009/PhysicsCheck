...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_2-(x_7*y_10-y_7*x_10)*y_2)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_2-(y_7*z_10-z_7*y_10)*z_2)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_2-(z_7*x_10-x_7*z_10)*x_2)==0) 
