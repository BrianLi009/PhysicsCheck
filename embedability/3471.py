...
def test_embed(): 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_9-(x_1*y_12-y_1*x_12)*y_9)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_9-(y_1*z_12-z_1*y_12)*z_9)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_9-(z_1*x_12-x_1*z_12)*x_9)==0) 
