...
def test_embed(): 
    ...
    s.add(((z_1*x_5-x_1*z_5)*z_9-(x_1*y_5-y_1*x_5)*y_9)==0) 
    s.add(((x_1*y_5-y_1*x_5)*x_9-(y_1*z_5-z_1*y_5)*z_9)==0) 
    s.add(((y_1*z_5-z_1*y_5)*y_9-(z_1*x_5-x_1*z_5)*x_9)==0) 
    ...
    s.add(((z_7*x_8-x_7*z_8)*z_11-(x_7*y_8-y_7*x_8)*y_11)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_11-(y_7*z_8-z_7*y_8)*z_11)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_11-(z_7*x_8-x_7*z_8)*x_11)==0) 
    s.add(((z_6*x_9-x_6*z_9)*z_12-(x_6*y_9-y_6*x_9)*y_12)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_12-(y_6*z_9-z_6*y_9)*z_12)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_12-(z_6*x_9-x_6*z_9)*x_12)==0) 
    s.add(((z_2*x_10-x_2*z_10)*z_13-(x_2*y_10-y_2*x_10)*y_13)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_13-(y_2*z_10-z_2*y_10)*z_13)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_13-(z_2*x_10-x_2*z_10)*x_13)==0) 
    s.add(x_4 == 0) 
    s.add(y_4 == 0) 
    s.add(z_4 == 1) 
    s.add(x_5 == 0) 
