...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_9-(x_5*y_10-y_5*x_10)*y_9)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_9-(y_5*z_10-z_5*y_10)*z_9)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_9-(z_5*x_10-x_5*z_10)*x_9)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
