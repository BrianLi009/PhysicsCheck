...
def test_embed(): 
    ...
    s.add(((z_1*x_10-x_1*z_10)*z_4-(x_1*y_10-y_1*x_10)*y_4)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_4-(y_1*z_10-z_1*y_10)*z_4)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_4-(z_1*x_10-x_1*z_10)*x_4)==0) 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_9-(x_6*y_10-y_6*x_10)*y_9)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_9-(y_6*z_10-z_6*y_10)*z_9)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_9-(z_6*x_10-x_6*z_10)*x_9)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_7 == 0) 
