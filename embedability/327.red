...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1))))); 
neq1 := k(v2,v0); 
...
neq8 := k(v2,v3); 
neq9 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),v0); 
neq10 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),k(v2,k(v0,v1))); 
neq11 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),v1); 
neq12 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),k(k(k(v3,v2),v3),k(v0,v1))); 
neq13 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),k(v3,v2)); 
neq14 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),k(v0,v1)); 
neq15 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),k(k(v3,v2),v3)); 
neq16 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1)))),v3); 
neq17 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v0); 
neq18 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,k(v0,v1)))); 
neq19 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(v3,v2),v3),v0)); 
neq20 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v2,k(v0,v1))); 
neq21 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v1); 
neq22 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,v2)); 
neq23 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v0,v1)); 
neq24 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(v3,v2),v3)); 
neq25 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),v3); 
neq26 := k(v0,k(v3,k(v2,k(v0,v1)))); 
neq27 := k(v0,k(v2,k(v0,v1))); 
neq28 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(v0,k(k(v3,v2),v3)); 
neq31 := k(v0,v3); 
neq32 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,v2),v3),v0)); 
neq33 := k(k(v3,k(v2,k(v0,v1))),v1); 
neq34 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v0,v1))); 
neq35 := k(k(v3,k(v2,k(v0,v1))),k(v3,v2)); 
neq36 := k(k(v3,k(v2,k(v0,v1))),k(v0,v1)); 
neq37 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,v2),v3)); 
neq38 := k(k(k(k(v3,v2),v3),v0),k(v2,k(v0,v1))); 
neq39 := k(k(k(k(v3,v2),v3),v0),v1); 
neq40 := k(k(k(k(v3,v2),v3),v0),k(k(k(v3,v2),v3),k(v0,v1))); 
neq41 := k(k(k(k(v3,v2),v3),v0),k(v3,v2)); 
neq42 := k(k(k(k(v3,v2),v3),v0),k(v0,v1)); 
neq43 := k(k(k(k(v3,v2),v3),v0),v3); 
neq44 := k(k(v2,k(v0,v1)),v1); 
neq45 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v3),k(v0,v1))); 
neq46 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq47 := k(k(v2,k(v0,v1)),k(k(v3,v2),v3)); 
neq48 := k(k(v2,k(v0,v1)),v3); 
neq49 := k(v1,k(k(k(v3,v2),v3),k(v0,v1))); 
neq50 := k(v1,k(v3,v2)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,k(v0,v1))))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
