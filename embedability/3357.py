...
def test_embed(): 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_5-(x_6*y_11-y_6*x_11)*y_5)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_5-(y_6*z_11-z_6*y_11)*z_5)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_5-(z_6*x_11-x_6*z_11)*x_5)==0) 
