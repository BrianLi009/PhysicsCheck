...
def test_embed(): 
    ...
    s.add(((z_2*x_8-x_2*z_8)*z_12-(x_2*y_8-y_2*x_8)*y_12)==0) 
    s.add(((x_2*y_8-y_2*x_8)*x_12-(y_2*z_8-z_2*y_8)*z_12)==0) 
    s.add(((y_2*z_8-z_2*y_8)*y_12-(z_2*x_8-x_2*z_8)*x_12)==0) 
    s.add(((z_3*x_7-x_3*z_7)*z_13-(x_3*y_7-y_3*x_7)*y_13)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_13-(y_3*z_7-z_3*y_7)*z_13)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_13-(z_3*x_7-x_3*z_7)*x_13)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_6 == 0) 
