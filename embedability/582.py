...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_3-(x_7*y_10-y_7*x_10)*y_3)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_3-(y_7*z_10-z_7*y_10)*z_3)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_3-(z_7*x_10-x_7*z_10)*x_3)==0) 
    s.add(((z_8*x_10-x_8*z_10)*z_4-(x_8*y_10-y_8*x_10)*y_4)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_4-(y_8*z_10-z_8*y_10)*z_4)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_4-(z_8*x_10-x_8*z_10)*x_4)==0) 
