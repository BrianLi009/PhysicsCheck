...
def test_embed(): 
    ...
    s.add(((z_0*x_4-x_0*z_4)*z_8-(x_0*y_4-y_0*x_4)*y_8)==0) 
    s.add(((x_0*y_4-y_0*x_4)*x_8-(y_0*z_4-z_0*y_4)*z_8)==0) 
    s.add(((y_0*z_4-z_0*y_4)*y_8-(z_0*x_4-x_0*z_4)*x_8)==0) 
    ...
    s.add(((z_1*x_3-x_1*z_3)*z_10-(x_1*y_3-y_1*x_3)*y_10)==0) 
    s.add(((x_1*y_3-y_1*x_3)*x_10-(y_1*z_3-z_1*y_3)*z_10)==0) 
    s.add(((y_1*z_3-z_1*y_3)*y_10-(z_1*x_3-x_1*z_3)*x_10)==0) 
    s.add(((z_4*x_5-x_4*z_5)*z_11-(x_4*y_5-y_4*x_5)*y_11)==0) 
    s.add(((x_4*y_5-y_4*x_5)*x_11-(y_4*z_5-z_4*y_5)*z_11)==0) 
    s.add(((y_4*z_5-z_4*y_5)*y_11-(z_4*x_5-x_4*z_5)*x_11)==0) 
