...
def test_embed(): 
    ...
    s.add(((z_10*x_12-x_10*z_12)*z_1-(x_10*y_12-y_10*x_12)*y_1)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_1-(y_10*z_12-z_10*y_12)*z_1)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_1-(z_10*x_12-x_10*z_12)*x_1)==0) 
    ...
    s.add(((z_6*x_9-x_6*z_9)*z_3-(x_6*y_9-y_6*x_9)*y_3)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_3-(y_6*z_9-z_6*y_9)*z_3)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_3-(z_6*x_9-x_6*z_9)*x_3)==0) 
