...
def test_embed(): 
    ...
    s.add(((z_6*x_10-x_6*z_10)*z_0-(x_6*y_10-y_6*x_10)*y_0)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_0-(y_6*z_10-z_6*y_10)*z_0)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_0-(z_6*x_10-x_6*z_10)*x_0)==0) 
    ...
    s.add(((z_1*x_7-x_1*z_7)*z_3-(x_1*y_7-y_1*x_7)*y_3)==0) 
    s.add(((x_1*y_7-y_1*x_7)*x_3-(y_1*z_7-z_1*y_7)*z_3)==0) 
    s.add(((y_1*z_7-z_1*y_7)*y_3-(z_1*x_7-x_1*z_7)*x_3)==0) 
