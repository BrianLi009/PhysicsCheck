...
neq7 := k(v2,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq8 := k(v2,k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq9 := k(v2,k(k(v3,v2),v1)); 
neq10 := k(k(v2,v0),v3); 
neq11 := k(k(v2,v0),k(k(k(k(v3,v2),v1),v1),v3)); 
neq12 := k(k(v2,v0),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2)); 
neq13 := k(k(v2,v0),k(v3,v2)); 
neq14 := k(k(v2,v0),v1); 
neq15 := k(k(v2,v0),k(k(k(v3,v2),v1),v1)); 
neq16 := k(k(v2,v0),k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq17 := k(k(v2,v0),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq18 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq19 := k(k(v2,v0),k(k(v3,v2),v1)); 
neq20 := k(v3,v0); 
neq21 := k(v3,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2)); 
neq22 := k(v3,v1); 
neq23 := k(v3,k(k(k(v3,v2),v1),v1)); 
neq24 := k(v3,k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq25 := k(v3,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq26 := k(v3,k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq27 := k(v3,k(k(v3,v2),v1)); 
neq28 := k(v0,k(k(k(k(v3,v2),v1),v1),v3)); 
neq29 := k(v0,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2)); 
neq30 := k(v0,k(v3,v2)); 
neq31 := k(v0,k(k(k(v3,v2),v1),v1)); 
neq32 := k(v0,k(v3,k(v2,v0))); 
neq33 := k(v0,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq34 := k(v0,k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq35 := k(v0,k(k(v3,v2),v1)); 
neq36 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2)); 
neq37 := k(k(k(k(k(v3,v2),v1),v1),v3),k(v3,v2)); 
neq38 := k(k(k(k(k(v3,v2),v1),v1),v3),v1); 
neq39 := k(k(k(k(k(v3,v2),v1),v1),v3),k(v3,k(v2,v0))); 
neq40 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq41 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq42 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(v3,v2),v1)); 
neq43 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(v3,v2)); 
neq44 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),v1); 
neq45 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(k(k(v3,v2),v1),v1)); 
neq46 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(v3,k(v2,v0))); 
neq47 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(k(v3,v2),v1)); 
neq49 := k(k(v3,v2),v1); 
neq50 := k(k(v3,v2),k(k(k(v3,v2),v1),v1)); 
neq51 := k(k(v3,v2),k(v3,k(v2,v0))); 
neq52 := k(k(v3,v2),k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq53 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq54 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq55 := k(v1,k(v3,k(v2,v0))); 
neq56 := k(v1,k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq57 := k(v1,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq58 := k(v1,k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq59 := k(k(k(k(v3,v2),v1),v1),k(v3,k(v2,v0))); 
neq60 := k(k(k(k(v3,v2),v1),v1),k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq61 := k(k(k(k(v3,v2),v1),v1),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq62 := k(k(k(k(v3,v2),v1),v1),k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0)))); 
neq63 := k(k(v3,k(v2,v0)),k(k(k(k(k(v3,v2),v1),v1),v3),v0)); 
neq64 := k(k(v3,k(v2,v0)),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq65 := k(k(v3,k(v2,v0)),k(k(v3,v2),v1)); 
neq66 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))); 
neq67 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(k(v3,v2),v1)); 
neq68 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),v2),k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v0),k(v3,k(v2,v0))),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
