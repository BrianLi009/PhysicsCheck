...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v2,k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1))); 
neq1 := k(v2,k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
...
neq10 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),v0); 
neq11 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq12 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq13 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),v1); 
neq14 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(v2,v1),v1)); 
neq15 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(v0,v1)); 
neq16 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(v2,k(v0,v1)),v2)); 
neq17 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(v2,k(v0,v1))); 
neq18 := k(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq19 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),v0); 
neq20 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq21 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq22 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq23 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq24 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,v1),v1)); 
neq25 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq26 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq27 := k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq28 := k(v0,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))); 
neq29 := k(v0,k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1)))); 
neq30 := k(v0,k(k(v2,v1),v1)); 
neq31 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq32 := k(v0,k(v2,k(v0,v1))); 
neq33 := k(v0,k(k(v2,k(v0,v1)),k(v0,v1))); 
neq34 := k(v0,k(v2,v1)); 
neq35 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq36 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),v1); 
neq37 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq38 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq39 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq40 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)),k(v2,v1)); 
neq41 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,k(v0,v1)),v2),v0)); 
neq42 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),v1); 
neq43 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v0,v1)); 
neq44 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq45 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,k(v0,v1))); 
neq46 := k(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)); 
neq47 := k(k(k(k(v2,k(v0,v1)),v2),v0),v1); 
neq48 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,v1),v1)); 
neq49 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(v0,v1)); 
neq50 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(v2,k(v0,v1))); 
neq51 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(k(v2,k(v0,v1)),k(v0,v1))); 
neq52 := k(k(k(k(v2,k(v0,v1)),v2),v0),k(v2,v1)); 
...
neq59 := k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))); 
...
phi := 
       ...
       d(k(k(k(v2,v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(v2,v1)),k(k(k(v2,k(v0,v1)),v2),v0)) = 0 and 
       d(k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),k(v0,v1))),k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
