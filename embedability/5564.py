...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_11-(x_9*y_13-y_9*x_13)*y_11)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_11-(y_9*z_13-z_9*y_13)*z_11)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_11-(z_9*x_13-x_9*z_13)*x_11)==0) 
