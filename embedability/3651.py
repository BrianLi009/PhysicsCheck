...
def test_embed(): 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_13-(x_3*y_10-y_3*x_10)*y_13)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_13-(y_3*z_10-z_3*y_10)*z_13)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_13-(z_3*x_10-x_3*z_10)*x_13)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_6 == 0) 
