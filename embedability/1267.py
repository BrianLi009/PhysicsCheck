...
def test_embed(): 
    ...
    s.add(((z_1*x_11-x_1*z_11)*z_6-(x_1*y_11-y_1*x_11)*y_6)==0) 
    s.add(((x_1*y_11-y_1*x_11)*x_6-(y_1*z_11-z_1*y_11)*z_6)==0) 
    s.add(((y_1*z_11-z_1*y_11)*y_6-(z_1*x_11-x_1*z_11)*x_6)==0) 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_4-(x_7*y_10-y_7*x_10)*y_4)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_4-(y_7*z_10-z_7*y_10)*z_4)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_4-(z_7*x_10-x_7*z_10)*x_4)==0) 
