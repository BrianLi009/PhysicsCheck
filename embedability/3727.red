...
v3 := {v3c1, v3c2, v3c3}; 
v2c2 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2))); 
neq1 := k(v2,v3); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1)); 
neq4 := k(v2,k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)); 
neq5 := k(v2,k(k(k(v3,v2),v2),v0)); 
neq6 := k(v2,k(k(k(k(v3,v2),v2),v0),v0)); 
neq7 := k(v2,k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq8 := k(v2,k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq9 := k(v2,k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq10 := k(k(k(v3,v2),v2),k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2))); 
neq11 := k(k(k(v3,v2),v2),v3); 
neq12 := k(k(k(v3,v2),v2),v0); 
neq13 := k(k(k(v3,v2),v2),k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1)); 
neq14 := k(k(k(v3,v2),v2),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)); 
neq15 := k(k(k(v3,v2),v2),k(k(k(k(v3,v2),v2),v0),v0)); 
neq16 := k(k(k(v3,v2),v2),k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq17 := k(k(k(v3,v2),v2),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq18 := k(k(k(v3,v2),v2),k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq19 := k(k(k(v3,v2),v2),v1); 
neq20 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v3); 
neq21 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v0); 
neq22 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1)); 
neq23 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),k(k(k(v3,v2),v2),v0)); 
neq24 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),k(k(k(k(v3,v2),v2),v0),v0)); 
neq25 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq26 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq27 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1); 
neq28 := k(v3,v0); 
neq29 := k(v3,k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1)); 
neq30 := k(v3,k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)); 
neq31 := k(v3,k(k(k(v3,v2),v2),v0)); 
neq32 := k(v3,k(k(k(k(v3,v2),v2),v0),v0)); 
neq33 := k(v3,k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq34 := k(v3,v1); 
neq35 := k(v0,k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1)); 
neq36 := k(v0,k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)); 
neq37 := k(v0,k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq38 := k(v0,k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq39 := k(v0,k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq40 := k(v0,k(v3,v2)); 
neq41 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)); 
neq42 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),k(k(k(v3,v2),v2),v0)); 
neq43 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),k(k(k(k(v3,v2),v2),v0),v0)); 
neq44 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq45 := k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),k(v3,v2)); 
neq46 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1),k(k(k(v3,v2),v2),v0)); 
neq47 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1),k(k(k(k(v3,v2),v2),v0),v0)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1),k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq50 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1),k(v3,v2)); 
neq51 := k(k(k(k(v3,v2),v2),v0),k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq52 := k(k(k(k(v3,v2),v2),v0),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq53 := k(k(k(k(v3,v2),v2),v0),k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq54 := k(k(k(k(v3,v2),v2),v0),v1); 
neq55 := k(k(k(k(v3,v2),v2),v0),k(v3,v2)); 
neq56 := k(k(k(k(k(v3,v2),v2),v0),v0),k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3)); 
neq57 := k(k(k(k(k(v3,v2),v2),v0),v0),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3)); 
neq58 := k(k(k(k(k(v3,v2),v2),v0),v0),v1); 
neq59 := k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)); 
neq60 := k(k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3),k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq61 := k(k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3),v1); 
neq62 := k(k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3),k(v3,v2)); 
neq63 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2))); 
neq64 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v1); 
neq65 := k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),k(v3,v2)); 
neq66 := k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1); 
neq67 := k(v1,k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),v1),v3),v3),k(k(k(k(k(k(k(v3,v2),v2),v0),v0),k(v3,v2)),k(v3,v2)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
