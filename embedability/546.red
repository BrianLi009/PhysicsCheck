...
neq1 := k(v2,v3); 
neq2 := k(v2,v1); 
neq3 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq4 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq5 := k(v2,k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq6 := k(v2,k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq7 := k(v2,k(k(v2,v0),v0)); 
neq8 := k(v2,k(k(v3,v2),v3)); 
neq9 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(v2,v0)); 
neq10 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(v3,v2)); 
neq11 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v0); 
neq12 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v3); 
neq13 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1); 
neq14 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq15 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq16 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(k(v2,v0),v0)); 
neq17 := k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),k(k(v3,v2),v3)); 
neq18 := k(k(v2,v0),k(v3,v2)); 
neq19 := k(k(v2,v0),v3); 
neq20 := k(k(v2,v0),v1); 
neq21 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq22 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq23 := k(k(v2,v0),k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq24 := k(k(v2,v0),k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq25 := k(k(v2,v0),k(k(v3,v2),v3)); 
neq26 := k(k(v3,v2),v0); 
neq27 := k(k(v3,v2),v1); 
neq28 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq29 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq30 := k(k(v3,v2),k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq31 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq32 := k(k(v3,v2),k(k(v2,v0),v0)); 
neq33 := k(v0,v3); 
neq34 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq35 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq36 := k(v0,k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq37 := k(v0,k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq38 := k(v0,k(k(v3,v2),v3)); 
neq39 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq40 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq41 := k(v3,k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq42 := k(v3,k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq43 := k(v3,k(k(v2,v0),v0)); 
neq44 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))); 
neq45 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3))); 
neq46 := k(v1,k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq47 := k(v1,k(k(v2,v0),v0)); 
neq48 := k(v1,k(k(v3,v2),v3)); 
neq49 := k(k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0)),k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq50 := k(k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0)),k(k(v3,v2),v3)); 
neq51 := k(k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3)),k(k(k(v3,v2),v3),k(k(v2,v0),v0))); 
neq52 := k(k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3)),k(k(v2,v0),v0)); 
neq53 := k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1)); 
neq54 := k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0)); 
neq55 := k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3)); 
neq56 := k(k(k(v2,v0),v0),k(k(v3,v2),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v3,v2),v3)),k(k(k(k(k(k(v3,v2),v3),k(k(v2,v0),v0)),v2),v1),k(k(v2,v0),v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
