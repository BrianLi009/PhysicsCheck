...
def test_embed(): 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_8-(x_6*y_13-y_6*x_13)*y_8)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_8-(y_6*z_13-z_6*y_13)*z_8)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_8-(z_6*x_13-x_6*z_13)*x_8)==0) 
    ...
    s.add(((z_6*x_8-x_6*z_8)*z_11-(x_6*y_8-y_6*x_8)*y_11)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_11-(y_6*z_8-z_6*y_8)*z_11)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_11-(z_6*x_8-x_6*z_8)*x_11)==0) 
    ...
    s.add(((z_4*x_8-x_4*z_8)*z_2-(x_4*y_8-y_4*x_8)*y_2)==0) 
    s.add(((x_4*y_8-y_4*x_8)*x_2-(y_4*z_8-z_4*y_8)*z_2)==0) 
    s.add(((y_4*z_8-z_4*y_8)*y_2-(z_4*x_8-x_4*z_8)*x_2)==0) 
