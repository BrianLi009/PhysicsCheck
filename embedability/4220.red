...
neq1 := k(v2,v0); 
neq2 := k(v2,v1); 
neq3 := k(v2,k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq4 := k(v2,k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
neq5 := k(v2,k(v3,v1)); 
neq6 := k(v2,v3); 
...
neq15 := k(k(v3,v2),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
neq16 := k(k(v3,v2),k(v3,v1)); 
neq17 := k(k(v3,v2),k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq18 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq19 := k(k(v3,v2),k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
neq20 := k(k(v0,v1),k(k(k(v3,v1),v3),v2)); 
neq21 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq22 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
...
neq30 := k(v0,k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq31 := k(v0,k(v3,v1)); 
neq32 := k(v0,v3); 
neq33 := k(v0,k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq34 := k(v0,k(k(v3,v1),v3)); 
neq35 := k(v0,k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
neq36 := k(v1,k(k(k(v3,v1),v3),v2)); 
neq37 := k(v1,k(v2,k(v0,v1))); 
neq38 := k(v1,k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq39 := k(v1,k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
neq40 := k(v1,v3); 
neq41 := k(v1,k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq42 := k(v1,k(k(v3,v1),v3)); 
neq43 := k(v1,k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
neq44 := k(k(k(k(v3,v1),v3),v2),k(v2,k(v0,v1))); 
neq45 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq46 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
neq47 := k(k(k(k(v3,v1),v3),v2),k(v3,v1)); 
neq48 := k(k(k(k(v3,v1),v3),v2),v3); 
neq49 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
neq50 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))); 
neq51 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0)); 
neq52 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq53 := k(k(v2,k(v0,v1)),v3); 
neq54 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq55 := k(k(v2,k(v0,v1)),k(k(v3,v1),v3)); 
neq56 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2)),k(v3,v1)); 
neq57 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2)),v3); 
neq58 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2)),k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq59 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2)),k(k(v3,v1),v3)); 
neq60 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0),k(v3,v1)); 
neq61 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0),v3); 
neq62 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0),k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq63 := k(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0),k(k(v3,v1),v3)); 
neq64 := k(k(v3,v1),k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq65 := k(k(v3,v1),k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
neq66 := k(v3,k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3))); 
neq67 := k(v3,k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1)))); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),v0),k(k(k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v3)),k(v2,k(v0,v1))),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
