...
neq10 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v3),k(k(v2,v1),v1))); 
neq11 := k(k(v2,k(v0,v1)),v0); 
neq12 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq13 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq14 := k(k(v2,k(v0,v1)),v1); 
neq15 := k(k(v2,k(v0,v1)),k(k(v3,v2),v3)); 
neq16 := k(k(k(v2,v1),v1),v3); 
neq17 := k(k(k(v2,v1),v1),v0); 
neq18 := k(k(k(v2,v1),v1),k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq19 := k(k(k(v2,v1),v1),k(v3,v2)); 
neq20 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq21 := k(k(k(v2,v1),v1),k(k(v3,v2),v3)); 
neq22 := k(v3,k(k(k(v3,v2),v3),k(k(v2,v1),v1))); 
neq23 := k(v3,k(v2,v1)); 
neq24 := k(v3,k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq25 := k(v3,k(v0,v1)); 
neq26 := k(v3,v1); 
neq27 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v1)),v0); 
neq28 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v1)),k(v2,v1)); 
neq29 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v1)),k(v3,v2)); 
neq30 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v1)),k(v0,v1)); 
neq31 := k(k(k(k(v3,v2),v3),k(k(v2,v1),v1)),v1); 
neq32 := k(v0,k(v2,v1)); 
neq33 := k(v0,k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq34 := k(v0,k(v3,v2)); 
neq35 := k(v0,k(k(v3,v2),v3)); 
neq36 := k(k(v2,v1),k(k(k(v3,v2),v3),k(v2,k(v0,v1)))); 
neq37 := k(k(v2,v1),k(v3,v2)); 
neq38 := k(k(v2,v1),k(v0,v1)); 
neq39 := k(k(v2,v1),k(k(v3,v2),v3)); 
neq40 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v3,v2)); 
neq41 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(v0,v1)); 
neq42 := k(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),v1); 
neq43 := k(k(v3,v2),k(v0,v1)); 
neq44 := k(k(v3,v2),v1); 
neq45 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq46 := k(v1,k(k(v3,v2),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,v2),v3),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
