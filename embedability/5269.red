...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0))); 
neq1 := k(v2,v1); 
neq2 := k(v2,k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3)); 
neq3 := k(v2,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq4 := k(v2,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq5 := k(v2,k(v3,v1)); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(k(v3,v2),v1)); 
neq8 := k(v2,k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq9 := k(v2,k(k(v3,v1),v3)); 
neq10 := k(k(v2,v0),v1); 
neq11 := k(k(v2,v0),k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3)); 
neq12 := k(k(v2,v0),k(v3,v2)); 
neq13 := k(k(v2,v0),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq14 := k(k(v2,v0),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq15 := k(k(v2,v0),k(v3,v1)); 
neq16 := k(k(v2,v0),v3); 
neq17 := k(k(v2,v0),k(k(v3,v2),v1)); 
neq18 := k(k(v2,v0),k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq19 := k(k(v2,v0),k(k(v3,v1),v3)); 
neq20 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),v0); 
neq21 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),v1); 
neq22 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(v3,v2)); 
neq23 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq24 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(v3,v1)); 
neq25 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),v3); 
neq26 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(k(v3,v2),v1)); 
neq27 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq28 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0)),k(k(v3,v1),v3)); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3)); 
neq30 := k(v0,k(v3,v2)); 
neq31 := k(v0,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq32 := k(v0,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq33 := k(v0,k(v3,v1)); 
neq34 := k(v0,v3); 
neq35 := k(v0,k(k(v3,v2),v1)); 
neq36 := k(v0,k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq37 := k(v0,k(k(v3,v1),v3)); 
neq38 := k(v1,k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3)); 
neq39 := k(v1,k(v3,v2)); 
neq40 := k(v1,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq41 := k(v1,k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq42 := k(v1,v3); 
neq43 := k(v1,k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq44 := k(v1,k(k(v3,v1),v3)); 
neq45 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(v3,v2)); 
neq46 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq47 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(v3,v1)); 
neq48 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(k(v3,v2),v1)); 
neq49 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq50 := k(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(k(v3,v1),v3)); 
neq51 := k(k(v3,v2),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3))); 
neq52 := k(k(v3,v2),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
neq53 := k(k(v3,v2),k(v3,v1)); 
neq54 := k(k(v3,v2),k(k(k(v3,v1),v3),k(k(v3,v2),v1))); 
neq55 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq56 := k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1))); 
...
neq60 := k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),k(v3,v1)); 
neq61 := k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3); 
neq62 := k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),k(k(v3,v1),v3)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v2),v1)),v3),k(k(k(k(k(v3,v1),v3),k(k(v3,v2),v1)),k(k(v3,v1),v3)),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
