...
neq4 := k(v2,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq5 := k(v2,k(k(k(v2,v1),v2),k(v0,v1))); 
neq6 := k(v2,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq7 := k(v2,k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq8 := k(v2,k(v0,v1)); 
neq9 := k(k(v2,v1),v3); 
neq10 := k(k(v2,v1),v0); 
neq11 := k(k(v2,v1),k(v2,k(v0,v1))); 
neq12 := k(k(v2,v1),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq13 := k(k(v2,v1),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq14 := k(k(v2,v1),k(k(k(v2,v1),v2),k(v0,v1))); 
neq15 := k(k(v2,v1),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq16 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq17 := k(k(v2,v1),k(v0,v1)); 
neq18 := k(v3,v1); 
neq19 := k(v3,k(v2,k(v0,v1))); 
neq20 := k(v3,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq21 := k(v3,k(k(k(v2,v1),v2),k(v0,v1))); 
neq22 := k(v3,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq23 := k(v3,k(v0,v1)); 
neq24 := k(v3,k(k(v2,v1),v2)); 
neq25 := k(v0,k(v2,k(v0,v1))); 
neq26 := k(v0,k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq27 := k(v0,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq28 := k(v0,k(k(k(v2,v1),v2),k(v0,v1))); 
neq29 := k(v0,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq30 := k(v0,k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq31 := k(v0,k(k(v2,v1),v2)); 
neq32 := k(v1,k(v2,k(v0,v1))); 
neq33 := k(v1,k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq34 := k(v1,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq35 := k(v1,k(k(k(v2,v1),v2),k(v0,v1))); 
neq36 := k(v1,k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq37 := k(v1,k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq38 := k(v1,k(k(v2,v1),v2)); 
neq39 := k(k(v2,k(v0,v1)),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq40 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),k(v0,v1))); 
neq41 := k(k(v2,k(v0,v1)),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq42 := k(k(v2,k(v0,v1)),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq43 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq44 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))); 
neq45 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq46 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(v0,v1)); 
neq47 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v2)); 
neq48 := k(k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1))),k(k(k(v2,v1),v2),k(v0,v1))); 
neq49 := k(k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1))),k(v0,v1)); 
neq50 := k(k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq51 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2))); 
neq52 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3)); 
neq53 := k(k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2)),k(v0,v1)); 
neq54 := k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v0,v1)); 
neq55 := k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(k(v2,v1),v2)),k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v3),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
