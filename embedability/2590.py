...
def test_embed(): 
    ...
    s.add(((z_2*x_12-x_2*z_12)*z_4-(x_2*y_12-y_2*x_12)*y_4)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_4-(y_2*z_12-z_2*y_12)*z_4)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_4-(z_2*x_12-x_2*z_12)*x_4)==0) 
    ...
    s.add(((z_3*x_12-x_3*z_12)*z_5-(x_3*y_12-y_3*x_12)*y_5)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_5-(y_3*z_12-z_3*y_12)*z_5)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_5-(z_3*x_12-x_3*z_12)*x_5)==0) 
