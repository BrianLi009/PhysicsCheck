...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_12-(x_5*y_10-y_5*x_10)*y_12)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_12-(y_5*z_10-z_5*y_10)*z_12)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_12-(z_5*x_10-x_5*z_10)*x_12)==0) 
