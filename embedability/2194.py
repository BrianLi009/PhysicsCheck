...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_5-(x_0*y_10-y_0*x_10)*y_5)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_5-(y_0*z_10-z_0*y_10)*z_5)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_5-(z_0*x_10-x_0*z_10)*x_5)==0) 
    ...
    s.add(((z_3*x_10-x_3*z_10)*z_1-(x_3*y_10-y_3*x_10)*y_1)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_1-(y_3*z_10-z_3*y_10)*z_1)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_1-(z_3*x_10-x_3*z_10)*x_1)==0) 
    ...
    s.add(((z_6*x_12-x_6*z_12)*z_2-(x_6*y_12-y_6*x_12)*y_2)==0) 
    s.add(((x_6*y_12-y_6*x_12)*x_2-(y_6*z_12-z_6*y_12)*z_2)==0) 
    s.add(((y_6*z_12-z_6*y_12)*y_2-(z_6*x_12-x_6*z_12)*x_2)==0) 
