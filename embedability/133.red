...
neq6 := k(v2,k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(v3,k(k(v2,v0),v0))); 
neq9 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(v2,v0),v0)); 
neq10 := k(k(k(k(v3,v2),v1),k(v2,v0)),v0); 
neq11 := k(k(k(k(v3,v2),v1),k(v2,v0)),v3); 
neq12 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq13 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v2,v1)); 
neq14 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,v2)); 
neq15 := k(k(k(k(v3,v2),v1),k(v2,v0)),v1); 
neq16 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,k(k(v2,v0),v0))); 
neq17 := k(k(k(v2,v0),v0),v3); 
neq18 := k(k(k(v2,v0),v0),k(k(v3,k(k(v2,v0),v0)),v3)); 
neq19 := k(k(k(v2,v0),v0),k(k(v3,v2),v1)); 
neq20 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq21 := k(k(k(v2,v0),v0),k(v3,v2)); 
neq22 := k(k(k(v2,v0),v0),k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq23 := k(k(k(v2,v0),v0),v1); 
neq24 := k(v0,v3); 
neq25 := k(v0,k(k(v3,k(k(v2,v0),v0)),v3)); 
neq26 := k(v0,k(k(v3,v2),v1)); 
neq27 := k(v0,k(v2,v1)); 
neq28 := k(v0,k(v3,v2)); 
neq29 := k(v0,k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq30 := k(v0,k(v3,k(k(v2,v0),v0))); 
neq31 := k(v3,k(k(v3,v2),v1)); 
neq32 := k(v3,k(v2,v1)); 
neq33 := k(v3,k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq34 := k(v3,v1); 
neq35 := k(v3,k(v2,v0)); 
neq36 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(k(v3,v2),v1)); 
neq37 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1)); 
neq38 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(v3,v2)); 
neq39 := k(k(k(v3,k(k(v2,v0),v0)),v3),v1); 
neq40 := k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v0)); 
neq41 := k(k(k(v3,v2),v1),k(v2,v1)); 
neq42 := k(k(k(v3,v2),v1),k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq43 := k(k(k(v3,v2),v1),k(v3,k(k(v2,v0),v0))); 
neq44 := k(k(k(v3,v2),v1),k(v2,v0)); 
neq45 := k(k(v2,v1),k(v3,v2)); 
neq46 := k(k(v2,v1),k(v3,k(k(v2,v0),v0))); 
neq47 := k(k(v2,v1),k(v2,v0)); 
neq48 := k(k(v3,v2),k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))); 
neq49 := k(k(v3,v2),v1); 
neq50 := k(k(v3,v2),k(v3,k(k(v2,v0),v0))); 
neq51 := k(k(v3,v2),k(v2,v0)); 
neq52 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1)),v1); 
neq53 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1)),k(v3,k(k(v2,v0),v0))); 
neq54 := k(k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1)),k(v2,v0)); 
...
phi := 
       ...
       d(k(k(k(v3,v2),v1),k(v2,v0)),k(k(k(v3,k(k(v2,v0),v0)),v3),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
