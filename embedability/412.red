...
neq8 := k(v2,v1); 
neq9 := k(k(v2,v0),k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3))); 
neq10 := k(k(v2,v0),k(k(v3,k(v2,v1)),v3)); 
neq11 := k(k(v2,v0),k(v3,k(v2,v1))); 
...
neq17 := k(k(v2,v0),v1); 
neq18 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),k(v3,k(v2,v1))); 
neq19 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),k(v2,v1)); 
neq20 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),v0); 
neq21 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),k(v0,v1)); 
neq22 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),k(v3,v2)); 
neq23 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),v3); 
neq24 := k(k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3)),v1); 
neq25 := k(k(k(v3,k(v2,v1)),v3),k(v2,v1)); 
neq26 := k(k(k(v3,k(v2,v1)),v3),v0); 
neq27 := k(k(k(v3,k(v2,v1)),v3),k(k(k(v3,v2),v1),k(v2,v0))); 
neq28 := k(k(k(v3,k(v2,v1)),v3),k(v0,v1)); 
neq29 := k(k(k(v3,k(v2,v1)),v3),k(v3,v2)); 
neq30 := k(k(k(v3,k(v2,v1)),v3),k(k(v3,v2),v1)); 
neq31 := k(k(k(v3,k(v2,v1)),v3),v1); 
neq32 := k(k(v3,k(v2,v1)),v0); 
neq33 := k(k(v3,k(v2,v1)),k(k(k(v3,v2),v1),k(v2,v0))); 
neq34 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq35 := k(k(v3,k(v2,v1)),k(v3,v2)); 
neq36 := k(k(v3,k(v2,v1)),k(k(v3,v2),v1)); 
neq37 := k(k(v3,k(v2,v1)),v1); 
neq38 := k(k(v2,v1),v0); 
neq39 := k(k(v2,v1),k(k(k(v3,v2),v1),k(v2,v0))); 
neq40 := k(k(v2,v1),k(v0,v1)); 
neq41 := k(k(v2,v1),k(v3,v2)); 
neq42 := k(k(v2,v1),v3); 
neq43 := k(k(v2,v1),k(k(v3,v2),v1)); 
neq44 := k(v0,k(k(k(v3,v2),v1),k(v2,v0))); 
neq45 := k(v0,k(v3,v2)); 
neq46 := k(v0,v3); 
neq47 := k(v0,k(k(v3,v2),v1)); 
neq48 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v0,v1)); 
neq49 := k(k(k(k(v3,v2),v1),k(v2,v0)),k(v3,v2)); 
neq50 := k(k(k(k(v3,v2),v1),k(v2,v0)),v3); 
neq51 := k(k(k(k(v3,v2),v1),k(v2,v0)),v1); 
neq52 := k(k(v0,v1),k(v3,v2)); 
neq53 := k(k(v0,v1),k(k(v3,v2),v1)); 
neq54 := k(k(v3,v2),v1); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,v2),v1),k(v2,v0)),k(k(k(v3,v2),v1),k(k(v3,k(v2,v1)),v3))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
