...
neq2 := k(v2,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(k(v3,k(v2,v1)),v3)); 
neq8 := k(v2,k(k(k(v3,v0),v2),k(v0,v1))); 
neq9 := k(v2,k(v3,v0)); 
neq10 := k(k(v3,k(v2,v1)),k(k(v3,v0),k(v2,v1))); 
neq11 := k(k(v3,k(v2,v1)),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1))); 
neq12 := k(k(v3,k(v2,v1)),v0); 
neq13 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq14 := k(k(v3,k(v2,v1)),k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq15 := k(k(v3,k(v2,v1)),v1); 
neq16 := k(k(v3,k(v2,v1)),k(k(v3,v0),v2)); 
neq17 := k(k(v3,k(v2,v1)),k(k(k(v3,v0),v2),k(v0,v1))); 
neq18 := k(k(v3,k(v2,v1)),k(v3,v0)); 
neq19 := k(k(k(v3,v0),k(v2,v1)),v0); 
neq20 := k(k(k(v3,v0),k(v2,v1)),k(v0,v1)); 
neq21 := k(k(k(v3,v0),k(v2,v1)),k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq22 := k(k(k(v3,v0),k(v2,v1)),v3); 
neq23 := k(k(k(v3,v0),k(v2,v1)),k(k(v3,k(v2,v1)),v3)); 
neq24 := k(k(k(v3,v0),k(v2,v1)),v1); 
neq25 := k(k(k(v3,v0),k(v2,v1)),k(k(v3,v0),v2)); 
neq26 := k(k(k(v3,v0),k(v2,v1)),k(k(k(v3,v0),v2),k(v0,v1))); 
neq27 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),v0); 
neq28 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(v0,v1)); 
neq29 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq30 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),v3); 
neq31 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v3,k(v2,v1)),v3)); 
neq32 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),v1); 
neq33 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v3,v0),v2)); 
neq34 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(v3,v0)); 
neq35 := k(v0,k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq36 := k(v0,v3); 
neq37 := k(v0,k(k(v3,k(v2,v1)),v3)); 
neq38 := k(v0,k(k(v3,v0),v2)); 
neq39 := k(v0,k(k(k(v3,v0),v2),k(v0,v1))); 
neq40 := k(v0,k(v2,v1)); 
neq41 := k(k(v0,v1),k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3))); 
neq42 := k(k(v0,v1),v3); 
neq43 := k(k(v0,v1),k(k(v3,k(v2,v1)),v3)); 
neq44 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq45 := k(k(v0,v1),k(v3,v0)); 
neq46 := k(k(v0,v1),k(v2,v1)); 
neq47 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3)),v3); 
neq48 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3)),v1); 
neq49 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3)),k(v3,v0)); 
neq50 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3)),k(v2,v1)); 
neq51 := k(v3,v1); 
neq52 := k(v3,k(k(v3,v0),v2)); 
neq53 := k(v3,k(k(k(v3,v0),v2),k(v0,v1))); 
neq54 := k(v3,k(v2,v1)); 
neq55 := k(k(k(v3,k(v2,v1)),v3),v1); 
neq56 := k(k(k(v3,k(v2,v1)),v3),k(k(v3,v0),v2)); 
neq57 := k(k(k(v3,k(v2,v1)),v3),k(k(k(v3,v0),v2),k(v0,v1))); 
neq58 := k(k(k(v3,k(v2,v1)),v3),k(v3,v0)); 
neq59 := k(k(k(v3,k(v2,v1)),v3),k(v2,v1)); 
neq60 := k(v1,k(k(v3,v0),v2)); 
neq61 := k(v1,k(k(k(v3,v0),v2),k(v0,v1))); 
neq62 := k(v1,k(v3,v0)); 
neq63 := k(k(k(v3,v0),v2),k(v2,v1)); 
neq64 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,v0)); 
neq65 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(v3,v0),v2),k(k(v3,k(v2,v1)),v3)),k(k(k(v3,v0),v2),k(v0,v1))) = 0 and 
       d(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,v1)),k(k(v3,v0),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
