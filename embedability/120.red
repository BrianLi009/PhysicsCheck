...
neq1 := k(k(k(v3,v1),v1),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
neq2 := k(k(k(v3,v1),v1),k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0))); 
neq3 := k(k(k(v3,v1),v1),v0); 
neq4 := k(k(k(v3,v1),v1),v3); 
neq5 := k(k(k(v3,v1),v1),k(v2,v0)); 
neq6 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq7 := k(k(k(v3,v1),v1),k(k(v2,v0),v0)); 
neq8 := k(k(k(v3,v1),v1),k(k(v3,v2),v3)); 
neq9 := k(v2,k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))); 
...
neq17 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v0); 
neq18 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v3); 
neq19 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),v1); 
neq20 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),k(v3,v1)); 
neq21 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),k(v2,v0)); 
neq22 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),k(v3,v2)); 
neq23 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3)),k(k(v2,v0),v0)); 
neq24 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),v0); 
neq25 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),v3); 
neq26 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),v1); 
neq27 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),k(v3,v1)); 
neq28 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq29 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),k(v3,v2)); 
neq30 := k(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),k(k(v3,v2),v3)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(v3,v1)); 
neq33 := k(v0,k(v3,v2)); 
...
neq36 := k(v3,v1); 
neq37 := k(v3,k(v2,v0)); 
neq38 := k(v3,k(k(v2,v0),v0)); 
neq39 := k(v3,k(k(k(v3,v1),v1),v2)); 
neq40 := k(v1,k(v2,v0)); 
neq41 := k(v1,k(v3,v2)); 
neq42 := k(v1,k(k(v2,v0),v0)); 
neq43 := k(v1,k(k(v3,v2),v3)); 
neq44 := k(v1,k(k(k(v3,v1),v1),v2)); 
neq45 := k(k(v3,v1),k(v2,v0)); 
neq46 := k(k(v3,v1),k(v3,v2)); 
neq47 := k(k(v3,v1),k(k(v2,v0),v0)); 
neq48 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq49 := k(k(v3,v1),k(k(k(v3,v1),v1),v2)); 
neq50 := k(k(v2,v0),k(v3,v2)); 
neq51 := k(k(v2,v0),k(k(v3,v2),v3)); 
neq52 := k(k(v2,v0),k(k(k(v3,v1),v1),v2)); 
neq53 := k(k(v3,v2),k(k(v2,v0),v0)); 
neq54 := k(k(v3,v2),k(k(k(v3,v1),v1),v2)); 
neq55 := k(k(k(v2,v0),v0),k(k(v3,v2),v3)); 
neq56 := k(k(k(v2,v0),v0),k(k(k(v3,v1),v1),v2)); 
neq57 := k(k(k(v3,v2),v3),k(k(k(v3,v1),v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,v1),v1),v2),k(k(v2,v0),v0)),k(k(k(k(v3,v1),v1),v2),k(k(v3,v2),v3))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
