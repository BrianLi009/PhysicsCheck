...
def test_embed(): 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_13-(x_8*y_12-y_8*x_12)*y_13)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_13-(y_8*z_12-z_8*y_12)*z_13)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_13-(z_8*x_12-x_8*z_12)*x_13)==0) 
    ...
    s.add(((z_1*x_8-x_1*z_8)*z_3-(x_1*y_8-y_1*x_8)*y_3)==0) 
    s.add(((x_1*y_8-y_1*x_8)*x_3-(y_1*z_8-z_1*y_8)*z_3)==0) 
    s.add(((y_1*z_8-z_1*y_8)*y_3-(z_1*x_8-x_1*z_8)*x_3)==0) 
