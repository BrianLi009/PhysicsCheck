...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_8-(x_2*y_13-y_2*x_13)*y_8)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_8-(y_2*z_13-z_2*y_13)*z_8)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_8-(z_2*x_13-x_2*z_13)*x_8)==0) 
