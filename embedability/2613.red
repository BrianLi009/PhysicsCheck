...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(k(v2,v0),v2),v1)); 
neq1 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq2 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v0); 
neq3 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq4 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(v2,v0),v0)); 
neq5 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq6 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
neq7 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v2); 
neq8 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(k(v2,v0),v2)); 
neq9 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),k(v2,v0)); 
neq10 := k(k(k(k(v2,v0),v2),v1),v0); 
neq11 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1)); 
neq12 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq13 := k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)); 
neq14 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq15 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
neq16 := k(k(k(k(v2,v0),v2),v1),v2); 
neq17 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq18 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq19 := k(k(k(k(k(v2,v0),v2),v1),v1),v0); 
neq20 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1)); 
neq21 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v0)); 
neq22 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq23 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
neq24 := k(k(k(k(k(v2,v0),v2),v1),v1),v2); 
neq25 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v2)); 
neq26 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)); 
neq27 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq28 := k(v0,k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1)); 
neq29 := k(v0,k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq30 := k(v0,k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq31 := k(v0,k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
neq32 := k(v0,v2); 
neq33 := k(v0,k(k(v2,v0),v2)); 
neq34 := k(v0,k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq35 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq36 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(k(v2,v0),v0)); 
neq37 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
neq38 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),v2); 
neq39 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(k(v2,v0),v2)); 
neq40 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(v2,v0)); 
neq41 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq42 := k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(v2,v0),v0)); 
neq43 := k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq44 := k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0))); 
...
neq48 := k(k(k(v2,v0),v0),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2))); 
neq49 := k(k(k(v2,v0),v0),v2); 
neq50 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq51 := k(k(k(v2,v0),v0),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq52 := k(k(k(v2,v0),v0),v1); 
neq53 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)),v2); 
neq54 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)),k(v2,v0)); 
neq55 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq56 := k(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)),v1); 
neq57 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),v2); 
neq58 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
neq59 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq60 := k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),v1); 
neq61 := k(v2,v1); 
neq62 := k(k(k(v2,v0),v2),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq63 := k(k(k(v2,v0),v2),v1); 
neq64 := k(k(v2,v0),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2)); 
neq65 := k(k(v2,v0),v1); 
neq66 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),k(k(v2,v0),v0)),k(k(v2,v0),v2)),k(k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v2),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
