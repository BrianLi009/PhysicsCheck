...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),v2); 
neq1 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)))); 
neq2 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1))); 
neq3 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(v2,v1),v1)); 
neq4 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v1)); 
neq5 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),v0); 
neq6 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(v2,v0),v0)); 
neq7 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0)); 
neq8 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq9 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),v1); 
neq10 := k(v2,k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)))); 
neq11 := k(v2,k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1))); 
neq12 := k(v2,k(k(v2,v1),v1)); 
neq13 := k(v2,v0); 
neq14 := k(v2,k(k(v2,v0),v0)); 
neq15 := k(v2,k(v0,v1)); 
neq16 := k(v2,k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq17 := k(v2,k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq18 := k(v2,v1); 
neq19 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(k(v2,v1),v1)); 
neq20 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(v2,v1)); 
neq21 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),v0); 
neq22 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(k(v2,v0),v0)); 
neq23 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(v2,v0)); 
neq24 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(v0,v1)); 
neq25 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq26 := k(k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))),v1); 
neq27 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(k(v2,v1),v1)); 
neq28 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(v2,v1)); 
neq29 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),v0); 
neq30 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(k(v2,v0),v0)); 
neq31 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(v2,v0)); 
neq32 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq33 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),v1); 
neq34 := k(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(k(v2,v0),v2)); 
neq35 := k(k(k(v2,v1),v1),v0); 
neq36 := k(k(k(v2,v1),v1),k(k(v2,v0),v0)); 
neq37 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq38 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq39 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq40 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq41 := k(k(v2,v1),v0); 
neq42 := k(k(v2,v1),k(k(v2,v0),v0)); 
neq43 := k(k(v2,v1),k(v2,v0)); 
neq44 := k(k(v2,v1),k(v0,v1)); 
neq45 := k(k(v2,v1),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq46 := k(k(v2,v1),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq47 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq48 := k(v0,k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq49 := k(v0,k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq50 := k(v0,k(k(v2,v0),v2)); 
neq51 := k(k(k(v2,v0),v0),k(v0,v1)); 
neq52 := k(k(k(v2,v0),v0),v1); 
neq53 := k(k(k(v2,v0),v0),k(k(v2,v0),v2)); 
neq54 := k(k(v2,v0),k(v0,v1)); 
neq55 := k(k(v2,v0),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq56 := k(k(v2,v0),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq57 := k(k(v2,v0),v1); 
neq58 := k(k(v0,v1),k(k(k(v2,v0),v0),k(k(v2,v1),v1))); 
neq59 := k(k(v0,v1),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0))); 
neq60 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq61 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),v1); 
neq62 := k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq63 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),v1); 
neq64 := k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(v0,v1)),k(k(v2,v0),v2)) = 0 and 
       d(k(k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)),k(v0,v1)),k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v0),k(k(v2,v1),v1)),k(k(v2,v0),v0)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
