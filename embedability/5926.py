...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_12-(x_9*y_13-y_9*x_13)*y_12)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_12-(y_9*z_13-z_9*y_13)*z_12)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_12-(z_9*x_13-x_9*z_13)*x_12)==0) 
