...
def test_embed(): 
    ...
    s.add(((z_1*x_9-x_1*z_9)*z_5-(x_1*y_9-y_1*x_9)*y_5)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_5-(y_1*z_9-z_1*y_9)*z_5)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_5-(z_1*x_9-x_1*z_9)*x_5)==0) 
    s.add(((z_2*x_10-x_2*z_10)*z_6-(x_2*y_10-y_2*x_10)*y_6)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_6-(y_2*z_10-z_2*y_10)*z_6)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_6-(z_2*x_10-x_2*z_10)*x_6)==0) 
    s.add(((z_10*x_13-x_10*z_13)*z_3-(x_10*y_13-y_10*x_13)*y_3)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_3-(y_10*z_13-z_10*y_13)*z_3)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_3-(z_10*x_13-x_10*z_13)*x_3)==0) 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_4-(x_9*y_13-y_9*x_13)*y_4)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_4-(y_9*z_13-z_9*y_13)*z_4)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_4-(z_9*x_13-x_9*z_13)*x_4)==0) 
    s.add(((z_4*x_8-x_4*z_8)*z_7-(x_4*y_8-y_4*x_8)*y_7)==0) 
    s.add(((x_4*y_8-y_4*x_8)*x_7-(y_4*z_8-z_4*y_8)*z_7)==0) 
    s.add(((y_4*z_8-z_4*y_8)*y_7-(z_4*x_8-x_4*z_8)*x_7)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
