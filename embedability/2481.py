...
def test_embed(): 
    ...
    s.add(((z_2*x_8-x_2*z_8)*z_9-(x_2*y_8-y_2*x_8)*y_9)==0) 
    s.add(((x_2*y_8-y_2*x_8)*x_9-(y_2*z_8-z_2*y_8)*z_9)==0) 
    s.add(((y_2*z_8-z_2*y_8)*y_9-(z_2*x_8-x_2*z_8)*x_9)==0) 
    ...
    s.add(((z_4*x_12-x_4*z_12)*z_6-(x_4*y_12-y_4*x_12)*y_6)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_6-(y_4*z_12-z_4*y_12)*z_6)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_6-(z_4*x_12-x_4*z_12)*x_6)==0) 
