...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v3,k(v0,v1)),k(k(k(v3,v0),v2),k(v0,v1))); 
neq1 := k(k(v3,k(v0,v1)),k(v2,k(v0,v1))); 
neq2 := k(k(v3,k(v0,v1)),v0); 
neq3 := k(k(v3,k(v0,v1)),v1); 
neq4 := k(k(v3,k(v0,v1)),v2); 
neq5 := k(k(v3,k(v0,v1)),k(v3,k(v2,k(v0,v1)))); 
neq6 := k(k(v3,k(v0,v1)),k(k(v3,v0),v2)); 
neq7 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq8 := k(k(v3,k(v0,v1)),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq9 := k(k(v3,k(v0,v1)),k(v3,v0)); 
neq10 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v2,k(v0,v1))); 
neq11 := k(k(k(k(v3,v0),v2),k(v0,v1)),v0); 
neq12 := k(k(k(k(v3,v0),v2),k(v0,v1)),v1); 
neq13 := k(k(k(k(v3,v0),v2),k(v0,v1)),v2); 
neq14 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1)))); 
neq15 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(v3,k(v0,v1)),v2)); 
neq16 := k(k(k(k(v3,v0),v2),k(v0,v1)),v3); 
neq17 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq18 := k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,v0)); 
neq19 := k(k(v2,k(v0,v1)),v0); 
neq20 := k(k(v2,k(v0,v1)),v1); 
neq21 := k(k(v2,k(v0,v1)),k(k(v3,k(v0,v1)),v2)); 
neq22 := k(k(v2,k(v0,v1)),k(k(v3,v0),v2)); 
neq23 := k(k(v2,k(v0,v1)),v3); 
neq24 := k(k(v2,k(v0,v1)),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
...
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
...
neq38 := k(v1,v3); 
neq39 := k(v1,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq40 := k(v1,k(v3,v0)); 
neq41 := k(v2,k(v3,k(v2,k(v0,v1)))); 
neq42 := k(v2,v3); 
neq43 := k(v2,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq44 := k(v2,k(k(k(v3,k(v0,v1)),v2),v1)); 
neq45 := k(v2,k(v3,v0)); 
neq46 := k(v2,k(v0,v1)); 
neq47 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,k(v0,v1)),v2)); 
neq48 := k(k(v3,k(v2,k(v0,v1))),k(k(v3,v0),v2)); 
neq49 := k(k(v3,k(v2,k(v0,v1))),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq50 := k(k(v3,k(v2,k(v0,v1))),k(v3,v0)); 
neq51 := k(k(v3,k(v2,k(v0,v1))),k(v0,v1)); 
neq52 := k(k(k(v3,k(v0,v1)),v2),k(k(v3,v0),v2)); 
neq53 := k(k(k(v3,k(v0,v1)),v2),v3); 
neq54 := k(k(k(v3,k(v0,v1)),v2),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq55 := k(k(k(v3,k(v0,v1)),v2),k(v3,v0)); 
neq56 := k(k(k(v3,k(v0,v1)),v2),k(v0,v1)); 
neq57 := k(k(k(v3,v0),v2),v3); 
neq58 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq59 := k(k(k(v3,v0),v2),k(k(k(v3,k(v0,v1)),v2),v1)); 
neq60 := k(k(k(v3,v0),v2),k(v0,v1)); 
neq61 := k(v3,k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))); 
neq62 := k(v3,k(k(k(v3,k(v0,v1)),v2),v1)); 
neq63 := k(v3,k(v0,v1)); 
neq64 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1)))),k(v3,v0)); 
neq65 := k(k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1)))),k(v0,v1)); 
...
phi := 
       ...
       d(k(k(k(v3,k(v0,v1)),v2),v1),k(k(k(k(v3,v0),v2),k(v0,v1)),k(v3,k(v2,k(v0,v1))))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
