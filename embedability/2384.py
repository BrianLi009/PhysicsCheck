...
def test_embed(): 
    ...
    s.add(((z_9*x_11-x_9*z_11)*z_3-(x_9*y_11-y_9*x_11)*y_3)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_3-(y_9*z_11-z_9*y_11)*z_3)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_3-(z_9*x_11-x_9*z_11)*x_3)==0) 
