...
neq2 := k(k(v2,k(v0,v1)),k(k(v3,v0),k(k(v3,v2),v1))); 
...
neq13 := k(v2,k(k(v3,v0),k(k(v3,v2),v1))); 
...
neq21 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(v3,v2)); 
neq22 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(v3,v2),v1)); 
...
neq30 := k(v3,k(k(v3,v0),k(k(v3,v2),v1))); 
neq31 := k(v3,k(k(v3,v2),v1)); 
neq32 := k(v3,k(v2,v0)); 
neq33 := k(v3,k(v0,v1)); 
neq34 := k(v3,v0); 
neq35 := k(v3,v1); 
neq36 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v0),k(k(v3,v2),v1))); 
neq37 := k(k(k(v3,v1),k(v2,v0)),k(v3,v2)); 
neq38 := k(k(k(v3,v1),k(v2,v0)),k(k(v3,v2),v1)); 
...
neq43 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v2)); 
neq44 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v3,v1)); 
neq45 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v2,v0)); 
neq46 := k(k(k(v3,v0),k(k(v3,v2),v1)),k(v0,v1)); 
neq47 := k(k(k(v3,v0),k(k(v3,v2),v1)),v0); 
neq48 := k(k(k(v3,v0),k(k(v3,v2),v1)),v1); 
neq49 := k(k(v3,v2),k(v3,v1)); 
neq50 := k(k(v3,v2),k(v3,v0)); 
neq51 := k(k(v3,v2),k(v2,v0)); 
neq52 := k(k(v3,v2),k(v0,v1)); 
neq53 := k(k(v3,v2),v0); 
neq54 := k(k(v3,v2),v1); 
neq55 := k(k(k(v3,v2),v1),k(v3,v1)); 
...
phi := 
       ...
       d(k(k(k(v3,v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(v3,v0),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
