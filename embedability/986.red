...
neq1 := k(v2,k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3)); 
neq5 := k(v2,k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1)))); 
neq6 := k(v2,v3); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,k(k(k(v3,v1),v2),v0)); 
neq9 := k(v2,k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq10 := k(k(v3,k(v0,v1)),k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1))); 
neq11 := k(k(v3,k(v0,v1)),v0); 
neq12 := k(k(v3,k(v0,v1)),v1); 
neq13 := k(k(v3,k(v0,v1)),k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2)); 
neq14 := k(k(v3,k(v0,v1)),k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3)); 
neq15 := k(k(v3,k(v0,v1)),k(v3,v1)); 
neq16 := k(k(v3,k(v0,v1)),k(k(k(v3,v1),v2),v0)); 
neq17 := k(k(v3,k(v0,v1)),k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq18 := k(k(v3,k(v0,v1)),k(k(v3,v1),v2)); 
neq19 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v0); 
neq20 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v1); 
neq21 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2)); 
neq22 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1)))); 
neq23 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3); 
neq24 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),k(v3,v1)); 
neq25 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),k(k(k(v3,v1),v2),v0)); 
neq26 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),k(k(v3,v1),v2)); 
neq27 := k(v0,k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2)); 
neq28 := k(v0,k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3)); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1)))); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(v3,v1)); 
neq32 := k(v0,k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq33 := k(v0,k(k(v3,v1),v2)); 
neq34 := k(v1,k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2)); 
neq35 := k(v1,k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3)); 
neq36 := k(v1,k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1)))); 
neq37 := k(v1,v3); 
neq38 := k(v1,k(k(k(v3,v1),v2),v0)); 
neq39 := k(v1,k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq40 := k(v1,k(k(v3,v1),v2)); 
neq41 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),v3); 
neq42 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),k(v3,v1)); 
neq43 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),k(k(k(v3,v1),v2),v0)); 
neq44 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq45 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),k(k(v3,v1),v2)); 
neq46 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2),k(v0,v1)); 
neq47 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1)))); 
neq48 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(v3,v1)); 
neq49 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(k(k(v3,v1),v2),v0)); 
neq50 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq51 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(k(v3,v1),v2)); 
neq52 := k(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(v0,v1)); 
neq53 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v3); 
neq54 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),k(v3,v1)); 
neq55 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),k(k(k(v3,v1),v2),v0)); 
neq56 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),k(k(v3,v1),v2)); 
neq57 := k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),k(v0,v1)); 
neq58 := k(v3,k(k(k(v3,v1),v2),v0)); 
neq59 := k(v3,k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq60 := k(v3,k(k(v3,v1),v2)); 
neq61 := k(v3,k(v0,v1)); 
neq62 := k(k(v3,v1),k(k(k(v3,v1),v2),v0)); 
neq63 := k(k(v3,v1),k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2))); 
neq64 := k(k(v3,v1),k(v0,v1)); 
neq65 := k(k(k(k(v3,v1),v2),v0),k(v0,v1)); 
neq66 := k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)); 
neq67 := k(k(k(v3,v1),v2),k(v0,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v0,v1)),v3),k(k(k(k(k(k(v3,v1),v2),v0),k(k(v3,v1),v2)),k(v3,k(v0,v1))),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
