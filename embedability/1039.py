...
def test_embed(): 
    ...
    s.add(((z_7*x_9-x_7*z_9)*z_8-(x_7*y_9-y_7*x_9)*y_8)==0) 
    s.add(((x_7*y_9-y_7*x_9)*x_8-(y_7*z_9-z_7*y_9)*z_8)==0) 
    s.add(((y_7*z_9-z_7*y_9)*y_8-(z_7*x_9-x_7*z_9)*x_8)==0) 
    s.add(((z_8*x_9-x_8*z_9)*z_10-(x_8*y_9-y_8*x_9)*y_10)==0) 
    s.add(((x_8*y_9-y_8*x_9)*x_10-(y_8*z_9-z_8*y_9)*z_10)==0) 
    s.add(((y_8*z_9-z_8*y_9)*y_10-(z_8*x_9-x_8*z_9)*x_10)==0) 
    ...
    s.add(((z_7*x_8-x_7*z_8)*z_1-(x_7*y_8-y_7*x_8)*y_1)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_1-(y_7*z_8-z_7*y_8)*z_1)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_1-(z_7*x_8-x_7*z_8)*x_1)==0) 
    ...
    s.add(((z_2*x_10-x_2*z_10)*z_4-(x_2*y_10-y_2*x_10)*y_4)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_4-(y_2*z_10-z_2*y_10)*z_4)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_4-(z_2*x_10-x_2*z_10)*x_4)==0) 
    ...
    s.add(((z_3*x_6-x_3*z_6)*z_5-(x_3*y_6-y_3*x_6)*y_5)==0) 
    s.add(((x_3*y_6-y_3*x_6)*x_5-(y_3*z_6-z_3*y_6)*z_5)==0) 
    s.add(((y_3*z_6-z_3*y_6)*y_5-(z_3*x_6-x_3*z_6)*x_5)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_7 == 0) 
