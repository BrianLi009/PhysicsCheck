...
neq2 := k(v2,k(v4,v3)); 
neq3 := k(v2,v4); 
neq4 := k(v2,k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq5 := k(v2,k(k(v4,v3),k(k(v3,v0),v2))); 
neq6 := k(v2,k(v4,k(v2,v1))); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v3,v0)); 
neq10 := k(k(k(v3,v0),v2),k(v2,v1)); 
neq11 := k(k(k(v3,v0),v2),k(k(v3,v1),v2)); 
neq12 := k(k(k(v3,v0),v2),v0); 
neq13 := k(k(k(v3,v0),v2),v3); 
neq14 := k(k(k(v3,v0),v2),k(v4,v3)); 
neq15 := k(k(k(v3,v0),v2),v4); 
neq16 := k(k(k(v3,v0),v2),k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq17 := k(k(k(v3,v0),v2),k(v4,k(v2,v1))); 
neq18 := k(k(k(v3,v0),v2),k(v3,v1)); 
neq19 := k(k(k(v3,v0),v2),v1); 
neq20 := k(k(v2,v1),k(k(v3,v1),v2)); 
neq21 := k(k(v2,v1),v0); 
neq22 := k(k(v2,v1),v3); 
neq23 := k(k(v2,v1),k(v4,v3)); 
neq24 := k(k(v2,v1),v4); 
neq25 := k(k(v2,v1),k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq26 := k(k(v2,v1),k(k(v4,v3),k(k(v3,v0),v2))); 
neq27 := k(k(v2,v1),k(v3,v1)); 
neq28 := k(k(v2,v1),k(v3,v0)); 
neq29 := k(k(k(v3,v1),v2),v0); 
neq30 := k(k(k(v3,v1),v2),v3); 
neq31 := k(k(k(v3,v1),v2),k(v4,v3)); 
neq32 := k(k(k(v3,v1),v2),v4); 
neq33 := k(k(k(v3,v1),v2),k(k(v4,v3),k(k(v3,v0),v2))); 
neq34 := k(k(k(v3,v1),v2),k(v4,k(v2,v1))); 
neq35 := k(k(k(v3,v1),v2),v1); 
neq36 := k(k(k(v3,v1),v2),k(v3,v0)); 
neq37 := k(v0,v3); 
neq38 := k(v0,k(v4,v3)); 
neq39 := k(v0,k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq40 := k(v0,k(k(v4,v3),k(k(v3,v0),v2))); 
neq41 := k(v0,k(v4,k(v2,v1))); 
neq42 := k(v0,k(v3,v1)); 
neq43 := k(v3,v4); 
neq44 := k(v3,k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq45 := k(v3,k(k(v4,v3),k(k(v3,v0),v2))); 
neq46 := k(v3,k(v4,k(v2,v1))); 
neq47 := k(v3,v1); 
neq48 := k(k(v4,v3),k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq49 := k(k(v4,v3),k(v4,k(v2,v1))); 
neq50 := k(k(v4,v3),k(v3,v1)); 
neq51 := k(k(v4,v3),v1); 
neq52 := k(k(v4,v3),k(v3,v0)); 
neq53 := k(v4,k(k(v4,k(v2,v1)),k(k(v3,v1),v2))); 
neq54 := k(v4,k(k(v4,v3),k(k(v3,v0),v2))); 
neq55 := k(v4,k(v3,v1)); 
neq56 := k(v4,v1); 
neq57 := k(v4,k(v3,v0)); 
neq58 := k(k(k(v4,k(v2,v1)),k(k(v3,v1),v2)),k(v3,v1)); 
neq59 := k(k(k(v4,k(v2,v1)),k(k(v3,v1),v2)),v1); 
neq60 := k(k(k(v4,k(v2,v1)),k(k(v3,v1),v2)),k(v3,v0)); 
neq61 := k(k(k(v4,v3),k(k(v3,v0),v2)),k(v4,k(v2,v1))); 
neq62 := k(k(k(v4,v3),k(k(v3,v0),v2)),k(v3,v1)); 
neq63 := k(k(k(v4,v3),k(k(v3,v0),v2)),v1); 
neq64 := k(k(k(v4,v3),k(k(v3,v0),v2)),k(v3,v0)); 
neq65 := k(k(v4,k(v2,v1)),k(v3,v1)); 
neq66 := k(k(v4,k(v2,v1)),v1); 
neq67 := k(k(v4,k(v2,v1)),k(v3,v0)); 
neq68 := k(k(v3,v1),k(v3,v0)); 
neq69 := k(v1,k(v3,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v4,v0) = 0 and 
       d(k(k(v4,v3),k(k(v3,v0),v2)),k(k(v4,k(v2,v1)),k(k(v3,v1),v2))) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
