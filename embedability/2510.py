...
def test_embed(): 
    ...
    s.add(((z_10*x_13-x_10*z_13)*z_9-(x_10*y_13-y_10*x_13)*y_9)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_9-(y_10*z_13-z_10*y_13)*z_9)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_9-(z_10*x_13-x_10*z_13)*x_9)==0) 
    s.add(((z_12*x_13-x_12*z_13)*z_0-(x_12*y_13-y_12*x_13)*y_0)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_0-(y_12*z_13-z_12*y_13)*z_0)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_0-(z_12*x_13-x_12*z_13)*x_0)==0) 
    s.add(((z_0*x_11-x_0*z_11)*z_8-(x_0*y_11-y_0*x_11)*y_8)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_8-(y_0*z_11-z_0*y_11)*z_8)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_8-(z_0*x_11-x_0*z_11)*x_8)==0) 
    s.add(((z_1*x_13-x_1*z_13)*z_2-(x_1*y_13-y_1*x_13)*y_2)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_2-(y_1*z_13-z_1*y_13)*z_2)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_2-(z_1*x_13-x_1*z_13)*x_2)==0) 
    s.add(((z_1*x_12-x_1*z_12)*z_6-(x_1*y_12-y_1*x_12)*y_6)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_6-(y_1*z_12-z_1*y_12)*z_6)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_6-(z_1*x_12-x_1*z_12)*x_6)==0) 
    s.add(((z_2*x_11-x_2*z_11)*z_7-(x_2*y_11-y_2*x_11)*y_7)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_7-(y_2*z_11-z_2*y_11)*z_7)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_7-(z_2*x_11-x_2*z_11)*x_7)==0) 
    s.add(((z_10*x_12-x_10*z_12)*z_3-(x_10*y_12-y_10*x_12)*y_3)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_3-(y_10*z_12-z_10*y_12)*z_3)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_3-(z_10*x_12-x_10*z_12)*x_3)==0) 
    s.add(((z_3*x_8-x_3*z_8)*z_4-(x_3*y_8-y_3*x_8)*y_4)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_4-(y_3*z_8-z_3*y_8)*z_4)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_4-(z_3*x_8-x_3*z_8)*x_4)==0) 
    s.add(((z_6*x_9-x_6*z_9)*z_5-(x_6*y_9-y_6*x_9)*y_5)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_5-(y_6*z_9-z_6*y_9)*z_5)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_5-(z_6*x_9-x_6*z_9)*x_5)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
