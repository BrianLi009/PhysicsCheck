...
def test_embed(): 
    ...
    s.add(((z_4*x_10-x_4*z_10)*z_9-(x_4*y_10-y_4*x_10)*y_9)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_9-(y_4*z_10-z_4*y_10)*z_9)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_9-(z_4*x_10-x_4*z_10)*x_9)==0) 
    s.add(((z_7*x_11-x_7*z_11)*z_5-(x_7*y_11-y_7*x_11)*y_5)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_5-(y_7*z_11-z_7*y_11)*z_5)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_5-(z_7*x_11-x_7*z_11)*x_5)==0) 
    s.add(((z_5*x_8-x_5*z_8)*z_6-(x_5*y_8-y_5*x_8)*y_6)==0) 
    s.add(((x_5*y_8-y_5*x_8)*x_6-(y_5*z_8-z_5*y_8)*z_6)==0) 
    s.add(((y_5*z_8-z_5*y_8)*y_6-(z_5*x_8-x_5*z_8)*x_6)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_3 == 0) 
