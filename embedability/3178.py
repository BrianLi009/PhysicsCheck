...
def test_embed(): 
    ...
    s.add(((z_0*x_11-x_0*z_11)*z_2-(x_0*y_11-y_0*x_11)*y_2)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_2-(y_0*z_11-z_0*y_11)*z_2)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_2-(z_0*x_11-x_0*z_11)*x_2)==0) 
    ...
    s.add(((z_4*x_13-x_4*z_13)*z_5-(x_4*y_13-y_4*x_13)*y_5)==0) 
    s.add(((x_4*y_13-y_4*x_13)*x_5-(y_4*z_13-z_4*y_13)*z_5)==0) 
    s.add(((y_4*z_13-z_4*y_13)*y_5-(z_4*x_13-x_4*z_13)*x_5)==0) 
