...
neq3 := k(v2,v4); 
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,k(k(v4,v3),v3)); 
neq6 := k(v2,k(k(v4,k(k(v2,v1),v2)),v4)); 
neq7 := k(v2,k(k(k(v4,v3),v3),k(v0,v1))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v4,k(k(v2,v1),v2))); 
neq10 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(k(v2,v1),v2)); 
neq11 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(v2,v1)); 
neq12 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),v0); 
neq13 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),v3); 
neq14 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(v4,v3)); 
neq15 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),v4); 
neq16 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(v0,v1)); 
neq17 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(k(v4,v3),v3)); 
neq18 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),v1); 
neq19 := k(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(v4,k(k(v2,v1),v2))); 
neq20 := k(k(k(v2,v1),v2),v0); 
neq21 := k(k(k(v2,v1),v2),v3); 
neq22 := k(k(k(v2,v1),v2),k(v4,v3)); 
neq23 := k(k(k(v2,v1),v2),v4); 
neq24 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq25 := k(k(k(v2,v1),v2),k(k(v4,v3),v3)); 
neq26 := k(k(k(v2,v1),v2),k(k(v4,k(k(v2,v1),v2)),v4)); 
neq27 := k(k(k(v2,v1),v2),k(k(k(v4,v3),v3),k(v0,v1))); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(v2,v1),v0); 
neq30 := k(k(v2,v1),v3); 
neq31 := k(k(v2,v1),k(v4,v3)); 
neq32 := k(k(v2,v1),v4); 
neq33 := k(k(v2,v1),k(v0,v1)); 
neq34 := k(k(v2,v1),k(k(v4,v3),v3)); 
neq35 := k(k(v2,v1),k(k(v4,k(k(v2,v1),v2)),v4)); 
neq36 := k(k(v2,v1),k(k(k(v4,v3),v3),k(v0,v1))); 
neq37 := k(k(v2,v1),k(v4,k(k(v2,v1),v2))); 
neq38 := k(v0,k(v4,v3)); 
neq39 := k(v0,v4); 
neq40 := k(v0,k(k(v4,v3),v3)); 
neq41 := k(v0,k(k(v4,k(k(v2,v1),v2)),v4)); 
neq42 := k(v0,k(k(k(v4,v3),v3),k(v0,v1))); 
neq43 := k(v0,k(v4,k(k(v2,v1),v2))); 
neq44 := k(v3,v4); 
neq45 := k(v3,k(v0,v1)); 
neq46 := k(v3,k(k(v4,k(k(v2,v1),v2)),v4)); 
neq47 := k(v3,k(k(k(v4,v3),v3),k(v0,v1))); 
neq48 := k(v3,v1); 
neq49 := k(v3,k(v4,k(k(v2,v1),v2))); 
neq50 := k(k(v4,v3),k(v0,v1)); 
neq51 := k(k(v4,v3),k(k(v4,k(k(v2,v1),v2)),v4)); 
neq52 := k(k(v4,v3),k(k(k(v4,v3),v3),k(v0,v1))); 
neq53 := k(k(v4,v3),v1); 
neq54 := k(k(v4,v3),k(v4,k(k(v2,v1),v2))); 
neq55 := k(v4,k(v0,v1)); 
neq56 := k(v4,k(k(v4,v3),v3)); 
neq57 := k(v4,k(k(k(v4,v3),v3),k(v0,v1))); 
neq58 := k(v4,v1); 
neq59 := k(k(v0,v1),k(k(v4,v3),v3)); 
neq60 := k(k(v0,v1),k(k(v4,k(k(v2,v1),v2)),v4)); 
neq61 := k(k(v0,v1),k(v4,k(k(v2,v1),v2))); 
neq62 := k(k(k(v4,v3),v3),k(k(v4,k(k(v2,v1),v2)),v4)); 
neq63 := k(k(k(v4,v3),v3),v1); 
neq64 := k(k(k(v4,v3),v3),k(v4,k(k(v2,v1),v2))); 
neq65 := k(k(k(v4,k(k(v2,v1),v2)),v4),k(k(k(v4,v3),v3),k(v0,v1))); 
neq66 := k(k(k(v4,k(k(v2,v1),v2)),v4),v1); 
neq67 := k(k(k(k(v4,v3),v3),k(v0,v1)),v1); 
neq68 := k(k(k(k(v4,v3),v3),k(v0,v1)),k(v4,k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v4,k(k(v2,v1),v2)),v4),v2),k(k(k(v4,v3),v3),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
