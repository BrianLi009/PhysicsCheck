...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1))); 
neq1 := k(v2,k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)))); 
neq2 := k(v2,k(v0,v1)); 
neq3 := k(v2,v0); 
neq4 := k(v2,v3); 
neq5 := k(v2,k(k(v3,v1),k(v2,v0))); 
neq6 := k(v2,k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq7 := k(v2,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v3,v1)); 
neq10 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(v3,v1),v2)); 
neq11 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(v3,v2)); 
neq12 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),v0); 
neq13 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),v3); 
neq14 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(v3,v1),k(v2,v0))); 
neq15 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq16 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(v2,v0)); 
neq17 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),v1); 
neq18 := k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(v3,v1)); 
neq19 := k(k(k(v3,v1),v2),k(v3,v2)); 
neq20 := k(k(k(v3,v1),v2),k(v0,v1)); 
neq21 := k(k(k(v3,v1),v2),v0); 
neq22 := k(k(k(v3,v1),v2),v3); 
neq23 := k(k(k(v3,v1),v2),k(k(v3,v1),k(v2,v0))); 
neq24 := k(k(k(v3,v1),v2),k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq25 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq26 := k(k(k(v3,v1),v2),k(v2,v0)); 
neq27 := k(k(k(v3,v1),v2),v1); 
neq28 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(v3,v2)); 
neq29 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(v0,v1)); 
neq30 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),v0); 
neq31 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),v3); 
neq32 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(k(v3,v1),k(v2,v0))); 
neq33 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq34 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(v2,v0)); 
neq35 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),v1); 
neq36 := k(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(v3,v1)); 
neq37 := k(k(v3,v2),k(v0,v1)); 
neq38 := k(k(v3,v2),v0); 
neq39 := k(k(v3,v2),k(k(v3,v1),k(v2,v0))); 
neq40 := k(k(v3,v2),k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq41 := k(k(v3,v2),k(v2,v0)); 
neq42 := k(k(v3,v2),v1); 
neq43 := k(k(v3,v2),k(v3,v1)); 
neq44 := k(k(v0,v1),v3); 
neq45 := k(k(v0,v1),k(k(v3,v1),k(v2,v0))); 
neq46 := k(k(v0,v1),k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq47 := k(k(v0,v1),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq48 := k(k(v0,v1),k(v2,v0)); 
neq49 := k(k(v0,v1),k(v3,v1)); 
neq50 := k(v0,v3); 
neq51 := k(v0,k(k(v3,v1),k(v2,v0))); 
neq52 := k(v0,k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq53 := k(v0,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq54 := k(v0,k(v3,v1)); 
neq55 := k(v3,k(k(v3,v1),k(v2,v0))); 
neq56 := k(v3,k(k(k(v3,v1),k(v2,v0)),k(v2,v0))); 
neq57 := k(v3,k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq58 := k(v3,k(v2,v0)); 
neq59 := k(k(k(v3,v1),k(v2,v0)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))); 
neq60 := k(k(k(v3,v1),k(v2,v0)),v1); 
neq61 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),v1); 
neq62 := k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v1)); 
neq63 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v2,v0)); 
neq64 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),v1); 
neq65 := k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v3,v1)); 
neq66 := k(k(v2,v0),v1); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2)),k(v0,v1)),k(k(k(k(v3,v1),k(v2,v0)),k(v2,v0)),k(v3,v2))),k(k(v3,v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
