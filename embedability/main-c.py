    ...
    if result == sat:
        ...
        if verify:
            ...
            with open("solution.log", "w+") as f2:
                for i in g:
                    f2.write(str(i)+"\n")
                    f2.write(str(m.evaluate(ver[i][0].r)).replace("?","")+"\n")
                    f2.write(str(m.evaluate(ver[i][0].i)).replace("?","")+"\n")
                    f2.write(str(m.evaluate(ver[i][1].r)).replace("?","")+"\n")
                    f2.write(str(m.evaluate(ver[i][1].i)).replace("?","")+"\n")
                    f2.write(str(m.evaluate(ver[i][2].r)).replace("?","")+"\n")
                    f2.write(str(m.evaluate(ver[i][2].i)).replace("?","")+"\n")
