...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v2,v0),k(v3,k(v0,v1))); 
neq1 := k(k(v2,v0),v3); 
neq2 := k(k(v2,v0),k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1))); 
neq3 := k(k(v2,v0),k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1))); 
neq4 := k(k(v2,v0),k(v0,v1)); 
neq5 := k(k(v2,v0),k(v3,v1)); 
neq6 := k(k(v2,v0),k(v2,v1)); 
neq7 := k(k(v2,v0),k(k(v3,k(v0,v1)),v3)); 
neq8 := k(k(v2,v0),v1); 
neq9 := k(k(v2,v0),k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq10 := k(k(v3,k(v0,v1)),v2); 
neq11 := k(k(v3,k(v0,v1)),k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1))); 
neq12 := k(k(v3,k(v0,v1)),k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1))); 
neq13 := k(k(v3,k(v0,v1)),v0); 
neq14 := k(k(v3,k(v0,v1)),k(v3,v1)); 
neq15 := k(k(v3,k(v0,v1)),k(v2,v1)); 
neq16 := k(k(v3,k(v0,v1)),k(k(v2,v0),v2)); 
neq17 := k(k(v3,k(v0,v1)),v1); 
neq18 := k(k(v3,k(v0,v1)),k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq19 := k(v2,v3); 
neq20 := k(v2,k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1))); 
neq21 := k(v2,k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1))); 
neq22 := k(v2,v0); 
neq23 := k(v2,k(v0,v1)); 
neq24 := k(v2,k(v3,v1)); 
neq25 := k(v2,k(k(v3,k(v0,v1)),v3)); 
neq26 := k(v2,v1); 
neq27 := k(v2,k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq28 := k(v3,k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1))); 
neq29 := k(v3,k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1))); 
neq30 := k(v3,v0); 
neq31 := k(v3,k(v0,v1)); 
neq32 := k(v3,k(v2,v1)); 
neq33 := k(v3,k(k(v2,v0),v2)); 
neq34 := k(v3,v1); 
neq35 := k(v3,k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq36 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),v0); 
neq37 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),k(v0,v1)); 
neq38 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),k(v3,v1)); 
neq39 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),k(k(v2,v0),v2)); 
neq40 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),k(k(v3,k(v0,v1)),v3)); 
neq41 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),v1); 
neq42 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),v0); 
neq43 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),k(v0,v1)); 
neq44 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),k(v2,v1)); 
neq45 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),k(k(v2,v0),v2)); 
neq46 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),k(k(v3,k(v0,v1)),v3)); 
neq47 := k(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1)),v1); 
neq48 := k(v0,k(v3,v1)); 
neq49 := k(v0,k(v2,v1)); 
neq50 := k(v0,k(k(v2,v0),v2)); 
neq51 := k(v0,k(k(v3,k(v0,v1)),v3)); 
neq52 := k(v0,k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq53 := k(k(v0,v1),k(v3,v1)); 
neq54 := k(k(v0,v1),k(v2,v1)); 
neq55 := k(k(v0,v1),k(k(v2,v0),v2)); 
neq56 := k(k(v0,v1),k(k(v3,k(v0,v1)),v3)); 
neq57 := k(k(v0,v1),k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq58 := k(k(v3,v1),k(v2,v1)); 
neq59 := k(k(v3,v1),k(k(v2,v0),v2)); 
neq60 := k(k(v3,v1),k(k(v3,k(v0,v1)),v3)); 
neq61 := k(k(v3,v1),k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq62 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq63 := k(k(v2,v1),k(k(v3,k(v0,v1)),v3)); 
neq64 := k(k(v2,v1),k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
neq65 := k(k(k(v2,v0),v2),k(k(v3,k(v0,v1)),v3)); 
neq66 := k(k(k(v2,v0),v2),v1); 
neq67 := k(k(k(v3,k(v0,v1)),v3),v1); 
neq68 := k(v1,k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v3,k(v0,v1)),v3),k(k(v2,v0),v2)),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
