...
neq8 := k(v2,k(v3,v1)); 
neq9 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(k(v3,v1),v3),v0),v2),v3)); 
neq10 := k(k(k(k(v3,v1),v3),v0),k(v0,v1)); 
neq11 := k(k(k(k(v3,v1),v3),v0),k(k(k(v3,v1),v1),v2)); 
neq12 := k(k(k(k(v3,v1),v3),v0),k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1))); 
neq13 := k(k(k(k(v3,v1),v3),v0),v3); 
neq14 := k(k(k(k(v3,v1),v3),v0),v1); 
neq15 := k(k(k(k(v3,v1),v3),v0),k(k(v3,v1),v1)); 
neq16 := k(k(k(k(v3,v1),v3),v0),k(v3,v1)); 
neq17 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(v0,v1)); 
neq18 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),v0); 
neq19 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(k(k(v3,v1),v1),v2)); 
neq20 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(k(v3,v1),v3)); 
neq21 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),v1); 
neq22 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(k(v3,v1),v1)); 
neq23 := k(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(v3,v1)); 
neq24 := k(k(k(k(k(v3,v1),v3),v0),v2),k(v0,v1)); 
neq25 := k(k(k(k(k(v3,v1),v3),v0),v2),v0); 
neq26 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(k(v3,v1),v1),v2)); 
neq27 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1))); 
neq28 := k(k(k(k(k(v3,v1),v3),v0),v2),v3); 
neq29 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(v3,v1),v3)); 
neq30 := k(k(k(k(k(v3,v1),v3),v0),v2),v1); 
neq31 := k(k(k(k(k(v3,v1),v3),v0),v2),k(k(v3,v1),v1)); 
neq32 := k(k(k(k(k(v3,v1),v3),v0),v2),k(v3,v1)); 
neq33 := k(k(v0,v1),k(k(k(v3,v1),v1),v2)); 
neq34 := k(k(v0,v1),k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1))); 
neq35 := k(k(v0,v1),v3); 
neq36 := k(k(v0,v1),k(k(v3,v1),v3)); 
neq37 := k(k(v0,v1),k(k(v3,v1),v1)); 
neq38 := k(k(v0,v1),k(v3,v1)); 
neq39 := k(v0,k(k(k(v3,v1),v1),v2)); 
neq40 := k(v0,k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1))); 
neq41 := k(v0,v3); 
neq42 := k(v0,k(k(v3,v1),v3)); 
neq43 := k(v0,k(k(v3,v1),v1)); 
neq44 := k(v0,k(v3,v1)); 
neq45 := k(k(k(k(v3,v1),v1),v2),v3); 
neq46 := k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v3)); 
neq47 := k(k(k(k(v3,v1),v1),v2),v1); 
neq48 := k(k(k(k(v3,v1),v1),v2),k(v3,v1)); 
neq49 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1)),v3); 
neq50 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1)),k(k(v3,v1),v3)); 
neq51 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1)),v1); 
neq52 := k(k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1)),k(v3,v1)); 
neq53 := k(v3,v1); 
neq54 := k(v3,k(k(v3,v1),v1)); 
neq55 := k(k(k(v3,v1),v3),v1); 
neq56 := k(k(k(v3,v1),v3),k(k(v3,v1),v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(v3,v1),v3),v0),v2),v3),k(k(k(k(v3,v1),v1),v2),k(k(v3,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
