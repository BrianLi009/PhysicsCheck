...
def test_embed(): 
    ...
    s.add(((z_3*x_8-x_3*z_8)*z_9-(x_3*y_8-y_3*x_8)*y_9)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_9-(y_3*z_8-z_3*y_8)*z_9)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_9-(z_3*x_8-x_3*z_8)*x_9)==0) 
    s.add(((z_4*x_7-x_4*z_7)*z_10-(x_4*y_7-y_4*x_7)*y_10)==0) 
    s.add(((x_4*y_7-y_4*x_7)*x_10-(y_4*z_7-z_4*y_7)*z_10)==0) 
    s.add(((y_4*z_7-z_4*y_7)*y_10-(z_4*x_7-x_4*z_7)*x_10)==0) 
