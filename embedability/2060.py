...
def test_embed(): 
    ...
    s.add(((z_7*x_10-x_7*z_10)*z_8-(x_7*y_10-y_7*x_10)*y_8)==0) 
    s.add(((x_7*y_10-y_7*x_10)*x_8-(y_7*z_10-z_7*y_10)*z_8)==0) 
    s.add(((y_7*z_10-z_7*y_10)*y_8-(z_7*x_10-x_7*z_10)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
