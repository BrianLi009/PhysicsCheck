...
def test_embed(): 
    ...
    s.add(((z_6*x_12-x_6*z_12)*z_5-(x_6*y_12-y_6*x_12)*y_5)==0) 
    s.add(((x_6*y_12-y_6*x_12)*x_5-(y_6*z_12-z_6*y_12)*z_5)==0) 
    s.add(((y_6*z_12-z_6*y_12)*y_5-(z_6*x_12-x_6*z_12)*x_5)==0) 
