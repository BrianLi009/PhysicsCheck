...
neq7 := k(v0,k(k(v3,v1),v2)); 
neq8 := k(v1,k(k(k(v3,v1),v2),v0)); 
neq9 := k(v1,k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq10 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq11 := k(v1,v2); 
neq12 := k(v1,k(k(v2,v1),v2)); 
neq13 := k(v1,v3); 
neq14 := k(v1,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq15 := k(v1,k(k(v3,v1),v2)); 
neq16 := k(k(k(k(v3,v1),v2),v0),k(v3,k(k(v2,v1),v2))); 
neq17 := k(k(k(k(v3,v1),v2),v0),v2); 
neq18 := k(k(k(k(v3,v1),v2),v0),k(k(v2,v1),v2)); 
neq19 := k(k(k(k(v3,v1),v2),v0),v3); 
neq20 := k(k(k(k(v3,v1),v2),v0),k(v3,v1)); 
neq21 := k(k(k(k(v3,v1),v2),v0),k(v2,v1)); 
neq22 := k(k(k(k(v3,v1),v2),v0),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq23 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v3,k(k(v2,v1),v2))); 
neq24 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v2); 
neq25 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(v2,v1),v2)); 
neq26 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),v3); 
neq27 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v3,v1)); 
neq28 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)); 
neq29 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(v3,v1),v2)); 
neq30 := k(k(v3,k(k(v2,v1),v2)),v2); 
neq31 := k(k(v3,k(k(v2,v1),v2)),k(v3,v1)); 
neq32 := k(k(v3,k(k(v2,v1),v2)),k(v2,v1)); 
neq33 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v1),v2)); 
neq34 := k(v2,v3); 
neq35 := k(v2,k(v3,v1)); 
neq36 := k(v2,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq37 := k(k(k(v2,v1),v2),v3); 
neq38 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq39 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq40 := k(k(k(v2,v1),v2),k(k(v3,v1),v2)); 
neq41 := k(v3,k(v2,v1)); 
neq42 := k(v3,k(k(v3,v1),v2)); 
neq43 := k(k(v3,v1),k(v2,v1)); 
neq44 := k(k(v3,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq45 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq46 := k(k(v2,v1),k(k(v3,v1),v2)); 
neq47 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(v3,v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(k(k(v3,v1),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
