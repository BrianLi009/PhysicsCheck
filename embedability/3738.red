...
neq3 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0))); 
neq4 := k(v2,v0); 
...
neq11 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq12 := k(k(v2,v1),k(k(k(v2,v1),v2),v0)); 
neq13 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0))); 
neq14 := k(k(v2,v1),v0); 
neq15 := k(k(v2,v1),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq16 := k(k(v2,v1),v3); 
neq17 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq18 := k(k(v2,v1),k(v0,v1)); 
neq19 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq20 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(v3,k(k(v2,v1),v2))); 
neq21 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq22 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0))); 
neq23 := k(k(k(k(v2,v1),v2),k(v0,v1)),v0); 
neq24 := k(k(k(k(v2,v1),v2),k(v0,v1)),v3); 
neq25 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq26 := k(k(k(k(v2,v1),v2),k(v0,v1)),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq27 := k(k(k(k(v2,v1),v2),k(v0,v1)),v1); 
neq28 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq29 := k(k(v3,k(k(v2,v1),v2)),k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0))); 
neq30 := k(k(v3,k(k(v2,v1),v2)),v0); 
neq31 := k(k(v3,k(k(v2,v1),v2)),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq32 := k(k(v3,k(k(v2,v1),v2)),k(v0,v1)); 
neq33 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq34 := k(k(v3,k(k(v2,v1),v2)),v1); 
neq35 := k(k(k(k(v2,v1),v2),v0),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq36 := k(k(k(k(v2,v1),v2),v0),v3); 
neq37 := k(k(k(k(v2,v1),v2),v0),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq38 := k(k(k(k(v2,v1),v2),v0),k(v0,v1)); 
neq39 := k(k(k(k(v2,v1),v2),v0),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq40 := k(k(k(k(v2,v1),v2),v0),v1); 
neq41 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),v0); 
neq42 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq43 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),v3); 
neq44 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),k(v0,v1)); 
neq45 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),v1); 
neq46 := k(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v2)); 
neq47 := k(v0,k(v3,k(k(k(v2,v1),v2),k(v0,v1)))); 
neq48 := k(v0,v3); 
neq49 := k(v0,k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq50 := k(v0,k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq51 := k(v0,k(k(v2,v1),v2)); 
neq52 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq53 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(v0,v1)); 
neq54 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v1); 
neq55 := k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),k(k(v2,v1),v2)); 
neq56 := k(v3,k(k(v3,k(k(v2,v1),v2)),k(v0,v1))); 
neq57 := k(v3,k(v0,v1)); 
neq58 := k(v3,k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq59 := k(v3,k(k(v2,v1),v2)); 
neq60 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),v1); 
neq61 := k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(v2,v1),v2)); 
neq62 := k(k(v0,v1),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)); 
neq63 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq64 := k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2),v1); 
neq65 := k(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2),k(k(v2,v1),v2)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2),k(k(v3,k(k(v2,v1),v2)),k(v0,v1))) = 0 and 
       d(k(k(k(v3,k(k(v2,v1),v2)),k(v0,v1)),k(k(k(v2,v1),v2),v0)),k(k(v3,k(k(k(v2,v1),v2),k(v0,v1))),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
