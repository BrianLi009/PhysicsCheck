...
v3c2 := 0;
neq0 := k(v2,v0); 
neq1 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3)); 
neq2 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq3 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq4 := k(v2,v1); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(k(v3,v1),v2),k(v3,v1))); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq9 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3)); 
neq10 := k(k(v2,v0),k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq11 := k(k(v2,v0),v1); 
neq12 := k(k(v2,v0),v3); 
neq13 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq14 := k(k(v2,v0),k(k(k(v3,v1),v2),k(v3,v1))); 
neq15 := k(k(v2,v0),k(v3,v1)); 
neq16 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v0); 
neq17 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq18 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v1); 
neq19 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3); 
neq20 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),k(k(v3,v1),v2)); 
neq21 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),k(k(k(v3,v1),v2),k(v3,v1))); 
neq22 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),k(v3,v1)); 
neq23 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3)); 
neq24 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq25 := k(v0,v3); 
neq26 := k(v0,k(k(v3,v1),v2)); 
neq27 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq28 := k(v0,k(v3,v1)); 
neq29 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq30 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),v1); 
neq31 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),k(k(v3,v1),v2)); 
neq32 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),k(k(k(v3,v1),v2),k(v3,v1))); 
neq33 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),k(v3,v1)); 
neq34 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0))); 
neq35 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v1); 
neq36 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v3); 
neq37 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(v3,v1),v2)); 
neq38 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(v3,v1)); 
neq39 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v1); 
neq40 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3); 
neq41 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(k(v3,v1),v2)); 
neq42 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),k(v3,v1)); 
neq43 := k(v1,k(k(v3,v1),v2)); 
neq44 := k(v1,k(k(k(v3,v1),v2),k(v3,v1))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(v2,v0)),v3),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
