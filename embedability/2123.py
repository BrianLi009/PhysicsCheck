...
def test_embed(): 
    ...
    s.add(((z_2*x_9-x_2*z_9)*z_8-(x_2*y_9-y_2*x_9)*y_8)==0) 
    s.add(((x_2*y_9-y_2*x_9)*x_8-(y_2*z_9-z_2*y_9)*z_8)==0) 
    s.add(((y_2*z_9-z_2*y_9)*y_8-(z_2*x_9-x_2*z_9)*x_8)==0) 
    s.add(((z_3*x_8-x_3*z_8)*z_7-(x_3*y_8-y_3*x_8)*y_7)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_7-(y_3*z_8-z_3*y_8)*z_7)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_7-(z_3*x_8-x_3*z_8)*x_7)==0) 
