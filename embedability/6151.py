...
def test_embed(): 
    ...
    s.add(((z_3*x_11-x_3*z_11)*z_12-(x_3*y_11-y_3*x_11)*y_12)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_12-(y_3*z_11-z_3*y_11)*z_12)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_12-(z_3*x_11-x_3*z_11)*x_12)==0) 
