...
def test_embed(): 
    ...
    s.add(((z_1*x_6-x_1*z_6)*z_4-(x_1*y_6-y_1*x_6)*y_4)==0) 
    s.add(((x_1*y_6-y_1*x_6)*x_4-(y_1*z_6-z_1*y_6)*z_4)==0) 
    s.add(((y_1*z_6-z_1*y_6)*y_4-(z_1*x_6-x_1*z_6)*x_4)==0) 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_2-(x_5*y_10-y_5*x_10)*y_2)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_2-(y_5*z_10-z_5*y_10)*z_2)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_2-(z_5*x_10-x_5*z_10)*x_2)==0) 
    s.add(((z_2*x_10-x_2*z_10)*z_3-(x_2*y_10-y_2*x_10)*y_3)==0) 
    s.add(((x_2*y_10-y_2*x_10)*x_3-(y_2*z_10-z_2*y_10)*z_3)==0) 
    s.add(((y_2*z_10-z_2*y_10)*y_3-(z_2*x_10-x_2*z_10)*x_3)==0) 
