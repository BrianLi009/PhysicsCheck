...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),v2); 
neq1 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3))); 
neq2 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq3 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq4 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),v3); 
neq5 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(v3,v2),v3),v1)); 
neq6 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(v3,v2),v3)); 
neq7 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(k(k(k(v3,v2),v3),v1),v1)); 
neq8 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),v1); 
neq9 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0),k(v3,v2)); 
neq10 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3))); 
neq11 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),v0); 
neq12 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq13 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),v3); 
neq14 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq15 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(v3,v2),v3),v1)); 
neq16 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(v3,v2),v3)); 
neq17 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(k(v3,v2),v3),v1),v1)); 
neq18 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),v1); 
neq19 := k(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(v3,v2)); 
neq20 := k(v2,k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3))); 
neq21 := k(v2,v0); 
neq22 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq23 := k(v2,v3); 
neq24 := k(v2,k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq25 := k(v2,k(k(k(v3,v2),v3),v1)); 
neq26 := k(v2,k(k(v3,v2),v3)); 
neq27 := k(v2,k(k(k(k(v3,v2),v3),v1),v1)); 
neq28 := k(v2,v1); 
neq29 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v0); 
neq30 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v3); 
neq31 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq32 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),k(k(k(v3,v2),v3),v1)); 
neq33 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),k(k(k(k(v3,v2),v3),v1),v1)); 
neq34 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1); 
neq35 := k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),k(v3,v2)); 
neq36 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1)); 
neq37 := k(v0,k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq38 := k(v0,k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq39 := k(v0,k(k(k(v3,v2),v3),v1)); 
neq40 := k(v0,k(k(v3,v2),v3)); 
neq41 := k(v0,k(k(k(k(v3,v2),v3),v1),v1)); 
neq42 := k(v0,k(v3,v2)); 
neq43 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(k(k(v3,v2),v3),v1),v1),v2)); 
neq44 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v3); 
neq45 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq46 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),v1)); 
neq47 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(v3,v2),v3)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(k(k(k(v3,v2),v3),v1),v1)); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),k(v3,v2)); 
neq50 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v3); 
neq51 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq52 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(k(v3,v2),v3),v1)); 
neq53 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)); 
neq54 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),v1); 
neq55 := k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(v3,v2)); 
neq56 := k(v3,k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2))); 
neq57 := k(v3,k(k(k(v3,v2),v3),v1)); 
neq58 := k(v3,k(k(k(k(v3,v2),v3),v1),v1)); 
neq59 := k(v3,v1); 
neq60 := k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),k(k(k(v3,v2),v3),v1)); 
neq61 := k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),k(k(v3,v2),v3)); 
neq62 := k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v1); 
neq63 := k(k(k(k(v3,v2),v3),v1),k(v3,v2)); 
neq64 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),v1),v1)); 
neq65 := k(k(k(v3,v2),v3),v1); 
neq66 := k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)); 
neq67 := k(v1,k(v3,v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(k(k(k(v3,v2),v3),v1),v1),v2),k(k(v3,v2),v3)),v1),v2),k(k(k(k(k(k(v3,v2),v3),v1),v1),k(v3,v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
