...
def test_embed(): 
    ...
    s.add(((z_3*x_4-x_3*z_4)*z_7-(x_3*y_4-y_3*x_4)*y_7)==0) 
    s.add(((x_3*y_4-y_3*x_4)*x_7-(y_3*z_4-z_3*y_4)*z_7)==0) 
    s.add(((y_3*z_4-z_3*y_4)*y_7-(z_3*x_4-x_3*z_4)*x_7)==0) 
    ...
    s.add(((z_2*x_4-x_2*z_4)*z_11-(x_2*y_4-y_2*x_4)*y_11)==0) 
    s.add(((x_2*y_4-y_2*x_4)*x_11-(y_2*z_4-z_2*y_4)*z_11)==0) 
    s.add(((y_2*z_4-z_2*y_4)*y_11-(z_2*x_4-x_2*z_4)*x_11)==0) 
