...
def test_embed(): 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_8-(x_7*y_13-y_7*x_13)*y_8)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_8-(y_7*z_13-z_7*y_13)*z_8)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_8-(z_7*x_13-x_7*z_13)*x_8)==0) 
    s.add(((z_8*x_10-x_8*z_10)*z_9-(x_8*y_10-y_8*x_10)*y_9)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_9-(y_8*z_10-z_8*y_10)*z_9)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_9-(z_8*x_10-x_8*z_10)*x_9)==0) 
    s.add(((z_10*x_13-x_10*z_13)*z_0-(x_10*y_13-y_10*x_13)*y_0)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_0-(y_10*z_13-z_10*y_13)*z_0)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_0-(z_10*x_13-x_10*z_13)*x_0)==0) 
    s.add(((z_0*x_10-x_0*z_10)*z_6-(x_0*y_10-y_0*x_10)*y_6)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_6-(y_0*z_10-z_0*y_10)*z_6)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_6-(z_0*x_10-x_0*z_10)*x_6)==0) 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_3-(x_7*y_12-y_7*x_12)*y_3)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_3-(y_7*z_12-z_7*y_12)*z_3)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_3-(z_7*x_12-x_7*z_12)*x_3)==0) 
    s.add(((z_3*x_7-x_3*z_7)*z_4-(x_3*y_7-y_3*x_7)*y_4)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_4-(y_3*z_7-z_3*y_7)*z_4)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_4-(z_3*x_7-x_3*z_7)*x_4)==0) 
