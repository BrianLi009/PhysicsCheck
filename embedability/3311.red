...
neq1 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),k(v2,v1)); 
neq2 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),k(v2,v0)); 
neq3 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),k(k(v2,v1),v2)); 
neq4 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq5 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),v3); 
neq6 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0),k(v3,k(v2,v0))); 
...
neq10 := k(v2,k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0)))); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq13 := k(v2,k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq14 := k(v2,v3); 
neq15 := k(v2,k(v3,k(v2,v0))); 
neq16 := k(v2,k(k(v3,v1),k(k(v2,v1),v2))); 
neq17 := k(v2,v1); 
neq18 := k(v2,k(v3,v1)); 
neq19 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(v2,v1)); 
neq20 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v0); 
neq21 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(v2,v0)); 
neq22 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(v2,v1),v2)); 
neq23 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq24 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v3); 
neq25 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(v3,v1),k(k(v2,v1),v2))); 
neq26 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),v1); 
neq27 := k(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(v3,v1)); 
neq28 := k(k(v2,v1),v0); 
neq29 := k(k(v2,v1),k(v2,v0)); 
neq30 := k(k(v2,v1),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq31 := k(k(v2,v1),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq32 := k(k(v2,v1),v3); 
neq33 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq34 := k(k(v2,v1),k(k(v3,v1),k(k(v2,v1),v2))); 
neq35 := k(k(v2,v1),k(v3,v1)); 
neq36 := k(v0,k(k(v2,v1),v2)); 
neq37 := k(v0,k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq38 := k(v0,k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq39 := k(v0,v3); 
neq40 := k(v0,k(v3,k(v2,v0))); 
neq41 := k(v0,k(k(v3,v1),k(k(v2,v1),v2))); 
neq42 := k(v0,k(v3,v1)); 
neq43 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq44 := k(k(v2,v0),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq45 := k(k(v2,v0),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq46 := k(k(v2,v0),v3); 
neq47 := k(k(v2,v0),k(k(v3,v1),k(k(v2,v1),v2))); 
neq48 := k(k(v2,v0),v1); 
neq49 := k(k(v2,v0),k(v3,v1)); 
neq50 := k(k(k(v2,v1),v2),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1))); 
neq51 := k(k(k(v2,v1),v2),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq52 := k(k(k(v2,v1),v2),v3); 
neq53 := k(k(k(v2,v1),v2),k(v3,k(v2,v0))); 
neq54 := k(k(k(v2,v1),v2),v1); 
neq55 := k(k(k(v2,v1),v2),k(v3,v1)); 
neq56 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0)))); 
neq57 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v3); 
neq58 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),k(v3,k(v2,v0))); 
neq59 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v1); 
neq60 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),v3); 
neq61 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),v1); 
neq62 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,v1)); 
neq63 := k(v3,k(k(v3,v1),k(k(v2,v1),v2))); 
neq64 := k(k(v3,k(v2,v0)),k(k(v3,v1),k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,k(v2,v0))),k(v3,k(v2,v0))),k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(v3,v1)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
