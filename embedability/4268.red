...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),v2); 
neq1 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(v2,v1)); 
neq2 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(k(k(v2,v0),v2),k(v0,v1))); 
neq3 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),v0); 
neq4 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq5 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(k(v2,v0),v2)); 
neq6 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(v2,v0)); 
neq7 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(k(v2,v1),v1)); 
neq8 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),v1); 
neq9 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(v0,v1)); 
neq10 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),v2); 
neq11 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(v2,v1)); 
neq12 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0))); 
neq13 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),v0); 
neq14 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq15 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(v2,v0),v2)); 
neq16 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(v2,v0)); 
neq17 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq18 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),v1); 
neq19 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(v0,v1)); 
neq20 := k(v2,k(k(k(v2,v0),v2),k(v0,v1))); 
neq21 := k(v2,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0))); 
neq22 := k(v2,v0); 
neq23 := k(v2,k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq24 := k(v2,k(k(v2,v1),v1)); 
neq25 := k(v2,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq26 := k(v2,v1); 
neq27 := k(v2,k(v0,v1)); 
neq28 := k(k(v2,v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq29 := k(k(v2,v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0))); 
neq30 := k(k(v2,v1),v0); 
neq31 := k(k(v2,v1),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq32 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq33 := k(k(v2,v1),k(v2,v0)); 
neq34 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq35 := k(k(v2,v1),k(v0,v1)); 
neq36 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0))); 
...
neq40 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)); 
neq41 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq42 := k(k(k(k(v2,v0),v2),k(v0,v1)),v1); 
neq43 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0)),v0); 
neq44 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0)),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq45 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0)),k(k(v2,v0),v2)); 
neq46 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0)),k(k(v2,v1),v1)); 
...
neq52 := k(v0,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq53 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v2,v0)); 
neq54 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v1); 
neq55 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)); 
neq56 := k(k(k(v2,v0),v2),k(k(v2,v1),v1)); 
neq57 := k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq58 := k(k(k(v2,v0),v2),v1); 
neq59 := k(k(k(v2,v0),v2),k(v0,v1)); 
neq60 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq61 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq62 := k(k(v2,v0),v1); 
neq63 := k(k(v2,v0),k(v0,v1)); 
neq64 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))); 
neq65 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq66 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),v1); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1))),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v0,v1)),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
