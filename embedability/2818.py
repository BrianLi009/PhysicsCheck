...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_3-(x_0*y_10-y_0*x_10)*y_3)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_3-(y_0*z_10-z_0*y_10)*z_3)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_3-(z_0*x_10-x_0*z_10)*x_3)==0) 
    ...
    s.add(((z_5*x_6-x_5*z_6)*z_4-(x_5*y_6-y_5*x_6)*y_4)==0) 
    s.add(((x_5*y_6-y_5*x_6)*x_4-(y_5*z_6-z_5*y_6)*z_4)==0) 
    s.add(((y_5*z_6-z_5*y_6)*y_4-(z_5*x_6-x_5*z_6)*x_4)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
