...
def test_embed(): 
    ...
    s.add(((z_1*x_10-x_1*z_10)*z_7-(x_1*y_10-y_1*x_10)*y_7)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_7-(y_1*z_10-z_1*y_10)*z_7)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_7-(z_1*x_10-x_1*z_10)*x_7)==0) 
