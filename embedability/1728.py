...
def test_embed(): 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_4-(x_1*y_12-y_1*x_12)*y_4)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_4-(y_1*z_12-z_1*y_12)*z_4)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_4-(z_1*x_12-x_1*z_12)*x_4)==0) 
    ...
    s.add(((z_2*x_12-x_2*z_12)*z_10-(x_2*y_12-y_2*x_12)*y_10)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_10-(y_2*z_12-z_2*y_12)*z_10)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_10-(z_2*x_12-x_2*z_12)*x_10)==0) 
