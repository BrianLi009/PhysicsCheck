...
def test_embed(): 
    ...
    s.add(((z_7*x_11-x_7*z_11)*z_1-(x_7*y_11-y_7*x_11)*y_1)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_1-(y_7*z_11-z_7*y_11)*z_1)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_1-(z_7*x_11-x_7*z_11)*x_1)==0) 
