...
def test_embed(): 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_0-(x_9*y_10-y_9*x_10)*y_0)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_0-(y_9*z_10-z_9*y_10)*z_0)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_0-(z_9*x_10-x_9*z_10)*x_0)==0) 
