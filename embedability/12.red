...
v2c3 := 0;
neq0 := k(v0,v2); 
neq1 := k(v0,k(v2,k(v0,v1))); 
neq2 := k(v0,v3); 
neq3 := k(v0,k(k(v3,v0),v3)); 
neq4 := k(v0,k(k(v3,v2),v1)); 
neq5 := k(v0,k(v3,v2)); 
neq6 := k(v0,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq7 := k(v1,v2); 
neq8 := k(v1,k(v2,k(v0,v1))); 
neq9 := k(v1,v3); 
neq10 := k(v1,k(k(v3,v0),v3)); 
neq11 := k(v1,k(v3,v2)); 
neq12 := k(v1,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq13 := k(v1,k(v3,v0)); 
neq14 := k(v2,v3); 
...
neq21 := k(k(v2,k(v0,v1)),k(k(v3,v2),v1)); 
neq22 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq23 := k(k(v2,k(v0,v1)),k(v3,v0)); 
neq24 := k(v3,k(k(v3,v2),v1)); 
neq25 := k(v3,k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq26 := k(v3,k(v0,v1)); 
neq27 := k(k(k(v3,v0),v3),k(k(v3,v2),v1)); 
neq28 := k(k(k(v3,v0),v3),k(v3,v2)); 
neq29 := k(k(k(v3,v0),v3),k(v0,v1)); 
neq30 := k(k(k(v3,v2),v1),k(v3,v0)); 
neq31 := k(k(k(v3,v2),v1),k(v0,v1)); 
neq32 := k(k(v3,v2),k(k(k(v3,v0),v3),k(v2,k(v0,v1)))); 
neq33 := k(k(v3,v2),k(v3,v0)); 
neq34 := k(k(v3,v2),k(v0,v1)); 
neq35 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(v3,v0)); 
neq36 := k(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(v0,v1)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(v3,v0),v3),k(v2,k(v0,v1))),k(k(v3,v2),v1)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
