...
neq1 := k(k(v3,k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq2 := k(k(v3,k(v2,v0)),k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0))); 
neq3 := k(k(v3,k(v2,v0)),v0); 
neq4 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq5 := k(k(v3,k(v2,v0)),k(k(v3,v2),v3)); 
neq6 := k(k(v3,k(v2,v0)),v1); 
neq7 := k(k(v3,k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq8 := k(v2,k(k(k(v3,v2),v3),k(v2,v0))); 
neq9 := k(v2,k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0))); 
neq10 := k(v2,v3); 
neq11 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq12 := k(v2,k(k(v3,v2),v3)); 
neq13 := k(v2,v1); 
neq14 := k(v2,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq15 := k(k(k(k(v3,v2),v3),k(v2,v0)),v0); 
neq16 := k(k(k(k(v3,v2),v3),k(v2,v0)),v3); 
neq17 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,k(v2,v0)),v1)); 
neq18 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(v3,v2)); 
neq19 := k(k(k(k(v3,v2),v3),k(v2,v0)),v1); 
neq20 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq21 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),v0); 
neq22 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),v3); 
neq23 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),k(k(v3,k(v2,v0)),v1)); 
neq24 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),k(v3,v2)); 
neq25 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),k(k(v3,v2),v3)); 
neq26 := k(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),v1); 
neq27 := k(v0,v3); 
neq28 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(v0,k(k(v3,v2),v3)); 
neq31 := k(v0,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq32 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq33 := k(v3,v1); 
neq34 := k(v3,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq35 := k(v3,k(v2,v0)); 
neq36 := k(k(k(v3,k(v2,v0)),v1),k(v3,v2)); 
neq37 := k(k(k(v3,k(v2,v0)),v1),k(k(v3,v2),v3)); 
neq38 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq39 := k(k(v3,v2),v1); 
neq40 := k(k(v3,v2),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq41 := k(k(v3,v2),k(v2,v0)); 
neq42 := k(k(k(v3,v2),v3),v1); 
neq43 := k(k(k(v3,v2),v3),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq44 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq45 := k(v1,k(v2,v0)); 
neq46 := k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(v3,k(v2,v0)),v1),v1),k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
