...
def test_embed(): 
    ...
    s.add(((z_2*x_12-x_2*z_12)*z_7-(x_2*y_12-y_2*x_12)*y_7)==0) 
    s.add(((x_2*y_12-y_2*x_12)*x_7-(y_2*z_12-z_2*y_12)*z_7)==0) 
    s.add(((y_2*z_12-z_2*y_12)*y_7-(z_2*x_12-x_2*z_12)*x_7)==0) 
