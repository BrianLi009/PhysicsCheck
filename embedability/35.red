...
neq0 := k(v2,v3); 
neq1 := k(v2,v0); 
neq2 := k(v2,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq3 := k(v2,k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(v3,k(k(v2,v1),v1))); 
neq6 := k(v2,k(k(v2,v1),v1)); 
neq7 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq8 := k(k(k(v3,k(k(v2,v1),v1)),v2),v3); 
neq9 := k(k(k(v3,k(k(v2,v1),v1)),v2),v0); 
neq10 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v2,v1)); 
neq11 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq12 := k(k(k(v3,k(k(v2,v1),v1)),v2),v1); 
neq13 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(v2,v0)); 
neq14 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(v2,v1),v1)); 
neq15 := k(k(k(v3,k(k(v2,v1),v1)),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq16 := k(v3,k(v2,v1)); 
neq17 := k(v3,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq18 := k(v3,v1); 
neq19 := k(v3,k(v2,v0)); 
neq20 := k(v3,k(k(v2,v1),v1)); 
neq21 := k(v3,k(k(k(v2,v1),v1),k(v2,v0))); 
neq22 := k(v0,k(v2,v1)); 
neq23 := k(v0,k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq24 := k(v0,k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq25 := k(v0,k(v3,k(k(v2,v1),v1))); 
neq26 := k(v0,k(k(v2,v1),v1)); 
neq27 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq28 := k(k(v2,v1),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0)))); 
neq29 := k(k(v2,v1),k(v3,k(k(k(v2,v1),v1),k(v2,v0)))); 
neq30 := k(k(v2,v1),k(v2,v0)); 
neq31 := k(k(v2,v1),k(v3,k(k(v2,v1),v1))); 
neq32 := k(k(v2,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq33 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0))),v1); 
neq34 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0))),k(v2,v0)); 
neq35 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0))),k(v3,k(k(v2,v1),v1))); 
neq36 := k(k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0))),k(k(v2,v1),v1)); 
neq37 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),v1); 
neq38 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(v2,v0)); 
neq39 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(v3,k(k(v2,v1),v1))); 
neq40 := k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(v2,v1),v1)); 
neq41 := k(v1,k(v2,v0)); 
neq42 := k(v1,k(v3,k(k(v2,v1),v1))); 
neq43 := k(v1,k(k(k(v2,v1),v1),k(v2,v0))); 
neq44 := k(k(v2,v0),k(v3,k(k(v2,v1),v1))); 
neq45 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq46 := k(k(v3,k(k(v2,v1),v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(v3,k(k(v2,v1),v1)),v2),k(k(v3,k(k(k(v2,v1),v1),k(v2,v0))),k(k(k(v2,v1),v1),k(v2,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
