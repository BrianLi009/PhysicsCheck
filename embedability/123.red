...
neq5 := k(k(k(v3,v2),v1),k(k(k(v3,v0),v2),v2)); 
neq6 := k(k(k(v3,v2),v1),k(k(v3,v0),v2)); 
neq7 := k(k(k(v3,v2),v1),k(k(k(v3,v2),v3),k(v0,v1))); 
neq8 := k(k(k(v3,v2),v1),k(v3,v0)); 
neq9 := k(v2,v3); 
neq10 := k(v2,k(k(v3,v2),v3)); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(v0,v1)); 
neq13 := k(v2,k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq14 := k(v2,v1); 
neq15 := k(v2,k(k(k(v3,v2),v3),k(v0,v1))); 
neq16 := k(v2,k(v3,v0)); 
neq17 := k(v3,v0); 
neq18 := k(v3,k(v0,v1)); 
neq19 := k(v3,k(k(k(v3,v0),v2),v2)); 
neq20 := k(v3,k(k(v3,v0),v2)); 
neq21 := k(v3,k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq22 := k(v3,v1); 
neq23 := k(v3,k(k(k(v3,v2),v3),k(v0,v1))); 
neq24 := k(k(k(v3,v2),v3),v0); 
neq25 := k(k(k(v3,v2),v3),k(v0,v1)); 
neq26 := k(k(k(v3,v2),v3),k(k(k(v3,v0),v2),v2)); 
neq27 := k(k(k(v3,v2),v3),k(k(v3,v0),v2)); 
neq28 := k(k(k(v3,v2),v3),k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq29 := k(k(k(v3,v2),v3),v1); 
neq30 := k(k(k(v3,v2),v3),k(v3,v0)); 
neq31 := k(v0,k(k(k(v3,v0),v2),v2)); 
neq32 := k(v0,k(k(v3,v0),v2)); 
neq33 := k(v0,k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq34 := k(v0,k(k(k(v3,v2),v3),k(v0,v1))); 
neq35 := k(v0,k(v3,v2)); 
neq36 := k(k(v0,v1),k(k(k(v3,v0),v2),v2)); 
neq37 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq38 := k(k(v0,v1),k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq39 := k(k(v0,v1),k(v3,v0)); 
neq40 := k(k(v0,v1),k(v3,v2)); 
neq41 := k(k(k(k(v3,v0),v2),v2),v1); 
neq42 := k(k(k(k(v3,v0),v2),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq43 := k(k(k(k(v3,v0),v2),v2),k(v3,v0)); 
neq44 := k(k(k(k(v3,v0),v2),v2),k(v3,v2)); 
neq45 := k(k(k(v3,v0),v2),k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))); 
neq46 := k(k(k(v3,v0),v2),v1); 
neq47 := k(k(k(v3,v0),v2),k(k(k(v3,v2),v3),k(v0,v1))); 
neq48 := k(k(k(v3,v0),v2),k(v3,v2)); 
neq49 := k(k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1)),v1); 
neq50 := k(k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1)),k(v3,v0)); 
neq51 := k(k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1)),k(v3,v2)); 
neq52 := k(v1,k(k(k(v3,v2),v3),k(v0,v1))); 
neq53 := k(v1,k(v3,v0)); 
neq54 := k(v1,k(v3,v2)); 
neq55 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v0)); 
...
phi := 
       ...
       d(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(v3,v0),v2),v2),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
