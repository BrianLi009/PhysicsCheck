...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v2,k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
...
neq6 := k(v2,v1); 
neq7 := k(v2,v3); 
neq8 := k(v2,k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq9 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq10 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq11 := k(k(v2,v1),v0); 
neq12 := k(k(v2,v1),k(v3,k(v2,v0))); 
neq13 := k(k(v2,v1),k(k(v3,k(v2,v0)),v1)); 
neq14 := k(k(v2,v1),k(v3,v0)); 
neq15 := k(k(v2,v1),k(v2,v0)); 
neq16 := k(k(v2,v1),v3); 
neq17 := k(k(v2,v1),k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq18 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),v0); 
neq19 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v3,k(v2,v0))); 
neq20 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(v3,k(v2,v0)),v1)); 
neq21 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v3,v0)); 
neq22 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v0)); 
neq23 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),v1); 
neq24 := k(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),v3); 
neq25 := k(k(v3,k(k(v2,v1),v2)),v0); 
neq26 := k(k(v3,k(k(v2,v1),v2)),k(v3,k(v2,v0))); 
neq27 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,k(v2,v0)),v1)); 
neq28 := k(k(v3,k(k(v2,v1),v2)),k(v3,v0)); 
neq29 := k(k(v3,k(k(v2,v1),v2)),k(v2,v0)); 
neq30 := k(k(v3,k(k(v2,v1),v2)),v1); 
neq31 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq32 := k(v0,k(v3,k(v2,v0))); 
neq33 := k(v0,k(k(v3,k(v2,v0)),v1)); 
neq34 := k(v0,v3); 
neq35 := k(v0,k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq36 := k(v0,k(k(v2,v1),v2)); 
neq37 := k(k(v3,k(v2,v0)),k(v3,v0)); 
neq38 := k(k(v3,k(v2,v0)),v1); 
neq39 := k(k(v3,k(v2,v0)),k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq40 := k(k(v3,k(v2,v0)),k(k(v2,v1),v2)); 
neq41 := k(k(k(v3,k(v2,v0)),v1),k(v3,v0)); 
neq42 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq43 := k(k(k(v3,k(v2,v0)),v1),v3); 
neq44 := k(k(k(v3,k(v2,v0)),v1),k(k(v2,v1),v2)); 
neq45 := k(k(v3,v0),k(v2,v0)); 
neq46 := k(k(v3,v0),v1); 
neq47 := k(k(v3,v0),k(k(v2,v1),v2)); 
neq48 := k(k(v2,v0),v1); 
neq49 := k(k(v2,v0),v3); 
neq50 := k(k(v2,v0),k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq51 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq52 := k(v1,v3); 
neq53 := k(v1,k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq54 := k(v1,k(k(v2,v1),v2)); 
neq55 := k(v3,k(k(v3,v0),k(k(v3,k(v2,v0)),v1))); 
neq56 := k(v3,k(k(v2,v1),v2)); 
neq57 := k(k(k(v3,v0),k(k(v3,k(v2,v0)),v1)),k(k(v2,v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(v3,k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(v3,v0),k(k(v3,k(v2,v0)),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
