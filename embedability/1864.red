...
neq6 := k(v2,k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
...
neq16 := k(v3,k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
...
neq22 := k(k(k(v3,v2),v0),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
...
neq31 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
...
neq38 := k(k(v2,v1),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
...
neq44 := k(k(k(k(v3,v2),v3),v1),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))); 
neq45 := k(k(k(k(v3,v2),v3),v1),k(v3,k(v2,v1))); 
...
neq56 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1))),k(k(v3,v2),v3)); 
neq57 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1))),v1); 
neq58 := k(k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1))),k(v3,v2)); 
neq59 := k(k(v3,k(v2,v1)),k(k(k(k(v3,v2),v3),v1),k(k(k(v3,v2),v0),k(v3,v2)))); 
...
phi := 
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,v2),v3),v1),k(k(k(v3,v2),v0),k(v3,v2))),k(k(k(k(v3,v2),v3),v0),k(v3,k(v2,v1)))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
