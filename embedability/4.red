...
v2c1 := 0;
neq0 := k(v0,k(v3,v1)); 
neq1 := k(v0,k(k(v3,v1),v1)); 
neq2 := k(v0,k(v3,v2)); 
neq3 := k(v0,k(k(v3,v2),v2)); 
neq4 := k(v0,v3); 
neq5 := k(v0,k(k(k(v3,v1),v1),k(v3,v0))); 
neq6 := k(v1,v2); 
neq7 := k(v1,k(v3,v0)); 
neq8 := k(v1,k(v3,v2)); 
neq9 := k(v1,k(k(v3,v2),v2)); 
neq10 := k(v1,v3); 
neq11 := k(v1,k(k(k(v3,v1),v1),k(v3,v0))); 
neq12 := k(v2,k(v3,v0)); 
neq13 := k(v2,k(v3,v1)); 
neq14 := k(v2,k(k(v3,v1),v1)); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(k(v3,v1),v1),k(v3,v0))); 
neq17 := k(k(v3,v0),k(v3,v1)); 
neq18 := k(k(v3,v0),k(k(v3,v1),v1)); 
neq19 := k(k(v3,v0),k(v3,v2)); 
neq20 := k(k(v3,v0),k(k(v3,v2),v2)); 
neq21 := k(k(v3,v1),k(v3,v2)); 
neq22 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq23 := k(k(v3,v1),k(k(k(v3,v1),v1),k(v3,v0))); 
neq24 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq25 := k(k(k(v3,v1),v1),k(k(v3,v2),v2)); 
neq26 := k(k(k(v3,v1),v1),v3); 
neq27 := k(k(v3,v2),k(k(k(v3,v1),v1),k(v3,v0))); 
neq28 := k(k(k(v3,v2),v2),v3); 
neq29 := k(v3,k(k(k(v3,v1),v1),k(v3,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(v3,v1),v1),k(v3,v0)),k(k(v3,v2),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
