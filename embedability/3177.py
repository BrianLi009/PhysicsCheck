...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_2-(x_0*y_10-y_0*x_10)*y_2)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_2-(y_0*z_10-z_0*y_10)*z_2)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_2-(z_0*x_10-x_0*z_10)*x_2)==0) 
    ...
    s.add(((z_1*x_9-x_1*z_9)*z_3-(x_1*y_9-y_1*x_9)*y_3)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_3-(y_1*z_9-z_1*y_9)*z_3)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_3-(z_1*x_9-x_1*z_9)*x_3)==0) 
    s.add(((z_4*x_11-x_4*z_11)*z_5-(x_4*y_11-y_4*x_11)*y_5)==0) 
    s.add(((x_4*y_11-y_4*x_11)*x_5-(y_4*z_11-z_4*y_11)*z_5)==0) 
    s.add(((y_4*z_11-z_4*y_11)*y_5-(z_4*x_11-x_4*z_11)*x_5)==0) 
    ...
    s.add(((z_6*x_9-x_6*z_9)*z_7-(x_6*y_9-y_6*x_9)*y_7)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_7-(y_6*z_9-z_6*y_9)*z_7)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_7-(z_6*x_9-x_6*z_9)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_2 == 0) 
