...
v3 := {v3c1, v3c2, v3c3}; 
v2c3 := 0;
neq0 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)); 
neq1 := k(k(v0,v1),k(k(k(k(k(v3,v1),v2),v0),v3),v3)); 
neq2 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))); 
neq3 := k(k(v0,v1),v3); 
neq4 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq5 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq6 := k(k(v0,v1),k(v3,v1)); 
neq7 := k(k(v0,v1),k(k(k(v3,v1),v2),v0)); 
neq8 := k(k(v0,v1),k(k(k(k(v3,v1),v2),v0),v3)); 
neq9 := k(k(v0,v1),k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq10 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),v0); 
neq11 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),v1); 
neq12 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),v3); 
neq13 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq14 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(k(v3,v1),v2)); 
neq15 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(v3,v1)); 
neq16 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(k(k(v3,v1),v2),v0)); 
neq17 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(k(k(k(v3,v1),v2),v0),v3)); 
neq18 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2),k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq19 := k(v2,v0); 
neq20 := k(v2,v1); 
neq21 := k(v2,k(k(k(k(k(v3,v1),v2),v0),v3),v3)); 
neq22 := k(v2,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))); 
neq23 := k(v2,v3); 
neq24 := k(v2,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq25 := k(v2,k(v3,v1)); 
neq26 := k(v2,k(k(k(v3,v1),v2),v0)); 
neq27 := k(v2,k(k(k(k(v3,v1),v2),v0),v3)); 
neq28 := k(v2,k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v2),v0),v3),v3)); 
neq30 := k(v0,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq33 := k(v0,k(k(v3,v1),v2)); 
neq34 := k(v0,k(v3,v1)); 
neq35 := k(v0,k(k(k(k(v3,v1),v2),v0),v3)); 
neq36 := k(v0,k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq37 := k(v1,k(k(k(k(k(v3,v1),v2),v0),v3),v3)); 
neq38 := k(v1,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))); 
neq39 := k(v1,v3); 
neq40 := k(v1,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq41 := k(v1,k(k(v3,v1),v2)); 
neq42 := k(v1,k(k(k(v3,v1),v2),v0)); 
neq43 := k(v1,k(k(k(k(v3,v1),v2),v0),v3)); 
neq44 := k(v1,k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq45 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))); 
neq46 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq47 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(k(v3,v1),v2)); 
neq48 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(v3,v1)); 
neq49 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(k(k(v3,v1),v2),v0)); 
neq50 := k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq51 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)),v3); 
neq52 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)),k(k(v3,v1),v2)); 
neq53 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)),k(v3,v1)); 
neq54 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)),k(k(k(v3,v1),v2),v0)); 
neq55 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2)),k(k(k(k(v3,v1),v2),v0),v3)); 
neq56 := k(v3,k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1))); 
neq57 := k(v3,k(k(v3,v1),v2)); 
neq58 := k(v3,k(k(k(v3,v1),v2),v0)); 
neq59 := k(v3,k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq60 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1)),k(k(v3,v1),v2)); 
neq61 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1)),k(k(k(v3,v1),v2),v0)); 
neq62 := k(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1)),k(k(k(k(v3,v1),v2),v0),v3)); 
neq63 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),v0),v3)); 
neq64 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
neq65 := k(k(v3,v1),k(k(k(v3,v1),v2),v0)); 
neq66 := k(k(v3,v1),k(k(k(k(v3,v1),v2),v0),v3)); 
neq67 := k(k(v3,v1),k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(v3,v1)),k(k(k(k(k(k(v3,v1),v2),v0),v3),k(k(k(v3,v1),v2),v0)),k(k(k(k(k(k(v3,v1),v2),v0),v3),v3),v2))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
