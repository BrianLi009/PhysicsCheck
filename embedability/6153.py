...
def test_embed(): 
    ...
    s.add(((z_1*x_12-x_1*z_12)*z_10-(x_1*y_12-y_1*x_12)*y_10)==0) 
    s.add(((x_1*y_12-y_1*x_12)*x_10-(y_1*z_12-z_1*y_12)*z_10)==0) 
    s.add(((y_1*z_12-z_1*y_12)*y_10-(z_1*x_12-x_1*z_12)*x_10)==0) 
    ...
    s.add(((z_3*x_13-x_3*z_13)*z_7-(x_3*y_13-y_3*x_13)*y_7)==0) 
    s.add(((x_3*y_13-y_3*x_13)*x_7-(y_3*z_13-z_3*y_13)*z_7)==0) 
    s.add(((y_3*z_13-z_3*y_13)*y_7-(z_3*x_13-x_3*z_13)*x_7)==0) 
    s.add(((z_6*x_11-x_6*z_11)*z_4-(x_6*y_11-y_6*x_11)*y_4)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_4-(y_6*z_11-z_6*y_11)*z_4)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_4-(z_6*x_11-x_6*z_11)*x_4)==0) 
    ...
    s.add(((z_5*x_11-x_5*z_11)*z_9-(x_5*y_11-y_5*x_11)*y_9)==0) 
    s.add(((x_5*y_11-y_5*x_11)*x_9-(y_5*z_11-z_5*y_11)*z_9)==0) 
    s.add(((y_5*z_11-z_5*y_11)*y_9-(z_5*x_11-x_5*z_11)*x_9)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_6 == 0) 
