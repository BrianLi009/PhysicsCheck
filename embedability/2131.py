...
def test_embed(): 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_1-(x_5*y_13-y_5*x_13)*y_1)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_1-(y_5*z_13-z_5*y_13)*z_1)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_1-(z_5*x_13-x_5*z_13)*x_1)==0) 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_2-(x_6*y_13-y_6*x_13)*y_2)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_2-(y_6*z_13-z_6*y_13)*z_2)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_2-(z_6*x_13-x_6*z_13)*x_2)==0) 
