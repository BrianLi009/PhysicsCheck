...
def test_embed(): 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_8-(x_1*y_13-y_1*x_13)*y_8)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_8-(y_1*z_13-z_1*y_13)*z_8)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_8-(z_1*x_13-x_1*z_13)*x_8)==0) 
    ...
    s.add(((z_3*x_12-x_3*z_12)*z_11-(x_3*y_12-y_3*x_12)*y_11)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_11-(y_3*z_12-z_3*y_12)*z_11)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_11-(z_3*x_12-x_3*z_12)*x_11)==0) 
