...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_5-(x_2*y_13-y_2*x_13)*y_5)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_5-(y_2*z_13-z_2*y_13)*z_5)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_5-(z_2*x_13-x_2*z_13)*x_5)==0) 
    s.add(((z_3*x_10-x_3*z_10)*z_7-(x_3*y_10-y_3*x_10)*y_7)==0) 
    s.add(((x_3*y_10-y_3*x_10)*x_7-(y_3*z_10-z_3*y_10)*z_7)==0) 
    s.add(((y_3*z_10-z_3*y_10)*y_7-(z_3*x_10-x_3*z_10)*x_7)==0) 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_9-(x_5*y_12-y_5*x_12)*y_9)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_9-(y_5*z_12-z_5*y_12)*z_9)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_9-(z_5*x_12-x_5*z_12)*x_9)==0) 
    s.add(((z_9*x_11-x_9*z_11)*z_8-(x_9*y_11-y_9*x_11)*y_8)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_8-(y_9*z_11-z_9*y_11)*z_8)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_8-(z_9*x_11-x_9*z_11)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
