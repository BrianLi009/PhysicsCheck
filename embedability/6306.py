...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_13-(x_8*y_11-y_8*x_11)*y_13)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_13-(y_8*z_11-z_8*y_11)*z_13)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_13-(z_8*x_11-x_8*z_11)*x_13)==0) 
    ...
    s.add(((z_0*x_8-x_0*z_8)*z_1-(x_0*y_8-y_0*x_8)*y_1)==0) 
    s.add(((x_0*y_8-y_0*x_8)*x_1-(y_0*z_8-z_0*y_8)*z_1)==0) 
    s.add(((y_0*z_8-z_0*y_8)*y_1-(z_0*x_8-x_0*z_8)*x_1)==0) 
    ...
    s.add(((z_1*x_8-x_1*z_8)*z_4-(x_1*y_8-y_1*x_8)*y_4)==0) 
    s.add(((x_1*y_8-y_1*x_8)*x_4-(y_1*z_8-z_1*y_8)*z_4)==0) 
    s.add(((y_1*z_8-z_1*y_8)*y_4-(z_1*x_8-x_1*z_8)*x_4)==0) 
