...
def test_embed(): 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_13-(x_8*y_10-y_8*x_10)*y_13)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_13-(y_8*z_10-z_8*y_10)*z_13)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_13-(z_8*x_10-x_8*z_10)*x_13)==0) 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_6-(x_8*y_13-y_8*x_13)*y_6)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_6-(y_8*z_13-z_8*y_13)*z_6)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_6-(z_8*x_13-x_8*z_13)*x_6)==0) 
