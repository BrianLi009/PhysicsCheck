...
def test_embed(): 
    ...
    s.add(((z_11*x_12-x_11*z_12)*z_6-(x_11*y_12-y_11*x_12)*y_6)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_6-(y_11*z_12-z_11*y_12)*z_6)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_6-(z_11*x_12-x_11*z_12)*x_6)==0) 
