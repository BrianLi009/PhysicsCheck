...
v4 := {v4c1, v4c2, v4c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(v4,v2),v3),v1)); 
neq1 := k(v2,v3); 
neq2 := k(v2,k(v4,k(v0,v1))); 
neq3 := k(v2,k(k(v4,k(v0,v1)),v3)); 
neq4 := k(v2,k(v0,v1)); 
neq5 := k(v2,v4); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(k(k(v4,v2),v3),v1),v4)); 
neq8 := k(v2,k(k(k(v4,k(v0,v1)),v3),v3)); 
neq9 := k(v2,k(k(v4,v2),v3)); 
neq10 := k(k(v4,v2),k(k(k(k(k(v4,v2),v3),v1),v4),v2)); 
neq11 := k(k(v4,v2),v0); 
neq12 := k(k(v4,v2),k(k(k(v4,v2),v3),v1)); 
neq13 := k(k(v4,v2),v3); 
neq14 := k(k(v4,v2),k(v4,k(v0,v1))); 
neq15 := k(k(v4,v2),k(k(v4,k(v0,v1)),v3)); 
neq16 := k(k(v4,v2),k(v0,v1)); 
neq17 := k(k(v4,v2),v1); 
neq18 := k(k(v4,v2),k(k(k(k(v4,v2),v3),v1),v4)); 
neq19 := k(k(v4,v2),k(k(k(v4,k(v0,v1)),v3),v3)); 
neq20 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),v0); 
neq21 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(k(k(v4,v2),v3),v1)); 
neq22 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),v3); 
neq23 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(v4,k(v0,v1))); 
neq24 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(k(v4,k(v0,v1)),v3)); 
neq25 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(v0,v1)); 
neq26 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),v4); 
neq27 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),v1); 
neq28 := k(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(k(v4,v2),v3)); 
neq29 := k(v0,k(k(k(v4,v2),v3),v1)); 
neq30 := k(v0,v3); 
neq31 := k(v0,k(v4,k(v0,v1))); 
neq32 := k(v0,k(k(v4,k(v0,v1)),v3)); 
neq33 := k(v0,v4); 
neq34 := k(v0,k(k(k(k(v4,v2),v3),v1),v4)); 
neq35 := k(v0,k(k(k(v4,k(v0,v1)),v3),v3)); 
neq36 := k(v0,k(k(v4,v2),v3)); 
neq37 := k(k(k(k(v4,v2),v3),v1),v3); 
neq38 := k(k(k(k(v4,v2),v3),v1),k(v4,k(v0,v1))); 
neq39 := k(k(k(k(v4,v2),v3),v1),k(k(v4,k(v0,v1)),v3)); 
neq40 := k(k(k(k(v4,v2),v3),v1),k(v0,v1)); 
neq41 := k(k(k(k(v4,v2),v3),v1),v4); 
neq42 := k(k(k(k(v4,v2),v3),v1),k(k(k(v4,k(v0,v1)),v3),v3)); 
neq43 := k(v3,k(v4,k(v0,v1))); 
neq44 := k(v3,k(v0,v1)); 
neq45 := k(v3,v4); 
neq46 := k(v3,v1); 
neq47 := k(v3,k(k(k(k(v4,v2),v3),v1),v4)); 
neq48 := k(k(v4,k(v0,v1)),v1); 
neq49 := k(k(v4,k(v0,v1)),k(k(k(k(v4,v2),v3),v1),v4)); 
neq50 := k(k(v4,k(v0,v1)),k(k(k(v4,k(v0,v1)),v3),v3)); 
neq51 := k(k(v4,k(v0,v1)),k(k(v4,v2),v3)); 
neq52 := k(k(k(v4,k(v0,v1)),v3),k(v0,v1)); 
neq53 := k(k(k(v4,k(v0,v1)),v3),v4); 
neq54 := k(k(k(v4,k(v0,v1)),v3),v1); 
neq55 := k(k(k(v4,k(v0,v1)),v3),k(k(k(k(v4,v2),v3),v1),v4)); 
neq56 := k(k(k(v4,k(v0,v1)),v3),k(k(v4,v2),v3)); 
neq57 := k(k(v0,v1),v4); 
neq58 := k(k(v0,v1),k(k(k(k(v4,v2),v3),v1),v4)); 
neq59 := k(k(v0,v1),k(k(k(v4,k(v0,v1)),v3),v3)); 
neq60 := k(k(v0,v1),k(k(v4,v2),v3)); 
neq61 := k(v4,v1); 
neq62 := k(v4,k(k(k(v4,k(v0,v1)),v3),v3)); 
neq63 := k(v4,k(k(v4,v2),v3)); 
neq64 := k(v1,k(k(k(k(v4,v2),v3),v1),v4)); 
neq65 := k(v1,k(k(k(v4,k(v0,v1)),v3),v3)); 
neq66 := k(v1,k(k(v4,v2),v3)); 
neq67 := k(k(k(k(k(v4,v2),v3),v1),v4),k(k(k(v4,k(v0,v1)),v3),v3)); 
neq68 := k(k(k(k(k(v4,v2),v3),v1),v4),k(k(v4,v2),v3)); 
neq69 := k(k(k(k(v4,k(v0,v1)),v3),v3),k(k(v4,v2),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v4,v2),v3),v1),v4),v2),k(k(k(v4,k(v0,v1)),v3),v3)) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
