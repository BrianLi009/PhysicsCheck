...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_8-(x_0*y_10-y_0*x_10)*y_8)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_8-(y_0*z_10-z_0*y_10)*z_8)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_8-(z_0*x_10-x_0*z_10)*x_8)==0) 
    s.add(((z_3*x_11-x_3*z_11)*z_1-(x_3*y_11-y_3*x_11)*y_1)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_1-(y_3*z_11-z_3*y_11)*z_1)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_1-(z_3*x_11-x_3*z_11)*x_1)==0) 
