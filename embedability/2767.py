...
def test_embed(): 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_5-(x_8*y_13-y_8*x_13)*y_5)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_5-(y_8*z_13-z_8*y_13)*z_5)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_5-(z_8*x_13-x_8*z_13)*x_5)==0) 
    s.add(((z_5*x_9-x_5*z_9)*z_7-(x_5*y_9-y_5*x_9)*y_7)==0) 
    s.add(((x_5*y_9-y_5*x_9)*x_7-(y_5*z_9-z_5*y_9)*z_7)==0) 
    s.add(((y_5*z_9-z_5*y_9)*y_7-(z_5*x_9-x_5*z_9)*x_7)==0) 
    s.add(x_2 == 0) 
    s.add(y_2 == 0) 
    s.add(z_2 == 1) 
    s.add(x_10 == 0) 
