...
v3 := {v3c1, v3c2, v3c3}; 
v2c3 := 0;
neq0 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),v0); 
neq1 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(v3,v2)); 
neq2 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0)); 
neq3 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),v1); 
neq4 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),v3); 
neq5 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(k(k(v3,v1),v3),k(v0,v1))); 
neq6 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq7 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(v0,v1)); 
neq8 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(k(v3,v1),v3)); 
neq9 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2),k(v3,v1)); 
neq10 := k(v2,k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3))); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0)); 
neq13 := k(v2,k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1))); 
neq14 := k(v2,v1); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(k(v3,v1),v3),k(v0,v1))); 
neq17 := k(v2,k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq18 := k(v2,k(k(v3,v1),v3)); 
neq19 := k(v2,k(v3,v1)); 
neq20 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),v0); 
neq21 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(v3,v2)); 
neq22 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1))); 
neq23 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),v1); 
neq24 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),v3); 
neq25 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(k(k(v3,v1),v3),k(v0,v1))); 
neq26 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq27 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(v0,v1)); 
neq28 := k(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(v3,v1)); 
neq29 := k(v0,k(v3,v2)); 
neq30 := k(v0,k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1))); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(v3,v1),v3),k(v0,v1))); 
neq33 := k(v0,k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq34 := k(v0,k(k(v3,v1),v3)); 
neq35 := k(v0,k(v3,v1)); 
neq36 := k(k(v3,v2),k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0)); 
neq37 := k(k(v3,v2),k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1))); 
neq38 := k(k(v3,v2),v1); 
neq39 := k(k(v3,v2),k(k(k(v3,v1),v3),k(v0,v1))); 
neq40 := k(k(v3,v2),k(v0,v1)); 
neq41 := k(k(v3,v2),k(k(v3,v1),v3)); 
neq42 := k(k(v3,v2),k(v3,v1)); 
neq43 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1))); 
neq44 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),v1); 
neq45 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),v3); 
neq46 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(k(v3,v1),v3),k(v0,v1))); 
neq47 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(v0,v1)); 
neq48 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)); 
neq49 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(v3,v1)); 
neq50 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v1); 
neq51 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v3); 
neq52 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),k(k(k(v3,v1),v3),k(v0,v1))); 
neq53 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),k(v0,v1)); 
neq54 := k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),k(k(v3,v1),v3)); 
neq55 := k(v1,v3); 
neq56 := k(v1,k(k(k(v3,v1),v3),k(v0,v1))); 
neq57 := k(v1,k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq58 := k(v1,k(k(v3,v1),v3)); 
neq59 := k(v3,k(k(k(v3,v1),v3),k(v0,v1))); 
neq60 := k(v3,k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2))); 
neq61 := k(v3,k(v0,v1)); 
neq62 := k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v1)); 
neq63 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v0,v1)); 
neq64 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(k(v3,v1),v3)); 
neq65 := k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)); 
neq66 := k(k(v0,v1),k(k(v3,v1),v3)); 
neq67 := k(k(v0,v1),k(v3,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),v0),k(k(v3,v1),v3)),k(k(k(k(k(k(v3,v1),v3),k(v0,v1)),k(v3,v2)),k(v3,v1)),v2)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
