...
neq4 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)))); 
neq5 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0))); 
neq6 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(v2,k(v0,v1)),v2)); 
neq7 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq8 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(k(k(v2,k(v0,v1)),v2),v1)); 
neq9 := k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)); 
neq10 := k(v2,k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1)))); 
neq11 := k(v2,v0); 
neq12 := k(v2,v1); 
neq13 := k(v2,k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)))); 
neq14 := k(v2,k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0))); 
neq15 := k(v2,k(v0,v1)); 
...
neq21 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1))),k(v0,v1)); 
neq22 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(v2,k(v0,v1)),v2)); 
neq23 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq24 := k(k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v2,k(v0,v1)),v2),v1)); 
...
neq27 := k(v0,k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)))); 
neq28 := k(v0,k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0))); 
...
neq34 := k(v1,k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)))); 
neq35 := k(v1,k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0))); 
neq36 := k(v1,k(k(v2,k(v0,v1)),v2)); 
neq37 := k(v1,k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq38 := k(v1,k(v2,v0)); 
neq39 := k(v1,k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0))); 
neq40 := k(v1,k(v2,k(v0,v1))); 
neq41 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0))); 
neq42 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(v0,v1)); 
neq43 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(k(v2,k(v0,v1)),v2)); 
neq44 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(k(k(v2,k(v0,v1)),v2),v1)); 
neq45 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(v2,v0)); 
neq46 := k(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(v2,k(v0,v1))); 
neq47 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v0,v1)); 
neq48 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(k(v2,k(v0,v1)),v2)); 
neq49 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
neq50 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0))); 
neq51 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1))); 
neq52 := k(k(v0,v1),k(k(v2,k(v0,v1)),v2)); 
neq53 := k(k(v0,v1),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))); 
...
neq58 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0))); 
neq59 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)),k(v2,v0)); 
neq60 := k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2)),k(v2,k(v0,v1))); 
neq61 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)); 
neq62 := k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0))); 
...
phi := 
       ...
       d(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))) = 0 and 
       d(k(k(k(k(v2,k(v0,v1)),k(v0,v1)),k(v2,v0)),k(k(k(k(v2,k(v0,v1)),v2),v1),k(k(v2,k(v0,v1)),v2))),k(k(k(k(k(v2,k(v0,v1)),v2),v1),k(v2,v0)),k(v2,k(v0,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
