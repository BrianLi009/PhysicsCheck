...
neq2 := k(v2,k(k(v3,k(v2,v0)),v1)); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq5 := k(v2,k(v0,v1)); 
neq6 := k(v2,k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq7 := k(v2,k(v3,k(v2,v0))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq10 := k(k(v2,k(v0,v1)),v3); 
neq11 := k(k(v2,k(v0,v1)),k(k(v3,k(v2,v0)),v3)); 
neq12 := k(k(v2,k(v0,v1)),k(k(v3,k(v2,v0)),v1)); 
neq13 := k(k(v2,k(v0,v1)),v0); 
neq14 := k(k(v2,k(v0,v1)),k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq15 := k(k(v2,k(v0,v1)),k(v2,v0)); 
neq16 := k(k(v2,k(v0,v1)),k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq17 := k(k(v2,k(v0,v1)),k(v3,k(v2,v0))); 
neq18 := k(k(v2,k(v0,v1)),v1); 
neq19 := k(k(v2,k(v0,v1)),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq20 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq21 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(v2,v0)),v3)); 
neq22 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(v2,v0)),v1)); 
neq23 := k(k(k(v2,k(v0,v1)),v2),v0); 
neq24 := k(k(k(v2,k(v0,v1)),v2),k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq25 := k(k(k(v2,k(v0,v1)),v2),k(v2,v0)); 
neq26 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq27 := k(k(k(v2,k(v0,v1)),v2),k(v3,k(v2,v0))); 
neq28 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq29 := k(k(k(v2,k(v0,v1)),v2),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq30 := k(v3,k(k(v3,k(v2,v0)),v1)); 
neq31 := k(v3,v0); 
neq32 := k(v3,k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq33 := k(v3,k(v2,v0)); 
neq34 := k(v3,k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq35 := k(v3,v1); 
neq36 := k(v3,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq37 := k(k(k(v3,k(v2,v0)),v3),k(k(v3,k(v2,v0)),v1)); 
neq38 := k(k(k(v3,k(v2,v0)),v3),v0); 
neq39 := k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq40 := k(k(k(v3,k(v2,v0)),v3),k(v2,v0)); 
neq41 := k(k(k(v3,k(v2,v0)),v3),k(v0,v1)); 
neq42 := k(k(k(v3,k(v2,v0)),v3),v1); 
neq43 := k(k(k(v3,k(v2,v0)),v3),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq44 := k(k(k(v3,k(v2,v0)),v1),v0); 
neq45 := k(k(k(v3,k(v2,v0)),v1),k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq46 := k(k(k(v3,k(v2,v0)),v1),k(v2,v0)); 
neq47 := k(k(k(v3,k(v2,v0)),v1),k(v0,v1)); 
neq48 := k(k(k(v3,k(v2,v0)),v1),k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq49 := k(v0,k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0))); 
neq50 := k(v0,k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq51 := k(v0,k(v3,k(v2,v0))); 
neq52 := k(v0,k(k(k(v3,k(v2,v0)),v1),v1)); 
neq53 := k(k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0)),k(v0,v1)); 
neq54 := k(k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0)),k(v3,k(v2,v0))); 
neq55 := k(k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0)),v1); 
neq56 := k(k(v2,v0),k(v0,v1)); 
neq57 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq58 := k(k(v2,v0),v1); 
neq59 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq60 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))); 
neq61 := k(k(v0,v1),k(v3,k(v2,v0))); 
neq62 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v1),v1)); 
neq63 := k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v3,k(v2,v0))); 
neq64 := k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),v1); 
...
phi := 
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(v3,k(v2,v0)),v1),v1),k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2))) = 0 and 
       d(k(k(k(k(v3,k(v2,v0)),v3),k(k(v2,k(v0,v1)),v2)),k(v2,v0)),k(k(k(v3,k(v2,v0)),v1),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
