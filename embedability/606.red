...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v2,k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
...
neq6 := k(v2,v1); 
neq7 := k(v2,k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq8 := k(v2,k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq9 := k(v2,k(v3,k(k(v2,v0),v2))); 
neq10 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(v2,v0),v2),v1)); 
neq11 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),v0); 
neq12 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(v3,k(v2,v0))); 
neq13 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),v3); 
neq14 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(v3,k(k(v2,v0),v2)),v0)); 
neq15 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1); 
neq16 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq17 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq18 := k(k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(v2,v0)); 
neq19 := k(k(k(k(v2,v0),v2),v1),v0); 
neq20 := k(k(k(k(v2,v0),v2),v1),k(v3,k(v2,v0))); 
neq21 := k(k(k(k(v2,v0),v2),v1),v3); 
neq22 := k(k(k(k(v2,v0),v2),v1),k(k(v3,k(k(v2,v0),v2)),v0)); 
neq23 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq24 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq25 := k(k(k(k(v2,v0),v2),v1),k(v3,k(k(v2,v0),v2))); 
neq26 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq27 := k(v0,k(v3,k(v2,v0))); 
neq28 := k(v0,v3); 
neq29 := k(v0,k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq30 := k(v0,k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq31 := k(v0,k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq32 := k(v0,k(v3,k(k(v2,v0),v2))); 
neq33 := k(v0,k(k(v2,v0),v2)); 
neq34 := k(k(v3,k(v2,v0)),k(k(v3,k(k(v2,v0),v2)),v0)); 
neq35 := k(k(v3,k(v2,v0)),v1); 
neq36 := k(k(v3,k(v2,v0)),k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq37 := k(k(v3,k(v2,v0)),k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq38 := k(k(v3,k(v2,v0)),k(v3,k(k(v2,v0),v2))); 
neq39 := k(k(v3,k(v2,v0)),k(k(v2,v0),v2)); 
neq40 := k(v3,k(k(v3,k(k(v2,v0),v2)),v0)); 
neq41 := k(v3,k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq42 := k(v3,k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq43 := k(v3,k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq44 := k(v3,k(v2,v0)); 
neq45 := k(v3,k(k(v2,v0),v2)); 
neq46 := k(k(k(v3,k(k(v2,v0),v2)),v0),v1); 
neq47 := k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq48 := k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq49 := k(k(k(v3,k(k(v2,v0),v2)),v0),k(v2,v0)); 
neq50 := k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(v2,v0),v2)); 
neq51 := k(v1,k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0)))); 
neq52 := k(v1,k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq53 := k(v1,k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2)); 
neq54 := k(v1,k(v3,k(k(v2,v0),v2))); 
neq55 := k(v1,k(v2,v0)); 
neq56 := k(v1,k(k(v2,v0),v2)); 
neq57 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0))),k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1))); 
neq58 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0))),k(v3,k(k(v2,v0),v2))); 
neq59 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0))),k(v2,v0)); 
neq60 := k(k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0))),k(k(v2,v0),v2)); 
neq61 := k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),k(v3,k(k(v2,v0),v2))); 
neq62 := k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),k(v2,v0)); 
neq63 := k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),k(k(v2,v0),v2)); 
neq64 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(k(v2,v0),v2))); 
neq65 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v2,v0)); 
neq66 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)),v2),k(v3,k(v2,v0))),k(k(v3,k(k(v2,v0),v2)),k(k(v2,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
