...
neq9 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(k(v2,v1),v2)); 
neq10 := k(k(k(k(v2,v0),v0),k(v2,v1)),v0); 
neq11 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1)); 
neq12 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1)); 
neq13 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(k(k(v2,v1),v2),k(k(v2,v0),v0))); 
neq14 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq15 := k(k(k(k(v2,v0),v0),k(v2,v1)),v1); 
neq16 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v0)); 
neq17 := k(k(k(v2,v1),v2),k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1))); 
neq18 := k(k(k(v2,v1),v2),v0); 
neq19 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1)); 
neq20 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1)); 
neq21 := k(k(k(v2,v1),v2),k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq22 := k(k(k(v2,v1),v2),v1); 
neq23 := k(k(k(v2,v1),v2),k(k(v2,v0),v0)); 
neq24 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq25 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),v0); 
neq26 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1)); 
neq27 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1)); 
neq28 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(k(k(v2,v1),v2),k(k(v2,v0),v0))); 
neq29 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),v1); 
neq30 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v0)); 
neq31 := k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)); 
neq32 := k(v0,k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1)); 
neq33 := k(v0,k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1)); 
neq34 := k(v0,k(k(k(v2,v1),v2),k(k(v2,v0),v0))); 
neq35 := k(v0,k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq36 := k(v0,k(v2,v1)); 
neq37 := k(k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1),k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
...
neq41 := k(k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1),k(k(k(v2,v1),v2),k(k(v2,v0),v0))); 
neq42 := k(k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1),k(k(v2,v0),v0)); 
neq43 := k(k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1),k(v2,v0)); 
neq44 := k(k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1),k(v2,v1)); 
neq45 := k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0))); 
neq46 := k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1); 
neq47 := k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),k(v2,v0)); 
neq48 := k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),k(v2,v1)); 
neq49 := k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1); 
neq50 := k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),k(k(v2,v0),v0)); 
neq51 := k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),k(v2,v1)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v1)),k(v2,v0)),v1),k(k(k(k(v2,v1),v2),k(k(v2,v0),v0)),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
