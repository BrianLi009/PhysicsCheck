...
neq5 := k(v2,v3); 
neq6 := k(v2,k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq9 := k(k(v3,k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq10 := k(k(v3,k(k(v2,v0),v2)),k(k(k(v2,v0),v2),v1)); 
neq11 := k(k(v3,k(k(v2,v0),v2)),v0); 
neq12 := k(k(v3,k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq13 := k(k(v3,k(k(v2,v0),v2)),k(v2,v1)); 
neq14 := k(k(v3,k(k(v2,v0),v2)),v1); 
neq15 := k(k(v3,k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq16 := k(k(v3,k(k(v2,v0),v2)),k(v2,v0)); 
neq17 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0); 
neq18 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq19 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)); 
neq20 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v3); 
neq21 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))); 
neq22 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v1); 
neq23 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v0)); 
neq24 := k(k(k(k(v2,v0),v2),v1),v0); 
neq25 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq26 := k(k(k(k(v2,v0),v2),v1),k(v2,v1)); 
neq27 := k(k(k(k(v2,v0),v2),v1),v3); 
neq28 := k(k(k(k(v2,v0),v2),v1),k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))); 
neq29 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq30 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq31 := k(v0,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq32 := k(v0,k(v2,v1)); 
neq33 := k(v0,k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))); 
neq34 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq35 := k(v0,k(k(v2,v0),v2)); 
neq36 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(v2,v1)); 
neq37 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),v3); 
neq38 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),v1); 
neq39 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(k(v2,v0),v2)); 
neq40 := k(k(v2,v1),v3); 
neq41 := k(k(v2,v1),k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))); 
neq42 := k(k(v2,v1),k(v2,v0)); 
neq43 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq44 := k(v3,v1); 
neq45 := k(v3,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq46 := k(v3,k(v2,v0)); 
neq47 := k(v3,k(k(v2,v0),v2)); 
neq48 := k(k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))),v1); 
neq49 := k(k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq50 := k(k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))),k(v2,v0)); 
neq51 := k(k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(v3,k(k(v2,v0),v2)),k(v3,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
