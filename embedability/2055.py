...
def test_embed(): 
    ...
    s.add(((z_2*x_11-x_2*z_11)*z_5-(x_2*y_11-y_2*x_11)*y_5)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_5-(y_2*z_11-z_2*y_11)*z_5)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_5-(z_2*x_11-x_2*z_11)*x_5)==0) 
    s.add(((z_3*x_11-x_3*z_11)*z_7-(x_3*y_11-y_3*x_11)*y_7)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_7-(y_3*z_11-z_3*y_11)*z_7)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_7-(z_3*x_11-x_3*z_11)*x_7)==0) 
    s.add(((z_4*x_7-x_4*z_7)*z_8-(x_4*y_7-y_4*x_7)*y_8)==0) 
    s.add(((x_4*y_7-y_4*x_7)*x_8-(y_4*z_7-z_4*y_7)*z_8)==0) 
    s.add(((y_4*z_7-z_4*y_7)*y_8-(z_4*x_7-x_4*z_7)*x_8)==0) 
    s.add(((z_10*x_12-x_10*z_12)*z_6-(x_10*y_12-y_10*x_12)*y_6)==0) 
    s.add(((x_10*y_12-y_10*x_12)*x_6-(y_10*z_12-z_10*y_12)*z_6)==0) 
    s.add(((y_10*z_12-z_10*y_12)*y_6-(z_10*x_12-x_10*z_12)*x_6)==0) 
    s.add(((z_6*x_8-x_6*z_8)*z_9-(x_6*y_8-y_6*x_8)*y_9)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_9-(y_6*z_8-z_6*y_8)*z_9)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_9-(z_6*x_8-x_6*z_8)*x_9)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
