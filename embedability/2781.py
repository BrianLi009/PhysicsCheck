...
def test_embed(): 
    ...
    s.add(((z_9*x_10-x_9*z_10)*z_13-(x_9*y_10-y_9*x_10)*y_13)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_13-(y_9*z_10-z_9*y_10)*z_13)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_13-(z_9*x_10-x_9*z_10)*x_13)==0) 
    s.add(((z_8*x_11-x_8*z_11)*z_12-(x_8*y_11-y_8*x_11)*y_12)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_12-(y_8*z_11-z_8*y_11)*z_12)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_12-(z_8*x_11-x_8*z_11)*x_12)==0) 
    ...
    s.add(((z_1*x_9-x_1*z_9)*z_2-(x_1*y_9-y_1*x_9)*y_2)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_2-(y_1*z_9-z_1*y_9)*z_2)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_2-(z_1*x_9-x_1*z_9)*x_2)==0) 
    ...
    s.add(((z_9*x_12-x_9*z_12)*z_6-(x_9*y_12-y_9*x_12)*y_6)==0) 
    s.add(((x_9*y_12-y_9*x_12)*x_6-(y_9*z_12-z_9*y_12)*z_6)==0) 
    s.add(((y_9*z_12-z_9*y_12)*y_6-(z_9*x_12-x_9*z_12)*x_6)==0) 
