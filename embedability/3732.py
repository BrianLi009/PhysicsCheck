...
def test_embed(): 
    ...
    s.add(((z_9*x_11-x_9*z_11)*z_7-(x_9*y_11-y_9*x_11)*y_7)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_7-(y_9*z_11-z_9*y_11)*z_7)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_7-(z_9*x_11-x_9*z_11)*x_7)==0) 
    ...
    s.add(((z_7*x_8-x_7*z_8)*z_3-(x_7*y_8-y_7*x_8)*y_3)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_3-(y_7*z_8-z_7*y_8)*z_3)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_3-(z_7*x_8-x_7*z_8)*x_3)==0) 
