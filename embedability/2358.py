...
def test_embed(): 
    ...
    s.add(((z_8*x_11-x_8*z_11)*z_6-(x_8*y_11-y_8*x_11)*y_6)==0) 
    s.add(((x_8*y_11-y_8*x_11)*x_6-(y_8*z_11-z_8*y_11)*z_6)==0) 
    s.add(((y_8*z_11-z_8*y_11)*y_6-(z_8*x_11-x_8*z_11)*x_6)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_2 == 0) 
