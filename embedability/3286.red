...
neq2 := k(v0,k(v3,v2)); 
neq3 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq4 := k(v0,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq5 := k(v0,k(k(k(v3,v1),v2),k(v3,v1))); 
neq6 := k(v0,v3); 
neq7 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq8 := k(v0,k(v3,v1)); 
neq9 := k(v0,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq10 := k(v2,v1); 
neq11 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq12 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq13 := k(v2,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq14 := k(v2,k(k(k(v3,v1),v2),k(v3,v1))); 
neq15 := k(v2,v3); 
neq16 := k(v2,k(k(v3,v2),v0)); 
neq17 := k(v2,k(v3,v1)); 
neq18 := k(v2,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq19 := k(v1,k(k(v3,v1),v2)); 
neq20 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq21 := k(v1,k(v3,v2)); 
neq22 := k(v1,k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq23 := k(v1,k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq24 := k(v1,k(k(k(v3,v1),v2),k(v3,v1))); 
neq25 := k(v1,k(k(v3,v2),v0)); 
neq26 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq27 := k(v1,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq28 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),v0)); 
neq29 := k(k(k(v3,v1),v2),k(v3,v2)); 
neq30 := k(k(k(v3,v1),v2),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq31 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq32 := k(k(k(v3,v1),v2),v3); 
neq33 := k(k(k(v3,v1),v2),k(k(v3,v2),v0)); 
neq34 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq35 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq36 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(v3,v2)); 
neq37 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq38 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq39 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v3); 
neq40 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(v3,v2),v0)); 
neq41 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(v3,v1)); 
neq42 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq43 := k(k(v3,v2),k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3)); 
neq44 := k(k(v3,v2),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq45 := k(k(v3,v2),k(k(k(v3,v1),v2),k(v3,v1))); 
neq46 := k(k(v3,v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq47 := k(k(v3,v2),k(v3,v1)); 
neq48 := k(k(v3,v2),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq49 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3),k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq50 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3),k(k(k(v3,v1),v2),k(v3,v1))); 
neq51 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3),k(k(v3,v2),v0)); 
neq52 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3),k(v3,v1)); 
neq53 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),v3); 
neq54 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq55 := k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(v3,v1)); 
neq56 := k(k(k(k(v3,v1),v2),k(v3,v1)),v3); 
neq57 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)); 
neq58 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq59 := k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq60 := k(v3,k(k(v3,v2),v0)); 
neq61 := k(v3,k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq62 := k(v3,k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq63 := k(k(k(v3,v2),v0),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)); 
neq64 := k(k(k(v3,v2),v0),k(v3,v1)); 
neq65 := k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),k(v3,v1)); 
neq66 := k(k(v3,v1),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0)),k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2)) = 0 and 
       d(k(k(k(k(k(k(v3,v1),v2),k(v3,v1)),v0),v2),v3),k(k(k(k(k(v3,v1),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
