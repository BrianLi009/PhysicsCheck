...
def test_embed(): 
    ...
    s.add(((z_4*x_12-x_4*z_12)*z_2-(x_4*y_12-y_4*x_12)*y_2)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_2-(y_4*z_12-z_4*y_12)*z_2)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_2-(z_4*x_12-x_4*z_12)*x_2)==0) 
