...
def test_embed(): 
    ...
    s.add(((z_8*x_10-x_8*z_10)*z_0-(x_8*y_10-y_8*x_10)*y_0)==0) 
    s.add(((x_8*y_10-y_8*x_10)*x_0-(y_8*z_10-z_8*y_10)*z_0)==0) 
    s.add(((y_8*z_10-z_8*y_10)*y_0-(z_8*x_10-x_8*z_10)*x_0)==0) 
