...
def test_embed(): 
    ...
    s.add(((z_4*x_11-x_4*z_11)*z_12-(x_4*y_11-y_4*x_11)*y_12)==0) 
    s.add(((x_4*y_11-y_4*x_11)*x_12-(y_4*z_11-z_4*y_11)*z_12)==0) 
    s.add(((y_4*z_11-z_4*y_11)*y_12-(z_4*x_11-x_4*z_11)*x_12)==0) 
