...
def test_embed(): 
    ...
    s.add(((z_5*x_10-x_5*z_10)*z_13-(x_5*y_10-y_5*x_10)*y_13)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_13-(y_5*z_10-z_5*y_10)*z_13)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_13-(z_5*x_10-x_5*z_10)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_6 == 0) 
