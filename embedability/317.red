...
v3c2 := 0;
neq0 := k(v0,v2); 
neq1 := k(v0,k(k(k(v3,k(v2,v0)),v3),v2)); 
neq2 := k(v0,k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))))); 
neq3 := k(v0,k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq4 := k(v0,k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq5 := k(v0,v3); 
neq6 := k(v0,k(k(v3,k(v2,v0)),k(v0,v1))); 
neq7 := k(v0,k(k(v3,k(v2,v0)),v3)); 
neq8 := k(v0,k(v3,k(v2,v0))); 
neq9 := k(v2,v1); 
neq10 := k(v2,k(v0,v1)); 
neq11 := k(v2,k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))))); 
neq12 := k(v2,k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq13 := k(v2,v3); 
neq14 := k(v2,k(k(v3,k(v2,v0)),k(v0,v1))); 
neq15 := k(v2,k(k(v3,k(v2,v0)),v3)); 
neq16 := k(v2,k(v3,k(v2,v0))); 
neq17 := k(v1,k(v2,v0)); 
neq18 := k(v1,k(k(k(v3,k(v2,v0)),v3),v2)); 
neq19 := k(v1,k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))))); 
neq20 := k(v1,k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq21 := k(v1,k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq22 := k(v1,k(k(v3,k(v2,v0)),k(v0,v1))); 
neq23 := k(v1,k(k(v3,k(v2,v0)),v3)); 
neq24 := k(v1,k(v3,k(v2,v0))); 
neq25 := k(k(v2,v0),k(v0,v1)); 
neq26 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v3),v2)); 
neq27 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))))); 
neq28 := k(k(v2,v0),k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq29 := k(k(v2,v0),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq30 := k(k(v2,v0),v3); 
neq31 := k(k(v2,v0),k(k(v3,k(v2,v0)),k(v0,v1))); 
neq32 := k(k(v2,v0),k(k(v3,k(v2,v0)),v3)); 
neq33 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v3),v2)); 
neq34 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))))); 
neq35 := k(k(v0,v1),k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq36 := k(k(v0,v1),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq37 := k(k(v0,v1),v3); 
neq38 := k(k(v0,v1),k(k(v3,k(v2,v0)),v3)); 
neq39 := k(k(v0,v1),k(v3,k(v2,v0))); 
neq40 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq41 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))); 
neq42 := k(k(k(k(v3,k(v2,v0)),v3),v2),v3); 
neq43 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(k(v3,k(v2,v0)),k(v0,v1))); 
neq44 := k(k(k(k(v3,k(v2,v0)),v3),v2),k(v3,k(v2,v0))); 
neq45 := k(k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))),k(k(k(v3,k(v2,v0)),k(v0,v1)),v2)); 
neq46 := k(k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))),v3); 
neq47 := k(k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))),k(k(v3,k(v2,v0)),k(v0,v1))); 
neq48 := k(k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))),k(v3,k(v2,v0))); 
neq49 := k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),v3); 
neq50 := k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),v3)); 
neq51 := k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(v3,k(v2,v0))); 
neq52 := k(k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))),v3); 
neq53 := k(k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))),k(k(v3,k(v2,v0)),v3)); 
neq54 := k(k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1))),k(v3,k(v2,v0))); 
neq55 := k(v3,k(k(v3,k(v2,v0)),k(v0,v1))); 
neq56 := k(k(k(v3,k(v2,v0)),k(v0,v1)),k(k(v3,k(v2,v0)),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,k(v2,v0)),v3),k(k(k(k(v3,k(v2,v0)),k(v0,v1)),v2),k(k(v3,k(v2,v0)),k(v0,v1)))),k(k(k(v3,k(v2,v0)),v3),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
