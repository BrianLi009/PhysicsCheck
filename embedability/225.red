...
neq7 := k(v2,k(k(k(k(v3,v0),v2),v2),k(v3,v1))); 
neq8 := k(v2,k(v3,v0)); 
...
neq12 := k(k(k(k(k(v3,v0),v3),k(v0,v1)),k(v0,v1)),k(k(k(v3,v0),v2),v2)); 
neq13 := k(k(k(k(k(v3,v0),v3),k(v0,v1)),k(v0,v1)),k(k(v3,v0),v2)); 
...
neq20 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(k(v3,v0),v2),v2)); 
neq21 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(v3,v0),v2)); 
neq22 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(v3,v1)); 
neq23 := k(k(k(k(v3,v0),v3),k(v0,v1)),k(k(k(k(v3,v0),v2),v2),k(v3,v1))); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(v3,v0),v3),k(v0,v1)),k(v0,v1)),k(k(k(k(v3,v0),v2),v2),k(v3,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
