...
v3 := {v3c1, v3c2, v3c3}; 
v2c3 := 0;
neq0 := k(v2,k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0)); 
neq1 := k(v2,k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),v3))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
...
neq10 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(v0,v1)); 
neq11 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(v3,v2)); 
neq12 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),v3); 
neq13 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1))); 
neq14 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(k(k(v3,v2),v1),v1)); 
neq15 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(k(k(k(v3,v2),v1),v1),v3)); 
neq16 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(k(v3,v2),v1)); 
neq17 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),v1); 
neq18 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0),k(k(k(k(k(v3,v2),v1),v1),v3),v3)); 
neq19 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),v3)),k(k(k(k(k(v3,v2),v1),v1),v3),v2)); 
neq20 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),v3)),v0); 
neq21 := k(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),v3)),k(v0,v1)); 
...
neq28 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0); 
neq29 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(v0,v1)); 
neq30 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(v3,v2)); 
neq31 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v3); 
neq32 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1))); 
...
neq36 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(k(k(k(v3,v2),v1),v1),v3),v3)); 
neq37 := k(v0,k(v3,v2)); 
neq38 := k(v0,v3); 
...
neq45 := k(k(v0,v1),v3); 
neq46 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1))); 
neq47 := k(k(v0,v1),k(k(k(v3,v2),v1),v1)); 
neq48 := k(k(v0,v1),k(k(k(k(v3,v2),v1),v1),v3)); 
neq49 := k(k(v0,v1),k(k(v3,v2),v1)); 
neq50 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),v1),v3),v3)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),v3)),k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
