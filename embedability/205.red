...
neq8 := k(v2,v1); 
neq9 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),v3); 
neq10 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(k(k(k(k(v3,v2),v1),v1),v3),v2)); 
neq11 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(v3,v2)); 
neq12 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(v0,v1)); 
neq13 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(k(k(v3,v2),v1),v1)); 
neq14 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(k(k(k(v3,v2),v1),v1),v3)); 
neq15 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(k(v3,v2),v1)); 
neq16 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),v1); 
...
neq23 := k(v3,v1); 
neq24 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(k(k(k(v3,v2),v1),v1),v3),v2)); 
neq25 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(v3,v2)); 
neq26 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0); 
neq27 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(v0,v1)); 
neq28 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(v3,v2),v1))); 
neq29 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(k(v3,v2),v1),v1)); 
neq30 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),k(k(v3,v2),v1)); 
neq31 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v1); 
neq32 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(v3,v2)); 
neq33 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v0); 
neq34 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(v0,v1)); 
neq35 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(k(v3,v2),v1),v1)); 
neq36 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(v3,v2),v1)); 
neq37 := k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),v1); 
neq38 := k(k(v3,v2),v0); 
neq39 := k(k(v3,v2),k(v0,v1)); 
neq40 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(v3,v2),v1))); 
...
neq48 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(v3,v2),v1))); 
neq49 := k(k(v0,v1),k(k(k(v3,v2),v1),v1)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v1),v1),v3),v3),v0),k(k(k(k(k(k(v3,v2),v1),v1),v3),v2),k(k(v3,v2),v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
