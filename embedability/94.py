...
def test_embed(): 
    ...
    s.add(((z_4*x_5-x_4*z_5)*z_0-(x_4*y_5-y_4*x_5)*y_0)==0) 
    s.add(((x_4*y_5-y_4*x_5)*x_0-(y_4*z_5-z_4*y_5)*z_0)==0) 
    s.add(((y_4*z_5-z_4*y_5)*y_0-(z_4*x_5-x_4*z_5)*x_0)==0) 
    s.add(((z_6*x_8-x_6*z_8)*z_1-(x_6*y_8-y_6*x_8)*y_1)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_1-(y_6*z_8-z_6*y_8)*z_1)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_1-(z_6*x_8-x_6*z_8)*x_1)==0) 
