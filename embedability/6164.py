...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_7-(x_2*y_13-y_2*x_13)*y_7)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_7-(y_2*z_13-z_2*y_13)*z_7)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_7-(z_2*x_13-x_2*z_13)*x_7)==0) 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_4-(x_8*y_12-y_8*x_12)*y_4)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_4-(y_8*z_12-z_8*y_12)*z_4)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_4-(z_8*x_12-x_8*z_12)*x_4)==0) 
