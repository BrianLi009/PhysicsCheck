...
neq5 := k(v2,k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1)))); 
neq6 := k(v2,v1); 
neq7 := k(v2,v3); 
neq8 := k(k(k(v2,v0),v0),k(k(v3,k(v2,v0)),k(v2,v0))); 
neq9 := k(k(k(v2,v0),v0),k(v3,k(v2,v0))); 
neq10 := k(k(k(v2,v0),v0),k(v2,v1)); 
neq11 := k(k(k(v2,v0),v0),k(v3,v2)); 
...
neq16 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v2,v1)); 
neq17 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(v3,v2)); 
neq18 := k(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(k(v2,v0),v0),k(v2,v1))); 
neq19 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v1); 
neq20 := k(k(k(v3,k(v2,v0)),k(v2,v0)),v3); 
neq21 := k(k(v3,k(v2,v0)),v0); 
neq22 := k(k(v3,k(v2,v0)),k(v2,v1)); 
neq23 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq24 := k(k(v3,k(v2,v0)),k(k(k(v2,v0),v0),k(v2,v1))); 
neq25 := k(k(v3,k(v2,v0)),k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1)))); 
neq26 := k(k(v3,k(v2,v0)),v1); 
neq27 := k(v0,k(v2,v1)); 
neq28 := k(v0,k(v3,v2)); 
neq29 := k(v0,k(k(k(v2,v0),v0),k(v2,v1))); 
neq30 := k(v0,k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1)))); 
neq31 := k(v0,v3); 
neq32 := k(k(v2,v1),k(v3,v2)); 
neq33 := k(k(v2,v1),k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1)))); 
neq34 := k(k(v2,v1),v3); 
neq35 := k(k(v2,v1),k(v2,v0)); 
neq36 := k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1))); 
neq37 := k(k(v3,v2),v1); 
neq38 := k(k(v3,v2),k(v2,v0)); 
neq39 := k(k(k(k(v2,v0),v0),k(v2,v1)),v1); 
neq40 := k(k(k(k(v2,v0),v0),k(v2,v1)),v3); 
neq41 := k(k(k(k(v2,v0),v0),k(v2,v1)),k(v2,v0)); 
neq42 := k(k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1))),v1); 
neq43 := k(k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1))),v3); 
neq44 := k(k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1))),k(v2,v0)); 
neq45 := k(v1,k(v2,v0)); 
neq46 := k(v3,k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(v3,k(v2,v0)),k(v2,v0)),k(k(v3,v2),k(k(k(v2,v0),v0),k(v2,v1)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
