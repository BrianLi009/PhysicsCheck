...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v0,k(k(v2,v1),v1)); 
neq1 := k(v0,k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq2 := k(v0,v2); 
neq3 := k(v0,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq4 := k(v0,k(v2,v1)); 
neq5 := k(v0,k(k(v2,v0),v2)); 
neq6 := k(v0,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq7 := k(v1,k(v2,v0)); 
neq8 := k(v1,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0)); 
neq9 := k(v1,k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq10 := k(v1,v2); 
neq11 := k(v1,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq12 := k(v1,k(k(v2,v0),v2)); 
neq13 := k(v1,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq14 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0)); 
neq15 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq16 := k(k(v2,v0),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq17 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq18 := k(k(v2,v0),k(v2,v1)); 
neq19 := k(k(v2,v0),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq20 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0),k(k(v2,v1),v1)); 
neq21 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),k(k(v2,v1),v1))); 
neq22 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0),v2); 
neq23 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0),k(v2,v1)); 
neq24 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0),k(k(v2,v0),v2)); 
neq25 := k(k(k(v2,v1),v1),v2); 
neq26 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq27 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq28 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq29 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v2); 
neq30 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq31 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v2,v1)); 
neq32 := k(v2,k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq33 := k(v2,k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
neq34 := k(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(v2,v0),v2)); 
neq35 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq36 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v0)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
