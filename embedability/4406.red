...
neq4 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq5 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq6 := k(v2,k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq7 := k(v2,k(k(v3,v2),v3)); 
neq8 := k(v2,v1); 
neq9 := k(v2,v3); 
neq10 := k(k(v2,v0),k(v0,v1)); 
neq11 := k(k(v2,v0),k(k(k(v3,v2),v3),k(v0,v1))); 
neq12 := k(k(v2,v0),k(k(k(k(v3,v2),v3),k(v0,v1)),v2)); 
neq13 := k(k(v2,v0),k(v3,v2)); 
neq14 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq15 := k(k(v2,v0),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq16 := k(k(v2,v0),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq17 := k(k(v2,v0),k(k(v3,v2),v3)); 
neq18 := k(k(v2,v0),v1); 
neq19 := k(k(v2,v0),v3); 
neq20 := k(k(v0,v1),k(k(k(k(v3,v2),v3),k(v0,v1)),v2)); 
neq21 := k(k(v0,v1),k(v3,k(v2,v0))); 
neq22 := k(k(v0,v1),k(v3,v2)); 
neq23 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq24 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq25 := k(k(v0,v1),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq26 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq27 := k(k(v0,v1),v3); 
neq28 := k(k(k(k(v3,v2),v3),k(v0,v1)),v0); 
neq29 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,k(v2,v0))); 
neq30 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(v3,v2)); 
neq31 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq32 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq33 := k(k(k(k(v3,v2),v3),k(v0,v1)),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq34 := k(k(k(k(v3,v2),v3),k(v0,v1)),v1); 
neq35 := k(k(k(k(v3,v2),v3),k(v0,v1)),v3); 
neq36 := k(v0,k(k(k(k(v3,v2),v3),k(v0,v1)),v2)); 
neq37 := k(v0,k(v3,k(v2,v0))); 
neq38 := k(v0,k(v3,v2)); 
neq39 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq40 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq41 := k(v0,k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq42 := k(v0,k(k(v3,v2),v3)); 
neq43 := k(v0,v3); 
neq44 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))); 
neq45 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,v2)); 
neq46 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq47 := k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
...
neq51 := k(k(v3,k(v2,v0)),k(v3,v2)); 
neq52 := k(k(v3,k(v2,v0)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq53 := k(k(v3,k(v2,v0)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq54 := k(k(v3,k(v2,v0)),k(k(v3,v2),v3)); 
neq55 := k(k(v3,k(v2,v0)),v1); 
neq56 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)); 
neq57 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3))); 
neq58 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0)))); 
neq59 := k(k(v3,v2),v1); 
neq60 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1),k(k(v3,v2),v3)); 
neq61 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1),v3); 
neq62 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3)),v1); 
neq63 := k(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3)),v3); 
neq64 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3)); 
neq65 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1); 
neq66 := k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v3); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),k(k(v3,v2),v3)),k(k(k(k(k(k(v3,v2),v3),k(v0,v1)),v2),k(v3,k(v2,v0))),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
