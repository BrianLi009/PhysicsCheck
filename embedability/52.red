...
neq1 := k(v2,v1); 
neq2 := k(v2,v3); 
neq3 := k(v2,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))); 
neq4 := k(v2,k(v3,v0)); 
neq5 := k(v2,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq6 := k(v2,k(k(v3,v0),v3)); 
neq7 := k(v2,k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq8 := k(k(v3,v2),k(v0,v1)); 
neq9 := k(k(v3,v2),v0); 
neq10 := k(k(v3,v2),v1); 
neq11 := k(k(v3,v2),k(v3,v0)); 
neq12 := k(k(v3,v2),k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq13 := k(k(v3,v2),k(k(k(v3,v0),v3),v2)); 
neq14 := k(k(v3,v2),k(k(v3,v0),v3)); 
neq15 := k(k(v3,v2),k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq16 := k(k(v0,v1),v3); 
neq17 := k(k(v0,v1),k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))); 
neq18 := k(k(v0,v1),k(v3,v0)); 
neq19 := k(k(v0,v1),k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq20 := k(k(v0,v1),k(k(k(v3,v0),v3),v2)); 
neq21 := k(k(v0,v1),k(k(v3,v0),v3)); 
neq22 := k(k(v0,v1),k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq23 := k(v0,v3); 
neq24 := k(v0,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))); 
neq25 := k(v0,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq26 := k(v0,k(k(k(v3,v0),v3),v2)); 
neq27 := k(v0,k(k(v3,v0),v3)); 
neq28 := k(v0,k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq29 := k(v1,v3); 
neq30 := k(v1,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))); 
neq31 := k(v1,k(v3,v0)); 
neq32 := k(v1,k(k(k(v3,v0),v3),v2)); 
neq33 := k(v1,k(k(v3,v0),v3)); 
neq34 := k(v1,k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq35 := k(v3,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))); 
neq36 := k(v3,k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq37 := k(v3,k(k(k(v3,v0),v3),v2)); 
neq38 := k(v3,k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq39 := k(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2)),k(v3,v0)); 
neq40 := k(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2)),k(k(k(v3,v0),v3),v2)); 
neq41 := k(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2)),k(k(v3,v0),v3)); 
neq42 := k(k(v3,v0),k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1)); 
neq43 := k(k(v3,v0),k(k(k(v3,v0),v3),v2)); 
neq44 := k(k(v3,v0),k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3))); 
neq45 := k(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1),k(k(k(v3,v0),v3),v2)); 
neq46 := k(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1),k(k(v3,v0),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),v1),k(k(k(k(k(v3,v0),v3),v2),k(k(v3,v0),v3)),k(v3,v2))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
