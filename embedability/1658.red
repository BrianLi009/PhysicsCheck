...
neq1 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1))); 
neq2 := k(v2,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1))); 
...
neq10 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1))); 
neq11 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))); 
neq12 := k(k(k(v2,v1),v1),v0); 
neq13 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq14 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1))); 
neq15 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq16 := k(k(k(v2,v1),v1),k(k(v2,v0),v0)); 
neq17 := k(k(k(v2,v1),v1),k(k(k(v2,v0),v2),v1)); 
neq18 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq19 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),v0); 
neq20 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(v2,v0),v2)); 
neq21 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1))); 
neq22 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq23 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),v1); 
...
neq27 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),v0); 
neq28 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v2)); 
neq29 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq30 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq31 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),v1); 
neq32 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(v2,v0),v0)); 
neq33 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(k(k(v2,v0),v2),v1)); 
neq34 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1)),k(v2,v0)); 
neq35 := k(v0,k(k(v2,v0),v2)); 
neq36 := k(v0,k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1))); 
neq37 := k(v0,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq38 := k(v0,k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq39 := k(v0,k(k(k(v2,v0),v2),v1)); 
neq40 := k(v0,k(v2,v1)); 
neq41 := k(k(k(v2,v0),v2),k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1))); 
neq42 := k(k(k(v2,v0),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq43 := k(k(k(v2,v0),v2),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq44 := k(k(k(v2,v0),v2),v1); 
neq45 := k(k(k(v2,v0),v2),k(k(v2,v0),v0)); 
neq46 := k(k(k(v2,v0),v2),k(v2,v1)); 
neq47 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0))); 
neq48 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),v1); 
neq49 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),k(k(v2,v0),v0)); 
neq50 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),k(v2,v0)); 
neq51 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),k(v2,v1)); 
neq52 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(k(k(v2,v1),v1),k(k(v2,v0),v0))); 
neq53 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),v1); 
neq54 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v0)); 
neq55 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)); 
neq56 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),v1); 
neq57 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)); 
...
neq65 := k(k(k(k(v2,v0),v2),v1),k(v2,v1)); 
...
phi := 
       ...
       d(k(k(k(k(v2,v1),v1),k(k(v2,v0),v0)),k(k(k(v2,v0),v2),v1)),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v0)),k(v2,v1)),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
