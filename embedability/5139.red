...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))); 
neq1 := k(v2,v1); 
neq2 := k(v2,k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))); 
neq3 := k(v2,k(k(v3,v1),v1)); 
neq4 := k(v2,k(k(k(v3,v1),v3),k(v2,v0))); 
neq5 := k(v2,v3); 
...
neq12 := k(k(k(k(v3,v1),v3),v2),k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))); 
neq13 := k(k(k(k(v3,v1),v3),v2),k(k(v3,v1),v1)); 
neq14 := k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v3),k(v2,v0))); 
neq15 := k(k(k(k(v3,v1),v3),v2),v3); 
neq16 := k(k(k(k(v3,v1),v3),v2),k(v3,k(v2,v0))); 
neq17 := k(k(k(k(v3,v1),v3),v2),k(v2,v0)); 
neq18 := k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq19 := k(k(k(k(v3,v1),v3),v2),k(v3,v1)); 
neq20 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),v0); 
neq21 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),v1); 
neq22 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(v3,v1),v1)); 
neq23 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v3),k(v2,v0))); 
neq24 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),v3); 
neq25 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v3,k(v2,v0))); 
neq26 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v2,v0)); 
neq27 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(v3,v1),v3)); 
neq28 := k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v3,v1)); 
neq29 := k(v0,k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))); 
neq30 := k(v0,k(k(v3,v1),v1)); 
neq31 := k(v0,k(k(k(v3,v1),v3),k(v2,v0))); 
neq32 := k(v0,v3); 
neq33 := k(v0,k(v3,k(v2,v0))); 
neq34 := k(v0,k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq35 := k(v0,k(k(v3,v1),v3)); 
neq36 := k(v0,k(v3,v1)); 
neq37 := k(v1,k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))); 
neq38 := k(v1,k(k(k(v3,v1),v3),k(v2,v0))); 
neq39 := k(v1,v3); 
neq40 := k(v1,k(v3,k(v2,v0))); 
neq41 := k(v1,k(v2,v0)); 
neq42 := k(v1,k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq43 := k(v1,k(k(v3,v1),v3)); 
neq44 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(v3,v1),v1)); 
neq45 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),v3); 
neq46 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v3,k(v2,v0))); 
neq47 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v2,v0)); 
neq48 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(v3,v1),v3)); 
neq49 := k(k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(v3,v1)); 
neq50 := k(k(k(v3,v1),v1),k(k(k(v3,v1),v3),k(v2,v0))); 
neq51 := k(k(k(v3,v1),v1),v3); 
neq52 := k(k(k(v3,v1),v1),k(v3,k(v2,v0))); 
neq53 := k(k(k(v3,v1),v1),k(v2,v0)); 
neq54 := k(k(k(v3,v1),v1),k(k(v3,v1),v3)); 
neq55 := k(k(k(k(v3,v1),v3),k(v2,v0)),v3); 
neq56 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v3,k(v2,v0))); 
neq57 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq58 := k(k(k(k(v3,v1),v3),k(v2,v0)),k(v3,v1)); 
neq59 := k(v3,k(v2,v0)); 
neq60 := k(v3,k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq61 := k(k(v3,k(v2,v0)),k(k(v3,v1),v3)); 
neq62 := k(k(v3,k(v2,v0)),k(v3,v1)); 
neq63 := k(k(v2,v0),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))); 
neq64 := k(k(v2,v0),k(k(v3,v1),v3)); 
neq65 := k(k(v2,v0),k(v3,v1)); 
neq66 := k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(k(v3,v1),v3)); 
neq67 := k(k(k(k(v3,v1),v1),k(v3,k(v2,v0))),k(v3,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(v3,v1),v3),k(v2,v0)),k(k(k(k(k(v3,v1),v3),v2),k(k(k(v3,v1),v1),k(v3,k(v2,v0)))),k(k(k(v3,v1),v1),k(v3,k(v2,v0))))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
