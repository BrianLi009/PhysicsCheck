...
neq1 := k(v2,v0); 
neq2 := k(v2,v3); 
neq3 := k(v2,k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq4 := k(v2,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq5 := k(v2,k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq6 := k(v2,k(k(k(v3,v0),v2),k(v3,v1))); 
neq7 := k(v2,k(k(v3,v2),v0)); 
neq8 := k(v2,k(v3,v1)); 
neq9 := k(k(v3,v0),k(v3,v2)); 
neq10 := k(k(v3,v0),v1); 
neq11 := k(k(v3,v0),k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq12 := k(k(v3,v0),k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq13 := k(k(v3,v0),k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq14 := k(k(v3,v0),k(k(k(v3,v0),v2),k(v3,v1))); 
neq15 := k(k(v3,v0),k(k(v3,v2),v0)); 
neq16 := k(k(v3,v0),k(v3,v1)); 
neq17 := k(k(v3,v2),v0); 
neq18 := k(k(v3,v2),v1); 
neq19 := k(k(v3,v2),k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq20 := k(k(v3,v2),k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq21 := k(k(v3,v2),k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq22 := k(k(v3,v2),k(k(k(v3,v0),v2),k(v3,v1))); 
neq23 := k(k(v3,v2),k(v3,v1)); 
neq24 := k(k(v3,v2),k(k(v3,v0),v2)); 
neq25 := k(v0,v3); 
neq26 := k(v0,k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq27 := k(v0,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq28 := k(v0,k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq29 := k(v0,k(k(k(v3,v0),v2),k(v3,v1))); 
neq30 := k(v0,k(v3,v1)); 
neq31 := k(v0,k(k(v3,v0),v2)); 
neq32 := k(v1,v3); 
neq33 := k(v1,k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq34 := k(v1,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq35 := k(v1,k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq36 := k(v1,k(k(k(v3,v0),v2),k(v3,v1))); 
neq37 := k(v1,k(k(v3,v2),v0)); 
neq38 := k(v1,k(k(v3,v0),v2)); 
neq39 := k(v3,k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))); 
neq40 := k(v3,k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1))); 
neq41 := k(v3,k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq42 := k(v3,k(k(k(v3,v0),v2),k(v3,v1))); 
neq43 := k(v3,k(k(v3,v2),v0)); 
neq44 := k(v3,k(k(v3,v0),v2)); 
neq45 := k(k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0)),k(k(k(v3,v0),v2),k(v3,v1))); 
neq46 := k(k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0)),k(v3,v1)); 
neq47 := k(k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0)),k(k(v3,v0),v2)); 
neq48 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1)),k(k(k(v3,v0),v2),k(k(v3,v2),v0))); 
neq49 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1)),k(k(v3,v2),v0)); 
neq50 := k(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1)),k(k(v3,v0),v2)); 
neq51 := k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(k(v3,v0),v2),k(v3,v1))); 
neq52 := k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(v3,v1)); 
neq53 := k(k(k(k(v3,v0),v2),k(v3,v1)),k(k(v3,v2),v0)); 
neq54 := k(k(k(v3,v2),v0),k(v3,v1)); 
neq55 := k(k(k(v3,v2),v0),k(k(v3,v0),v2)); 
neq56 := k(k(v3,v1),k(k(v3,v0),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v1) = 0 and 
       d(k(k(k(k(v3,v0),v2),k(v3,v1)),k(v3,v1)),k(k(k(k(v3,v0),v2),k(k(v3,v2),v0)),k(k(v3,v2),v0))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c1,
