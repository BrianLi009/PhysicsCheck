...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(v2,k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3)); 
neq1 := k(v2,k(v0,v1)); 
neq2 := k(v2,v0); 
neq3 := k(v2,k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3)); 
neq4 := k(v2,v1); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(k(k(v3,v1),v2),v2),v0)); 
neq7 := k(v2,k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq8 := k(v2,k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq9 := k(v2,k(v3,v1)); 
neq10 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(v0,v1)); 
neq11 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),v0); 
neq12 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(k(k(v3,v1),v2),v2)); 
neq13 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),v1); 
neq14 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(k(v3,v1),v2)); 
neq15 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(k(k(k(v3,v1),v2),v2),v0)); 
neq16 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq17 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq18 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3),k(v3,v1)); 
neq19 := k(k(v0,v1),k(k(k(v3,v1),v2),v2)); 
neq20 := k(k(v0,v1),k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3)); 
neq21 := k(k(v0,v1),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2)); 
neq22 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq23 := k(k(v0,v1),v3); 
neq24 := k(k(v0,v1),k(k(k(k(v3,v1),v2),v2),v0)); 
neq25 := k(k(v0,v1),k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq26 := k(k(v0,v1),k(v3,v1)); 
neq27 := k(v0,k(k(k(v3,v1),v2),v2)); 
neq28 := k(v0,k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3)); 
neq29 := k(v0,k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2)); 
neq30 := k(v0,k(k(v3,v1),v2)); 
neq31 := k(v0,v3); 
neq32 := k(v0,k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq33 := k(v0,k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq34 := k(v0,k(v3,v1)); 
neq35 := k(k(k(k(v3,v1),v2),v2),k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3)); 
neq36 := k(k(k(k(v3,v1),v2),v2),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2)); 
neq37 := k(k(k(k(v3,v1),v2),v2),v1); 
neq38 := k(k(k(k(v3,v1),v2),v2),v3); 
neq39 := k(k(k(k(v3,v1),v2),v2),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq40 := k(k(k(k(v3,v1),v2),v2),k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq41 := k(k(k(k(v3,v1),v2),v2),k(v3,v1)); 
neq42 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2)); 
neq43 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),v1); 
neq44 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(k(v3,v1),v2)); 
neq45 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(k(k(k(v3,v1),v2),v2),v0)); 
neq46 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq47 := k(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(v3,v1)); 
neq48 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v1); 
neq49 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),k(k(v3,v1),v2)); 
neq50 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3); 
neq51 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),k(k(k(k(v3,v1),v2),v2),v0)); 
neq52 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq53 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),k(v3,v1)); 
neq54 := k(v1,k(k(v3,v1),v2)); 
neq55 := k(v1,v3); 
neq56 := k(v1,k(k(k(k(v3,v1),v2),v2),v0)); 
neq57 := k(v1,k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq58 := k(v1,k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq59 := k(k(k(v3,v1),v2),v3); 
neq60 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),v2),v0)); 
neq61 := k(k(k(v3,v1),v2),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq62 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq63 := k(v3,k(k(k(k(v3,v1),v2),v2),v0)); 
neq64 := k(v3,k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq65 := k(v3,k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1))); 
neq66 := k(k(k(k(k(v3,v1),v2),v2),v0),k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1))); 
neq67 := k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)); 
neq68 := k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),k(v3,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),k(v0,v1)),v3),k(k(k(k(k(k(k(v3,v1),v2),v2),v0),k(v3,v1)),v2),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
