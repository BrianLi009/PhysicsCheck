...
v2c1 := 0;
neq0 := k(v0,v3); 
neq1 := k(v0,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1)); 
neq2 := k(v0,k(v3,v2)); 
neq3 := k(v0,k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3))); 
neq4 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq5 := k(v0,k(k(k(v3,v2),v3),k(v2,v0))); 
neq6 := k(v0,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq7 := k(v0,k(k(v3,v2),v3)); 
neq8 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq9 := k(v2,v3); 
neq10 := k(v2,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1)); 
neq11 := k(v2,v1); 
neq12 := k(v2,k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3))); 
neq13 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq14 := k(v2,k(k(k(v3,v2),v3),k(v2,v0))); 
neq15 := k(v2,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq16 := k(v2,k(k(v3,v2),v3)); 
neq17 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq18 := k(v3,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1)); 
neq19 := k(v3,v1); 
neq20 := k(v3,k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3))); 
neq21 := k(v3,k(k(k(v3,v2),v3),k(v2,v0))); 
neq22 := k(v3,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq23 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq24 := k(v3,k(v2,v0)); 
neq25 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(v3,v2)); 
neq26 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq27 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(k(k(v3,v2),v3),k(v2,v0))); 
neq28 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq29 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(k(v3,v2),v3)); 
neq30 := k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),k(v2,v0)); 
neq31 := k(k(v3,v2),v1); 
neq32 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3))); 
neq33 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq34 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v2,v0))); 
neq35 := k(k(v3,v2),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq36 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq37 := k(k(v3,v2),k(v2,v0)); 
neq38 := k(v1,k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3))); 
neq39 := k(v1,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq40 := k(v1,k(k(k(v3,v2),v3),k(v2,v0))); 
neq41 := k(v1,k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq42 := k(v1,k(k(v3,v2),v3)); 
neq43 := k(v1,k(v2,v0)); 
neq44 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)); 
neq45 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq46 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq47 := k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),k(v2,v0)); 
neq48 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3),k(k(k(v3,v2),v3),k(v2,v0))); 
neq49 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3),k(k(v3,v2),v3)); 
neq50 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3),k(v2,v0)); 
neq51 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0))); 
neq52 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq53 := k(k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0)),k(k(v3,v2),v3)); 
neq54 := k(k(k(v3,v2),v3),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1)); 
neq55 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq56 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),k(v2,v0)),k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v2),v3)),v1),v1),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
