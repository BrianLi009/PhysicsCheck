...
def output_clause(g6_string, count):
    ...
    if find_triangle(edge_lst, n) != False:
        ...
        equation_7 = ' '*4+"s.add(" + x_1 + " == 0) \n" 
        equation_8 = ' '*4+"s.add(" + y_1 + " == 0) \n" 
        equation_9 = ' '*4+"s.add(" + z_1 + " == 1) \n" 
