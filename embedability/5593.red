...
v2 := {v2c1, v2c2, v2c3}; 
v3 := {v3c1, v3c2, v3c3}; 
neq0 := k(k(v2,k(v0,v1)),v3); 
neq1 := k(k(v2,k(v0,v1)),v0); 
neq2 := k(k(v2,k(v0,v1)),k(v3,v2)); 
neq3 := k(k(v2,k(v0,v1)),v1); 
neq4 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq5 := k(k(v2,k(v0,v1)),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq6 := k(k(v2,k(v0,v1)),k(k(v3,v2),v3)); 
neq7 := k(k(v2,k(v0,v1)),k(v2,v0)); 
neq8 := k(k(v2,k(v0,v1)),k(k(k(v3,v2),v3),k(v2,v0))); 
neq9 := k(k(v2,k(v0,v1)),k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq10 := k(v2,k(v0,v1)); 
neq11 := k(v2,v3); 
neq12 := k(v2,v0); 
neq13 := k(v2,v1); 
neq14 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq15 := k(v2,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq16 := k(v2,k(k(v3,v2),v3)); 
neq17 := k(v2,k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq18 := k(v2,k(k(k(v3,v2),v3),k(v2,v0))); 
neq19 := k(v2,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq20 := k(k(v0,v1),v3); 
neq21 := k(k(v0,v1),k(v3,v2)); 
neq22 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq23 := k(k(v0,v1),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq24 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq25 := k(k(v0,v1),k(v2,v0)); 
neq26 := k(k(v0,v1),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq27 := k(k(v0,v1),k(k(k(v3,v2),v3),k(v2,v0))); 
neq28 := k(k(v0,v1),k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq29 := k(v3,v0); 
neq30 := k(v3,v1); 
neq31 := k(v3,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq32 := k(v3,k(v2,v0)); 
neq33 := k(v3,k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq34 := k(v3,k(k(k(v3,v2),v3),k(v2,v0))); 
neq35 := k(v3,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq36 := k(v0,k(v3,v2)); 
neq37 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq38 := k(v0,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq39 := k(v0,k(k(v3,v2),v3)); 
neq40 := k(v0,k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq41 := k(v0,k(k(k(v3,v2),v3),k(v2,v0))); 
neq42 := k(v0,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq43 := k(k(v3,v2),v1); 
neq44 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)); 
neq45 := k(k(v3,v2),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq46 := k(k(v3,v2),k(v2,v0)); 
neq47 := k(k(v3,v2),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq48 := k(k(v3,v2),k(k(k(v3,v2),v3),k(v2,v0))); 
neq49 := k(k(v3,v2),k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq50 := k(v1,k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3)); 
neq51 := k(v1,k(k(v3,v2),v3)); 
neq52 := k(v1,k(v2,v0)); 
neq53 := k(v1,k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq54 := k(v1,k(k(k(v3,v2),v3),k(v2,v0))); 
neq55 := k(v1,k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq56 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1),k(k(v3,v2),v3)); 
neq57 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1),k(v2,v0)); 
neq58 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq59 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1),k(k(k(v3,v2),v3),k(v2,v0))); 
neq60 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(v3,v2),v3)); 
neq61 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(v2,v0)); 
neq62 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq63 := k(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(v3,v2),v3),k(v2,v0))); 
neq64 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq65 := k(k(k(v3,v2),v3),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq66 := k(k(k(v3,v2),v3),k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
neq67 := k(k(v2,v0),k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1)))); 
neq68 := k(k(v2,v0),k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0)))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v3),k(k(k(k(k(k(v3,v2),v3),k(v2,v0)),k(v2,k(v0,v1))),k(k(k(v3,v2),v3),k(v2,v0))),v1)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
