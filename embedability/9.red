...
neq7 := k(k(k(k(v3,v2),v3),k(v2,v0)),v0); 
neq8 := k(k(k(k(v3,v2),v3),k(v2,v0)),v3); 
neq9 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(v3,v1)); 
neq10 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(v3,v2)); 
neq11 := k(k(k(k(v3,v2),v3),k(v2,v0)),v1); 
neq12 := k(k(k(k(v3,v2),v3),k(v2,v0)),k(k(v3,v1),v1)); 
neq13 := k(k(k(k(v3,v1),v1),k(v2,v0)),v0); 
neq14 := k(k(k(k(v3,v1),v1),k(v2,v0)),v3); 
neq15 := k(k(k(k(v3,v1),v1),k(v2,v0)),k(v3,v1)); 
neq16 := k(k(k(k(v3,v1),v1),k(v2,v0)),k(v3,v2)); 
neq17 := k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v2),v3)); 
neq18 := k(k(k(k(v3,v1),v1),k(v2,v0)),v1); 
neq19 := k(v0,v3); 
neq20 := k(v0,k(v3,v1)); 
neq21 := k(v0,k(v3,v2)); 
neq22 := k(v0,k(k(v3,v2),v3)); 
neq23 := k(v0,k(k(v3,v1),v1)); 
neq24 := k(v3,v1); 
neq25 := k(v3,k(k(v3,v1),v1)); 
neq26 := k(v3,k(v2,v0)); 
neq27 := k(k(v3,v1),k(v3,v2)); 
neq28 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq29 := k(k(v3,v1),k(v2,v0)); 
neq30 := k(k(v3,v2),v1); 
neq31 := k(k(v3,v2),k(k(v3,v1),v1)); 
neq32 := k(k(v3,v2),k(v2,v0)); 
neq33 := k(k(k(v3,v2),v3),v1); 
neq34 := k(k(k(v3,v2),v3),k(k(v3,v1),v1)); 
neq35 := k(k(k(v3,v2),v3),k(v2,v0)); 
neq36 := k(v1,k(v2,v0)); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(v3,v1),v1),k(v2,v0)),k(k(k(v3,v2),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
