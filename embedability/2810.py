...
def test_embed(): 
    ...
    s.add(((z_1*x_10-x_1*z_10)*z_8-(x_1*y_10-y_1*x_10)*y_8)==0) 
    s.add(((x_1*y_10-y_1*x_10)*x_8-(y_1*z_10-z_1*y_10)*z_8)==0) 
    s.add(((y_1*z_10-z_1*y_10)*y_8-(z_1*x_10-x_1*z_10)*x_8)==0) 
