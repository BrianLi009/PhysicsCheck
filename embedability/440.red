...
v2c3 := 0;
neq0 := k(k(v0,v1),v3); 
neq1 := k(k(v0,v1),k(k(v3,v0),v3)); 
neq2 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3))); 
neq3 := k(k(v0,v1),k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2)); 
neq4 := k(k(v0,v1),k(v3,v2)); 
neq5 := k(k(v0,v1),k(k(k(v3,v2),v1),k(v3,v0))); 
neq6 := k(k(v0,v1),k(v3,v0)); 
neq7 := k(k(v0,v1),k(k(v3,v2),v1)); 
neq8 := k(k(v0,v1),k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq9 := k(v2,v3); 
neq10 := k(v2,k(k(v3,v0),v3)); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3))); 
neq13 := k(v2,v1); 
neq14 := k(v2,k(k(k(v3,v2),v1),k(v3,v0))); 
neq15 := k(v2,k(v3,v0)); 
neq16 := k(v2,k(k(v3,v2),v1)); 
neq17 := k(v2,k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq18 := k(v3,v0); 
neq19 := k(v3,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3))); 
neq20 := k(v3,v1); 
neq21 := k(v3,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2)); 
neq22 := k(v3,k(k(k(v3,v2),v1),k(v3,v0))); 
neq23 := k(v3,k(k(v3,v2),v1)); 
neq24 := k(v3,k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq25 := k(k(k(v3,v0),v3),v0); 
neq26 := k(k(k(v3,v0),v3),v1); 
neq27 := k(k(k(v3,v0),v3),k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2)); 
neq28 := k(k(k(v3,v0),v3),k(v3,v2)); 
neq29 := k(k(k(v3,v0),v3),k(k(k(v3,v2),v1),k(v3,v0))); 
neq30 := k(k(k(v3,v0),v3),k(k(v3,v2),v1)); 
neq31 := k(k(k(v3,v0),v3),k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq32 := k(v0,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3))); 
neq33 := k(v0,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2)); 
neq34 := k(v0,k(v3,v2)); 
neq35 := k(v0,k(k(k(v3,v2),v1),k(v3,v0))); 
neq36 := k(v0,k(k(v3,v2),v1)); 
neq37 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq38 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3)),v1); 
neq39 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3)),k(v3,v2)); 
neq40 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3)),k(k(k(v3,v2),v1),k(v3,v0))); 
neq41 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3)),k(v3,v0)); 
neq42 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3)),k(k(v3,v2),v1)); 
neq43 := k(v1,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2)); 
neq44 := k(v1,k(v3,v2)); 
neq45 := k(v1,k(k(k(v3,v2),v1),k(v3,v0))); 
neq46 := k(v1,k(v3,v0)); 
neq47 := k(v1,k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq48 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2),k(v3,v2)); 
neq49 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2),k(k(k(v3,v2),v1),k(v3,v0))); 
neq50 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2),k(v3,v0)); 
neq51 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2),k(k(v3,v2),v1)); 
neq52 := k(k(v3,v2),k(k(k(v3,v2),v1),k(v3,v0))); 
neq53 := k(k(v3,v2),k(v3,v0)); 
neq54 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
neq55 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq56 := k(k(v3,v0),k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),v2),k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(k(v3,v2),v1)),k(k(v3,v0),v3))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
