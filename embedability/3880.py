...
def test_embed(): 
    ...
    s.add(((z_0*x_9-x_0*z_9)*z_1-(x_0*y_9-y_0*x_9)*y_1)==0) 
    s.add(((x_0*y_9-y_0*x_9)*x_1-(y_0*z_9-z_0*y_9)*z_1)==0) 
    s.add(((y_0*z_9-z_0*y_9)*y_1-(z_0*x_9-x_0*z_9)*x_1)==0) 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_3-(x_12*y_13-y_12*x_13)*y_3)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_3-(y_12*z_13-z_12*y_13)*z_3)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_3-(z_12*x_13-x_12*z_13)*x_3)==0) 
    s.add(((z_3*x_12-x_3*z_12)*z_7-(x_3*y_12-y_3*x_12)*y_7)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_7-(y_3*z_12-z_3*y_12)*z_7)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_7-(z_3*x_12-x_3*z_12)*x_7)==0) 
    s.add(((z_4*x_11-x_4*z_11)*z_8-(x_4*y_11-y_4*x_11)*y_8)==0) 
    s.add(((x_4*y_11-y_4*x_11)*x_8-(y_4*z_11-z_4*y_11)*z_8)==0) 
    s.add(((y_4*z_11-z_4*y_11)*y_8-(z_4*x_11-x_4*z_11)*x_8)==0) 
