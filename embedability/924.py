...
def test_embed(): 
    ...
    s.add(((z_3*x_5-x_3*z_5)*z_7-(x_3*y_5-y_3*x_5)*y_7)==0) 
    s.add(((x_3*y_5-y_3*x_5)*x_7-(y_3*z_5-z_3*y_5)*z_7)==0) 
    s.add(((y_3*z_5-z_3*y_5)*y_7-(z_3*x_5-x_3*z_5)*x_7)==0) 
    s.add(((z_4*x_6-x_4*z_6)*z_8-(x_4*y_6-y_4*x_6)*y_8)==0) 
    s.add(((x_4*y_6-y_4*x_6)*x_8-(y_4*z_6-z_4*y_6)*z_8)==0) 
    s.add(((y_4*z_6-z_4*y_6)*y_8-(z_4*x_6-x_4*z_6)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_9 == 0) 
