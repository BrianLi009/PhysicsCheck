...
v3 := {v3c1, v3c2, v3c3}; 
v3c3 := 0;
neq0 := k(v2,k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3)); 
neq1 := k(v2,v3); 
neq2 := k(v2,v0); 
neq3 := k(v2,v1); 
neq4 := k(v2,k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq5 := k(v2,k(v3,k(v0,v1))); 
neq6 := k(v2,k(v0,v1)); 
neq7 := k(v2,k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq8 := k(v2,k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq9 := k(k(v2,v1),k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3)); 
neq10 := k(k(v2,v1),v3); 
neq11 := k(k(v2,v1),v0); 
neq12 := k(k(v2,v1),k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2)); 
neq13 := k(k(v2,v1),k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq14 := k(k(v2,v1),k(v3,k(v0,v1))); 
neq15 := k(k(v2,v1),k(v0,v1)); 
neq16 := k(k(v2,v1),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq17 := k(k(v2,v1),k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq18 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),v0); 
neq19 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),v1); 
neq20 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(k(v2,v1),v2)); 
neq21 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq22 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(v3,k(v0,v1))); 
neq23 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(v0,v1)); 
neq24 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq25 := k(v3,v0); 
neq26 := k(v3,k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2)); 
neq27 := k(v3,v1); 
neq28 := k(v3,k(k(v2,v1),v2)); 
neq29 := k(v3,k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq30 := k(v3,k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq31 := k(v3,k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq32 := k(v0,k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2)); 
neq33 := k(v0,k(k(v2,v1),v2)); 
neq34 := k(v0,k(v3,k(v0,v1))); 
neq35 := k(v0,k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq36 := k(v0,k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq37 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),v1); 
neq38 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),k(k(v2,v1),v2)); 
neq39 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq40 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),k(v3,k(v0,v1))); 
neq41 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),k(v0,v1)); 
neq42 := k(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq43 := k(v1,k(k(v2,v1),v2)); 
neq44 := k(v1,k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq45 := k(v1,k(v3,k(v0,v1))); 
neq46 := k(v1,k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq47 := k(v1,k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq48 := k(k(k(v2,v1),v2),k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0)); 
neq49 := k(k(k(v2,v1),v2),k(v3,k(v0,v1))); 
neq50 := k(k(k(v2,v1),v2),k(v0,v1)); 
neq51 := k(k(k(v2,v1),v2),k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq52 := k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(v3,k(v0,v1))); 
neq53 := k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(v0,v1)); 
neq54 := k(k(v3,k(v0,v1)),k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
neq55 := k(k(v0,v1),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))); 
neq56 := k(k(v0,v1),k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2)))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,k(v0,v1)) = 0 and 
       d(k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v3),k(k(k(k(k(v3,k(v0,v1)),k(k(v2,v1),v2)),v0),k(k(v3,k(v0,v1)),k(k(v2,v1),v2))),v2)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
