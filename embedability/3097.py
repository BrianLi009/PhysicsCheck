...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_10-(x_2*y_13-y_2*x_13)*y_10)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_10-(y_2*z_13-z_2*y_13)*z_10)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_10-(z_2*x_13-x_2*z_13)*x_10)==0) 
