...
def test_embed(): 
    ...
    y_9 = Real('y_9')
    z_9 = Real('z_9')
    s.add(x_7*x_6+y_7*y_6+z_7*z_6 == 0)
    ...
    s.add(((z_4*x_1-x_4*z_1)*z_9-(x_4*y_1-y_4*x_1)*y_9)==0) 
    s.add(((x_4*y_1-y_4*x_1)*x_9-(y_4*z_1-z_4*y_1)*z_9)==0) 
    s.add(((y_4*z_1-z_4*y_1)*y_9-(z_4*x_1-x_4*z_1)*x_9)==0) 
    s.add(((z_9*x_4-x_9*z_4)*z_3-(x_9*y_4-y_9*x_4)*y_3)==0) 
    s.add(((x_9*y_4-y_9*x_4)*x_3-(y_9*z_4-z_9*y_4)*z_3)==0) 
    s.add(((y_9*z_4-z_9*y_4)*y_3-(z_9*x_4-x_9*z_4)*x_3)==0) 
    s.add(((z_9*x_1-x_9*z_1)*z_5-(x_9*y_1-y_9*x_1)*y_5)==0) 
    s.add(((x_9*y_1-y_9*x_1)*x_5-(y_9*z_1-z_9*y_1)*z_5)==0) 
    s.add(((y_9*z_1-z_9*y_1)*y_5-(z_9*x_1-x_9*z_1)*x_5)==0) 
    s.add(((z_3*x_0-x_3*z_0)*z_2-(x_3*y_0-y_3*x_0)*y_2)==0) 
    s.add(((x_3*y_0-y_3*x_0)*x_2-(y_3*z_0-z_3*y_0)*z_2)==0) 
    s.add(((y_3*z_0-z_3*y_0)*y_2-(z_3*x_0-x_3*z_0)*x_2)==0) 
    s.add(((z_2*x_0-x_2*z_0)*z_8-(x_2*y_0-y_2*x_0)*y_8)==0) 
    s.add(((x_2*y_0-y_2*x_0)*x_8-(y_2*z_0-z_2*y_0)*z_8)==0) 
    s.add(((y_2*z_0-z_2*y_0)*y_8-(z_2*x_0-x_2*z_0)*x_8)==0) 
    s.add(((z_8*x_5-x_8*z_5)*z_6-(x_8*y_5-y_8*x_5)*y_6)==0) 
    s.add(((x_8*y_5-y_8*x_5)*x_6-(y_8*z_5-z_8*y_5)*z_6)==0) 
    s.add(((y_8*z_5-z_8*y_5)*y_6-(z_8*x_5-x_8*z_5)*x_6)==0) 
    s.add(((z_8*x_4-x_8*z_4)*z_7-(x_8*y_4-y_8*x_4)*y_7)==0) 
    s.add(((x_8*y_4-y_8*x_4)*x_7-(y_8*z_4-z_8*y_4)*z_7)==0) 
    s.add(((y_8*z_4-z_8*y_4)*y_7-(z_8*x_4-x_8*z_4)*x_7)==0) 
