...
def test_embed(): 
    ...
    s.add(((z_2*x_11-x_2*z_11)*z_4-(x_2*y_11-y_2*x_11)*y_4)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_4-(y_2*z_11-z_2*y_11)*z_4)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_4-(z_2*x_11-x_2*z_11)*x_4)==0) 
