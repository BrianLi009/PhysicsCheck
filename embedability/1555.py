...
def test_embed(): 
    ...
    s.add(((z_1*x_9-x_1*z_9)*z_10-(x_1*y_9-y_1*x_9)*y_10)==0) 
    s.add(((x_1*y_9-y_1*x_9)*x_10-(y_1*z_9-z_1*y_9)*z_10)==0) 
    s.add(((y_1*z_9-z_1*y_9)*y_10-(z_1*x_9-x_1*z_9)*x_10)==0) 
    ...
    s.add(((z_5*x_12-x_5*z_12)*z_4-(x_5*y_12-y_5*x_12)*y_4)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_4-(y_5*z_12-z_5*y_12)*z_4)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_4-(z_5*x_12-x_5*z_12)*x_4)==0) 
