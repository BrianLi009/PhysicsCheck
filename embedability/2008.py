...
def test_embed(): 
    ...
    s.add(((z_2*x_9-x_2*z_9)*z_10-(x_2*y_9-y_2*x_9)*y_10)==0) 
    s.add(((x_2*y_9-y_2*x_9)*x_10-(y_2*z_9-z_2*y_9)*z_10)==0) 
    s.add(((y_2*z_9-z_2*y_9)*y_10-(z_2*x_9-x_2*z_9)*x_10)==0) 
    s.add(((z_3*x_7-x_3*z_7)*z_12-(x_3*y_7-y_3*x_7)*y_12)==0) 
    s.add(((x_3*y_7-y_3*x_7)*x_12-(y_3*z_7-z_3*y_7)*z_12)==0) 
    s.add(((y_3*z_7-z_3*y_7)*y_12-(z_3*x_7-x_3*z_7)*x_12)==0) 
