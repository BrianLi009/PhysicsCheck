...
def test_embed(): 
    ...
    s.add(((z_2*x_11-x_2*z_11)*z_1-(x_2*y_11-y_2*x_11)*y_1)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_1-(y_2*z_11-z_2*y_11)*z_1)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_1-(z_2*x_11-x_2*z_11)*x_1)==0) 
