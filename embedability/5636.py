...
def test_embed(): 
    ...
    s.add(((z_4*x_11-x_4*z_11)*z_3-(x_4*y_11-y_4*x_11)*y_3)==0) 
    s.add(((x_4*y_11-y_4*x_11)*x_3-(y_4*z_11-z_4*y_11)*z_3)==0) 
    s.add(((y_4*z_11-z_4*y_11)*y_3-(z_4*x_11-x_4*z_11)*x_3)==0) 
