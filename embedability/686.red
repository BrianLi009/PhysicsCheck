...
neq3 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq4 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(v2,v1),v2),v0)); 
neq5 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1)); 
neq6 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),v1); 
neq7 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(v2,v1),v2)); 
neq8 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq9 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq10 := k(k(k(v2,v1),v1),v2); 
neq11 := k(k(k(v2,v1),v1),v0); 
neq12 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq13 := k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)); 
neq14 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1)); 
neq15 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq16 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq17 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq18 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq19 := k(v2,v0); 
neq20 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq21 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq22 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1)); 
neq23 := k(v2,v1); 
neq24 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq25 := k(v2,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq26 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq27 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2))); 
neq28 := k(v0,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1)); 
neq29 := k(v0,k(k(v2,v1),v2)); 
neq30 := k(v0,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq31 := k(v0,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq32 := k(v0,k(k(k(v2,v1),v1),k(v2,v0))); 
neq33 := k(v0,k(v2,v1)); 
neq34 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(v2,v1),v2),v0)); 
neq35 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1); 
neq36 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq37 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq38 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(v2,v0)); 
neq39 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),k(v2,v1)); 
neq40 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1)); 
neq41 := k(k(k(k(v2,v1),v2),v0),v1); 
neq42 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq43 := k(k(k(k(v2,v1),v2),v0),k(v2,v0)); 
neq44 := k(k(k(k(v2,v1),v2),v0),k(k(k(v2,v1),v1),k(v2,v0))); 
neq45 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq46 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(v2,v1),v2)); 
neq47 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq48 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(v2,v0)); 
neq49 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq50 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(v2,v1)); 
neq51 := k(v1,k(k(v2,v1),v2)); 
neq52 := k(v1,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq53 := k(v1,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq54 := k(v1,k(v2,v0)); 
neq55 := k(v1,k(k(k(v2,v1),v1),k(v2,v0))); 
neq56 := k(k(k(v2,v1),v2),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq57 := k(k(k(v2,v1),v2),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))); 
neq58 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq59 := k(k(k(v2,v1),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq60 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)); 
neq61 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)); 
neq62 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq63 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))) = 0 and 
       d(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v2)),v1),k(k(k(v2,v1),v2),v0))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
