...
neq2 := k(k(v2,k(v0,v1)),k(k(v3,v1),v2)); 
neq3 := k(k(v2,k(v0,v1)),k(k(v3,v0),v2)); 
neq4 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq5 := k(k(v2,k(v0,v1)),k(v3,v0)); 
neq6 := k(k(v2,k(v0,v1)),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq7 := k(k(v2,k(v0,v1)),k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq8 := k(k(v2,k(v0,v1)),v3); 
neq9 := k(k(v2,k(v0,v1)),k(k(v3,k(v2,k(v0,v1))),v3)); 
neq10 := k(k(v0,v1),v2); 
neq11 := k(k(v0,v1),k(k(v3,v1),v2)); 
neq12 := k(k(v0,v1),k(k(v3,v0),v2)); 
neq13 := k(k(v0,v1),k(v3,v1)); 
neq14 := k(k(v0,v1),k(v3,v0)); 
neq15 := k(k(v0,v1),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq16 := k(k(v0,v1),k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
...
neq22 := k(v2,k(v3,v1)); 
neq23 := k(v2,k(v3,v0)); 
neq24 := k(v2,k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq25 := k(v2,k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq26 := k(v2,k(v3,k(v2,k(v0,v1)))); 
neq27 := k(v2,v3); 
neq28 := k(v2,k(k(v3,k(v2,k(v0,v1))),v3)); 
neq29 := k(v0,k(k(v3,v1),v2)); 
neq30 := k(v0,k(k(v3,v0),v2)); 
neq31 := k(v0,k(v3,v1)); 
neq32 := k(v0,k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq33 := k(v0,k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
...
neq39 := k(v1,k(v3,v0)); 
neq40 := k(v1,k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq41 := k(v1,k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq42 := k(v1,k(v3,k(v2,k(v0,v1)))); 
neq43 := k(v1,v3); 
neq44 := k(v1,k(k(v3,k(v2,k(v0,v1))),v3)); 
neq45 := k(k(k(v3,v1),v2),k(k(v3,v0),v2)); 
neq46 := k(k(k(v3,v1),v2),k(v3,v0)); 
neq47 := k(k(k(v3,v1),v2),k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq48 := k(k(k(v3,v1),v2),k(v3,k(v2,k(v0,v1)))); 
neq49 := k(k(k(v3,v1),v2),v3); 
neq50 := k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3)); 
neq51 := k(k(k(v3,v0),v2),k(v3,v1)); 
neq52 := k(k(k(v3,v0),v2),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq53 := k(k(k(v3,v0),v2),k(v3,k(v2,k(v0,v1)))); 
neq54 := k(k(k(v3,v0),v2),v3); 
neq55 := k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3)); 
neq56 := k(k(v3,v1),k(v3,v0)); 
neq57 := k(k(v3,v1),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq58 := k(k(v3,v1),k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq59 := k(k(v3,v1),k(v3,k(v2,k(v0,v1)))); 
neq60 := k(k(v3,v1),k(k(v3,k(v2,k(v0,v1))),v3)); 
neq61 := k(k(v3,v0),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq62 := k(k(v3,v0),k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3))); 
neq63 := k(k(v3,v0),k(v3,k(v2,k(v0,v1)))); 
neq64 := k(k(v3,v0),k(k(v3,k(v2,k(v0,v1))),v3)); 
neq65 := k(k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3)),k(v3,k(v2,k(v0,v1)))); 
neq66 := k(k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3)),v3); 
neq67 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3)),k(v3,k(v2,k(v0,v1)))); 
neq68 := k(k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3)),v3); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(v3,v0),v2),k(k(v3,k(v2,k(v0,v1))),v3)),k(k(k(v3,v1),v2),k(k(v3,k(v2,k(v0,v1))),v3))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
