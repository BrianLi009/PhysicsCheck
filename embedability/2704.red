...
neq6 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)))); 
neq7 := k(k(k(k(v2,v0),v2),v1),k(v2,v1)); 
neq8 := k(k(k(k(v2,v0),v2),v1),v2); 
neq9 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq10 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v0); 
neq11 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v2,v0)); 
neq12 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v0)); 
neq13 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)))); 
neq14 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(v2,v0),v2),v1),v1)); 
neq15 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(v2,v1)); 
neq16 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),v2); 
neq17 := k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
...
neq21 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v0)); 
neq22 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v0)); 
neq23 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),v1)); 
neq24 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(v2,v1)); 
neq25 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),v2); 
neq26 := k(k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
...
neq31 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)))); 
neq32 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq33 := k(k(k(v2,v1),v1),v2); 
neq34 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq35 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq36 := k(v0,k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)))); 
neq37 := k(v0,k(k(k(k(v2,v0),v2),v1),v1)); 
neq38 := k(v0,k(v2,v1)); 
neq39 := k(v0,v2); 
neq40 := k(v0,k(k(k(k(k(v2,v0),v2),v1),v1),v2)); 
neq41 := k(v0,k(k(v2,v0),v2)); 
neq42 := k(k(v2,v0),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v0)); 
neq43 := k(k(v2,v0),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2)))); 
neq44 := k(k(v2,v0),k(k(k(k(v2,v0),v2),v1),v1)); 
...
neq53 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),k(k(k(k(v2,v0),v2),v1),v1)); 
neq54 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),k(v2,v1)); 
neq55 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),v2); 
neq56 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),v1); 
neq57 := k(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),k(k(v2,v0),v2)); 
neq58 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v1)); 
neq59 := k(k(k(k(k(v2,v0),v2),v1),v1),v2); 
neq60 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),k(k(k(k(v2,v0),v2),k(k(v2,v1),v1)),k(k(v2,v0),v2))),k(k(k(k(k(k(v2,v0),v2),v1),v1),v2),v0)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
