...
def test_embed(): 
    ...
    s.add(((z_1*x_13-x_1*z_13)*z_10-(x_1*y_13-y_1*x_13)*y_10)==0) 
    s.add(((x_1*y_13-y_1*x_13)*x_10-(y_1*z_13-z_1*y_13)*z_10)==0) 
    s.add(((y_1*z_13-z_1*y_13)*y_10-(z_1*x_13-x_1*z_13)*x_10)==0) 
