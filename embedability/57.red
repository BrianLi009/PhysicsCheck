...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),v0); 
neq1 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),v3); 
neq2 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(v2,v0)); 
neq3 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(k(k(k(v3,v1),v1),k(v2,v0)),v3)); 
neq4 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),v1); 
neq5 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(v3,v1)); 
neq6 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(k(k(v3,v1),v1),k(v2,v0))); 
neq7 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(k(v3,v1),v1)); 
neq8 := k(v2,k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3)); 
neq9 := k(v2,v3); 
neq10 := k(v2,k(k(k(k(v3,v1),v1),k(v2,v0)),v3)); 
neq11 := k(v2,v1); 
neq12 := k(v2,k(v3,v1)); 
neq13 := k(v2,k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq14 := k(v2,k(k(k(v3,v1),v1),k(v2,v0))); 
neq15 := k(v2,k(k(v3,v1),v1)); 
neq16 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),v0); 
neq17 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),k(v2,v0)); 
neq18 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),v1); 
neq19 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),k(v3,v1)); 
neq20 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq21 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),k(k(k(v3,v1),v1),k(v2,v0))); 
neq22 := k(k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3),k(k(v3,v1),v1)); 
neq23 := k(v0,v3); 
neq24 := k(v0,k(k(k(k(v3,v1),v1),k(v2,v0)),v3)); 
neq25 := k(v0,k(v3,v1)); 
neq26 := k(v0,k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq27 := k(v0,k(k(k(v3,v1),v1),k(v2,v0))); 
neq28 := k(v0,k(k(v3,v1),v1)); 
neq29 := k(v3,k(v2,v0)); 
neq30 := k(v3,v1); 
neq31 := k(v3,k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq32 := k(v3,k(k(k(v3,v1),v1),k(v2,v0))); 
neq33 := k(v3,k(k(v3,v1),v1)); 
neq34 := k(k(v2,v0),k(k(k(k(v3,v1),v1),k(v2,v0)),v3)); 
neq35 := k(k(v2,v0),v1); 
neq36 := k(k(v2,v0),k(v3,v1)); 
neq37 := k(k(v2,v0),k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq38 := k(k(v2,v0),k(k(v3,v1),v1)); 
neq39 := k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v1); 
neq40 := k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),k(v3,v1)); 
neq41 := k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq42 := k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),k(k(v3,v1),v1)); 
neq43 := k(v1,k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq44 := k(v1,k(k(k(v3,v1),v1),k(v2,v0))); 
neq45 := k(k(v3,v1),k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1))); 
neq46 := k(k(v3,v1),k(k(k(v3,v1),v1),k(v2,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v1),v1),k(v2,v0)),k(k(v3,v1),v1)),v2),k(k(k(k(k(v3,v1),v1),k(v2,v0)),v3),v3)) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
