...
def test_embed(): 
    ...
    s.add(((z_6*x_9-x_6*z_9)*z_2-(x_6*y_9-y_6*x_9)*y_2)==0) 
    s.add(((x_6*y_9-y_6*x_9)*x_2-(y_6*z_9-z_6*y_9)*z_2)==0) 
    s.add(((y_6*z_9-z_6*y_9)*y_2-(z_6*x_9-x_6*z_9)*x_2)==0) 
    ...
    s.add(((z_5*x_11-x_5*z_11)*z_4-(x_5*y_11-y_5*x_11)*y_4)==0) 
    s.add(((x_5*y_11-y_5*x_11)*x_4-(y_5*z_11-z_5*y_11)*z_4)==0) 
    s.add(((y_5*z_11-z_5*y_11)*y_4-(z_5*x_11-x_5*z_11)*x_4)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
