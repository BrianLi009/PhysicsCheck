...
def test_embed(): 
    ...
    s.add(((z_0*x_4-x_0*z_4)*z_11-(x_0*y_4-y_0*x_4)*y_11)==0) 
    s.add(((x_0*y_4-y_0*x_4)*x_11-(y_0*z_4-z_0*y_4)*z_11)==0) 
    s.add(((y_0*z_4-z_0*y_4)*y_11-(z_0*x_4-x_0*z_4)*x_11)==0) 
    ...
    s.add(((z_1*x_4-x_1*z_4)*z_13-(x_1*y_4-y_1*x_4)*y_13)==0) 
    s.add(((x_1*y_4-y_1*x_4)*x_13-(y_1*z_4-z_1*y_4)*z_13)==0) 
    s.add(((y_1*z_4-z_1*y_4)*y_13-(z_1*x_4-x_1*z_4)*x_13)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
