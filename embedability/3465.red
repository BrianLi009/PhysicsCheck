...
neq1 := k(v2,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1))); 
neq2 := k(v2,v0); 
neq3 := k(v2,v3); 
neq4 := k(v2,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq5 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq6 := k(v2,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq7 := k(v2,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v3,k(k(v2,v1),v2))); 
...
neq13 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq14 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq15 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq16 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq17 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),v1); 
neq18 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(v3,k(k(v2,v1),v2))); 
neq19 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v2)); 
neq20 := k(k(k(v2,v1),v2),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1))); 
...
neq28 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1))); 
neq29 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(v2,v1)); 
neq30 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0); 
neq31 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v3); 
neq32 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq33 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq34 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq35 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v1); 
neq36 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),k(v3,k(k(v2,v1),v2))); 
neq37 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),k(v2,v1)); 
neq38 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),v0); 
neq39 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),v3); 
neq40 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq41 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq42 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),v1); 
neq43 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)),k(v3,k(k(v2,v1),v2))); 
neq44 := k(k(v2,v1),v0); 
neq45 := k(k(v2,v1),v3); 
neq46 := k(k(v2,v1),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq47 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq48 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq49 := k(k(v2,v1),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq50 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq51 := k(v0,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2)))); 
neq52 := k(v0,k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq53 := k(v0,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq54 := k(v0,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1)); 
neq55 := k(v0,k(v3,k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1),k(v3,k(k(v2,v1),v2))),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v2),v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
