...
def test_embed(): 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_9-(x_6*y_11-y_6*x_11)*y_9)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_9-(y_6*z_11-z_6*y_11)*z_9)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_9-(z_6*x_11-x_6*z_11)*x_9)==0) 
