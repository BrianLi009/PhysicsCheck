...
v3 := {v3c1, v3c2, v3c3}; 
v2c3 := 0;
neq0 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(v0,v1)); 
neq1 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),v2); 
neq2 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(v3,v1)); 
neq3 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),v3); 
neq4 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),v0); 
neq5 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(k(v3,v2),v2)); 
neq6 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(k(k(v3,v2),v2),v1)); 
neq7 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(k(v3,v2),v0)); 
neq8 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),v1); 
neq9 := k(k(k(k(v3,v2),v3),k(k(v3,v1),v1)),k(v3,v2)); 
neq10 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(v0,v1)); 
neq11 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),v2); 
neq12 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(v3,v1)); 
neq13 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),v3); 
neq14 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),v0); 
neq15 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(k(v3,v2),v2)); 
neq16 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(k(v3,v1),v1)); 
neq17 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(k(v3,v2),v3)); 
neq18 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),v1); 
neq19 := k(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(v3,v2)); 
neq20 := k(k(v0,v1),k(v3,v1)); 
neq21 := k(k(v0,v1),v3); 
neq22 := k(k(v0,v1),k(k(v3,v2),v2)); 
neq23 := k(k(v0,v1),k(k(v3,v1),v1)); 
neq24 := k(k(v0,v1),k(k(v3,v2),v3)); 
neq25 := k(k(v0,v1),k(k(k(v3,v2),v2),v1)); 
neq26 := k(k(v0,v1),k(k(v3,v2),v0)); 
neq27 := k(k(v0,v1),k(v3,v2)); 
neq28 := k(v2,k(v3,v1)); 
neq29 := k(v2,v3); 
neq30 := k(v2,v0); 
neq31 := k(v2,k(k(v3,v1),v1)); 
neq32 := k(v2,k(k(v3,v2),v3)); 
neq33 := k(v2,k(k(k(v3,v2),v2),v1)); 
neq34 := k(v2,k(k(v3,v2),v0)); 
neq35 := k(v2,v1); 
neq36 := k(k(v3,v1),v0); 
neq37 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq38 := k(k(v3,v1),k(k(v3,v2),v3)); 
neq39 := k(k(v3,v1),k(k(k(v3,v2),v2),v1)); 
neq40 := k(k(v3,v1),k(k(v3,v2),v0)); 
neq41 := k(k(v3,v1),k(v3,v2)); 
neq42 := k(v3,v0); 
neq43 := k(v3,k(k(v3,v2),v2)); 
neq44 := k(v3,k(k(v3,v1),v1)); 
neq45 := k(v3,k(k(k(v3,v2),v2),v1)); 
...
neq52 := k(v0,k(v3,v2)); 
neq53 := k(k(k(v3,v2),v2),k(k(v3,v1),v1)); 
neq54 := k(k(k(v3,v2),v2),k(k(v3,v2),v3)); 
neq55 := k(k(k(v3,v2),v2),k(k(v3,v2),v0)); 
neq56 := k(k(k(v3,v2),v2),v1); 
neq57 := k(k(k(v3,v1),v1),k(k(v3,v2),v3)); 
neq58 := k(k(k(v3,v1),v1),k(k(k(v3,v2),v2),v1)); 
neq59 := k(k(k(v3,v1),v1),k(k(v3,v2),v0)); 
neq60 := k(k(k(v3,v1),v1),k(v3,v2)); 
neq61 := k(k(k(v3,v2),v3),k(k(k(v3,v2),v2),v1)); 
neq62 := k(k(k(v3,v2),v3),k(k(v3,v2),v0)); 
...
phi := 
       ...
       d(v2,k(v0,v1)) = 0 and 
       d(k(k(k(v3,v2),v0),k(k(k(v3,v2),v2),v1)),k(k(k(v3,v2),v3),k(k(v3,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v3c2,
     ex(v3c3,
