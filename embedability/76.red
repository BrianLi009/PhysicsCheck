...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1)); 
neq1 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq2 := k(v2,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1))); 
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0)); 
neq5 := k(v2,k(k(v2,v1),v1)); 
neq6 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq9 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1))); 
neq10 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1))); 
neq11 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),v0); 
neq12 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0)); 
neq13 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(v2,v1),v1)); 
neq14 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq15 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(v2,v1)); 
neq16 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),v1),k(v2,v0)); 
neq17 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1))); 
neq18 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v0); 
neq19 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0)); 
neq20 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(v2,v1)); 
neq21 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v1); 
neq22 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq23 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),k(v2,v0)); 
neq24 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),v0); 
neq25 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(v2,v1),v1)); 
neq26 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq27 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),v1); 
neq28 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(v2,v0)); 
neq29 := k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
...
neq35 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(k(v2,v1),v1)); 
neq36 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(k(k(v2,v1),v1),k(v2,v0))); 
neq37 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(v2,v1)); 
neq38 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),v1); 
neq39 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq40 := k(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(v2,v0)); 
neq41 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq42 := k(k(k(v2,v1),v1),k(v2,v0)); 
neq43 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq44 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v1)); 
neq45 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq46 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq47 := k(k(v2,v1),k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq48 := k(k(v2,v1),k(v2,v0)); 
neq49 := k(k(v2,v1),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq50 := k(v1,k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0))); 
neq51 := k(v1,k(v2,v0)); 
neq52 := k(v1,k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq53 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
neq54 := k(k(v2,v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(v2,v1),v1)),v2),v0),k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v0)),k(v2,v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
