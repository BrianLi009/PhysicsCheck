...
def test_embed(): 
    ...
    s.add(((z_6*x_11-x_6*z_11)*z_8-(x_6*y_11-y_6*x_11)*y_8)==0) 
    s.add(((x_6*y_11-y_6*x_11)*x_8-(y_6*z_11-z_6*y_11)*z_8)==0) 
    s.add(((y_6*z_11-z_6*y_11)*y_8-(z_6*x_11-x_6*z_11)*x_8)==0) 
    s.add(x_1 == 0) 
    s.add(y_1 == 0) 
    s.add(z_1 == 1) 
    s.add(x_9 == 0) 
