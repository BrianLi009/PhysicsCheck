...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(v2,k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3)); 
neq1 := k(v2,k(v3,v0)); 
neq2 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1)); 
neq3 := k(v2,v3); 
...
neq10 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(v3,v0)); 
neq11 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2)); 
neq12 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),v0); 
neq13 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(v3,v1),v2)); 
neq14 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(v3,v1),v1)); 
neq15 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1))); 
neq16 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(v3,v1)); 
neq17 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),v1); 
neq18 := k(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(k(v3,v1),v2),k(v3,v0))); 
neq19 := k(k(v3,v0),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2)); 
neq20 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1)); 
neq21 := k(k(v3,v0),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),k(k(k(v3,v1),v2),k(v3,v0)))); 
neq22 := k(k(v3,v0),k(k(v3,v1),v2)); 
neq23 := k(k(v3,v0),k(k(v3,v1),v1)); 
neq24 := k(k(v3,v0),k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1))); 
neq25 := k(k(v3,v0),k(v3,v1)); 
neq26 := k(k(v3,v0),v1); 
neq27 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v0); 
neq28 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v3); 
neq29 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),k(k(k(v3,v1),v2),k(v3,v0)))); 
neq30 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),k(k(v3,v1),v2)); 
neq31 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),k(k(v3,v1),v1)); 
neq32 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),k(v3,v1)); 
neq33 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1); 
neq34 := k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),k(k(k(v3,v1),v2),k(v3,v0))); 
neq35 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1)); 
neq36 := k(v0,v3); 
...
neq43 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3); 
neq44 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),k(k(k(v3,v1),v2),k(v3,v0)))); 
neq45 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(k(v3,v1),v2)); 
neq46 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(k(v3,v1),v1)); 
neq47 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1))); 
neq48 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(v3,v1)); 
neq49 := k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),k(k(k(v3,v1),v2),k(v3,v0))); 
...
phi := 
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),v2),v1),v3),k(k(k(k(k(v3,v1),v2),k(v3,v0)),k(k(v3,v1),v1)),k(k(k(v3,v1),v2),k(v3,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
