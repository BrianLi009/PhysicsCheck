...
def test_embed(): 
    ...
    s.add(((z_2*x_7-x_2*z_7)*z_4-(x_2*y_7-y_2*x_7)*y_4)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_4-(y_2*z_7-z_2*y_7)*z_4)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_4-(z_2*x_7-x_2*z_7)*x_4)==0) 
    ...
    s.add(((z_5*x_7-x_5*z_7)*z_8-(x_5*y_7-y_5*x_7)*y_8)==0) 
    s.add(((x_5*y_7-y_5*x_7)*x_8-(y_5*z_7-z_5*y_7)*z_8)==0) 
    s.add(((y_5*z_7-z_5*y_7)*y_8-(z_5*x_7-x_5*z_7)*x_8)==0) 
