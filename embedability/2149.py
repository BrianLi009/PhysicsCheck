...
def test_embed(): 
    ...
    s.add(((z_4*x_9-x_4*z_9)*z_8-(x_4*y_9-y_4*x_9)*y_8)==0) 
    s.add(((x_4*y_9-y_4*x_9)*x_8-(y_4*z_9-z_4*y_9)*z_8)==0) 
    s.add(((y_4*z_9-z_4*y_9)*y_8-(z_4*x_9-x_4*z_9)*x_8)==0) 
    s.add(((z_10*x_11-x_10*z_11)*z_6-(x_10*y_11-y_10*x_11)*y_6)==0) 
    s.add(((x_10*y_11-y_10*x_11)*x_6-(y_10*z_11-z_10*y_11)*z_6)==0) 
    s.add(((y_10*z_11-z_10*y_11)*y_6-(z_10*x_11-x_10*z_11)*x_6)==0) 
    s.add(((z_6*x_10-x_6*z_10)*z_7-(x_6*y_10-y_6*x_10)*y_7)==0) 
    s.add(((x_6*y_10-y_6*x_10)*x_7-(y_6*z_10-z_6*y_10)*z_7)==0) 
    s.add(((y_6*z_10-z_6*y_10)*y_7-(z_6*x_10-x_6*z_10)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_3 == 0) 
