...
neq2 := k(v2,v0); 
neq3 := k(v2,v4); 
neq4 := k(v2,k(k(v4,v3),v3)); 
neq5 := k(v2,k(v4,v0)); 
neq6 := k(v2,k(k(v4,k(k(v2,v1),v2)),v1)); 
neq7 := k(v2,k(k(k(v4,v3),v3),k(v4,v0))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v4,k(k(v2,v1),v2))); 
neq10 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v2)); 
neq11 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(v2,v1)); 
neq12 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),v3); 
neq13 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(v4,v3)); 
neq14 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),v0); 
neq15 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),v4); 
neq16 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(k(v4,v3),v3)); 
neq17 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(v4,v0)); 
neq18 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),v1); 
neq19 := k(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(v4,k(k(v2,v1),v2))); 
neq20 := k(k(k(v2,v1),v2),v3); 
neq21 := k(k(k(v2,v1),v2),k(v4,v3)); 
neq22 := k(k(k(v2,v1),v2),v0); 
neq23 := k(k(k(v2,v1),v2),v4); 
neq24 := k(k(k(v2,v1),v2),k(k(v4,v3),v3)); 
neq25 := k(k(k(v2,v1),v2),k(v4,v0)); 
neq26 := k(k(k(v2,v1),v2),k(k(v4,k(k(v2,v1),v2)),v1)); 
neq27 := k(k(k(v2,v1),v2),k(k(k(v4,v3),v3),k(v4,v0))); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(v2,v1),v3); 
neq30 := k(k(v2,v1),k(v4,v3)); 
neq31 := k(k(v2,v1),v0); 
neq32 := k(k(v2,v1),v4); 
neq33 := k(k(v2,v1),k(k(v4,v3),v3)); 
neq34 := k(k(v2,v1),k(v4,v0)); 
neq35 := k(k(v2,v1),k(k(v4,k(k(v2,v1),v2)),v1)); 
neq36 := k(k(v2,v1),k(k(k(v4,v3),v3),k(v4,v0))); 
neq37 := k(k(v2,v1),k(v4,k(k(v2,v1),v2))); 
neq38 := k(v3,v4); 
neq39 := k(v3,k(v4,v0)); 
neq40 := k(v3,k(k(v4,k(k(v2,v1),v2)),v1)); 
neq41 := k(v3,k(k(k(v4,v3),v3),k(v4,v0))); 
neq42 := k(v3,v1); 
neq43 := k(v3,k(v4,k(k(v2,v1),v2))); 
neq44 := k(k(v4,v3),v0); 
neq45 := k(k(v4,v3),k(v4,v0)); 
neq46 := k(k(v4,v3),k(k(v4,k(k(v2,v1),v2)),v1)); 
neq47 := k(k(v4,v3),k(k(k(v4,v3),v3),k(v4,v0))); 
neq48 := k(k(v4,v3),v1); 
neq49 := k(k(v4,v3),k(v4,k(k(v2,v1),v2))); 
neq50 := k(v0,v4); 
neq51 := k(v0,k(k(v4,v3),v3)); 
neq52 := k(v0,k(k(v4,k(k(v2,v1),v2)),v1)); 
neq53 := k(v0,k(k(k(v4,v3),v3),k(v4,v0))); 
neq54 := k(v0,k(v4,k(k(v2,v1),v2))); 
neq55 := k(v4,k(k(v4,v3),v3)); 
neq56 := k(v4,k(k(v4,k(k(v2,v1),v2)),v1)); 
neq57 := k(v4,k(k(k(v4,v3),v3),k(v4,v0))); 
neq58 := k(v4,v1); 
neq59 := k(k(k(v4,v3),v3),k(v4,v0)); 
neq60 := k(k(k(v4,v3),v3),k(k(v4,k(k(v2,v1),v2)),v1)); 
neq61 := k(k(k(v4,v3),v3),v1); 
neq62 := k(k(k(v4,v3),v3),k(v4,k(k(v2,v1),v2))); 
neq63 := k(k(v4,v0),k(k(v4,k(k(v2,v1),v2)),v1)); 
neq64 := k(k(v4,v0),v1); 
neq65 := k(k(v4,v0),k(v4,k(k(v2,v1),v2))); 
neq66 := k(k(k(v4,k(k(v2,v1),v2)),v1),k(k(k(v4,v3),v3),k(v4,v0))); 
neq67 := k(k(k(k(v4,v3),v3),k(v4,v0)),v1); 
neq68 := k(k(k(k(v4,v3),v3),k(v4,v0)),k(v4,k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v4,k(k(v2,v1),v2)),v1),v2),k(k(k(v4,v3),v3),k(v4,v0))) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
