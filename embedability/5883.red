...
neq5 := k(v2,v1); 
neq6 := k(v2,k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq7 := k(v2,k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq8 := k(v2,k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq9 := k(v2,k(k(v3,v0),v3)); 
neq10 := k(k(v2,v0),k(k(v3,v1),v2)); 
neq11 := k(k(v2,v0),k(v3,v1)); 
neq12 := k(k(v2,v0),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2)); 
neq13 := k(k(v2,v0),k(v3,v0)); 
neq14 := k(k(v2,v0),v3); 
neq15 := k(k(v2,v0),k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq16 := k(k(v2,v0),v1); 
neq17 := k(k(v2,v0),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq18 := k(k(v2,v0),k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq19 := k(k(v2,v0),k(k(v3,v0),v3)); 
neq20 := k(k(k(v3,v1),v2),v0); 
neq21 := k(k(k(v3,v1),v2),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2)); 
neq22 := k(k(k(v3,v1),v2),k(v3,v0)); 
neq23 := k(k(k(v3,v1),v2),v3); 
neq24 := k(k(k(v3,v1),v2),v1); 
neq25 := k(k(k(v3,v1),v2),k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq26 := k(k(k(v3,v1),v2),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq27 := k(k(k(v3,v1),v2),k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq28 := k(k(k(v3,v1),v2),k(k(v3,v0),v3)); 
neq29 := k(k(v3,v1),v0); 
neq30 := k(k(v3,v1),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2)); 
neq31 := k(k(v3,v1),k(v3,v0)); 
neq32 := k(k(v3,v1),k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq33 := k(k(v3,v1),k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq34 := k(k(v3,v1),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq35 := k(k(v3,v1),k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq36 := k(k(v3,v1),k(k(v3,v0),v3)); 
neq37 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2)); 
neq38 := k(v0,v3); 
neq39 := k(v0,k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq40 := k(v0,k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq41 := k(v0,k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq42 := k(v0,k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq43 := k(v0,k(k(v3,v0),v3)); 
neq44 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),k(v3,v0)); 
neq45 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),v3); 
neq46 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq47 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),v1); 
neq48 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq49 := k(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2),k(k(v3,v0),v3)); 
neq50 := k(k(v3,v0),k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq51 := k(k(v3,v0),v1); 
neq52 := k(k(v3,v0),k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq53 := k(k(v3,v0),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq54 := k(k(v3,v0),k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq55 := k(v3,k(k(k(v3,v1),v2),k(k(v3,v0),v3))); 
neq56 := k(v3,v1); 
neq57 := k(v3,k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq58 := k(v3,k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq59 := k(v3,k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq60 := k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),v1); 
neq61 := k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq62 := k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1)); 
neq63 := k(v1,k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0))); 
neq64 := k(v1,k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq65 := k(v1,k(k(v3,v0),v3)); 
neq66 := k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3))); 
neq67 := k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),k(k(v3,v0),v3)); 
neq68 := k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),k(k(v3,v0),v3)),k(k(k(k(k(k(v3,v1),v2),k(k(v3,v0),v3)),k(v2,v0)),v1),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
