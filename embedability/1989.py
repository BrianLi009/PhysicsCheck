...
def test_embed(): 
    ...
    s.add(((z_4*x_12-x_4*z_12)*z_10-(x_4*y_12-y_4*x_12)*y_10)==0) 
    s.add(((x_4*y_12-y_4*x_12)*x_10-(y_4*z_12-z_4*y_12)*z_10)==0) 
    s.add(((y_4*z_12-z_4*y_12)*y_10-(z_4*x_12-x_4*z_12)*x_10)==0) 
