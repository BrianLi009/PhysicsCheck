...
def test_embed(): 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_5-(x_6*y_13-y_6*x_13)*y_5)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_5-(y_6*z_13-z_6*y_13)*z_5)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_5-(z_6*x_13-x_6*z_13)*x_5)==0) 
