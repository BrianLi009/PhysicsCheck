...
def test_embed(): 
    ...
    s.add(((z_9*x_13-x_9*z_13)*z_0-(x_9*y_13-y_9*x_13)*y_0)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_0-(y_9*z_13-z_9*y_13)*z_0)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_0-(z_9*x_13-x_9*z_13)*x_0)==0) 
    ...
    s.add(((z_3*x_9-x_3*z_9)*z_5-(x_3*y_9-y_3*x_9)*y_5)==0) 
    s.add(((x_3*y_9-y_3*x_9)*x_5-(y_3*z_9-z_3*y_9)*z_5)==0) 
    s.add(((y_3*z_9-z_3*y_9)*y_5-(z_3*x_9-x_3*z_9)*x_5)==0) 
    s.add(((z_4*x_10-x_4*z_10)*z_6-(x_4*y_10-y_4*x_10)*y_6)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_6-(y_4*z_10-z_4*y_10)*z_6)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_6-(z_4*x_10-x_4*z_10)*x_6)==0) 
    s.add(((z_7*x_11-x_7*z_11)*z_8-(x_7*y_11-y_7*x_11)*y_8)==0) 
    s.add(((x_7*y_11-y_7*x_11)*x_8-(y_7*z_11-z_7*y_11)*z_8)==0) 
    s.add(((y_7*z_11-z_7*y_11)*y_8-(z_7*x_11-x_7*z_11)*x_8)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_4 == 0) 
