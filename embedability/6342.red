...
neq3 := k(v2,v4); 
neq4 := k(v2,k(v3,v0)); 
neq5 := k(v2,k(k(v4,v3),v1)); 
neq6 := k(v2,k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq7 := k(v2,k(v4,k(v3,v0))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v4,k(k(v2,v1),v2))); 
neq10 := k(k(k(v4,k(v3,v0)),v2),k(k(v2,v1),v2)); 
neq11 := k(k(k(v4,k(v3,v0)),v2),k(v2,v1)); 
neq12 := k(k(k(v4,k(v3,v0)),v2),k(v4,v3)); 
neq13 := k(k(k(v4,k(v3,v0)),v2),v3); 
neq14 := k(k(k(v4,k(v3,v0)),v2),v0); 
neq15 := k(k(k(v4,k(v3,v0)),v2),v4); 
neq16 := k(k(k(v4,k(v3,v0)),v2),k(v3,v0)); 
neq17 := k(k(k(v4,k(v3,v0)),v2),k(k(v4,v3),v1)); 
neq18 := k(k(k(v4,k(v3,v0)),v2),v1); 
neq19 := k(k(k(v4,k(v3,v0)),v2),k(v4,k(k(v2,v1),v2))); 
neq20 := k(k(k(v2,v1),v2),k(v4,v3)); 
neq21 := k(k(k(v2,v1),v2),v3); 
neq22 := k(k(k(v2,v1),v2),v0); 
neq23 := k(k(k(v2,v1),v2),v4); 
neq24 := k(k(k(v2,v1),v2),k(v3,v0)); 
neq25 := k(k(k(v2,v1),v2),k(k(v4,v3),v1)); 
neq26 := k(k(k(v2,v1),v2),k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq27 := k(k(k(v2,v1),v2),k(v4,k(v3,v0))); 
neq28 := k(k(k(v2,v1),v2),v1); 
neq29 := k(k(v2,v1),k(v4,v3)); 
neq30 := k(k(v2,v1),v3); 
neq31 := k(k(v2,v1),v0); 
neq32 := k(k(v2,v1),v4); 
neq33 := k(k(v2,v1),k(v3,v0)); 
neq34 := k(k(v2,v1),k(k(v4,v3),v1)); 
neq35 := k(k(v2,v1),k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq36 := k(k(v2,v1),k(v4,k(v3,v0))); 
neq37 := k(k(v2,v1),k(v4,k(k(v2,v1),v2))); 
neq38 := k(k(v4,v3),v0); 
neq39 := k(k(v4,v3),k(v3,v0)); 
neq40 := k(k(v4,v3),k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq41 := k(k(v4,v3),k(v4,k(v3,v0))); 
neq42 := k(k(v4,v3),v1); 
neq43 := k(k(v4,v3),k(v4,k(k(v2,v1),v2))); 
neq44 := k(v3,v4); 
neq45 := k(v3,k(k(v4,v3),v1)); 
neq46 := k(v3,k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq47 := k(v3,k(v4,k(v3,v0))); 
neq48 := k(v3,v1); 
neq49 := k(v3,k(v4,k(k(v2,v1),v2))); 
neq50 := k(v0,v4); 
neq51 := k(v0,k(k(v4,v3),v1)); 
neq52 := k(v0,k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq53 := k(v0,k(v4,k(v3,v0))); 
neq54 := k(v0,k(v4,k(k(v2,v1),v2))); 
neq55 := k(v4,k(v3,v0)); 
neq56 := k(v4,k(k(v4,v3),v1)); 
neq57 := k(v4,k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq58 := k(v4,v1); 
neq59 := k(k(v3,v0),k(k(v4,v3),v1)); 
neq60 := k(k(v3,v0),k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1))); 
neq61 := k(k(v3,v0),v1); 
neq62 := k(k(v3,v0),k(v4,k(k(v2,v1),v2))); 
neq63 := k(k(k(v4,v3),v1),k(v4,k(v3,v0))); 
neq64 := k(k(k(v4,v3),v1),k(v4,k(k(v2,v1),v2))); 
neq65 := k(k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1)),k(v4,k(v3,v0))); 
neq66 := k(k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1)),v1); 
neq67 := k(k(v4,k(v3,v0)),v1); 
neq68 := k(k(v4,k(v3,v0)),k(v4,k(k(v2,v1),v2))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(v4,k(k(v2,v1),v2)),k(k(v4,v3),v1)),k(k(v4,k(v3,v0)),v2)) = 0 and 
        true;
rlqe 
     ex(v4c2,
     ex(v2c3,
