...
v3c1 := 0;
neq0 := k(v2,v0); 
neq1 := k(v2,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0))); 
neq2 := k(v2,v3); 
neq3 := k(v2,k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3)); 
neq4 := k(v2,v1); 
neq5 := k(v2,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq6 := k(v2,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq7 := k(v2,k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq8 := k(v2,k(v3,k(v2,v1))); 
neq9 := k(k(v2,v1),k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2)); 
neq10 := k(k(v2,v1),v0); 
neq11 := k(k(v2,v1),k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0))); 
neq12 := k(k(v2,v1),v3); 
neq13 := k(k(v2,v1),k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3)); 
neq14 := k(k(v2,v1),k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq15 := k(k(v2,v1),k(k(v3,k(v2,v1)),k(v2,v0))); 
neq16 := k(k(v2,v1),k(v2,v0)); 
neq17 := k(k(v2,v1),k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq18 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),v0); 
neq19 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0))); 
neq20 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),v3); 
neq21 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3)); 
neq22 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),v1); 
neq23 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(k(v3,k(v2,v1)),k(v2,v0))); 
neq24 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v2,v0)); 
neq25 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1))); 
neq26 := k(v0,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0))); 
neq27 := k(v0,k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3)); 
neq28 := k(v0,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq29 := k(v0,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq30 := k(v0,k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq31 := k(v0,k(v3,k(v2,v1))); 
neq32 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)),v3); 
neq33 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)),v1); 
neq34 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)),k(k(v3,k(v2,v1)),k(v2,v0))); 
neq35 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)),k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq36 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)),k(v3,k(v2,v1))); 
neq37 := k(v3,v1); 
neq38 := k(v3,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq39 := k(v3,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq40 := k(v3,k(v2,v0)); 
neq41 := k(v3,k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq42 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),v1); 
neq43 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq44 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(k(v3,k(v2,v1)),k(v2,v0))); 
neq45 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0)); 
neq46 := k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v3,k(v2,v1))); 
neq47 := k(v1,k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1)))); 
neq48 := k(v1,k(k(v3,k(v2,v1)),k(v2,v0))); 
neq49 := k(v1,k(v2,v0)); 
neq50 := k(v1,k(v3,k(v2,v1))); 
neq51 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1))),k(k(v3,k(v2,v1)),k(v2,v0))); 
neq52 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1))),k(v2,v0)); 
neq53 := k(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1))),k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq54 := k(k(v2,v0),k(k(k(v3,k(v2,v1)),k(v2,v0)),v1)); 
neq55 := k(k(v2,v0),k(v3,k(v2,v1))); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v2),k(v3,k(v2,v1))),k(k(k(k(k(v3,k(v2,v1)),k(v2,v0)),v1),v3),k(v2,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
