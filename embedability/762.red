...
neq4 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
...
neq10 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))); 
neq11 := k(k(v2,v0),k(k(v2,v1),v1)); 
neq12 := k(k(v2,v0),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0)); 
neq13 := k(k(v2,v0),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq14 := k(k(v2,v0),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq15 := k(k(v2,v0),k(v2,v1)); 
neq16 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq17 := k(k(v2,v0),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq18 := k(k(v2,v0),v1); 
neq19 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(v2,v1),v1)); 
neq20 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0)); 
neq21 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v0); 
neq22 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v2); 
neq23 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(v2,v1)); 
neq24 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(v2,v1),v2)); 
neq25 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq26 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2)),v1); 
neq27 := k(k(k(v2,v1),v1),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0)); 
neq28 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq29 := k(k(k(v2,v1),v1),v0); 
neq30 := k(k(k(v2,v1),v1),v2); 
neq31 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq32 := k(k(k(v2,v1),v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq33 := k(k(k(v2,v1),v1),k(k(v2,v0),v2)); 
neq34 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq35 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),v2); 
neq36 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),k(v2,v1)); 
neq37 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),k(k(v2,v1),v2)); 
neq38 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),v1); 
neq39 := k(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),k(k(v2,v0),v2)); 
neq40 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v0); 
neq41 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v2); 
neq42 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq43 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v1)); 
neq44 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v1); 
neq45 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(v2,v0),v2)); 
neq46 := k(v0,v2); 
neq47 := k(v0,k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq48 := k(v0,k(v2,v1)); 
neq49 := k(v0,k(k(v2,v1),v2)); 
neq50 := k(v0,k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq51 := k(v0,k(k(v2,v0),v2)); 
neq52 := k(v2,k(k(k(v2,v1),v1),k(k(v2,v0),v2))); 
neq53 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq54 := k(v2,v1); 
neq55 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(v2,v1)); 
neq56 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v1),v2)); 
neq57 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq58 := k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v1); 
neq59 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))); 
neq60 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq61 := k(k(k(v2,v1),v2),v1); 
neq62 := k(k(k(v2,v1),v2),k(k(v2,v0),v2)); 
neq63 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),v1); 
neq64 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),v0),k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2))) = 0 and 
       d(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(k(v2,v1),v1),k(k(v2,v0),v2)),k(k(v2,v0),v2))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
