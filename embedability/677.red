...
neq5 := k(v2,k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq6 := k(v2,v1); 
neq7 := k(v2,k(v3,v1)); 
neq8 := k(v2,k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq9 := k(v2,k(k(v3,v2),v0)); 
neq10 := k(k(k(k(v3,v2),v0),k(v3,v2)),v3); 
neq11 := k(k(k(k(v3,v2),v0),k(v3,v2)),v0); 
neq12 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(v3,v2),v2),k(v3,v1))); 
neq13 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(v3,v2),v2),v0)); 
neq14 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq15 := k(k(k(k(v3,v2),v0),k(v3,v2)),v1); 
neq16 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(v3,v1)); 
neq17 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq18 := k(k(k(k(v3,v2),v0),k(v3,v2)),k(k(v3,v2),v2)); 
neq19 := k(v3,v0); 
neq20 := k(v3,k(k(k(v3,v2),v2),k(v3,v1))); 
neq21 := k(v3,k(k(k(v3,v2),v2),v0)); 
neq22 := k(v3,k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq23 := k(v3,k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq24 := k(v3,k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq25 := k(v3,k(k(v3,v2),v0)); 
neq26 := k(v3,k(k(v3,v2),v2)); 
neq27 := k(v0,k(k(k(v3,v2),v2),k(v3,v1))); 
neq28 := k(v0,k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq29 := k(v0,k(v3,v1)); 
neq30 := k(v0,k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq31 := k(v0,k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq32 := k(v0,k(k(v3,v2),v2)); 
neq33 := k(v0,k(v3,v2)); 
neq34 := k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(k(v3,v2),v2),v0)); 
neq35 := k(k(k(k(v3,v2),v2),k(v3,v1)),v1); 
neq36 := k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq37 := k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq38 := k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)); 
neq39 := k(k(k(k(v3,v2),v2),k(v3,v1)),k(v3,v2)); 
neq40 := k(k(k(k(v3,v2),v2),v0),k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0))); 
neq41 := k(k(k(k(v3,v2),v2),v0),v1); 
neq42 := k(k(k(k(v3,v2),v2),v0),k(v3,v1)); 
neq43 := k(k(k(k(v3,v2),v2),v0),k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq44 := k(k(k(k(v3,v2),v2),v0),k(k(v3,v2),v0)); 
neq45 := k(k(k(k(v3,v2),v2),v0),k(v3,v2)); 
neq46 := k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v1); 
neq47 := k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),k(v3,v1)); 
neq48 := k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq49 := k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),k(k(v3,v2),v2)); 
neq50 := k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),k(v3,v2)); 
neq51 := k(v1,k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq52 := k(v1,k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq53 := k(v1,k(k(v3,v2),v0)); 
neq54 := k(v1,k(k(v3,v2),v2)); 
neq55 := k(v1,k(v3,v2)); 
neq56 := k(k(v3,v1),k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))); 
neq57 := k(k(v3,v1),k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2)); 
neq58 := k(k(v3,v1),k(k(v3,v2),v0)); 
neq59 := k(k(v3,v1),k(k(v3,v2),v2)); 
neq60 := k(k(v3,v1),k(v3,v2)); 
neq61 := k(k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2))),k(k(v3,v2),v0)); 
neq62 := k(k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2))),k(k(v3,v2),v2)); 
neq63 := k(k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2))),k(v3,v2)); 
neq64 := k(k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2),k(k(v3,v2),v0)); 
neq65 := k(k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2),k(k(v3,v2),v2)); 
neq66 := k(k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2),k(v3,v2)); 
neq67 := k(k(k(v3,v2),v0),k(k(v3,v2),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,v2),v2),k(v3,v1)),k(k(v3,v2),v0)),v2),k(k(k(k(v3,v2),v2),v0),k(k(k(v3,v2),v0),k(v3,v2)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c1,
