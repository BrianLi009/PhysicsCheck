...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(k(v2,k(v0,v1)),k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))))); 
neq1 := k(k(v2,k(v0,v1)),v0); 
neq2 := k(k(v2,k(v0,v1)),v3); 
neq3 := k(k(v2,k(v0,v1)),k(v3,v1)); 
neq4 := k(k(v2,k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq5 := k(k(v2,k(v0,v1)),k(k(v3,v1),k(k(v2,v1),v2))); 
neq6 := k(k(v2,k(v0,v1)),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq7 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq8 := k(k(v2,k(v0,v1)),k(k(v2,v1),v2)); 
neq9 := k(k(v2,k(v0,v1)),v1); 
neq10 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v2); 
neq11 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v0,v1)); 
neq12 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v0); 
neq13 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v3); 
neq14 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v3,v1)); 
neq15 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v3,v1),k(k(v2,v1),v2))); 
neq16 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq17 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(v2,v1)); 
neq18 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),k(k(v2,v1),v2)); 
neq19 := k(k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))),v1); 
neq20 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),v2); 
neq21 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(v0,v1)); 
neq22 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),v0); 
neq23 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(v3,v1)); 
neq24 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(k(k(v2,v1),v2),v0)); 
neq25 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(k(v3,v1),k(k(v2,v1),v2))); 
neq26 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(v2,v1)); 
neq27 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),k(k(v2,v1),v2)); 
neq28 := k(k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1)))),v1); 
neq29 := k(v2,k(v0,v1)); 
neq30 := k(v2,v0); 
neq31 := k(v2,v3); 
neq32 := k(v2,k(v3,v1)); 
neq33 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq34 := k(v2,k(k(v3,v1),k(k(v2,v1),v2))); 
neq35 := k(v2,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq36 := k(v2,v1); 
neq37 := k(k(v0,v1),v3); 
neq38 := k(k(v0,v1),k(v3,v1)); 
neq39 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq40 := k(k(v0,v1),k(k(v3,v1),k(k(v2,v1),v2))); 
neq41 := k(k(v0,v1),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq42 := k(k(v0,v1),k(v2,v1)); 
neq43 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq44 := k(v0,v3); 
neq45 := k(v0,k(v3,v1)); 
neq46 := k(v0,k(k(v3,v1),k(k(v2,v1),v2))); 
neq47 := k(v0,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq48 := k(v0,k(v2,v1)); 
neq49 := k(v0,k(k(v2,v1),v2)); 
neq50 := k(v3,k(k(k(v2,v1),v2),v0)); 
neq51 := k(v3,k(k(v3,v1),k(k(v2,v1),v2))); 
neq52 := k(v3,k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq53 := k(v3,k(v2,v1)); 
neq54 := k(v3,k(k(v2,v1),v2)); 
neq55 := k(k(v3,v1),k(k(k(v2,v1),v2),v0)); 
neq56 := k(k(v3,v1),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq57 := k(k(v3,v1),k(v2,v1)); 
neq58 := k(k(v3,v1),k(k(v2,v1),v2)); 
neq59 := k(k(k(k(v2,v1),v2),v0),k(k(v3,v1),k(k(v2,v1),v2))); 
neq60 := k(k(k(k(v2,v1),v2),v0),k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq61 := k(k(k(k(v2,v1),v2),v0),k(v2,v1)); 
neq62 := k(k(k(k(v2,v1),v2),v0),v1); 
neq63 := k(k(k(v3,v1),k(k(v2,v1),v2)),k(v2,v1)); 
neq64 := k(k(k(v3,v1),k(k(v2,v1),v2)),v1); 
neq65 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v1)); 
neq66 := k(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v1); 
...
phi := 
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(v3,v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v3,k(k(k(k(v2,v1),v2),v0),k(v2,k(v0,v1))))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
