...
def test_embed(): 
    ...
    s.add(((z_6*x_13-x_6*z_13)*z_1-(x_6*y_13-y_6*x_13)*y_1)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_1-(y_6*z_13-z_6*y_13)*z_1)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_1-(z_6*x_13-x_6*z_13)*x_1)==0) 
