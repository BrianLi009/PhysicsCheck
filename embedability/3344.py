...
def test_embed(): 
    ...
    s.add(((z_12*x_13-x_12*z_13)*z_5-(x_12*y_13-y_12*x_13)*y_5)==0) 
    s.add(((x_12*y_13-y_12*x_13)*x_5-(y_12*z_13-z_12*y_13)*z_5)==0) 
    s.add(((y_12*z_13-z_12*y_13)*y_5-(z_12*x_13-x_12*z_13)*x_5)==0) 
