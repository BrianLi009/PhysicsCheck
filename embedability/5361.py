...
def test_embed(): 
    ...
    s.add(((z_2*x_13-x_2*z_13)*z_6-(x_2*y_13-y_2*x_13)*y_6)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_6-(y_2*z_13-z_2*y_13)*z_6)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_6-(z_2*x_13-x_2*z_13)*x_6)==0) 
    s.add(((z_6*x_13-x_6*z_13)*z_3-(x_6*y_13-y_6*x_13)*y_3)==0) 
    s.add(((x_6*y_13-y_6*x_13)*x_3-(y_6*z_13-z_6*y_13)*z_3)==0) 
    s.add(((y_6*z_13-z_6*y_13)*y_3-(z_6*x_13-x_6*z_13)*x_3)==0) 
