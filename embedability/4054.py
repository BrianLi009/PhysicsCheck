...
def test_embed(): 
    ...
    s.add(((z_11*x_12-x_11*z_12)*z_9-(x_11*y_12-y_11*x_12)*y_9)==0) 
    s.add(((x_11*y_12-y_11*x_12)*x_9-(y_11*z_12-z_11*y_12)*z_9)==0) 
    s.add(((y_11*z_12-z_11*y_12)*y_9-(z_11*x_12-x_11*z_12)*x_9)==0) 
    s.add(((z_9*x_11-x_9*z_11)*z_10-(x_9*y_11-y_9*x_11)*y_10)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_10-(y_9*z_11-z_9*y_11)*z_10)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_10-(z_9*x_11-x_9*z_11)*x_10)==0) 
    ...
    s.add(((z_0*x_11-x_0*z_11)*z_1-(x_0*y_11-y_0*x_11)*y_1)==0) 
    s.add(((x_0*y_11-y_0*x_11)*x_1-(y_0*z_11-z_0*y_11)*z_1)==0) 
    s.add(((y_0*z_11-z_0*y_11)*y_1-(z_0*x_11-x_0*z_11)*x_1)==0) 
    s.add(((z_9*x_13-x_9*z_13)*z_2-(x_9*y_13-y_9*x_13)*y_2)==0) 
    s.add(((x_9*y_13-y_9*x_13)*x_2-(y_9*z_13-z_9*y_13)*z_2)==0) 
    s.add(((y_9*z_13-z_9*y_13)*y_2-(z_9*x_13-x_9*z_13)*x_2)==0) 
    s.add(((z_2*x_13-x_2*z_13)*z_3-(x_2*y_13-y_2*x_13)*y_3)==0) 
    s.add(((x_2*y_13-y_2*x_13)*x_3-(y_2*z_13-z_2*y_13)*z_3)==0) 
    s.add(((y_2*z_13-z_2*y_13)*y_3-(z_2*x_13-x_2*z_13)*x_3)==0) 
    s.add(((z_3*x_11-x_3*z_11)*z_6-(x_3*y_11-y_3*x_11)*y_6)==0) 
    s.add(((x_3*y_11-y_3*x_11)*x_6-(y_3*z_11-z_3*y_11)*z_6)==0) 
    s.add(((y_3*z_11-z_3*y_11)*y_6-(z_3*x_11-x_3*z_11)*x_6)==0) 
    s.add(((z_10*x_13-x_10*z_13)*z_4-(x_10*y_13-y_10*x_13)*y_4)==0) 
    s.add(((x_10*y_13-y_10*x_13)*x_4-(y_10*z_13-z_10*y_13)*z_4)==0) 
    s.add(((y_10*z_13-z_10*y_13)*y_4-(z_10*x_13-x_10*z_13)*x_4)==0) 
    s.add(((z_4*x_10-x_4*z_10)*z_5-(x_4*y_10-y_4*x_10)*y_5)==0) 
    s.add(((x_4*y_10-y_4*x_10)*x_5-(y_4*z_10-z_4*y_10)*z_5)==0) 
    s.add(((y_4*z_10-z_4*y_10)*y_5-(z_4*x_10-x_4*z_10)*x_5)==0) 
    s.add(((z_5*x_12-x_5*z_12)*z_8-(x_5*y_12-y_5*x_12)*y_8)==0) 
    s.add(((x_5*y_12-y_5*x_12)*x_8-(y_5*z_12-z_5*y_12)*z_8)==0) 
    s.add(((y_5*z_12-z_5*y_12)*y_8-(z_5*x_12-x_5*z_12)*x_8)==0) 
    s.add(((z_6*x_8-x_6*z_8)*z_7-(x_6*y_8-y_6*x_8)*y_7)==0) 
    s.add(((x_6*y_8-y_6*x_8)*x_7-(y_6*z_8-z_6*y_8)*z_7)==0) 
    s.add(((y_6*z_8-z_6*y_8)*y_7-(z_6*x_8-x_6*z_8)*x_7)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_1 == 0) 
