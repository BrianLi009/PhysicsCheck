...
def test_embed(): 
    ...
    s.add(((z_0*x_7-x_0*z_7)*z_8-(x_0*y_7-y_0*x_7)*y_8)==0) 
    s.add(((x_0*y_7-y_0*x_7)*x_8-(y_0*z_7-z_0*y_7)*z_8)==0) 
    s.add(((y_0*z_7-z_0*y_7)*y_8-(z_0*x_7-x_0*z_7)*x_8)==0) 
    ...
    s.add(((z_9*x_11-x_9*z_11)*z_5-(x_9*y_11-y_9*x_11)*y_5)==0) 
    s.add(((x_9*y_11-y_9*x_11)*x_5-(y_9*z_11-z_9*y_11)*z_5)==0) 
    s.add(((y_9*z_11-z_9*y_11)*y_5-(z_9*x_11-x_9*z_11)*x_5)==0) 
    s.add(((z_5*x_10-x_5*z_10)*z_6-(x_5*y_10-y_5*x_10)*y_6)==0) 
    s.add(((x_5*y_10-y_5*x_10)*x_6-(y_5*z_10-z_5*y_10)*z_6)==0) 
    s.add(((y_5*z_10-z_5*y_10)*y_6-(z_5*x_10-x_5*z_10)*x_6)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
