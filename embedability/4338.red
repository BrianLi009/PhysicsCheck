...
v3 := {v3c1, v3c2, v3c3}; 
v2c1 := 0;
neq0 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),v3); 
neq1 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(k(k(k(v3,v2),v1),v1),v3)); 
neq2 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),v0); 
neq3 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(v3,v2)); 
neq4 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq5 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),v1); 
neq6 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(v3,v0)); 
neq7 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(k(k(v3,v2),v1),v1)); 
neq8 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(k(k(v3,v2),v1),k(v3,v0))); 
neq9 := k(k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2),k(k(v3,v2),v1)); 
neq10 := k(v2,v3); 
neq11 := k(v2,k(k(k(k(v3,v2),v1),v1),v3)); 
neq12 := k(v2,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1))); 
neq13 := k(v2,k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq14 := k(v2,k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(v3,v0)); 
...
neq20 := k(v3,v0); 
neq21 := k(v3,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1))); 
neq22 := k(v3,k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq23 := k(v3,k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq24 := k(v3,v1); 
neq25 := k(v3,k(k(k(v3,v2),v1),v1)); 
neq26 := k(v3,k(k(k(v3,v2),v1),k(v3,v0))); 
neq27 := k(v3,k(k(v3,v2),v1)); 
neq28 := k(k(k(k(k(v3,v2),v1),v1),v3),v0); 
neq29 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1))); 
neq30 := k(k(k(k(k(v3,v2),v1),v1),v3),k(v3,v2)); 
neq31 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq32 := k(k(k(k(k(v3,v2),v1),v1),v3),v1); 
neq33 := k(k(k(k(k(v3,v2),v1),v1),v3),k(v3,v0)); 
neq34 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))); 
neq35 := k(k(k(k(k(v3,v2),v1),v1),v3),k(k(v3,v2),v1)); 
neq36 := k(v0,k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1))); 
neq37 := k(v0,k(v3,v2)); 
neq38 := k(v0,k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq39 := k(v0,k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq40 := k(v0,k(k(k(v3,v2),v1),v1)); 
neq41 := k(v0,k(k(k(v3,v2),v1),k(v3,v0))); 
neq42 := k(v0,k(k(v3,v2),v1)); 
neq43 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(v3,v2)); 
neq44 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq45 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),v1); 
neq46 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(v3,v0)); 
neq47 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(k(k(v3,v2),v1),k(v3,v0))); 
neq48 := k(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(k(v3,v2),v1)); 
neq49 := k(k(v3,v2),k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0)))); 
neq50 := k(k(v3,v2),k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq51 := k(k(v3,v2),v1); 
neq52 := k(k(v3,v2),k(v3,v0)); 
neq53 := k(k(v3,v2),k(k(k(v3,v2),v1),v1)); 
neq54 := k(k(v3,v2),k(k(k(v3,v2),v1),k(v3,v0))); 
neq55 := k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0))); 
neq56 := k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v1); 
neq57 := k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),k(v3,v0)); 
neq58 := k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),k(k(k(v3,v2),v1),v1)); 
neq59 := k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),k(k(v3,v2),v1)); 
neq60 := k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),v1); 
neq61 := k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)); 
neq62 := k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(v3,v2),v1)); 
neq63 := k(v1,k(v3,v0)); 
neq64 := k(v1,k(k(k(v3,v2),v1),k(v3,v0))); 
neq65 := k(k(v3,v0),k(k(k(v3,v2),v1),v1)); 
neq66 := k(k(v3,v0),k(k(v3,v2),v1)); 
neq67 := k(k(k(k(v3,v2),v1),v1),k(k(k(v3,v2),v1),k(v3,v0))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v2,v0) = 0 and 
       d(k(k(k(k(k(v3,v2),v1),k(v3,v0)),k(v3,v0)),k(k(k(v3,v2),v1),v1)),k(k(k(k(k(k(v3,v2),v1),v1),v3),k(k(k(v3,v2),v1),k(v3,v0))),v2)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
