...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),v2); 
neq1 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1))); 
neq2 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0))); 
neq3 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(v2,v1)); 
neq4 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(v2,v0),v2),v1)); 
neq5 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(v2,v0),v2)); 
neq6 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(k(v2,v0),v2),v1),v1)); 
neq7 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),v1); 
neq8 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(v2,v0)); 
neq9 := k(v2,k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1))); 
neq10 := k(v2,k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0))); 
neq11 := k(v2,v0); 
neq12 := k(v2,k(k(k(v2,v0),v2),v1)); 
neq13 := k(v2,k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq14 := k(v2,k(k(k(k(v2,v0),v2),v1),v1)); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq17 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),k(v2,v1)); 
neq18 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),v0); 
neq19 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),k(k(k(v2,v0),v2),v1)); 
neq20 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq21 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),k(k(v2,v0),v2)); 
neq22 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),v1); 
neq23 := k(k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)),k(v2,v0)); 
neq24 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(v2,v1)); 
neq25 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),v0); 
neq26 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(k(k(v2,v0),v2),v1)); 
neq27 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq28 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(k(v2,v0),v2)); 
neq29 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),v1); 
neq30 := k(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq31 := k(k(v2,v1),v0); 
neq32 := k(k(v2,v1),k(k(k(v2,v0),v2),v1)); 
neq33 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))); 
neq34 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq35 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),v1)); 
...
neq41 := k(v0,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq42 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq43 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq44 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),v1)); 
...
neq49 := k(k(k(v2,v0),v2),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq50 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq51 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)); 
neq52 := k(v1,k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))); 
neq53 := k(v1,k(v2,v0)); 
neq54 := k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0),k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1))) = 0 and 
       d(k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)),k(k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
