...
def test_embed(): 
    ...
    s.add(((z_7*x_13-x_7*z_13)*z_5-(x_7*y_13-y_7*x_13)*y_5)==0) 
    s.add(((x_7*y_13-y_7*x_13)*x_5-(y_7*z_13-z_7*y_13)*z_5)==0) 
    s.add(((y_7*z_13-z_7*y_13)*y_5-(z_7*x_13-x_7*z_13)*x_5)==0) 
