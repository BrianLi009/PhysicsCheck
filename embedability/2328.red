...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2))); 
neq1 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2))); 
neq2 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2)); 
neq3 := k(k(k(k(v2,v1),v2),v0),k(k(v2,v1),v1)); 
neq4 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq5 := k(k(k(k(v2,v1),v2),v0),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))); 
...
neq10 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2)); 
neq11 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(v2,v1),v1)); 
...
neq14 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq15 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v2); 
neq16 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(v2,v1)); 
neq17 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq18 := k(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),v1); 
neq19 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2)); 
neq20 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v1)); 
...
neq23 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))); 
...
neq26 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
...
neq31 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
...
neq37 := k(k(k(v2,v1),v1),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq38 := k(k(k(v2,v1),v1),v2); 
neq39 := k(k(k(v2,v1),v1),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq40 := k(k(k(v2,v1),v1),k(k(v2,v1),v2)); 
neq41 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1)); 
neq42 := k(k(k(k(k(v2,v1),v2),v0),v0),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))); 
...
neq48 := k(v0,k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))); 
neq49 := k(v0,v2); 
neq50 := k(v0,k(v2,v1)); 
neq51 := k(v0,k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq52 := k(v0,k(k(v2,v1),v2)); 
neq53 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))); 
neq54 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),v2); 
neq55 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(v2,v1)); 
neq56 := k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)); 
neq57 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1)),v2); 
neq58 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1)),k(v2,v1)); 
neq59 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1)),k(k(k(k(k(v2,v1),v2),v0),v0),v2)); 
neq60 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1)),v1); 
neq61 := k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1)),k(k(v2,v1),v2)); 
neq62 := k(v2,v1); 
...
phi := 
       ...
       d(k(k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v1),k(k(v2,v1),v2)),k(k(v2,v1),v2)),k(k(k(k(k(k(k(v2,v1),v2),v0),v0),v2),v2),k(k(v2,v1),v1))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v2c2,
