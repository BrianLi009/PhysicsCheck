...
v3 := {v3c1, v3c2, v3c3}; 
v3c2 := 0;
neq0 := k(v0,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))); 
neq1 := k(v0,v2); 
neq2 := k(v0,k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))); 
neq3 := k(v0,v3); 
neq4 := k(v0,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq5 := k(v0,k(k(v2,v1),v2)); 
neq6 := k(v0,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq7 := k(v0,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq8 := k(v0,k(v2,v1)); 
neq9 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq10 := k(k(v2,v0),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))); 
neq11 := k(k(v2,v0),v1); 
neq12 := k(k(v2,v0),v3); 
neq13 := k(k(v2,v0),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq14 := k(k(v2,v0),k(k(v2,v1),v2)); 
neq15 := k(k(v2,v0),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq16 := k(k(v2,v0),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq17 := k(k(v2,v0),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq18 := k(k(v2,v0),k(v2,v1)); 
neq19 := k(k(v2,v0),k(v3,k(k(v2,v1),v2))); 
neq20 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v2); 
neq21 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v1); 
neq22 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),v3); 
neq23 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(k(v2,v1),v2)); 
neq24 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq25 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq26 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(v2,v1)); 
neq27 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))),k(v3,k(k(v2,v1),v2))); 
neq28 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0))); 
neq29 := k(v2,v1); 
neq30 := k(v2,v3); 
neq31 := k(v2,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq32 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq33 := k(v2,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq34 := k(v2,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq35 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq36 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),v1); 
neq37 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),v3); 
neq38 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq39 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(v2,v1),v2)); 
neq40 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq41 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq42 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(v2,v1)); 
neq43 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)),k(v3,k(k(v2,v1),v2))); 
neq44 := k(v1,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq45 := k(v1,k(k(v2,v1),v2)); 
neq46 := k(v1,k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq47 := k(v1,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq48 := k(v1,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq49 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq50 := k(v3,k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2)))); 
neq51 := k(v3,k(k(v2,v1),v2)); 
neq52 := k(v3,k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq53 := k(v3,k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq54 := k(v3,k(v2,v1)); 
neq55 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq56 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq57 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq58 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))),k(v2,v1)); 
neq59 := k(k(k(v2,v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v3),v0)); 
neq60 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq61 := k(k(k(v2,v1),v2),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq62 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)); 
neq63 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v3,k(k(v2,v1),v2))); 
neq64 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1))); 
neq65 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v1)); 
neq66 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))); 
neq67 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v1) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(v3,k(k(v2,v1),v2))),k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v0),k(v2,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),k(v2,v0)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c3,
