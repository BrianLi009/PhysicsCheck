...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_10-(x_7*y_12-y_7*x_12)*y_10)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_10-(y_7*z_12-z_7*y_12)*z_10)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_10-(z_7*x_12-x_7*z_12)*x_10)==0) 
    ...
    s.add(((z_8*x_13-x_8*z_13)*z_0-(x_8*y_13-y_8*x_13)*y_0)==0) 
    s.add(((x_8*y_13-y_8*x_13)*x_0-(y_8*z_13-z_8*y_13)*z_0)==0) 
    s.add(((y_8*z_13-z_8*y_13)*y_0-(z_8*x_13-x_8*z_13)*x_0)==0) 
    ...
    s.add(((z_5*x_7-x_5*z_7)*z_3-(x_5*y_7-y_5*x_7)*y_3)==0) 
    s.add(((x_5*y_7-y_5*x_7)*x_3-(y_5*z_7-z_5*y_7)*z_3)==0) 
    s.add(((y_5*z_7-z_5*y_7)*y_3-(z_5*x_7-x_5*z_7)*x_3)==0) 
