...
def test_embed(): 
    ...
    s.add(((z_7*x_12-x_7*z_12)*z_5-(x_7*y_12-y_7*x_12)*y_5)==0) 
    s.add(((x_7*y_12-y_7*x_12)*x_5-(y_7*z_12-z_7*y_12)*z_5)==0) 
    s.add(((y_7*z_12-z_7*y_12)*y_5-(z_7*x_12-x_7*z_12)*x_5)==0) 
