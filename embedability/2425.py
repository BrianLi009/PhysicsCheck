...
def test_embed(): 
    ...
    s.add(((z_1*x_7-x_1*z_7)*z_9-(x_1*y_7-y_1*x_7)*y_9)==0) 
    s.add(((x_1*y_7-y_1*x_7)*x_9-(y_1*z_7-z_1*y_7)*z_9)==0) 
    s.add(((y_1*z_7-z_1*y_7)*y_9-(z_1*x_7-x_1*z_7)*x_9)==0) 
    s.add(((z_2*x_7-x_2*z_7)*z_12-(x_2*y_7-y_2*x_7)*y_12)==0) 
    s.add(((x_2*y_7-y_2*x_7)*x_12-(y_2*z_7-z_2*y_7)*z_12)==0) 
    s.add(((y_2*z_7-z_2*y_7)*y_12-(z_2*x_7-x_2*z_7)*x_12)==0) 
    ...
    s.add(((z_3*x_8-x_3*z_8)*z_11-(x_3*y_8-y_3*x_8)*y_11)==0) 
    s.add(((x_3*y_8-y_3*x_8)*x_11-(y_3*z_8-z_3*y_8)*z_11)==0) 
    s.add(((y_3*z_8-z_3*y_8)*y_11-(z_3*x_8-x_3*z_8)*x_11)==0) 
