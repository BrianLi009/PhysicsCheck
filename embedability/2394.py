...
def test_embed(): 
    ...
    s.add(((z_2*x_11-x_2*z_11)*z_10-(x_2*y_11-y_2*x_11)*y_10)==0) 
    s.add(((x_2*y_11-y_2*x_11)*x_10-(y_2*z_11-z_2*y_11)*z_10)==0) 
    s.add(((y_2*z_11-z_2*y_11)*y_10-(z_2*x_11-x_2*z_11)*x_10)==0) 
    ...
    s.add(((z_7*x_8-x_7*z_8)*z_5-(x_7*y_8-y_7*x_8)*y_5)==0) 
    s.add(((x_7*y_8-y_7*x_8)*x_5-(y_7*z_8-z_7*y_8)*z_5)==0) 
    s.add(((y_7*z_8-z_7*y_8)*y_5-(z_7*x_8-x_7*z_8)*x_5)==0) 
    s.add(((z_9*x_10-x_9*z_10)*z_6-(x_9*y_10-y_9*x_10)*y_6)==0) 
    s.add(((x_9*y_10-y_9*x_10)*x_6-(y_9*z_10-z_9*y_10)*z_6)==0) 
    s.add(((y_9*z_10-z_9*y_10)*y_6-(z_9*x_10-x_9*z_10)*x_6)==0) 
    s.add(x_0 == 0) 
    s.add(y_0 == 0) 
    s.add(z_0 == 1) 
    s.add(x_7 == 0) 
