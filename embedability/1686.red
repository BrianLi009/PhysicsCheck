...
neq1 := k(k(k(v2,v1),v1),k(k(v3,k(v2,v1)),k(v2,v1))); 
neq2 := k(k(k(v2,v1),v1),k(v3,k(v2,v1))); 
neq3 := k(k(k(v2,v1),v1),v0); 
neq4 := k(k(k(v2,v1),v1),k(v2,k(v0,v1))); 
neq5 := k(k(k(v2,v1),v1),k(k(v2,k(v0,v1)),v2)); 
neq6 := k(k(k(v2,v1),v1),v3); 
neq7 := k(k(k(v2,v1),v1),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq8 := k(k(k(v2,v1),v1),k(v0,v1)); 
neq9 := k(k(k(v2,v1),v1),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq10 := k(v2,k(k(v3,k(v2,v1)),k(v2,v1))); 
neq11 := k(v2,k(v3,k(v2,v1))); 
neq12 := k(v2,v0); 
neq13 := k(v2,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1))); 
neq14 := k(v2,v3); 
neq15 := k(v2,v1); 
neq16 := k(v2,k(v3,k(k(v2,k(v0,v1)),v2))); 
neq17 := k(v2,k(v0,v1)); 
neq18 := k(v2,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq19 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v0); 
neq20 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1))); 
neq21 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v2,k(v0,v1))); 
neq22 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v2,k(v0,v1)),v2)); 
neq23 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v3); 
neq24 := k(k(k(v3,k(v2,v1)),k(v2,v1)),v1); 
neq25 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq26 := k(k(k(v3,k(v2,v1)),k(v2,v1)),k(v0,v1)); 
neq27 := k(k(v3,k(v2,v1)),v0); 
neq28 := k(k(v3,k(v2,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1))); 
neq29 := k(k(v3,k(v2,v1)),k(v2,k(v0,v1))); 
neq30 := k(k(v3,k(v2,v1)),k(k(v2,k(v0,v1)),v2)); 
neq31 := k(k(v3,k(v2,v1)),v1); 
neq32 := k(k(v3,k(v2,v1)),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq33 := k(k(v3,k(v2,v1)),k(v0,v1)); 
neq34 := k(k(v3,k(v2,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq35 := k(v0,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1))); 
neq36 := k(v0,k(v2,k(v0,v1))); 
neq37 := k(v0,k(k(v2,k(v0,v1)),v2)); 
neq38 := k(v0,k(v3,k(k(v2,k(v0,v1)),v2))); 
neq39 := k(v0,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq40 := k(v0,k(v2,v1)); 
neq41 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),k(v2,k(v0,v1))); 
neq42 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),k(k(v2,k(v0,v1)),v2)); 
neq43 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),v3); 
neq44 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),v1); 
neq45 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),k(v0,v1)); 
neq46 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1)),k(v2,v1)); 
neq47 := k(k(v2,k(v0,v1)),v3); 
neq48 := k(k(v2,k(v0,v1)),v1); 
neq49 := k(k(v2,k(v0,v1)),k(v3,k(k(v2,k(v0,v1)),v2))); 
neq50 := k(k(v2,k(v0,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq51 := k(k(v2,k(v0,v1)),k(v2,v1)); 
neq52 := k(k(k(v2,k(v0,v1)),v2),v3); 
neq53 := k(k(k(v2,k(v0,v1)),v2),v1); 
neq54 := k(k(k(v2,k(v0,v1)),v2),k(v0,v1)); 
neq55 := k(k(k(v2,k(v0,v1)),v2),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq56 := k(k(k(v2,k(v0,v1)),v2),k(v2,v1)); 
neq57 := k(v3,v1); 
neq58 := k(v3,k(v0,v1)); 
neq59 := k(v3,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq60 := k(v3,k(v2,v1)); 
neq61 := k(v1,k(v3,k(k(v2,k(v0,v1)),v2))); 
neq62 := k(v1,k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))); 
neq63 := k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1)); 
neq64 := k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v2,v1)); 
neq65 := k(k(v0,v1),k(v2,v1)); 
neq66 := k(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1)),k(v2,v1)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(k(v2,v1),v1))) = 0 and 
       d(k(k(v3,k(v2,v1)),k(v2,v1)),k(k(v3,k(k(v2,k(v0,v1)),v2)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
