...
neq3 := k(v2,v0); 
neq4 := k(v2,k(k(v3,k(k(v2,v0),v2)),v3)); 
neq5 := k(v2,v3); 
neq6 := k(v2,k(k(v3,k(k(v2,v0),v2)),v1)); 
neq7 := k(v2,v1); 
neq8 := k(v2,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq9 := k(v2,k(v3,k(k(v2,v0),v2))); 
neq10 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0))); 
neq11 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v0); 
neq12 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq13 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),v3); 
neq14 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(v3,k(k(v2,v0),v2)),v1)); 
neq15 := k(k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)),k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
...
neq19 := k(k(k(k(v2,v0),v2),v1),k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0))); 
neq20 := k(k(k(k(v2,v0),v2),v1),v0); 
neq21 := k(k(k(k(v2,v0),v2),v1),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq22 := k(k(k(k(v2,v0),v2),v1),v3); 
neq23 := k(k(k(k(v2,v0),v2),v1),k(k(v3,k(k(v2,v0),v2)),v1)); 
neq24 := k(k(k(k(v2,v0),v2),v1),k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
neq25 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq26 := k(k(k(k(v2,v0),v2),v1),k(v3,k(k(v2,v0),v2))); 
neq27 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq28 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),v0); 
neq29 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),k(k(v3,k(k(v2,v0),v2)),v3)); 
neq30 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),v3); 
neq31 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
neq32 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),v1); 
neq33 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),k(v3,k(k(v2,v0),v2))); 
neq34 := k(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),k(k(v2,v0),v2)); 
neq35 := k(v0,k(k(v3,k(k(v2,v0),v2)),v3)); 
neq36 := k(v0,k(k(v3,k(k(v2,v0),v2)),v1)); 
neq37 := k(v0,k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
neq38 := k(v0,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq39 := k(v0,k(v3,k(k(v2,v0),v2))); 
neq40 := k(v0,k(k(v2,v0),v2)); 
neq41 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(k(v3,k(k(v2,v0),v2)),v1)); 
neq42 := k(k(k(v3,k(k(v2,v0),v2)),v3),v1); 
neq43 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq44 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(v2,v0)); 
neq45 := k(k(k(v3,k(k(v2,v0),v2)),v3),k(k(v2,v0),v2)); 
neq46 := k(v3,k(k(v3,k(k(v2,v0),v2)),v1)); 
neq47 := k(v3,k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
neq48 := k(v3,v1); 
neq49 := k(v3,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq50 := k(v3,k(v2,v0)); 
neq51 := k(v3,k(k(v2,v0),v2)); 
neq52 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(v3,k(k(v2,v0),v2)),v3),v2)); 
neq53 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq54 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)); 
neq55 := k(k(k(v3,k(k(v2,v0),v2)),v1),k(k(v2,v0),v2)); 
neq56 := k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),v1); 
neq57 := k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(v3,k(k(v2,v0),v2))); 
neq58 := k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(v2,v0)); 
neq59 := k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(v2,v0),v2)); 
neq60 := k(v1,k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))); 
neq61 := k(v1,k(v3,k(k(v2,v0),v2))); 
neq62 := k(v1,k(v2,v0)); 
neq63 := k(v1,k(k(v2,v0),v2)); 
neq64 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))),k(v3,k(k(v2,v0),v2))); 
neq65 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))),k(v2,v0)); 
neq66 := k(k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2))),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(v3,k(k(v2,v0),v2)),v1),k(v2,v0)),k(k(k(k(v3,k(k(v2,v0),v2)),v3),v2),k(k(k(k(v2,v0),v2),v1),k(k(v2,v0),v2)))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
