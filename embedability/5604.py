...
def test_embed(): 
    ...
    s.add(((z_0*x_10-x_0*z_10)*z_13-(x_0*y_10-y_0*x_10)*y_13)==0) 
    s.add(((x_0*y_10-y_0*x_10)*x_13-(y_0*z_10-z_0*y_10)*z_13)==0) 
    s.add(((y_0*z_10-z_0*y_10)*y_13-(z_0*x_10-x_0*z_10)*x_13)==0) 
    s.add(x_3 == 0) 
    s.add(y_3 == 0) 
    s.add(z_3 == 1) 
    s.add(x_6 == 0) 
