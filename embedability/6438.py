...
def test_embed(): 
    ...
    s.add(((z_5*x_13-x_5*z_13)*z_8-(x_5*y_13-y_5*x_13)*y_8)==0) 
    s.add(((x_5*y_13-y_5*x_13)*x_8-(y_5*z_13-z_5*y_13)*z_8)==0) 
    s.add(((y_5*z_13-z_5*y_13)*y_8-(z_5*x_13-x_5*z_13)*x_8)==0) 
