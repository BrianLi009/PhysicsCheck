...
neq2 := k(v2,v0); 
neq3 := k(v2,k(v3,v0)); 
neq4 := k(v2,k(v4,k(v3,k(v2,v1)))); 
neq5 := k(v2,v4); 
neq6 := k(v2,k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq7 := k(v2,k(k(v4,v2),k(k(v3,v0),v0))); 
neq8 := k(v2,v1); 
neq9 := k(v2,k(v3,k(v2,v1))); 
neq10 := k(k(v2,v1),k(v4,v2)); 
neq11 := k(k(v2,v1),k(k(v4,k(v3,k(v2,v1))),v2)); 
neq12 := k(k(v2,v1),v3); 
neq13 := k(k(v2,v1),k(k(v3,v0),v0)); 
neq14 := k(k(v2,v1),v0); 
neq15 := k(k(v2,v1),k(v3,v0)); 
neq16 := k(k(v2,v1),k(v4,k(v3,k(v2,v1)))); 
neq17 := k(k(v2,v1),v4); 
neq18 := k(k(v2,v1),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq19 := k(k(v2,v1),k(k(v4,v2),k(k(v3,v0),v0))); 
neq20 := k(k(v4,v2),k(k(v4,k(v3,k(v2,v1))),v2)); 
neq21 := k(k(v4,v2),v3); 
neq22 := k(k(v4,v2),k(k(v3,v0),v0)); 
neq23 := k(k(v4,v2),v0); 
neq24 := k(k(v4,v2),k(v3,v0)); 
neq25 := k(k(v4,v2),k(v4,k(v3,k(v2,v1)))); 
neq26 := k(k(v4,v2),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq27 := k(k(v4,v2),v1); 
neq28 := k(k(v4,v2),k(v3,k(v2,v1))); 
neq29 := k(k(k(v4,k(v3,k(v2,v1))),v2),v3); 
neq30 := k(k(k(v4,k(v3,k(v2,v1))),v2),k(k(v3,v0),v0)); 
neq31 := k(k(k(v4,k(v3,k(v2,v1))),v2),v0); 
neq32 := k(k(k(v4,k(v3,k(v2,v1))),v2),k(v3,v0)); 
neq33 := k(k(k(v4,k(v3,k(v2,v1))),v2),v4); 
neq34 := k(k(k(v4,k(v3,k(v2,v1))),v2),k(k(v4,v2),k(k(v3,v0),v0))); 
neq35 := k(k(k(v4,k(v3,k(v2,v1))),v2),v1); 
neq36 := k(k(k(v4,k(v3,k(v2,v1))),v2),k(v3,k(v2,v1))); 
neq37 := k(v3,k(k(v3,v0),v0)); 
neq38 := k(v3,v0); 
neq39 := k(v3,k(v4,k(v3,k(v2,v1)))); 
neq40 := k(v3,v4); 
neq41 := k(v3,k(k(v4,v2),k(k(v3,v0),v0))); 
neq42 := k(v3,v1); 
neq43 := k(k(k(v3,v0),v0),k(v4,k(v3,k(v2,v1)))); 
neq44 := k(k(k(v3,v0),v0),v4); 
neq45 := k(k(k(v3,v0),v0),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq46 := k(k(k(v3,v0),v0),v1); 
neq47 := k(k(k(v3,v0),v0),k(v3,k(v2,v1))); 
neq48 := k(v0,k(v4,k(v3,k(v2,v1)))); 
neq49 := k(v0,v4); 
neq50 := k(v0,k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq51 := k(v0,k(k(v4,v2),k(k(v3,v0),v0))); 
neq52 := k(v0,k(v3,k(v2,v1))); 
neq53 := k(k(v3,v0),k(v4,k(v3,k(v2,v1)))); 
neq54 := k(k(v3,v0),v4); 
neq55 := k(k(v3,v0),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq56 := k(k(v3,v0),k(k(v4,v2),k(k(v3,v0),v0))); 
neq57 := k(k(v3,v0),v1); 
neq58 := k(k(v3,v0),k(v3,k(v2,v1))); 
neq59 := k(k(v4,k(v3,k(v2,v1))),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq60 := k(k(v4,k(v3,k(v2,v1))),k(k(v4,v2),k(k(v3,v0),v0))); 
neq61 := k(k(v4,k(v3,k(v2,v1))),v1); 
neq62 := k(v4,k(k(k(v4,v2),k(k(v3,v0),v0)),v3)); 
neq63 := k(v4,k(k(v4,v2),k(k(v3,v0),v0))); 
neq64 := k(v4,k(v3,k(v2,v1))); 
neq65 := k(k(k(k(v4,v2),k(k(v3,v0),v0)),v3),v1); 
neq66 := k(k(k(k(v4,v2),k(k(v3,v0),v0)),v3),k(v3,k(v2,v1))); 
neq67 := k(k(k(v4,v2),k(k(v3,v0),v0)),v1); 
neq68 := k(k(k(v4,v2),k(k(v3,v0),v0)),k(v3,k(v2,v1))); 
neq69 := k(v1,k(v3,k(v2,v1))); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v4,v1) = 0 and 
       d(k(k(v4,k(v3,k(v2,v1))),v2),k(k(k(v4,v2),k(k(v3,v0),v0)),v3)) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
