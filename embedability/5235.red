...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),v2); 
neq1 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),v0); 
neq2 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(v2,v1)); 
neq3 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq4 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),v3); 
neq5 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq6 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(k(v2,v1),v2)); 
neq7 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq8 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(v3,k(k(v2,v1),v2))); 
neq9 := k(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),v1); 
neq10 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2)))); 
neq11 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)); 
neq12 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),v0); 
neq13 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v2,v1)); 
neq14 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),v3); 
neq15 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq16 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(k(v2,v1),v2)); 
neq17 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq18 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v3,k(k(v2,v1),v2))); 
neq19 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),v1); 
neq20 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2)))); 
neq21 := k(v2,k(v0,v1)); 
neq22 := k(v2,v0); 
neq23 := k(v2,k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq24 := k(v2,v3); 
neq25 := k(v2,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq26 := k(v2,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq27 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq28 := k(v2,v1); 
neq29 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),k(v0,v1)); 
neq30 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),v0); 
neq31 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),k(v2,v1)); 
neq32 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq33 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),v3); 
neq34 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq35 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),k(k(v2,v1),v2)); 
neq36 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2))),v1); 
neq37 := k(k(v0,v1),k(v2,v1)); 
neq38 := k(k(v0,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq39 := k(k(v0,v1),v3); 
neq40 := k(k(v0,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq41 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq42 := k(k(v0,v1),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq43 := k(k(v0,v1),k(v3,k(k(v2,v1),v2))); 
neq44 := k(v0,k(v2,v1)); 
neq45 := k(v0,k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq46 := k(v0,k(k(v3,k(k(v2,v1),v2)),v3)); 
neq47 := k(v0,k(k(v2,v1),v2)); 
neq48 := k(v0,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq49 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq50 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),v3),v1)); 
neq51 := k(k(v2,v1),v3); 
neq52 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v3)); 
neq53 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq54 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq55 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v3); 
neq56 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),k(k(v2,v1),v2)); 
neq57 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq58 := k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),k(v3,k(k(v2,v1),v2))); 
neq59 := k(v3,k(k(v2,v1),v2)); 
neq60 := k(v3,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq61 := k(v3,v1); 
neq62 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(v2,v1),v2)); 
neq63 := k(k(k(v3,k(k(v2,v1),v2)),v3),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq64 := k(k(k(v3,k(k(v2,v1),v2)),v3),v1); 
neq65 := k(k(k(v2,v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)); 
...
phi := 
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(k(v3,k(k(v2,v1),v2)),v3),v1),v2),k(v0,v1)),k(k(k(v3,k(k(v2,v1),v2)),v1),k(v3,k(k(v2,v1),v2)))) = 0 and 
        true;
rlqe 
     ex(v2c3,
     ex(v3c2,
