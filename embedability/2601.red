...
neq2 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq3 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq4 := k(k(k(k(v2,v0),v2),v1),v0); 
neq5 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq6 := k(k(k(k(v2,v0),v2),v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq7 := k(k(k(k(v2,v0),v2),v1),k(v2,v0)); 
neq8 := k(k(k(k(v2,v0),v2),v1),k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq9 := k(k(k(k(v2,v0),v2),v1),k(v0,v1)); 
neq10 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq11 := k(k(v2,v1),k(k(k(k(v2,v0),v2),v1),v1)); 
neq12 := k(k(v2,v1),v0); 
neq13 := k(k(v2,v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq14 := k(k(v2,v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq15 := k(k(v2,v1),k(v2,v0)); 
neq16 := k(k(v2,v1),k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq17 := k(k(v2,v1),k(v0,v1)); 
neq18 := k(k(v2,v1),k(k(v2,v0),v2)); 
neq19 := k(v2,k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2))); 
neq20 := k(v2,k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1))); 
neq21 := k(v2,k(k(k(k(v2,v0),v2),v1),v1)); 
neq22 := k(v2,v0); 
neq23 := k(v2,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq24 := k(v2,k(k(k(v2,v0),v2),k(v0,v1))); 
neq25 := k(v2,k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq26 := k(v2,k(v0,v1)); 
neq27 := k(v2,v1); 
neq28 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),v1),v1)); 
neq29 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v0); 
neq30 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq31 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v0)); 
neq32 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq33 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v0,v1)); 
neq34 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),v1); 
neq35 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),v1),v1)); 
neq36 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),v0); 
neq37 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq38 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(k(v2,v0),v2),k(v0,v1))); 
neq39 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)); 
neq40 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v0,v1)); 
neq41 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),v1); 
neq42 := k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(k(v2,v0),v2)); 
neq43 := k(k(k(k(k(v2,v0),v2),v1),v1),v0); 
neq44 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq45 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(k(v2,v0),v2),k(v0,v1))); 
neq46 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v2,v0)); 
neq47 := k(k(k(k(k(v2,v0),v2),v1),v1),k(v0,v1)); 
neq48 := k(k(k(k(k(v2,v0),v2),v1),v1),k(k(v2,v0),v2)); 
neq49 := k(v0,k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))); 
neq50 := k(v0,k(k(k(v2,v0),v2),k(v0,v1))); 
neq51 := k(v0,k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq52 := k(v0,k(k(v2,v0),v2)); 
neq53 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),k(v2,v0)); 
neq54 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),v1); 
neq55 := k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1)),k(k(v2,v0),v2)); 
neq56 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(v2,v0)); 
neq57 := k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0))); 
neq58 := k(k(k(k(v2,v0),v2),k(v0,v1)),v1); 
neq59 := k(k(v2,v0),k(v0,v1)); 
neq60 := k(k(v2,v0),v1); 
neq61 := k(k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(v0,v1)); 
neq62 := k(k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),v1); 
neq63 := k(k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(k(v2,v0),v2)); 
...
phi := 
       ...
       d(k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(k(k(k(v2,v0),v2),v1),v1)) = 0 and 
       d(k(k(k(k(k(k(v2,v0),v2),k(v0,v1)),k(k(v2,v0),v2)),k(v2,v1)),k(v2,v0)),k(k(k(k(v2,v0),v2),k(v0,v1)),k(v0,v1))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
