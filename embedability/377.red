...
v3 := {v3c1, v3c2, v3c3}; 
v3c1 := 0;
neq0 := k(v2,k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1))); 
neq1 := k(v2,v0); 
neq2 := k(v2,v1); 
neq3 := k(v2,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))); 
neq4 := k(v2,v3); 
neq5 := k(v2,k(v3,k(k(v2,v1),v2))); 
neq6 := k(v2,k(k(v3,v0),k(k(v2,v1),v2))); 
neq7 := k(v2,k(v3,v0)); 
neq8 := k(v2,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq9 := k(k(v2,v1),k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1))); 
neq10 := k(k(v2,v1),v0); 
neq11 := k(k(v2,v1),k(k(k(v3,k(k(v2,v1),v2)),v1),v2)); 
neq12 := k(k(v2,v1),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))); 
neq13 := k(k(v2,v1),v3); 
neq14 := k(k(v2,v1),k(v3,k(k(v2,v1),v2))); 
neq15 := k(k(v2,v1),k(k(v3,v0),k(k(v2,v1),v2))); 
neq16 := k(k(v2,v1),k(v3,v0)); 
neq17 := k(k(v2,v1),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq18 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),v0); 
neq19 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),v1); 
neq20 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),v3); 
neq21 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),k(v3,k(k(v2,v1),v2))); 
neq22 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),k(k(v3,v0),k(k(v2,v1),v2))); 
neq23 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),k(v3,v0)); 
neq24 := k(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),k(k(v2,v1),v2)); 
neq25 := k(v0,k(k(k(v3,k(k(v2,v1),v2)),v1),v2)); 
neq26 := k(v0,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))); 
neq27 := k(v0,k(v3,k(k(v2,v1),v2))); 
neq28 := k(v0,k(k(v3,v0),k(k(v2,v1),v2))); 
neq29 := k(v0,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq30 := k(v0,k(k(v2,v1),v2)); 
neq31 := k(v1,k(k(k(v3,k(k(v2,v1),v2)),v1),v2)); 
neq32 := k(v1,k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))); 
neq33 := k(v1,v3); 
neq34 := k(v1,k(v3,k(k(v2,v1),v2))); 
neq35 := k(v1,k(k(v3,v0),k(k(v2,v1),v2))); 
neq36 := k(v1,k(v3,v0)); 
neq37 := k(v1,k(k(v2,v1),v2)); 
neq38 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))); 
neq39 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),v3); 
neq40 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(v3,k(k(v2,v1),v2))); 
neq41 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,v0),k(k(v2,v1),v2))); 
neq42 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(v3,v0)); 
neq43 := k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v2,v1),v2)); 
neq44 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0)),v3); 
neq45 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0)),k(v3,k(k(v2,v1),v2))); 
neq46 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0)),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq47 := k(k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0)),k(k(v2,v1),v2)); 
neq48 := k(v3,k(k(v3,v0),k(k(v2,v1),v2))); 
neq49 := k(v3,k(k(v3,k(k(v2,v1),v2)),v1)); 
neq50 := k(v3,k(k(v2,v1),v2)); 
neq51 := k(k(v3,k(k(v2,v1),v2)),k(k(v3,v0),k(k(v2,v1),v2))); 
neq52 := k(k(v3,k(k(v2,v1),v2)),k(v3,v0)); 
neq53 := k(k(k(v3,v0),k(k(v2,v1),v2)),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq54 := k(k(v3,v0),k(k(v3,k(k(v2,v1),v2)),v1)); 
neq55 := k(k(v3,v0),k(k(v2,v1),v2)); 
neq56 := k(k(k(v3,k(k(v2,v1),v2)),v1),k(k(v2,v1),v2)); 
phi := 
       (first neq0 neq 0 or
       ...
       d(v3,v0) = 0 and 
       d(k(k(k(k(v3,k(k(v2,v1),v2)),v1),v2),k(k(v3,k(k(v2,v1),v2)),v1)),k(k(k(v3,v0),k(k(v2,v1),v2)),k(v3,v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v3c2,
