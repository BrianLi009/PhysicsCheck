...
def test_embed(): 
    ...
    s.add(((z_8*x_12-x_8*z_12)*z_11-(x_8*y_12-y_8*x_12)*y_11)==0) 
    s.add(((x_8*y_12-y_8*x_12)*x_11-(y_8*z_12-z_8*y_12)*z_11)==0) 
    s.add(((y_8*z_12-z_8*y_12)*y_11-(z_8*x_12-x_8*z_12)*x_11)==0) 
