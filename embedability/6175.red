...
v1 := {v1c1, v1c2, v1c3}; 
v2 := {v2c1, v2c2, v2c3}; 
neq0 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),v2); 
neq1 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(v2,v1),v2)); 
neq2 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq3 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq4 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(v2,v0)); 
neq5 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(k(v2,v1),v2),v0)); 
neq6 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(v2,v1)); 
neq7 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(v2,v1),v1)); 
neq8 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),v0); 
neq9 := k(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),v1); 
neq10 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0))); 
neq11 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)); 
neq12 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),v2); 
neq13 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(k(v2,v1),v2)); 
neq14 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(k(k(v2,v1),v1),k(v2,v0))); 
neq15 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(k(k(v2,v1),v2),v0)); 
neq16 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v2,v1)); 
neq17 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(k(v2,v1),v1)); 
neq18 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),v0); 
neq19 := k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),v1); 
neq20 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(v0,v1)); 
neq21 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),v2); 
neq22 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v2)); 
neq23 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq24 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(v2,v0)); 
neq25 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
neq26 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),k(k(v2,v1),v1)); 
neq27 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),v0); 
neq28 := k(k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)),v1); 
neq29 := k(k(v0,v1),v2); 
neq30 := k(k(v0,v1),k(k(v2,v1),v2)); 
neq31 := k(k(v0,v1),k(k(k(v2,v1),v1),k(v2,v0))); 
neq32 := k(k(v0,v1),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq33 := k(k(v0,v1),k(v2,v0)); 
neq34 := k(k(v0,v1),k(k(k(v2,v1),v2),v0)); 
neq35 := k(k(v0,v1),k(v2,v1)); 
neq36 := k(k(v0,v1),k(k(v2,v1),v1)); 
neq37 := k(v2,k(k(k(v2,v1),v1),k(v2,v0))); 
neq38 := k(v2,k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq39 := k(v2,k(k(k(v2,v1),v2),v0)); 
neq40 := k(v2,k(k(v2,v1),v1)); 
neq41 := k(v2,v0); 
neq42 := k(v2,v1); 
neq43 := k(k(k(v2,v1),v2),k(k(k(v2,v1),v1),k(v2,v0))); 
neq44 := k(k(k(v2,v1),v2),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq45 := k(k(k(v2,v1),v2),k(v2,v0)); 
neq46 := k(k(k(v2,v1),v2),k(k(v2,v1),v1)); 
neq47 := k(k(k(v2,v1),v2),v0); 
neq48 := k(k(k(v2,v1),v2),v1); 
neq49 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0))); 
neq50 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0)); 
neq51 := k(k(k(k(v2,v1),v1),k(v2,v0)),k(v2,v1)); 
neq52 := k(k(k(k(v2,v1),v1),k(v2,v0)),v0); 
neq53 := k(k(k(k(v2,v1),v1),k(v2,v0)),v1); 
neq54 := k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)); 
neq55 := k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v1)); 
neq56 := k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),v0); 
...
phi := 
       ...
       d(k(k(k(k(k(v2,v1),v1),k(k(k(v2,v1),v2),v0)),k(v2,v0)),k(v0,v1)),k(k(k(k(v2,v1),v1),k(v2,v0)),k(k(k(v2,v1),v2),v0))) = 0 and 
        true;
rlqe 
     ex(v2c2,
     ex(v2c1,
