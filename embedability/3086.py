...
def test_embed(): 
    ...
    s.add(((z_3*x_12-x_3*z_12)*z_1-(x_3*y_12-y_3*x_12)*y_1)==0) 
    s.add(((x_3*y_12-y_3*x_12)*x_1-(y_3*z_12-z_3*y_12)*z_1)==0) 
    s.add(((y_3*z_12-z_3*y_12)*y_1-(z_3*x_12-x_3*z_12)*x_1)==0) 
